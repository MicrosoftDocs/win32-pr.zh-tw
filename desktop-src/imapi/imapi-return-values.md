...
<td style="text-align: left;">光碟未通過燒錄驗證，可能包含損毀的資料或無法使用。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">已取消要求。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">要求必須選取目前的光碟錄製器。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">目前沒有任何寫入作業正在進行中。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">磁片磁碟機不支援要求的寫入速度，並且已調整速度。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">磁片磁碟機不支援要求的旋轉類型，且已調整旋轉類型。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">磁片磁碟機不支援要求的寫入速度和旋轉類型，而且兩者都經過調整。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">裝置已接受命令，但傳回的意義資料表示錯誤。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">因為呼叫 <a href="/windows/desktop/api/imapi2/nf-imapi2-irawcdimagecreator-createresultimage"><strong>IRawCDImageCreator：： CreateResultImage</strong></a>，所以映射已變成隻讀。 因此無法再修改物件。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">可能不會再新增任何曲目。 CD 媒體的範圍限制為1-99 個曲目。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">使用此函式之前，必須先將追蹤新增至影像。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">不支援要求的磁區類型。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">使用此函式之前，可能不會將追蹤新增至影像。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">新增此播放軌會超過 leadout 開頭的限制。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">新增此播放軌會超過99索引限制。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">指定的 LBA 位移不在追蹤索引的清單中。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指定的 LBA 位移已經在追蹤索引的清單中。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">無法清除索引 1 (LBA offset 0) 。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">每個索引都必須有10個磁區的最小大小。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">裝置回報要求的模式頁面 (，且類型) 不存在。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">裝置中沒有任何媒體。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">媒體與未知的實體格式不相容。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">媒體會朝下插入。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">磁片磁碟機回報正在準備就緒。 請稍後再試一次要求。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">媒體目前正在格式化。 請等候格式完成，再嘗試使用媒體。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">磁片磁碟機回報它正在執行長時間執行的作業，例如完成寫入。 磁片磁碟機可能很長一段時間無法使用。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">磁片磁碟機回報，不支援在模式選取命令的模式頁面中提供的參數組合。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">磁片磁碟機報告媒體已受寫入保護。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">裝置不支援要求的功能頁面。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">支援要求的功能頁面，但未標示為最新。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">磁片磁碟機不支援 GET CONFIGURATION 命令。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">裝置無法接受超時時間內的命令。 這可能是因為裝置進入不一致的狀態，或命令的超時值可能需要增加。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">DVD 結構不存在。 這可能是因為使用的驅動程式/媒體不相容所造成。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">媒體的速度與裝置不相容。 這可能是因為使用較高或較低的速度媒體，而不是裝置支援的速度範圍。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">上次操作期間與此錄製器相關聯的裝置已被獨佔鎖定，導致此作業失敗。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">用戶端名稱無效。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">裝置針對命令回報了未預期或不正確資料。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">寫入失敗，因為磁片磁碟機無法快速地接收資料來繼續寫入。 將來源資料移至本機電腦、減少寫入速度，或啟用 &quot; 緩衝區不足的可用設定， &quot; 即可解決此問題。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">寫入失敗，因為磁片磁碟機傳回無法從中復原的錯誤資訊。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">目前正在進行寫入作業。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">要求的作業僅適用于支援的媒體。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">不支援提供要寫入的資料流程。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">提供要寫入的資料流程對目前插入的媒體而言太大。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">若未將 ForceOverwrite 屬性設定為 VARIANT_TRUE，則不允許覆寫非空白媒體。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">不支援目前的媒體類型。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">此裝置不支援此光碟格式所需的作業。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">只有在備妥媒體時，要求的作業才有效 &quot; &quot; 。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">當媒體已備妥但未釋出時，要求的操作無效 &quot; &quot; 。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">寫入媒體之後，就無法變更此屬性。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">無法從空的光碟取出目錄。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">僅支援空白的 CD-R/RW 媒體。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">CD-R 和 CD-RW 媒體最多支援99個音訊播放軌。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">媒體上沒有足夠的空間可新增提供的音訊播放軌。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">在選擇要使用的錄製器之前，您無法準備媒體。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">提供的 ISRC 無效。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">提供的媒體目錄號碼無效。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">提供的音訊資料流程無效。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">媒體上的空間不足，無法新增提供的會話。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">目前的裝置不支援要求的資料區塊類型。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">串流在目前媒體的 leadin 中未包含足夠的磁區數目。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">此格式目前正在使用光碟錄製器進行清除操作。 請等候清除完成，再嘗試設定或清除目前的光碟錄製器。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">清除格式只支援一個錄製器。 設定新的錄製器之前，您必須先清除目前的錄製器。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">磁片磁碟機未報告讀取光碟資訊命令的足夠資料。 可能不支援磁片磁碟機，或媒體可能不正確。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">磁片磁碟機未回報足夠的資料給模式感知 (頁面 0x2A) 命令。 可能不支援磁片磁碟機，或媒體可能不正確。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">磁片磁碟機報告媒體無法擦擦。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">磁片磁碟機無法清除命令。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">磁片磁碟機未在一小時內完成清除。 磁片磁碟機可能需要電源週期、媒體移除或其他手動介入，才能繼續適當的操作。<br/>
<blockquote>
[!Note]<br />
目前，如果嘗試透過 <a href="/windows/desktop/api/imapi2/nn-imapi2-idiscformat2erase"><strong>IDiscFormat2Erase</strong></a> 介面在 CD-RW 或 cd-rw 媒體上執行清除失敗，因為媒體不正確，也會傳回此值。
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">磁片磁碟機在清除期間傳回未預期的錯誤。 媒體可能無法使用、清除可能已完成，或磁片磁碟機可能仍在清除光碟的過程中。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">磁片磁碟機傳回啟動單元 (spinup) 命令的錯誤。 可能需要手動介入。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">發生內部錯誤： %1！ ls！。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">為參數 ' %1！ ls！ ' 指定的值 無效。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">FileSystemImage 物件處於唯讀模式。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">未指定輸出檔案系統。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指定的磁片區識別碼太長，或包含一或多個不正確字元。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">不正確檔案日期。 %1！ ls！ 時間早于 %2！ ls！ 時間的多個數列。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">此函數的檔案系統必須為空白。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">您無法變更為建立所指定的檔案系統，因為匯入會話中的檔案系統與目前會話中的檔案系統不符。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指定的路徑 ' %1！ ls！ ' 未識別檔案。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">指定的路徑 ' %1！ ls！ ' 未識別目錄。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">目錄 ' %1！ s！ ' 不是空的。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">ls！ ' 不是檔案系統的一部分。 必須新增才能完成此操作。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">路徑 ' %1！ s！ ' 的格式不正確，或包含不正確字元。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">名稱 ' %1！ ls！ ' 指定的不是合法：設定 UseRestrictedCharacterSet 屬性時所建立的檔案或目錄物件的名稱，可能只包含 ANSI 字元。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">ls！ ' 名稱已存在。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">嘗試加入 ' %1！ ls！ ' failed：無法為 %2！ ls！建立檔案系統特有的唯一名稱 檔案系統)。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">找不到專案 ' %1！ ls！ ' 在 FileSystemImage 階層中。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">檔案 ' %1！ s！ ' 在 FileSystemImage 階層中找不到。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">目錄 ' %1！ s！ ' 在 FileSystemImage 階層中找不到。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">正在加入 ' %1！ ls！ ' 結果影像的大小會大於目前設定的限制。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">針對 FreeMediaBlocks 屬性指定的值對於以目前資料為基礎的估計影像大小而言太小。 <br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">影像未在2kb 磁區界限上對齊。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">映射未包含有效的磁片區描述項。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">在呼叫<a href="/windows/desktop/api/imapi2fs/nf-imapi2fs-iisoimagemanager-validate"><strong>IIsoImageManager：： Validate</strong></a>方法之前，尚未使用<a href="/windows/desktop/api/imapi2fs/nf-imapi2fs-iisoimagemanager-setpath"><strong>IIsoImageManager：： SetPath</strong></a>或<a href="/windows/desktop/api/imapi2fs/nf-imapi2fs-iisoimagemanager-setstream"><strong>IIsoImageManager：： SetStream</strong></a>方法設定影像。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">提供的映射太大，無法進行驗證，因為大小超過 <strong>MAXLONG</strong>。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">為檔案 ' %1！ ls！ ' 提供的資料流程 不一致：應為 %2！I64d! 位元組，找到 %3！I64d！。 <br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">無法從為檔案 ' %1！ ls！ ' 提供的資料流程讀取資料。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">嘗試建立檔案 ' %1！ ls！ ' 的資料流程時，發生下列錯誤： <br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">因為許可權的緣故，無法在目錄樹狀結構中列舉檔案。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">%1！ ls！的這個檔案系統映射有太多目錄 檔案系統)。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">ISO9660 限制為8個目錄層級。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">資料檔案對 ' %1！ ls！ ' 而言太大 檔案系統)。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">無法初始化 %1！ ls！ 隱藏盤案。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">在 ' %1！ ls！ ' 中搜尋時發生錯誤 隱藏盤案。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">寫入 ' %1！ ls！ ' 時發生錯誤 隱藏盤案。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">從 ' %1！ ls！ ' 讀取時發生錯誤 隱藏盤案。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">工作目錄 ' %1！ ls！ ' 無效。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">無法將工作目錄設定為 ' %1！ ls！ '。 可用的空間為 %2！I64d! 位元組，大約 %3！I64d! 需要的位元組。 <br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">嘗試將資料隱藏檔案移至目錄 ' %1！ ls！ ' 失敗。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">無法將開機物件新增至映射。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">開機物件只能包含在初始光碟映射中。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">要求的模擬類型與開機映射大小不符。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">光學媒體是空的。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">指定的光碟未包含其中一個支援的檔案系統。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指定的光碟未包含 ' %1！ ls！ ' 檔案系統)。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">匯入 ' %1！ ls！ ' 時發生一致性錯誤 檔案系統)。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">' %1！ ls！ '所選光碟上的檔案系統包含匯入： %2！ ls！不支援的功能。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">無法匯入 %2！ ls！ 磁片的檔案系統。檔案 ' %1！ ls！ ' 已存在於映射階層中做為目錄。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">無法搜尋以封鎖 %1！I64d! 在來源光碟上。 <br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">從上一個會話匯入失敗，因為讀取媒體上的區塊時發生錯誤 (很可能會封鎖 %1！ u！ ) 。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">目前的光碟與匯入檔案系統的磁片不同。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">IMAPI.EXE 不允許具有目前媒體類型的多重會話。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">IMAPI.EXE 無法執行與目前媒體的多重會話，因為它不支援寫入的相容 UDF 修訂。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">IMAPI.EXE 不支援所要求的多會話型別。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">作業失敗，因為先前從媒體匯入會話的版面配置不相容。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">IMAPI.EXE 不支援目前媒體上提供的任何多會話類型 (s) 。<br/>
<blockquote>
[!Note]<br />
[<strong>IFileSystemImage：： ImportFileSystem</strong>] (如果錄製裝置中沒有媒體，則/windows/desktop/api/imapi2fs/nf-imapi2fs-ifilesystemimage-importfilesystem) 方法會傳回此錯誤。
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">MultisessionInterfaces 屬性必須在呼叫這個方法之前設定。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">無法匯入 %2！ ls！ 磁片的檔案系統。目錄 ' %1！ ls！ ' 已在映射階層內以檔案形式存在。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">無法抓取其中一個多會話參數或其值錯誤。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">目前的檔案系統版本不支援這項功能。 建立映射時不會有這項功能。<br/></td>
</tr>
</tbody>
</table>
