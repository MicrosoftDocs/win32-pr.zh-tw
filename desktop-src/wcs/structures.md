---
title: WCS 1.0 結構
description: 參考的區段，其中包含 WCS 1.0 所使用的重要結構清單。
...
ms.locfileid: "118444715"
---
# <a name="wcs-10-structures"></a>WCS 1.0 結構

參考的這個區段包含 WCS 1.0 所使用的最重要結構清單。 這些步驟如下所示：
...
-   [**Gamut 地圖模型色彩結構**](https://www.bing.com/search?q=**Gamut+Map+Model+Color+Structures**)
...
-   [**ICM 色彩結構**](/windows/win32/api/icm/ns-icm-color)
-   [**LOGCOLORSPACE**](/windows/desktop/api/Wingdi/ns-wingdi-taglogcolorspacea)
-   [**命名 \_ 設定檔 \_ 資訊**](/windows/win32/api/icm/ns-icm-named_profile_info)
...
-   [**配置 檔**](/windows/win32/api/icm/ns-icm-profile)
