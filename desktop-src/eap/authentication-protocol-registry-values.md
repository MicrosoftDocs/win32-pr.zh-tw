...
|----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 類型           | REG_SZ                                                                                                                                                           |
| 描述    | 指定驗證通訊協定的易記名稱。 這個名稱會出現在 EAP 應用程式使用者介面中，以供撥號和無線執行。 |
...
|----------------|-----------------------------------------------------------------------------------------------------------------------------------|
| 類型           |  REG_EXPAND_SZ                                                                                                                    |
| 描述    | 指定在用戶端上執行設定使用者介面之 DLL 的路徑，因為此 UI 僅供用戶端使用。 |
...
|----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 類型           | REG_DWORD                                                                                                                                                                                                                                               |
| 描述    | 指定使用者是否必須在 EAP 用戶端應用程式使用者介面中提供設定資料。 如果此值為1，則不允許使用者離開 EAP 用戶端應用程式 UI，而不提供設定資料。 預設值為 0。 |
...
|----------------|----------------------------------------------------------------------------------------------------------------------------------------|
| 類型           |  REG_EXPAND_SZ                                                                                                                         |
| 描述    | 指定可在用戶端上執行函式以取得使用者身分識別之 DLL 的路徑，因為此 UI 僅供用戶端使用。 |
...
|----------------|---------------------------------------------------------------------------------------------------------------------------------|
| 類型           |  REG_EXPAND_SZ                                                                                                                  |
| 描述    | 指定在用戶端上執行互動式使用者介面之 DLL 的路徑，因為此 UI 僅供用戶端使用。 |
...
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 類型           | REG_DWORD                                                                                                                                                                                             |
| 描述    | 指定 RAS 是否應顯示標準 Windows NT/Windows 2000 使用者名稱對話方塊 (值 1) 或叫用 [**RasEapGetIdentity**](/previous-versions/windows/desktop/api/Raseapif/nf-raseapif-raseapgetidentity) (值為 0) 。 預設值為 1。 |
...
|----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 類型           | REG_DWORD                                                                                                                                                                                  |
| 描述    | 指定 RAS 是否應顯示標準的 Windows NT/Windows 2000 密碼對話方塊。 如果這個值存在且為0，RAS 將不會顯示密碼對話方塊。 預設值為 1。 |
...
|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 類型           | REG_DWORD                                                                                                                                                                                    |
| 描述    | 如果這個值是1，則驗證通訊協定可以產生 Microsoft 點對點加密 (MPPE) 加密樣式的金鑰。 可能的值為0或1。 預設值為 0。 |
...
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 類型           | REG_DWORD                                                                                                                                                                     |
| 描述    | 指定獨立 Windows 2000 伺服器是否支援此驗證通訊協定。 值為0表示不支援 EAP。 預設值為 1。 |
...
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 類型           | REG_DWORD                                                                                                                                                                                                                                 |
| 描述    | 指定 EAP 支援的各種角色。 這指出是否可在伺服器或用戶端上使用它， (VPN) 或 PEAP 的 RAS 連線是否支援。 預設行為是在 PEAP 和 EAP 中顯示 EAP 方法。 |
