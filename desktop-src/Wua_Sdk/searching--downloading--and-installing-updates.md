...
本主題中的腳本範例說明如何使用 Windows Update Agent (WUA) 來掃描、下載及安裝更新。

此範例會搜尋所有適用的軟體更新，然後列出這些更新。 接下來，它會建立要下載的更新集合，然後加以下載。 最後，它會建立要安裝的更新集合，然後加以安裝。

如果您想要使用更新標題來搜尋、下載及安裝您識別的特定更新，請參閱 [搜尋、下載及安裝特定](searching--downloading--and-installing-specific-updates.md)更新。
