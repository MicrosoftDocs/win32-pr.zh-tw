...
---
# <a name="windows-update-agent-api"></a>Windows Update 代理程式 API
...
您可以用數種程式設計語言撰寫 WUA 應用程式。 WUA 會定義 Visual Basic、Visual Basic Scripting Edition (VBScript) 、JScript 以及 C 和 c + + 可存取的介面和物件。 熟悉 COM 程式設計對 WUA 程式設計師很有用。
