---
title: MsRdpClient3a 類別
description: Microsoft RDP 用戶端控制 (可轉散發套件) -4a 版。
ms.assetid: F2E3D49F-B3F9-40EF-9B93-C87F55DB0352
ms.tgt_platform: multiple
keywords:
- MsRdpClient3a 類別遠端桌面服務
- MsRdpClient3a 類別遠端桌面服務，說明
topic_type:
- apiref
api_name:
- MsRdpClient3a
...
ms.locfileid: "104508415"
---
# <a name="msrdpclient3a-class"></a>MsRdpClient3a 類別

Microsoft RDP 用戶端控制 (可轉散發套件) -4a 版
...
| CLSID<br/>                    | CLSID \_ MsRdpClient3a 定義為6A6F4B83-45C5-4CA9-BDD9-0D81C12295E4<br/>     |
