---
title: 在網頁中內嵌遠端桌面 ActiveX 控制項
description: 示範如何使用可編寫腳本之介面的範例。
...
---
# <a name="embedding-the-remote-desktop-activex-control-in-a-webpage"></a><span data-ttu-id="69061-103">在網頁中內嵌遠端桌面 ActiveX 控制項</span><span class="sxs-lookup"><span data-stu-id="69061-103">Embedding the Remote Desktop ActiveX control in a webpage</span></span>

<span data-ttu-id="69061-104">您可以使用類似下面的程式碼，將遠端桌面 ActiveX 控制項內嵌在網頁中。</span><span class="sxs-lookup"><span data-stu-id="69061-104">You can embed the Remote Desktop ActiveX control in a web page by using code that is similar to the following.</span></span>
...
<span data-ttu-id="69061-105">CLSID 適用于由遠端桌面連線 (RDP) 6.0 所裝載的 ActiveX 控制項。</span><span class="sxs-lookup"><span data-stu-id="69061-105">The CLSID is for the ActiveX control that is hosted by Remote Desktop Connection (RDP) 6.0.</span></span> <span data-ttu-id="69061-106">此 ActiveX 控制項會執行 [**IMsRdpClient**](imsrdpclient-interface.md)。</span><span class="sxs-lookup"><span data-stu-id="69061-106">This ActiveX control implements [**IMsRdpClient**](imsrdpclient-interface.md).</span></span>

## <a name="related-topics"></a><span data-ttu-id="69061-107">相關主題</span><span class="sxs-lookup"><span data-stu-id="69061-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="69061-108">使用遠端桌面 ActiveX 控制項</span><span class="sxs-lookup"><span data-stu-id="69061-108">Using the Remote Desktop ActiveX control</span></span>](using-remote-desktop-web-connection.md)
</dt> </dl>
