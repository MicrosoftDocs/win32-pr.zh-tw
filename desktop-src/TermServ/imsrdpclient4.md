...
**IMsRdpClient4** 介面繼承自 [**IMsRdpClient3**](imsrdpclient3.md)。 **IMsRdpClient4** 也有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**IMsRdpClient4** 介面具有這些屬性。
...
下列介面已擴充 **IMsRdpClient4** 介面，每個新介面都會繼承先前介面的所有方法和屬性：
...
| IID<br/>                      | IID \_ IMsRdpClient4 定義為095E0738-D97D-488b-B9F6-DD0E8D66C0DE<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
