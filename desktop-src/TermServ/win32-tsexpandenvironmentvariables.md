...
ms.locfileid: "117940089"
---
# <a name="win32_tsexpandenvironmentvariables-class"></a>Win32 \_ TSExpandEnvironmentVariables 類別
...
**Win32 \_ TSExpandEnvironmentVariables** 類別具有下列類型的成員：
...
**Win32 \_ TSExpandEnvironmentVariables** 類別具有這些方法。



| 方法                                                                                  | 描述                                              |
|:----------------------------------------------------------------------------------------|:---------------------------------------------------------|
| [**EnvironmentVariables**](environmentvariables-win32-tsexpandenvironmentvariables.md) | 展開系統定義的環境變數。<br/> |
...
**Win32 \_ TSExpandEnvironmentVariables** 類別具有這些屬性。
