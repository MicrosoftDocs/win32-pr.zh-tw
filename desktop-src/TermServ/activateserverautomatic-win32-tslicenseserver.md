...
---
# <a name="activateserverautomatic-method-of-the-win32_tslicenseserver-class"></a>Win32 TSLicenseServer 類別的 ActivateServerAutomatic 方法 \_
...
除非已設定 **FirstName**、 **LastName**、 **Company** 和 **國家（地區** ）屬性，否則這個方法會失敗。
