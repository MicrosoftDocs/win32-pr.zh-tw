...
ms.locfileid: "118609252"
---
# <a name="imsrdpclientadvancedsettingsacceleratorpassthrough-property"></a>IMsRdpClientAdvancedSettings：： AcceleratorPassthrough 屬性
...
將此參數設定為0，以停用此功能或非零值以啟用此功能。 預設值為非零值。
