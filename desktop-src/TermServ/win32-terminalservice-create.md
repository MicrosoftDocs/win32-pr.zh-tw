...
因為 [**Win32 \_ BaseService**](/windows/desktop/CIMWin32Prov/win32-baseservice)) 類別的服務 (**state** 屬性的狀態等於0、1或2，所以無法將要求的控制項程式碼傳送至服務。
...
**Create** 方法類似于 [**變更**](win32-terminalservice-change.md)方法。 在這兩種情況下，服務的屬性都會作為參數傳遞給方法。 如同與 **變更** 方法搭配使用的參數，傳遞這些參數的順序很重要。
