...
ms.locfileid: "117757820"
---
# <a name="getprotocolname-method-of-the-win32_tsgatewayserversettings-class"></a>Win32 TSGatewayServerSettings 類別的 GetProtocolName 方法 \_
...
通訊協定識別碼的索引。 值必須介於零到 **MaxProtocols** 屬性的值之間。
