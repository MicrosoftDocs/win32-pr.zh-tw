...
ms.locfileid: "119870068"
---
# <a name="setsmartcardallowed-method-of-the-win32_tsgatewayconnectionauthorizationpolicy-class"></a>Win32 TSGatewayConnectionAuthorizationPolicy 類別的 SetSmartcardAllowed 方法 \_

設定 **SmartcardAllowed** 屬性，此屬性可啟用或停用智慧卡的支援，以連接至遠端桌面閘道 (RD 閘道) 伺服器。
