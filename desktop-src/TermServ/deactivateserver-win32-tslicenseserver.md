...
---
# <a name="deactivateserver-method-of-the-win32_tslicenseserver-class"></a>Win32 TSLicenseServer 類別的 DeactivateServer 方法 \_

使用透過電話收到的確認碼來停用遠端桌面授權伺服器。
