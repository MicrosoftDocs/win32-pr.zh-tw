...
---
# <a name="win32_tsstartmenuapplication-class"></a>Win32 \_ TSStartMenuApplication 類別

描述 [開始] 功能表遠端桌面工作階段主機 (RD 工作階段主機) server 上的應用程式。
...
**Win32 \_ TSStartMenuApplication** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ TSStartMenuApplication** 類別具有這些屬性。
