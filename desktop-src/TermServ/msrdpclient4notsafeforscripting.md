...
---
# <a name="msrdpclient4notsafeforscripting-class"></a>MsRdpClient4NotSafeForScripting 類別

Microsoft RDP 用戶端控制-第5版
...
**MsRdpClient4NotSafeForScripting** 具有下列類型的成員：
...
**MsRdpClient4NotSafeForScripting** 類別有這些方法。
...
**MsRdpClient4NotSafeForScripting** 類別具有這些屬性。
...
| CLSID<br/>                    | CLSID \_ MsRdpClient4NotSafeForScripting 定義為6AE29350-321B-42BE-BBE5-12FB5270C0DE<br/> |
