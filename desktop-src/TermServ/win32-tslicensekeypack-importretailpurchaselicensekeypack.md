...
---
# <a name="importretailpurchaselicensekeypack-method-of-the-win32_tslicensekeypack-class"></a>Win32 TSLicenseKeyPack 類別的 ImportRetailPurchaseLicenseKeyPack 方法 \_

從另一部遠端桌面授權伺服器匯入，這是透過零售通路購買的遠端桌面服務授權金鑰套件。
