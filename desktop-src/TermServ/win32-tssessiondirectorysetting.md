...
ms.locfileid: "119769278"
---
# <a name="win32_tssessiondirectorysetting-class"></a>Win32 \_ TSSessionDirectorySetting 類別
...
**Win32 \_ TSSessionDirectorySetting** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ TSSessionDirectorySetting** 類別具有這些屬性。
...
表示可以使用 **設定** 屬性設定的 **Win32 \_ TerminalService** 實例。
...
資料類型： **Win32 \_ TSSessionDirectory**
</dt> <dt>
...
表示可以套用至相關聯 RD 工作階段主機伺服器的 RD 連線代理人設定。
