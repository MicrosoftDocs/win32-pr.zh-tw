...
---
# <a name="imsrdpclientnonscriptable3showredirectionwarningdialog-property"></a>IMsRdpClientNonScriptable3：： ShowRedirectionWarningDialog 屬性

指定或抓取是否應顯示 [重新導向警告] 對話方塊。
