---
title: MsRdpClient10NotSafeForScripting 類別
description: Microsoft RDP 用戶端控制-第11版。
ms.assetid: AAC3DA65-222D-498F-B9C3-A8CBCB722D9D
ms.tgt_platform: multiple
keywords:
- MsRdpClient10NotSafeForScripting 類別遠端桌面服務
- MsRdpClient10NotSafeForScripting 類別遠端桌面服務，說明
topic_type:
- apiref
api_name:
...
ms.locfileid: "104465313"
---
# <a name="msrdpclient10notsafeforscripting-class"></a>MsRdpClient10NotSafeForScripting 類別

Microsoft RDP 用戶端控制-第11版
...
**MsRdpClient10NotSafeForScripting** 具有下列類型的成員：
...
**MsRdpClient10NotSafeForScripting** 類別有這些方法。
...
**MsRdpClient10NotSafeForScripting** 類別具有這些屬性。
...
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">要 <a href="imsrdpclientadvancedsettings6.md"><strong>IMsRdpClientAdvancedSettings6</strong></a>的介面。<br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><a href="imsrdpclient7-advancedsettings8.md"><strong>AdvancedSettings8</strong></a><br/></td>
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">支援 <a href="imsrdpclientadvancedsettings7.md"><strong>IMsRdpClientAdvancedSettings7</strong></a> 介面的物件。<br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><a href="imsrdpclient8-advancedsettings9.md"><strong>AdvancedSettings9</strong></a><br/></td>
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">表示 settings 物件的 <a href="imsrdpclientadvancedsettings8.md"><strong>IMsRdpClientAdvancedSettings8</strong></a> 介面。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">指定 [認證] 對話方塊是否顯示啟用儲存認證的核取方塊。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">指定遠端桌面 ActiveX 控制項是否可以提示使用者輸入認證。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">以純文字格式的遠端桌面 ActiveX 控制項密碼。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">唯寫<br/></td>
<td style="text-align: left;">指定遠端桌面 ActiveX 控制項是否應該停用連接列。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">指定遠端桌面 ActiveX 控制項是否不應檢查伺服器的 RemoteApp 功能。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">指定遠端監視的周框。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">指定使用者是否使用 RD Web 存取介面啟動用戶端控制項。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">指定是否將 RDP 設定標示為安全。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">指定用戶端控制項是否顯示提示輸入認證的對話方塊。<br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><a href="imsrdppreferredredirectioninfo-useredirectionservername.md"><strong>屬性</strong></a><br/></td>
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">包含已命名的屬性。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">指定發行者的憑證鏈。 鏈會儲存在類型 VT_BYREF 的變數中，其中包含 <a href="/windows/desktop/api/wincrypt/ns-wincrypt-cert_chain_context"><strong>CERT_CHAIN_CONTEXT</strong></a> 結構的指標。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">控制重新導向對話方塊的存在和外觀。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">指定遠端監視的數目。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">指定遠端監視配置是否與本機監視器版面配置相同。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">支援 <a href="itsremoteprogram2.md"><strong>ITSRemoteProgram2</strong></a> 介面的物件。<br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><a href="imsrdpclient10-remoteprogram3.md"><strong>RemoteProgram3</strong></a><br/></td>
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">支援 <a href="itsremoteprogram3.md"><strong>ITSRemoteProgram3</strong></a> 介面的物件。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">支援 <a href="imsrdpclientsecuredsettings2.md"><strong>IMsRdpClientSecuredSettings2</strong></a> 介面的物件。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">要 <a href="imsrdpclienttransportsettings2.md"><strong>IMsRdpClientTransportSettings2</strong></a>的介面。<br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><a href="imsrdpclient7-transportsettings3.md"><strong>TransportSettings3</strong></a><br/></td>
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">支援 <a href="imsrdpclienttransportsettings3.md"><strong>IMsRdpClientTransportSettings3</strong></a> 介面的物件。<br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><a href="imsrdpclient9-transportsettings4.md"><strong>TransportSettings4</strong></a><br/></td>
<td style="text-align: left;">唯讀<br/></td>
<td style="text-align: left;">支援 <a href="imsrdpclienttransportsettings4.md"><strong>IMsRdpClientTransportSettings4</strong></a> 介面的物件。<br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><a href="imsrdpclientnonscriptable4-trustedzonesite.md"><strong>TrustedZoneSite</strong></a><br/></td>
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">指定使用者啟動連線的網站是否位於用戶端電腦的 [信任的網站] 清單中。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">指定遠端桌面 ActiveX 控制項是否應該使用多個監視器。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">是否要使用重新導向伺服器名稱。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">不會使用此屬性。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">讀取/寫入<br/></td>
<td style="text-align: left;">指定在啟動會話之前，重新導向對話方塊是否顯示印表機重新導向的相關訊息。<br/></td>
</tr>
<tr class="even">
...
| CLSID<br/>                    | CLSID \_ MsRdpClient10NotSafeForScripting 定義為 A0C63C30-F08D-4AB4-907C-34905D770C7D<br/> |
