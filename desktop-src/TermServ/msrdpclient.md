...
---
# <a name="msrdpclient-class"></a>MsRdpClient 類別

Microsoft RDP 用戶端控制 (可轉散發套件) -第2版
...
| CLSID<br/>                    | CLSID \_ MsRdpClient 定義為791fa017-2de3-492e-acc5-53c67a2b94d0<br/>       |
