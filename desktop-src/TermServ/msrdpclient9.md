...
-   [<span data-ttu-id="e9f39-121">**IMsRdpClientNonScriptable**</span><span class="sxs-lookup"><span data-stu-id="e9f39-121">**IMsRdpClientNonScriptable**</span></span>](imsrdpclientnonscriptable-interface.md)
...
| [<span data-ttu-id="e9f39-142">**中斷連線**</span><span class="sxs-lookup"><span data-stu-id="e9f39-142">**Disconnect**</span></span>](imstscax-disconnect.md)                                                   | <span data-ttu-id="e9f39-143">中斷使用中連接。</span><span class="sxs-lookup"><span data-stu-id="e9f39-143">Disconnects the active connection.</span></span><br/>                                                                                                                                                                                                                                                 |
...
| [<span data-ttu-id="e9f39-196">**OnNetworkStatusChanged**</span><span class="sxs-lookup"><span data-stu-id="e9f39-196">**OnNetworkStatusChanged**</span></span>](imstscaxevents-onnetworkstatuschanged.md)                     | <span data-ttu-id="e9f39-197">在網路狀態變更時呼叫。</span><span class="sxs-lookup"><span data-stu-id="e9f39-197">Called when the network status has changed.</span></span><br/>                                                                                                                                                                                                                                        |
...
| [<span data-ttu-id="e9f39-233">**SendRemoteAction**</span><span class="sxs-lookup"><span data-stu-id="e9f39-233">**SendRemoteAction**</span></span>](imsrdpclient8-sendremoteaction.md)                                  | <span data-ttu-id="e9f39-234">使動作在遠端會話中執行。</span><span class="sxs-lookup"><span data-stu-id="e9f39-234">Causes an action to be performed in the remote session.</span></span><br/>                                                                                                                                                                                                                            |
...
<td style="text-align: left;"><span data-ttu-id="e9f39-253">唯讀</span><span class="sxs-lookup"><span data-stu-id="e9f39-253">Read-only</span></span><br/></td>
...
<td style="text-align: left;"><span data-ttu-id="e9f39-269">支援 <a href="imsrdpclientadvancedsettings7.md"><strong>IMsRdpClientAdvancedSettings7</strong></a> 介面的物件。</span><span class="sxs-lookup"><span data-stu-id="e9f39-269">An object that supports the <a href="imsrdpclientadvancedsettings7.md"><strong>IMsRdpClientAdvancedSettings7</strong></a> interface.</span></span><br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><span data-ttu-id="e9f39-286">唯讀</span><span class="sxs-lookup"><span data-stu-id="e9f39-286">Read-only</span></span><br/></td>
...
<td style="text-align: left;"><span data-ttu-id="e9f39-305">要為連接列顯示的文字字串。</span><span class="sxs-lookup"><span data-stu-id="e9f39-305">The text string to display for the connection bar.</span></span><br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><span data-ttu-id="e9f39-323">在連接結束之前出現在控制項中央的文字。</span><span class="sxs-lookup"><span data-stu-id="e9f39-323">The text that appears centered in the control before a connection is terminated.</span></span><br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><span data-ttu-id="e9f39-341">當控制項處於全螢幕模式時，所顯示的視窗標題。</span><span class="sxs-lookup"><span data-stu-id="e9f39-341">The window title displayed when the control is in full-screen mode.</span></span><br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;"><span data-ttu-id="e9f39-358">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-358">Read/write</span></span><br/></td>
...
<td style="text-align: left;"><span data-ttu-id="e9f39-374">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-374">Read/write</span></span><br/></td>
...
<tr class="even">
<td style="text-align: left;"><span data-ttu-id="e9f39-419"><a href="imsrdpclient5-transportsettings.md"><strong>TransportSettings</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-419"><a href="imsrdpclient5-transportsettings.md"><strong>TransportSettings</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-420">唯讀</span><span class="sxs-lookup"><span data-stu-id="e9f39-420">Read-only</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-421">用戶端 RD 閘道設定。</span><span class="sxs-lookup"><span data-stu-id="e9f39-421">The client RD Gateway setting.</span></span><br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><span data-ttu-id="e9f39-422"><a href="imsrdpclient6-transportsettings2.md"><strong>TransportSettings2</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-422"><a href="imsrdpclient6-transportsettings2.md"><strong>TransportSettings2</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-423">唯讀</span><span class="sxs-lookup"><span data-stu-id="e9f39-423">Read-only</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-424">要 <a href="imsrdpclienttransportsettings2.md"><strong>IMsRdpClientTransportSettings2</strong></a>的介面。</span><span class="sxs-lookup"><span data-stu-id="e9f39-424">The interface to <a href="imsrdpclienttransportsettings2.md"><strong>IMsRdpClientTransportSettings2</strong></a>.</span></span><br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><span data-ttu-id="e9f39-425"><a href="imsrdpclient7-transportsettings3.md"><strong>TransportSettings3</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-425"><a href="imsrdpclient7-transportsettings3.md"><strong>TransportSettings3</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-426">唯讀</span><span class="sxs-lookup"><span data-stu-id="e9f39-426">Read-only</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-427">支援 <a href="imsrdpclienttransportsettings3.md"><strong>IMsRdpClientTransportSettings3</strong></a> 介面的物件。</span><span class="sxs-lookup"><span data-stu-id="e9f39-427">An object that supports the <a href="imsrdpclienttransportsettings3.md"><strong>IMsRdpClientTransportSettings3</strong></a> interface.</span></span><br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><span data-ttu-id="e9f39-428"><a href="imsrdpclient9-transportsettings4.md"><strong>TransportSettings4</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-428"><a href="imsrdpclient9-transportsettings4.md"><strong>TransportSettings4</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-429">唯讀</span><span class="sxs-lookup"><span data-stu-id="e9f39-429">Read-only</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-430">支援 <a href="imsrdpclienttransportsettings4.md"><strong>IMsRdpClientTransportSettings4</strong></a> 介面的物件。</span><span class="sxs-lookup"><span data-stu-id="e9f39-430">An object that supports the <a href="imsrdpclienttransportsettings4.md"><strong>IMsRdpClientTransportSettings4</strong></a> interface.</span></span><br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><span data-ttu-id="e9f39-431"><a href="imsrdpclientnonscriptable4-trustedzonesite.md"><strong>TrustedZoneSite</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-431"><a href="imsrdpclientnonscriptable4-trustedzonesite.md"><strong>TrustedZoneSite</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-432">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-432">Read/write</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-433">指定使用者啟動連線的網站是否位於用戶端電腦的 [信任的網站] 清單中。</span><span class="sxs-lookup"><span data-stu-id="e9f39-433">Specifies whether the website from which the user launched the connection is in the trusted sites list of the client computer.</span></span><br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><span data-ttu-id="e9f39-434"><a href="imsrdpclientnonscriptable2-uiparentwindowhandle.md"><strong>UIParentWindowHandle</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-434"><a href="imsrdpclientnonscriptable2-uiparentwindowhandle.md"><strong>UIParentWindowHandle</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-435">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-435">Read/write</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-436">要作為控制項父視窗的視窗控制碼。</span><span class="sxs-lookup"><span data-stu-id="e9f39-436">The window handle to be the parent window for the control.</span></span> <span data-ttu-id="e9f39-437">如此一來，控制項所顯示的任何視窗都能針對父應用程式所顯示的任何視窗適當地進行模式回應。</span><span class="sxs-lookup"><span data-stu-id="e9f39-437">This allows any windows displayed by the control to be properly modal with respect to any windows displayed by the parent application.</span></span><br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><span data-ttu-id="e9f39-438"><a href="imsrdpclientnonscriptable5-usemultimon.md"><strong>UseMultimon</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-438"><a href="imsrdpclientnonscriptable5-usemultimon.md"><strong>UseMultimon</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-439">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-439">Read/write</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-440">指定遠端桌面 ActiveX 控制項是否應該使用多個監視器。</span><span class="sxs-lookup"><span data-stu-id="e9f39-440">Specifies whether the Remote Desktop ActiveX control should use multiple monitors.</span></span><br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><span data-ttu-id="e9f39-441"><a href="imsrdppreferredredirectioninfo-useredirectionservername.md"><strong>UseRedirectionServerName</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-441"><a href="imsrdppreferredredirectioninfo-useredirectionservername.md"><strong>UseRedirectionServerName</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-442">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-442">Read/write</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-443">是否要使用重新導向伺服器名稱。</span><span class="sxs-lookup"><span data-stu-id="e9f39-443">Whether to use the redirection server name.</span></span><br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><span data-ttu-id="e9f39-444"><a href="imstscax-username.md"><strong>使用者</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-444"><a href="imstscax-username.md"><strong>UserName</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-445">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-445">Read/write</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-446">使用者名稱登入認證。</span><span class="sxs-lookup"><span data-stu-id="e9f39-446">The user name logon credential.</span></span><br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><span data-ttu-id="e9f39-447"><a href="imstscax-version.md"><strong>版本</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-447"><a href="imstscax-version.md"><strong>Version</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-448">唯讀</span><span class="sxs-lookup"><span data-stu-id="e9f39-448">Read-only</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-449">目前控制項的版本號碼。</span><span class="sxs-lookup"><span data-stu-id="e9f39-449">The version number of the current control.</span></span><br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><span data-ttu-id="e9f39-450"><a href="imstscax-verticalscrollbarvisible.md"><strong>VerticalScrollBarVisible</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-450"><a href="imstscax-verticalscrollbarvisible.md"><strong>VerticalScrollBarVisible</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-451">唯讀</span><span class="sxs-lookup"><span data-stu-id="e9f39-451">Read-only</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-452">指出控制項是否顯示垂直捲動條。</span><span class="sxs-lookup"><span data-stu-id="e9f39-452">Indicates whether the control displays a vertical scroll bar.</span></span><br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><span data-ttu-id="e9f39-453"><a href="imsrdpclientnonscriptable3-warnaboutclipboardredirection.md"><strong>WarnAboutClipboardRedirection</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-453"><a href="imsrdpclientnonscriptable3-warnaboutclipboardredirection.md"><strong>WarnAboutClipboardRedirection</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-454">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-454">Read/write</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-455">指定在啟動會話之前，安全性警告對話方塊是否應包含關於剪貼簿重新導向的警告。</span><span class="sxs-lookup"><span data-stu-id="e9f39-455">Specifies whether the security warning dialog box should include a warning about clipboard redirection before starting a session.</span></span><br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><span data-ttu-id="e9f39-456"><a href="imsrdpclientnonscriptable5-warnaboutdirectxredirection.md"><strong>WarnAboutDirectXRedirection</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-456"><a href="imsrdpclientnonscriptable5-warnaboutdirectxredirection.md"><strong>WarnAboutDirectXRedirection</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-457">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-457">Read/write</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-458">不會使用此屬性。</span><span class="sxs-lookup"><span data-stu-id="e9f39-458">This property is not used.</span></span><br/></td>
</tr>
<tr class="odd">
<td style="text-align: left;"><span data-ttu-id="e9f39-459"><a href="imsrdpclientnonscriptable4-warnaboutprinterredirection.md"><strong>WarnAboutPrinterRedirection</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-459"><a href="imsrdpclientnonscriptable4-warnaboutprinterredirection.md"><strong>WarnAboutPrinterRedirection</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-460">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-460">Read/write</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-461">指定在啟動會話之前，重新導向對話方塊是否顯示印表機重新導向的相關訊息。</span><span class="sxs-lookup"><span data-stu-id="e9f39-461">Specifies whether the redirection dialog box displays a message about printer redirection before starting a session.</span></span><br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><span data-ttu-id="e9f39-462"><a href="imsrdpclientnonscriptable3-warnaboutsendingcredentials.md"><strong>WarnAboutSendingCredentials</strong></a></span><span class="sxs-lookup"><span data-stu-id="e9f39-462"><a href="imsrdpclientnonscriptable3-warnaboutsendingcredentials.md"><strong>WarnAboutSendingCredentials</strong></a></span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-463">讀取/寫入</span><span class="sxs-lookup"><span data-stu-id="e9f39-463">Read/write</span></span><br/></td>
<td style="text-align: left;"><span data-ttu-id="e9f39-464">指定在啟動會話之前，安全性警告是否應包含有關將認證傳送至遠端伺服器的警告。</span><span class="sxs-lookup"><span data-stu-id="e9f39-464">Specifies whether the security warning should include a warning about sending credentials to the remote server before starting a session.</span></span><br/></td>
</tr>
</tbody>
</table>
...
## <a name="requirements"></a><span data-ttu-id="e9f39-465">規格需求</span><span class="sxs-lookup"><span data-stu-id="e9f39-465">Requirements</span></span>



| <span data-ttu-id="e9f39-466">需求</span><span class="sxs-lookup"><span data-stu-id="e9f39-466">Requirement</span></span> | <span data-ttu-id="e9f39-467">值</span><span class="sxs-lookup"><span data-stu-id="e9f39-467">Value</span></span> |
|-------------------------------------|----------------------------------------------------------------------------------------|
| <span data-ttu-id="e9f39-468">最低支援的用戶端</span><span class="sxs-lookup"><span data-stu-id="e9f39-468">Minimum supported client</span></span><br/> | <span data-ttu-id="e9f39-469">Windows 8.1</span><span class="sxs-lookup"><span data-stu-id="e9f39-469">Windows 8.1</span></span><br/>                                                                 |
| <span data-ttu-id="e9f39-470">最低支援的伺服器</span><span class="sxs-lookup"><span data-stu-id="e9f39-470">Minimum supported server</span></span><br/> | <span data-ttu-id="e9f39-471">Windows Server 2012 R2</span><span class="sxs-lookup"><span data-stu-id="e9f39-471">Windows Server 2012 R2</span></span><br/>                                                      |
| <span data-ttu-id="e9f39-472">類型程式庫</span><span class="sxs-lookup"><span data-stu-id="e9f39-472">Type library</span></span><br/>             | <dl> <span data-ttu-id="e9f39-473"><dt>MsTscAx.dll</dt></span><span class="sxs-lookup"><span data-stu-id="e9f39-473"><dt>MsTscAx.dll</dt></span></span> </dl> |
| <span data-ttu-id="e9f39-474">DLL</span><span class="sxs-lookup"><span data-stu-id="e9f39-474">DLL</span></span><br/>                      | <dl> <span data-ttu-id="e9f39-475"><dt>MsTscAx.dll</dt></span><span class="sxs-lookup"><span data-stu-id="e9f39-475"><dt>MsTscAx.dll</dt></span></span> </dl> |
| <span data-ttu-id="e9f39-476">CLSID</span><span class="sxs-lookup"><span data-stu-id="e9f39-476">CLSID</span></span><br/>                    | <span data-ttu-id="e9f39-477">CLSID \_ MsRdpClient9 定義為301B94BA-5D25-4A12-BFFE-3B6E7A616585</span><span class="sxs-lookup"><span data-stu-id="e9f39-477">CLSID\_MsRdpClient9 is defined as 301B94BA-5D25-4A12-BFFE-3B6E7A616585</span></span><br/>      |



## <a name="see-also"></a><span data-ttu-id="e9f39-478">另請參閱</span><span class="sxs-lookup"><span data-stu-id="e9f39-478">See also</span></span>

<dl> <dt>

[<span data-ttu-id="e9f39-479">遠端桌面 ActiveX 控制項類別</span><span class="sxs-lookup"><span data-stu-id="e9f39-479">Remote Desktop ActiveX control classes</span></span>](remote-desktop-activex-control-classes.md)
</dt> </dl>
