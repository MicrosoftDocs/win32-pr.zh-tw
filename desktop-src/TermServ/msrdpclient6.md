---
title: MsRdpClient6 類別
description: Microsoft RDP 用戶端控制 (可轉散發套件) -第7版。
ms.assetid: 1E8F5EBE-AF25-481D-8F41-13AAAF9B4A34
ms.tgt_platform: multiple
keywords:
- MsRdpClient6 類別遠端桌面服務
- MsRdpClient6 類別遠端桌面服務，說明
topic_type:
- apiref
api_name:
- MsRdpClient6
...
ms.locfileid: "104464789"
---
# <a name="msrdpclient6-class"></a>MsRdpClient6 類別

Microsoft RDP 用戶端控制 (可轉散發套件) -第7版
...
| CLSID<br/>                    | CLSID \_ MsRdpClient6 定義為7390F3D8-0439-4C05-91E3-CF5CB290C3D0<br/>      |
