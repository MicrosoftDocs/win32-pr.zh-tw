...
ms.locfileid: "118131040"
---
# <a name="deleteallservers-method-of-the-win32_tsgatewayloadbalancer-class"></a>Win32 TSGatewayLoadBalancer 類別的 DeleteAllServers 方法 \_

刪除參與負載平衡伺服器陣列的所有遠端桌面閘道 (RD 閘道) 負載平衡伺服器。
