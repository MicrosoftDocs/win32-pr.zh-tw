---
title: MsRdpClient3NotSafeForScripting 類別
description: Microsoft RDP 用戶端控制-第4版。
ms.assetid: F8123627-3561-45F6-81AD-41D1147E449D
ms.tgt_platform: multiple
keywords:
- MsRdpClient3NotSafeForScripting 類別遠端桌面服務
- MsRdpClient3NotSafeForScripting 類別遠端桌面服務，說明
topic_type:
- apiref
api_name:
...
ms.locfileid: "106967566"
---
# <a name="msrdpclient3notsafeforscripting-class"></a>MsRdpClient3NotSafeForScripting 類別

Microsoft RDP 用戶端控制-第4版
...
**MsRdpClient3NotSafeForScripting** 類別有這些方法。
...
**MsRdpClient3NotSafeForScripting** 類別具有這些屬性。
...
| CLSID<br/>                    | CLSID \_ MsRdpClient3NotSafeForScripting 定義為 ACE575FD-1FCF-4074-9401-EBAB990FA9DE<br/> |
