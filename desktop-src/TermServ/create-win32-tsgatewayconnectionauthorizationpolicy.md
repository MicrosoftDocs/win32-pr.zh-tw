...
ms.locfileid: "119871858"
---
# <a name="create-method-of-the-win32_tsgatewayconnectionauthorizationpolicy-class"></a>Win32 TSGatewayConnectionAuthorizationPolicy 類別的 Create 方法 \_

使用指定的值， (RD CAP) 建立遠端桌面連線授權原則。 新的 RD CAP 將會插入 RD CAP 評估順序的頂端，而 **order** 屬性值為 "1"。
