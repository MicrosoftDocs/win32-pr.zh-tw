...
ms.locfileid: "118603899"
---
# <a name="win32_terminalservicetosetting-class"></a>Win32 \_ TerminalServiceToSetting 類別

**Win32 \_ TerminalServiceToSetting** WMI 類別代表 [**win32 \_ TerminalService**](win32-terminalservice.md)類別的實例與特定 [**Win32 \_ TerminalServiceSetting**](win32-terminalservicesetting.md)屬性的設定之間的關聯。 設定包括遠端桌面工作階段主機 (RD 工作階段主機) 伺服器模式、授權、Active Desktop、許可權功能、刪除暫存資料夾和暫存資料夾（每個會話）。
...
**Win32 \_ TerminalServiceToSetting** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ TerminalServiceToSetting** 類別具有這些屬性。
...
表示可以使用 **設定** 屬性設定的 [**Win32 \_ TerminalService**](win32-terminalservice.md)實例。
...
資料類型： **Win32 \_ TerminalServiceSetting**
</dt> <dt>
...
表示可以套用至相關聯 RD 工作階段主機伺服器的遠端桌面服務設定。
