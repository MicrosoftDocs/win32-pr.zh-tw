---
title: MsRdpClient7 類別
description: Microsoft RDP 用戶端控制 (可轉散發套件) -第8版。
ms.assetid: DC401CD5-7C54-43C9-937E-17D3367472AB
ms.tgt_platform: multiple
keywords:
- MsRdpClient7 類別遠端桌面服務
- MsRdpClient7 類別遠端桌面服務，說明
topic_type:
- apiref
api_name:
- MsRdpClient7
...
ms.locfileid: "106965073"
---
# <a name="msrdpclient7-class"></a>MsRdpClient7 類別

Microsoft RDP 用戶端控制 (可轉散發套件) -第8版
...
| CLSID<br/>                    | CLSID \_ MsRdpClient7 定義為 A9D7038D-B5ED-472E-9C47-94BEA90A5910<br/>      |
