...
---
# <a name="mstscaxnotsafeforscripting-class"></a>MsTscAxNotSafeForScripting 類別

Microsoft 終端機服務用戶端控制-第1版
...
**MsTscAxNotSafeForScripting** 具有下列類型的成員：
...
**MsTscAxNotSafeForScripting** 類別有這些方法。
...
**MsTscAxNotSafeForScripting** 類別具有這些屬性。
...
| CLSID<br/>                    | CLSID \_ MsTscAxNotSafeForScripting 定義為 A41A4187-5A86-4E26-B40A-856F9035D9CB<br/> |
