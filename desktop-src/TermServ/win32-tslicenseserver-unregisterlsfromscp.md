...
---
# <a name="unregisterlsfromscp-method-of-the-win32_tslicenseserver-class"></a>Win32 TSLicenseServer 類別的 UnRegisterLSFromSCP 方法 \_

將遠端桌面授權伺服器移除為 Active Directory Domain Services 中的服務連接點。
