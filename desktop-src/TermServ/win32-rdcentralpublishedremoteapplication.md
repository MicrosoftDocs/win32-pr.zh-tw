...
---
# <a name="win32_rdcentralpublishedremoteapplication-class"></a>Win32 \_ RDCentralPublishedRemoteApplication 類別
...
**Win32 \_ RDCentralPublishedRemoteApplication** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ RDCentralPublishedRemoteApplication** 類別具有這些屬性。
...
控制應用程式存取的安全描述項（SDDL 格式）。 空字串表示允許所有存取。
