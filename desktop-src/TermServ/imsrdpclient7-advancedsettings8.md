...
ms.locfileid: "120099448"
---
# <a name="imsrdpclient7advancedsettings8-property"></a>IMsRdpClient7：： AdvancedSettings8 屬性

抓取支援 [**IMsRdpClientAdvancedSettings7**](imsrdpclientadvancedsettings7.md) 介面的物件。
...
接收物件之 [**IMsRdpClientAdvancedSettings7**](imsrdpclientadvancedsettings7.md) 介面指標的位址。
