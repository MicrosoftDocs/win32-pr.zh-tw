...
---
# <a name="setcookieauthenticationallowed-method-of-the-win32_tsgatewayconnectionauthorizationpolicy-class"></a>Win32 TSGatewayConnectionAuthorizationPolicy 類別的 SetCookieAuthenticationAllowed 方法 \_

設定 **CookieAuthenticationAllowed** 屬性。
