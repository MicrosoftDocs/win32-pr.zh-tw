...
---
# <a name="msrdpclient8-class"></a>MsRdpClient8 類別

Microsoft RDP 用戶端控制 (可轉散發套件) -第9版
...
| CLSID<br/>                    | CLSID \_ MsRdpClient8 定義為5F681803-2900-4C43-A1CC-CF405404A676<br/>      |
