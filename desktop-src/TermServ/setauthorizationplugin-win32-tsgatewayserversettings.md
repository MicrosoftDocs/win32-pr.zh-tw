...
---
# <a name="setauthorizationplugin-method-of-the-win32_tsgatewayserversettings-class"></a>Win32 TSGatewayServerSettings 類別的 SetAuthorizationPlugin 方法 \_

針對遠端桌面閘道 (RD 閘道) 伺服器設定目前的授權外掛程式。
...
您必須呼叫 [**RecycleRpcApplicationPools**](recyclerpcapplicationpools-win32-tsgatewayserversettings.md) 方法，才能讓授權外掛程式運作。
