...
ms.locfileid: "118605283"
---
# <a name="remoteapp-and-desktop-connection-runtime-interfaces"></a>RemoteApp 和桌面連線執行時間介面

RemoteApp 和桌面連線執行時間 API 支援可讓您在 RemoteApp 和桌面連線中開發自訂用戶端的介面。
...
公開方法，以提供 RemoteApp 和桌面連線中連接的相關資訊。
...
公開可在 RemoteApp 和桌面連線中提供連接相關資訊的其他方法。
...
公開方法，以提供 RemoteApp 和桌面連線中連接的相關資訊，並新增取得或設定宣告權杖的能力。
...
公開方法，以允許執行時間中斷 RemoteApp 和桌面連線中的自訂用戶端連線。
...
公開在 RemoteApp 和桌面連線中加入和移除自訂用戶端參考的方法。
...
公開允許外掛程式在 RemoteApp 和桌面連線執行時間中管理協力廠商副檔名的方法。
