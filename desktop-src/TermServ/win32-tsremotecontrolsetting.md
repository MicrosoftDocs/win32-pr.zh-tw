...
ms.locfileid: "119137621"
---
# <a name="win32_tsremotecontrolsetting-class"></a>Win32 \_ TSRemoteControlSetting 類別

**Win32 \_ TSRemoteControlSetting** WMI 類別會定義 [**win32 \_ 終端**](win32-terminal.md)機類別的遠端控制設定。
...
**Win32 \_ TSRemoteControlSetting** 類別具有下列類型的成員：
...
**Win32 \_ TSRemoteControlSetting** 類別具有這些方法。



| 方法                                                              | 描述                                                    |
|:--------------------------------------------------------------------|:---------------------------------------------------------------|
| [**RemoteControl**](win32-tsremotecontrolsetting-remotecontrol.md) | 設定這個類別的 **LevelOfControl** 屬性。<br/> |
...
**Win32 \_ TSRemoteControlSetting** 類別具有這些屬性。
...
會話的控制層級，指定會話是否只會由遠端使用者查看，或透過鍵盤和滑鼠來查看及控制。 如需詳細資訊，請參閱 [**RemoteControl**](win32-tsremotecontrolsetting-remotecontrol.md) 方法的備註一節。 支援下列值。
...
指出 **LevelOfControl** 屬性是由伺服器、群組原則或預設設定。
