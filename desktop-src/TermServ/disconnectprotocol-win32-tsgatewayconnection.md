...
---
# <a name="disconnectprotocol-method-of-the-win32_tsgatewayconnection-class"></a>Win32 TSGatewayConnection 類別的 DisconnectProtocol 方法 \_

將指定之通訊協定的所有連接從遠端桌面閘道的 (RD 閘道) 伺服器中斷連線。
...
特定連接的通訊協定名稱。 這可以從 **Win32 \_ TSGatewayConnection** 類別的 **ProtocolName** 屬性抓取。
