---
title: MsRdpClient5NotSafeForScripting 類別
description: Microsoft RDP 用戶端控制-第6版。
ms.assetid: 0DC46910-D77E-47CF-92C3-4019D79C783C
ms.tgt_platform: multiple
keywords:
- MsRdpClient5NotSafeForScripting 類別遠端桌面服務
- MsRdpClient5NotSafeForScripting 類別遠端桌面服務，說明
topic_type:
- apiref
api_name:
...
ms.locfileid: "104024816"
---
# <a name="msrdpclient5notsafeforscripting-class"></a>MsRdpClient5NotSafeForScripting 類別

Microsoft RDP 用戶端控制-第6版
...
**MsRdpClient5NotSafeForScripting** 類別有這些方法。
...
**MsRdpClient5NotSafeForScripting** 類別具有這些屬性。
...
| CLSID<br/>                    | CLSID \_ MsRdpClient5NotSafeForScripting 定義為4EB2F086-C818-447E-B32C-C51CE2B30D31<br/> |
