...
ms.locfileid: "119869258"
---
# <a name="tlskeypackenumnext-function"></a>TLSKeyPackEnumNext 函式
...
[**LSKeyPack**](lskeypack.md)結構的指標，此結構會接收符合搜尋準則的下一個金鑰套件。
...
呼叫順序無效。 必須先呼叫 [**TLSKeyPackEnumBegin ()**](tlskeypackenumbegin.md) 函式，才能進行此工作。
