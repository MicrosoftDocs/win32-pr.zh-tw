...
ms.locfileid: "118126528"
---
# <a name="win32_tsgeticon-class"></a>Win32 \_ TSGetIcon 類別
...
**Win32 \_ TSGetIcon** 類別具有這些方法。



| 方法                                     | 描述                                            |
|:-------------------------------------------|:-------------------------------------------------------|
| [**GetIcon**](geticon-win32-tsgeticon.md) | 傳回指定之圖示的內容。<br/> |
