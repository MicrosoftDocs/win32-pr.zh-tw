...
---
# <a name="imsrdpclient6transportsettings2-property"></a>IMsRdpClient6：： TransportSettings2 屬性

捕獲 [**IMsRdpClientTransportSettings2**](imsrdpclienttransportsettings2.md) 介面。
...
[**IMsRdpClientTransportSettings2**](imsrdpclienttransportsettings2.md)介面指標。
