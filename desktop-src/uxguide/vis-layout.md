...
-   <span data-ttu-id="433de-141">**一致性。**</span><span class="sxs-lookup"><span data-stu-id="433de-141">**Consistency.**</span></span> <span data-ttu-id="433de-142">類似的視窗或頁面使用類似的版面配置，因此使用者一律會感覺導向。</span><span class="sxs-lookup"><span data-stu-id="433de-142">Similar windows or pages use a similar layout, so users always feel oriented.</span></span>
...
-   <span data-ttu-id="433de-183">一旦使用者決定要做什麼之後，他們會立即停止掃描並進行。</span><span class="sxs-lookup"><span data-stu-id="433de-183">Once users have decided what to do, they immediately stop scanning and do it.</span></span>
...
-   <span data-ttu-id="433de-208">避免將重要的資訊放在左下角或長滾動控制項或頁面的底部。</span><span class="sxs-lookup"><span data-stu-id="433de-208">Avoid putting crucial information in the lower-left corner or at the bottom of a long scrollable control or page.</span></span>
...
-   <span data-ttu-id="433de-232">在深色背景上使用淺文字。</span><span class="sxs-lookup"><span data-stu-id="433de-232">Use light text on a dark background.</span></span> <span data-ttu-id="433de-233">暗灰色或藍色背景上的白色文字效果很好。</span><span class="sxs-lookup"><span data-stu-id="433de-233">White text on a dark gray or blue background works well.</span></span>
...
<span data-ttu-id="433de-252">您知道在下列情況中，配置會有效地使用螢幕空間：</span><span class="sxs-lookup"><span data-stu-id="433de-252">You know a layout is using screen space effectively when:</span></span>
...
### <a name="spacing"></a><span data-ttu-id="433de-273">間距</span><span class="sxs-lookup"><span data-stu-id="433de-273">Spacing</span></span>
...
![<span data-ttu-id="433de-293">調整控制項取得捲軸大小的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-293">screen shot of resized control getting scroll bar</span></span> ](images/vis-layout-image12.png)
...
### <a name="focus"></a><span data-ttu-id="433de-313">焦點</span><span class="sxs-lookup"><span data-stu-id="433de-313">Focus</span></span>
...
![<span data-ttu-id="433de-333">具有實用文字的 [搜尋] 對話方塊螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-333">screen shot of search dialog box with helpful text</span></span> ](images/vis-layout-image17.png)
...
-   <span data-ttu-id="433de-352">UI 元素的位置會反映使用者執行工作所需的步驟。</span><span class="sxs-lookup"><span data-stu-id="433de-352">The placement of the UI elements mirrors the steps users need to perform the task.</span></span>
...
<span data-ttu-id="433de-372">您可以利用下列方式來顯示群組 (增加 heaviness) ：</span><span class="sxs-lookup"><span data-stu-id="433de-372">You can show grouping in the following ways (in increasing heaviness):</span></span>
...
-   <span data-ttu-id="433de-391">**背景。**</span><span class="sxs-lookup"><span data-stu-id="433de-391">**Backgrounds.**</span></span> <span data-ttu-id="433de-392">您可以使用背景來強調或反強調不同類型的內容。</span><span class="sxs-lookup"><span data-stu-id="433de-392">You can use backgrounds to emphasize or de-emphasize different types of content.</span></span>
    ...
    ![<span data-ttu-id="433de-393">[控制台] 左側的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-393">screen shot of left side of control panel</span></span> ](images/vis-layout-image26.png)
...
-   <span data-ttu-id="433de-410">**簡化水準掃描。**</span><span class="sxs-lookup"><span data-stu-id="433de-410">**Ease in horizontal scanning.**</span></span> <span data-ttu-id="433de-411">使用者可以水準讀取並尋找彼此旁的相關專案，而不會有任何麻煩的間隙。</span><span class="sxs-lookup"><span data-stu-id="433de-411">Users can read horizontally and find related items next to each other, without any awkward gaps.</span></span>
...
<span data-ttu-id="433de-429">不要將視窗內容置中填滿空間。</span><span class="sxs-lookup"><span data-stu-id="433de-429">Don't center window content just to fill space.</span></span>
...
<span data-ttu-id="433de-448">一般對齊規則適用于控制項標籤，但這是值得特別注意的一般問題。</span><span class="sxs-lookup"><span data-stu-id="433de-448">The general alignment rules apply to control labels, but it is a common problem worthy of specific attention.</span></span> <span data-ttu-id="433de-449">標籤對齊具有下列目標：</span><span class="sxs-lookup"><span data-stu-id="433de-449">Label alignment has these goals:</span></span>
...
-   <span data-ttu-id="433de-473">有足夠的垂直空間可容納標籤。</span><span class="sxs-lookup"><span data-stu-id="433de-473">There is sufficient vertical space to accommodate the labels.</span></span>
...
<span data-ttu-id="433de-490">這種樣式可讓您輕鬆地垂直掃描標籤，以及水準掃描標籤和控制項，而且非常節省空間。但是更難垂直掃描控制項。</span><span class="sxs-lookup"><span data-stu-id="433de-490">This style makes it easy to scan the labels vertically and the labels and controls horizontally, and is very space efficient; but it is harder to scan the controls vertically.</span></span> <span data-ttu-id="433de-491">控制項會靠右對齊，以充分利用可用的空間。</span><span class="sxs-lookup"><span data-stu-id="433de-491">The controls are right-justified to take full advantage of the available space.</span></span>

![<span data-ttu-id="433de-492">具有不完全控制項的兩個標籤資料行清單</span><span class="sxs-lookup"><span data-stu-id="433de-492">list of two columns of labels with ragged controls</span></span> ](images/vis-layout-image35.png)

<span data-ttu-id="433de-493">這種樣式是精簡且容易閱讀的，但很難垂直掃描控制項。</span><span class="sxs-lookup"><span data-stu-id="433de-493">This style is compact and easy to read, but it's hard to scan controls vertically.</span></span>

<span data-ttu-id="433de-494">最佳使用時機：</span><span class="sxs-lookup"><span data-stu-id="433de-494">Best used when:</span></span>

-   <span data-ttu-id="433de-495">UI 使用變數配置技術 (例如 Windows Presentation Foundation) 。</span><span class="sxs-lookup"><span data-stu-id="433de-495">The UI is using a variable layout technology (such as Windows Presentation Foundation).</span></span>
-   <span data-ttu-id="433de-496">使用者可能會垂直掃描以尋找特定標籤。</span><span class="sxs-lookup"><span data-stu-id="433de-496">Users are likely to scan vertically to find specific labels.</span></span>
-   <span data-ttu-id="433de-497">使用者很可能會以由左至右、由上到下的方式讀取標籤和控制項。</span><span class="sxs-lookup"><span data-stu-id="433de-497">Users are likely to read the labels and controls in a left-to-right, top-to-bottom manner.</span></span>
-   <span data-ttu-id="433de-498">使用者不太可能會以垂直方式掃描控制項。</span><span class="sxs-lookup"><span data-stu-id="433de-498">Users aren't likely to scan the controls vertically.</span></span>
-   <span data-ttu-id="433de-499">控制項文字的長度會有所不同，而且如果使用其他樣式，可能會被截斷。</span><span class="sxs-lookup"><span data-stu-id="433de-499">The control text varies in length and would likely be truncated if another style were used.</span></span>
-   <span data-ttu-id="433de-500">控制項是唯讀的，例如唯讀文字方塊。</span><span class="sxs-lookup"><span data-stu-id="433de-500">The controls are read-only, such as read only text boxes.</span></span> <span data-ttu-id="433de-501">針對其他控制項，此對齊方式看起來會草率。</span><span class="sxs-lookup"><span data-stu-id="433de-501">For other controls, this alignment will look sloppy.</span></span> <span data-ttu-id="433de-502">不過，按一下時，控制項可能會變成可編輯。</span><span class="sxs-lookup"><span data-stu-id="433de-502">However, the controls may become editable on click.</span></span>
-   <span data-ttu-id="433de-503">有許多資料行，但資料行中有少數控制項。</span><span class="sxs-lookup"><span data-stu-id="433de-503">There are many columns, but few controls in a column.</span></span>

<span data-ttu-id="433de-504">**控制項左邊的靠右對齊標籤**</span><span class="sxs-lookup"><span data-stu-id="433de-504">**Right-justified labels on left of controls**</span></span>

<span data-ttu-id="433de-505">這是水準讀取的最簡單方式，可將標籤與控制項建立關聯，但很難垂直掃描標籤，而且在 labelsList 具有縮排標籤和控制項的長度很大時，不會正常運作。</span><span class="sxs-lookup"><span data-stu-id="433de-505">This style is the easiest to read horizontally to associate the labels with their controls, but it is hard to scan the labels vertically and doesn't work well when labelsList with indented labels and controls differ greatly in length.</span></span>

![<span data-ttu-id="433de-506">具有縮排標籤和控制項的清單</span><span class="sxs-lookup"><span data-stu-id="433de-506">list with indented labels and controls</span></span> ](images/vis-layout-image36.png)

<span data-ttu-id="433de-507">這種樣式可讓您輕鬆地垂直掃描控制項，但很難垂直掃描標籤。</span><span class="sxs-lookup"><span data-stu-id="433de-507">This style permits easy vertical scanning of the controls, but makes it hard to scan the labels vertically.</span></span>

<span data-ttu-id="433de-508">最佳使用時機：</span><span class="sxs-lookup"><span data-stu-id="433de-508">Best used when:</span></span>

-   <span data-ttu-id="433de-509">使用者很可能會以由左至右、由上到下的方式讀取標籤和控制項。</span><span class="sxs-lookup"><span data-stu-id="433de-509">Users are likely to read the labels and controls in a left-to-right, top-to-bottom manner.</span></span>
-   <span data-ttu-id="433de-510">使用者可能無法垂直掃描以尋找特定標籤，可能是因為：</span><span class="sxs-lookup"><span data-stu-id="433de-510">Users aren't likely to scan vertically to find specific labels, possibly because:</span></span>
    -   <span data-ttu-id="433de-511">有幾個控制項。</span><span class="sxs-lookup"><span data-stu-id="433de-511">There are few controls.</span></span>
    -   <span data-ttu-id="433de-512">標籤很已知。</span><span class="sxs-lookup"><span data-stu-id="433de-512">The labels are well known.</span></span>
    -   <span data-ttu-id="433de-513">控制項大多很容易理解，而且很少空白 (可能會有預設值，以防止空白控制項) 。</span><span class="sxs-lookup"><span data-stu-id="433de-513">The controls are mostly self explanatory and are rarely blank (possibly having default values to prevent blank controls).</span></span>
-   <span data-ttu-id="433de-514">有足夠的水準空間可容納標籤。</span><span class="sxs-lookup"><span data-stu-id="433de-514">There is sufficient horizontal space to accommodate the labels.</span></span>
-   <span data-ttu-id="433de-515">標籤的長度不會有太大的差異。</span><span class="sxs-lookup"><span data-stu-id="433de-515">The labels don't vary significantly in length.</span></span>
-   <span data-ttu-id="433de-516">有許多資料行。</span><span class="sxs-lookup"><span data-stu-id="433de-516">There are many columns.</span></span> <span data-ttu-id="433de-517">標籤和控制項會以視覺化方式顯示為單一資料行。</span><span class="sxs-lookup"><span data-stu-id="433de-517">Visually the labels and controls appear as a single column.</span></span>

<span data-ttu-id="433de-518">不過，在採用上述任何一種樣式之前，請考慮兩個因素：</span><span class="sxs-lookup"><span data-stu-id="433de-518">Before adopting any of these styles, however, consider two more factors:</span></span>

-   <span data-ttu-id="433de-519">偏好可在整個程式中一致使用的樣式。</span><span class="sxs-lookup"><span data-stu-id="433de-519">Prefer a style that you can use consistently across your program.</span></span>
-   <span data-ttu-id="433de-520">靠左對齊的標籤會位於控制項左邊的控制項上方，是最常見的樣式，因此應該獲得喜好設定。</span><span class="sxs-lookup"><span data-stu-id="433de-520">Left-justified labels either above controls on left of controls are the most common styles, so they should be given preference.</span></span>

### <a name="balance"></a><span data-ttu-id="433de-521">餘額</span><span class="sxs-lookup"><span data-stu-id="433de-521">Balance</span></span>

<span data-ttu-id="433de-522">當視窗或頁面的內容平均分佈在其表面上時，就會有平衡。</span><span class="sxs-lookup"><span data-stu-id="433de-522">A window or page has balance when its content appears evenly distributed across its surface.</span></span> <span data-ttu-id="433de-523">如果介面實際具有與視覺效果相同的加權，則平衡的版面配置不會提示至一側。</span><span class="sxs-lookup"><span data-stu-id="433de-523">If the surface physically had the same weighting as it has visually, a balanced layout wouldn't tip over to one side.</span></span>

<span data-ttu-id="433de-524">最常見的餘額問題是視窗或頁面左側有太多內容。</span><span class="sxs-lookup"><span data-stu-id="433de-524">The most common balance problem is having too much content on the left side of a window or page.</span></span> <span data-ttu-id="433de-525">您可以透過下列方式建立餘額：</span><span class="sxs-lookup"><span data-stu-id="433de-525">You can create balance in the following ways:</span></span>

-   <span data-ttu-id="433de-526">在左側使用較大的邊界，而不是右邊。</span><span class="sxs-lookup"><span data-stu-id="433de-526">Using larger margins on the left side than the right.</span></span>
-   <span data-ttu-id="433de-527">放置用來完成右邊工作的 UI 元素。</span><span class="sxs-lookup"><span data-stu-id="433de-527">Placing UI elements used to complete a task on the right.</span></span>
-   <span data-ttu-id="433de-528">將在整個工作中使用的 UI 元素放在中央。</span><span class="sxs-lookup"><span data-stu-id="433de-528">Placing UI elements used throughout the task in the center.</span></span>
-   <span data-ttu-id="433de-529">延長可調整大小或多行控制項。</span><span class="sxs-lookup"><span data-stu-id="433de-529">Lengthening resizable or multi-line controls.</span></span>
-   <span data-ttu-id="433de-530">策略性地使用中央對齊。</span><span class="sxs-lookup"><span data-stu-id="433de-530">Using center-alignment strategically.</span></span>

![<span data-ttu-id="433de-531">左邊的印表機和右邊的文字螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-531">screen shot of printer on left and text on right</span></span> ](images/vis-layout-image37.png)

<span data-ttu-id="433de-532">這種平衡式的 wizard 頁面版面配置會顯示較大的左邊界，以提升餘額。</span><span class="sxs-lookup"><span data-stu-id="433de-532">This well balanced wizard page layout shows a larger left margin than right to improve balance.</span></span>

<span data-ttu-id="433de-533">如果這些技術沒有達到平衡，請考慮減少視窗或頁面的寬度，使其更符合其內容。</span><span class="sxs-lookup"><span data-stu-id="433de-533">If these techniques don't achieve balance, consider reducing the width of the window or page to better match its content.</span></span>

<span data-ttu-id="433de-534">針對可調整大小的表面，請勿將內容置中以達到平衡。</span><span class="sxs-lookup"><span data-stu-id="433de-534">For resizable surfaces, don't center content just to achieve balance.</span></span> <span data-ttu-id="433de-535">相反地，請維持固定的左上原點、定義最大介面區，以及在使用的空間內平衡內容。</span><span class="sxs-lookup"><span data-stu-id="433de-535">Rather, maintain a fixed upper left origin, define a maximum surface area, and balance the content within the space used.</span></span>

### <a name="grids"></a><span data-ttu-id="433de-536">方格</span><span class="sxs-lookup"><span data-stu-id="433de-536">Grids</span></span>

<span data-ttu-id="433de-537">方格是不可見的基礎對齊系統。</span><span class="sxs-lookup"><span data-stu-id="433de-537">A grid is an invisible underlying alignment system.</span></span> <span data-ttu-id="433de-538">網格可以進行對稱，但非對稱式方格也可以運作。</span><span class="sxs-lookup"><span data-stu-id="433de-538">Grids can be symmetrical, but asymmetric grids work just as well.</span></span> <span data-ttu-id="433de-539">由單一視窗或頁面使用時，方格可協助組織介面內的內容。</span><span class="sxs-lookup"><span data-stu-id="433de-539">When used by a single window or page, grids help organize content within a surface.</span></span> <span data-ttu-id="433de-540">重複使用時，方格會跨表面建立一致的版面配置。</span><span class="sxs-lookup"><span data-stu-id="433de-540">When reused, grids create consistent layout across surfaces.</span></span>

<span data-ttu-id="433de-541">格線數目會影響視覺複雜度的認知。</span><span class="sxs-lookup"><span data-stu-id="433de-541">The number of grid lines affect the perception of visual complexity.</span></span> <span data-ttu-id="433de-542">格線較少的版面配置會比具有更多格線的版面配置更簡單。</span><span class="sxs-lookup"><span data-stu-id="433de-542">A layout with fewer grid lines appears simpler than a layout with more grid lines.</span></span>

<span data-ttu-id="433de-543">**視覺效果複雜：**</span><span class="sxs-lookup"><span data-stu-id="433de-543">**Visually complex:**</span></span>

![<span data-ttu-id="433de-544">雜亂對話方塊的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-544">screen shot of cluttered dialog box</span></span> ](images/vis-layout-image38.png)

<span data-ttu-id="433de-545">**以視覺化方式簡單：**</span><span class="sxs-lookup"><span data-stu-id="433de-545">**Visually simple:**</span></span>

![<span data-ttu-id="433de-546">[組織] 對話方塊的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-546">screen shot of organized dialog box</span></span> ](images/vis-layout-image39.png)

<span data-ttu-id="433de-547">不必要的格線會造成視覺效果複雜度。</span><span class="sxs-lookup"><span data-stu-id="433de-547">Unnecessary grid lines create visual complexity.</span></span>

<span data-ttu-id="433de-548">您知道在下列情況中，版面配置會有效地使用方格：</span><span class="sxs-lookup"><span data-stu-id="433de-548">You know a layout is using grids effectively when:</span></span>

-   <span data-ttu-id="433de-549">具有類似內容或功能的 Windows 或頁面具有類似的版面配置。</span><span class="sxs-lookup"><span data-stu-id="433de-549">Windows or pages with similar content or function have similar layout.</span></span>
-   <span data-ttu-id="433de-550">重複的設計項目會出現在視窗和頁面的類似位置中。</span><span class="sxs-lookup"><span data-stu-id="433de-550">Repeated design elements appear in similar locations across windows and pages.</span></span>
-   <span data-ttu-id="433de-551">沒有不必要的垂直和水準對齊格線。</span><span class="sxs-lookup"><span data-stu-id="433de-551">There are no unnecessary vertical and horizontal alignment grid lines.</span></span>

### <a name="visual-simplicity"></a><span data-ttu-id="433de-552">視覺效果簡化</span><span class="sxs-lookup"><span data-stu-id="433de-552">Visual simplicity</span></span>

<span data-ttu-id="433de-553">視覺效果簡單明瞭的是，版面配置比所需更複雜。</span><span class="sxs-lookup"><span data-stu-id="433de-553">Visual simplicity is the perception that a layout is not more complicated than it needs to be.</span></span>

<span data-ttu-id="433de-554">當版面配置：</span><span class="sxs-lookup"><span data-stu-id="433de-554">You know a layout has visual simplicity when it:</span></span>

-   <span data-ttu-id="433de-555">消除不必要的視窗 chrome 層。</span><span class="sxs-lookup"><span data-stu-id="433de-555">Eliminates unnecessary layers of window chrome.</span></span>
-   <span data-ttu-id="433de-556">使用最多七個容易識別的群組來呈現內容。</span><span class="sxs-lookup"><span data-stu-id="433de-556">Presents the content using at most seven easily identifiable groups.</span></span>
-   <span data-ttu-id="433de-557">使用輕量群組，例如版面配置和分隔符號，而不是群組方塊。</span><span class="sxs-lookup"><span data-stu-id="433de-557">Uses lightweight grouping, such as layout and separators instead of group boxes.</span></span>
-   <span data-ttu-id="433de-558">使用輕量控制項，例如次要命令的連結而非命令按鈕，以及下拉式清單，而不是選項的清單。</span><span class="sxs-lookup"><span data-stu-id="433de-558">Uses lightweight controls, such as links instead of command buttons for secondary commands, and drop-down lists instead of lists for choices.</span></span>
-   <span data-ttu-id="433de-559">減少垂直和水準對齊格線的數目。</span><span class="sxs-lookup"><span data-stu-id="433de-559">Reduces the number of vertical and horizontal alignment grid lines.</span></span>
-   <span data-ttu-id="433de-560">例如，在表面上只使用一或兩個命令按鈕寬度，以減少控制項大小的數目。</span><span class="sxs-lookup"><span data-stu-id="433de-560">Reduces the number of control sizes, by, for example, using only one or two command button widths on a surface.</span></span>
-   <span data-ttu-id="433de-561">在需要時，會使用漸進式洩漏來隱藏 UI 元素。</span><span class="sxs-lookup"><span data-stu-id="433de-561">Uses progressive disclosure to hide UI elements until they are needed.</span></span>
-   <span data-ttu-id="433de-562">使用足夠的空間，讓視窗或頁面不會覺得 cramped。</span><span class="sxs-lookup"><span data-stu-id="433de-562">Uses sufficient space so that the window or page doesn't feel cramped.</span></span>
-   <span data-ttu-id="433de-563">適當地調整視窗和控制項的大小，以消除不必要的滾動。</span><span class="sxs-lookup"><span data-stu-id="433de-563">Sizes windows and controls appropriately to eliminate unnecessary scrolling.</span></span>
-   <span data-ttu-id="433de-564">使用具有少量大小和文字色彩的單一字型。</span><span class="sxs-lookup"><span data-stu-id="433de-564">Uses a single font with a small number of sizes and text colors.</span></span>

<span data-ttu-id="433de-565">一般而言，如果可以消除版面配置元素而不會損害 UI 的效果，則可能會是。</span><span class="sxs-lookup"><span data-stu-id="433de-565">As a general rule, if a layout element can be eliminated without harming the effectiveness of the UI, it probably should be.</span></span>

## <a name="guidelines"></a><span data-ttu-id="433de-566">指導方針</span><span class="sxs-lookup"><span data-stu-id="433de-566">Guidelines</span></span>

### <a name="screen-resolution-and-dpi"></a><span data-ttu-id="433de-567">螢幕解析度和 DPI</span><span class="sxs-lookup"><span data-stu-id="433de-567">Screen resolution and dpi</span></span>

-   <span data-ttu-id="433de-568">**支援最小的 Windows 有效解析度（800x600 圖元）。**</span><span class="sxs-lookup"><span data-stu-id="433de-568">**Support the minimum Windows effective resolution of 800x600 pixels.**</span></span> <span data-ttu-id="433de-569">對於必須在安全模式下運作的重要 Ui，支援有效的640x480 圖元解析度。</span><span class="sxs-lookup"><span data-stu-id="433de-569">For critical UIs that must work in safe mode, support an effective resolution of 640x480 pixels.</span></span> <span data-ttu-id="433de-570">請務必考慮工作列所使用的空間，其方式是針對顯示在工作列上的 windows 保留48垂直 [相對圖元](glossary.md) 。</span><span class="sxs-lookup"><span data-stu-id="433de-570">Be sure to account for the space used by the taskbar by reserving 48 vertical [relative pixels](glossary.md) for windows displayed with the taskbar.</span></span>
-   <span data-ttu-id="433de-571">**優化可調整大小的視窗版面配置，以有效解決1024圖元。**</span><span class="sxs-lookup"><span data-stu-id="433de-571">**Optimize resizable window layouts for an effective resolution of 1024x768 pixels.**</span></span> <span data-ttu-id="433de-572">以仍可正常運作的方式，自動調整這些視窗的大小以取得較低的螢幕解析度。</span><span class="sxs-lookup"><span data-stu-id="433de-572">Automatically resize these windows for lower screen resolutions in a way that is still functional.</span></span>
-   <span data-ttu-id="433de-573">**請務必以每英寸96點測試您的 windows (DPI)  (為800x600 圖元) 、120 DPI (1024x768 圖元) ，以及 144 DPI (1200x900 圖元) 模式。**</span><span class="sxs-lookup"><span data-stu-id="433de-573">**Be sure to test your windows in 96 dots per inch (dpi) (at 800x600 pixels), 120 dpi (at 1024x768 pixels), and 144 dpi (at 1200x900 pixels) modes.**</span></span> <span data-ttu-id="433de-574">檢查是否有版面配置問題，例如剪輯控制項、文字和視窗的裁剪，以及縮放圖示和點陣圖。</span><span class="sxs-lookup"><span data-stu-id="433de-574">Check for layout problems, such as clipping of controls, text, and windows, and stretching of icons and bitmaps.</span></span>
-   <span data-ttu-id="433de-575">**針對具有觸控和行動使用案例的程式，請針對 120 DPI 進行優化。**</span><span class="sxs-lookup"><span data-stu-id="433de-575">**For programs with touch and mobile use scenarios, optimize for 120 dpi.**</span></span> <span data-ttu-id="433de-576">高 DPI 螢幕目前在觸控和行動電腦上很普遍。</span><span class="sxs-lookup"><span data-stu-id="433de-576">High-dpi screens are currently prevalent on touch and mobile PCs.</span></span>

### <a name="window-size"></a><span data-ttu-id="433de-577">視窗大小</span><span class="sxs-lookup"><span data-stu-id="433de-577">Window size</span></span>

-   <span data-ttu-id="433de-578">**選擇適合其內容的預設視窗大小。**</span><span class="sxs-lookup"><span data-stu-id="433de-578">**Choose a default window size appropriate for its contents.**</span></span> <span data-ttu-id="433de-579">如果您可以有效地使用空間，請不要害怕使用較大的初始視窗大小。</span><span class="sxs-lookup"><span data-stu-id="433de-579">Don't be afraid to use larger initial window sizes if you can use the space effectively.</span></span>
-   <span data-ttu-id="433de-580">**使用對稱的高度與寬度的外觀比例。**</span><span class="sxs-lookup"><span data-stu-id="433de-580">**Use a balanced height to width aspect ratio.**</span></span> <span data-ttu-id="433de-581">建議您最好使用3:5 和5:3 之間的外觀比例，雖然 (的外觀1:3 比例可以用於訊息對話方塊例如) 錯誤和警告。</span><span class="sxs-lookup"><span data-stu-id="433de-581">An aspect ratio between 3:5 and 5:3 is preferred, although an aspect ratio of 1:3 can be used for message dialog boxes (such as errors and warnings).</span></span>
-   <span data-ttu-id="433de-582">**請盡可能使用可調整大小的視窗，以避免捲軸和截斷的資料。**</span><span class="sxs-lookup"><span data-stu-id="433de-582">**Use resizable windows whenever practical to avoid scroll bars and truncated data.**</span></span> <span data-ttu-id="433de-583">具有動態內容、檔、影像、清單和樹狀結構的 windows，可從可調整大小的視窗中獲益。</span><span class="sxs-lookup"><span data-stu-id="433de-583">Windows with dynamic content, documents, images, lists, and trees benefit the most from resizable windows.</span></span>
-   <span data-ttu-id="433de-584">**針對文字檔，請考慮使用最大的行長度80個字元** ，讓文字更容易閱讀。</span><span class="sxs-lookup"><span data-stu-id="433de-584">**For text documents, consider a maximum line length of 80 characters** to make the text easy to read.</span></span> <span data-ttu-id="433de-585"> (字元包含字母、標點符號和空格。 ) </span><span class="sxs-lookup"><span data-stu-id="433de-585">(Characters include letters, punctuation, and spaces.)</span></span>
-   <span data-ttu-id="433de-586">固定大小的視窗：</span><span class="sxs-lookup"><span data-stu-id="433de-586">Fixed-sized windows:</span></span>
    -   <span data-ttu-id="433de-587">**固定大小的 windows 必須是完全可見且大小調整，才能納入工作區域中。**</span><span class="sxs-lookup"><span data-stu-id="433de-587">**Fixed-sized windows must be entirely visible and sized to fit within the work area.**</span></span>
-   <span data-ttu-id="433de-588">可調整大小的視窗：</span><span class="sxs-lookup"><span data-stu-id="433de-588">Resizable windows:</span></span>
    -   <span data-ttu-id="433de-589">**可調整大小的視窗可能已針對較高的解析度進行優化，但在顯示時視需要調整為實際螢幕解析度的大小。**</span><span class="sxs-lookup"><span data-stu-id="433de-589">**Resizable windows may be optimized for higher resolutions, but sized down as needed at display time to the actual screen resolution.**</span></span>
    -   <span data-ttu-id="433de-590">**逐漸放大的視窗大小必須顯示漸進詳細資訊。**</span><span class="sxs-lookup"><span data-stu-id="433de-590">**Progressively larger window sizes must show progressively more information.**</span></span> <span data-ttu-id="433de-591">請確定至少有一個視窗部分或控制項具有可調整大小的內容。</span><span class="sxs-lookup"><span data-stu-id="433de-591">Make sure that at least one window portion or control has resizable content.</span></span>
    -   <span data-ttu-id="433de-592">**當調整視窗大小時，保留內容的左上角。**</span><span class="sxs-lookup"><span data-stu-id="433de-592">**Keep the upper-left origin of the content fixed as the window is resized.**</span></span> <span data-ttu-id="433de-593">請勿在視窗大小變更時移動來源以平衡內容。</span><span class="sxs-lookup"><span data-stu-id="433de-593">Don't move the origin to balance the content as the window size changes.</span></span>
    -   <span data-ttu-id="433de-594">**如果內容可能太寬，請設定內容大小上限。**</span><span class="sxs-lookup"><span data-stu-id="433de-594">**Set a maximum content size if the content can be too stretched too wide.**</span></span> <span data-ttu-id="433de-595">如果內容變得很困難，請不要將內容區域的大小調整到寬度超過最大寬度，或變更內容的原點，因為視窗的大小變大。</span><span class="sxs-lookup"><span data-stu-id="433de-595">If the content becomes unwieldy, don't resize the content area beyond its maximum width or change the content's origin as the window is resized larger.</span></span> <span data-ttu-id="433de-596">相反地，請保留最大寬度和固定左上角。</span><span class="sxs-lookup"><span data-stu-id="433de-596">Instead, keep a maximum width and a fixed upper-left origin.</span></span>
    -   <span data-ttu-id="433de-597">**設定最小的視窗大小（如果大小低於此值，內容就無法再使用）。**</span><span class="sxs-lookup"><span data-stu-id="433de-597">**Set a minimum window size if there is a size below which the content is no longer usable.**</span></span> <span data-ttu-id="433de-598">針對可調整大小的控制項，請將可調整大小下限的元素大小設定為其最小的功能大小，例如清單視圖中的最小功能性</span><span class="sxs-lookup"><span data-stu-id="433de-598">For resizable controls, set minimum resizable element sizes to their smallest functional sizes, such as minimum functional column widths in list views.</span></span> <span data-ttu-id="433de-599">選擇性的 UI 元素應完全移除。</span><span class="sxs-lookup"><span data-stu-id="433de-599">Optional UI elements should be removed completely.</span></span>
    -   <span data-ttu-id="433de-600">**請考慮改變簡報，讓內容可以使用較小的大小。**</span><span class="sxs-lookup"><span data-stu-id="433de-600">**Consider altering the presentation to make the content usable at smaller sizes.**</span></span>

        ![<span data-ttu-id="433de-601">media player 控制項的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-601">screen shot of media player controls</span></span> ](images/vis-layout-image16.png)

        <span data-ttu-id="433de-602">在此範例中，Windows Media Player 會在視窗對標準格式變得太小時變更其格式。</span><span class="sxs-lookup"><span data-stu-id="433de-602">In this example, Windows Media Player changes its format when the window becomes too small for the standard format.</span></span>

### <a name="control-size"></a><span data-ttu-id="433de-603">控制項大小</span><span class="sxs-lookup"><span data-stu-id="433de-603">Control size</span></span>

-   <span data-ttu-id="433de-604">**讓所有互動式控制項至少具有相對16x16 圖元。**</span><span class="sxs-lookup"><span data-stu-id="433de-604">**Make all interactive controls at least relative 16x16 pixels.**</span></span> <span data-ttu-id="433de-605">如此一來，所有輸入裝置（包括 Windows 平板電腦和觸控技術）都能順利運作。</span><span class="sxs-lookup"><span data-stu-id="433de-605">Doing so works well for all input devices, including Windows Tablet and Touch Technology.</span></span>
-   <span data-ttu-id="433de-606">**大小控制項以避免截斷的資料。**</span><span class="sxs-lookup"><span data-stu-id="433de-606">**Size controls to avoid truncated data.**</span></span> <span data-ttu-id="433de-607">請勿截斷必須讀取才能執行工作的資料。</span><span class="sxs-lookup"><span data-stu-id="433de-607">Don't truncate data that must be read to perform a task.</span></span> <span data-ttu-id="433de-608">大小清單視圖資料行，以避免截斷的資料。</span><span class="sxs-lookup"><span data-stu-id="433de-608">Size list view columns to avoid truncated data.</span></span>
-   <span data-ttu-id="433de-609">**用以消除不必要滾動的大小控制項。**</span><span class="sxs-lookup"><span data-stu-id="433de-609">**Size controls to eliminate unnecessary scrolling.**</span></span> <span data-ttu-id="433de-610">如果這樣做會消除捲軸，讓控制項稍微放大。</span><span class="sxs-lookup"><span data-stu-id="433de-610">Make controls slightly larger if doing so eliminates a scrollbar.</span></span> <span data-ttu-id="433de-611">應該不需要太多垂直捲動條，也不需要任何不需要的水準捲軸。</span><span class="sxs-lookup"><span data-stu-id="433de-611">There should be few vertical scrollbars and no unnecessary horizontal scrollbars.</span></span>

    ![<span data-ttu-id="433de-612">清單大小的螢幕擷取畫面，以避免捲軸</span><span class="sxs-lookup"><span data-stu-id="433de-612">screen shot of list sized to avoid a scrollbar</span></span> ](images/vis-layout-image40.png)

    <span data-ttu-id="433de-613">在此範例中，下拉式清單會調整大小以消除捲軸。</span><span class="sxs-lookup"><span data-stu-id="433de-613">In this example, the drop-down list is sized to eliminate the scrollbar.</span></span>

-   <span data-ttu-id="433de-614">**減少表面上的控制項大小數目。**</span><span class="sxs-lookup"><span data-stu-id="433de-614">**Reduce the number of control sizes on a surface.**</span></span> <span data-ttu-id="433de-615">偏好使用 [標準建議的控制項大小](#recommended-sizing-and-spacing) ，如有必要，請使用幾個一致大小的較大或較小的控制項。</span><span class="sxs-lookup"><span data-stu-id="433de-615">Prefer using the [standard recommended control sizes](#recommended-sizing-and-spacing) and when necessary, use a few consistently sized larger or smaller controls.</span></span> <span data-ttu-id="433de-616">請嘗試使用單一寬度的清單方塊和樹狀檢視，而且不超過三個命令按鈕和下拉式清單的寬度。</span><span class="sxs-lookup"><span data-stu-id="433de-616">Try to use a single width for list boxes and tree views, and no more than three widths for command buttons and drop-down lists.</span></span> <span data-ttu-id="433de-617">不過，文字方塊和下拉式方塊寬度應建議其最長或預期的輸入長度。</span><span class="sxs-lookup"><span data-stu-id="433de-617">However, text box and combo box widths should suggest the length of their longest or expected input.</span></span>

    ![<span data-ttu-id="433de-618">具有清單和按鈕之對話方塊的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-618">screen shot of dialog box with lists and buttons</span></span> ](images/vis-layout-image41.png)

    <span data-ttu-id="433de-619">在此範例中，會一致地使用一個清單方塊和命令按鈕大小。</span><span class="sxs-lookup"><span data-stu-id="433de-619">In this example, one list box and command button size is used consistently.</span></span>

-   <span data-ttu-id="433de-620">**針對以其文字為基礎調整大小的控制項，請針對將當地語系化的任何文字，在較短的文字) 中包含額外的 30% (高達200%。**</span><span class="sxs-lookup"><span data-stu-id="433de-620">**For controls that are sized based on their text, include an additional 30 percent (up to 200 percent for shorter text) for any text that will be localized.**</span></span> <span data-ttu-id="433de-621">此指導方針假設版面配置是使用英文文字所設計。</span><span class="sxs-lookup"><span data-stu-id="433de-621">This guideline assumes the layout is designed using English text.</span></span> <span data-ttu-id="433de-622">另外也請注意，此指導方針參考當地語系化的文字，而非數位。</span><span class="sxs-lookup"><span data-stu-id="433de-622">Note also that this guideline refers to localized text, not numbers.</span></span>
-   <span data-ttu-id="433de-623">**將靜態文字控制項、核取方塊和選項按鈕擴充至版面配置所容納的最大寬度。**</span><span class="sxs-lookup"><span data-stu-id="433de-623">**Extend static text controls, check boxes, and radio buttons to the maximum width that will fit in the layout.**</span></span> <span data-ttu-id="433de-624">這樣做可避免截斷變數長度文字和當地語系化。</span><span class="sxs-lookup"><span data-stu-id="433de-624">Doing so avoids truncation from variable length text and localization.</span></span>

    <span data-ttu-id="433de-625">**不正確：**</span><span class="sxs-lookup"><span data-stu-id="433de-625">**Incorrect:**</span></span>

    ![<span data-ttu-id="433de-626">進度控制項和部分文字的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-626">screen shot of progress control and partial text</span></span> ](images/vis-layout-image42.png)

    <span data-ttu-id="433de-627">在此範例中，會不必要地截斷控制項文字。</span><span class="sxs-lookup"><span data-stu-id="433de-627">In this example, control text is unnecessarily truncated.</span></span>

### <a name="control-spacing"></a><span data-ttu-id="433de-628">控制項間距</span><span class="sxs-lookup"><span data-stu-id="433de-628">Control spacing</span></span>

-   <span data-ttu-id="433de-629">**如果控制項沒有觸及，則至少有3個 Dlu (5 個相對圖元之間的空間) 。**</span><span class="sxs-lookup"><span data-stu-id="433de-629">**If controls aren't touching, have at least 3 DLUs (5 relative pixels) of space between them.**</span></span> <span data-ttu-id="433de-630">否則，使用者可以按一下控制項之間的非使用中空間。</span><span class="sxs-lookup"><span data-stu-id="433de-630">Otherwise, users may click on inactive space between the controls.</span></span> <span data-ttu-id="433de-631">由於按一下非使用中空間沒有結果或視覺效果的意見反應，因此使用者通常不確定發生什麼錯誤。</span><span class="sxs-lookup"><span data-stu-id="433de-631">Since clicking inactive space has no result or visual feedback, users are often uncertain what went wrong.</span></span>

### <a name="placement"></a><span data-ttu-id="433de-632">放置</span><span class="sxs-lookup"><span data-stu-id="433de-632">Placement</span></span>

-   <span data-ttu-id="433de-633">**將介面中的 UI 元素排列成自然地以左至右、由上到下的順序， (在西歐文化特性中) 。**</span><span class="sxs-lookup"><span data-stu-id="433de-633">**Arrange the UI elements within a surface to flow naturally in a left-to-right, top-to-bottom order (in Western cultures).**</span></span> <span data-ttu-id="433de-634">UI 元素的位置會傳達其關聯性，而且應該鏡像步驟來執行工作。</span><span class="sxs-lookup"><span data-stu-id="433de-634">The placement of the UI elements conveys their relationship and should mirror the steps to perform the task.</span></span>
-   <span data-ttu-id="433de-635">**將在左上角或左上角起始工作的 UI 元素放在上方。**</span><span class="sxs-lookup"><span data-stu-id="433de-635">**Place UI elements that initiate a task in the upper-left corner or upper-center.**</span></span> <span data-ttu-id="433de-636">提供使用者應該先查看最大視覺效果的 UI 元素。</span><span class="sxs-lookup"><span data-stu-id="433de-636">Give the UI element that users should look at first the greatest visual emphasis.</span></span>
-   <span data-ttu-id="433de-637">**將完成工作的 UI 元素放在右下角。**</span><span class="sxs-lookup"><span data-stu-id="433de-637">**Place UI elements that complete a task in the lower-right corner.**</span></span>
-   <span data-ttu-id="433de-638">**將相關的 UI 元素放在一起，並分隔不相關的元素。**</span><span class="sxs-lookup"><span data-stu-id="433de-638">**Place related UI elements together, and separate unrelated elements.**</span></span>
-   <span data-ttu-id="433de-639">**將必要的步驟放置在主要流程中。**</span><span class="sxs-lookup"><span data-stu-id="433de-639">**Place required steps in the main flow.**</span></span>
-   <span data-ttu-id="433de-640">**在主要流程之外放置選擇性步驟，** 可能會使用適當的背景或漸進式洩漏來將其反白。</span><span class="sxs-lookup"><span data-stu-id="433de-640">**Place optional steps outside the main flow,** possibly de-emphasized by using a suitable background or progressive disclosure.</span></span>
-   <span data-ttu-id="433de-641">**將經常使用的元素放** 在掃描路徑中不常使用的元素之前。</span><span class="sxs-lookup"><span data-stu-id="433de-641">**Place frequently used elements before infrequently used elements** in the scan path.</span></span>

### <a name="focus"></a><span data-ttu-id="433de-642">焦點</span><span class="sxs-lookup"><span data-stu-id="433de-642">Focus</span></span>

-   <span data-ttu-id="433de-643">**選擇使用者必須先查看的單一 UI 元素，才能成為焦點。**</span><span class="sxs-lookup"><span data-stu-id="433de-643">**Choose a single UI element that users need to look at first to be the focal point.**</span></span> <span data-ttu-id="433de-644">焦點應該是使用者需要快速尋找和瞭解的重要事項。</span><span class="sxs-lookup"><span data-stu-id="433de-644">The focal point should be something important that users need to find and understand quickly.</span></span>
-   <span data-ttu-id="433de-645">**將焦點放在左上角或左上角。**</span><span class="sxs-lookup"><span data-stu-id="433de-645">**Place the focal point in the upper-left corner or upper-center.**</span></span>
-   <span data-ttu-id="433de-646">**讓焦點成為最大的視覺效果，** 例如醒目的文字、預設選項或初始輸入焦點。</span><span class="sxs-lookup"><span data-stu-id="433de-646">**Give the focal point the greatest visual emphasis,** such as prominent text, default selection, or initial input focus.</span></span>

### <a name="alignment"></a><span data-ttu-id="433de-647">對齊</span><span class="sxs-lookup"><span data-stu-id="433de-647">Alignment</span></span>

-   <span data-ttu-id="433de-648">一般來說，使用靠左對齊。</span><span class="sxs-lookup"><span data-stu-id="433de-648">Normally, use left alignment.</span></span>
-   <span data-ttu-id="433de-649">針對數值資料使用靠右對齊，尤其是數值資料的資料行。</span><span class="sxs-lookup"><span data-stu-id="433de-649">Use right alignment for numeric data, especially columns of numeric data.</span></span>
-   <span data-ttu-id="433de-650">針對認可按鈕使用靠右對齊，以及對齊右視窗邊緣的控制項。</span><span class="sxs-lookup"><span data-stu-id="433de-650">Use right alignment for commit buttons, as well as controls aligned with right window edge.</span></span>
-   <span data-ttu-id="433de-651">當靠左或靠右對齊不適當或顯示不平衡時，請使用中央對齊。</span><span class="sxs-lookup"><span data-stu-id="433de-651">Use center alignment when either left or right alignment is inappropriate or appears unbalanced.</span></span>
-   <span data-ttu-id="433de-652">垂直對齊具有文字的控制項時，對齊文字基準以提供順暢的水準讀取流程。</span><span class="sxs-lookup"><span data-stu-id="433de-652">When vertically aligning controls with text, align the text baselines to give a smooth horizontal reading flow.</span></span>
-   <span data-ttu-id="433de-653">針對標籤對齊，請參閱設計概念中的 [標籤對齊](#label-alignment) 區段。</span><span class="sxs-lookup"><span data-stu-id="433de-653">For label alignment, refer to the [Label alignment](#label-alignment) section in Design concepts.</span></span>

### <a name="accessibility"></a><span data-ttu-id="433de-654">協助工具選項</span><span class="sxs-lookup"><span data-stu-id="433de-654">Accessibility</span></span>

-   <span data-ttu-id="433de-655">**請勿使用版面配置作為傳達 UI 相關重要資訊的唯一方法。**</span><span class="sxs-lookup"><span data-stu-id="433de-655">**Don't use layout as the only means to convey important information about a UI.**</span></span> <span data-ttu-id="433de-656">具有視覺障礙的使用者可能無法解讀此簡報。</span><span class="sxs-lookup"><span data-stu-id="433de-656">Users who have visual impairments may not be able to interpret this presentation.</span></span> <span data-ttu-id="433de-657">例如，請確定控制項標籤會將其關聯性傳達給其他專案。</span><span class="sxs-lookup"><span data-stu-id="433de-657">For example, make sure that controls labels communicate their relationship to other items.</span></span>
-   <span data-ttu-id="433de-658">**請勿將次級控制項內嵌在控制項標籤中，以建立一個句子或片語。**</span><span class="sxs-lookup"><span data-stu-id="433de-658">**Don't embed subordinate controls within control labels to create a sentence or phrase.**</span></span> <span data-ttu-id="433de-659">這類關聯純粹是以配置為基礎，而且不是由鍵盤流覽或協助工具輔助技術來妥善處理。</span><span class="sxs-lookup"><span data-stu-id="433de-659">Such associations are based purely on layout and aren't handled well by keyboard navigation or accessibility assistive technologies.</span></span> <span data-ttu-id="433de-660">此外，這項技術並不會當地語系化，因為句子結構會因語言而異。</span><span class="sxs-lookup"><span data-stu-id="433de-660">Furthermore, this technique isn't localizable because sentence structure varies with language.</span></span>

    <span data-ttu-id="433de-661">**不正確：**</span><span class="sxs-lookup"><span data-stu-id="433de-661">**Incorrect:**</span></span>

    ![<span data-ttu-id="433de-662">句子中間文字方塊的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-662">screen shot of a text box in middle of a sentence</span></span> ](images/vis-layout-image43.png)

    <span data-ttu-id="433de-663">在此範例中，文字方塊不正確地放在核取方塊標籤內。</span><span class="sxs-lookup"><span data-stu-id="433de-663">In this example, the text box is incorrectly placed within the check box label.</span></span>

    <span data-ttu-id="433de-664">**正確：**</span><span class="sxs-lookup"><span data-stu-id="433de-664">**Correct:**</span></span>

    ![<span data-ttu-id="433de-665">句子結尾文字方塊的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-665">screen shot of a text box at the end of a sentence</span></span> ](images/vis-layout-image44.png)

    <span data-ttu-id="433de-666">在此，文字方塊會置於核取方塊標籤之後。</span><span class="sxs-lookup"><span data-stu-id="433de-666">Here, the text box is placed after the check box label.</span></span>

-   <span data-ttu-id="433de-667">**將群組設為可存取。**</span><span class="sxs-lookup"><span data-stu-id="433de-667">**Make grouping accessible.**</span></span> <span data-ttu-id="433de-668">視窗窗格、群組方塊、分隔符號、文字標籤和匯總工具所定義的群組，都是由協助工具輔助程式自動處理。</span><span class="sxs-lookup"><span data-stu-id="433de-668">Groups defined by window panes, group boxes, separators, text labels, and aggregators are automatically handled by accessibility aids.</span></span> <span data-ttu-id="433de-669">不過，只有位置和背景定義的群組不是，且必須以程式設計的方式定義以供存取。</span><span class="sxs-lookup"><span data-stu-id="433de-669">However, groups defined only by placement and backgrounds are not, and must be defined programmatically for accessibility.</span></span>

<span data-ttu-id="433de-670">如需詳細指導方針，請參閱 [協助工具](inter-accessibility.md)。</span><span class="sxs-lookup"><span data-stu-id="433de-670">For more guidelines, see [Accessibility](inter-accessibility.md).</span></span>

## <a name="recommended-sizing-and-spacing"></a><span data-ttu-id="433de-671">建議的大小和間距</span><span class="sxs-lookup"><span data-stu-id="433de-671">Recommended sizing and spacing</span></span>

<span data-ttu-id="433de-672">**控制項大小調整**</span><span class="sxs-lookup"><span data-stu-id="433de-672">**Control sizing**</span></span>

<span data-ttu-id="433de-673">下表列出 (寬度 x 高度的建議大小，或者，如果通用 UI 元素的單一數位)  (9 pt，則為高度。</span><span class="sxs-lookup"><span data-stu-id="433de-673">The following table lists the recommended sizes (width x height, or height if a single number) for common UI elements (for 9 pt.</span></span> <span data-ttu-id="433de-674">Segoe UI 96 DPI) 。</span><span class="sxs-lookup"><span data-stu-id="433de-674">Segoe UI at 96 dpi).</span></span> <span data-ttu-id="433de-675">以英文的最長專案為基礎的寬度會增加30% 的當地語系化 (，最高可達 200) % 的文字 (但不是) 將當地語系化的數位。</span><span class="sxs-lookup"><span data-stu-id="433de-675">The widths based on the longest item in English add 30 percent for localization (up to 200 percent for shorter text) for any text (but not numbers) that will be localized.</span></span>



|                                                                                                 |                            |                                                                                                   |                                                                                                            |
|-------------------------------------------------------------------------------------------------|----------------------------|---------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------|
|                                                                                                 | <span data-ttu-id="433de-676">**控制**</span><span class="sxs-lookup"><span data-stu-id="433de-676">**Control**</span></span><br/>     | <span data-ttu-id="433de-677">**對話方塊單位**</span><span class="sxs-lookup"><span data-stu-id="433de-677">**Dialog units**</span></span><br/>                                                                       | <span data-ttu-id="433de-678">**相對圖元**</span><span class="sxs-lookup"><span data-stu-id="433de-678">**Relative pixels**</span></span><br/>                                                                             |
| ![<span data-ttu-id="433de-679">核取方塊及其標籤的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-679">screen shot of check boxes and their labels</span></span> ](images/vis-layout-image45.png)<br/>       | <span data-ttu-id="433de-680">核取方塊</span><span class="sxs-lookup"><span data-stu-id="433de-680">Check boxes</span></span><br/>     | <span data-ttu-id="433de-681">10</span><span class="sxs-lookup"><span data-stu-id="433de-681">10</span></span><br/>                                                                                     | <span data-ttu-id="433de-682">17</span><span class="sxs-lookup"><span data-stu-id="433de-682">17</span></span><br/>                                                                                              |
| ![<span data-ttu-id="433de-683">下拉式方塊的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-683">screen shot of combo box</span></span> ](images/vis-layout-image46.png)<br/>                          | <span data-ttu-id="433de-684">下拉式方塊</span><span class="sxs-lookup"><span data-stu-id="433de-684">Combo boxes</span></span><br/>     | <span data-ttu-id="433de-685">最長專案的寬度 + 30% x 14</span><span class="sxs-lookup"><span data-stu-id="433de-685">width of longest item + 30% x 14</span></span><br/>                                                       | <span data-ttu-id="433de-686">最長專案的寬度 + 30% x 23</span><span class="sxs-lookup"><span data-stu-id="433de-686">width of longest item + 30% x 23</span></span><br/>                                                                |
| ![<span data-ttu-id="433de-687">命令按鈕的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-687">screen shot of a command button</span></span> ](images/vis-layout-image47.png)<br/>                   | <span data-ttu-id="433de-688">命令按鈕</span><span class="sxs-lookup"><span data-stu-id="433de-688">Command buttons</span></span><br/> | <span data-ttu-id="433de-689">50 x 14</span><span class="sxs-lookup"><span data-stu-id="433de-689">50 x 14</span></span><br/>                                                                                | <span data-ttu-id="433de-690">75 x 23</span><span class="sxs-lookup"><span data-stu-id="433de-690">75 x 23</span></span><br/>                                                                                         |
| ![<span data-ttu-id="433de-691">選取了兩個命令連結之一的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-691">screen shot of one of two command links selected</span></span> ](images/vis-layout-image48.png)<br/>  | <span data-ttu-id="433de-692">命令連結</span><span class="sxs-lookup"><span data-stu-id="433de-692">Command links</span></span><br/>   | <span data-ttu-id="433de-693">25 (一行) 或 35 (兩行) </span><span class="sxs-lookup"><span data-stu-id="433de-693">25 (one line) or 35 (two lines)</span></span><br/>                                                        | <span data-ttu-id="433de-694">41 (一行) 或 58 (兩行) </span><span class="sxs-lookup"><span data-stu-id="433de-694">41 (one line) or 58 (two lines)</span></span><br/>                                                                 |
| ![<span data-ttu-id="433de-695">下拉式清單的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-695">screen shot of a drop-down list</span></span> ](images/vis-layout-image49.png)<br/>                   | <span data-ttu-id="433de-696">下拉式清單</span><span class="sxs-lookup"><span data-stu-id="433de-696">Drop-down lists</span></span><br/> | <span data-ttu-id="433de-697">最長有效資料的寬度 + 30% x 14</span><span class="sxs-lookup"><span data-stu-id="433de-697">width of longest valid data + 30% x 14</span></span><br/>                                                 | <span data-ttu-id="433de-698">最長專案的寬度 + 30% x 23</span><span class="sxs-lookup"><span data-stu-id="433de-698">width of longest item + 30% x 23</span></span><br/>                                                                |
| ![<span data-ttu-id="433de-699">清單方塊的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-699">screen shot of a list box</span></span> ](images/vis-layout-image50.png)<br/>                         | <span data-ttu-id="433de-700">清單方塊</span><span class="sxs-lookup"><span data-stu-id="433de-700">List boxes</span></span><br/>      | <span data-ttu-id="433de-701">最長專案的寬度 + 30% x 專案的整數 (3 個專案的最小值) </span><span class="sxs-lookup"><span data-stu-id="433de-701">width of longest item + 30% x an integral number of items (3 items minimum)</span></span><br/>            |                                                                                                            |
| ![<span data-ttu-id="433de-702">圖片檔案清單的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-702">screen shot of a list of picture files</span></span> ](images/vis-layout-image51.png)<br/>            | <span data-ttu-id="433de-703">清單檢視</span><span class="sxs-lookup"><span data-stu-id="433de-703">List views</span></span><br/>      | <span data-ttu-id="433de-704">避免截斷資料的資料行寬度 x 專案的整數數目</span><span class="sxs-lookup"><span data-stu-id="433de-704">columns widths that avoid truncated data x an integral number of items</span></span><br/>                 |                                                                                                            |
| ![<span data-ttu-id="433de-705">進度列的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-705">screen shot of a progress bar</span></span> ](images/vis-layout-image52.png)<br/>                     | <span data-ttu-id="433de-706">進度列</span><span class="sxs-lookup"><span data-stu-id="433de-706">Progress bars</span></span><br/>   | <span data-ttu-id="433de-707">107或 237 x 8</span><span class="sxs-lookup"><span data-stu-id="433de-707">107 or 237 x 8</span></span><br/>                                                                         | <span data-ttu-id="433de-708">160或 355 x 15</span><span class="sxs-lookup"><span data-stu-id="433de-708">160 or 355 x 15</span></span><br/>                                                                                 |
| ![<span data-ttu-id="433de-709">選項按鈕的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-709">screen shot of radio buttons</span></span> ](images/vis-layout-image53.png)<br/>                      | <span data-ttu-id="433de-710">選項按鈕</span><span class="sxs-lookup"><span data-stu-id="433de-710">Radio buttons</span></span><br/>   | <span data-ttu-id="433de-711">10</span><span class="sxs-lookup"><span data-stu-id="433de-711">10</span></span><br/>                                                                                     | <span data-ttu-id="433de-712">17</span><span class="sxs-lookup"><span data-stu-id="433de-712">17</span></span><br/>                                                                                              |
| ![<span data-ttu-id="433de-713">滑杆控制項的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-713">screen shot of slider control</span></span> ](images/vis-layout-image54.png)<br/>                     | <span data-ttu-id="433de-714">滑桿</span><span class="sxs-lookup"><span data-stu-id="433de-714">Sliders</span></span><br/>         | <span data-ttu-id="433de-715">15</span><span class="sxs-lookup"><span data-stu-id="433de-715">15</span></span><br/>                                                                                     | <span data-ttu-id="433de-716">24</span><span class="sxs-lookup"><span data-stu-id="433de-716">24</span></span><br/>                                                                                              |
| ![<span data-ttu-id="433de-717">文字的螢幕擷取畫面： [選取時區]</span><span class="sxs-lookup"><span data-stu-id="433de-717">screen shot of text: 'select time zone'</span></span> ](images/vis-layout-image55.png)<br/>           | <span data-ttu-id="433de-718">Text (靜態) </span><span class="sxs-lookup"><span data-stu-id="433de-718">Text (static)</span></span><br/>   | <span data-ttu-id="433de-719">8</span><span class="sxs-lookup"><span data-stu-id="433de-719">8</span></span><br/>                                                                                      | <span data-ttu-id="433de-720">13</span><span class="sxs-lookup"><span data-stu-id="433de-720">13</span></span><br/>                                                                                              |
| ![<span data-ttu-id="433de-721">空白文字方塊的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-721">screen shot of empty text box</span></span> ](images/vis-layout-image56.png)<br/>                     | <span data-ttu-id="433de-722">文字方塊</span><span class="sxs-lookup"><span data-stu-id="433de-722">Text boxes</span></span><br/>      | <span data-ttu-id="433de-723">最長或預期輸入的寬度 + 30% x 14 (一行) + 10 的額外一行</span><span class="sxs-lookup"><span data-stu-id="433de-723">width of longest or expected input + 30% x 14 (one line) + 10 for each additional line</span></span><br/> | <span data-ttu-id="433de-724">最長有效資料的寬度 + 30% x 23 相對圖元 (一行) + 16 代表每個額外的線</span><span class="sxs-lookup"><span data-stu-id="433de-724">width of longest valid data + 30% x 23 relative pixels (one line) + 16 for each additional line</span></span><br/> |
| ![<span data-ttu-id="433de-725">windows explorer 中嵌套資料夾的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="433de-725">screen shot of nested folders in windows explorer</span></span> ](images/vis-layout-image57.png)<br/> | <span data-ttu-id="433de-726">樹狀檢視</span><span class="sxs-lookup"><span data-stu-id="433de-726">Tree views</span></span><br/>      | <span data-ttu-id="433de-727">最長專案的寬度 + 30% x 專案的整數數目 (5 個專案的最小值) </span><span class="sxs-lookup"><span data-stu-id="433de-727">width of longest item + 30% x an integral number of items (5 items minimum)</span></span><br/>            |                                                                                                            |



 

<span data-ttu-id="433de-728">**間距**</span><span class="sxs-lookup"><span data-stu-id="433de-728">**Spacing**</span></span>

<span data-ttu-id="433de-729">下表列出一般 UI 元素 (9 pt 之間的建議間距。</span><span class="sxs-lookup"><span data-stu-id="433de-729">The following table lists the recommended spacing between common UI elements (for 9 pt.</span></span> <span data-ttu-id="433de-730">Segoe UI 96 DPI) 。</span><span class="sxs-lookup"><span data-stu-id="433de-730">Segoe UI at 96 dpi).</span></span>



|                                                                                                   |                                                                                                       |                                                                                           |                                                                                           |
|---------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
|                                                                                                   | <span data-ttu-id="433de-731">**Element**</span><span class="sxs-lookup"><span data-stu-id="433de-731">**Element**</span></span><br/>                                                                                | <span data-ttu-id="433de-732">**對話方塊單位**</span><span class="sxs-lookup"><span data-stu-id="433de-732">**Dialog units**</span></span><br/>                                                               | <span data-ttu-id="433de-733">**相對圖元**</span><span class="sxs-lookup"><span data-stu-id="433de-733">**Relative pixels**</span></span><br/>                                                            |
| ![<span data-ttu-id="433de-734">顯示對話方塊邊界間距的影像</span><span class="sxs-lookup"><span data-stu-id="433de-734">Image showing spacing in dialog box margins</span></span> ](images/vis_layout_image58.jpeg)<br/>        | <span data-ttu-id="433de-735">對話方塊邊界</span><span class="sxs-lookup"><span data-stu-id="433de-735">Dialog box margins</span></span><br/>                                                                         | <span data-ttu-id="433de-736">所有邊7</span><span class="sxs-lookup"><span data-stu-id="433de-736">7 on all sides</span></span><br/>                                                                 | <span data-ttu-id="433de-737">11的所有邊</span><span class="sxs-lookup"><span data-stu-id="433de-737">11 on all sides</span></span><br/>                                                                |
| ![<span data-ttu-id="433de-738">顯示標籤和控制項之間間距的影像</span><span class="sxs-lookup"><span data-stu-id="433de-738">Image showing spacing between labels and controls</span></span> ](images/vis_layout_image59.jpeg)<br/>  | <span data-ttu-id="433de-739">在文字標籤與其相關聯控制項之間 (例如，文字方塊和清單方塊) </span><span class="sxs-lookup"><span data-stu-id="433de-739">Between text labels and their associated controls (for example, text boxes and list boxes)</span></span><br/> | <span data-ttu-id="433de-740">3</span><span class="sxs-lookup"><span data-stu-id="433de-740">3</span></span><br/>                                                                              | <span data-ttu-id="433de-741">5</span><span class="sxs-lookup"><span data-stu-id="433de-741">5</span></span><br/>                                                                              |
| ![<span data-ttu-id="433de-742">顯示相關控制項之間間距的影像</span><span class="sxs-lookup"><span data-stu-id="433de-742">Image showing spacing between related controls</span></span> ](images/vis_layout_image60.jpeg)<br/>     | <span data-ttu-id="433de-743">在相關控制項之間</span><span class="sxs-lookup"><span data-stu-id="433de-743">Between related controls</span></span><br/>                                                                   | <span data-ttu-id="433de-744">4</span><span class="sxs-lookup"><span data-stu-id="433de-744">4</span></span><br/>                                                                              | <span data-ttu-id="433de-745">7</span><span class="sxs-lookup"><span data-stu-id="433de-745">7</span></span><br/>                                                                              |
| ![<span data-ttu-id="433de-746">顯示不相關控制項之間間距的影像</span><span class="sxs-lookup"><span data-stu-id="433de-746">Image showing spacing between unrelated controls</span></span> ](images/vis_layout_image61.jpeg)<br/>   | <span data-ttu-id="433de-747">不相關的控制項</span><span class="sxs-lookup"><span data-stu-id="433de-747">Between unrelated controls</span></span><br/>                                                                 | <span data-ttu-id="433de-748">7</span><span class="sxs-lookup"><span data-stu-id="433de-748">7</span></span><br/>                                                                              | <span data-ttu-id="433de-749">11</span><span class="sxs-lookup"><span data-stu-id="433de-749">11</span></span><br/>                                                                             |
| ![<span data-ttu-id="433de-750">顯示群組中第一個控制項間距的影像</span><span class="sxs-lookup"><span data-stu-id="433de-750">Image showing spacing of first control in a group</span></span> ](images/vis_layout_image62.jpeg)<br/>  | <span data-ttu-id="433de-751">群組方塊中的第一個控制項</span><span class="sxs-lookup"><span data-stu-id="433de-751">First control in a group box</span></span><br/>                                                               | <span data-ttu-id="433de-752">11向下群組方塊的頂端;垂直對齊群組框標題</span><span class="sxs-lookup"><span data-stu-id="433de-752">11 down from the top of the group box; align vertically to the group box title</span></span><br/> | <span data-ttu-id="433de-753">群組方塊頂端的向下16個，垂直對齊群組框標題</span><span class="sxs-lookup"><span data-stu-id="433de-753">16 down from the top of the group box; align vertically to the group box title</span></span><br/> |
| ![Aa511279 與 en-us 之間的 (en-us、MSDN. 10) .jpg](images/vis_layout_image60.jpeg)<br/>         | <span data-ttu-id="433de-755">群組方塊中的控制項之間</span><span class="sxs-lookup"><span data-stu-id="433de-755">Between controls in a group box</span></span><br/>                                                            | <span data-ttu-id="433de-756">4</span><span class="sxs-lookup"><span data-stu-id="433de-756">4</span></span><br/>                                                                              | <span data-ttu-id="433de-757">7</span><span class="sxs-lookup"><span data-stu-id="433de-757">7</span></span><br/>                                                                              |
| ![<span data-ttu-id="433de-758">顯示按鈕之間間距的影像</span><span class="sxs-lookup"><span data-stu-id="433de-758">Image showing spacing between buttons</span></span> ](images/vis_layout_image63.jpeg)<br/>              | <span data-ttu-id="433de-759">水準或垂直排列的按鈕之間</span><span class="sxs-lookup"><span data-stu-id="433de-759">Between horizontally or vertically arranged buttons</span></span><br/>                                        | <span data-ttu-id="433de-760">4</span><span class="sxs-lookup"><span data-stu-id="433de-760">4</span></span><br/>                                                                              | <span data-ttu-id="433de-761">7</span><span class="sxs-lookup"><span data-stu-id="433de-761">7</span></span><br/>                                                                              |
| ![<span data-ttu-id="433de-762">顯示群組中最後一個控制項間距的影像</span><span class="sxs-lookup"><span data-stu-id="433de-762">Image showing spacing of last control in a group</span></span> ](images/vis_layout_image64.jpeg)<br/>   | <span data-ttu-id="433de-763">群組方塊中的最後一個控制項</span><span class="sxs-lookup"><span data-stu-id="433de-763">Last control in a group box</span></span><br/>                                                                | <span data-ttu-id="433de-764">群組方塊底部的7</span><span class="sxs-lookup"><span data-stu-id="433de-764">7 above the bottom of the group box</span></span><br/>                                            | <span data-ttu-id="433de-765">群組方塊底部的11</span><span class="sxs-lookup"><span data-stu-id="433de-765">11 above the bottom of the group box</span></span><br/>                                           |
| ![<span data-ttu-id="433de-766">顯示群組方塊左邊緣間距的影像</span><span class="sxs-lookup"><span data-stu-id="433de-766">Image showing spacing from left edge of group box</span></span> ](images/vis_layout_image65.jpeg)<br/>  | <span data-ttu-id="433de-767">從群組方塊的左邊緣</span><span class="sxs-lookup"><span data-stu-id="433de-767">From the left edge of a group box</span></span><br/>                                                          | <span data-ttu-id="433de-768">6</span><span class="sxs-lookup"><span data-stu-id="433de-768">6</span></span><br/>                                                                              | <span data-ttu-id="433de-769">9</span><span class="sxs-lookup"><span data-stu-id="433de-769">9</span></span><br/>                                                                              |
| ![<span data-ttu-id="433de-770">顯示控制項旁文字標籤間距的影像</span><span class="sxs-lookup"><span data-stu-id="433de-770">Image showing spacing of text label beside control</span></span> ](images/vis_layout_image66.jpeg)<br/> | <span data-ttu-id="433de-771">控制項旁的文字標籤</span><span class="sxs-lookup"><span data-stu-id="433de-771">Text label beside a control</span></span><br/>                                                                | <span data-ttu-id="433de-772">從控制項頂端向下3下</span><span class="sxs-lookup"><span data-stu-id="433de-772">3 down from the top of the control</span></span><br/>                                             | <span data-ttu-id="433de-773">從控制項頂端向下5下</span><span class="sxs-lookup"><span data-stu-id="433de-773">5 down from the top of the control</span></span><br/>                                             |
| ![<span data-ttu-id="433de-774">顯示文欄位落之間間距的影像</span><span class="sxs-lookup"><span data-stu-id="433de-774">Image showing spacing between paragraphs of text</span></span> ](images/vis_layout_image67.jpeg)<br/>   | <span data-ttu-id="433de-775">文欄位落之間</span><span class="sxs-lookup"><span data-stu-id="433de-775">Between paragraphs of text</span></span><br/>                                                                 | <span data-ttu-id="433de-776">7</span><span class="sxs-lookup"><span data-stu-id="433de-776">7</span></span><br/>                                                                              | <span data-ttu-id="433de-777">11</span><span class="sxs-lookup"><span data-stu-id="433de-777">11</span></span><br/>                                                                             |
|                                                                                                   | <span data-ttu-id="433de-778">互動式控制項之間的最小空間</span><span class="sxs-lookup"><span data-stu-id="433de-778">Smallest space between interactive controls</span></span><br/>                                                | <span data-ttu-id="433de-779">3或無空格</span><span class="sxs-lookup"><span data-stu-id="433de-779">3 or no space</span></span><br/>                                                                  | <span data-ttu-id="433de-780">5或無空格</span><span class="sxs-lookup"><span data-stu-id="433de-780">5 or no space</span></span><br/>                                                                  |
|                                                                                                   | <span data-ttu-id="433de-781">非互動式控制項和任何其他控制項之間的最小空間</span><span class="sxs-lookup"><span data-stu-id="433de-781">Smallest space between a non-interactive control and any other control</span></span><br/>                     | <span data-ttu-id="433de-782">2</span><span class="sxs-lookup"><span data-stu-id="433de-782">2</span></span><br/>                                                                              | <span data-ttu-id="433de-783">3</span><span class="sxs-lookup"><span data-stu-id="433de-783">3</span></span><br/>                                                                              |
