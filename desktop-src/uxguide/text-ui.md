...
### <a name="avoid-over-communication"></a><span data-ttu-id="f2552-175">避免過度通訊</span><span class="sxs-lookup"><span data-stu-id="f2552-175">Avoid over-communication</span></span>
...
![<span data-ttu-id="f2552-193">加入 windows 程式之訊息的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="f2552-193">screen shot of message on joining windows program</span></span> ](images/text-ui-image7.png)
...
-   <span data-ttu-id="f2552-210">**選擇明確通訊的物件名稱和標籤，並區分物件的用途。**</span><span class="sxs-lookup"><span data-stu-id="f2552-210">**Choose object names and labels that clearly communicate and differentiate what the object does.**</span></span> <span data-ttu-id="f2552-211">使用者不應該需要找出物件真正的意義，或與其他物件有何不同。</span><span class="sxs-lookup"><span data-stu-id="f2552-211">Users shouldn't have to figure out what the object really means or how it differs from other objects.</span></span>
    ...
    <span data-ttu-id="f2552-212">不正確：</span><span class="sxs-lookup"><span data-stu-id="f2552-212">Incorrect:</span></span>
...
| ![<span data-ttu-id="f2552-279">第一個資料行：檔標題</span><span class="sxs-lookup"><span data-stu-id="f2552-279">first column: document headings</span></span> ](images/text-ui-image24.png)<br/>           | <span data-ttu-id="f2552-280">(無)</span><span class="sxs-lookup"><span data-stu-id="f2552-280">(none)</span></span><br/>           | <span data-ttu-id="f2552-281">17 pt。</span><span class="sxs-lookup"><span data-stu-id="f2552-281">17 pt.</span></span> <span data-ttu-id="f2552-282">黑色 (\# 000000) Calibri</span><span class="sxs-lookup"><span data-stu-id="f2552-282">black (\#000000) Calibri</span></span><br/>                 |
...
-   <span data-ttu-id="f2552-297">用來真正參考文字。</span><span class="sxs-lookup"><span data-stu-id="f2552-297">Use to refer to text literally.</span></span> <span data-ttu-id="f2552-298">請勿將引號用於此用途。</span><span class="sxs-lookup"><span data-stu-id="f2552-298">Don't use quotation marks for this purpose.</span></span>
    ...
    <span data-ttu-id="f2552-299">**正確：**</span><span class="sxs-lookup"><span data-stu-id="f2552-299">**Correct:**</span></span>
...
<span data-ttu-id="f2552-319">**驚嘆號**</span><span class="sxs-lookup"><span data-stu-id="f2552-319">**Exclamation points**</span></span>
...
-   <span data-ttu-id="f2552-350">**針對標題使用標題樣式的大小寫，針對所有其他 UI 元素使用句子樣式的大小寫。**</span><span class="sxs-lookup"><span data-stu-id="f2552-350">**Use title-style capitalization for titles, sentence-style capitalization for all other UI elements.**</span></span> <span data-ttu-id="f2552-351">這麼做會更適合 Windows 的 [聲音](text-style-tone.md)。</span><span class="sxs-lookup"><span data-stu-id="f2552-351">Doing so is more appropriate for the [Windows tone](text-style-tone.md).</span></span>
    ...
    <span data-ttu-id="f2552-356">此一般範例會針對對話方塊顯示正確的大小寫和標點符號。</span><span class="sxs-lookup"><span data-stu-id="f2552-356">This generic example shows correct capitalization and punctuation for dialogs.</span></span>
...
<span data-ttu-id="f2552-377">如需詳細資訊，請參閱特定 UI 元件指導方針中的「文字」或「標籤」一節。</span><span class="sxs-lookup"><span data-stu-id="f2552-377">For more information, see the "Text" or "Labels" section in the specific UI component guidelines.</span></span>
...
-   <span data-ttu-id="f2552-396">針對具有變數內容 (例如清單查看和樹狀檢視) 的控制項，請 **選擇適用于最長有效資料的寬度。**</span><span class="sxs-lookup"><span data-stu-id="f2552-396">For controls with variable contents (such as list views and tree views), **choose a width appropriate for the longest valid data.**</span></span>
...
-   <span data-ttu-id="f2552-435">**盡可能使用特定動詞。**</span><span class="sxs-lookup"><span data-stu-id="f2552-435">**Use specific verbs whenever possible.**</span></span> <span data-ttu-id="f2552-436">特定動詞 (範例： [連接]、[儲存]、[安裝) 比一般使用者更有意義， (範例：設定、管理、設定) 。</span><span class="sxs-lookup"><span data-stu-id="f2552-436">Specific verbs (examples: connect, save, install) are more meaningful to users than generic ones (examples: configure, manage, set).</span></span>
    -   <span data-ttu-id="f2552-437">針對 [控制台] 頁面和 [wizard] 頁面，如果您無法使用特定的動詞，您可能會想要完全省略動詞。</span><span class="sxs-lookup"><span data-stu-id="f2552-437">For control panel pages and wizard pages, if you can't use a specific verb, you may prefer to omit the verb completely.</span></span>
        ...
        <span data-ttu-id="f2552-438">**可以接受：**</span><span class="sxs-lookup"><span data-stu-id="f2552-438">**Acceptable:**</span></span>
...
-   <span data-ttu-id="f2552-458">必要時，請 **使用補充指示來呈現有助於瞭解或使用視窗或頁面的其他資訊，** 例如：</span><span class="sxs-lookup"><span data-stu-id="f2552-458">When necessary, **use a supplemental instruction to present additional information helpful to understanding or using the window or page,** such as:</span></span>
...
-   <span data-ttu-id="f2552-468">**為每個控制項或一組控制項加上標籤。異常：**</span><span class="sxs-lookup"><span data-stu-id="f2552-468">**Label every control or group of controls. Exceptions:**</span></span>
    ...
    -   <span data-ttu-id="f2552-473">**省略重新聲明主要指令的控制項標籤。**</span><span class="sxs-lookup"><span data-stu-id="f2552-473">**Omit control labels that restate the main instruction.**</span></span> <span data-ttu-id="f2552-474">在此情況下，主要指令會採用存取金鑰。</span><span class="sxs-lookup"><span data-stu-id="f2552-474">In this case, the main instruction takes the access key.</span></span>
        ...
        <span data-ttu-id="f2552-478">**較佳：**</span><span class="sxs-lookup"><span data-stu-id="f2552-478">**Better:**</span></span>
        ...
        <span data-ttu-id="f2552-480">在此範例中，會移除多餘的標籤，所以主要指令會取得存取金鑰。</span><span class="sxs-lookup"><span data-stu-id="f2552-480">In this example, the redundant label is removed, so the main instruction takes the access key.</span></span>

-   <span data-ttu-id="f2552-481">標籤位置：</span><span class="sxs-lookup"><span data-stu-id="f2552-481">Label placement:</span></span>
    -   <span data-ttu-id="f2552-482">文字提示、核取方塊、命令按鈕、群組方塊、連結、索引標籤和提示都會直接由控制項本身標記。</span><span class="sxs-lookup"><span data-stu-id="f2552-482">Balloons, check boxes, command buttons, group boxes, links, tabs, and tips are labeled directly by the control itself.</span></span>
    -   <span data-ttu-id="f2552-483">下拉式清單、清單方塊、清單視圖、進度列、滑杆、文字方塊和樹狀檢視會標記在上方、靠左或靠左對齊。</span><span class="sxs-lookup"><span data-stu-id="f2552-483">Drop-down lists, list boxes, list views, progress bars, sliders, text boxes, and tree views are labeled above, flush left, or to the left.</span></span>
    -   <span data-ttu-id="f2552-484">漸進式洩漏控制項通常是未標記的。</span><span class="sxs-lookup"><span data-stu-id="f2552-484">Progressive disclosure controls are usually unlabeled.</span></span> <span data-ttu-id="f2552-485">箭號按鈕會標示在右邊。</span><span class="sxs-lookup"><span data-stu-id="f2552-485">Chevron buttons are labeled to the right.</span></span>
-   <span data-ttu-id="f2552-486">為 **每個互動式控制項指派唯一的存取金鑰**，但連結除外。</span><span class="sxs-lookup"><span data-stu-id="f2552-486">**Assign a unique access key for each interactive control** except for links.</span></span> <span data-ttu-id="f2552-487">如需詳細資訊，請參閱 [鍵盤](inter-keyboard.md)。</span><span class="sxs-lookup"><span data-stu-id="f2552-487">For more information, see [Keyboard](inter-keyboard.md).</span></span>
-   <span data-ttu-id="f2552-488">**將標籤保持簡短。**</span><span class="sxs-lookup"><span data-stu-id="f2552-488">**Keep labels brief.**</span></span> <span data-ttu-id="f2552-489">不過，請注意，將一個或兩個字組新增至標籤有助於清楚起見，有時也不需要補充說明。</span><span class="sxs-lookup"><span data-stu-id="f2552-489">Note, however, that adding a word or two to a label can help clarity, and sometimes eliminates the need for supplemental explanations.</span></span>
-   <span data-ttu-id="f2552-490">**偏好泛型標籤上的特定標籤。**</span><span class="sxs-lookup"><span data-stu-id="f2552-490">**Prefer specific labels over generic ones.**</span></span> <span data-ttu-id="f2552-491">在理想的情況下，使用者不需要讀取任何其他人來瞭解標籤。</span><span class="sxs-lookup"><span data-stu-id="f2552-491">Ideally users shouldn't have to read anything else to understand the label.</span></span>

    <span data-ttu-id="f2552-492">**不正確：**</span><span class="sxs-lookup"><span data-stu-id="f2552-492">**Incorrect:**</span></span>

    ![<span data-ttu-id="f2552-493">[確定] 命令按鈕的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="f2552-493">screen shot of ok command button</span></span> ](images/text-ui-image38.png)

    <span data-ttu-id="f2552-494">**正確：**</span><span class="sxs-lookup"><span data-stu-id="f2552-494">**Correct:**</span></span>

    ![<span data-ttu-id="f2552-495">[發行] 命令按鈕的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="f2552-495">screen shot of publish command button</span></span> ](images/text-ui-image39.png)

    <span data-ttu-id="f2552-496">在正確的範例中，會使用 [認可] 按鈕的特定標籤。</span><span class="sxs-lookup"><span data-stu-id="f2552-496">In the correct example, a specific label is used for the commit button.</span></span>

-   <span data-ttu-id="f2552-497">如需 **標籤清單（例如選項按鈕），請使用平行片語，** 並嘗試保留所有標籤的相同長度。</span><span class="sxs-lookup"><span data-stu-id="f2552-497">**For lists of labels, such as radio buttons, use parallel phrasing,** and try to keep the length about the same for all labels.</span></span>
-   <span data-ttu-id="f2552-498">**如需標籤的清單，請將標籤文字焦點放在選項之間的差異。**</span><span class="sxs-lookup"><span data-stu-id="f2552-498">**For lists of labels, focus the label text on the differences among the options.**</span></span> <span data-ttu-id="f2552-499">如果所有選項都有相同的簡介文字，請將該文字移至群組標籤。</span><span class="sxs-lookup"><span data-stu-id="f2552-499">If all the options have the same introductory text, move that text to the group label.</span></span>

    <span data-ttu-id="f2552-500">**不正確：**</span><span class="sxs-lookup"><span data-stu-id="f2552-500">**Incorrect:**</span></span>

    ![具有重複的第一個片語之標籤的螢幕擷取畫面](images/text-ui-image40.png)

    <span data-ttu-id="f2552-502">**正確：**</span><span class="sxs-lookup"><span data-stu-id="f2552-502">**Correct:**</span></span>

    ![第一個片語移至群組標籤的螢幕擷取畫面](images/text-ui-image41.png)

    <span data-ttu-id="f2552-504">正確的範例會將相同的簡介片語移至標籤，因此這兩個選項的差異更明確。</span><span class="sxs-lookup"><span data-stu-id="f2552-504">The correct example moves the identical introductory phrasing to the label, so the two options are more cleanly differentiated.</span></span>

-   <span data-ttu-id="f2552-505">**一般情況下，建議使用正片語。**</span><span class="sxs-lookup"><span data-stu-id="f2552-505">**In general, prefer positive phrasing.**</span></span> <span data-ttu-id="f2552-506">例如，使用 do 而不是 [否]，而不會通知，而不是 [沒有通知]。</span><span class="sxs-lookup"><span data-stu-id="f2552-506">For example, use do instead of do not, and notify instead of do not notify.</span></span>
    -   <span data-ttu-id="f2552-507">**例外狀況：** 已廣泛使用 [不要再顯示此訊息] 核取方塊標籤。</span><span class="sxs-lookup"><span data-stu-id="f2552-507">**Exception:** The check box label, "Don't show this message again," is widely used.</span></span>
-   <span data-ttu-id="f2552-508">**省略套用至指定類型之所有控制項的指令動詞。**</span><span class="sxs-lookup"><span data-stu-id="f2552-508">**Omit instructional verbs that apply to all controls of the given type.**</span></span> <span data-ttu-id="f2552-509">相反地，會將焦點放在控制項的唯一相關標籤上。</span><span class="sxs-lookup"><span data-stu-id="f2552-509">Rather, focus labels on what is unique about the controls.</span></span> <span data-ttu-id="f2552-510">例如，它不會告訴使用者需要輸入文字方塊控制項，或是使用者必須按一下連結。</span><span class="sxs-lookup"><span data-stu-id="f2552-510">For example, it goes without saying that users need to type into a text box control or that users need to click a link.</span></span>

    <span data-ttu-id="f2552-511">**不正確：**</span><span class="sxs-lookup"><span data-stu-id="f2552-511">**Incorrect:**</span></span>

    ![<span data-ttu-id="f2552-512">標籤的螢幕擷取畫面： [輸入您的名稱]</span><span class="sxs-lookup"><span data-stu-id="f2552-512">screen shot of label: 'type your name'</span></span> ](images/text-ui-image42.png)

    <span data-ttu-id="f2552-513">**正確：**</span><span class="sxs-lookup"><span data-stu-id="f2552-513">**Correct:**</span></span>

    ![<span data-ttu-id="f2552-514">標籤的螢幕擷取畫面： ' 您的名稱 '</span><span class="sxs-lookup"><span data-stu-id="f2552-514">screen shot of label: 'your name'</span></span> ](images/text-ui-image43.png)

    <span data-ttu-id="f2552-515">在不正確的範例中，控制項標籤具有適用于其型別之所有控制項的說明動詞。</span><span class="sxs-lookup"><span data-stu-id="f2552-515">In the incorrect examples, the control labels have instructional verbs that apply to all controls of their type.</span></span>

-   <span data-ttu-id="f2552-516">在某些情況下，控制標籤的下列括弧批註可能很有説明：</span><span class="sxs-lookup"><span data-stu-id="f2552-516">In some cases, the following parenthetical annotations to control labels may be helpful:</span></span>
    -   <span data-ttu-id="f2552-517">**如果選項是選擇性的，請考慮將「 (選擇性) 」新增至標籤。**</span><span class="sxs-lookup"><span data-stu-id="f2552-517">**If an option is optional, consider adding "(optional)" to the label.**</span></span>
    -   <span data-ttu-id="f2552-518">**如果強烈建議選項，請將「 (建議的) 」新增至標籤。**</span><span class="sxs-lookup"><span data-stu-id="f2552-518">**If an option is strongly recommended, add "(recommended)" to the label.**</span></span> <span data-ttu-id="f2552-519">這麼做表示設定是選擇性的，但仍應設定。</span><span class="sxs-lookup"><span data-stu-id="f2552-519">Doing so means the setting is optional, but should be set anyway.</span></span>
    -   <span data-ttu-id="f2552-520">**如果選項僅供 advanced 使用者使用，請考慮將「 (advanced) 」新增至標籤。**</span><span class="sxs-lookup"><span data-stu-id="f2552-520">**If an option is intended only for advanced users, consider adding "(advanced)" to the label.**</span></span>
-   <span data-ttu-id="f2552-521">您可以在標籤後面的括弧中，指定單位 (秒、連接等) 。</span><span class="sxs-lookup"><span data-stu-id="f2552-521">You may specify units (seconds, connections, and so on) in parenthesis after the label.</span></span>

    ![<span data-ttu-id="f2552-522">標籤的螢幕擷取畫面：初始大小 (mb) </span><span class="sxs-lookup"><span data-stu-id="f2552-522">screen shot of label: initial size (mb)</span></span> ](images/text-ui-image44.png)

    <span data-ttu-id="f2552-523">此範例顯示度量單位為 mb (MB) 。</span><span class="sxs-lookup"><span data-stu-id="f2552-523">This example shows that the unit of measurement is megabytes (MB).</span></span>

<span data-ttu-id="f2552-524">如需詳細資訊，請參閱特定 UI 元件指導方針中的「文字」或「標籤」一節。</span><span class="sxs-lookup"><span data-stu-id="f2552-524">For more information, see the "Text" or "Labels" section in the specific UI component guidelines.</span></span>

### <a name="supplemental-explanations"></a><span data-ttu-id="f2552-525">補充說明</span><span class="sxs-lookup"><span data-stu-id="f2552-525">Supplemental explanations</span></span>

-   <span data-ttu-id="f2552-526">**當控制項所需的資訊超過其標籤可傳達的資訊時，請使用補充說明。**</span><span class="sxs-lookup"><span data-stu-id="f2552-526">**Use supplemental explanations when controls require more information than can be conveyed by their label.**</span></span> <span data-ttu-id="f2552-527">但是，如果您可以很簡潔地進行，請不要使用補充說明，如果您不想要將所有專案與控制項標籤進行通訊。</span><span class="sxs-lookup"><span data-stu-id="f2552-527">But don't use a supplemental explanation if one isn't necessary prefer to communicate everything with the control label if you can do so concisely.</span></span> <span data-ttu-id="f2552-528">通常，補充說明會搭配命令連結、選項按鈕和核取方塊使用。</span><span class="sxs-lookup"><span data-stu-id="f2552-528">Typically, supplemental explanations are used with command links, radio buttons, and check boxes.</span></span>
-   <span data-ttu-id="f2552-529">必要時，請 **在控制項標籤中使用粗體，讓文字** 在有補充說明時更容易掃描。</span><span class="sxs-lookup"><span data-stu-id="f2552-529">When necessary, **use bold in the control labels to make the text easier to scan** when there are supplemental explanations.</span></span>

    ![<span data-ttu-id="f2552-530">[安全性-設定] 對話方塊的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="f2552-530">screen shot of security-settings dialog box</span></span> ](images/text-ui-image45.png)

    <span data-ttu-id="f2552-531">在此範例中，選項按鈕標籤為粗體，可讓您更輕鬆地進行掃描。</span><span class="sxs-lookup"><span data-stu-id="f2552-531">In this example, the radio button labels are bold to make them easier to scan.</span></span>

-   <span data-ttu-id="f2552-532">**將補充說明新增至群組中的一個控制項，並不表示您必須為群組中的所有其他控制項提供說明。**</span><span class="sxs-lookup"><span data-stu-id="f2552-532">**Adding a supplemental explanation to one control in a group doesn't mean that you have to provide explanations for all the other controls in the group.**</span></span> <span data-ttu-id="f2552-533">如果您只有在必要時才可以和使用說明，請在標籤中提供相關資訊。</span><span class="sxs-lookup"><span data-stu-id="f2552-533">Provide the relevant information in the label if you can and use explanations only when necessary.</span></span> <span data-ttu-id="f2552-534">沒有只重新聲明一致性標籤的補充說明。</span><span class="sxs-lookup"><span data-stu-id="f2552-534">Don't have supplemental explanations that merely restate the label for consistency.</span></span>

    ![<span data-ttu-id="f2552-535">三個選項按鈕的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="f2552-535">screen shot of three radio buttons</span></span> ](images/text-ui-image46.png)

    <span data-ttu-id="f2552-536">在此範例中，群組中的兩個控制項包含補充說明，但第三個則否。</span><span class="sxs-lookup"><span data-stu-id="f2552-536">In this example, two controls in the group include supplemental explanations, but the third does not.</span></span>

-   <span data-ttu-id="f2552-537">如果有補充說明，請在命令連結之後，以第二個人撰寫補充文字。</span><span class="sxs-lookup"><span data-stu-id="f2552-537">If a supplemental explanation follows a command link, write the supplemental text in second person.</span></span>

    <span data-ttu-id="f2552-538">**範例：** 命令連結：建立無線網路設定並儲存至 USB 快閃磁片磁碟機</span><span class="sxs-lookup"><span data-stu-id="f2552-538">**Example:** Command link: Create wireless network settings and save to USB flash drive</span></span>

    <span data-ttu-id="f2552-539">補充說明：這會建立您可以使用 USB 快閃磁片磁碟機傳送至路由器的設定。</span><span class="sxs-lookup"><span data-stu-id="f2552-539">Supplemental explanation: This will create settings that you can transfer to the router with a USB flash drive.</span></span> <span data-ttu-id="f2552-540">只有當您有支援 USB 快閃磁片磁碟機設定的無線路由器時，才需要這麼做。</span><span class="sxs-lookup"><span data-stu-id="f2552-540">Do this only if you have a wireless router that supports USB flash drive configuration.</span></span>

-   <span data-ttu-id="f2552-541">使用完整的句子和結束標點符號。</span><span class="sxs-lookup"><span data-stu-id="f2552-541">Use complete sentences and ending punctuation.</span></span>

### <a name="commit-button-labels"></a><span data-ttu-id="f2552-542">認可按鈕標籤</span><span class="sxs-lookup"><span data-stu-id="f2552-542">Commit button labels</span></span>

<span data-ttu-id="f2552-543">下表顯示最常見的認可按鈕標籤和其使用方式。</span><span class="sxs-lookup"><span data-stu-id="f2552-543">The following table shows the most common commit button labels and their usage.</span></span>
...
<tbody>
<tr class="odd">
<td><span data-ttu-id="f2552-544"><strong>按鈕標籤</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-544"><strong>Button label</strong></span></span><br/></td>
<td><span data-ttu-id="f2552-545"><strong>意義</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-545"><strong>Meaning</strong></span></span><br/></td>
<td><span data-ttu-id="f2552-546"><strong>使用時機</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-546"><strong>When to use</strong></span></span><br/></td>
<td><span data-ttu-id="f2552-547"><strong>存取金鑰</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-547"><strong>Access key</strong></span></span><br/></td>
</tr>
<tr class="even">
<td><span data-ttu-id="f2552-548"><strong>確定</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-548"><strong>OK</strong></span></span><br/></td>
<td><ul>
<li><span data-ttu-id="f2552-549">在對話方塊中：將變更或認可套用至工作，然後關閉視窗。</span><span class="sxs-lookup"><span data-stu-id="f2552-549">In dialog boxes: apply the changes or commit to the task and close the window.</span></span></li>
<li><span data-ttu-id="f2552-550">在 [擁有者] 屬性視窗中：套用自視窗開啟後 (所做的暫止變更，或上次套用) 並關閉視窗。</span><span class="sxs-lookup"><span data-stu-id="f2552-550">In owner property windows: apply the pending changes (made since the window was opened or the last Apply) and close the window.</span></span></li>
<li><span data-ttu-id="f2552-551">在 [擁有的屬性] 視窗中：保留變更、關閉視窗，並在套用主控視窗的變更時套用變更。</span><span class="sxs-lookup"><span data-stu-id="f2552-551">In owned property windows: keep the changes, close the window, and apply the changes when the owner window's changes are applied.</span></span></li>
</ul></td>
<td><ul>
<li><span data-ttu-id="f2552-552">使用不是特定工作的 windows，例如屬性工作表。</span><span class="sxs-lookup"><span data-stu-id="f2552-552">Use with windows that aren't task specific, such as property sheets.</span></span></li>
<li><span data-ttu-id="f2552-553">針對用來執行一項特定工作的 windows，請使用特定標籤，而不是以動詞 (範例： Print) 。</span><span class="sxs-lookup"><span data-stu-id="f2552-553">For windows used to perform one specific task, use a specific label instead that starts with a verb (example: Print).</span></span></li>
<li><span data-ttu-id="f2552-554">對於使用者無法進行變更的 windows，請使用 [關閉]。</span><span class="sxs-lookup"><span data-stu-id="f2552-554">For windows in which users can't make changes, use Close.</span></span></li>
</ul></td>
<td><span data-ttu-id="f2552-555">Enter</span><span class="sxs-lookup"><span data-stu-id="f2552-555">Enter</span></span><br/></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="f2552-556"><strong>是/否</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-556"><strong>Yes/No</strong></span></span><br/></td>
<td><span data-ttu-id="f2552-557">[是] 是 [是] 或 [否] 問題的肯定回應，而不是負回應。</span><span class="sxs-lookup"><span data-stu-id="f2552-557">Yes is the affirmative response to a yes or no question, whereas No is the negative response.</span></span><br/></td>
<td><ul>
<li><span data-ttu-id="f2552-558">請使用 [是] 和 [無] 按鈕來回應是或沒有任何問題。</span><span class="sxs-lookup"><span data-stu-id="f2552-558">Use Yes and No buttons only to respond to yes or no questions.</span></span> <span data-ttu-id="f2552-559">請勿使用 [確定] 並取消 [是] 或 [否]。</span><span class="sxs-lookup"><span data-stu-id="f2552-559">Never use OK and Cancel for yes or no questions.</span></span></li>
<li><span data-ttu-id="f2552-560">偏好具有 [是] 和 [否] 按鈕的特定回應。</span><span class="sxs-lookup"><span data-stu-id="f2552-560">Prefer specific responses over Yes and No buttons.</span></span> <span data-ttu-id="f2552-561">雖然使用 [是] 和 [否] 並沒有任何問題，但可以更快速地瞭解特定的回應，進而做出有效率的決策。</span><span class="sxs-lookup"><span data-stu-id="f2552-561">While there's nothing wrong with using Yes and No, specific responses can be understood more quickly, resulting in efficient decision making.</span></span></li>
<li><span data-ttu-id="f2552-562">但是，如果特定回應的措辭很長或更難使用，請考慮使用 Yes 和 No 回應。</span><span class="sxs-lookup"><span data-stu-id="f2552-562">However, consider using Yes and No responses if the phrasing of specific responses turns out to be long or awkward.</span></span></li>
<li><span data-ttu-id="f2552-563">如果沒有回應的意義不清楚，請不要使用 [是] 和 [否] 按鈕。</span><span class="sxs-lookup"><span data-stu-id="f2552-563">Don't use Yes and No buttons if the meaning of the No response is unclear.</span></span> <span data-ttu-id="f2552-564">若是如此，請改用特定回應。</span><span class="sxs-lookup"><span data-stu-id="f2552-564">If so, use specific responses instead.</span></span></li>
<li><span data-ttu-id="f2552-565">是，而不一定要用成對的。</span><span class="sxs-lookup"><span data-stu-id="f2552-565">Yes and No must always be used as a pair.</span></span></li>
</ul></td>
<td><span data-ttu-id="f2552-566">Y 和 N</span><span class="sxs-lookup"><span data-stu-id="f2552-566">Y and N</span></span><br/></td>
</tr>
<tr class="even">
<td><span data-ttu-id="f2552-567"><strong>取消</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-567"><strong>Cancel</strong></span></span><br/></td>
<td><ul>
<li><span data-ttu-id="f2552-568">在對話方塊中：捨棄所有變更或進行中的工作、還原為先前的狀態 (不會有明顯的副作用) ，然後關閉視窗。</span><span class="sxs-lookup"><span data-stu-id="f2552-568">In dialog boxes: discard all changes or work in progress, revert to the previous state (leaving no noticeable side effect), and close the window.</span></span></li>
<li><span data-ttu-id="f2552-569">在 [屬性工作表：] 中，捨棄開啟視窗之後 (所做的所有暫止變更，或上次套用) 並關閉視窗。</span><span class="sxs-lookup"><span data-stu-id="f2552-569">In property sheets: discard all pending changes (made since the window was opened or the last Apply) and close the window.</span></span></li>
<li><span data-ttu-id="f2552-570">在 [控制台專案] 中：捨棄所有變更或進行中的工作、還原為先前的狀態，然後返回啟動工作的中樞頁面。</span><span class="sxs-lookup"><span data-stu-id="f2552-570">In control panel items: discard all changes or work in progress, revert to the previous state, and return to the hub page from which the task was launched.</span></span> <span data-ttu-id="f2552-571">如果沒有這類中樞頁面，請改為關閉 [控制台專案] 視窗。</span><span class="sxs-lookup"><span data-stu-id="f2552-571">If there is no such hub page, close the control panel item window instead.</span></span></li>
</ul></td>
<td><ul>
<li><span data-ttu-id="f2552-572">當所有暫止的變更或動作都可以捨棄，且任何副作用都可以復原時使用。</span><span class="sxs-lookup"><span data-stu-id="f2552-572">Use when all pending changes or actions can be discarded and any side effects can be undone.</span></span></li>
<li><span data-ttu-id="f2552-573">針對無法捨棄的變更，請使用 Close。</span><span class="sxs-lookup"><span data-stu-id="f2552-573">For changes that can't be discarded, use Close.</span></span> <span data-ttu-id="f2552-574">若為可停止的動作，請使用 [停止]。</span><span class="sxs-lookup"><span data-stu-id="f2552-574">For actions in progress that can be stopped, use Stop.</span></span> <span data-ttu-id="f2552-575">如果一開始可以捨棄變更或動作，您可以先使用 [取消]，然後在無法復原之後變更為關閉或停止。</span><span class="sxs-lookup"><span data-stu-id="f2552-575">If initially changes or actions can be discarded, you can use Cancel initially then change to Close or Stop once it can't be undone.</span></span></li>
</ul></td>
<td><span data-ttu-id="f2552-576">Esc</span><span class="sxs-lookup"><span data-stu-id="f2552-576">Esc</span></span><br/></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="f2552-577"><strong>關閉</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-577"><strong>Close</strong></span></span><br/></td>
<td><span data-ttu-id="f2552-578">關閉視窗。</span><span class="sxs-lookup"><span data-stu-id="f2552-578">Close the window.</span></span> <span data-ttu-id="f2552-579">不會捨棄任何變更或副作用。</span><span class="sxs-lookup"><span data-stu-id="f2552-579">Any changes or side effects are not discarded.</span></span><br/></td>
<td><ul>
<li><span data-ttu-id="f2552-580">當無法捨棄變更或副作用時使用。</span><span class="sxs-lookup"><span data-stu-id="f2552-580">Use when changes or side effects can't be discarded.</span></span> <span data-ttu-id="f2552-581">針對主要視窗使用 [關閉] 而非 [取消]。</span><span class="sxs-lookup"><span data-stu-id="f2552-581">Use Close instead of Cancel for primary windows.</span></span></li>
<li><span data-ttu-id="f2552-582">用於使用者無法進行變更的 windows。</span><span class="sxs-lookup"><span data-stu-id="f2552-582">Use for windows in which users can't make changes.</span></span></li>
</ul></td>
<td><span data-ttu-id="f2552-583">Alt + F4、Ctrl + F4</span><span class="sxs-lookup"><span data-stu-id="f2552-583">Alt+F4, Ctrl+F4</span></span><br/></td>
</tr>
<tr class="even">
<td><span data-ttu-id="f2552-584"><strong>停止</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-584"><strong>Stop</strong></span></span><br/></td>
<td><span data-ttu-id="f2552-585">停止目前正在執行的工作並關閉視窗。</span><span class="sxs-lookup"><span data-stu-id="f2552-585">Stop a currently running task and close the window.</span></span> <span data-ttu-id="f2552-586">任何正在進行或副作用的工作都不會被捨棄。</span><span class="sxs-lookup"><span data-stu-id="f2552-586">Any work in progress or side effects are not discarded.</span></span><br/></td>
<td><ul>
<li><span data-ttu-id="f2552-587">當進行中的工作和任何副作用都不會被捨棄（通常是使用進度列或動畫）時，請使用。</span><span class="sxs-lookup"><span data-stu-id="f2552-587">Use when work in progress and any side effects can't or won't be discarded, typically with progress bars or animations.</span></span></li>
</ul></td>
<td><span data-ttu-id="f2552-588">Esc</span><span class="sxs-lookup"><span data-stu-id="f2552-588">Esc</span></span><br/></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="f2552-589"><strong>套用</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-589"><strong>Apply</strong></span></span><br/></td>
<td><span data-ttu-id="f2552-590">在 [擁有者] 屬性工作表中：套用自視窗開啟後 (所做的暫止變更，或上次套用) ，但讓視窗保持開啟狀態。</span><span class="sxs-lookup"><span data-stu-id="f2552-590">In owner property sheets: apply the pending changes (made since the window was opened or the last Apply), but leave the window open.</span></span> <span data-ttu-id="f2552-591">這麼做可讓使用者在關閉屬性工作表之前評估變更。</span><span class="sxs-lookup"><span data-stu-id="f2552-591">Doing so allows users to evaluate the changes before closing the property sheet.</span></span> <span data-ttu-id="f2552-592">在擁有的屬性工作表中：不使用。</span><span class="sxs-lookup"><span data-stu-id="f2552-592">In owned property sheets: don't use.</span></span><br/></td>
<td><ul>
<li><span data-ttu-id="f2552-593">只在屬性工作表中使用。</span><span class="sxs-lookup"><span data-stu-id="f2552-593">Use only in property sheets.</span></span></li>
<li><span data-ttu-id="f2552-594">只有當屬性工作表的設定 (至少一個) 具有使用者可透過有意義的方式評估的效果時，才提供 [套用] 按鈕。</span><span class="sxs-lookup"><span data-stu-id="f2552-594">Provide an Apply button only if the property sheet has settings (at least one) with effects that users can evaluate in a meaningful way.</span></span> <span data-ttu-id="f2552-595">一般情況下，[套用] 按鈕會在設定進行可見變更時使用。</span><span class="sxs-lookup"><span data-stu-id="f2552-595">Typically, Apply buttons are used when settings make visible changes.</span></span> <span data-ttu-id="f2552-596">使用者應該能夠套用變更、評估變更，然後根據該評估進行進一步的變更。</span><span class="sxs-lookup"><span data-stu-id="f2552-596">Users should be able to apply a change, evaluate the change, and make further changes based on that evaluation.</span></span> <span data-ttu-id="f2552-597">如果沒有，請移除 [套用] 按鈕，而不要停用它。</span><span class="sxs-lookup"><span data-stu-id="f2552-597">If not, remove the Apply button instead of disabling it.</span></span></li>
</ul></td>
<td><span data-ttu-id="f2552-598">A</span><span class="sxs-lookup"><span data-stu-id="f2552-598">A</span></span><br/></td>
</tr>
<tr class="even">
<td><span data-ttu-id="f2552-599"><strong>下一步</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-599"><strong>Next</strong></span></span><br/></td>
<td><span data-ttu-id="f2552-600">在 [嚮導] 和 [多步驟工作] 中：前進至下一個步驟，而不需要認可工作。</span><span class="sxs-lookup"><span data-stu-id="f2552-600">In wizards and multi-step tasks: advance to the next step without committing to the task.</span></span><br/></td>
<td><ul>
<li><span data-ttu-id="f2552-601">只有在嚮導和多步驟工作中使用，才能前進到下一個步驟而不做任何承諾。</span><span class="sxs-lookup"><span data-stu-id="f2552-601">Use only in wizards and multi-step tasks to advance to the next step without commitment.</span></span></li>
<li><span data-ttu-id="f2552-602">您可以按一下 [上一步]，隨時復原 [下一步] 按鈕的效果。</span><span class="sxs-lookup"><span data-stu-id="f2552-602">The effect of a Next button can always be undone by clicking Back.</span></span></li>
</ul></td>
<td><span data-ttu-id="f2552-603">N</span><span class="sxs-lookup"><span data-stu-id="f2552-603">N</span></span><br/></td>
</tr>
<tr class="odd">
<td><span data-ttu-id="f2552-604"><strong>[完成]</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-604"><strong>Finish</strong></span></span><br/></td>
<td><span data-ttu-id="f2552-605">在 [嚮導] 和 [多步驟工作] 中：關閉視窗。</span><span class="sxs-lookup"><span data-stu-id="f2552-605">In wizards and multi-step tasks: close the window.</span></span> <span data-ttu-id="f2552-606">如果尚未執行此工作，請執行此工作。</span><span class="sxs-lookup"><span data-stu-id="f2552-606">If the task hasn't been performed yet, perform the task.</span></span> <span data-ttu-id="f2552-607">如果已執行該工作，則不會捨棄任何變更或副作用。</span><span class="sxs-lookup"><span data-stu-id="f2552-607">If that task has already been performed, any changes or side effects are not discarded.</span></span><br/></td>
<td><ul>
<li><span data-ttu-id="f2552-608">只使用於嚮導和多步驟工作。</span><span class="sxs-lookup"><span data-stu-id="f2552-608">Use only in wizards and multi-step tasks.</span></span> <span data-ttu-id="f2552-609">但是，不建議使用 [完成]，因為通常會有更明確、更明確的 [認可] 按鈕：</span><span class="sxs-lookup"><span data-stu-id="f2552-609">However, the use of Finish is discouraged because there is usually a better, more specific commit button:</span></span>
<ul>
<li><span data-ttu-id="f2552-610">如果按一下 [對工作的認可] 按鈕 (所以尚未執行此工作) ，請使用以動詞開頭的特定標籤 (範例： [列印]、[連接]、[開始) ] 作為主要指示的回應。</span><span class="sxs-lookup"><span data-stu-id="f2552-610">If clicking the button commits to the task (so the task hasn't already been performed), use a specific label that starts with a verb (examples: Print, Connect, Start) that is a response to the main instruction.</span></span></li>
<li><span data-ttu-id="f2552-611">如果已在嚮導內執行此工作，請改用 [關閉]。</span><span class="sxs-lookup"><span data-stu-id="f2552-611">If the task has already been performed within the wizard, use Close instead.</span></span></li>
</ul></li>
<li><span data-ttu-id="f2552-612">不過，您可以在下列情況下使用 Finish：</span><span class="sxs-lookup"><span data-stu-id="f2552-612">However, you can use Finish when:</span></span>
<ul>
<li><span data-ttu-id="f2552-613">特定標籤仍然是泛型，例如 Save、Select、Choose 或 Get。</span><span class="sxs-lookup"><span data-stu-id="f2552-613">The specific label is still generic, such as Save, Select, Choose, or Get.</span></span></li>
<li><span data-ttu-id="f2552-614">工作牽涉到變更設定或設定集合。</span><span class="sxs-lookup"><span data-stu-id="f2552-614">The task involves changing a setting or collection of settings.</span></span></li>
</ul></li>
</ul></td>
<td><span data-ttu-id="f2552-615">Enter</span><span class="sxs-lookup"><span data-stu-id="f2552-615">Enter</span></span><br/></td>
</tr>
<tr class="even">
<td><span data-ttu-id="f2552-616"><strong>完成</strong></span><span class="sxs-lookup"><span data-stu-id="f2552-616"><strong>Done</strong></span></span><br/></td>
<td><span data-ttu-id="f2552-617">不適用。</span><span class="sxs-lookup"><span data-stu-id="f2552-617">Not applicable.</span></span><br/></td>
<td><ul>
<li><span data-ttu-id="f2552-618">請勿使用。</span><span class="sxs-lookup"><span data-stu-id="f2552-618">Don't use.</span></span> <span data-ttu-id="f2552-619">以命令語法不正確的方式完成。</span><span class="sxs-lookup"><span data-stu-id="f2552-619">Done as a command is grammatically incorrect.</span></span></li>
</ul></td>
<td><span data-ttu-id="f2552-620">不適用。</span><span class="sxs-lookup"><span data-stu-id="f2552-620">Not applicable.</span></span><br/></td>
</tr>
</tbody>
</table>
