...
-   <span data-ttu-id="e48db-156">**快速啟動。**</span><span class="sxs-lookup"><span data-stu-id="e48db-156">**Quick Launch.**</span></span> <span data-ttu-id="e48db-157">使用者選取之程式的直接存取點。</span><span class="sxs-lookup"><span data-stu-id="e48db-157">A direct access point for programs selected by the user.</span></span> <span data-ttu-id="e48db-158">快速啟動已從 Windows 7 移除。</span><span class="sxs-lookup"><span data-stu-id="e48db-158">Quick Launch was removed from Windows 7.</span></span>
...
## <a name="usage-patterns"></a><span data-ttu-id="e48db-226">使用模式</span><span class="sxs-lookup"><span data-stu-id="e48db-226">Usage patterns</span></span>
...
<td><img src="images/winenv-notification-image12.png" alt="Screen shot of notification area and icons " /><br/> <span data-ttu-id="e48db-249">在此範例中，從 Windows Vista 開始，Outlook 和 Windows Live Messenger 是單一實例的應用程式，最小化到通知區域圖示。</span><span class="sxs-lookup"><span data-stu-id="e48db-249">In this example from Windows Vista, Outlook and Windows Live Messenger are single-instance applications that minimize to notification area icons.</span></span><br/> <span data-ttu-id="e48db-250">只有在下列所有情況都適用時，才考慮使用此模式：</span><span class="sxs-lookup"><span data-stu-id="e48db-250">Consider using this pattern only if all of the following apply:</span></span> <br/>
<ul>
...
-   <span data-ttu-id="e48db-266">針對暫時通知來源模式：</span><span class="sxs-lookup"><span data-stu-id="e48db-266">For the temporary notification source pattern:</span></span>
    ...
    | <span data-ttu-id="e48db-277">選用的使用者工作</span><span class="sxs-lookup"><span data-stu-id="e48db-277">Optional user task</span></span><br/>        | <span data-ttu-id="e48db-278">當工作完成時。</span><span class="sxs-lookup"><span data-stu-id="e48db-278">When task is done.</span></span><br/>            |
...
-   <span data-ttu-id="e48db-331">針對 [漸進式擴大](mess-notif.md)， **當情況變得更緊急時，請使用具有逐漸 emphatic 外觀的圖示。**</span><span class="sxs-lookup"><span data-stu-id="e48db-331">For [progressive escalation](mess-notif.md), **use icons with a progressively more emphatic appearance as the situation becomes more urgent.**</span></span>
    ...
    ![<span data-ttu-id="e48db-332">通知區域和五個圖示的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="e48db-332">screen shot of notification area and five icons</span></span> ](images/winenv-notification-image22.png)
...
-   <span data-ttu-id="e48db-352">**不要停用通知區域圖示。**</span><span class="sxs-lookup"><span data-stu-id="e48db-352">**Don't disable notification area icons.**</span></span> <span data-ttu-id="e48db-353">如果目前未套用圖示，請將它移除。</span><span class="sxs-lookup"><span data-stu-id="e48db-353">If the icon doesn't currently apply, remove it.</span></span> <span data-ttu-id="e48db-354">不過，如果使用者可以從圖示啟用，您可以顯示已停用狀態重迭的已啟用圖示。</span><span class="sxs-lookup"><span data-stu-id="e48db-354">However, you can show an enabled icon with a disabled status overlay if users can enable from the icon.</span></span>
    ...
    ![<span data-ttu-id="e48db-355">通知區域和音量滑杆的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="e48db-355">screen shot of notification area and volume slider</span></span> ](images/winenv-notification-image25.png)
...
-   <span data-ttu-id="e48db-366">**顯示最可能想要看到的任何使用者**，可能是：</span><span class="sxs-lookup"><span data-stu-id="e48db-366">**Display whatever users most likely want to see**, which may be:</span></span>
    ...
    -   <span data-ttu-id="e48db-371">狀態飛出視窗。</span><span class="sxs-lookup"><span data-stu-id="e48db-371">A status flyout.</span></span>
        ...
        <span data-ttu-id="e48db-373">在此範例中，按一下滑鼠左鍵會顯示狀態飛出視窗。</span><span class="sxs-lookup"><span data-stu-id="e48db-373">In this example, left clicking displays the status flyout.</span></span>
...
<span data-ttu-id="e48db-393">主要命令</span><span class="sxs-lookup"><span data-stu-id="e48db-393">Primary commands</span></span>
...
<span data-ttu-id="e48db-413">**正確：**</span><span class="sxs-lookup"><span data-stu-id="e48db-413">**Correct:**</span></span>
...
<span data-ttu-id="e48db-437">如需一般內容功能表的指導方針和範例，請參閱 [功能表](cmd-menus.md)。</span><span class="sxs-lookup"><span data-stu-id="e48db-437">For general context menu guidelines and examples, see [Menus](cmd-menus.md).</span></span>
...
### <a name="notification-area-flyouts"></a><span data-ttu-id="e48db-458">通知區域 flyouts</span><span class="sxs-lookup"><span data-stu-id="e48db-458">Notification area flyouts</span></span>
...
-   <span data-ttu-id="e48db-477">無法直接從內容功能表存取的選項，必須位於 [選項] 對話方塊中。</span><span class="sxs-lookup"><span data-stu-id="e48db-477">Options not accessible directly from the context menu must be in the Options dialog box.</span></span> <span data-ttu-id="e48db-478">此對話方塊可能是功能的 [控制台]。</span><span class="sxs-lookup"><span data-stu-id="e48db-478">This dialog could be the feature's control panel.</span></span>
-   <span data-ttu-id="e48db-479">**[選項] 對話方塊可能會在適當的情況下包含下列專案** (確切的文字是以引號括住) ：</span><span class="sxs-lookup"><span data-stu-id="e48db-479">**The Options dialog box may include the following items** as appropriate (exact text is in quotes):</span></span>
    -   <span data-ttu-id="e48db-480">啟用 \[ 功能名稱 \] (核取方塊) </span><span class="sxs-lookup"><span data-stu-id="e48db-480">Enable \[feature name\] (check box)</span></span>
        -   <span data-ttu-id="e48db-481">清除此選項會永久結束程式。</span><span class="sxs-lookup"><span data-stu-id="e48db-481">Clearing this option permanently quits the program.</span></span> <span data-ttu-id="e48db-482">程式可以從其控制台專案重新開機。</span><span class="sxs-lookup"><span data-stu-id="e48db-482">Program can be restarted from its control panel item.</span></span> <span data-ttu-id="e48db-483">內容功能表中的 [結束] 命令只會針對目前的 Windows 會話結束程式。</span><span class="sxs-lookup"><span data-stu-id="e48db-483">The Exit command in the context menu quits the program only for the current Windows session.</span></span>
    -   <span data-ttu-id="e48db-484">「通知區域中顯示圖示」 (核取方塊) </span><span class="sxs-lookup"><span data-stu-id="e48db-484">"Display icon in notification area" (check box)</span></span>
        -   <span data-ttu-id="e48db-485">從通知區域移除圖示，並不會影響基礎功能。</span><span class="sxs-lookup"><span data-stu-id="e48db-485">Removing the icon from the notification area doesn't affect the underlying feature.</span></span>
        -   <span data-ttu-id="e48db-486">選取此選項可讓使用者還原圖示，當然無法從圖示本身完成。</span><span class="sxs-lookup"><span data-stu-id="e48db-486">Selecting this option allows user to restore the icon, which of course can't be done from the icon itself.</span></span>
-   <span data-ttu-id="e48db-487">停用很少使用或可能令人討厭或混亂的功能。</span><span class="sxs-lookup"><span data-stu-id="e48db-487">Disable features that are rarely used, or potentially annoying or distracting.</span></span> <span data-ttu-id="e48db-488">讓使用者 [加入宣告](glossary.md) 這類功能。</span><span class="sxs-lookup"><span data-stu-id="e48db-488">Let users [opt in](glossary.md) to such features.</span></span>

<span data-ttu-id="e48db-489">如需一般選項對話方塊的指導方針和範例，請參閱 [屬性視窗](win-property-win.md)。</span><span class="sxs-lookup"><span data-stu-id="e48db-489">For general Options dialog box guidelines and examples, see [Property Windows](win-property-win.md).</span></span>

### <a name="minimizing-programs-to-the-notification-area"></a><span data-ttu-id="e48db-490">將程式降至最低通知區域</span><span class="sxs-lookup"><span data-stu-id="e48db-490">Minimizing programs to the notification area</span></span>

<span data-ttu-id="e48db-491">**注意： Windows 7 不再建議將程式視窗最小化至通知區域。**</span><span class="sxs-lookup"><span data-stu-id="e48db-491">**Note: Minimizing program windows to the notification area is no longer recommended for Windows 7.**</span></span> <span data-ttu-id="e48db-492">請改用一般 [工作列](winenv-taskbar.md) 按鈕。</span><span class="sxs-lookup"><span data-stu-id="e48db-492">Use regular [taskbar](winenv-taskbar.md) buttons instead.</span></span> <span data-ttu-id="e48db-493">您的程式可能會支援這兩種機制來提供回溯相容性。</span><span class="sxs-lookup"><span data-stu-id="e48db-493">Your program may support both mechanisms for backward compatibility.</span></span>

-   <span data-ttu-id="e48db-494">若要減少工作列雜亂，請考慮提供將程式最小化到通知區域的功能，只適用于下列所有專案：</span><span class="sxs-lookup"><span data-stu-id="e48db-494">To reduce taskbar clutter, consider providing the ability to minimize programs to the notification area only if all of the following apply:</span></span>
    -   <span data-ttu-id="e48db-495">程式只能有一個單一實例。</span><span class="sxs-lookup"><span data-stu-id="e48db-495">The program can have only a single instance.</span></span>
    -   <span data-ttu-id="e48db-496">此程式會執行一段很長的時間。</span><span class="sxs-lookup"><span data-stu-id="e48db-496">The program is run for an extended period of time.</span></span>
    -   <span data-ttu-id="e48db-497">圖示會顯示狀態。</span><span class="sxs-lookup"><span data-stu-id="e48db-497">The icon shows status.</span></span>
    -   <span data-ttu-id="e48db-498">圖示可以是通知來源。</span><span class="sxs-lookup"><span data-stu-id="e48db-498">The icon can be a notification source.</span></span>
    -   <span data-ttu-id="e48db-499">這麼做是選擇性的，使用者必須 [加入宣告](glossary.md)。</span><span class="sxs-lookup"><span data-stu-id="e48db-499">Doing so is optional and users must [opt in](glossary.md).</span></span>
-   <span data-ttu-id="e48db-500">使用應用程式標題列上的 [最小化] 按鈕，而不是 [關閉] 按鈕。</span><span class="sxs-lookup"><span data-stu-id="e48db-500">Use the Minimize button on the application's title bar, not the Close button.</span></span>

## <a name="text"></a><span data-ttu-id="e48db-501">Text</span><span class="sxs-lookup"><span data-stu-id="e48db-501">Text</span></span>

### <a name="infotips"></a><span data-ttu-id="e48db-502">提示</span><span class="sxs-lookup"><span data-stu-id="e48db-502">Infotips</span></span>

-   <span data-ttu-id="e48db-503">圖示提示應該具有下列其中一種格式 (其中公司名稱是選擇性的) ：</span><span class="sxs-lookup"><span data-stu-id="e48db-503">The icon infotip should have one of the following formats (where the company name is optional):</span></span>
    -   <span data-ttu-id="e48db-504"> (的公司名稱) 功能、程式或裝置名稱</span><span class="sxs-lookup"><span data-stu-id="e48db-504">(Company name) Feature, program, or device name</span></span>
    -   ![<span data-ttu-id="e48db-505">具有公司名稱的提示螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="e48db-505">screen shot of infotip with company name</span></span> ](images/winenv-notification-image37.png)
    -   <span data-ttu-id="e48db-506"> (的公司名稱) 功能、程式或裝置名稱-狀態摘要</span><span class="sxs-lookup"><span data-stu-id="e48db-506">(Company name) Feature, program, or device name - Status summary</span></span>
    -   ![<span data-ttu-id="e48db-507">顯示狀態摘要的提示螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="e48db-507">screen shot of infotip displaying status summary</span></span> ](images/winenv-notification-image38.png)
    -   <span data-ttu-id="e48db-508"> (的公司名稱) 功能、程式或裝置名稱的狀態語句。</span><span class="sxs-lookup"><span data-stu-id="e48db-508">(Company name) Feature, program, or device name status statement.</span></span>
    -   ![<span data-ttu-id="e48db-509">顯示狀態語句的顯示提示螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="e48db-509">screen shot of infotip displaying status statement</span></span> ](images/winenv-notification-image39.png)
    -   <span data-ttu-id="e48db-510"> (的公司名稱) 功能、程式或裝置名稱</span><span class="sxs-lookup"><span data-stu-id="e48db-510">(Company name) Feature, program, or device name</span></span>
    -   <span data-ttu-id="e48db-511">不同行上每個專案的狀態清單</span><span class="sxs-lookup"><span data-stu-id="e48db-511">Status list with each item on a separate line</span></span>
    -   ![<span data-ttu-id="e48db-512">顯示狀態清單的顯示提示螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="e48db-512">screen shot of infotip displaying status list</span></span> ](images/winenv-notification-image40.png)

<span data-ttu-id="e48db-513">提示表達：</span><span class="sxs-lookup"><span data-stu-id="e48db-513">Infotip phrasing:</span></span>

-   <span data-ttu-id="e48db-514">將焦點放在最有用的資訊。</span><span class="sxs-lookup"><span data-stu-id="e48db-514">Focus on the most useful information.</span></span> <span data-ttu-id="e48db-515">在左側按一下滑鼠右鍵時顯示其他資訊。</span><span class="sxs-lookup"><span data-stu-id="e48db-515">Display other information on left single-click.</span></span>
-   <span data-ttu-id="e48db-516">很簡潔。</span><span class="sxs-lookup"><span data-stu-id="e48db-516">Be concise.</span></span> <span data-ttu-id="e48db-517">使用句子片段或簡單語句。</span><span class="sxs-lookup"><span data-stu-id="e48db-517">Use sentence fragments or simple statements.</span></span>
-   <span data-ttu-id="e48db-518">除非提示片語為完整句子，否則請勿使用結尾標點符號。</span><span class="sxs-lookup"><span data-stu-id="e48db-518">Don't use ending punctuation unless tip is phrased as a complete sentence.</span></span>
-   <span data-ttu-id="e48db-519">省略不必要的字組。</span><span class="sxs-lookup"><span data-stu-id="e48db-519">Omit unnecessary words.</span></span> <span data-ttu-id="e48db-520">請勿包含軟體版本或其他無關的資訊。</span><span class="sxs-lookup"><span data-stu-id="e48db-520">Don't include the software version or other extraneous information.</span></span>

    <span data-ttu-id="e48db-521">**不正確：**</span><span class="sxs-lookup"><span data-stu-id="e48db-521">**Incorrect:**</span></span>

    ![<span data-ttu-id="e48db-522">具有不必要資訊的資訊提示螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="e48db-522">screen shot of infotip with unnecessary information</span></span> ](images/winenv-notification-image41.png)

    <span data-ttu-id="e48db-523">在此範例中，資訊提示有無關的資訊。</span><span class="sxs-lookup"><span data-stu-id="e48db-523">In this example, the infotip has extraneous information.</span></span>

-   <span data-ttu-id="e48db-524">請勿解釋如何與圖示互動。</span><span class="sxs-lookup"><span data-stu-id="e48db-524">Don't explain how to interact with the icon.</span></span>

    <span data-ttu-id="e48db-525">**不正確：**</span><span class="sxs-lookup"><span data-stu-id="e48db-525">**Incorrect:**</span></span>

    ![<span data-ttu-id="e48db-526">以滑鼠右鍵按一下指示的顯示提示螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="e48db-526">screen shot of infotip with right-click instructions</span></span> ](images/winenv-notification-image42.png)

    <span data-ttu-id="e48db-527">在此範例中，[無線網路連線] 圖示提供按滑鼠右鍵的指示。</span><span class="sxs-lookup"><span data-stu-id="e48db-527">In this example, the Wireless Network Connection icon gives right-click instructions.</span></span>

## <a name="documentation"></a><span data-ttu-id="e48db-528">文件</span><span class="sxs-lookup"><span data-stu-id="e48db-528">Documentation</span></span>

<span data-ttu-id="e48db-529">參考通知區域時：</span><span class="sxs-lookup"><span data-stu-id="e48db-529">When referring to the notification area:</span></span>

-   <span data-ttu-id="e48db-530">請將通知區域稱為通知區域，而不是系統匣。</span><span class="sxs-lookup"><span data-stu-id="e48db-530">Refer to the notification area as the notification area, not the system tray.</span></span>

<span data-ttu-id="e48db-531">參考通知區域圖示時：</span><span class="sxs-lookup"><span data-stu-id="e48db-531">When referring to a notification area icon:</span></span>

-   <span data-ttu-id="e48db-532">請使用其提示中提供的確切名稱來參考圖示，包括其大小寫，後面接著圖示。</span><span class="sxs-lookup"><span data-stu-id="e48db-532">Refer to the icon using the exact name given in its infotip, including its capitalization, followed by icon.</span></span>
-   <span data-ttu-id="e48db-533">第一個參考也請參閱通知區域。</span><span class="sxs-lookup"><span data-stu-id="e48db-533">For the first reference, also refer to the notification area.</span></span>
-   <span data-ttu-id="e48db-534">可能的話，請使用粗體格式化標題文字。</span><span class="sxs-lookup"><span data-stu-id="e48db-534">When possible, format the heading text using bold.</span></span> <span data-ttu-id="e48db-535">否則，請只在必要時才將標題放在引號中，以避免混淆。</span><span class="sxs-lookup"><span data-stu-id="e48db-535">Otherwise, put the heading in quotation marks only if required to prevent confusion.</span></span>

<span data-ttu-id="e48db-536">**範例：** 若要快速檢查網路狀態，請按一下通知區域中的 **網路** 圖示。</span><span class="sxs-lookup"><span data-stu-id="e48db-536">**Example:** To check the network status quickly, click the **Network** icon in the notification area.</span></span>
