...
<span data-ttu-id="82bf4-206">在此範例中，需要考慮正確的回應。</span><span class="sxs-lookup"><span data-stu-id="82bf4-206">In this example, the correct response requires thought.</span></span>
...
<span data-ttu-id="82bf4-224">[Windows XP 確認檔案取代] 對話方塊。</span><span class="sxs-lookup"><span data-stu-id="82bf4-224">The Windows XP Confirm File Replace dialog box.</span></span>
...
![<span data-ttu-id="82bf4-260">[您要變更設定嗎？] 的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="82bf4-260">screen shot of 'do you want to change settings?'</span></span> ](images/mess-confirm-image10.png)
...
<span data-ttu-id="82bf4-352">在此範例中，會使用警告圖示來詢問例行問題。</span><span class="sxs-lookup"><span data-stu-id="82bf4-352">In this example, a warning icon is used to ask a routine question.</span></span>
...
![<span data-ttu-id="82bf4-419">[確認檔案刪除] 對話方塊的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="82bf4-419">screen shot of 'confirm file delete' dialog box</span></span> ](images/mess-confirm-image35.png)
...
### <a name="main-instructions"></a><span data-ttu-id="82bf4-456">主要指示</span><span class="sxs-lookup"><span data-stu-id="82bf4-456">Main instructions</span></span>
...
-   <span data-ttu-id="82bf4-479">雖然片語沒有嚴格的規則，但 **這些常見的確認片語具有指出的含意：**</span><span class="sxs-lookup"><span data-stu-id="82bf4-479">While there are no strict rules for phrasing, **these common confirmation phrases have the indicated connotation:**</span></span>
    ...
    | <span data-ttu-id="82bf4-480">片語</span><span class="sxs-lookup"><span data-stu-id="82bf4-480">Phrase</span></span>                                                            | <span data-ttu-id="82bf4-481">內涵</span><span class="sxs-lookup"><span data-stu-id="82bf4-481">Connotation</span></span>                                                            |
    |-------------------------------------------------------------|-------------------------------------------------------------|
...
-   <span data-ttu-id="82bf4-490">針對具風險的動作確認，請永久使用該詞彙來指出動作無法復原。</span><span class="sxs-lookup"><span data-stu-id="82bf4-490">For risky action confirmations, use the term permanently to indicate that an action can't be undone.</span></span>

![<span data-ttu-id="82bf4-491">永久刪除確認的螢幕擷取畫面</span><span class="sxs-lookup"><span data-stu-id="82bf4-491">screen shot of permanent deletion confirmation</span></span> ](images/mess-confirm-image37.png)

<span data-ttu-id="82bf4-492">在此範例中，「永久」表示動作無法復原。</span><span class="sxs-lookup"><span data-stu-id="82bf4-492">In this example, "permanently" indicates that the action can't be undone.</span></span>

-   <span data-ttu-id="82bf4-493">使用 [句子樣式的大小寫](glossary.md)。</span><span class="sxs-lookup"><span data-stu-id="82bf4-493">Use [sentence-style capitalization](glossary.md).</span></span>

### <a name="supplemental-instructions"></a><span data-ttu-id="82bf4-494">補充指示</span><span class="sxs-lookup"><span data-stu-id="82bf4-494">Supplemental instructions</span></span>

-   <span data-ttu-id="82bf4-495">**確認的補充指示是根據其設計模式：**</span><span class="sxs-lookup"><span data-stu-id="82bf4-495">**The supplemental instruction for a confirmation is based on its design pattern:**</span></span>
    ...
    <tbody>
    <tr class="odd">
    <td><span data-ttu-id="82bf4-496"><strong>模式</strong></span><span class="sxs-lookup"><span data-stu-id="82bf4-496"><strong>Pattern</strong></span></span><br/></td>
    <td><span data-ttu-id="82bf4-497"><strong>補充指示</strong></span><span class="sxs-lookup"><span data-stu-id="82bf4-497"><strong>Supplemental instruction</strong></span></span><br/></td>
    </tr>
    <tr class="even">
    <td><span data-ttu-id="82bf4-498">非預期的結果確認</span><span class="sxs-lookup"><span data-stu-id="82bf4-498">Unintended consequence confirmations</span></span> <br/></td>
    <td><span data-ttu-id="82bf4-499">請詢問一個問題，以判斷使用者是否想要繼續進行。</span><span class="sxs-lookup"><span data-stu-id="82bf4-499">Ask a single question to determine if the user wants to proceed.</span></span> <br/></td>
    </tr>
    <tr class="odd">
    <td><span data-ttu-id="82bf4-500">All others</span><span class="sxs-lookup"><span data-stu-id="82bf4-500">All others</span></span> <br/></td>
    <td><span data-ttu-id="82bf4-501">說明使用者可能不想繼續的任何非明顯原因。</span><span class="sxs-lookup"><span data-stu-id="82bf4-501">Explain any non-obvious reasons why the user might not want to proceed.</span></span> <span data-ttu-id="82bf4-502">原因包括：</span><span class="sxs-lookup"><span data-stu-id="82bf4-502">Such reasons include:</span></span> <br/>
    <ul>
    <li><span data-ttu-id="82bf4-503">可能會遺失下列一或多項：</span><span class="sxs-lookup"><span data-stu-id="82bf4-503">Potential loss of one or more of the following:</span></span> <ul>
    <li><span data-ttu-id="82bf4-504">有價值的資產，例如資料遺失或財務損失。</span><span class="sxs-lookup"><span data-stu-id="82bf4-504">A valuable asset, such as data loss or financial loss.</span></span></li>
    <li><span data-ttu-id="82bf4-505">系統存取或完整性。</span><span class="sxs-lookup"><span data-stu-id="82bf4-505">System access or integrity.</span></span></li>
    <li><span data-ttu-id="82bf4-506">隱私權或對機密資訊的控制。</span><span class="sxs-lookup"><span data-stu-id="82bf4-506">Privacy or control over confidential information.</span></span></li>
    </ul></li>
    <li><span data-ttu-id="82bf4-507">無法復原的動作。</span><span class="sxs-lookup"><span data-stu-id="82bf4-507">Actions that are irreversible.</span></span></li>
    </ul></td>
    </tr>
    </tbody>
    </table>
...
-   <span data-ttu-id="82bf4-508">**請勿以稍微不同的用語重複主要指令。**</span><span class="sxs-lookup"><span data-stu-id="82bf4-508">**Don't repeat the main instruction with slightly different wording.**</span></span> <span data-ttu-id="82bf4-509">相反地，如果沒有其他要新增的指令，請省略補充指令。</span><span class="sxs-lookup"><span data-stu-id="82bf4-509">Instead, omit the supplemental instruction if there is not more to add.</span></span>
-   <span data-ttu-id="82bf4-510">**針對非預期的結果確認，請考慮使用詞彙，以確定不會** 在使用者忽略主要指示的情況下繼續進行。</span><span class="sxs-lookup"><span data-stu-id="82bf4-510">**For unintended consequence confirmations, consider using the term anyway to concisely indicate that there is a reason not to continue** in case the user overlooked the main instruction.</span></span> <span data-ttu-id="82bf4-511">如需詳細資訊，請參閱設計概念。</span><span class="sxs-lookup"><span data-stu-id="82bf4-511">See Design Concepts for more information.</span></span>
-   <span data-ttu-id="82bf4-512">使用完整句子、句子樣式的大小寫和結束標點符號。</span><span class="sxs-lookup"><span data-stu-id="82bf4-512">Use complete sentences, sentence-style capitalization, and ending punctuation.</span></span>

## <a name="documentation"></a><span data-ttu-id="82bf4-513">文件</span><span class="sxs-lookup"><span data-stu-id="82bf4-513">Documentation</span></span>

<span data-ttu-id="82bf4-514">參考確認時：</span><span class="sxs-lookup"><span data-stu-id="82bf4-514">When referring to confirmations:</span></span>

-   <span data-ttu-id="82bf4-515">如果標題是確認 (（而不是方案名稱) ;），請依標題參閱確認的標題。否則，請使用其主要指示來參考它。</span><span class="sxs-lookup"><span data-stu-id="82bf4-515">Refer to a confirmation by its title if the title is specific to the confirmation (that is, not the program name); otherwise, refer to it by its main instruction.</span></span>
-   <span data-ttu-id="82bf4-516">如有必要，您可以將確認對話方塊參考為訊息。</span><span class="sxs-lookup"><span data-stu-id="82bf4-516">If necessary, you may refer to a confirmation dialog box as a message.</span></span>
-   <span data-ttu-id="82bf4-517">使用完全相符的文字，包括其大小寫。</span><span class="sxs-lookup"><span data-stu-id="82bf4-517">Use the exact text, including its capitalization.</span></span>
-   <span data-ttu-id="82bf4-518">可能的話，請使用粗體格式化文字。</span><span class="sxs-lookup"><span data-stu-id="82bf4-518">When possible, format the text using bold.</span></span> <span data-ttu-id="82bf4-519">否則，請只在必要時才將文字放在引號中，以避免混淆。</span><span class="sxs-lookup"><span data-stu-id="82bf4-519">Otherwise, put the text in quotation marks only if required to prevent confusion.</span></span>

<span data-ttu-id="82bf4-520">範例：在 [ **複製** 檔案] 訊息中，按一下較新的檔案。</span><span class="sxs-lookup"><span data-stu-id="82bf4-520">Example: In the **Copy File** message, click the newer file.</span></span>
