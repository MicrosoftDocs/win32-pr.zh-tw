...
| **FILEFLAGSMASK** *FILEFLAGSMASK* | 指出 **fileflags 機碼** 語句中的位有效。 若為16位 Windows，此值為0x3f。                                                                                                                                                                                                                                                                                                                                          |
...
| **VOS \_ DOS \_ WINDOWS16** | 檔案是針對使用 MS-DOS 執行的16位 Windows 所設計。        |
