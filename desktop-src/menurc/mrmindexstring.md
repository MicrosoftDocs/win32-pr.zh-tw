...
ms.locfileid: "117687250"
---
# <a name="mrmindexstring-function"></a>MrmIndexString 函式

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

為屬於 UWP 應用程式的單一字串資源編制索引。 接受明確 (，但) 資源限定詞的選擇性清單。 如需詳細資訊，以及如何使用這些 Api 的案例式逐步解說，請參閱 [封裝資源索引 (PRI) api 和自訂群組建系統](/windows/uwp/app-resources/pri-apis-custom-build-systems)。
