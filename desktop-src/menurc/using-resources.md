...
<span data-ttu-id="51927-115">下列程式碼會執行這些步驟。</span><span class="sxs-lookup"><span data-stu-id="51927-115">The following code implements these steps.</span></span>
