...
建立資源索引子，用來為 UWP 應用程式 (PRI) 檔產生封裝資源索引。 如需詳細資訊，以及如何使用這些 Api 的案例式逐步解說，請參閱 [封裝資源索引 (PRI) api 和自訂群組建系統](/windows/uwp/app-resources/pri-apis-custom-build-systems)。
...
您將產生 PRI 檔案之 UWP 應用程式的套件系列名稱。 當您稍後從此資源索引子產生 PRI 檔案時，將會使用此值做為資源對應名稱。
