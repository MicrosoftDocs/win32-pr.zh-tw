...
* [**EnumResourceNamesW**](/windows/win32/api/Winbase/nf-winbase-enumresourcenamesw)和 [**EnumResourceNamesExW**](/windows/win32/api/libloaderapi/nf-libloaderapi-enumresourcenamesexw)函式會提供指定類型內每個資源的名稱。
