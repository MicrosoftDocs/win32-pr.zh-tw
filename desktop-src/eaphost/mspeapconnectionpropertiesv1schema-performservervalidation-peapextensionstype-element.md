...
ms.locfileid: "119042826"
---
# <a name="performservervalidation-peapextensionstype-element-v1-schema"></a>PerformServerValidation (PeapExtensionsType) 元素 (v1 架構) 

**PerformServerValidation (PeapExtensionsType)** 元素指出是否執行伺服器驗證。
