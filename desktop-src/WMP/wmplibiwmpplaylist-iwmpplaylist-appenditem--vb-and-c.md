...
ms.locfileid: "120098698"
---
# <a name="iwmpplaylistappenditem-method"></a>IWMPPlaylist：： appendItem 方法
...
代表要附加之媒體專案的 **WMPLib IWMPMedia** 介面。
...
下列範例會使用 **appendItem** 將目前的媒體專案新增至名為 "ThreeList" 的播放清單。 **AxWMPLib. AxWindowsMediaPlayer** 物件是以名為 player 的變數來表示。
