...
## <a name="windows-media-player-property-changes"></a>Windows Media Player屬性變更
...
## <a name="windows-media-player-method-changes"></a>Windows Media Player方法變更
...
然後，您將指派當值變更時要執行的 JScript 字串。 例如，若要回應可用來調整 Windows Media Player 音量之文字方塊值的變更，請在您的 **text** 元素內部輸入下列內容做為屬性：
