...
---
# <a name="example-serviceinfo-document-for-a-type-2-online-store"></a><span data-ttu-id="e6798-114">Type 2 線上商店的範例 ServiceInfo 檔</span><span class="sxs-lookup"><span data-stu-id="e6798-114">Example ServiceInfo Document for a Type 2 Online Store</span></span>

<span data-ttu-id="e6798-115">下列程式碼範例顯示完整的 ServiceInfo.xml 檔。</span><span class="sxs-lookup"><span data-stu-id="e6798-115">The following code example shows a complete ServiceInfo.xml document.</span></span> <span data-ttu-id="e6798-116">您可以使用這個 XML 做為您自己的 ServiceInfo 檔的起點。</span><span class="sxs-lookup"><span data-stu-id="e6798-116">You can use this XML as a starting point for your own ServiceInfo document.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="e6798-117">相關主題</span><span class="sxs-lookup"><span data-stu-id="e6798-117">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="e6798-118">**Type 2 線上商店的程式設計指南**</span><span class="sxs-lookup"><span data-stu-id="e6798-118">**Programming Guide for Type 2 Online Stores**</span></span>](programming-guide-for-type-2-online-stores.md)
</dt> <dt>

[<span data-ttu-id="e6798-119">**適用于 Type 2 線上商店的 ServiceInfo 檔**</span><span class="sxs-lookup"><span data-stu-id="e6798-119">**ServiceInfo Document for a Type 2 Online Store**</span></span>](serviceinfo-document-for-a-type-2-online-store.md)
</dt> <dt>

[<span data-ttu-id="e6798-120">**ServiceInfo 檔**</span><span class="sxs-lookup"><span data-stu-id="e6798-120">**ServiceInfo Document**</span></span>](serviceinfo-document.md)
</dt> </dl>
