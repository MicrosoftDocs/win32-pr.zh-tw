...
description: SplineTension 屬性會指定或抓取等化器控制項的曲線張力。
...
- apiref
api_name:
- EQUALIZERSETTINGS.splineTension
api_type:
- NA
ms.topic: reference
ms.date: 05/31/2018
...
這個屬性是讀取 **/寫入 (** **浮點數**) 範圍從 0.0 (沒有張力) 10.0 (具有預設值3.0 的完整張力) 。
