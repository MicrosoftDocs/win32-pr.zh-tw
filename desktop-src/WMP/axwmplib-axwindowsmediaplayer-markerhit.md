...
---
# <a name="markerhit-event-of-the-axwindowsmediaplayer-object"></a>AxWindowsMediaPlayer 物件的 MarkerHit 事件
...
與這個事件相關聯的處理常式屬於 **AxWMPLib 型別。 \_WMPOCXEvents \_ MarkerHitEventHandler**。 這個處理常式會接收 AxWMPLib 型別的引數 **。 \_WMPOCXEvents \_ MarkerHitEvent**，其中包含與這個事件相關的下列屬性。



| 屬性      | 描述                                                             |
|---------------|-------------------------------------------------------------------------|
| **MarkerNum** | Int32Indicates 已點擊的標記數目。<br/> |
