...
ms.locfileid: "106965217"
---
# <a name="enumerating-the-media-items"></a><span data-ttu-id="c9d59-116">列舉媒體專案</span><span class="sxs-lookup"><span data-stu-id="c9d59-116">Enumerating the Media Items</span></span>

<span data-ttu-id="c9d59-117">下列程式碼會顯示個別播放清單中包含的媒體專案。</span><span class="sxs-lookup"><span data-stu-id="c9d59-117">The following code displays the media items contained in an individual playlist.</span></span> <span data-ttu-id="c9d59-118">當使用者按一下 IDC PLVIEW 所識別的 ListView 控制項中的播放清單時，就會執行此程式碼 \_ 。</span><span class="sxs-lookup"><span data-stu-id="c9d59-118">This code runs when the user clicks a playlist in the ListView control identified by IDC\_PLVIEW.</span></span>
...
<span data-ttu-id="c9d59-119">如需 GetPartnershipSyncState 函式的執行，請參閱 [判斷播放清單同步處理狀態](determining-playlist-synchronization-state.md)。</span><span class="sxs-lookup"><span data-stu-id="c9d59-119">For the implementation of the GetPartnershipSyncState function, see [Determining Playlist Synchronization State](determining-playlist-synchronization-state.md).</span></span>

## <a name="related-topics"></a><span data-ttu-id="c9d59-120">相關主題</span><span class="sxs-lookup"><span data-stu-id="c9d59-120">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="c9d59-121">**IWMPMedia 介面**</span><span class="sxs-lookup"><span data-stu-id="c9d59-121">**IWMPMedia Interface**</span></span>](/previous-versions/windows/desktop/api/wmp/nn-wmp-iwmpmedia)
</dt> <dt>

[<span data-ttu-id="c9d59-122">**IWMPPlaylist 介面**</span><span class="sxs-lookup"><span data-stu-id="c9d59-122">**IWMPPlaylist Interface**</span></span>](/previous-versions/windows/desktop/api/wmp/nn-wmp-iwmpplaylist)
</dt> <dt>

[<span data-ttu-id="c9d59-123">**管理同步播放清單**</span><span class="sxs-lookup"><span data-stu-id="c9d59-123">**Managing Synchronization Playlists**</span></span>](managing-synchronization-playlists.md)
</dt> </dl>
