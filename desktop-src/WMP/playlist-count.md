---
title: 播放清單。計數
description: Count 屬性會抓取播放清單中的媒體專案數目。
ms.assetid: fd3265f3-3ab7-43e6-abc0-920225a66da6
keywords:
- 播放清單。計數 Windows Media Player
topic_type:
- apiref
api_name:
- Playlist.count
...
ms.locfileid: "119862328"
---
# <a name="playlistcount"></a>播放清單。計數

**Count** 屬性會抓取播放清單中的媒體專案數目。

## <a name="syntax"></a>Syntax

*玩家*。*currentPlaylist*。**計數**
