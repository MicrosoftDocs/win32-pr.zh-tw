...
---
# <a name="iwmpmediaimagesourcewidth-property"></a>IWMPMedia：： imageSourceWidth 屬性

**ImageSourceWidth** 屬性會取得目前媒體專案的寬度（以圖元為單位）。
...
下列範例會使用 **imageSourceWidth** ，在文字方塊中顯示目前媒體專案的影像大小（以圖元為單位）。 **AxWMPLib. AxWindowsMediaPlayer** 物件是以名為 player 的變數來表示。
