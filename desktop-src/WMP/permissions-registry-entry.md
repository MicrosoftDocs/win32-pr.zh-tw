...
| 128                  | 轉碼的許可權。 具有已註冊之副檔名的檔案，在特定情況下可以轉碼為 Windows 媒體格式。 請參閱 [IWMPTranscodePolicy：： allowTranscode](/previous-versions/windows/desktop/api/wmpservices/nf-wmpservices-iwmptranscodepolicy-allowtranscode)。 需要 Windows Media Player 10 或更新版本。 |
