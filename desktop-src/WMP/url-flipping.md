...
ms.locfileid: "119134521"
---
# <a name="url-flipping"></a>URL 翻轉

使用投影片放映的網頁稱為 url 翻轉，並會在遇到內嵌于所播放數位媒體資料流程中的 url 指令碼命令時由 Windows Media Player 自動處理。 您可以在每個指令碼命令中指定頁面的目標框架，也可以藉由設定 **設定 defaultFrame** 屬性來指定。 您可以在腳本中設定此屬性，或在內嵌 Windows Media Player 控制項的 OBJECT 元素內使用 PARAM 專案。
