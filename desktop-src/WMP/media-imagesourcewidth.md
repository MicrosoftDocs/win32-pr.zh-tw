...
ms.locfileid: "119508398"
---
# <a name="mediaimagesourcewidth"></a>ImageSourceWidth

**ImageSourceWidth** 屬性會抓取目前媒體專案的寬度（以圖元為單位）。

## <a name="syntax"></a>Syntax

*玩家*。*currentMedia*。**imageSourceWidth**
...
下列 JScript 範例會使用 *媒體*。**imageSourceWidth** ：顯示目前媒體專案的影像大小（以圖元為單位） **。這項資訊會列印到名為 VideoSize 的 HTML TEXTAREA 元素。** 使用 ID = "player" 建立 player 物件。
