...
ms.locfileid: "119648428"
---
# <a name="externalselecteditemid"></a>SelectedItemID
...
**SelectedItemID** 屬性會抓取 Windows Media Player 中目前選取之媒體專案的識別碼。
...
這個屬性會與 [selectedItemType](external-selecteditemtype.md) 屬性搭配使用。 例如，如果 **selectedItemType** 等於 CPTrackID，則 **selectedItemID** 是所選播放軌的識別碼。如需 Windows Media Player 如何讓線上商店內容的觀點有詳細的詳細資訊，請參閱 [位置和選取的專案](location-and-selected-item.md)。
...
[**SelectedItemType**](external-selecteditemtype.md)
</dt> <dt>
