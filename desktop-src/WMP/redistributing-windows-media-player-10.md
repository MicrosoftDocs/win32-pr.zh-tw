...
---
# <a name="redistributing-windows-media-player-10"></a>轉散發 Windows Media Player 10

您可以使用下列安裝程式，在 Windows XP 上安裝 Windows Media Player 10。
...
下表顯示您可以搭配 Windows Media Player 10 安裝程式使用的其他參數。
