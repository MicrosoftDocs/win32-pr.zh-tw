...
---
# <a name="navigating-from-windows-media-player-features"></a>從 Windows Media Player 功能導覽

如果您提供音樂線上商店，您可以從資訊中心視圖、專輯資訊，以及 HTMLView 頁面，到您的服務工作窗格中執行導覽。 此程式的運作方式完全如在 [服務工作窗格之間導覽](navigating-between-service-task-panes.md)所述。 差別在於，您可以從功能流覽至服務工作窗格，但不能從服務工作窗格流覽至功能。
