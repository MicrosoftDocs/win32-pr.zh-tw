...
---
# <a name="iwmpmediacollectionremove-method"></a>IWMPMediaCollection：： remove 方法

`remove`方法會從媒體集合中移除指定的專案。
...
下列範例會在提示使用者之後，使用來永久刪除媒體集合中的第一個媒體專案 `remove` 。 AxWMPLib. AxWindowsMediaPlayer 物件是以名為 player 的變數來表示。
