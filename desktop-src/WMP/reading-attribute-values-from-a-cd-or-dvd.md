...
---
# <a name="reading-attribute-values-from-a-cd-or-dvd"></a><span data-ttu-id="acf0c-114">從 CD 或 DVD 讀取屬性值</span><span class="sxs-lookup"><span data-stu-id="acf0c-114">Reading Attribute Values from a CD or DVD</span></span>

<span data-ttu-id="acf0c-115">在本主題中， **Player** 物件是以下列方式定義：</span><span class="sxs-lookup"><span data-stu-id="acf0c-115">Throughout this topic, the **Player** object was defined in the following manner:</span></span>
...
<span data-ttu-id="acf0c-116">下列 c # 範例程式碼會抓取磁片磁碟機中目前光碟的所有屬性值，並將它們寫入檔案。</span><span class="sxs-lookup"><span data-stu-id="acf0c-116">The following C# example code retrieves the values of all attributes in the current disc that is in the drive and writes them to a file.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="acf0c-117">相關主題</span><span class="sxs-lookup"><span data-stu-id="acf0c-117">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="acf0c-118">**媒體專案屬性**</span><span class="sxs-lookup"><span data-stu-id="acf0c-118">**Media Item Attributes**</span></span>](media-item-attributes.md)
</dt> <dt>

[<span data-ttu-id="acf0c-119">**媒體物件**</span><span class="sxs-lookup"><span data-stu-id="acf0c-119">**Media Object**</span></span>](media-object.md)
</dt> </dl>
