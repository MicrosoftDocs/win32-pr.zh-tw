...
Windows Media Player 目前支援下列通訊協定。



| 通訊協定 | 描述                                                                        |
|----------|------------------------------------------------------------------------------------|
| HTTP     | 超文字傳輸通訊協定。 包含 HTTP 與快速快取和多播。          |
| RTSP     | 即時串流通訊協定。 包含具有 fast cache 的 RTSP。                       |
| RTSPU    | 搭配使用者資料包協定使用的 RTSP (UDP) 。 包含具有快速快取的 RTSPU        |
| RTSPT    | 用於傳輸控制通訊協定 (TCP) 的 RTSP。 包含具有快速快取的 RTSPT |
