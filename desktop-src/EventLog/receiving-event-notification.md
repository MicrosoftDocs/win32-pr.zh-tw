...
ms.locfileid: "118951357"
---
# <a name="receiving-event-notification"></a>接收事件通知

下列範例示範如何使用 [**NotifyChangeEventLog**](/windows/desktop/api/Winbase/nf-winbase-notifychangeeventlog) 函數在記錄事件時接收通知。 此範例會篩選 [報告事件](reporting-an-event.md)的範例所撰寫的事件。
