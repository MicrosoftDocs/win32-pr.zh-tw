...
如需 Windows Vista 中系統效果的詳細資訊，請參閱 Windows 網站的 [音訊裝置技術](https://www.microsoft.com/whdc/device/audio/default.mspx) 上標題為「windows Vista 的自訂音訊效果」和「重複使用 Windows Vista 音訊系統效果」的白皮書。
