...
---
# <a name="wiaitempropertyid"></a><span data-ttu-id="585b4-103">WiaItemPropertyId</span><span class="sxs-lookup"><span data-stu-id="585b4-103">WiaItemPropertyId</span></span>

<span data-ttu-id="585b4-104">大部分的 Windows 映像取得 (WIA) 屬性常數都會分組為一個列舉資料類型，WiaItemPropertyId 為腳本作者。</span><span class="sxs-lookup"><span data-stu-id="585b4-104">Most of the Windows Image Acquisition (WIA) property constants are grouped in one enumerated data type, WiaItemPropertyId for scripting authors.</span></span>

<span data-ttu-id="585b4-105">下表提供在腳本和 c + + 中使用的命名慣例之間的對應。</span><span class="sxs-lookup"><span data-stu-id="585b4-105">The following table presents the mapping between the naming conventions used in scripting and C++.</span></span> <span data-ttu-id="585b4-106">例如，在腳本中，"CameraDevice" 前置詞會 \_ 對應到對應 c + + 常數的 "WIA DPC" 前置詞。</span><span class="sxs-lookup"><span data-stu-id="585b4-106">For example, in script the "CameraDevice" prefix maps to the "WIA\_DPC" prefix for the corresponding C++ constant.</span></span> <span data-ttu-id="585b4-107">在更明確的範例中，"CameraDeviceFlashMode" 屬性相當於 c + + "WIA \_ DPC \_ FLASH \_ MODE" 常數。</span><span class="sxs-lookup"><span data-stu-id="585b4-107">In a more specific example, the "CameraDeviceFlashMode" property is equivalent to the C++ "WIA\_DPC\_FLASH\_MODE" constant.</span></span> <span data-ttu-id="585b4-108">如需每個屬性的描述，請參閱對應的屬性常數主題。</span><span class="sxs-lookup"><span data-stu-id="585b4-108">See the corresponding property constant topics for descriptions of each property.</span></span> 

| <span data-ttu-id="585b4-109">腳本前置詞</span><span class="sxs-lookup"><span data-stu-id="585b4-109">Script Prefix</span></span>  | <span data-ttu-id="585b4-110">C + + 主題 (前置詞) </span><span class="sxs-lookup"><span data-stu-id="585b4-110">C++ Topic (prefix)</span></span>                                                                    |
|----------------|---------------------------------------------------------------------------------------|
| <span data-ttu-id="585b4-111">裝置</span><span class="sxs-lookup"><span data-stu-id="585b4-111">Device</span></span>         | [<span data-ttu-id="585b4-112">**(WIA DPA) 的一般裝置屬性常數 \_**</span><span class="sxs-lookup"><span data-stu-id="585b4-112">**Common Device Property Constants (WIA\_DPA)**</span></span>](-wia-wiaitempropcommondevice.md)   |
| <span data-ttu-id="585b4-113">CameraDevice</span><span class="sxs-lookup"><span data-stu-id="585b4-113">CameraDevice</span></span>   | [<span data-ttu-id="585b4-114">**相機裝置屬性常數 (WIA \_ DPC)**</span><span class="sxs-lookup"><span data-stu-id="585b4-114">**Camera Device Property Constants (WIA\_DPC)**</span></span>](-wia-wiaitempropcameradevice.md)   |
| <span data-ttu-id="585b4-115">ScannerDevice</span><span class="sxs-lookup"><span data-stu-id="585b4-115">ScannerDevice</span></span>  | [<span data-ttu-id="585b4-116">**掃描器裝置屬性常數 (WIA \_ DPS)**</span><span class="sxs-lookup"><span data-stu-id="585b4-116">**Scanner Device Property Constants (WIA\_DPS)**</span></span>](-wia-wiaitempropscannerdevice.md) |
| <span data-ttu-id="585b4-117">VideoDevice</span><span class="sxs-lookup"><span data-stu-id="585b4-117">VideoDevice</span></span>    | [<span data-ttu-id="585b4-118">**(WIA DPV) 的視頻 WIA 裝置屬性常數 \_**</span><span class="sxs-lookup"><span data-stu-id="585b4-118">**Video WIA Device Property Constants (WIA\_DPV)**</span></span>](-wia-wiaitempropvideodevice.md) |
| <span data-ttu-id="585b4-119">Picture</span><span class="sxs-lookup"><span data-stu-id="585b4-119">Picture</span></span>        | [<span data-ttu-id="585b4-120">**(WIA IPA) 的通用 WIA 專案屬性常數 \_**</span><span class="sxs-lookup"><span data-stu-id="585b4-120">**Common WIA Item Property Constants (WIA\_IPA)**</span></span>](-wia-wiaitempropcommonitem.md)   |
| <span data-ttu-id="585b4-121">CameraPicture</span><span class="sxs-lookup"><span data-stu-id="585b4-121">CameraPicture</span></span>  | [<span data-ttu-id="585b4-122">**(WIA IPC) 的相機 WIA 專案屬性常數 \_**</span><span class="sxs-lookup"><span data-stu-id="585b4-122">**Camera WIA Item Property Constants (WIA\_IPC)**</span></span>](-wia-wiaitempropcameraitem.md)   |
| <span data-ttu-id="585b4-123">ScannerPicture</span><span class="sxs-lookup"><span data-stu-id="585b4-123">ScannerPicture</span></span> | [<span data-ttu-id="585b4-124">**掃描器 WIA 專案屬性常數 (WIA \_ ip)**</span><span class="sxs-lookup"><span data-stu-id="585b4-124">**Scanner WIA Item Property Constants (WIA\_IPS)**</span></span>](-wia-wiaitempropscanneritem.md) |



 

<span data-ttu-id="585b4-125">下列範例會提供具有對應名稱的完整列舉型別。</span><span class="sxs-lookup"><span data-stu-id="585b4-125">The following example provides the complete enumerated type with the corresponding names.</span></span>
