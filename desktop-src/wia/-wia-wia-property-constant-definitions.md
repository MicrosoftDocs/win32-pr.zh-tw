---
description: 以下是 Windows 映像取得 (WIA) 屬性易記名稱和數值識別碼的清單。 這些會以 Microsoft Visual Basic 常數定義的形式呈現，以方便包含在應用程式或腳本中。
...
---
# <a name="wia-property-constant-definitions"></a><span data-ttu-id="06cb1-104">WIA 屬性常數定義</span><span class="sxs-lookup"><span data-stu-id="06cb1-104">WIA Property Constant Definitions</span></span>

<span data-ttu-id="06cb1-105">以下是 Windows 映像取得 (WIA) 屬性易記名稱和數值識別碼的清單。</span><span class="sxs-lookup"><span data-stu-id="06cb1-105">The following is a list of Windows Image Acquisition (WIA) property friendly names and numerical IDs.</span></span> <span data-ttu-id="06cb1-106">這些會以 Microsoft Visual Basic 常數定義的形式呈現，以方便包含在應用程式或腳本中。</span><span class="sxs-lookup"><span data-stu-id="06cb1-106">They are presented as Microsoft Visual Basic constant definitions, for convenient inclusion in applications or scripts.</span></span>

<span data-ttu-id="06cb1-107">對於 Visual Basic 應用程式，請新增「Microsoft Windows 映像取得1.01 型別程式庫」的參考，其中會提供這些常數作為列舉類型。</span><span class="sxs-lookup"><span data-stu-id="06cb1-107">For Visual Basic applications, add a reference to "Microsoft Windows Image Acquisition 1.01 Type Library", where these constants are provided as enumeration types.</span></span>
