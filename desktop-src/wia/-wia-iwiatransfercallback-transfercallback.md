...
類型： **[**WiaTransferParams**](-wia-wiatransferparams.md) \** _

指定 [_ *WiaTransferParams* *](-wia-wiatransferparams.md)結構的指標。
...
當此方法是由影像處理篩選器所執行時，Windows 映像取得 (WIA) 2.0 迷你驅動程式會在映射取得期間呼叫它，以將進度訊息傳回給應用程式。
