...
Windows 生物特徵辨識架構支援兩種類型的回呼簽章。 從 Windows 8 開始，支援下列回呼。 建議您針對所有新的應用程式執行此回呼。 不過，此回呼無法在 Windows 7 中使用。
...
下列回呼函數是在 Windows 7 中引進的。 我們建議您不要針對以 Windows 8 和更新版本的作業系統為目標的新應用程式執行這些應用程式。
