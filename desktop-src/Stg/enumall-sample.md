---
title: EnumAll 範例
description: 將所有屬性放在儲存體檔案的所有屬性集中。
ms.assetid: 40dd62b8-f76a-4cd8-9a9f-6ac344389b6c
keywords:
- 結構化儲存體 Strctd Stg.、範例、EnumAll
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104300652"
---
# <a name="enumall-sample"></a><span data-ttu-id="1f064-104">EnumAll 範例</span><span class="sxs-lookup"><span data-stu-id="1f064-104">EnumAll Sample</span></span>

<span data-ttu-id="1f064-105">EnumAll .cpp 範例應用程式會將所有屬性放在儲存體檔案的所有屬性集中。</span><span class="sxs-lookup"><span data-stu-id="1f064-105">The EnumAll.cpp sample application puts all properties in all property sets of a storage file.</span></span>
