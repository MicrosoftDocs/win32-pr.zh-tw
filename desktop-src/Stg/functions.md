---
title: '函數 (STG.) '
description: 函數是會傳回特定值或值的常式或副程式。 下列各節將描述結構化的儲存體函數。
...
ms.locfileid: "120034898"
---
# <a name="structured-storage-functions"></a>結構化的儲存體函數

函數是會傳回特定值或值的常式或副程式。 下列各節將描述結構化的儲存體函數：
