...
您也可以手動設定您的環境，方法是在您的 Autoexec.bat 檔案中新增如下所示的內容。 您可以使用 Windows 來編輯 Autoexec.bat 檔案，以包含這些命令。 使用 Windows Server 2003、Windows XP、Windows 2000 或 Windows NT，您可以使用可以從主控台執行的 [系統] 對話方塊來編輯或新增這些設定至環境變數。
