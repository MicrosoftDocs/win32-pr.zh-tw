...
ms.locfileid: "118756526"
---
# <a name="wm_pointerwheel-message"></a>WM_POINTERWHEEL 訊息
...
[**GET_WHEEL_DELTA_WPARAM**](/windows/win32/api/winuser/nf-winuser-get_wheel_delta_wparam) (WPARAM) ：滾輪 DELTA 作為帶正負號的簡短值。
