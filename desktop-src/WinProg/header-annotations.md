...
\[本主題說明 Windows 標頭透過 Windows 7 所支援的批註。 如果您正在針對 Windows 8 進行開發，您應該使用 [SAL 注釋]( /previous-versions/visualstudio/visual-studio-2013/ms182032(v=vs.120))中所述的注釋。\]
