...
---
# <a name="cmc-renewal-request"></a><span data-ttu-id="0ecf5-105">CMC 續約要求</span><span class="sxs-lookup"><span data-stu-id="0ecf5-105">CMC Renewal Request</span></span>

<span data-ttu-id="0ecf5-106">下列範例包含 CMC 更新要求。</span><span class="sxs-lookup"><span data-stu-id="0ecf5-106">The following example contains a CMC renewal request.</span></span> <span data-ttu-id="0ecf5-107">此範例是使用 Certreq.exe 和 Certutil.exe 工具產生的。</span><span class="sxs-lookup"><span data-stu-id="0ecf5-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="0ecf5-108">用作 Certreq.exe 輸入的 .inf 檔案包含下列設定。</span><span class="sxs-lookup"><span data-stu-id="0ecf5-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="0ecf5-109">設定會指定要求 (CMC) 的類型，以及要求所依據之憑證的序號。</span><span class="sxs-lookup"><span data-stu-id="0ecf5-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="0ecf5-110">這會產生下列輸出。</span><span class="sxs-lookup"><span data-stu-id="0ecf5-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="0ecf5-111">相關主題</span><span class="sxs-lookup"><span data-stu-id="0ecf5-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="0ecf5-112">範例要求</span><span class="sxs-lookup"><span data-stu-id="0ecf5-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
