...
---
# <a name="cmc-eobo-encoded-asn1"></a><span data-ttu-id="ea1ed-105">CMC EOBO 編碼的 ASN. 1</span><span class="sxs-lookup"><span data-stu-id="ea1ed-105">CMC EOBO Encoded ASN.1</span></span>

<span data-ttu-id="ea1ed-106">下列範例包含以 asn.1 格式顯示 (EOBO) 要求的 CMC 註冊。</span><span class="sxs-lookup"><span data-stu-id="ea1ed-106">The following example contains a CMC Enroll On Behalf Of (EOBO) request shown in ASN.1 format.</span></span> <span data-ttu-id="ea1ed-107">此範例是使用 Certreq.exe 和 Certutil.exe 工具產生的。</span><span class="sxs-lookup"><span data-stu-id="ea1ed-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="ea1ed-108">用作 Certreq.exe 輸入的 .inf 檔案包含下列設定。</span><span class="sxs-lookup"><span data-stu-id="ea1ed-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="ea1ed-109">此設定會產生下列範例輸出。</span><span class="sxs-lookup"><span data-stu-id="ea1ed-109">This configuration generates the following sample output.</span></span> <span data-ttu-id="ea1ed-110">設定會指定 (CMC) 的要求類型、要求註冊之實體的名稱，以及範本的名稱。</span><span class="sxs-lookup"><span data-stu-id="ea1ed-110">The configuration specifies the type of request (CMC), the name of the entity requesting the enrollment, and the name of the template.</span></span> <span data-ttu-id="ea1ed-111">使用者範本會指定：</span><span class="sxs-lookup"><span data-stu-id="ea1ed-111">The User template specifies that:</span></span>

-   <span data-ttu-id="ea1ed-112">要求必須使用 Microsoft 基礎密碼編譯提供者1.0 或 Microsoft 增強型密碼編譯提供者1.0。</span><span class="sxs-lookup"><span data-stu-id="ea1ed-112">The request must use either the Microsoft Base Cryptographic Provider 1.0 or the Microsoft Enhanced Cryptographic Provider 1.0.</span></span>
-   <span data-ttu-id="ea1ed-113">主體名稱必須從 Active Directory 建立。</span><span class="sxs-lookup"><span data-stu-id="ea1ed-113">The subject name must be built from Active Directory.</span></span>
-   <span data-ttu-id="ea1ed-114">要求包含憑證範本名稱、增強金鑰使用方法 (EKU) 和金鑰使用延伸模組。</span><span class="sxs-lookup"><span data-stu-id="ea1ed-114">The request includes the Certificate Template Name, Enhanced Key Usage (EKU), and Key Usage extensions.</span></span> <span data-ttu-id="ea1ed-115">EKU 延伸模組指定已發行的憑證可用於加密檔案系統 (EFS) 、安全電子郵件和用戶端驗證。</span><span class="sxs-lookup"><span data-stu-id="ea1ed-115">The EKU extension specifies that the issued certificate can be used for Encrypting File System (EFS), secure email, and client authentication.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="ea1ed-116">相關主題</span><span class="sxs-lookup"><span data-stu-id="ea1ed-116">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="ea1ed-117">範例要求</span><span class="sxs-lookup"><span data-stu-id="ea1ed-117">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
