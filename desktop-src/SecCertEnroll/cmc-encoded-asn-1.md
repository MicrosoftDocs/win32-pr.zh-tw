---
description: 下列範例包含 asn.1 格式所示的 CMC 要求。 此範例是使用 Certreq.exe 和 Certutil.exe 工具產生的。 用作 Certreq.exe 輸入的 .inf 檔案包含下列設定。
...
ms.locfileid: "118902024"
---
# <a name="cmc-encoded-asn1"></a>CMC 編碼的 ASN. 1

下列範例包含 asn.1 格式所示的 CMC 要求。 此範例是使用 Certreq.exe 和 Certutil.exe 工具產生的。 用作 Certreq.exe 輸入的 .inf 檔案包含下列設定。
