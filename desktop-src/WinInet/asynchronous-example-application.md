---
title: 非同步範例應用程式
description: 下列範例示範如何以非同步方式傳送要求。
...
ms.locfileid: "104183666"
---
# <a name="asynchronous-example-application"></a><span data-ttu-id="d778d-103">非同步範例應用程式</span><span class="sxs-lookup"><span data-stu-id="d778d-103">Asynchronous Example Application</span></span>

<span data-ttu-id="d778d-104">下列範例示範如何以非同步方式傳送要求。</span><span class="sxs-lookup"><span data-stu-id="d778d-104">The following example demonstrated sending a request asynchronously.</span></span>
