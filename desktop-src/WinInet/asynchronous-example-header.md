...
ms.locfileid: "104183245"
---
# <a name="asynchronous-example-header"></a><span data-ttu-id="42210-103">非同步範例標頭</span><span class="sxs-lookup"><span data-stu-id="42210-103">Asynchronous Example Header</span></span>

<span data-ttu-id="42210-104">以下是 [非同步範例應用程式](asynchronous-example-application.md)的標頭檔。</span><span class="sxs-lookup"><span data-stu-id="42210-104">The following is the header file for the [asynchronous example application](asynchronous-example-application.md).</span></span>
