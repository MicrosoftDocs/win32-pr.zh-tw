...
---
# <a name="example-that-creates-a-session-and-enables-a-manifest-based-or-classic-provider"></a>建立會話並啟用以資訊清單為基礎或傳統提供者的範例

下列範例顯示如何啟動追蹤會話、啟用以資訊清單為基礎或傳統的提供者、停用提供者，然後停止會話。
