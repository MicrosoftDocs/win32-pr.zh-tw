---
description: 下列範例顯示如何啟動追蹤會話、啟用以資訊清單為基礎或傳統的提供者、停用提供者，然後停止會話。
ms.assetid: 13c83b62-9235-4101-82a9-a118e6ece3d5
title: 建立會話並啟用以資訊清單為基礎或傳統提供者的範例
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104972205"
---
# <a name="example-that-creates-a-session-and-enables-a-manifest-based-or-classic-provider"></a><span data-ttu-id="cbc79-103">建立會話並啟用以資訊清單為基礎或傳統提供者的範例</span><span class="sxs-lookup"><span data-stu-id="cbc79-103">Example that Creates a Session and Enables a Manifest-based or Classic Provider</span></span>

<span data-ttu-id="cbc79-104">下列範例顯示如何啟動追蹤會話、啟用以資訊清單為基礎或傳統的提供者、停用提供者，然後停止會話。</span><span class="sxs-lookup"><span data-stu-id="cbc79-104">The following example shows how to start a trace session, enables a manifest-based or classic provider, disables the provider and then stops the session.</span></span>
