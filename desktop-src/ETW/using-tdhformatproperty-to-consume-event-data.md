---
description: 下列範例示範如何使用 TdhFormatProperty 函數來取用事件資料。
ms.assetid: 5ebd500c-420e-4979-a03a-49b687464b0e
title: 使用 TdhFormatProperty 取用事件資料
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104972264"
---
# <a name="using-tdhformatproperty-to-consume-event-data"></a><span data-ttu-id="e9fb0-103">使用 TdhFormatProperty 取用事件資料</span><span class="sxs-lookup"><span data-stu-id="e9fb0-103">Using TdhFormatProperty to Consume Event Data</span></span>

<span data-ttu-id="e9fb0-104">下列範例示範如何使用 [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) 函數來取用事件資料。</span><span class="sxs-lookup"><span data-stu-id="e9fb0-104">The following example shows how to consume event data using the [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) function.</span></span>
