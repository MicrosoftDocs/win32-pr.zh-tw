...
ms.locfileid: "118951227"
---
# <a name="using-tdhformatproperty-to-consume-event-data"></a>使用 TdhFormatProperty 取用事件資料

下列範例示範如何使用 [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) 函數來取用事件資料。
