...
ms.locfileid: "120083108"
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a>使用 TdhGetProperty 取用事件資料

下列範例示範如何使用 [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) 函數來取用事件資料。
