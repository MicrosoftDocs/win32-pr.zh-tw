---
description: 下列範例示範如何使用 TdhGetProperty 函數來取用事件資料。
ms.assetid: 16b36718-087f-4be9-9ca2-fc083358017b
title: 使用 TdhGetProperty 取用事件資料
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103691195"
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a><span data-ttu-id="af5cc-103">使用 TdhGetProperty 取用事件資料</span><span class="sxs-lookup"><span data-stu-id="af5cc-103">Using TdhGetProperty to Consume Event Data</span></span>

<span data-ttu-id="af5cc-104">下列範例示範如何使用 [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) 函數來取用事件資料。</span><span class="sxs-lookup"><span data-stu-id="af5cc-104">The following example shows how to consume event data using the [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) function.</span></span>
