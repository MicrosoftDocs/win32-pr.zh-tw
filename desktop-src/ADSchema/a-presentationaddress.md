...
---
# <a name="presentation-address-attribute"></a>Presentation-Address 屬性

指定與代表 OSI 應用程式實體之物件相關聯的呈現位址。
...
| Ldap-顯示名稱 | presentationAddress                                                   |
| 大小              | \-                                                                    |
| 更新許可權  | \-                                                                    |
| 更新頻率  | \-                                                                    |
| Attribute-Id      | 2.5.4.29                                                              |
| 系統識別碼-Guid    | a8df744b-c5ea-11d1-bbcb-0080c76670c0                                  |
| Syntax            | [**Object(Presentation-Address)**](s-object-presentation-address.md) |
...
| 中使用的類別        | [**應用程式-實體**](c-applicationentity.md)<br/> |
