...
ms.locfileid: "119706028"
---
# <a name="frs-level-limit-attribute"></a>FRS 層級限制屬性

要複寫以進行檔案複寫的目錄樹狀目錄深度限制。
...
|-------------------|--------------------------------------|
| CN                | FRS 層級限制                      |
| Ldap-顯示名稱 | fRSLevelLimit                        |
| 大小              | 4 個位元組                              |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.534               |
| 系統識別碼-Guid    | 5245801e-ca6a-11d0-afff-0000f80367c1 |
