...
ms.locfileid: "119022956"
---
# <a name="acs-cache-timeout-attribute"></a>ACS-Cache-Timeout 屬性

ACS 服務快取的 ACS 物件到期前的時間量。
...
|-------------------|--------------------------------------|
| CN                | ACS-快取-超時                    |
| Ldap-顯示名稱 | aCSCacheTimeout                      |
| 大小              | 4 個位元組                              |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.779               |
| 系統識別碼-Guid    | 1cb355a1-56d0-11d1-a9c6-0000f80367c1 |
