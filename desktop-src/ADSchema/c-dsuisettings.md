...
ms.locfileid: "119801788"
---
# <a name="ds-ui-settings-class"></a>DS-UI-設定類別

用來儲存 Active Directory 消費者和電腦嵌入式管理單元所使用的設定。
...
|-------------------|--------------------------------------|
| CN                | DS-UI-設定                       |
| Ldap-顯示名稱 | dSUISettings                         |
| 更新許可權  | 網域系統管理員。                |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 09b10f14-6f93-11d2-9905-0000f87a57d4 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.183                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
...
| [**DS-UI-管理員-最大值**](a-dsuiadminmaximum.md)                         | 否     | **DS-UI-設定**              |
| [**DS-UI-系統管理-通知**](a-dsuiadminnotification.md)               | 否     | **DS-UI-設定**              |
| [**DS-UI-Shell-最大值**](a-dsuishellmaximum.md)                         | 否     | **DS-UI-設定**              |
...
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)                    | 否     | [**返回頁首**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                                 | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DS-篩選-容器**](a-msds-filtercontainers.md)                                | 否     | **DS-UI-設定**              |
...
| [**ms DS-非安全性群組-額外類別**](a-msds-non-security-group-extra-classes.md) | 否     | **DS-UI-設定**              |
...
| [**ms-DS-安全性群組-額外類別**](a-msds-security-group-extra-classes.md)         | 否     | **DS-UI-設定**              |
