...
---
# <a name="meetingendtime-attribute"></a>meetingEndTime 屬性
...
|-------------------|----------------------------------------------------------------------------------|
| CN                | meetingEndTime                                                                   |
| Ldap-顯示名稱 | meetingEndTime                                                                   |
| 大小              | \-                                                                               |
| 更新許可權  | 任何人都可以根據所建立物件的安全性來更新這個物件。 |
| 更新頻率  | \-                                                                               |
| Attribute-Id      | 1.2.840.113556.1.4.588                                                           |
| 系統識別碼-Guid    | 11b6cc91-48c4-11d1-a9c3-0000f80367c1                                             |
