...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 124564458147fb1978c1a9a821b9b68554e1419fddde1c7db557089d2afb7f00
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118422972"
---
# <a name="ms-ds-az-admin-manager-class"></a>ms-chap-Az-管理管理員類別

授權原則存放區實例的根目錄。 請注意，可能有許多存放區實例。
...
|-------------------|-------------------------------------------------|
| CN                | ms-chap-Az-管理管理員                          |
| Ldap-顯示名稱 | AzAdminManager                             |
| 更新許可權  | 此值是由 AzRoles 系統管理員所設定。 |
| 更新頻率  | 在初始化或原則變更期間。         |
| 架構識別碼-Guid    | cfee1051-5f28-4bae-a863-5d0cc18a8ed1            |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.5.234                                                                                                           |
| 預設值-隱藏-值        | 1                                                                                                                                |
...
| 預設安全描述項 | D:(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)(A;;RPLCLORC;;;AU)(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;CO) |
...
| [**描述**](a-description.md)                                        | 否     | **ms-chap-Az-管理-管理員** [ **Top**](c-top.md)<br/> |
...
| [**ms DS-Az-應用程式-資料**](a-msds-azapplicationdata.md)               | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms-chap-Az-Domain-Timeout**](a-msds-azdomaintimeout.md)                   | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms DS-Az-產生-審核**](a-msds-azgenerateaudits.md)                 | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms-chap-Az-主要版本**](a-msds-azmajorversion.md)                     | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms-chap-Az-次要版本**](a-msds-azminorversion.md)                     | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms DS-Az-腳本-引擎-快取-最大值**](a-msds-azscriptenginecachemax.md)   | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms DS-Az-Script-Timeout**](a-msds-azscripttimeout.md)                   | 否     | **ms-chap-Az-管理管理員**                                 |
...
| [**ms-chap-Az-Domain-Timeout**](a-msds-azdomaintimeout.md)                      | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms DS-Az-產生-審核**](a-msds-azgenerateaudits.md)                    | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms DS-Az-Generic-資料**](a-msds-azgenericdata.md)                          | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms-chap-Az-主要版本**](a-msds-azmajorversion.md)                        | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms-chap-Az-次要版本**](a-msds-azminorversion.md)                        | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                            | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms DS-Az-腳本-引擎-快取-最大值**](a-msds-azscriptenginecachemax.md)      | 否     | **ms-chap-Az-管理管理員**                                 |
| [**ms DS-Az-Script-Timeout**](a-msds-azscripttimeout.md)                      | 否     | **ms-chap-Az-管理管理員**                                 |
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)         | 否     | [**返回頁首**](c-top.md)<br/>                            |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | 否     | [**返回頁首**](c-top.md)<br/>                            |
