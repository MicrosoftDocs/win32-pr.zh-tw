...
精煉群組原則物件的管理範圍。 新增規則清單，以目的電腦上執行的 WQL 查詢表示。 所有查詢都必須傳回此 SOM 的結果，才能套用至目標。
...
| 更新許可權  | 群組原則系統管理員           |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | ab857078-0142-4406-945b-34c9b6b13372 |
...
| Object-Category             | 1                                                                                                    |
| 預設-物件-類別     | \-                                                                                                   |
| Governs-Id                  | 1.2.840.113556.1.5.213                                                                               |
| 預設值-隱藏-值        | 1                                                                                                    |
...
| [**Parm4**](a-mswmi-parm4.md)                                       | 否     | **ms-WMI-Som**                  |
