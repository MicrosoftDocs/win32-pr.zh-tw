...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 2622cd54816d2519c3bf50b1e0d3d9b8e201a7157ce8bac55860fde2b2dac6b1
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119801468"
---
# <a name="rras-administration-dictionary-class"></a>RRAS-管理-字典類別

用來將供應商專屬路由屬性轉譯為名稱的字典物件。
...
|-------------------|--------------------------------------|
| CN                | RRAS-管理-字典       |
| Ldap-顯示名稱 | rRASAdministrationDictionary         |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | f39b98ae-938d-11d1-aebd-0000f80367c1 |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.5.156                                                                                                           |
| 預設值-隱藏-值        | 1                                                                                                                                |
...
| [**ms RRAS-廠商-屬性-Entry**](a-msrrasvendorattributeentry.md)    | 否     | **RRAS-管理-字典** |
