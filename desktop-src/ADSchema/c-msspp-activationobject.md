...
| [**SPP-CSVLK-部分產品金鑰**](a-msspp-csvlkpartialproductkey.md)                   | 對      | **ms SPP-啟用-物件**    |
| [**SPP-CSVLK-Pid**](a-msspp-csvlkpid.md)                                                 | 對      | **ms SPP-啟用-物件**    |
| [**SPP-CSVLK-Sku-Id**](a-msspp-csvlkskuid.md)                                            | 對      | **ms SPP-啟用-物件**    |
| [**SPP-安裝-識別碼**](a-msspp-installationid.md)                                     | 否     | **ms SPP-啟用-物件**    |
| [**SPP-發佈-授權**](a-msspp-issuancelicense.md)                                   | 否     | **ms SPP-啟用-物件**    |
| [**SPP-KMS-識別碼**](a-msspp-kmsids.md)                                                     | 對      | **ms SPP-啟用-物件**    |
