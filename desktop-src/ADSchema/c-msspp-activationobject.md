...
ms.locfileid: "119879428"
---
# <a name="ms-spp-activation-object-class"></a>SPP-Activation-Object 類別

以 Active Directory 為基礎的啟用所使用的啟用物件
...
|-------------------|--------------------------------------|
| CN                | ms SPP-啟用-物件             |
| Ldap-顯示名稱 | msSPP-ActivationObject               |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 51a0e68c-0dc5-43ca-935d-c1c911bf2ee5 |
...
| 可能的 Superiors          | [**SPP-啟用-物件-容器**](c-msspp-activationobjectscontainer.md) |
| 輔助類別           | \-                                                                                |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                      |
| 預設安全描述項 | O:BAG：不正確： (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPLCLORC;;;AU)                  |
...
| [**ms-SPP-Config-授權**](a-msspp-configlicense.md)                                       | 否     | **ms SPP-啟用-物件**    |
| [**SPP-確認-識別碼**](a-msspp-confirmationid.md)                                     | 否     | **ms SPP-啟用-物件**    |
| [**SPP-CSVLK-部分產品金鑰**](a-msspp-csvlkpartialproductkey.md)                   | 是      | **ms SPP-啟用-物件**    |
| [**SPP-CSVLK-Pid**](a-msspp-csvlkpid.md)                                                 | 是      | **ms SPP-啟用-物件**    |
| [**SPP-CSVLK-Sku-Id**](a-msspp-csvlkskuid.md)                                            | 是      | **ms SPP-啟用-物件**    |
| [**SPP-安裝-識別碼**](a-msspp-installationid.md)                                     | 否     | **ms SPP-啟用-物件**    |
| [**SPP-發佈-授權**](a-msspp-issuancelicense.md)                                   | 否     | **ms SPP-啟用-物件**    |
| [**SPP-KMS 識別碼**](a-msspp-kmsids.md)                                                     | 是      | **ms SPP-啟用-物件**    |
| [**SPP-線上-授權**](a-msspp-onlinelicense.md)                                       | 否     | **ms SPP-啟用-物件**    |
| [**SPP-電話-授權**](a-msspp-phonelicense.md)                                         | 否     | **ms SPP-啟用-物件**    |
