...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: e909d856f340c35e1d5e39bc25ec9b527a42f3ae3cbf495b4283c743457e4d94
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119703908"
---
# <a name="application-site-settings-class"></a>應用程式-網站設定類別
...
|-------------------|------------------------------------------------------|
| CN                | 應用程式-網站-設定                            |
| Ldap-顯示名稱 | applicationSiteSettings                              |
| 更新許可權  | 系統會設定此值。                          |
| 更新頻率  | 只要這個延伸的許可權套用至新的類別。 |
| 架構識別碼-Guid    | 19195a5c-6da0-11d0-afd3-00c04fd930c9                 |
...
| Object-Category             | 2                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.68                                                                        |
| 預設值-隱藏-值        | 1                                                                                            |
...
| [**應用程式名稱**](a-applicationname.md)                             | 否     | **應用程式-網站-設定**   |
...
| [**通知-清單**](a-notificationlist.md)                           | 否     | **應用程式-網站-設定**   |
