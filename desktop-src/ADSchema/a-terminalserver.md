...
---
# <a name="terminal-server-attribute"></a>Terminal-Server 屬性

Windows NT 終端機伺服器使用的不透明資料。
...
|-------------------|-------------------------------------------------------|
| CN                | Terminal-Server                                       |
| Ldap-顯示名稱 | terminalServer                                        |
| 大小              | \-                                                    |
| 更新許可權  | \-                                                    |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.885                                |
| 系統識別碼-Guid    | 6db69a1c-9422-11d1-aebd-0000f80367c1                  |
