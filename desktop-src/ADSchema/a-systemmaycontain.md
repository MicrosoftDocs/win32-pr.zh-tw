...
ms.locfileid: "119081372"
---
# <a name="system-may-contain-attribute"></a>System-可包含屬性

類別的選擇性屬性清單。 屬性清單只能由系統修改。
...
|-------------------|------------------------------------------------------------------------------|
| CN                | 系統-可能包含                                                           |
| Ldap-顯示名稱 | systemMayContain                                                             |
| 大小              | \-                                                                           |
| 更新許可權  | 架構系統管理員                                                         |
| 更新頻率  | 建立類別時，或將新的選擇性屬性加入至類別。 |
| Attribute-Id      | 1.2.840.113556.1.4.196                                                       |
| 系統識別碼-Guid    | bf967a44-0de6-11d0-a285-00aa003049e2                                         |
