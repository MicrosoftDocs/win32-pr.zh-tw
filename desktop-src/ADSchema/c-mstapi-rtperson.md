...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 6e69a8299094aa11d5a195a8982b95eed43a79763e73109c90a813725c0e65ac
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119879378"
---
# <a name="ms-tapi-rt-person-class"></a>ms-chap-Rt-Person 類別

用來將使用者對應到使用者登入的電腦 IP 位址，以供 TAPI 多播會議使用。
...
| Ldap-顯示名稱 | msTAPI-RtPerson                                                                   |
| 更新許可權  | 不需要任何特殊許可權。                                                   |
| 更新頻率  | 當 TAPI 用戶端在向 TAPI 目錄註冊之後啟動。 |
| 架構識別碼-Guid    | 53ea1cb5-b704-4df9-818f-5cb4ec86cac1                                              |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.222                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                       |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                              |
| 可能的 Superiors          | [**組織單位**](c-organizationalunit.md)[**組織**](c-organization.md)    |
| 輔助類別           | \-                                                                                           |
...
| [**ms-TAPI-Ip 位址**](a-mstapi-ipaddress.md)                            | 否     | **ms-TAPI-Rt-Person**           |
| [**ms-TAPI-唯一識別碼**](a-mstapi-uid.md)                           | 否     | **ms-TAPI-Rt-Person**           |
