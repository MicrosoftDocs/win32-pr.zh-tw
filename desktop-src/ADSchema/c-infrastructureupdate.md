...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 6749c1401b7e4b8fedd33674ba65eb3916c246cd0051609fa5df011d2cce07a5
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119324488"
---
# <a name="infrastructure-update-class"></a>Infrastructure-Update 類別
...
| Ldap-顯示名稱 | infrastructureUpdate                           |
| 更新許可權  | 此值是由網域系統管理員所設定。 |
| 更新頻率  | \-                                             |
| 架構識別碼-Guid    | 2df90d89-009f-11d2-aa4c-00c04fd7d83a           |
...
| Object-Category             | 1                                                   |
| 預設-物件-類別     | \-                                                  |
| Governs-Id                  | 1.2.840.113556.1.5.175                              |
| 預設值-隱藏-值        | 1                                                   |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>              |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                     |
| 可能的 Superiors          | [**網域**](c-domain.md)**基礎結構-更新** |
| 輔助類別           | \-                                                  |
...
| [**DN-參考-更新**](a-dnreferenceupdate.md)                        | 否     | **基礎結構-更新**       |
