...
ms.locfileid: "119544928"
---
# <a name="domain-policy-object-attribute"></a>網域原則-物件屬性

參考定義主機網域之本地安全機構原則的原則物件。
...
|-------------------|-----------------------------------------|
| CN                | 網域原則-物件                    |
| Ldap-顯示名稱 | domainPolicyObject                      |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.32                   |
| 系統識別碼-Guid    | bf96795d-0de6-11d0-a285-00aa003049e2    |
...
| 中使用的類別        | [**憑證授權單位單位**](c-certificationauthority.md)<br/> [**Sam-網域**](c-samdomain.md)<br/> |
