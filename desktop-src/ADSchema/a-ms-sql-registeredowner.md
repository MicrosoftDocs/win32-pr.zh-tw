...
---
# <a name="ms-sql-registeredowner-attribute"></a>>registeredowner 屬性

SQL Server 目前實例的註冊擁有者。
...
|-------------------|---------------------------------------------|
| CN                | >registeredowner                      |
| Ldap-顯示名稱 | >registeredowner                      |
| 大小              | \-                                          |
| 更新許可權  | 網域系統管理員                        |
| 更新頻率  | 在系統設定時。                            |
| Attribute-Id      | 1.2.840.113556.1.4.1364                     |
| 系統識別碼-Guid    | 48fd44ea-ccee-11d2-9993-0000f87a57d4        |
