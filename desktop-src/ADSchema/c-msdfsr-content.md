...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 80fb651fe95fbecd9eaff8748263c6bf054ec73f6f7850ee054a58e17060bf68
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119880688"
---
# <a name="ms-dfsr-content-class"></a>ms-DFSR-Content 類別

表示 [**MS DFSR ContentSet**](c-msdfsr-contentset.md) 物件的容器。
...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 64759b35-d3a1-42e4-b5f1-a3de162109b3 |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.6.13.4.6                                                                                                        |
| 預設值-隱藏-值        | 1                                                                                                                                |
| Rdn-Att-Id                  | \-                                                                                                                               |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                  |
| 可能的 Superiors          | [**ms-DFSR-ReplicationGroup**](c-msdfsr-replicationgroup.md)                                                                    |
| 輔助類別           | \-                                                                                                                               |
...
| [**ms-DFSR-擴充功能**](a-msdfsr-extension.md)                             | 否     | **ms-DFSR-內容**             |
| [**ms-DFSR-旗標**](a-msdfsr-flags.md)                                     | 否     | **ms-DFSR-內容**             |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                 | 否     | **ms-DFSR-內容**             |
...
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                    | 否     | **ms-DFSR-內容**             |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                  | 否     | **ms-DFSR-內容**             |
| [**ms-DS-Immed-從屬**](a-msds-approx-immed-subordinates.md)    | 否     | [**返回頁首**](c-top.md)<br/> |
...
**MS DFSR 內容** 類別是分散式檔案系統 (DFS) Replication service 支援的一部分。
