...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 9abdac035a56d3e639bcdfa187539046f59dc95962d3a1e6f9537624e3c3f9f3
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119880388"
---
# <a name="ms-ds-az-application-class"></a>ms DS-Az-Application 類別

定義已安裝且系結至特定原則存放區之應用程式的實例。
...
|-------------------|-----------------------------------------|
| CN                | ms DS-Az-應用程式                    |
| Ldap-顯示名稱 | AzApplication                      |
| 更新許可權  | AzRoles 系統管理員                           |
| 更新頻率  | 在初始化或原則變更期間。 |
| 架構識別碼-Guid    | ddf8de9b-cba5-4e12-842e-28d8b66f75ec    |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.5.235                                                                                                           |
| 預設值-隱藏-值        | 1                                                                                                                                |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                                                           |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                  |
| 可能的 Superiors          | [**ms-chap-Az-管理管理員**](c-msds-azadminmanager.md)                                                                          |
| 輔助類別           | \-                                                                                                                               |
...
| [**描述**](a-description.md)                                        | 否     | **ms DS-Az-應用程式** [**頂端**](c-top.md)<br/> |
...
| [**ms DS-Az-應用程式-資料**](a-msds-azapplicationdata.md)               | 否     | **ms DS-Az-應用程式**                                 |
| [**ms-DS-Az-應用程式名稱**](a-msds-azapplicationname.md)               | 否     | **ms DS-Az-應用程式**                                 |
| [**ms DS-Az-應用程式版本**](a-msds-azapplicationversion.md)         | 否     | **ms DS-Az-應用程式**                                 |
| [**ms-chap-Az-Class-ID**](a-msds-azclassid.md)                               | 否     | **ms DS-Az-應用程式**                                 |
| [**ms DS-Az-產生-審核**](a-msds-azgenerateaudits.md)                 | 否     | **ms DS-Az-應用程式**                                 |
...
| [**ms-chap-Az-Class-ID**](a-msds-azclassid.md)                                  | 否     | **ms DS-Az-應用程式**                                 |
| [**ms DS-Az-產生-審核**](a-msds-azgenerateaudits.md)                    | 否     | **ms DS-Az-應用程式**                                 |
| [**ms DS-Az-Generic-資料**](a-msds-azgenericdata.md)                          | 否     | **ms DS-Az-應用程式**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                            | 否     | **ms DS-Az-應用程式**                                 |
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)         | 否     | [**返回頁首**](c-top.md)<br/>                          |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | 否     | [**返回頁首**](c-top.md)<br/>                          |
