...
ms.locfileid: "118960707"
---
# <a name="ms-ds-lockout-threshold-attribute"></a>ms DS-鎖定-閾值屬性
...
|-------------------|--------------------------------------|
| CN                | ms DS-鎖定-閾值              |
| Ldap-顯示名稱 | msDS-LockoutThreshold                |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.2019              |
| 系統識別碼-Guid    | b8c8c35e-4a19-4a95-99d0-69fe4446286f |
