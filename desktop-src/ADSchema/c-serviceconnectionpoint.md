...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 638bf4f2f8ac17b4e1ac1fb62010debeed9b9ca96819060dd4bd694c83b05cad
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119533648"
---
# <a name="service-connection-point-class"></a>服務連接點類別

此物件是用來發佈用戶端應用程式可用來系結至服務的資訊。
...
|-------------------|------------------------------------------------------------|
| CN                | 服務-連接點                                   |
| Ldap-顯示名稱 | serviceConnectionPoint                                     |
| 更新許可權  | 系統管理員或任何需要安裝該服務的人。 |
| 更新頻率  | 當您安裝新的服務時。                           |
| 架構識別碼-Guid    | 28630ec1-41d5-11d1-a9c1-0000f80367c1                       |
...
| 可能的 Superiors          | [**電腦**](c-computer.md)[**容器**](c-container.md)[**組織單位**](c-organizationalunit.md)                |
| 輔助類別           | \-                                                                                                                               |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                     |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;CO)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPLCLORC;;;AU)  |
...
| [**服務系結資訊**](a-servicebindinginformation.md)        | 否     | **服務-連接點**                                                             |
| [**服務類別名稱**](a-serviceclassname.md)                          | 否     | **服務-連接點**                                                             |
| [**服務-DNS-名稱**](a-servicednsname.md)                              | 否     | **服務-連接點**                                                             |
| [**服務-DNS-名稱-類型**](a-servicednsnametype.md)                     | 否     | **服務-連接點**                                                             |
...
| [**允許-子類別**](a-allowedchildclasses.md)                      | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**允許-子類別-有效**](a-allowedchildclasseseffective.md)   | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**應用程式架構版本**](a-appschemaversion.md)                            | 否     | **服務-連接點**                                                             |
| [**橋頭-伺服器-清單-BL**](a-bridgeheadserverlistbl.md)               | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**標準名稱**](a-canonicalname.md)                                   | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**一般名稱**](a-cn.md)                                                 | 是      | [**連接點**](c-connectionpoint.md)<br/> [**返回頁首**](c-top.md)<br/> |
| [**建立時間戳記**](a-createtimestamp.md)                              | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
...
| [**USN-最後-Obj-Rem**](a-usnlastobjrem.md)                                 | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**USN-來源**](a-usnsource.md)                                           | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**廠商**](a-vendor.md)                                                  | 否     | **服務-連接點**                                                             |
| [**版本號碼**](a-versionnumber.md)                                   | 否     | **服務-連接點**                                                             |
| [**版本號碼-Hi**](a-versionnumberhi.md)                              | 否     | **服務-連接點**                                                             |
| [**版本號碼-Lo**](a-versionnumberlo.md)                              | 否     | **服務-連接點**                                                             |
| [**Wbem-路徑**](a-wbempath.md)                                             | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**知名物件**](a-wellknownobjects.md)                            | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**變更時**](a-whenchanged.md)                                       | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**建立時間**](a-whencreated.md)                                       | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
