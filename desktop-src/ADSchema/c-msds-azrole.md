...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: fd9dc0f3dabb033ea17ef4ca507075182e7799aa773bb1fcfc841a83f824783a
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119880318"
---
# <a name="ms-ds-az-role-class"></a>ms DS-Az-Role 類別

定義一組作業，這些作業可由特定範圍內的一組特定使用者執行。
...
| 更新許可權  | AzRoles 系統管理員                           |
| 更新頻率  | 在初始化或原則變更期間。 |
| 架構識別碼-Guid    | 8213eac9-9d55-44dc-925c-e9a52b927644    |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.5.239                                                                                                           |
| 預設值-隱藏-值        | 1                                                                                                                                |
...
| [**描述**](a-description.md)                                        | 否     | **ms DS-Az-角色** [**頂端**](c-top.md)<br/> |
...
| [**ms DS-Az-應用程式-資料**](a-msds-azapplicationdata.md)               | 否     | **ms DS-Az-Role**                                 |
...
| [**ms DS-成員--Az-Role**](a-msds-membersforazrole.md)                | 否     | **ms DS-Az-Role**                                 |
...
| [**ms DS-作業--Az-Role**](a-msds-operationsforazrole.md)          | 否     | **ms DS-Az-Role**                                 |
...
| [**ms DS-工作--Az-角色**](a-msds-tasksforazrole.md)                    | 否     | **ms DS-Az-Role**                                 |
...
| [**ms DS-Az-應用程式-資料**](a-msds-azapplicationdata.md)                  | 否     | **ms DS-Az-Role**                                 |
| [**ms DS-Az-Generic-資料**](a-msds-azgenericdata.md)                          | 否     | **ms DS-Az-Role**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                            | 否     | **ms DS-Az-Role**                                 |
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)         | 否     | [**返回頁首**](c-top.md)<br/>                   |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | 否     | [**返回頁首**](c-top.md)<br/>                   |
