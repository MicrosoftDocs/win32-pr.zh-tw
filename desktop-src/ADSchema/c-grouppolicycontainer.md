...
---
# <a name="group-policy-container-class"></a>群組原則-容器類別

這代表群組原則物件。 它是用來定義群組原則。
...
|-------------------|----------------------------------------------------------|
| CN                | 群組-原則-容器                                   |
| Ldap-顯示名稱 | groupPolicyContainer                                     |
| 更新許可權  | 此值是由網域或原則管理員所設定。 |
| 更新頻率  | 每次透過 GPE 更新 GPO 時。               |
| 架構識別碼-Guid    | f30e3bc2-9ff0-11d1-b603-0000f80367c1                     |
...
| 的子類別                 | [**容器**](c-container.md)<br/>                                                                                                                                                                                      |
| 可能的 Superiors          | \-                                                                                                                                                                                                                               |
| 輔助類別           | \-                                                                                                                                                                                                                               |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                                                                                                                     |
| 預設安全描述項 | D:P (A;CI; RPWPCCDCLCLOLORCWOWDSDDTSW;;;DA)  (;CI; RPWPCCDCLCLOLORCWOWDSDDTSW;;;EA)  (A;CI; RPWPCCDCLCLOLORCWOWDSDDTSW;;;CO)  (A;CI; RPWPCCDCLCLORCWOWDSDDTSW;;;SY)  (A;CI; RPLCLORC;;;AU)  (OA;CI; CR; edacfd8f-ffb3-11d1-b41d-00a0c968f939;;AU)  |
...
| [**一般名稱**](a-cn.md)                                               | 對      | [**容器**](c-container.md)<br/> [**返回頁首**](c-top.md)<br/> |
| [**建立時間戳記**](a-createtimestamp.md)                            | 否     | [**返回頁首**](c-top.md)<br/>                                             |
| [**預設類別-存放區**](a-defaultclassstore.md)                        | 否     | [**容器**](c-container.md)<br/>                                 |
...
| [**標誌**](a-flags.md)                                                  | 否     | **群組-原則-容器** [**頂端**](c-top.md)<br/>                  |
...
| [**GPC-File-Sys-Path**](a-gpcfilesyspath.md)                             | 否     | **群組-原則-容器**                                                  |
| [**GPC-功能-版本**](a-gpcfunctionalityversion.md)            | 否     | **群組-原則-容器**                                                  |
| [**GPC-電腦延伸模組名稱**](a-gpcmachineextensionnames.md)         | 否     | **群組-原則-容器**                                                  |
| [**GPC-使用者延伸-名稱**](a-gpcuserextensionnames.md)               | 否     | **群組-原則-容器**                                                  |
...
| [**架構版本**](a-schemaversion.md)                                 | 否     | [**容器**](c-container.md)<br/>                                 |
...
| [**版本號碼**](a-versionnumber.md)                                 | 否     | **群組-原則-容器**                                                  |
...
| 輔助類別           | \-                                                                                                                                                                                                                                                   |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                                                                                                                                         |
| 預設安全描述項 | D:P (A;CI; RPWPCCDCLCLOLORCWOWDSDDTSW;;;DA)  (;CI; RPWPCCDCLCLOLORCWOWDSDDTSW;;;EA)  (A;CI; RPWPCCDCLCLOLORCWOWDSDDTSW;;;CO)  (A;CI; RPWPCCDCLCLORCWOWDSDDTSW;;;SY)  (A;CI; RPLCLORC;;;AU)  (OA;CI; CR; edacfd8f-ffb3-11d1-b41d-00a0c968f939;;AU)  (A;CI; LCRPLORC;;;ED)  |
| System-Flags                | 0x00000010                                                                                                                                                                                                                                           |
...
| [**GPC-電腦延伸模組名稱**](a-gpcmachineextensionnames.md)           | 否     | **群組-原則-容器**                                                  |
| [**GPC-使用者延伸-名稱**](a-gpcuserextensionnames.md)                 | 否     | **群組-原則-容器**                                                  |
| [**GPC-WQL-篩選**](a-gpcwqlfilter.md)                                    | 否     | **群組-原則-容器**                                                  |
| [**實例類型**](a-instancetype.md)                                     | 對      | [**返回頁首**](c-top.md)<br/>                                             |
| [**為關鍵-系統物件**](a-iscriticalsystemobject.md)               | 否     | [**返回頁首**](c-top.md)<br/>                                             |
| [**已刪除**](a-isdeleted.md)                                           | 否     | [**返回頁首**](c-top.md)<br/>                                             |
| [**是-DL 的成員**](a-memberof.md)                                       | 否     | [**返回頁首**](c-top.md)<br/>                                             |
...
| [**ms-DS-物件參考**](a-msds-objectreference.md)                    | 否     | [**容器**](c-container.md)<br/>                                 |
