...
ms.locfileid: "118422539"
---
# <a name="ms-ds-resource-property-class"></a>ms DS-Resource 屬性類別
...
|-------------------|--------------------------------------|
| CN                | ms DS-資源-屬性              |
| Ldap-顯示名稱 | ResourceProperty                |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 5b283d5e-8404-4195-9339-8450188c501a |
...
| 可能的 Superiors          | [**ms DS-資源-屬性**](c-msds-resourceproperties.md)                                   |
| 輔助類別           | \-                                                                                               |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                     |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLOLORCWOWDSDDTDTSW;;;EA)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPLCLORC;;;AU)  |
...
| [**ms-DS-適用于資源類型**](a-msds-appliestoresourcetypes.md)                         | 否     | **ms DS-資源-屬性**                                                       |
...
| [**ms-chap-使用中-資源安全性屬性**](a-msds-isusedasresourcesecurityattribute.md) | 否     | **ms DS-資源-屬性**                                                       |
...
| [**ms-DS-數值型別參考**](a-msds-valuetypereference.md)                                  | 是      | **ms DS-資源-屬性**                                                       |
