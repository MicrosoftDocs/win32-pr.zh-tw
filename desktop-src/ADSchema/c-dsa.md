...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: ad465f803265e5ca9ec2b5395218e621faf096cd1743fe01e4183e842916484e
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119801868"
---
# <a name="dsa-class"></a>DSA 類別

目錄服務只會使用子類別 MSFT-DSA。
...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 3fdfee52-47f4-11d1-a9c3-0000f80367c1 |
...
| 的子類別                 | [**應用程式-實體**](c-applicationentity.md)<br/>                                 |
| 可能的 Superiors          | [**電腦**](c-computer.md)[**伺服器**](c-server.md)                                     |
| 輔助類別           | \-                                                                                           |
...
| [**一般名稱**](a-cn.md)                                               | 是      | [**應用程式-實體**](c-applicationentity.md)<br/> [**返回頁首**](c-top.md)<br/> |
...
| [**知識資訊**](a-knowledgeinformation.md)                   | 否     | **DSA**                                                                                      |
| [**最後一個已知-父系**](a-lastknownparent.md)                            | 否     | [**返回頁首**](c-top.md)<br/>                                                              |
| [**位置名稱**](a-l.md)                                              | 否     | [**應用程式-實體**](c-applicationentity.md)<br/>                                 |
...
| [**組織單位-名稱**](a-ou.md)                                  | 否     | [**應用程式-實體**](c-applicationentity.md)<br/>                                 |
| [**組織名稱**](a-o.md)                                          | 否     | [**應用程式-實體**](c-applicationentity.md)<br/>                                 |
...
| [**簡報-位址**](a-presentationaddress.md)                     | 是      | [**應用程式-實體**](c-applicationentity.md)<br/>                                 |
...
| [**請參閱-也**](a-seealso.md)                                             | 否     | [**應用程式-實體**](c-applicationentity.md)<br/>                                 |
...
| [**支援-應用程式內容**](a-supportedapplicationcontext.md)    | 否     | [**應用程式-實體**](c-applicationentity.md)<br/>                                 |
