...
ms.locfileid: "118960757"
---
# <a name="ms-ds-hab-seniority-index-attribute"></a>ms DS-HAB-資歷-索引屬性

包含人員所屬組織所套用的的 Seniority 索引。
...
| Ldap-顯示名稱 | msDS-HABSeniorityIndex               |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.1997              |
| 系統識別碼-Guid    | def449f1-fd3b-4045-98cf-d9658da788b5 |
