...
---
# <a name="meetingapplication-attribute"></a>meetingApplication 屬性

此屬性包含將用於線上會議的應用程式名稱，例如 Microsoft NetMeeting、Windows Media Services 或 Microsoft Exchange 會議。
...
| Ldap-顯示名稱 | meetingApplication                          |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.573                      |
| 系統識別碼-Guid    | 11b6cc83-48c4-11d1-a9c3-0000f80367c1        |
