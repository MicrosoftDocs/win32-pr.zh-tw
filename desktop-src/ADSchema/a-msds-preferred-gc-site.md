...
ms.locfileid: "117838138"
---
# <a name="ms-ds-preferred-gc-site-attribute"></a>ms DS-慣用-GC-Site 屬性

在權杖評估期間，安全性帳戶管理員會使用 **MS DS 慣用的 GC-Site** 屬性進行群組擴充。
...
| 系統識別碼-Guid    | d921b50a-0ab2-42cd-87f6-09cf83a91854    |
