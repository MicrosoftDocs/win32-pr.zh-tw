...
---
# <a name="content-indexing-allowed-attribute"></a>內容-索引-允許的屬性
...
|-------------------|--------------------------------------|
| CN                | 內容-索引-允許             |
| Ldap-顯示名稱 | contentIndexingAllowed               |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.24                |
| 系統識別碼-Guid    | bf967943-0de6-11d0-a285-00aa003049e2 |
