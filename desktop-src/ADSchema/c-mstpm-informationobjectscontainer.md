...
---
# <a name="ms-tpm-information-objects-container-class"></a>ms-TPM-資訊-物件-容器類別
...
|-------------------|--------------------------------------|
| CN                | ms-TPM-資訊-物件-容器 |
| Ldap-顯示名稱 | Mstpm-ownerinformation-InformationObjectsContainer    |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | e027a8bd-6456-45de-90a3-38593877ee74 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.276                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | \-                                                                                           |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                              |
| 可能的 Superiors          | [**網域**](c-domain.md)[**網域-DNS**](c-domaindns.md)                                  |
| 輔助類別           | \-                                                                                           |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                 |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;LOLCCCRP;;;DC)  |
...
| [**一般名稱**](a-cn.md)                                                                  | 對      | **ms-TPM-資訊-物件-容器** [**頂端**](c-top.md)<br/> |
