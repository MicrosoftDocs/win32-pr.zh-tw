...
| 更新許可權  | 任何人都可以更新此物件。       |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | bf967aa8-0de6-11d0-a285-00aa003049e2 |
...
| 的子類別                 | [**連接點**](c-connectionpoint.md)<br/>                                                                                                             |
| 可能的 Superiors          | [**電腦**](c-computer.md)[**容器**](c-container.md)[**網域-DNS**](c-domaindns.md)[**組織單位**](c-organizationalunit.md)                   |
| 輔助類別           | \-                                                                                                                                                                   |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                                                         |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;PO)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;CO)  (A;;RPLCLORC;;;AU)  |
...
| [**驅動程式名稱**](a-drivername.md)                                       | 否     | **列印佇列**                                                                          |
| [**驅動程式版本**](a-driverversion.md)                                 | 否     | **列印佇列**                                                                          |
...
| [**作業系統-修復程式**](a-operatingsystemhotfix.md)                | 否     | **列印佇列**                                                                          |
| [**作業系統-Service Pack**](a-operatingsystemservicepack.md)     | 否     | **列印佇列**                                                                          |
| [**作業系統版本**](a-operatingsystemversion.md)              | 否     | **列印佇列**                                                                          |
...
| [**實體位置-物件**](a-physicallocationobject.md)              | 否     | **列印佇列**                                                                          |
| [**埠名稱**](a-portname.md)                                           | 否     | **列印佇列**                                                                          |
| [**可能-Inferiors**](a-possibleinferiors.md)                         | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**列印-屬性**](a-printattributes.md)                             | 否     | **列印佇列**                                                                          |
| [**列印-Bin 名稱**](a-printbinnames.md)                                | 否     | **列印佇列**                                                                          |
| [**列印-Collate**](a-printcollate.md)                                   | 否     | **列印佇列**                                                                          |
...
| [**列印-MAC 位址**](a-printmacaddress.md)                            | 否     | **列印佇列**                                                                          |
| [**列印-最大複本**](a-printmaxcopies.md)                              | 否     | **列印佇列**                                                                          |
| [**列印-最大解析度-支援**](a-printmaxresolutionsupported.md)   | 否     | **列印佇列**                                                                          |
| [**列印-最大-X-範圍**](a-printmaxxextent.md)                           | 否     | **列印佇列**                                                                          |
| [**列印-最大-Y-範圍**](a-printmaxyextent.md)                           | 否     | **列印佇列**                                                                          |
| [**列印-媒體就緒**](a-printmediaready.md)                            | 否     | **列印佇列**                                                                          |
| [**列印-媒體-支援**](a-printmediasupported.md)                    | 否     | **列印佇列**                                                                          |
| [**列印-記憶體**](a-printmemory.md)                                     | 否     | **列印佇列**                                                                          |
| [**列印-最小-X-範圍**](a-printminxextent.md)                           | 否     | **列印佇列**                                                                          |
| [**列印-最小-Y-範圍**](a-printminyextent.md)                           | 否     | **列印佇列**                                                                          |
| [**列印-網路位址**](a-printnetworkaddress.md)                    | 否     | **列印佇列**                                                                          |
| [**列印-通知**](a-printnotify.md)                                     | 否     | **列印佇列**                                                                          |
| [**列印-編號**](a-printnumberup.md)                                | 否     | **列印佇列**                                                                          |
| [**列印方向-支援**](a-printorientationssupported.md)      | 否     | **列印佇列**                                                                          |
| [**列印-擁有者**](a-printowner.md)                                       | 否     | **列印佇列**                                                                          |
| [**列印-每分鐘頁面**](a-printpagesperminute.md)                   | 否     | **列印佇列**                                                                          |
| [**列印速率**](a-printrate.md)                                         | 否     | **列印佇列**                                                                          |
| [**列印-費率-單位**](a-printrateunit.md)                                | 否     | **列印佇列**                                                                          |
| [**列印-分隔符號-檔案**](a-printseparatorfile.md)                      | 否     | **列印佇列**                                                                          |
| [**列印-共用-名稱**](a-printsharename.md)                              | 否     | **列印佇列**                                                                          |
| [**列印-幕後處理**](a-printspooling.md)                                 | 否     | **列印佇列**                                                                          |
| [**列印-裝訂-支援**](a-printstaplingsupported.md)              | 否     | **列印佇列**                                                                          |
| [**列印-開始時間**](a-printstarttime.md)                              | 否     | **列印佇列**                                                                          |
| [**列印-狀態**](a-printstatus.md)                                     | 否     | **列印佇列**                                                                          |
| [**優先順序**](a-priority.md)                                            | 否     | **列印佇列**                                                                          |
