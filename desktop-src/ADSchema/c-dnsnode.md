...
---
# <a name="dns-node-class"></a>Dns-Node 類別
...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | e0fa1e8c-9b45-11d0-afdd-00c04fd930c9 |
...
| Object-Category             | 1                                                                                                                                                                    |
| 預設-物件-類別     | \-                                                                                                                                                                   |
| Governs-Id                  | 1.2.840.113556.1.5.86                                                                                                                                                |
| 預設值-隱藏-值        | 1                                                                                                                                                                    |
| Rdn-Att-Id                  | [**網域元件**](a-dc.md)<br/>                                                                                                                          |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                                                      |
| 可能的 Superiors          | [**Dns-區域**](c-dnszone.md)                                                                                                                                        |
| 輔助類別           | \-                                                                                                                                                                   |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                                                         |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;ED)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;CO)  (A;;RPLCLORC;;;WD)  |
...
| [**DNS-屬性**](a-dnsproperty.md)                                     | 否     | **Dns-Node**                    |
| [**Dns-記錄**](a-dnsrecord.md)                                         | 否     | **Dns-Node**                    |
| [**DNS-已被刪除**](a-dnstombstoned.md)                                 | 否     | **Dns-Node**                    |
| [**網域元件**](a-dc.md)                                          | 對      | **Dns-Node**                    |
