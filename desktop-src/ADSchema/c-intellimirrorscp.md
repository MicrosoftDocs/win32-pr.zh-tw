...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: d328ca14a8c96b37d766405466f3e74c4fc34ab212a7ff686039be15ee368584
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118423116"
---
# <a name="intellimirror-scp-class"></a>Intellimirror-SCP 類別

此物件包含服務的設定資訊，此服務會回應遠端開機用戶端，並從遠端安裝伺服器要求注意。
...
| Ldap-顯示名稱 | intellimirrorSCP                               |
| 更新許可權  | 此值是由網域系統管理員所設定。 |
| 更新頻率  | \-                                             |
| 架構識別碼-Guid    | 07383085-91df-11d1-aebc-0000f80367c1           |
...
| 的子類別                 | [**服務管理-點**](c-serviceadministrationpoint.md)<br/>              |
| 可能的 Superiors          | [**Intellimirror-群組**](c-intellimirrorgroup.md)[**電腦**](c-computer.md)            |
| 輔助類別           | \-                                                                                           |
...
| [**netboot-允許-新增-用戶端**](a-netbootallownewclients.md)                | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-僅限回應-有效-用戶端**](a-netbootansweronlyvalidclients.md) | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-解答-要求**](a-netbootanswerrequests.md)                   | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-目前-用戶端計數**](a-netbootcurrentclientcount.md)          | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-IntelliMirror-作業系統**](a-netbootintellimirroroses.md)             | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-限制-用戶端**](a-netbootlimitclients.md)                       | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-本機安裝-作業系統**](a-netbootlocallyinstalledoses.md)      | 否     | **Intellimirror-SCP**                                                                    |
| [**Netboot-電腦-檔案-路徑**](a-netbootmachinefilepath.md)                | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-最大用戶端**](a-netbootmaxclients.md)                           | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-新增-電腦-命名原則**](a-netbootnewmachinenamingpolicy.md) | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-新增-電腦-OU**](a-netbootnewmachineou.md)                      | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                     | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**netboot-伺服器**](a-netbootserver.md)                                    | 否     | **Intellimirror-SCP**                                                                    |
| [**netboot-工具**](a-netboottools.md)                                      | 否     | **Intellimirror-SCP**                                                                    |
