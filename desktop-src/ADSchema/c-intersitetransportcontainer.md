...
---
# <a name="inter-site-transport-container-class"></a>網站間-傳輸-容器類別
...
|-------------------|--------------------------------------|
| CN                | 站間-傳輸-容器       |
| Ldap-顯示名稱 | interSiteTransportContainer          |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 26d97375-6070-11d1-a9c6-0000f80367c1 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.140                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
