...
---
# <a name="ms-sql-unicodesortorder-attribute"></a>UnicodeSortOrder 屬性

SQL Server 目前實例的 Unicode 排序次序。
...
|-------------------|--------------------------------------|
| CN                | UnicodeSortOrder              |
| Ldap-顯示名稱 | UnicodeSortOrder              |
| 大小              | 4 個位元組                              |
| 更新許可權  | 網域系統管理員                 |
| 更新頻率  | 在系統啟動時。                   |
| Attribute-Id      | 1.2.840.113556.1.4.1372              |
| 系統識別碼-Guid    | 72dc918a-ccee-11d2-9993-0000f87a57d4 |
