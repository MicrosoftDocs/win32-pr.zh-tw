...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 0f5790e40c6c0446f56ca92ed13a3a4a2591803fc8d69440b84b9689547256c5
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119324118"
---
# <a name="link-track-volume-table-class"></a>連結-追蹤-磁片區資料表類別
...
|-------------------|---------------------------------------|
| CN                | 連結-追蹤-磁片區資料表               |
| Ldap-顯示名稱 | linkTrackVolumeTable                  |
| 更新許可權  | 此值是由系統所設定。      |
| 更新頻率  | 每次建立檔案的連結時。 |
| 架構識別碼-Guid    | ddac0cf4-af8f-11d0-afeb-00c04fd930c9  |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.90                                                                        |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                       |
| 的子類別                 | [**檔案-連結-追蹤**](c-filelinktracking.md)<br/>                                  |
| 可能的 Superiors          | [**檔案-連結-追蹤**](c-filelinktracking.md)                                             |
| 輔助類別           | \-                                                                                           |
