...
ms.locfileid: "119922808"
---
# <a name="dynamic-object-class"></a>Dynamic-Object 類別

此類別（如果存在於專案中）表示這個專案的存留期有限，而且在存留時間到達0時可能會自動消失。 如果用戶端未提供 entryTtl 屬性的值，伺服器將會提供一個值。
...
|-------------------|--------------------------------------|
| CN                | Dynamic-Object                       |
| Ldap-顯示名稱 | dynamicObject                        |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 66d51249-3355-4c1f-b24e-81f252aca23b |
...
| [**ms DS-進入-存留時間**](a-msds-entry-time-to-die.md)                 | 否     | **動態物件**              |
