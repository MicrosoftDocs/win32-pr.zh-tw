...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: da792a02f8a2db17f88ada9fa5eac4441985c866930bbc7947aa46a14becce54
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119702238"
---
# <a name="address-template-class"></a>Address-Template 類別
...
|-------------------|--------------------------------------|
| CN                | Address-Template                     |
| Ldap-顯示名稱 | addressTemplate                      |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 5fd4250a-1262-11d0-a060-00aa006c33ed |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.3.58                                                                        |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                       |
| 的子類別                 | [**顯示範本**](c-displaytemplate.md)<br/>                                     |
...
| 屬性                                                                    | 強制性 | 衍生自                                                                             |
|------------------------------------------------------------------------------|-----------|------------------------------------------------------------------------------------------|
| [**位址-輸入-顯示資料表**](a-addressentrydisplaytable.md)            | 否     | [**顯示範本**](c-displaytemplate.md)<br/>                                 |
| [**位址-輸入-顯示資料表-MSDOS.SYS**](a-addressentrydisplaytablemsdos.md) | 否     | [**顯示範本**](c-displaytemplate.md)<br/>                                 |
| [**Address-語法**](a-addresssyntax.md)                                    | 否     | **位址範本**                                                                     |
| [**網址類別型**](a-addresstype.md)                                        | 否     | **位址範本**                                                                     |
...
| [**一般名稱**](a-cn.md)                                                  | 是      | [**顯示範本**](c-displaytemplate.md)<br/> [**返回頁首**](c-top.md)<br/> |
| [**建立時間戳記**](a-createtimestamp.md)                               | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**描述**](a-description.md)                                         | 否     | [**返回頁首**](c-top.md)<br/>                                                          |
| [**顯示名稱**](a-displayname.md)                                        | 是      | **位址範本** [**頂端**](c-top.md)<br/>                                     |
...
| [**說明-Data16**](a-helpdata16.md)                                          | 否     | [**顯示範本**](c-displaytemplate.md)<br/>                                 |
| [**說明-Data32**](a-helpdata32.md)                                          | 否     | [**顯示範本**](c-displaytemplate.md)<br/>                                 |
| [**說明檔-檔案名**](a-helpfilename.md)                                     | 否     | [**顯示範本**](c-displaytemplate.md)<br/>                                 |
...
| [**原始-顯示資料表**](a-originaldisplaytable.md)                     | 否     | [**顯示範本**](c-displaytemplate.md)<br/>                                 |
| [**原始-顯示資料表-MSDOS.SYS**](a-originaldisplaytablemsdos.md)          | 否     | [**顯示範本**](c-displaytemplate.md)<br/>                                 |
...
| [**每個訊息-對話方塊-顯示資料表**](a-permsgdialogdisplaytable.md)           | 否     | **位址範本**                                                                     |
| [**每一 Recip-對話方塊-顯示資料表**](a-perrecipdialogdisplaytable.md)       | 否     | **位址範本**                                                                     |
...
| [**Proxy 產生-已啟用**](a-proxygenerationenabled.md)                 | 否     | **位址範本**                                                                     |
