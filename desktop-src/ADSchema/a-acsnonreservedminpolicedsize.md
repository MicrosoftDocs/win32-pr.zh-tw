...
ms.locfileid: "118178422"
---
# <a name="acs-non-reserved-min-policed-size-attribute"></a>ACS-非保留-最小-Policed-大小屬性

**ACS-非保留-最小 Policed 大小** 屬性僅供內部使用。 以 RFC2814 為基礎。



| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | ACS-非保留-最小-Policed-大小    |
| Ldap-顯示名稱 | aCSNonReservedMinPolicedSize         |
| 大小              | 8 個位元組                              |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.1321              |
| 系統識別碼-Guid    | b6873917-3b90-11d2-90cc-00c04fd91ab1 |
