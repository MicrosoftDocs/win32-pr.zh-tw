...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 473efce6d9e36909bd53d6bdb5e187e7cb96f5897f2752db688d75c960f320fa
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118175347"
---
# <a name="msmq-configuration-class"></a>MSMQ-Configuration 類別

此物件包含特定電腦的 MSMQ 設定參數。 此類別的屬性是 MSMQ 特定的，而且會用於 MSMQ 路由決策。
...
| Ldap-顯示名稱 | mSMQConfiguration                                                                                     |
| 更新許可權  | 佇列擁有者。                                                                                      |
| 更新頻率  | 每一部安裝 MSMQ 之電腦的電腦物件下，都會建立這個類別的實例。 |
| 架構識別碼-Guid    | 9a0dc344-c100-11d1-bbc5-0080c76670c0                                                                  |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.162                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                       |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                              |
| 可能的 Superiors          | [**電腦**](c-computer.md)                                                               |
| 輔助類別           | \-                                                                                           |
...
| [**MSMQ-電腦類型**](a-msmqcomputertype.md)                          | 否     | **MSMQ-設定**          |
| [**MSMQ-電腦類型-Ex**](a-msmqcomputertypeex.md)                     | 否     | **MSMQ-設定**          |
| [**MSMQ 相依-用戶端服務**](a-msmqdependentclientservices.md)   | 否     | **MSMQ-設定**          |
| [**MSMQ-Ds-服務**](a-msmqdsservices.md)                              | 否     | **MSMQ-設定**          |
| [**MSMQ-加密-金鑰**](a-msmqencryptkey.md)                              | 否     | **MSMQ-設定**          |
| [**MSMQ-外部**](a-msmqforeign.md)                                     | 否     | **MSMQ-設定**          |
| [**MSMQ 路由傳送伺服器**](a-msmqinroutingservers.md)                 | 否     | **MSMQ-設定**          |
| [**MSMQ 日誌-配額**](a-msmqjournalquota.md)                          | 否     | **MSMQ-設定**          |
| [**MSMQ-OS 類型**](a-msmqostype.md)                                      | 否     | **MSMQ-設定**          |
| [**MSMQ 輸出路由-伺服器**](a-msmqoutroutingservers.md)               | 否     | **MSMQ-設定**          |
| [**MSMQ-擁有者識別碼**](a-msmqownerid.md)                                    | 否     | **MSMQ-設定**          |
| [**MSMQ-配額**](a-msmqquota.md)                                         | 否     | **MSMQ-設定**          |
| [**MSMQ 路由服務**](a-msmqroutingservices.md)                    | 否     | **MSMQ-設定**          |
| [**MSMQ-服務類型**](a-msmqservicetype.md)                            | 否     | **MSMQ-設定**          |
| [**MSMQ-簽署金鑰**](a-msmqsignkey.md)                                    | 否     | **MSMQ-設定**          |
| [**MSMQ-網站**](a-msmqsites.md)                                         | 否     | **MSMQ-設定**          |
