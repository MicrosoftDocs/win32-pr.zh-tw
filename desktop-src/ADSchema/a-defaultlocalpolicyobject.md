...
---
# <a name="default-local-policy-object-attribute"></a>預設-本機原則-物件屬性

原則物件的參考，該物件定義主物件的本機原則。
...
|-------------------|-----------------------------------------|
| CN                | 預設-本機-原則-物件             |
| Ldap-顯示名稱 | defaultLocalPolicyObject                |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.57                   |
| 系統識別碼-Guid    | bf96799f-0de6-11d0-a285-00aa003049e2    |
...
| 中使用的類別        | [**電腦**](c-computer.md)<br/> [**網域原則**](c-domainpolicy.md)<br/> [**Sam-網域**](c-samdomain.md)<br/> |
