...
---
# <a name="ms-ds-minimum-password-age-attribute"></a>ms-chap-最小密碼-存留期屬性
...
| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | ms-chap-最小密碼-使用期限           |
| Ldap-顯示名稱 | msDS-MinimumPasswordAge              |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.2012              |
| 系統識別碼-Guid    | 2a74f878-4d9c-49f9-97b3-6767d1cbd9a3 |
