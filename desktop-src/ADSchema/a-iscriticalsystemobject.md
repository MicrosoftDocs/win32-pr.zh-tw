...
ms.locfileid: "119924878"
---
# <a name="is-critical-system-object-attribute"></a>為關鍵-系統物件屬性

若 **為 TRUE**，則在安裝新的複本期間，必須複寫裝載這個屬性的物件。
...
|-------------------|--------------------------------------|
| CN                | 為關鍵-系統物件            |
| Ldap-顯示名稱 | isCriticalSystemObject               |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.868               |
| 系統識別碼-Guid    | 00fbf30d-91fe-11d1-aebc-0000f80367c1 |
