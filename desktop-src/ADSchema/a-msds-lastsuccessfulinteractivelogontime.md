...
ms.locfileid: "119295540"
---
# <a name="ms-ds-last-successful-interactive-logon-time-attribute"></a>ms DS-上次成功-互動式登入時間屬性

在 Ctrl + Alt + Delete 登入期間提供正確密碼的時間。



| 進入 | 值 |
|-------------------|----------------------------------------------|
| CN                | ms-DS-上次成功-互動式登入時間 |
| Ldap-顯示名稱 | msDS-LastSuccessfulInteractiveLogonTime      |
| 大小              | \-                                           |
| 更新許可權  | \-                                           |
| 更新頻率  | \-                                           |
| Attribute-Id      | 1.2.840.113556.1.4.1970                      |
| 系統識別碼-Guid    | 011929e6-8b5d-4258-b64a-00b0b4949747         |
