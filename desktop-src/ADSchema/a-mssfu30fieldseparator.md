---
title: msSFU-30-Field-Separator 屬性
description: 包含每個 NIS 對應的欄位分隔符號。
ms.assetid: 378a37a8-a0a2-467f-ad30-40a9d522f7a2
ms.tgt_platform: multiple
keywords:
- msSFU-30-欄位-分隔符號屬性 AD 架構
- msSFU30FieldSeparator 屬性 AD 架構
topic_type:
- apiref
api_name:
...
|-------------------|---------------------------------------------|
| CN                | msSFU-30-欄位-分隔符號                    |
| Ldap-顯示名稱 | msSFU30FieldSeparator                       |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.6.18.1.302                 |
| 系統識別碼-Guid    | a2e11a42-e781-4ca1-a7fa-ec307f62b6a1        |
