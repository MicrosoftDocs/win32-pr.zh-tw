...
ms.locfileid: "118682730"
---
# <a name="ms-fve-recoveryguid-attribute"></a>FVE-Ms-fve-recoveryguid 屬性

包含與完整磁片區加密相關聯的 GUID (FVE) 修復密碼。
...
| Ldap-顯示名稱 | msFVE-RecoveryGuid                                    |
| 大小              | \-                                                    |
| 更新許可權  | \-                                                    |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.1965                               |
| 系統識別碼-Guid    | f76909bc-e678-47a0-b0b3-f86a0044c06d                  |
...
| 中使用的類別        | [**ms-FVE-RecoveryInformation**](c-msfve-recoveryinformation.md)<br/> |
