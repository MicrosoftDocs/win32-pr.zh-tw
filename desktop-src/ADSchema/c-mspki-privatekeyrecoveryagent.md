...
ms.locfileid: "119879798"
---
# <a name="ms-pki-private-key-recovery-agent-class"></a>ms-PKI-私用金鑰-修復代理程式類別

用來發佈 KRA 容器中的金鑰復原代理憑證。



| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | ms-PKI-私用金鑰-復原代理程式    |
| Ldap-顯示名稱 | Mspki-certificate-name-flag-PrivateKeyRecoveryAgent        |
| 更新許可權  | 網域系統管理員                 |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 1562a632-44b9-4a7e-a2d3-e426c96a3acc |
...
| [**X509-Cert**](a-usercertificate.md)                                      | 是      | **ms-PKI-私用金鑰-復原代理程式** |
