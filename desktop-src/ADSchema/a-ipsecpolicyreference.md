...
ms.locfileid: "119322488"
---
# <a name="ipsec-policy-reference-attribute"></a>Ipsec-原則參考屬性

相關網際網路通訊協定安全性 (IPsec) 原則的分辨名稱。
...
|-------------------|-----------------------------------------|
| CN                | Ipsec-原則-參考                  |
| Ldap-顯示名稱 | ipsecPolicyReference                    |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.517                  |
| 系統識別碼-Guid    | b7b13118-b82e-11d0-afee-0000f80367c1    |
