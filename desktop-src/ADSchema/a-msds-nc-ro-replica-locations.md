...
---
# <a name="ms-ds-nc-ro-replica-locations-attribute"></a>ms DS-NC-RO-Replica-位置屬性

分割區之交互參考物件的連結屬性。 列出應以唯讀方式裝載分割區的 DC。
...
| Ldap-顯示名稱 | msDS-NC-RO-Replica-Locations            |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.1967                 |
| 系統識別碼-Guid    | 3df793df-9858-4417-a701-735a1ecebf74    |
