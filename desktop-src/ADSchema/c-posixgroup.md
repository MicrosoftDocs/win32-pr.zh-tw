...
ms.locfileid: "118680503"
---
# <a name="posixgroup-class"></a>posixGroup 類別
...
|-------------------|--------------------------------------|
| CN                | posixGroup                           |
| Ldap-顯示名稱 | posixGroup                           |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 2a9350b8-062c-4ed0-9903-dde10d06deba |
...
| [**一般名稱**](a-cn.md)                                                 | 否     | **posixGroup** [ **Top**](c-top.md)<br/> |
| [**建立時間戳記**](a-createtimestamp.md)                              | 否     | [**返回頁首**](c-top.md)<br/>                |
| [**描述**](a-description.md)                                        | 否     | **posixGroup** [ **Top**](c-top.md)<br/> |
...
| [**gidNumber**](a-gidnumber.md)                                            | 否     | **posixGroup**                                 |
...
| [**memberUid**](a-memberuid.md)                                            | 否     | **posixGroup**                                 |
...
| [**unixUserPassword**](a-unixuserpassword.md)                              | 否     | **posixGroup**                                 |
| [**使用者-密碼**](a-userpassword.md)                                     | 否     | **posixGroup**                                 |
