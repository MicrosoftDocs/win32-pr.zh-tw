...
description: 適用于應用程式的 X. 500 基類 Exchange 僅使用子類別 DSA 應用程式。
...
ms.locfileid: "119702058"
---
# <a name="application-process-class"></a>Application-Process 類別

適用于應用程式的 X. 500 基類： Exchange 只會使用子類別 DSA 應用程式。
...
| Ldap-顯示名稱 | applicationProcess                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 5fd4250b-1262-11d0-a060-00aa006c33ed |
...
| 可能的 Superiors          | [**電腦**](c-computer.md)[**容器**](c-container.md)                               |
| 輔助類別           | \-                                                                                           |
...
| [**一般名稱**](a-cn.md)                                               | 是      | **應用程式-進程** [**頂端**](c-top.md)<br/> |
...
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                                                                                  |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                                         |
| 可能的 Superiors          | [**電腦**](c-computer.md)[**容器**](c-container.md)[**組織**](c-organization.md)[**組織單位**](c-organizationalunit.md) |
| 輔助類別           | \-                                                                                                                                                      |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                                            |
| 預設安全描述項 | D:(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)(A;;RPLCLORC;;;AU)                                                            |
| System-Flags                | 0x00000010                                                                                                                                              |
