...
ms.locfileid: "118423829"
---
# <a name="querypoint-attribute"></a>QueryPoint 屬性

查詢頁面的 URL 或 UNC，或其他用來存取目錄的前端。
...
|-------------------|---------------------------------------------|
| CN                | QueryPoint                                  |
| Ldap-顯示名稱 | queryPoint                                  |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.680                      |
| 系統識別碼-Guid    | 7bfdcb86-4807-11d1-a9c3-0000f80367c1        |
