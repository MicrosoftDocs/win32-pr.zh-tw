...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: bbf35091ac87ed5261abc679bb97b76632c7256f6ec39450099fdb27da025bb4
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118175212"
---
# <a name="msmq-migrated-user-class"></a>MSMQ 遷移的使用者類別

在 MSMQ 1.0 中，我們有自己的 DS，我們會在其中保存每位使用者的部分資訊。 在 msmq 與 Windows 2000 DS 整合的過程中，msmq 會提供遷移工具。 在遷移期間，針對不在 Windows 2000 網域中的每個使用者，我們會建立遷移的使用者。
...
|-------------------|--------------------------------------------------------------------------------------------------|
| CN                | MSMQ 遷移-使用者                                                                               |
| Ldap-顯示名稱 | mSMQMigratedUser                                                                                 |
| 更新許可權  | 佇列擁有者。                                                                                 |
| 更新頻率  | 此物件是由混合模式網域環境中的訊息佇列升級嚮導所建立。 |
| 架構識別碼-Guid    | 50776997-3c3d-11d2-90cc-00c04fd91ab1                                                             |
...
| Object-Category             | 1                                                                                                                             |
| 預設-物件-類別     | \-                                                                                                                            |
| Governs-Id                  | 1.2.840.113556.1.5.179                                                                                                        |
| 預設值-隱藏-值        | 1                                                                                                                             |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                                                        |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                               |
| 可能的 Superiors          | 內 [**建-網域**](c-builtindomain.md)[**網域 DNS**](c-domaindns.md)[**組織單位**](c-organizationalunit.md) |
| 輔助類別           | \-                                                                                                                            |
...
| [**MSMQ 摘要**](a-msmqdigests.md)                                     | 否     | **MSMQ 遷移-使用者**          |
| [**MSMQ-摘要-Svrmig.mig**](a-msmqdigestsmig.md)                              | 否     | **MSMQ 遷移-使用者**          |
| [**MSMQ-簽署憑證**](a-msmqsigncertificates.md)                  | 否     | **MSMQ 遷移-使用者**          |
| [**MSMQ-簽署-憑證-Svrmig.mig**](a-msmqsigncertificatesmig.md)           | 否     | **MSMQ 遷移-使用者**          |
| [**MSMQ-使用者 Sid**](a-msmqusersid.md)                                    | 否     | **MSMQ 遷移-使用者**          |
...
| [**物件 Sid**](a-objectsid.md)                                         | 否     | **MSMQ 遷移-使用者**          |
