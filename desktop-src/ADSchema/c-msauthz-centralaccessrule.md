...
ms.locfileid: "119323708"
---
# <a name="ms-authz-central-access-rule-class"></a>ms-Authz-存取-規則類別

類別，定義用來建立集中存取原則的集中存取規則。
...
|-------------------|--------------------------------------|
| CN                | ms-Authz-存取-規則         |
| Ldap-顯示名稱 | msAuthz-CentralAccessRule            |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 5b4a06dc-251c-4edb-8813-0bdd71327226 |
...
| 可能的 Superiors          | [**ms-Authz-集中存取-規則**](c-msauthz-centralaccessrules.md)                        |
| 輔助類別           | \-                                                                                           |
...
| [**啟用**](a-enabled.md)                                                                 | 否     | **ms-Authz-存取-規則** |
...
| [**ms-Authz-有效-安全性-原則**](a-msauthz-effectivesecuritypolicy.md)              | 否     | **ms-Authz-存取-規則** |
| [**ms-Authz-最新-安全性-原則**](a-msauthz-lasteffectivesecuritypolicy.md)     | 否     | **ms-Authz-存取-規則** |
| [**ms-Authz-建議的安全性原則**](a-msauthz-proposedsecuritypolicy.md)                | 否     | **ms-Authz-存取-規則** |
| [**ms-Authz-資源-條件**](a-msauthz-resourcecondition.md)                           | 否     | **ms-Authz-存取-規則** |
