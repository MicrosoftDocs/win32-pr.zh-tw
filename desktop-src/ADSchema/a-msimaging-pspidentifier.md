...
---
# <a name="ms-imaging-psp-identifier-attribute"></a>毫秒-影像處理-PSP 識別碼屬性

包含此 Post 掃描程式之唯一識別碼的架構屬性。
...
|-------------------|-------------------------------------------------------|
| CN                | 毫秒-影像處理-PSP-識別碼                             |
| Ldap-顯示名稱 | msImaging-PSPIdentifier                               |
| 大小              | \-                                                    |
| 更新許可權  | \-                                                    |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.2053                               |
| 系統識別碼-Guid    | 51583ce9-94fa-4b12-b990-304c35b18595                  |
...
| 中使用的類別        | [**毫秒-映射-PostScanProcess**](c-msimaging-postscanprocess.md)<br/> |
