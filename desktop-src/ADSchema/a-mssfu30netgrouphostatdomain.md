...
ms.locfileid: "120066388"
---
# <a name="mssfu-30-netgroup-host-at-domain-attribute"></a>msSFU-30-網路-網域-主機網域屬性

包含代表計算字串的網路組對應部分，例如 " host@domain "。



| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | msSFU-30-網路-網域-網域間主機     |
| Ldap-顯示名稱 | msSFU30NetgroupHostAtDomain          |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.6.18.1.348          |
| 系統識別碼-Guid    | 97d2bf65-0466-4852-a25a-ec20f57ee36c |
...
| 中使用的類別        | [**nisNetgroup**](c-nisnetgroup.md)<br/> |
