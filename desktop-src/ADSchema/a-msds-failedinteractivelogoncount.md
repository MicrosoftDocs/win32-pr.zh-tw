...
ms.locfileid: "118426761"
---
# <a name="ms-ds-failed-interactive-logon-count-attribute"></a>ms DS-失敗-互動式登入計數屬性

在開啟此功能之後，失敗的互動式登入的總數。



| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | ms DS-失敗-互動式登入-計數 |
| Ldap-顯示名稱 | msDS-FailedInteractiveLogonCount     |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.1972              |
| 系統識別碼-Guid    | dc3ca86f-70ad-4960-8425-a4d6313d93dd |
