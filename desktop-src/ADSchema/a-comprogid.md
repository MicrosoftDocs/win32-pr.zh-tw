...
---
# <a name="com-progid-attribute"></a>COM-ProgID 屬性

這個屬性會儲存在此應用程式封裝中所執行之 COM 物件程式識別碼的清單。
...
| 系統識別碼-Guid    | bf96793d-0de6-11d0-a285-00aa003049e2                                             |
...
| 中使用的類別        | [**類別註冊**](c-classregistration.md)<br/> [**套件-註冊**](c-packageregistration.md)<br/> |
