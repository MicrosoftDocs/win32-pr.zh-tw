...
ms.locfileid: "119925068"
---
# <a name="ipsec-negotiation-policy-type-attribute"></a>IPSEC-協商-原則類型屬性

**Ipsec-協商-原則類型** 屬性僅供內部使用。
...
|-------------------|---------------------------------------------|
| CN                | IPSEC-協調-原則-類型               |
| Ldap-顯示名稱 | iPSECNegotiationPolicyType                  |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.887                      |
| 系統識別碼-Guid    | 07383074-91df-11d1-aebc-0000f80367c1        |
...
| 中使用的類別        | [**Ipsec-協調原則**](c-ipsecnegotiationpolicy.md)<br/> |
