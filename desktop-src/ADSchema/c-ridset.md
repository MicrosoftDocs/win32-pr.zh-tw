...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 5543d261a766523aea1709b3cb61e28736a72fa3eaec3f043f5aa423efe7b44e
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118959540"
---
# <a name="rid-set-class"></a>RID-Set 類別

每個網域控制站都有其中一種。 它會保存 DC 所配置的 RID 集區。
...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 7bfdcb89-4807-11d1-a9c3-0000f80367c1 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.129                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                       |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                              |
| 可能的 Superiors          | [**電腦**](c-computer.md)[**容器**](c-container.md)[**使用者**](c-user.md)         |
| 輔助類別           | \-                                                                                           |
...
| [**RID-組態集區**](a-ridallocationpool.md)                        | 是      | **RID 集**                     |
| [**RID-下一個 RID**](a-ridnextrid.md)                                      | 是      | **RID 集**                     |
| [**RID-先前組態集區**](a-ridpreviousallocationpool.md)       | 是      | **RID 集**                     |
| [**RID-已使用集區**](a-ridusedpool.md)                                    | 是      | **RID 集**                     |
