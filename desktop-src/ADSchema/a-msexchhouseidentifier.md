...
---
# <a name="ms-exch-house-identifier-attribute"></a>Ms-exch-assistant-name-內部識別碼屬性

此屬性包含 Exchange server 通訊錄中連絡人的位址。



| 進入 | 值 |
|-------------------|---------------------------------------------|
| CN                | Ms-exch-assistant-name-內部識別碼                    |
| Ldap-顯示名稱 | msExchHouseIdentifier                       |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.2.596                      |
| 系統識別碼-Guid    | a8df7407-c5ea-11d1-bbcb-0080c76670c0        |
