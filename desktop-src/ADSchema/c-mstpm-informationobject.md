...
ms.locfileid: "119879308"
---
# <a name="ms-tpm-information-object-class"></a>ms-TPM-Information 物件類別

此類別包含可信賴平臺模組 (TPM) 裝置的修復資訊。
...
|-------------------|--------------------------------------|
| CN                | ms-TPM-資訊-物件            |
| Ldap-顯示名稱 | Mstpm-ownerinformation-InformationObject              |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 85045b6a-47a6-4243-a7cc-6890701f662c |
...
| 可能的 Superiors          | [**ms-TPM-資訊-物件-容器**](c-mstpm-informationobjectscontainer.md)                  |
| 輔助類別           | \-                                                                                                   |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                         |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPLO;;;DC)  (A;;WP;;;共同)  |
...
| [**ms-TPM-OwnerInformation**](a-mstpm-ownerinformation.md)                                  | 是      | **ms-TPM-資訊-物件**   |
| [**ms-TPM-擁有者-資訊-暫存**](a-mstpm-ownerinformationtemp.md)                        | 否     | **ms-TPM-資訊-物件**   |
| [**ms-TPM-Srk-Pub-指紋**](a-mstpm-srkpubthumbprint.md)                                | 否     | **ms-TPM-資訊-物件**   |
