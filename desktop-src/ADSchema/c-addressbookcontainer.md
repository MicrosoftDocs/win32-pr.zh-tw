...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 65da57625f9767c744b41b13692a6b23bb6a529ef0676d1ada49f61707a07e63
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119644108"
---
# <a name="address-book-container-class"></a>通訊錄-容器類別
...
|-------------------|--------------------------------------|
| CN                | 通訊錄-容器               |
| Ldap-顯示名稱 | addressBookContainer                 |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 3e74f60f-3e73-11d1-a9c0-0000f80367c1 |
...
| Object-Category             | 1                                                                                                                                             |
| 預設-物件-類別     | \-                                                                                                                                            |
| Governs-Id                  | 1.2.840.113556.1.5.125                                                                                                                        |
| 預設值-隱藏-值        | 1                                                                                                                                             |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                                                                        |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                               |
| 可能的 Superiors          | [](c-configuration.md)設定 **位址-活頁簿-容器**                                                                            |
| 輔助類別           | \-                                                                                                                                            |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                                  |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPLCLORC;;;AU)  (OA;;CR; a1990816-4298-11d1-ade2-00c04fd8d5cd;;AU)  |
...
| [**顯示名稱**](a-displayname.md)                                     | 是      | **通訊錄-容器** [**頂端**](c-top.md)<br/> |
...
| [**假想-搜尋**](a-purportedsearch.md)                             | 否     | **通訊錄-容器**                                 |
