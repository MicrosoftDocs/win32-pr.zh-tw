...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: fc2765fcc6f5a2186b9aa0cb2d81f1f6e5f52e87bab574bdfbcadd9f82505369
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118175222"
---
# <a name="msmq-queue-class"></a>MSMQ-Queue 類別

MSMQ 使用者會根據其需求，建立 MMC 或 MSMQ API)  (的佇列。 佇列會與特定電腦相關聯，並放在該電腦的 MSMQ-Configuration 下。 每一部電腦的佇列數目沒有任何限制。
...
| 更新許可權  | 佇列擁有者。                     |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 9a0dc343-c100-11d1-bbc5-0080c76670c0 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.161                                                                       |
| 預設值-隱藏-值        | 0                                                                                            |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                       |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                              |
| 可能的 Superiors          | [**MSMQ-設定**](c-msmqconfiguration.md)                                            |
| 輔助類別           | \-                                                                                           |
...
| [**MSMQ-驗證**](a-msmqauthenticate.md)                           | 否     | **MSMQ-佇列**                  |
| [**MSMQ-基本優先順序**](a-msmqbasepriority.md)                          | 否     | **MSMQ-佇列**                  |
| [**MSMQ-日誌**](a-msmqjournal.md)                                     | 否     | **MSMQ-佇列**                  |
| [**MSMQ 標籤**](a-msmqlabel.md)                                         | 否     | **MSMQ-佇列**                  |
| [**MSMQ 標籤-例如**](a-msmqlabelex.md)                                    | 否     | **MSMQ-佇列**                  |
| [**MSMQ-擁有者識別碼**](a-msmqownerid.md)                                    | 否     | **MSMQ-佇列**                  |
| [**MSMQ-隱私權層級**](a-msmqprivacylevel.md)                          | 否     | **MSMQ-佇列**                  |
| [**MSMQ-佇列-日誌-配額**](a-msmqqueuejournalquota.md)               | 否     | **MSMQ-佇列**                  |
| [**MSMQ-佇列-名稱-Ext**](a-msmqqueuenameext.md)                         | 否     | **MSMQ-佇列**                  |
| [**MSMQ-佇列-配額**](a-msmqqueuequota.md)                              | 否     | **MSMQ-佇列**                  |
| [**MSMQ-佇列類型**](a-msmqqueuetype.md)                                | 否     | **MSMQ-佇列**                  |
| [**MSMQ-交易式**](a-msmqtransactional.md)                         | 否     | **MSMQ-佇列**                  |
...
| [**MSMQ 標籤**](a-msmqlabel.md)                                           | 否     | **MSMQ-佇列**                  |
| [**MSMQ 標籤-例如**](a-msmqlabelex.md)                                      | 否     | **MSMQ-佇列**                  |
| [**MSMQ-多播-位址**](a-msmq-multicastaddress.md)                   | 否     | **MSMQ-佇列**                  |
| [**MSMQ-擁有者識別碼**](a-msmqownerid.md)                                      | 否     | **MSMQ-佇列**                  |
| [**MSMQ-隱私權層級**](a-msmqprivacylevel.md)                            | 否     | **MSMQ-佇列**                  |
| [**MSMQ-佇列-日誌-配額**](a-msmqqueuejournalquota.md)                 | 否     | **MSMQ-佇列**                  |
| [**MSMQ-佇列-名稱-Ext**](a-msmqqueuenameext.md)                           | 否     | **MSMQ-佇列**                  |
| [**MSMQ-佇列-配額**](a-msmqqueuequota.md)                                | 否     | **MSMQ-佇列**                  |
| [**MSMQ-佇列類型**](a-msmqqueuetype.md)                                  | 否     | **MSMQ-佇列**                  |
| [**MSMQ 安全-來源**](a-msmq-securedsource.md)                         | 否     | **MSMQ-佇列**                  |
| [**MSMQ-交易式**](a-msmqtransactional.md)                           | 否     | **MSMQ-佇列**                  |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                    | 否     | [**返回頁首**](c-top.md)<br/> |
| [**非安全性成員-BL**](a-nonsecuritymemberbl.md)                     | 否     | [**返回頁首**](c-top.md)<br/> |
| [**NT-Security-描述元**](a-ntsecuritydescriptor.md)                    | 是      | [**返回頁首**](c-top.md)<br/> |
