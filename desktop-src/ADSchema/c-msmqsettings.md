...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 74eb2ad09df5c87b063722d8e882d670bf2875fd861613f191d3737b4509ba75
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118175191"
---
# <a name="msmq-settings-class"></a>MSMQ-Settings 類別

這些物件的用途是讓您能夠快速查詢特定網站中的 MSMQ 伺服器。 此物件會保存伺服器提供的資訊，例如訊息佇列服務。
...
|-------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CN                | MSMQ-Settings                                                                                                                                                           |
| Ldap-顯示名稱 | mSMQSettings                                                                                                                                                            |
| 更新許可權  | 佇列擁有者。                                                                                                                                                        |
| 更新頻率  | 針對安裝在 Windows 2000 網域控制站上的每個訊息佇列伺服器，以及具有路由服務的每個訊息佇列伺服器，都會建立這個物件。 |
| 架構識別碼-Guid    | 9a0dc347-c100-11d1-bbc5-0080c76670c0                                                                                                                                    |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.165                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                       |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                              |
| 可能的 Superiors          | [**伺服器**](c-server.md)                                                                   |
| 輔助類別           | \-                                                                                           |
...
| [**MSMQ 相依用戶端-服務**](a-msmqdependentclientservice.md)     | 否     | **MSMQ-設定**               |
| [**MSMQ-Ds-服務**](a-msmqdsservice.md)                                | 否     | **MSMQ-設定**               |
| [**MSMQ-已遷移**](a-msmqmigrated.md)                                   | 否     | **MSMQ-設定**               |
| [**MSMQ-Nt4-旗標**](a-msmqnt4flags.md)                                  | 否     | **MSMQ-設定**               |
| [**MSMQ-擁有者識別碼**](a-msmqownerid.md)                                    | 否     | **MSMQ-設定**               |
| [**MSMQ-QM-ID**](a-msmqqmid.md)                                          | 否     | **MSMQ-設定**               |
| [**MSMQ-路由服務**](a-msmqroutingservice.md)                      | 否     | **MSMQ-設定**               |
| [**MSMQ-Services**](a-msmqservices.md)                                   | 否     | **MSMQ-設定**               |
| [**MSMQ-網站名稱**](a-msmqsitename.md)                                  | 否     | **MSMQ-設定**               |
| [**MSMQ-網站名稱-例如**](a-msmqsitenameex.md)                             | 否     | **MSMQ-設定**               |
