...
Enterprise Scan Post Scan Process 物件。
...
| [**顯示名稱**](a-displayname.md)                                            | 對      | **毫秒-影像-PostScanProcess** [**頂端**](c-top.md)<br/> |
...
| [**毫秒-影像處理-PSP-識別碼**](a-msimaging-pspidentifier.md)                   | 對      | **毫秒-映射-PostScanProcess**                                 |
