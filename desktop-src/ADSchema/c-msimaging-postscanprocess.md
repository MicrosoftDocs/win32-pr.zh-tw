...
description: Enterprise掃描後續掃描處理物件。
...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 105cc6f7a63e71f16f9d8e93be518b38dcc5b359a6f1ccbb75a44721ddae180c
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118175742"
---
# <a name="ms-imaging-postscanprocess-class"></a>PostScanProcess 類別

Enterprise掃描後續掃描處理物件。



| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | 毫秒-映射-PostScanProcess           |
| Ldap-顯示名稱 | msImaging-PostScanProcess            |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 1f7c257c-b8a3-4525-82f8-11ccc7bee36e |
...
| Object-Category             | 1                                                                                                |
| 預設-物件-類別     | \-                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.5.263                                                                           |
| 預設值-隱藏-值        | 0                                                                                                |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                           |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                  |
| 可能的 Superiors          | [**毫秒-映射-PSPs**](c-msimaging-psps.md)                                                      |
| 輔助類別           | \-                                                                                               |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                     |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLOLORCWOWDSDDTDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPLCLORC;;;AU)  |
...
| [**顯示名稱**](a-displayname.md)                                            | 是      | **毫秒-影像-PostScanProcess** [**頂端**](c-top.md)<br/> |
...
| [**毫秒-影像處理-PSP-識別碼**](a-msimaging-pspidentifier.md)                   | 是      | **毫秒-映射-PostScanProcess**                                 |
| [**毫秒-影像處理-PSP-字串**](a-msimaging-pspstring.md)                           | 否     | **毫秒-映射-PostScanProcess**                                 |
...
| [**伺服器名稱**](a-servername.md)                                              | 否     | **毫秒-映射-PostScanProcess**                                 |
