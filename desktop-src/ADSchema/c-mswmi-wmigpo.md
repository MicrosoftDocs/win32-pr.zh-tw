...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: d7ef4418b2cd6a73a220a162d41aa942aff4959948db836651c290c119aa59ff
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119753628"
---
# <a name="ms-wmi-wmigpo-class"></a>WMIGPO 類別

此值會寫入至對應群組原則物件所指向之路徑中的 Active Directory。 它是用來將用來表示 WMI 擴充功能的各種物件系結至群組原則基礎結構。
...
|-------------------|--------------------------------------|
| CN                | WMIGPO                        |
| Ldap-顯示名稱 | msWMI-WMIGPO                         |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 05630000-3927-4ede-bf27-ca91f275c26f |
...
| Object-Category             | 1                                                                                                    |
| 預設-物件-類別     | \-                                                                                                   |
| Governs-Id                  | 1.2.840.113556.1.5.215                                                                               |
| 預設值-隱藏-值        | 1                                                                                                    |
...
| [**intFlags1**](a-mswmi-intflags1.md)                               | 否     | **WMIGPO**               |
| [**intFlags2**](a-mswmi-intflags2.md)                               | 否     | **WMIGPO**               |
| [**intFlags3**](a-mswmi-intflags3.md)                               | 否     | **WMIGPO**               |
| [**intFlags4**](a-mswmi-intflags4.md)                               | 否     | **WMIGPO**               |
| [**Parm1**](a-mswmi-parm1.md)                                       | 否     | **WMIGPO**               |
| [**Parm2**](a-mswmi-parm2.md)                                       | 否     | **WMIGPO**               |
| [**Parm3**](a-mswmi-parm3.md)                                       | 否     | **WMIGPO**               |
| [**Parm4**](a-mswmi-parm4.md)                                       | 否     | **WMIGPO**               |
| [**>targetclass**](a-mswmi-targetclass.md)                           | 是      | **WMIGPO**               |
