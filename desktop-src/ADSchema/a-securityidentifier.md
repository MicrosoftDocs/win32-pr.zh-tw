...
ms.locfileid: "119836868"
---
# <a name="security-identifier-attribute"></a>Security-Identifier 屬性

變數長度的唯一值，用來識別套用 ACE 的使用者帳戶、群組帳戶或登入會話。
...
| Ldap-顯示名稱 | securityIdentifier                   |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.121               |
| 系統識別碼-Guid    | bf967a2f-0de6-11d0-a285-00aa003049e2 |
...
| 中使用的類別        | [**安全性-主體**](c-securityprincipal.md)<br/> [**信任網域**](c-trusteddomain.md)<br/> |
