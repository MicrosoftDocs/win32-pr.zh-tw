...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 963d2756-48be-11d1-a9c3-0000f80367c1 |
...
| [**dhcp-Obj-名稱**](a-dhcpobjname.md)                                    | 否     | **DHCP 類別**                  |
| [**dhcp-選項**](a-dhcpoptions.md)                                     | 否     | **DHCP 類別**                  |
| [**dhcp-屬性**](a-dhcpproperties.md)                               | 否     | **DHCP 類別**                  |
| [**dhcp-範圍**](a-dhcpranges.md)                                       | 否     | **DHCP 類別**                  |
| [**dhcp-保留**](a-dhcpreservations.md)                           | 否     | **DHCP 類別**                  |
| [**dhcp 伺服器**](a-dhcpservers.md)                                     | 否     | **DHCP 類別**                  |
...
| [**Mscope 識別碼**](a-mscopeid.md)                                           | 否     | **DHCP 類別**                  |
...
| [**選項-位置**](a-optionslocation.md)                             | 否     | **DHCP 類別**                  |
...
| [**超級範圍-描述**](a-superscopedescription.md)                | 否     | **DHCP 類別**                  |
| [**超級範圍**](a-superscopes.md)                                     | 否     | **DHCP 類別**                  |
