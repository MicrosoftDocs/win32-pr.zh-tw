...
---
# <a name="ms-ds-resource-property-list-class"></a>ms DS-資源-屬性清單類別
...
|-------------------|--------------------------------------|
| CN                | ms-DS-資源-屬性清單         |
| Ldap-顯示名稱 | ResourcePropertyList            |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 72e3d47a-b342-4d45-8f56-baff803cabf9 |
...
| [**ms DS-資源-屬性清單**](a-msds-membersofresourcepropertylist.md)      | 否     | **ms-DS-資源-屬性清單** |
