...
---
# <a name="ms-dfsr-dfslinktarget-attribute"></a>ms-chap-DfsLinkTarget 屬性
...
| Ldap-顯示名稱 | msDFSR-DfsLinkTarget                        |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.6.13.3.24                  |
| 系統識別碼-Guid    | f7b85ba9-3bf9-428f-aab4-2eee6d56f063        |
...
**DfsLinkTarget** 屬性屬於分散式檔案系統 (DFS) Replication service 支援的一部分。
