...
---
# <a name="service-class-id-attribute"></a>服務類別識別碼屬性
...
|-------------------|-------------------------------------------------------|
| CN                | 服務類別識別碼                                      |
| Ldap-顯示名稱 | serviceClassID                                        |
| 大小              | \-                                                    |
| 更新許可權  | \-                                                    |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.122                                |
| 系統識別碼-Guid    | bf967a35-0de6-11d0-a285-00aa003049e2                  |
...
| 中使用的類別        | [**服務類別**](c-serviceclass.md)<br/> [**服務實例**](c-serviceinstance.md)<br/> |
