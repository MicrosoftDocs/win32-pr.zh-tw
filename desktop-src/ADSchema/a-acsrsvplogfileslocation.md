...
ms.locfileid: "118689455"
---
# <a name="acs-rsvp-log-files-location-attribute"></a>ACS-RSVP-記錄檔-位置屬性

用於儲存 RSVP 記錄檔的檔案系統路徑。
...
|-------------------|---------------------------------------------|
| CN                | ACS-RSVP-記錄檔-位置                 |
| Ldap-顯示名稱 | aCSRSVPLogFilesLocation                     |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.773                      |
| 系統識別碼-Guid    | 1cb3559b-56d0-11d1-a9c6-0000f80367c1        |
