...
ms.locfileid: "119326278"
---
# <a name="ms-wmi-targettype-attribute"></a>ms-WMI-TargetType 屬性
...
| Ldap-顯示名稱 | msWMI-TargetType                            |
| 大小              | 少於100個字元。                   |
| 更新許可權  | 群組原則系統管理員                  |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.1649                     |
| 系統識別碼-Guid    | ca2a281e-262b-4ff7-b419-bc123352a4e9        |
...
| 中使用的類別        | [**PolicyTemplate**](c-mswmi-policytemplate.md)<br/> [**RangeParam**](c-mswmi-rangeparam.md)<br/> |
