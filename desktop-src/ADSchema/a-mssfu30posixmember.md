...
---
# <a name="mssfu-30-posix-member-attribute"></a>msSFU-30-Posix-Member 屬性
...
| 進入 | 值 |
|-------------------|-----------------------------------------|
| CN                | msSFU-30-Posix-成員                   |
| Ldap-顯示名稱 | msSFU30PosixMember                      |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.6.18.1.346             |
| 系統識別碼-Guid    | c875d82d-2848-4cec-bb50-3c5486d09d57    |
