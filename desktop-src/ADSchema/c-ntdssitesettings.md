...
ms.locfileid: "119753408"
---
# <a name="ntds-site-settings-class"></a>NTDS-Site-設定類別

用於保存所有 Active Directory 網站特定設定的容器。
...
|-------------------|--------------------------------------|
| CN                | NTDS-Site-設定                   |
| Ldap-顯示名稱 | nTDSSiteSettings                     |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 19195a5d-6da0-11d0-afd3-00c04fd930c9 |
...
| 的子類別                 | [**應用程式-網站-設定**](c-applicationsitesettings.md)<br/>                    |
| 可能的 Superiors          | [**網站**](c-site.md)                                                                       |
| 輔助類別           | \-                                                                                           |
...
| [**應用程式名稱**](a-applicationname.md)                             | 否     | [**應用程式-網站-設定**](c-applicationsitesettings.md)<br/> |
...
| [**網站間拓撲-容錯移轉**](a-intersitetopologyfailover.md)       | 否     | **NTDS-Site-設定**                                                    |
| [**網站間拓撲-產生器**](a-intersitetopologygenerator.md)     | 否     | **NTDS-Site-設定**                                                    |
| [**網站間-拓撲-更新**](a-intersitetopologyrenew.md)             | 否     | **NTDS-Site-設定**                                                    |
...
| [**管理者**](a-managedby.md)                                         | 否     | **NTDS-Site-設定**                                                    |
...
| [**通知-清單**](a-notificationlist.md)                           | 否     | [**應用程式-網站-設定**](c-applicationsitesettings.md)<br/> |
...
| [**選項**](a-options.md)                                              | 否     | **NTDS-Site-設定**                                                    |
...
| [**查詢-原則-物件**](a-querypolicyobject.md)                        | 否     | **NTDS-Site-設定**                                                    |
...
| [**排程**](a-schedule.md)                                            | 否     | **NTDS-Site-設定**                                                    |
...
| [**ms DS-慣用-GC-網站**](a-msds-preferred-gc-site.md)                 | 否     | **NTDS-Site-設定**                                                    |
