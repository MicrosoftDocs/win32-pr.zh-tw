...
ms.locfileid: "119021876"
---
# <a name="acs-resource-limits-class"></a>ACS-資源限制類別

包含子網的可保留資源限制。 這些限制可用於每個 ACS 服務類型或所有服務類型。
...
|-------------------|------------------------------------------------|
| CN                | ACS-資源-限制                            |
| Ldap-顯示名稱 | aCSResourceLimits                              |
| 更新許可權  | 此值是由網域系統管理員所設定。 |
| 更新頻率  | \-                                             |
| 架構識別碼-Guid    | 2e899b04-2834-11d3-91d4-0000f87a57d4           |
...
| Object-Category             | 1                                                                                                |
| 預設-物件-類別     | \-                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.5.191                                                                           |
| 預設值-隱藏-值        | 1                                                                                                |
...
| 屬性                                                                 | 強制性 | 衍生自                    |
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Allocable-RSVP-頻寬**](a-acsallocablersvpbandwidth.md)       | 否     | **ACS-資源-限制**         |
| [**ACS-最大尖峰頻寬**](a-acsmaxpeakbandwidth.md)                   | 否     | **ACS-資源-限制**         |
| [**ACS-最大尖峰頻寬-每 Flow**](a-acsmaxpeakbandwidthperflow.md)   | 否     | **ACS-資源-限制**         |
| [**ACS-最大權杖-每 Flow**](a-acsmaxtokenrateperflow.md)           | 否     | **ACS-資源-限制**         |
| [**ACS-服務類型**](a-acsservicetype.md)                              | 否     | **ACS-資源-限制**         |
