...
---
# <a name="oem-information-attribute"></a>OEM-Information 屬性

用於保存 OEM 資訊。 不再使用。 這是為了回溯相容性。
...
|-------------------|---------------------------------------------|
| CN                | OEM-Information                             |
| Ldap-顯示名稱 | oEMInformation                              |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.151                      |
| 系統識別碼-Guid    | bf9679ea-0de6-11d0-a285-00aa003049e2        |
