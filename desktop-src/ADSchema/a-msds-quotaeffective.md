...
---
# <a name="ms-ds-quota-effective-attribute"></a>ms DS-配額-有效的屬性

從為目錄分割指派配額計算的安全性主體有效配額。
...
|-------------------|--------------------------------------|
| CN                | ms DS-配額-有效                |
| Ldap-顯示名稱 | QuotaEffective                  |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.1848              |
| 系統識別碼-Guid    | 6655b152-101c-48b4-b347-e1fcebc60157 |
...
| 中使用的類別        | [**ms DS-配額-容器**](c-msds-quotacontainer.md)<br/> |
