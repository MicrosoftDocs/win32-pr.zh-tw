...
ms.locfileid: "117836443"
---
# <a name="ms-dfs-deleted-link-v2-class"></a>ms-DFS-已刪除-連結-v2 類別

已刪除 DFS 命名空間中的 DFS 連結。
...
| Ldap-顯示名稱 | msDFS-DeletedLinkv2                  |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 25173408-04ca-40e8-865e-3f9ce9bf1bd3 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.260                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
...
| [**ms-DFS-Comment-v2**](a-msdfs-commentv2.md)                                 | 否     | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Last-Modified-v2**](a-msdfs-lastmodifiedv2.md)                      | 是      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Link-Identity-GUID-v2**](a-msdfs-linkidentityguidv2.md)             | 是      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-連結-路徑-v2**](a-msdfs-linkpathv2.md)                              | 是      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Namespace-Identity-GUID-v2**](a-msdfs-namespaceidentityguidv2.md)   | 是      | **ms-DFS-Deleted-Link-v2**      |
...
| [**ms-DFS-簡短名稱-連結路徑-v2**](a-msdfs-shortnamelinkpathv2.md)          | 否     | **ms-DFS-Deleted-Link-v2**      |
