...
| [**ms-DFS-Last-Modified-v2**](a-msdfs-lastmodifiedv2.md)                      | 對      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Link-Identity-GUID-v2**](a-msdfs-linkidentityguidv2.md)             | 對      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-連結-路徑-v2**](a-msdfs-linkpathv2.md)                              | 對      | **ms-DFS-Deleted-Link-v2**      |
| [**ms-DFS-Namespace-Identity-GUID-v2**](a-msdfs-namespaceidentityguidv2.md)   | 對      | **ms-DFS-Deleted-Link-v2**      |
