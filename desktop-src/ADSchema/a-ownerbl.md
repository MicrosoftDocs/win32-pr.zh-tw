...
---
# <a name="ms-exch-owner-bl-attribute"></a>Ms-exch-assistant-name-Owner-BL 屬性

[擁有者] 屬性的反向連結。 包含物件的擁有者清單。



| 進入 | 值 |
|-------------------|-----------------------------------------|
| CN                | Ms-exch-assistant-name-擁有者-BL                        |
| Ldap-顯示名稱 | ownerBL                                 |
| 大小              | \-                                      |
| 更新許可權  | 此值是由系統所設定。        |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.2.104                  |
| 系統識別碼-Guid    | bf9679f4-0de6-11d0-a285-00aa003049e2    |
