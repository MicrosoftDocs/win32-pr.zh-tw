...
|-------------------|-----------------------------------------------|
| CN                | Attribute-Schema                              |
| Ldap-顯示名稱 | attributeSchema                               |
| 更新許可權  | 此值由架構管理員設定 |
| 更新頻率  | \-                                            |
| 架構識別碼-Guid    | bf967a80-0de6-11d0-a285-00aa003049e2          |
...
| [**範圍-較低**](a-rangelower.md)                                           | 否     | **屬性-架構**                                 |
| [**範圍-上方**](a-rangeupper.md)                                           | 否     | **屬性-架構**                                 |
