...
---
# <a name="ms-wmi-rule-class"></a>ms-chap-規則類別
...
| 更新許可權  | 群組原則系統管理員           |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 3c7e6f83-dd0e-481b-a0c2-74cd96ef2a66 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.214                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                       |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                              |
| 可能的 Superiors          | [**容器**](c-container.md)[**ms-WMI-Som**](c-mswmi-som.md)                            |
| 輔助類別           | \-                                                                                           |
...
| [**ms-WMI-查詢**](a-mswmi-query.md)                                       | 對      | **ms-WMI-規則**                 |
| [**QueryLanguage**](a-mswmi-querylanguage.md)                       | 對      | **ms-WMI-規則**                 |
| [**ms-WMI-TargetNameSpace**](a-mswmi-targetnamespace.md)                   | 對      | **ms-WMI-規則**                 |
