...
ms.locfileid: "119323488"
---
# <a name="frs-service-command-status-attribute"></a>FRS-服務-命令-Status 屬性
...
|-------------------|---------------------------------------------|
| CN                | FRS-服務-命令-狀態                  |
| Ldap-顯示名稱 | fRSServiceCommandStatus                     |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.879                      |
| 系統識別碼-Guid    | 2a132582-9373-11d1-aebc-0000f80367c1        |
...
| 中使用的類別        | [**NTFRS-訂閱者**](c-ntfrssubscriber.md)<br/> |
