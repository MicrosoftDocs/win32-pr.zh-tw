...
---
# <a name="ms-dfsr-memberreference-attribute"></a>ms-chap-MemberReference 屬性

包含 [**MS DFSR 成員**](c-msdfsr-member.md) 物件的向前連結。
...
| Ldap-顯示名稱 | msDFSR-MemberReference                  |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.6.13.3.100             |
| 系統識別碼-Guid    | 261337aa-f1c3-44b2-bbea-c88d49e6f0c7    |
...
| 中使用的類別        | [**ms-DFSR-訂閱者**](c-msdfsr-subscriber.md)<br/> |
...
**MemberReference** 屬性屬於分散式檔案系統 (DFS) Replication service 支援的一部分。
