...
---
# <a name="ms-ds-external-key-attribute"></a>ms DS-External-Key 屬性

識別外部存放區中之物件的字串，例如資料庫中的記錄。
...
| Ldap-顯示名稱 | ExternalKey                            |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.1833                     |
| 系統識別碼-Guid    | b92fd528-38ac-40d4-818d-0433380837c1        |
