...
---
# <a name="ms-ds-az-biz-rule-language-attribute"></a>ms-chap-Az-Biz-Rule-Language 屬性

商務規則腳本在 (JScript、VBScript) 的語言。



| 進入 | 值 |
|-------------------|---------------------------------------------|
| CN                | ms-chap-Az-Biz-Rule-Language                  |
| Ldap-顯示名稱 | AzBizRuleLanguage                      |
| 大小              | 20 個字元                               |
| 更新許可權  | AzRoles 系統管理員                               |
| 更新頻率  | 在初始化或原則變更期間。     |
| Attribute-Id      | 1.2.840.113556.1.4.1802                     |
| 系統識別碼-Guid    | 52994b56-0e6c-4e07-aa5c-ef9d7f5a0e25        |
