...
ms.locfileid: "118685244"
---
# <a name="ms-ds-az-last-imported-biz-rule-path-attribute"></a>ms-chap-Az-最後匯入-Biz-Rule-Path 屬性
...
| 進入 | 值 |
|-------------------|---------------------------------------------|
| CN                | ms-chap-Az-最後匯入-Biz-規則-路徑        |
| Ldap-顯示名稱 | AzLastImportedBizRulePath              |
| 大小              | 128 個字元                              |
| 更新許可權  | AzRoles 系統管理員                               |
| 更新頻率  | 在初始化或原則變更期間。     |
| Attribute-Id      | 1.2.840.113556.1.4.1803                     |
| 系統識別碼-Guid    | 665acb5c-bb92-4dbc-8c59-b3638eab09b3        |
...
| 中使用的類別        | [**ms DS-Az-Task**](c-msds-aztask.md)<br/> |
...
| Search-Flags           | 0x00000000                                                                            |
| System-Flags           | 0x00000010                                                                            |
| 中使用的類別        | [**Group**](c-group.md)<br/> [**ms DS-Az-Task**](c-msds-aztask.md)<br/> |
