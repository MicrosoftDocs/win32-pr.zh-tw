...
---
# <a name="rpc-profile-element-class"></a>rpc 設定檔-Element 類別
...
|-------------------|--------------------------------------|
| CN                | rpc 設定檔-元素                  |
| Ldap-顯示名稱 | rpcProfileElement                    |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | f29653cf-7ad0-11d0-afd6-00c04fd930c9 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.26                                                                        |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                       |
| 的子類別                 | [**rpc-Entry**](c-rpcentry.md)<br/>                                                   |
| 可能的 Superiors          | [**rpc-設定檔**](c-rpcprofile.md)                                                          |
| 輔助類別           | \-                                                                                           |
...
| [**rpc-Ns-批註**](a-rpcnsannotation.md)                            | 否     | **rpc 設定檔-元素**                                                                  |
| [**rpc-Ns-Interface-ID**](a-rpcnsinterfaceid.md)                         | 對      | **rpc 設定檔-元素**                                                                  |
| [**rpc-Ns-優先順序**](a-rpcnspriority.md)                                | 對      | **rpc 設定檔-元素**                                                                  |
| [**rpc-Ns-設定檔-Entry**](a-rpcnsprofileentry.md)                       | 否     | **rpc 設定檔-元素**                                                                  |
