...
---
# <a name="revision-attribute"></a>修訂屬性

安全描述項或其他變更的修訂層級。 僅用於 sam 伺服器和 ds ui 設定物件。
...
| 系統識別碼-Guid    | bf967a21-0de6-11d0-a285-00aa003049e2 |
...
| 中使用的類別        | [**Sam-網域-基礎**](c-samdomainbase.md)<br/> [**返回頁首**](c-top.md)<br/> |
