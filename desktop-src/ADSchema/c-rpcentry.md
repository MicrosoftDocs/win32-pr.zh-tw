...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: a6ff11296dd40c3ad08fe61462fa1fc8e4da52ac448267a9b8f4ffd2f6ee12cf
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119801548"
---
# <a name="rpc-entry-class"></a>rpc 專案類別

抽象類別，其子類別是由 RPC 名稱服務所使用 (Ns) ，它是使用 WIN32 API 中的 RpcNs 函式來存取 \* 。
...
| 更新許可權  | 架構系統管理員                 |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | bf967aac-0de6-11d0-a285-00aa003049e2 |
...
| Object-Category             | 2                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.27                                                                        |
| 預設值-隱藏-值        | 1                                                                                            |
