...
|-------------------|--------------------------------------|
| CN                | 交叉參考容器                  |
| Ldap-顯示名稱 | crossRefContainer                    |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | ef9e60e0-56f7-11d1-a9c6-0000f80367c1 |
...
| [**UPN-尾碼**](a-upnsuffixes.md)                                     | 否     | **交叉參考容器**         |
...
| [**ms DS-行為-版本**](a-msds-behavior-version.md)                   | 否     | **交叉參考容器**         |
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)      | 否     | [**返回頁首**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                   | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ExecuteScriptPassword**](a-msds-executescriptpassword.md)         | 否     | **交叉參考容器**         |
...
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)           | 否     | [**返回頁首**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                        | 否     | [**返回頁首**](c-top.md)<br/> |
| [**啟用 ms DS-功能**](a-msds-enabledfeature.md)                           | 否     | **交叉參考容器**         |
