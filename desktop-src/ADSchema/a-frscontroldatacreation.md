...
ms.locfileid: "119925698"
---
# <a name="frs-control-data-creation-attribute"></a>FRS-控制項-資料建立屬性

檔案資料建立的警告/錯誤層級組 (每秒 mb) 。
...
|-------------------|---------------------------------------------|
| CN                | FRS-控制-資料建立                   |
| Ldap-顯示名稱 | fRSControlDataCreation                      |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.871                      |
| 系統識別碼-Guid    | 2a13257a-9373-11d1-aebc-0000f80367c1        |
...
| 中使用的類別        | [**NTFRS-成員**](c-ntfrsmember.md)<br/> |
