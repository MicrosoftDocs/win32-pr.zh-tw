...
表示伺服器上的 Active Directory DSA 進程。
...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | f0f8ffab-1191-11d0-a060-00aa006c33ed |
...
| 的子類別                 | [**應用程式-設定**](c-applicationsettings.md)<br/>                             |
...
| [**DMD-位置**](a-dmdlocation.md)                                     | 否     | **NTDS-DSA**                                                     |
...
| [**FRS-根目錄路徑**](a-frsrootpath.md)                                    | 否     | **NTDS-DSA**                                                     |
...
| [**上次備份-還原時間**](a-lastbackuprestorationtime.md)       | 否     | **NTDS-DSA**                                                     |
| [**最後一個已知-父系**](a-lastknownparent.md)                            | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**管理者**](a-managedby.md)                                         | 否     | **NTDS-DSA**                                                     |
...
| [**查詢-原則-物件**](a-querypolicyobject.md)                        | 否     | **NTDS-DSA**                                                     |
...
| [**已淘汰-複寫-DSA-簽章**](a-retiredrepldsasignatures.md)         | 否     | **NTDS-DSA**                                                     |
| [**修訂**](a-revision.md)                                            | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**SD-Rights-有效**](a-sdrightseffective.md)                        | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**伺服器參考**](a-serverreference.md)                             | 否     | **NTDS-DSA**                                                     |
...
| [**ms DS-行為-版本**](a-msds-behavior-version.md)                   | 否     | **NTDS-DSA**                                                     |
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)      | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                   | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**ms-DS-Nc**](a-msds-hasdomainncs.md)                         | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-具現化-Nc**](a-msds-hasinstantiatedncs.md)             | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-Nc**](a-msds-hasmasterncs.md)                         | 否     | **NTDS-DSA**                                                     |
...
| [**ReplicationEpoch**](a-msds-replicationepoch.md)                   | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-複製-值中繼資料**](a-msds-replvaluemetadata.md)              | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**ms-DS-已停用-複寫-NC-簽章**](a-msds-retiredreplncsignatures.md)  | 否     | **NTDS-DSA**                                                     |
...
| [**ms-DS-NC-複寫-輸入-相鄰**](a-msds-ncreplinboundneighbors.md)    | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**ms DS-NC-複寫-輸出-相鄰**](a-msds-ncreploutboundneighbors.md)  | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**ms-DS-埠-LDAP**](a-msds-portldap.md)                                  | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-埠-SSL**](a-msds-portssl.md)                                    | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-複寫-屬性中繼資料**](a-msds-replattributemetadata.md)      | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**ReplicationEpoch**](a-msds-replicationepoch.md)                   | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-複製-值中繼資料**](a-msds-replvaluemetadata.md)              | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**ms-DS-已停用-複寫-NC-簽章**](a-msds-retiredreplncsignatures.md)  | 否     | **NTDS-DSA**                                                     |
| [**ms DS-服務-帳戶**](a-msds-serviceaccount.md)                      | 否     | **NTDS-DSA**                                                     |
...
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**ms-DS-Nc**](a-msds-hasdomainncs.md)                            | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-Has-Full-Replica-NCs**](a-msds-hasfullreplicancs.md)                 | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-具現化-Nc**](a-msds-hasinstantiatedncs.md)                | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-Nc**](a-msds-hasmasterncs.md)                            | 否     | **NTDS-DSA**                                                     |
...
| [**ms-DS-isGC**](a-msds-isgc.md)                                              | 否     | **NTDS-DSA**                                                     |
| [**ms-chap-為部分複本**](a-msds-ispartialreplicafor.md)             | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**isRODC**](a-msds-isrodc.md)                                          | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-Is-User-Cachable-At-Rodc**](a-msds-isusercachableatrodc.md)          | 否     | **NTDS-DSA**                                                     |
...
| [**ms-DS-不顯示群組**](a-msds-neverrevealgroup.md)                    | 否     | **NTDS-DSA**                                                     |
| [**ms DS-非成員-BL**](a-msds-nonmembersbl.md)                            | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**BL-------物件參考**](a-msds-objectreferencebl.md)                  | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**BL-------------------**](a-msds-operationsforazrolebl.md)        | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**BL-------------工作-**](a-msds-operationsforaztaskbl.md)        | 否     | [**返回頁首**](c-top.md)<br/>                                  |
...
| [**以 ms DS 呈現的使用者**](a-msds-revealedusers.md)                           | 否     | **NTDS-DSA**                                                     |
| [**ms-DS-顯示-OnDemand-群組**](a-msds-revealondemandgroup.md)              | 否     | **NTDS-DSA**                                                     |
| [**ms DS-設定**](a-msds-settings.md)                                      | 否     | [**應用程式-設定**](c-applicationsettings.md)<br/> |
...
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)           | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                        | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**啟用 ms DS-功能**](a-msds-enabledfeature.md)                           | 否     | **NTDS-DSA**                                                     |
...
| 一般名稱                                                                    |
|--------------------------------------------------------------------------------|
| [**已驗證-DS-行為-版本**](r-validated-ms-ds-behavior-version.md) |
