...
ms.locfileid: "119301038"
---
# <a name="max-pwd-age-attribute"></a>Max-Pwd-Age 屬性

密碼的最大時間量，以 100-毫微秒間隔為有效。 此值會儲存為一個大型整數，表示密碼在密碼到期前的設定時間，100-納秒間隔的數目。
...
| 系統識別碼-Guid    | bf9679bb-0de6-11d0-a285-00aa003049e2 |
