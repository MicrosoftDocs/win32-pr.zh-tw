...
ms.locfileid: "119763068"
---
# <a name="msi-script-size-attribute"></a>Msi-腳本-大小屬性

此應用程式的 Microsoft installer 公告腳本檔案的檔案大小。
...
|-------------------|--------------------------------------|
| CN                | Msi-腳本-大小                      |
| Ldap-顯示名稱 | msiScriptSize                        |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.846               |
| 系統識別碼-Guid    | 96a7dd63-9118-11d1-aebc-0000f80367c1 |
