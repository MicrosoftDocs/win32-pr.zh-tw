...
ms.locfileid: "119022456"
---
# <a name="previous-parent-ca-attribute"></a>上一個-父系-CA 屬性

參考為憑證授權單位單位發出最後過期憑證的憑證授權單位單位。
...
|-------------------|-----------------------------------------|
| CN                | 上一個-父系-CA                      |
| Ldap-顯示名稱 | previousParentCA                        |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.694                  |
| 系統識別碼-Guid    | 963d273d-48be-11d1-a9c3-0000f80367c1    |
