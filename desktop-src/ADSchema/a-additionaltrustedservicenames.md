...
ms.locfileid: "118689174"
---
# <a name="additional-trusted-service-names-attribute"></a>其他受信任的服務名稱屬性
...
|-------------------|---------------------------------------------|
| CN                | 其他受信任的服務名稱            |
| Ldap-顯示名稱 | additionalTrustedServiceNames               |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.889                      |
| 系統識別碼-Guid    | 032160be-9824-11d1-aec0-0000f80367c1        |
