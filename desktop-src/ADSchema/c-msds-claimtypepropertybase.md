...
ms.locfileid: "118422783"
---
# <a name="ms-ds-claim-type-property-base-class"></a>ms DS-----Property-Base 類別

定義宣告類型或資源屬性類別之基類的抽象類別。



| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | ms-DS------Property-Base       |
| Ldap-顯示名稱 | ClaimTypePropertyBase           |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | b8442f58-c490-4487-8a9d-d80b883271ad |
...
| [**啟用**](a-enabled.md)                                                                 | 否     | **ms-DS------Property-Base** |
...
| [**ms DS-宣告-可能值**](a-msds-claimpossiblevalues.md)                            | 否     | **ms-DS------Property-Base** |
| [**ms DS--------可能值-**](a-msds-claimsharespossiblevalueswith.md)      | 否     | **ms-DS------Property-Base** |
