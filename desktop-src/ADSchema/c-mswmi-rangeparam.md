...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 857a9bb542c95d5ba96e3a89304fc0c56c4a27b5cfc65705b79ad195e00554da
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118175077"
---
# <a name="ms-wmi-rangeparam-class"></a>RangeParam 類別

範圍參數類別，這是 PolicyTemplate 的基礎。 它描述目標的一個 mergeable 屬性。 每個子類別都會執行特定的類型。 執行 merge 方法以支援合併。 執行解析方法，以產生最終目標屬性。
...
|-------------------|--------------------------------------|
| CN                | RangeParam                    |
| Ldap-顯示名稱 | msWMI-RangeParam                     |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 45fb5a57-5018-4d0f-9056-997c8c9122d9 |
...
| Object-Category             | 1                                                                                                  |
| 預設-物件-類別     | \-                                                                                                 |
| Governs-Id                  | 1.2.840.113556.1.5.203                                                                             |
| 預設值-隱藏-值        | 1                                                                                                  |
...
| [**ms-WMI-PropertyName**](a-mswmi-propertyname.md)                         | 是      | **RangeParam**           |
| [**>targetclass**](a-mswmi-targetclass.md)                           | 是      | **RangeParam**           |
| [**ms-WMI-TargetType**](a-mswmi-targettype.md)                             | 是      | **RangeParam**           |
