...
ms.locfileid: "120050128"
---
# <a name="dhcp-maxkey-attribute"></a>dhcp-MaxKey 屬性

目前未使用 **Dhcp MaxKey** 屬性。
...
|-------------------|--------------------------------------|
| CN                | dhcp-MaxKey                          |
| Ldap-顯示名稱 | dhcpMaxKey                           |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.719               |
| 系統識別碼-Guid    | 963d2754-48be-11d1-a9c3-0000f80367c1 |
