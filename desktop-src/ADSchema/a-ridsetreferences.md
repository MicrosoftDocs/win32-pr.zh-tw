...
---
# <a name="rid-set-references-attribute"></a>RID-Set 參考屬性

RID-Set 物件的參考清單，這些物件會管理 (RID) 配置的相對識別碼。
...
|-------------------|-----------------------------------------|
| CN                | RID-Set 參考                      |
| Ldap-顯示名稱 | rIDSetReferences                        |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.669                  |
| 系統識別碼-Guid    | 7bfdcb7b-4807-11d1-a9c3-0000f80367c1    |
