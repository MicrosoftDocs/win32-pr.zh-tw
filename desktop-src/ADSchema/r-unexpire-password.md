---
title: Unexpire-Password 擴充許可權
description: 可讓使用者還原使用者物件過期密碼的 [擴充控制] 存取權限。
ms.assetid: 4ff90ffb-52a0-480d-a9d5-8f5f9bad33b4
ms.tgt_platform: multiple
keywords:
- Unexpire-Password 擴充的正確 AD 架構
topic_type:
- apiref
api_name:
- Unexpire-Password
...
| CN           | 未過期密碼                    |
| 顯示名稱 | Unexpire 密碼                    |
| 許可權-GUID  | ccc2dc7d-a6ad-4a7a-8846-c04e3cc53501 |
