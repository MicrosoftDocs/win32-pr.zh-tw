...
---
# <a name="ipsec-owners-reference-attribute"></a>Ipsec-擁有者-Reference 屬性

**Ipsec 擁有者參考** 屬性僅供內部使用。
...
|-------------------|-----------------------------------------|
| CN                | Ipsec-擁有者-參考                  |
| Ldap-顯示名稱 | ipsecOwnersReference                    |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.624                  |
| 系統識別碼-Guid    | b40ff824-427a-11d1-a9c2-0000f80367c1    |
...
| 中使用的類別        | [**Ipsec-基礎**](c-ipsecbase.md)<br/> |
