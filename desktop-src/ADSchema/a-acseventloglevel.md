...
ms.locfileid: "119929838"
---
# <a name="acs-event-log-level-attribute"></a>ACS-事件-記錄層級屬性
...
|-------------------|-----------------------------------------|
| CN                | ACS-事件-記錄層級                     |
| Ldap-顯示名稱 | aCSEventLogLevel                        |
| 大小              | 4個位元組的值可以是0、1、2和3。 |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.769                  |
| 系統識別碼-Guid    | 7f561286-5301-11d1-a9c5-0000f80367c1    |
