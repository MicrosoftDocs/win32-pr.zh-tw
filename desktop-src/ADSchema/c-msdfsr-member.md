...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 8f53bfb97b2b84b0aea338e7e0ef067ad3fafde40fb69da8e61bdd321ea52f04
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118011028"
---
# <a name="ms-dfsr-member-class"></a>ms-DFSR-成員類別
...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 4229c897-c211-437c-a5ae-dbf705b696e5 |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.6.13.4.9                                                                                                        |
| 預設值-隱藏-值        | 1                                                                                                                                |
| Rdn-Att-Id                  | \-                                                                                                                               |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                  |
| 可能的 Superiors          | [**毫秒-DFSR-拓撲**](c-msdfsr-topology.md)                                                                                    |
| 輔助類別           | \-                                                                                                                               |
...
| [**ms-DFSR-ComputerReference**](a-msdfsr-computerreference.md)             | 是      | **ms-DFSR-成員**              |
| [**ms-DFSR-ComputerReferenceBL**](a-msdfsr-computerreferencebl.md)         | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-擴充功能**](a-msdfsr-extension.md)                             | 否     | **ms-DFSR-成員**              |
| [**ms-DFSR-旗標**](a-msdfsr-flags.md)                                     | 否     | **ms-DFSR-成員**              |
| [**ms-DFSR-關鍵字**](a-msdfsr-keywords.md)                               | 否     | **ms-DFSR-成員**              |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                 | 否     | **ms-DFSR-成員**              |
...
| [**伺服器參考**](a-serverreference.md)                               | 否     | **ms-DFSR-成員**              |
...
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                    | 否     | **ms-DFSR-成員**              |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                  | 否     | **ms-DFSR-成員**              |
| [**ms-DS-Immed-從屬**](a-msds-approx-immed-subordinates.md)    | 否     | [**返回頁首**](c-top.md)<br/> |
...
**MS DFSR 成員** 類別是分散式檔案系統 (DFS) Replication service 支援的一部分。
