...
ms.locfileid: "118689623"
---
# <a name="acs-enable-rsvp-accounting-attribute"></a>ACS-啟用-RSVP-Accounting 屬性

如果已啟用 RSVP 帳戶處理，則為 True。
...
|-------------------|--------------------------------------|
| CN                | ACS-啟用-RSVP-帳戶處理           |
| Ldap-顯示名稱 | aCSEnableRSVPAccounting              |
| 大小              | 4 個位元組                              |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.899               |
| 系統識別碼-Guid    | f072230e-aef5-11d1-bdcf-0000f80367c1 |
