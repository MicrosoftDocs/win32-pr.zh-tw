...
ms.locfileid: "119879978"
---
# <a name="ms-ds-optional-feature-class"></a>ms DS-選用功能類別
...
|-------------------|--------------------------------------|
| CN                | ms-DS-選用-功能               |
| Ldap-顯示名稱 | OptionalFeature                 |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 44f00041-35af-468b-b20a-6ce8737c580b |
...
| 預設安全描述項 | D： (;;RPLCLORC;;;AU)  (A;;RPWPCRLCLOCCDCRCWDWOSDDTSW;;;EA)  (A;;RPWPCRLCLOCCDCRCWDWOSDDTSW;;;CO)  (A;;RPWPCRLCLOCCDCRCWDWOSDDTSW;;;SY)  |
...
| [**ms-DS-選用-功能-旗標**](a-msds-optionalfeatureflags.md)                    | 是      | **ms-DS-選用-功能**      |
| [**ms-DS-選用-功能-GUID**](a-msds-optionalfeatureguid.md)                      | 是      | **ms-DS-選用-功能**      |
...
| [**ms-DS-必要網域-行為-版本**](a-msds-requireddomainbehaviorversion.md) | 否     | **ms-DS-選用-功能**      |
| [**ms-DS-必要-樹系行為-版本**](a-msds-requiredforestbehaviorversion.md) | 否     | **ms-DS-選用-功能**      |
