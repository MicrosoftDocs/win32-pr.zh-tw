...
ms.locfileid: "119322498"
---
# <a name="ipsec-negotiation-policy-reference-attribute"></a>Ipsec-協商-原則參考屬性

**Ipsec-協商-原則參考** 屬性僅供內部使用。
...
|-------------------|-----------------------------------------|
| CN                | Ipsec-協商-原則-參考      |
| Ldap-顯示名稱 | ipsecNegotiationPolicyReference         |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.628                  |
| 系統識別碼-Guid    | b40ff822-427a-11d1-a9c2-0000f80367c1    |
...
| 中使用的類別        | [**Ipsec-NFA**](c-ipsecnfa.md)<br/> |
