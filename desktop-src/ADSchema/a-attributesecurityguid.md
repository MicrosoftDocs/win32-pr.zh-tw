...
ms.locfileid: "119703468"
---
# <a name="attribute-security-guid-attribute"></a>屬性-安全性-GUID 屬性

用來將安全性認證套用至一組物件的 GUID。
...
|-------------------|-------------------------------------------------------|
| CN                | 屬性-安全性-GUID                               |
| Ldap-顯示名稱 | attributeSecurityGUID                                 |
| 大小              | \-                                                    |
| 更新許可權  | 架構系統管理員                                  |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.149                                |
| 系統識別碼-Guid    | bf967924-0de6-11d0-a285-00aa003049e2                  |
