...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: fea646a135cc7db234fc8d0901a1009bc09a634e06f7faf8c31d2f3182254cdb
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119643188"
---
# <a name="ms-com-partition-class"></a>ms COM-Partition 類別

COM + 用來讓相同的 COM + 應用程式的多個版本存在於相同的實體電腦上的命名空間。
...
|-------------------|--------------------------------------|
| CN                | ms-COM-資料分割                     |
| Ldap-顯示名稱 | msCOM-資料分割                      |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | c9010e74-4e58-49f7-8a89-5e3e2340fcf8 |
...
| Object-Category             | 1                                                                                                                    |
| 預設-物件-類別     | \-                                                                                                                   |
| Governs-Id                  | 1.2.840.113556.1.5.193                                                                                               |
| 預設值-隱藏-值        | 1                                                                                                                    |
...
| [**ms-COM-ObjectId**](a-mscom-objectid.md)                                 | 否     | **ms-COM-資料分割**            |
