...
ms.locfileid: "119703198"
---
# <a name="next-level-store-attribute"></a>下一層級存放區屬性

這個屬性工作表示要搜尋的下一個類別存放區。
...
|-------------------|-----------------------------------------|
| CN                | 下一層-存放區                        |
| Ldap-顯示名稱 | nextLevelStore                          |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.214                  |
| 系統識別碼-Guid    | bf9679da-0de6-11d0-a285-00aa003049e2    |
