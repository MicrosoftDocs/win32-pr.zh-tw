...
ms.locfileid: "118685962"
---
# <a name="ms-dfsr-contentsetguid-attribute"></a>ms-chap-ContentSetGuid 屬性

包含分散式檔案系統 (DFS) 複寫內容集 GUID。
...
| Ldap-顯示名稱 | msDFSR-ContentSetGuid                                 |
| 大小              | \-                                                    |
| 更新許可權  | \-                                                    |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.6.13.3.18                            |
| 系統識別碼-Guid    | 1035a8e1-67a8-4c21-b7bb-031cdf99d7a0                  |
...
**ContentSetGuid** 屬性是 DFS 複寫服務支援的一部分。
