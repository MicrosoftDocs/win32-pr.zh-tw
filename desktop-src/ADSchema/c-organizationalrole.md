...
ms.locfileid: "118959697"
---
# <a name="organizational-role-class"></a>Organizational-Role 類別

這個類別是用於包含組織內某個位置或角色相關資訊的物件，例如系統管理員、管理員等等。 它也可以用於組織中的 nonhuman 身分識別。
...
| Ldap-顯示名稱 | organizationalRole                   |
| 更新許可權  | 任何人都可以更新此物件。       |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | a8df74bf-c5ea-11d1-bbcb-0080c76670c0 |
...
| [**傳真-電話號碼**](a-facsimiletelephonenumber.md)          | 否     | **組織角色**                                 |
...
| [**國際 ISDN 號碼**](a-internationalisdnnumber.md)            | 否     | **組織角色**                                 |
...
| [**實體傳遞-Office-名稱**](a-physicaldeliveryofficename.md)     | 否     | **組織角色**                                 |
| [**可能-Inferiors**](a-possibleinferiors.md)                         | 否     | [**返回頁首**](c-top.md)<br/>                         |
| [**郵件標籤**](a-postaladdress.md)                                 | 否     | **組織角色**                                 |
| [**郵遞區號**](a-postalcode.md)                                       | 否     | **組織角色**                                 |
| [**後續 Office-Box**](a-postofficebox.md)                                | 否     | **組織角色**                                 |
| [**慣用傳遞方法**](a-preferreddeliverymethod.md)            | 否     | **組織角色**                                 |
...
| [**登入位址**](a-registeredaddress.md)                         | 否     | **組織角色**                                 |
...
| [**角色-住戶**](a-roleoccupant.md)                                   | 否     | **組織角色**                                 |
| [**SD-Rights-有效**](a-sdrightseffective.md)                        | 否     | [**返回頁首**](c-top.md)<br/>                         |
| [**請參閱-也**](a-seealso.md)                                             | 否     | **組織角色**                                 |
...
| [**州/省名稱**](a-st.md)                                    | 否     | **組織角色**                                 |
| [**街道位址**](a-street.md)                                        | 否     | **組織角色**                                 |
...
| [**電話號碼**](a-telephonenumber.md)                             | 否     | **組織角色**                                 |
| [**Teletex-終端機-識別碼**](a-teletexterminalidentifier.md)        | 否     | **組織角色**                                 |
| [**電傳號碼**](a-telexnumber.md)                                     | 否     | **組織角色**                                 |
...
| [**X121-位址**](a-x121address.md)                                     | 否     | **組織角色**                                 |
