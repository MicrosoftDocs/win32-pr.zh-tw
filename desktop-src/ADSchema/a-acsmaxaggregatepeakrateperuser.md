...
---
# <a name="acs-max-aggregate-peak-rate-per-user-attribute"></a>ACS-最大匯總-每個使用者的尖峰率-每個使用者屬性

任何使用者可能會對所有流程產生的最大尖峰速率。



| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | ACS-最大匯總-每位使用者的尖峰率 |
| Ldap-顯示名稱 | aCSMaxAggregatePeakRatePerUser       |
| 大小              | 8 個位元組                              |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.897               |
| 系統識別碼-Guid    | f072230c-aef5-11d1-bdcf-0000f80367c1 |
