...
ms.locfileid: "119643718"
---
# <a name="country-class"></a>Country 類別
...
| CN                | 國家/地區                                                    |
| Ldap-顯示名稱 | country                                                    |
| 更新許可權  | 帳戶擁有者或網域系統管理員會設定此值。 |
| 更新頻率  | 當使用者的國家/地區變更時。               |
| 架構識別碼-Guid    | bf967a8c-0de6-11d0-a285-00aa003049e2                       |
...
| Rdn-Att-Id                  | [**國家/地區-名稱**](a-c.md)<br/>                                                       |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                              |
| 可能的 Superiors          | [**組織**](c-organization.md)[**網域-DNS**](c-domaindns.md)                      |
| 輔助類別           | \-                                                                                           |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                 |
| 預設安全描述項 | D:(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)(A;;RPLCLORC;;;AU) |
| System-Flags                | 0x00000010                                                                                   |
