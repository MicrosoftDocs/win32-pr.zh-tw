...
---
# <a name="mssfu-30-network-user-class"></a>msSFU-30-網路-使用者類別
...
|-------------------|--------------------------------------|
| CN                | msSFU-30-網路-使用者                |
| Ldap-顯示名稱 | msSFU30NetworkUser                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | e15334a3-0bf0-4427-b672-11f5d84acc92 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.6.18.2.216                                                                  |
| 預設值-隱藏-值        | 1                                                                                            |
...
| [**msSFU-30-索引鍵-值**](a-mssfu30keyvalues.md)                           | 否     | **msSFU-30-網路-使用者**       |
| [**msSFU-30-名稱**](a-mssfu30name.md)                                      | 否     | **msSFU-30-網路-使用者**       |
| [**msSFU-30-Nis-網域**](a-mssfu30nisdomain.md)                           | 否     | **msSFU-30-網路-使用者**       |
| [**msSFU-30-Posix-成員**](a-mssfu30posixmemberof.md)                  | 否     | [**返回頁首**](c-top.md)<br/> |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                    | 否     | [**返回頁首**](c-top.md)<br/> |
| [**nisMapName**](a-nismapname.md)                                          | 否     | **msSFU-30-網路-使用者**       |
