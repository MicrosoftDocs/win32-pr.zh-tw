...
ms.locfileid: "119835108"
---
# <a name="user-shared-folder-other-attribute"></a>使用者共用資料夾-其他屬性

指定使用者的 [其他共用檔] 資料夾的 UNC 路徑。 路徑必須是表單 **\\\\** _伺服器_ *_\\_* _共用_ *_\\_* _目錄_ 的網路 UNC 路徑。 這個值可以是 null 字串。
...
|-------------------|-----------------------------------------------------------------------------------|
| CN                | 使用者共用資料夾-其他                                                          |
| Ldap-顯示名稱 | userSharedFolderOther                                                             |
| 大小              | \-                                                                                |
| 更新許可權  | 網域系統管理員或帳戶擁有者。                                            |
| 更新頻率  | 當使用者的記錄建立時，以及每次共用資料夾需要變更時。 |
| Attribute-Id      | 1.2.840.113556.1.4.752                                                            |
| 系統識別碼-Guid    | 9a9a0220-4a5b-11d1-a9c3-0000f80367c1                                              |
