...
ms.locfileid: "119322138"
---
# <a name="ms-ds-promotion-settings-attribute"></a>ms-DS-升級-設定屬性

若為電腦，包含要用於委派 DSA 升級的 XML 字串。
...
| Ldap-顯示名稱 | msDS-PromotionSettings                      |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.1962                     |
| 系統識別碼-Guid    | c881b4e2-43c0-4ebe-b9bb-5250aa9b434c        |
