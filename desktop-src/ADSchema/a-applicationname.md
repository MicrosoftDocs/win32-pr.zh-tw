...
ms.locfileid: "118178027"
---
# <a name="application-name-attribute"></a>Application-Name 屬性
...
|-------------------|---------------------------------------------|
| CN                | Application-Name                            |
| Ldap-顯示名稱 | applicationName                             |
| 大小              | \-                                          |
| 更新許可權  | 網域系統管理員                        |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.218                      |
| 系統識別碼-Guid    | dd712226-10e4-11d0-a05f-00aa006c33ed        |
...
| 中使用的類別        | [**應用程式-設定**](c-applicationsettings.md)<br/> [**應用程式-網站-設定**](c-applicationsitesettings.md)<br/> |
