...
ms.locfileid: "119301818"
---
# <a name="local-policy-reference-attribute"></a>本機原則參考屬性

原則物件從中複製的本機原則物件的分辨名稱。
...
|-------------------|-----------------------------------------|
| CN                | 本機原則-參考                  |
| Ldap-顯示名稱 | localPolicyReference                    |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.457                  |
| 系統識別碼-Guid    | 80a67e4d-9f22-11d0-afdd-00c04fd930c9    |
