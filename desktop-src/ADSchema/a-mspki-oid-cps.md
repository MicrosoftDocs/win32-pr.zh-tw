...
ms.locfileid: "118960362"
---
# <a name="ms-pki-oid-cps-attribute"></a>ms-PKI-OID-CPS 屬性

CPS (「企業簽發者原則」 OID 的憑證原則聲明) 。
...
|-------------------|--------------------------------------------------------------------------------------------|
| CN                | ms-PKI-OID-CPS                                                                             |
| Ldap-顯示名稱 | Mspki-certificate-name-flag-OID-CPS                                                                              |
| 大小              | \-                                                                                         |
| 更新許可權  | 企業系統管理員                                                                   |
| 更新頻率  | 每次建立新範本，或編輯現有範本的屬性時。 |
| Attribute-Id      | 1.2.840.113556.1.4.1672                                                                    |
| 系統識別碼-Guid    | 5f49940e-a79f-4a51-bb6f-3d446a54dc6b                                                       |
