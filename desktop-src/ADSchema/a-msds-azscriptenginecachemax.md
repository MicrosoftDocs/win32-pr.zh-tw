...
ms.locfileid: "118014989"
---
# <a name="ms-ds-az-script-engine-cache-max-attribute"></a>ms DS-Az-腳本-引擎-快取-最大屬性
...
| 進入 | 值 |
|-------------------|-----------------------------------------|
| CN                | ms DS-Az-腳本-引擎-快取-最大值        |
| Ldap-顯示名稱 | AzScriptEngineCacheMax             |
| 大小              | \-                                      |
| 更新許可權  | AzRoles 系統管理員                           |
| 更新頻率  | 在初始化或原則變更期間。 |
| Attribute-Id      | 1.2.840.113556.1.4.1796                 |
| 系統識別碼-Guid    | 2629f66a-1f95-4bf3-a296-8e9d7b9e30c8    |
