...
---
# <a name="crl-partitioned-revocation-list-attribute"></a>CRL-資料分割-撤銷清單屬性
...
|-------------------|-------------------------------------------------------|
| CN                | CRL-資料分割-撤銷清單                       |
| Ldap-顯示名稱 | cRLPartitionedRevocationList                          |
| 大小              | \-                                                    |
| 更新許可權  | \-                                                    |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.683                                |
| 系統識別碼-Guid    | 963d2731-48be-11d1-a9c3-0000f80367c1                  |
