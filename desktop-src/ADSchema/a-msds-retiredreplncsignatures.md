...
---
# <a name="ms-ds-retired-repl-nc-signatures-attribute"></a>ms-DS-已停用-複寫-NC-簽章屬性
...
| 進入 | 值 |
|-------------------|-------------------------------------------------------|
| CN                | ms-DS-已停用-複寫-NC-簽章                      |
| Ldap-顯示名稱 | RetiredReplNCSignatures                          |
| 大小              | \-                                                    |
| 更新許可權  | \-                                                    |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.1826                               |
| 系統識別碼-Guid    | d5b35506-19d6-4d26-9afb-11357ac99b5e                  |
