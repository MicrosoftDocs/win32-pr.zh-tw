...
ms.locfileid: "119753228"
---
# <a name="ntfrs-member-class"></a>NTFRS-Member 類別
...
|-------------------|--------------------------------------|
| CN                | NTFRS-Member                         |
| Ldap-顯示名稱 | nTFRSMember                          |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 2a132586-9373-11d1-aebc-0000f80367c1 |
...
| 可能的 Superiors          | [**NTFRS-複本集**](c-ntfrsreplicaset.md)                                                                                   |
| 輔助類別           | \-                                                                                                                               |
...
| [**Frs-電腦-參考**](a-frscomputerreference.md)                  | 否     | **NTFRS-成員**                |
| [**Frs-電腦-參考-BL**](a-frscomputerreferencebl.md)             | 否     | [**返回頁首**](c-top.md)<br/> |
| [**FRS-控制-資料建立**](a-frscontroldatacreation.md)             | 否     | **NTFRS-成員**                |
| [**FRS-控制-輸入-待處理專案**](a-frscontrolinboundbacklog.md)         | 否     | **NTFRS-成員**                |
| [**FRS-控制-輸出-待處理專案**](a-frscontroloutboundbacklog.md)       | 否     | **NTFRS-成員**                |
| [**FRS-擴充功能**](a-frsextensions.md)                                 | 否     | **NTFRS-成員**                |
| [**FRS-旗標**](a-frsflags.md)                                           | 否     | **NTFRS-成員**                |
| [**FRS-成員參考-BL**](a-frsmemberreferencebl.md)                 | 否     | [**返回頁首**](c-top.md)<br/> |
| [**FRS-夥伴驗證層級**](a-frspartnerauthlevel.md)                   | 否     | **NTFRS-成員**                |
| [**FRS-根目錄-安全性**](a-frsrootsecurity.md)                            | 否     | **NTFRS-成員**                |
| [**FRS-服務-命令**](a-frsservicecommand.md)                        | 否     | **NTFRS-成員**                |
| [**FRS-更新-超時**](a-frsupdatetimeout.md)                          | 否     | **NTFRS-成員**                |
...
| [**伺服器參考**](a-serverreference.md)                             | 否     | **NTFRS-成員**                |
