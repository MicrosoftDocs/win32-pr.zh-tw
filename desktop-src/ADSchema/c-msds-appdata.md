...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 7a8ecd237fbefd11f56ddd5996e343303ecf8d5a7656ceaa75c4bf63e56c8fdd
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119880558"
---
# <a name="ms-ds-app-data-class"></a>ms DS-應用程式-資料類別

儲存物件所要使用的資料。 例如，使用者物件的設定檔資訊。
...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 9e67d761-e327-4d55-bc95-682f875e2f8e |
...
| Object-Category             | 1                                                                                                                 |
| 預設-物件-類別     | \-                                                                                                                |
| Governs-Id                  | 1.2.840.113556.1.5.241                                                                                            |
| 預設值-隱藏-值        | 1                                                                                                                 |
...
| [**關鍵字**](a-keywords.md)                                              | 否     | **ms DS-應用程式-資料**                                               |
| [**最後一個已知-父系**](a-lastknownparent.md)                              | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**管理者**](a-managedby.md)                                           | 否     | **ms DS-應用程式-資料**                                               |
...
| [**ms-DS-位元組陣列**](a-msds-bytearray.md)                                | 否     | **ms DS-應用程式-資料**                                               |
...
| [**ms DS-日期時間**](a-msds-datetime.md)                                  | 否     | **ms DS-應用程式-資料**                                               |
| [**ms DS-整數**](a-msds-integer.md)                                     | 否     | **ms DS-應用程式-資料**                                               |
...
| [**ms-DS-物件參考**](a-msds-objectreference.md)                    | 否     | **ms DS-應用程式-資料**                                               |
...
| [**擁有者**](a-owner.md)                                                    | 否     | **ms DS-應用程式-資料**                                               |
