...
ms.locfileid: "120065676"
---
# <a name="print-max-resolution-supported-attribute"></a>列印-最大解析度-支援的屬性
...
|-------------------|--------------------------------------|
| CN                | 列印-最大解析度-支援       |
| Ldap-顯示名稱 | printMaxResolutionSupported          |
| 大小              | 4 個位元組                              |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.238               |
| 系統識別碼-Guid    | 281416cf-1968-11d0-a28f-00aa003049e2 |
