...
ms.locfileid: "118423089"
---
# <a name="link-track-omt-entry-class"></a>連結-追蹤-OMT-Entry 類別
...
|-------------------|--------------------------------------|
| CN                | 連結-追蹤-OMT-Entry                 |
| Ldap-顯示名稱 | linkTrackOMTEntry                    |
| 更新許可權  | 此值是由系統所設定。     |
| 更新頻率  | 每當檔案的連結變更時。   |
| 架構識別碼-Guid    | ddac0cf7-af8f-11d0-afeb-00c04fd930c9 |
...
| 可能的 Superiors          | [**連結-追蹤-物件-移動資料表**](c-linktrackobjectmovetable.md)                           |
| 輔助類別           | \-                                                                                           |
...
| [**出生位置**](a-birthlocation.md)                                 | 否     | **連結-追蹤-OMT-Entry**        |
...
| [**目前-位置**](a-currentlocation.md)                             | 否     | **連結-追蹤-OMT-Entry**        |
...
| [**OMT-Guid**](a-omtguid.md)                                             | 否     | **連結-追蹤-OMT-Entry**        |
| [**OMT-Indx-Guid**](a-omtindxguid.md)                                    | 否     | **連結-追蹤-OMT-Entry**        |
...
| [**時間-重新整理**](a-timerefresh.md)                                     | 否     | **連結-追蹤-OMT-Entry**        |
