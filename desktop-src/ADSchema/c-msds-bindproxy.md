...
ms.locfileid: "119880248"
---
# <a name="ms-ds-bind-proxy-class"></a>ms DS-Bind-Proxy 類別

代表 AD/AM 中系結 proxy 的輔助類別。 Bind proxy 會透過其 objectSid 屬性參考 Windows 安全性主體。 當使用者對 bind proxy 物件執行簡單的系結時，系結會重新導向至對應的 Windows 主體。
...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 717532ab-66e9-684d-a62b-8af1e3985e2f |
...
| [**ms-DS-主體-名稱**](a-msds-principalname.md)                        | 否     | **ms DS-系結-Proxy**            |
...
| [**物件 Sid**](a-objectsid.md)                                           | 是      | **ms DS-系結-Proxy**            |
