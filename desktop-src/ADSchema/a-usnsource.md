...
---
# <a name="usn-source-attribute"></a>USN-Source 屬性

從複寫變更至本機伺服器的遠端目錄中，已變更之物件的 [**USN 變更**](a-usnchanged.md) 屬性值。
...
| 大小              | 8 個位元組                                                                                             |
| 更新許可權  | 此值是由系統所設定。                                                                    |
| 更新頻率  | 當將變更複製到本機目錄的遠端目錄上的物件變更時。 |
| Attribute-Id      | 1.2.840.113556.1.4.896                                                                              |
| 系統識別碼-Guid    | 167758ad-47f3-11d1-a9c3-0000f80367c1                                                                |
