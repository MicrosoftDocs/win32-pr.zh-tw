...
ms.locfileid: "120005408"
---
# <a name="ms-wmi-policytemplate-class"></a>PolicyTemplate 類別

原則範本會提供在目標命名空間中建立類別實例的配方。
...
|-------------------|--------------------------------------|
| CN                | PolicyTemplate                |
| Ldap-顯示名稱 | msWMI-PolicyTemplate                 |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | e2bc80f1-244a-4d59-acc6-ca5c4f82e6e1 |
...
| 預設安全描述項 | D： (;;RPLCLORC;;;AU)  (A;;RPWPCRLCLOCCDCRCWDWOSW;;;DA)  (;;CC;;;PA)  (A;;RPWPCRLCLOCCDCRCWDWOSDDTSW;;;SY)  |
...
| [**ms-WMI-作者**](a-mswmi-author.md)                                     | 否     | **PolicyTemplate**       |
| [**ChangeDate**](a-mswmi-changedate.md)                             | 否     | **PolicyTemplate**       |
| [**CreationDate**](a-mswmi-creationdate.md)                         | 否     | **PolicyTemplate**       |
| [**ms-WMI-識別碼**](a-mswmi-id.md)                                             | 是      | **PolicyTemplate**       |
| [**intFlags1**](a-mswmi-intflags1.md)                               | 否     | **PolicyTemplate**       |
| [**intFlags2**](a-mswmi-intflags2.md)                               | 否     | **PolicyTemplate**       |
| [**intFlags3**](a-mswmi-intflags3.md)                               | 否     | **PolicyTemplate**       |
| [**intFlags4**](a-mswmi-intflags4.md)                               | 否     | **PolicyTemplate**       |
| [**ms-WMI-名稱**](a-mswmi-name.md)                                         | 是      | **PolicyTemplate**       |
| [**NormalizedClass**](a-mswmi-normalizedclass.md)                   | 是      | **PolicyTemplate**       |
| [**Parm1**](a-mswmi-parm1.md)                                       | 否     | **PolicyTemplate**       |
| [**Parm2**](a-mswmi-parm2.md)                                       | 否     | **PolicyTemplate**       |
| [**Parm3**](a-mswmi-parm3.md)                                       | 否     | **PolicyTemplate**       |
| [**Parm4**](a-mswmi-parm4.md)                                       | 否     | **PolicyTemplate**       |
| [**SourceOrganization**](a-mswmi-sourceorganization.md)             | 否     | **PolicyTemplate**       |
| [**>targetclass**](a-mswmi-targetclass.md)                           | 是      | **PolicyTemplate**       |
| [**ms-WMI-TargetNameSpace**](a-mswmi-targetnamespace.md)                   | 是      | **PolicyTemplate**       |
| [**TargetPath**](a-mswmi-targetpath.md)                             | 是      | **PolicyTemplate**       |
| [**ms-WMI-TargetType**](a-mswmi-targettype.md)                             | 否     | **PolicyTemplate**       |
