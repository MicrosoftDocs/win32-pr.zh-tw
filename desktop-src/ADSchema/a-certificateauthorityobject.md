...
---
# <a name="certificate-authority-object-attribute"></a>憑證授權單位單位-物件屬性

參考與憑證撤銷清單發佈點相關聯的憑證授權單位單位。
...
|-------------------|-----------------------------------------|
| CN                | 憑證授權單位單位-物件            |
| Ldap-顯示名稱 | certificateAuthorityObject              |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.684                  |
| 系統識別碼-Guid    | 963d2732-48be-11d1-a9c3-0000f80367c1    |
...
| 中使用的類別        | [**CRL-發佈點**](c-crldistributionpoint.md)<br/> |
