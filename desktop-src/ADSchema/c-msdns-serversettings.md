...
ms.locfileid: "119880608"
---
# <a name="ms-dns-server-settings-class"></a>ms-DNS-伺服器-設定類別
...
|-------------------|--------------------------------------|
| CN                | ms-DNS-伺服器-設定               |
| Ldap-顯示名稱 | msDNS-ServerSettings                 |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | ef2fc3ed-6e18-415b-99e4-3114a8cb124b |
...
| [**Keymaster-區域**](a-msdns-keymasterzones.md)                                     | 否     | **ms-DNS-伺服器-設定**      |
