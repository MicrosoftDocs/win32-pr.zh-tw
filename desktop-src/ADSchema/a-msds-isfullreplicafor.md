...
ms.locfileid: "118426136"
---
# <a name="ms-ds-is-full-replica-for-attribute"></a>ms-chap-已滿-複本-代表屬性

適用于 [**nc**](a-msds-hasdomainncs.md)的反向連結。 識別哪些 Dc 將該磁碟分割保留為其主域。
...
| Ldap-顯示名稱 | msDS-IsFullReplicaFor                   |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.1932                 |
| 系統識別碼-Guid    | c8bc72e0-a6b4-48f0-94a5-fd76a88c9987    |
