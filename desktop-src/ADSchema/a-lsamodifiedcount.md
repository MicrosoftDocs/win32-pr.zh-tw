...
ms.locfileid: "119301528"
---
# <a name="lsa-modified-count-attribute"></a>LSA-已修改-計數屬性

**LSA 修改計數** 屬性是用來支援 Windows NT 4.0 網域的複寫。
...
|-------------------|--------------------------------------|
| CN                | LSA-已修改-計數                   |
| Ldap-顯示名稱 | lSAModifiedCount                     |
| 大小              | 8 個位元組                              |
| 更新許可權  | 此值是由系統所設定。     |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.67                |
| 系統識別碼-Guid    | bf9679ae-0de6-11d0-a285-00aa003049e2 |
