...
ms.locfileid: "118959787"
---
# <a name="ntfrs-settings-class"></a>NTFRS-Settings 類別
...
|-------------------|--------------------------------------|
| CN                | NTFRS-Settings                       |
| Ldap-顯示名稱 | nTFRSSettings                        |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | f780acc2-56f0-11d1-a9c6-0000f80367c1 |
...
| Object-Category             | 1                                                                                                                                           |
| 預設-物件-類別     | \-                                                                                                                                          |
| Governs-Id                  | 1.2.840.113556.1.5.89                                                                                                                       |
| 預設值-隱藏-值        | 1                                                                                                                                           |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                                                                      |
| 的子類別                 | [**應用程式-設定**](c-applicationsettings.md)<br/>                                                                            |
| 可能的 Superiors          | [**組織**](c-organization.md)[**組織單位**](c-organizationalunit.md)[**容器**](c-container.md)**NTFRS-設定** |
| 輔助類別           | \-                                                                                                                                          |
...
| [**FRS-擴充功能**](a-frsextensions.md)                                 | 否     | **NTFRS-設定**                                               |
