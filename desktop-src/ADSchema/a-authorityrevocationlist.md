...
|-------------------|-------------------------------------------------------|
| CN                | 授權單位-撤銷清單                             |
| Ldap-顯示名稱 | authorityRevocationList                               |
| 大小              | \-                                                    |
| 更新許可權  | \-                                                    |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 2.5.4.38                                              |
| 系統識別碼-Guid    | 1677578d-47f3-11d1-a9c3-0000f80367c1                  |
...
| 中使用的類別        | [**憑證授權單位單位**](c-certificationauthority.md)<br/> [**CRL-發佈點**](c-crldistributionpoint.md)<br/> |
