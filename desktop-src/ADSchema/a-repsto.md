...
---
# <a name="reps-to-attribute"></a>Reps-To 屬性

列出目錄將會通知變更的伺服器，以及目錄將對定義之命名內容的要求傳送變更的伺服器。
...
| 更新許可權  | \-                                                    |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.2.83                                 |
| 系統識別碼-Guid    | bf967a1e-0de6-11d0-a285-00aa003049e2                  |
