...
---
# <a name="ms-dfsr-subscription-class"></a>ms-DFSR-訂用帳戶類別
...
|-------------------|--------------------------------------|
| CN                | ms-DFSR-訂用帳戶                 |
| Ldap-顯示名稱 | msDFSR-訂用帳戶                  |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 67212414-7bcc-4609-87e0-088dad8abdee |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.6.13.4.3                                                                                                        |
| 預設值-隱藏-值        | 1                                                                                                                                |
| Rdn-Att-Id                  | \-                                                                                                                               |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                  |
| 可能的 Superiors          | [**ms-DFSR-訂閱者**](c-msdfsr-subscriber.md)                                                                                |
| 輔助類別           | \-                                                                                                                               |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                     |
| 預設安全描述項 | D： (;;RPLCLORC;;;AU)  (A;;RPWPCRLCLOCCDCRCWDWOSDDTSW;;;DA)  (;;RPWPCRLCLOCCDCRCWDWOSDDTSW;;;CO)  (A;;RPWPCRLCLOCCDCRCWDWOSDDTSW;;;SY)  |
...
| [**ms-DFSR-ConflictPath**](a-msdfsr-conflictpath.md)                       | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-ConflictSizeInMb**](a-msdfsr-conflictsizeinmb.md)               | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-ContentSetGuid**](a-msdfsr-contentsetguid.md)                   | 對      | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-DfsLinkTarget**](a-msdfsr-dfslinktarget.md)                     | 否     | **ms-DFSR-訂用帳戶**        |
| [**啟用 ms-DFSR**](a-msdfsr-enabled.md)                                 | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-擴充功能**](a-msdfsr-extension.md)                             | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-旗標**](a-msdfsr-flags.md)                                     | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                 | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)       | 對      | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-RootFence**](a-msdfsr-rootfence.md)                             | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-RootPath**](a-msdfsr-rootpath.md)                               | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-RootSizeInMb**](a-msdfsr-rootsizeinmb.md)                       | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-StagingPath**](a-msdfsr-stagingpath.md)                         | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-StagingSizeInMb**](a-msdfsr-stagingsizeinmb.md)                 | 否     | **ms-DFSR-訂用帳戶**        |
...
| [**PartitionSetLink**](a-mscom-partitionsetlink.md)                                   | 否     | [**返回頁首**](c-top.md)<br/> |
| [**UserLink**](a-mscom-userlink.md)                                                   | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-CachePolicy**](a-msdfsr-cachepolicy.md)                                           | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-ComputerReferenceBL**](a-msdfsr-computerreferencebl.md)                           | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-ConflictPath**](a-msdfsr-conflictpath.md)                                         | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-ConflictSizeInMb**](a-msdfsr-conflictsizeinmb.md)                                 | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-ContentSetGuid**](a-msdfsr-contentsetguid.md)                                     | 對      | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-DeletedPath**](a-msdfsr-deletedpath.md)                                           | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-DeletedSizeInMb**](a-msdfsr-deletedsizeinmb.md)                                   | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-DfsLinkTarget**](a-msdfsr-dfslinktarget.md)                                       | 否     | **ms-DFSR-訂用帳戶**        |
| [**啟用 ms-DFSR**](a-msdfsr-enabled.md)                                                   | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-擴充功能**](a-msdfsr-extension.md)                                               | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-旗標**](a-msdfsr-flags.md)                                                       | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-MaxAgeInCacheInMin**](a-msdfsr-maxageincacheinmin.md)                             | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                               | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-MinDurationCacheInMin**](a-msdfsr-mindurationcacheinmin.md)                       | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-OnDemandExclusionDirectoryFilter**](a-msdfsr-ondemandexclusiondirectoryfilter.md) | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-OnDemandExclusionFileFilter**](a-msdfsr-ondemandexclusionfilefilter.md)           | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                                   | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                                 | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-ReadOnly**](a-msdfsr-readonly.md)                                                 | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)                         | 對      | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-RootFence**](a-msdfsr-rootfence.md)                                               | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-RootPath**](a-msdfsr-rootpath.md)                                                 | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-RootSizeInMb**](a-msdfsr-rootsizeinmb.md)                                         | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-StagingCleanupTriggerInPercent**](a-msdfsr-stagingcleanuptriggerinpercent.md)     | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-StagingPath**](a-msdfsr-stagingpath.md)                                           | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DFSR-StagingSizeInMb**](a-msdfsr-stagingsizeinmb.md)                                   | 否     | **ms-DFSR-訂用帳戶**        |
| [**ms-DS-Immed-從屬**](a-msds-approx-immed-subordinates.md)                   | 否     | [**返回頁首**](c-top.md)<br/> |
...
**MS DFSR 訂** 用帳戶類別是分散式檔案系統 (DFS) Replication service 支援的一部分。
