...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 7343ccddd97c6013896f73d8933194e6e4ce7b62e68e897f35e0d0734670f2e4
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118959887"
---
# <a name="ms-dfsr-subscriber-class"></a>ms-DFSR-訂閱者類別
...
|-------------------|--------------------------------------|
| CN                | ms-DFSR-訂閱者                   |
| Ldap-顯示名稱 | msDFSR-訂閱者                    |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | e11505d7-92c4-43e7-bf5c-295832ffc896 |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.6.13.4.2                                                                                                        |
| 預設值-隱藏-值        | 1                                                                                                                                |
| Rdn-Att-Id                  | \-                                                                                                                               |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                  |
| 可能的 Superiors          | [**ms-DFSR-LocalSettings**](c-msdfsr-localsettings.md)                                                                          |
| 輔助類別           | \-                                                                                                                               |
...
| [**ms-DFSR-擴充功能**](a-msdfsr-extension.md)                             | 否     | **ms-DFSR-訂閱者**          |
| [**ms-DFSR-旗標**](a-msdfsr-flags.md)                                     | 否     | **ms-DFSR-訂閱者**          |
| [**ms-DFSR-MemberReference**](a-msdfsr-memberreference.md)                 | 是      | **ms-DFSR-訂閱者**          |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                 | 否     | **ms-DFSR-訂閱者**          |
| [**ms-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)       | 是      | **ms-DFSR-訂閱者**          |
...
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                    | 否     | **ms-DFSR-訂閱者**          |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                  | 否     | **ms-DFSR-訂閱者**          |
| [**ms-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)          | 是      | **ms-DFSR-訂閱者**          |
| [**ms-DS-Immed-從屬**](a-msds-approx-immed-subordinates.md)    | 否     | [**返回頁首**](c-top.md)<br/> |
...
**MS DFSR 訂閱者** 類別是分散式檔案系統 (DFS) Replication service 支援的一部分。
