...
---
# <a name="ms-sql-sqlpublication-class"></a>SQLPublication 類別

用於儲存 SQL Server 發行集屬性的類別。 允許使用者流覽可訂閱的發行集。
...
|-------------------|--------------------------------------|
| CN                | SQLPublication                |
| Ldap-顯示名稱 | SQLPublication                |
| 更新許可權  | 此值是由系統所設定。     |
| 更新頻率  | 在系統設定時。                     |
| 架構識別碼-Guid    | 17c2f64e-ccef-11d2-9993-0000f87a57d4 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.187                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                       |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                              |
| 可能的 Superiors          | [**MS-CHAP-SQLServer**](c-ms-sql-sqlserver.md)                                               |
| 輔助類別           | \-                                                                                           |
...
| [**AllowAnonymousSubscription**](a-ms-sql-allowanonymoussubscription.md)                 | 否     | **SQLPublication**       |
| [**AllowImmediateUpdatingSubscription**](a-ms-sql-allowimmediateupdatingsubscription.md) | 否     | **SQLPublication**       |
| [**AllowKnownPullSubscription**](a-ms-sql-allowknownpullsubscription.md)                 | 否     | **SQLPublication**       |
| [**AllowQueuedUpdatingSubscription**](a-ms-sql-allowqueuedupdatingsubscription.md)       | 否     | **SQLPublication**       |
| [**AllowSnapshotFilesFTPDownloading**](a-ms-sql-allowsnapshotfilesftpdownloading.md)     | 否     | **SQLPublication**       |
| [**MS-SQL-資料庫**](a-ms-sql-database.md)                                                     | 否     | **SQLPublication**       |
| [**MS-SQL-Description**](a-ms-sql-description.md)                                               | 否     | **SQLPublication**       |
| [**MS-SQL-名稱**](a-ms-sql-name.md)                                                             | 否     | **SQLPublication**       |
| [**TRANSACT-SQL-發行者**](a-ms-sql-publisher.md)                                                   | 否     | **SQLPublication**       |
| [**MS-SQL-狀態**](a-ms-sql-status.md)                                                         | 否     | **SQLPublication**       |
| [**ThirdParty**](a-ms-sql-thirdparty.md)                                                 | 否     | **SQLPublication**       |
| [**MS-CHAP 類型**](a-ms-sql-type.md)                                                             | 否     | **SQLPublication**       |
