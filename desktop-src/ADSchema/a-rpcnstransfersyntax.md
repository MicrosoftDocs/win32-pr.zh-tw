...
ms.locfileid: "118681547"
---
# <a name="rpc-ns-transfer-syntax-attribute"></a>rpc-Ns-Transfer-語法屬性
...
|-------------------|---------------------------------------------|
| CN                | rpc-Ns-傳輸-語法                      |
| Ldap-顯示名稱 | rpcNsTransferSyntax                         |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.314                      |
| 系統識別碼-Guid    | 29401c4a-7a27-11d0-afd6-00c04fd930c9        |
...
| 中使用的類別        | [**rpc-Server 元素**](c-rpcserverelement.md)<br/> |
