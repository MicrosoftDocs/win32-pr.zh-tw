...
---
# <a name="ms-com-partitionset-class"></a>PartitionSet 類別
...
|-------------------|--------------------------------------|
| CN                | PartitionSet                  |
| Ldap-顯示名稱 | msCOM-PartitionSet                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 250464ab-c417-497a-975a-9e0d459a7ca1 |
...
| Object-Category             | 1                                                                                                                    |
| 預設-物件-類別     | \-                                                                                                                   |
| Governs-Id                  | 1.2.840.113556.1.5.194                                                                                               |
| 預設值-隱藏-值        | 1                                                                                                                    |
...
| [**DefaultPartitionLink**](a-mscom-defaultpartitionlink.md)         | 否     | **PartitionSet**         |
| [**ms-COM-ObjectId**](a-mscom-objectid.md)                                 | 否     | **PartitionSet**         |
| [**PartitionLink**](a-mscom-partitionlink.md)                       | 否     | **PartitionSet**         |
