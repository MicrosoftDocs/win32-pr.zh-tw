...
ms.locfileid: "120005368"
---
# <a name="rpc-server-element-class"></a>rpc-Server 元素類別
...
|-------------------|--------------------------------------|
| CN                | rpc-Server 元素                   |
| Ldap-顯示名稱 | rpcServerElement                     |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | f29653d0-7ad0-11d0-afd6-00c04fd930c9 |
...
| 可能的 Superiors          | [**rpc-伺服器**](c-rpcserver.md)                                                            |
| 輔助類別           | \-                                                                                           |
...
| [**rpc-Ns-系結**](a-rpcnsbindings.md)                                | 是      | **rpc-Server 元素**                                                                   |
| [**rpc-Ns-Interface-ID**](a-rpcnsinterfaceid.md)                         | 是      | **rpc-Server 元素**                                                                   |
| [**rpc-Ns-傳輸-語法**](a-rpcnstransfersyntax.md)                   | 是      | **rpc-Server 元素**                                                                   |
