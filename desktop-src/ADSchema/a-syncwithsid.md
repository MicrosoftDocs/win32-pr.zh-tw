...
---
# <a name="sync-with-sid-attribute"></a>Sync-With-SID 屬性

針對 SAM 內建群組物件/本機原則同步處理，這是物件所對應的本機群組。
...
|-------------------|--------------------------------------|
| CN                | 同步-使用-SID                        |
| Ldap-顯示名稱 | syncWithSID                          |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.667               |
| 系統識別碼-Guid    | 037651e5-441d-11d1-a9c3-0000f80367c1 |
