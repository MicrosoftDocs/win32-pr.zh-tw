...
ms.locfileid: "118177308"
---
# <a name="extended-attribute-info-attribute"></a>擴充屬性-Info 屬性

多值屬性，其中包含代表每個屬性之其他資訊的字串。
...
|-------------------|---------------------------------------------|
| CN                | 擴充屬性資訊                     |
| Ldap-顯示名稱 | extendedAttributeInfo                       |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.909                      |
| 系統識別碼-Guid    | 9a7ad947-ca53-11d1-bbd0-0080c76670c0        |
...
| 中使用的類別        | [**Ubschema**](c-subschema.md)<br/> |
