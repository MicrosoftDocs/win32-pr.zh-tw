...
ms.locfileid: "118177946"
---
# <a name="attribute-types-attribute"></a>Attribute-Types 屬性

多值屬性，其中包含表示架構中每個屬性的字串。
...
|-------------------|---------------------------------------------|
| CN                | Attribute-Types                             |
| Ldap-顯示名稱 | attributeTypes                              |
| 大小              | \-                                          |
| 更新許可權  | 架構系統管理員                        |
| 更新頻率  | \-                                          |
| Attribute-Id      | 2.5.21.5                                    |
| 系統識別碼-Guid    | 9a7ad944-ca53-11d1-bbd0-0080c76670c0        |
