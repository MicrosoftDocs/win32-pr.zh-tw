...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: da99a513376286487a1a336d666fa03a8d3ef8c4001a23c4f90e084fb56f485e
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119879878"
---
# <a name="ms-ds-quota-container-class"></a>ms DS-配額-容器類別
...
|-------------------|--------------------------------------|
| CN                | ms DS-配額-容器                |
| Ldap-顯示名稱 | QuotaContainer                  |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | da83fc4f-076f-4aea-b4dc-8f4dab9b5993 |
...
| 可能的 Superiors          | [**網域 DNS**](c-domaindns.md)[設定](c-configuration.md)                                 |
| 輔助類別           | \-                                                                                                        |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                              |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPLCLORC;;;BA)  (OA;;CR; 4ecc03fe-ffc0-4947-b630-eb672a8a9dbc;;WD)  |
...
| [**一般名稱**](a-cn.md)                                                 | 是      | **ms-DS-配額-容器** [**頂端**](c-top.md)<br/> |
...
| [**ms DS-預設配額**](a-msds-defaultquota.md)                          | 否     | **ms DS-配額-容器**                                 |
...
| [**ms DS-配額-有效**](a-msds-quotaeffective.md)                      | 否     | **ms DS-配額-容器**                                 |
| [**ms DS-使用配額**](a-msds-quotaused.md)                                | 否     | **ms DS-配額-容器**                                 |
...
| [**ms-DS-標記-配額因素**](a-msds-tombstonequotafactor.md)         | 否     | **ms DS-配額-容器**                                 |
| [**ms-DS-最上層配額-使用量**](a-msds-topquotausage.md)                       | 否     | **ms DS-配額-容器**                                 |
