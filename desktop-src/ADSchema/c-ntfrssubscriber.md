...
ms.locfileid: "118959737"
---
# <a name="ntfrs-subscriber-class"></a>NTFRS-Subscriber 類別
...
|-------------------|--------------------------------------|
| CN                | NTFRS-Subscriber                     |
| Ldap-顯示名稱 | nTFRSSubscriber                      |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 2a132588-9373-11d1-aebc-0000f80367c1 |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.5.155                                                                                                           |
| 預設值-隱藏-值        | 1                                                                                                                                |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                                                           |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                  |
| 可能的 Superiors          | [**NTFRS-訂閱**](c-ntfrssubscriptions.md)                                                                              |
| 輔助類別           | \-                                                                                                                               |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                     |
| 預設安全描述項 | D： (;;RPLCLORC;;;AU)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;共同)  |
...
| [**FRS-擴充功能**](a-frsextensions.md)                                 | 否     | **NTFRS-訂閱者**            |
| [**FRS-錯誤-條件**](a-frsfaultcondition.md)                        | 否     | **NTFRS-訂閱者**            |
| [**FRS-旗標**](a-frsflags.md)                                           | 否     | **NTFRS-訂閱者**            |
| [**FRS-成員參考**](a-frsmemberreference.md)                      | 否     | **NTFRS-訂閱者**            |
| [**FRS-成員參考-BL**](a-frsmemberreferencebl.md)                 | 否     | [**返回頁首**](c-top.md)<br/> |
| [**FRS-根目錄路徑**](a-frsrootpath.md)                                    | 是      | **NTFRS-訂閱者**            |
| [**FRS-服務-命令**](a-frsservicecommand.md)                        | 否     | **NTFRS-訂閱者**            |
| [**FRS-服務-命令-狀態**](a-frsservicecommandstatus.md)           | 否     | **NTFRS-訂閱者**            |
| [**FRS-暫存路徑**](a-frsstagingpath.md)                              | 是      | **NTFRS-訂閱者**            |
| [**FRS-時間-最後一個命令**](a-frstimelastcommand.md)                     | 否     | **NTFRS-訂閱者**            |
| [**FRS 時間-上次設定-變更**](a-frstimelastconfigchange.md)          | 否     | **NTFRS-訂閱者**            |
| [**FRS-更新-超時**](a-frsupdatetimeout.md)                          | 否     | **NTFRS-訂閱者**            |
