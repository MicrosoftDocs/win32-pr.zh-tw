...
---
# <a name="ms-ds-failed-interactive-logon-count-at-last-successful-logon-attribute"></a>ms DS-失敗-互動式-登入計數-最新的登入屬性

在上次成功的 C-A-D 登入之前，失敗的互動式登入的總數。
...
| Ldap-顯示名稱 | msDS-FailedInteractiveLogonCountAtLastSuccessfulLogon         |
| 大小              | \-                                                            |
| 更新許可權  | \-                                                            |
| 更新頻率  | \-                                                            |
| Attribute-Id      | 1.2.840.113556.1.4.1973                                       |
| 系統識別碼-Guid    | c5d234e5-644a-4403-a665-e26e0aef5e98                          |
