...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 2298248bb375248fea1efcf692bdce4a6a6301f217fbc750c55f0a7b92140f58
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119643968"
---
# <a name="application-entity-class"></a>Application-Entity 類別

應用程式的 X. 500 基類：目錄服務只會使用子類別 MSFT-DSA。
...
| Ldap-顯示名稱 | applicationEntity                    |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 3fdfee4f-47f4-11d1-a9c3-0000f80367c1 |
...
| [**一般名稱**](a-cn.md)                                               | 是      | **應用程式-實體** [ **Top**](c-top.md)<br/> |
...
| [**組織單位-名稱**](a-ou.md)                                  | 否     | **應用程式-實體**                                 |
| [**組織名稱**](a-o.md)                                          | 否     | **應用程式-實體**                                 |
...
| [**簡報-位址**](a-presentationaddress.md)                     | 是      | **應用程式-實體**                                 |
...
| [**支援-應用程式內容**](a-supportedapplicationcontext.md)    | 否     | **應用程式-實體**                                 |
...
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                                                                 |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                        |
| 可能的 Superiors          | [**容器**](c-container.md)[**組織-單位**](c-organizationalunit.md)[**應用程式-進程**](c-applicationprocess.md) |
| 輔助類別           | \-                                                                                                                                     |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                           |
| 預設安全描述項 | D:(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)(A;;RPLCLORC;;;AU)                                           |
| System-Flags                | 0x00000010                                                                                                                             |
