...
---
# <a name="service-dns-name-type-attribute"></a>服務-DNS-名稱-類型屬性

要查閱此服務的 DNS 記錄類型。 例如，或 SRV。
...
|-------------------|---------------------------------------------|
| CN                | 服務-DNS-名稱-類型                       |
| Ldap-顯示名稱 | serviceDNSNameType                          |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.659                      |
| 系統識別碼-Guid    | 28630eba-41d5-11d1-a9c1-0000f80367c1        |
