...
---
# <a name="ms-dfs-link-v2-class"></a>ms-DFS-Link-v2 類別
...
|-------------------|--------------------------------------|
| CN                | ms-DFS-Link-v2                       |
| Ldap-顯示名稱 | msDFS-Linkv2                         |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 7769fb7a-1159-4e96-9ccd-68bc487073eb |
...
| 可能的 Superiors          | [**ms-DFS-Namespace-v2**](c-msdfs-namespacev2.md)                                           |
| 輔助類別           | \-                                                                                           |
...
| [**ms-DFS-Comment-v2**](a-msdfs-commentv2.md)                                 | 否     | **ms-DFS-Link-v2**              |
| [**ms-DFS-Generation-GUID-v2**](a-msdfs-generationguidv2.md)                  | 對      | **ms-DFS-Link-v2**              |
| [**ms-DFS-Last-Modified-v2**](a-msdfs-lastmodifiedv2.md)                      | 對      | **ms-DFS-Link-v2**              |
| [**ms-DFS-Link-Identity-GUID-v2**](a-msdfs-linkidentityguidv2.md)             | 對      | **ms-DFS-Link-v2**              |
| [**ms-DFS-連結-路徑-v2**](a-msdfs-linkpathv2.md)                              | 對      | **ms-DFS-Link-v2**              |
| [**ms-DFS-Link-Security-Descriptor-v2**](a-msdfs-linksecuritydescriptorv2.md) | 否     | **ms-DFS-Link-v2**              |
| [**ms-DFS-Namespace-Identity-GUID-v2**](a-msdfs-namespaceidentityguidv2.md)   | 對      | **ms-DFS-Link-v2**              |
| [**ms-DFS-屬性-v2**](a-msdfs-propertiesv2.md)                           | 對      | **ms-DFS-Link-v2**              |
...
| [**ms-DFS-簡短名稱-連結路徑-v2**](a-msdfs-shortnamelinkpathv2.md)          | 否     | **ms-DFS-Link-v2**              |
| [**ms-DFS-Target-List-v2**](a-msdfs-targetlistv2.md)                          | 對      | **ms-DFS-Link-v2**              |
| [**ms-DFS-Ttl-v2**](a-msdfs-ttlv2.md)                                         | 對      | **ms-DFS-Link-v2**              |
