...
---
# <a name="ms-exch-assistant-name-attribute"></a>Ms-exch-assistant-name-Assistant-Name 屬性
...
| 進入 | 值 |
|-------------------|---------------------------------------------|
| CN                | Ms-exch-assistant-name-助理-名稱                      |
| Ldap-顯示名稱 | msExchAssistantName                         |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.2.444                      |
| 系統識別碼-Guid    | a8df7394-c5ea-11d1-bbcb-0080c76670c0        |
