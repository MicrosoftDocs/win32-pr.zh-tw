...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 63bec4a7a1ab7bcabc1638c9c985207ce75a73d0e8616e656157e2de0563032d
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119834928"
---
# <a name="link-track-vol-entry-class"></a>連結-追蹤-音量-進入類別
...
|-------------------|---------------------------------------|
| CN                | 連結-追蹤-音量-進入                  |
| Ldap-顯示名稱 | linkTrackVolEntry                     |
| 更新許可權  | 此值是由系統所設定。      |
| 更新頻率  | 每次建立檔案的連結時。 |
| 架構識別碼-Guid    | ddac0cf6-af8f-11d0-afeb-00c04fd930c9  |
...
| Object-Category             | 1                                                                          |
| 預設-物件-類別     | \-                                                                         |
| Governs-Id                  | 1.2.840.113556.1.5.92                                                      |
| 預設值-隱藏-值        | 1                                                                          |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                     |
| 的子類別                 | [**Leaf**](c-leaf.md)<br/>                                          |
| 可能的 Superiors          | [**連結-追蹤-磁片區資料表**](c-linktrackvolumetable.md)                  |
| 輔助類別           | \-                                                                         |
| NT-Security-描述元      | O:BAG：不正確： S：                                                               |
| 預設安全描述項 | D:(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY) |
...
| [**Curr.errlog-電腦識別碼**](a-currmachineid.md)                                | 否     | **連結-追蹤-音量-進入**        |
...
| [**連結-追蹤-秘密**](a-linktracksecret.md)                            | 否     | **連結-追蹤-音量-進入**        |
...
| [**物件計數**](a-objectcount.md)                                     | 否     | **連結-追蹤-音量-進入**        |
...
| [**Seq-通知**](a-seqnotification.md)                             | 否     | **連結-追蹤-音量-進入**        |
...
| [**時間-重新整理**](a-timerefresh.md)                                     | 否     | **連結-追蹤-音量-進入**        |
| [**時間-音量-變更**](a-timevolchange.md)                                | 否     | **連結-追蹤-音量-進入**        |
...
| [**Vol-資料表-GUID**](a-voltableguid.md)                                  | 否     | **連結-追蹤-音量-進入**        |
| [**Vol-資料表-Idx-GUID**](a-voltableidxguid.md)                           | 否     | **連結-追蹤-音量-進入**        |
