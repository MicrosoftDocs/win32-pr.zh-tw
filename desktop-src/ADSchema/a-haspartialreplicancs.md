...
ms.locfileid: "118176785"
---
# <a name="has-partial-replica-ncs-attribute"></a>具有-Partial-Replica-Nc 屬性

Nc 的同級。 具有-Partial-Nc 會反映所有其他已複寫到通用類別目錄的網域 Nc 的分辨名稱。



| 進入 | 值 |
|-------------------|-----------------------------------------|
| CN                | 具有-Partial-Replica-Nc                 |
| Ldap-顯示名稱 | hasPartialReplicaNCs                    |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.2.15                   |
| 系統識別碼-Guid    | bf967981-0de6-11d0-a285-00aa003049e2    |
