...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: a66793ba5d27c4c0d919fef147a1a7fd32a7c19628bcc6472d12e9e8815e87b4
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118423198"
---
# <a name="control-access-right-class"></a>控制項存取權限類別

識別可使用 ACL 授與或撤銷的延伸許可權。
...
|-------------------|--------------------------------------|
| CN                | Control-存取權限                 |
| Ldap-顯示名稱 | controlAccessRight                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 8297931e-86d3-11d0-afda-00c04fd930c9 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.77                                                                        |
| 預設值-隱藏-值        | 1                                                                                            |
...
| [**適用于**](a-appliesto.md)                                         | 否     | **Control-存取權限**        |
...
| [**當地語系化-顯示識別碼**](a-localizationdisplayid.md)                | 否     | **Control-存取權限**        |
...
| [**許可權-Guid**](a-rightsguid.md)                                       | 否     | **Control-存取權限**        |
...
| [**有效-存取**](a-validaccesses.md)                                 | 否     | **Control-存取權限**        |
