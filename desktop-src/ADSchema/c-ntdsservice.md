...
ms.locfileid: "119753448"
---
# <a name="ntds-service-class"></a>NTDS-Service 類別

此類別可用於 NTDS 服務物件，此物件包含目錄服務樹系設定的相關資訊。 此物件會保存在 cn = Directory 服務，cn = Windows NT，cn = Services，cn = Configuration,.。。容器。
...
|-------------------|--------------------------------------|
| CN                | NTDS-Service                         |
| Ldap-顯示名稱 | nTDSService                          |
| 更新許可權  | 企業系統管理員             |
| 更新頻率  | 幾乎沒有。                        |
| 架構識別碼-Guid    | 19195a5f-6da0-11d0-afd3-00c04fd930c9 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.72                                                                        |
| 預設值-隱藏-值        | 1                                                                                            |
...
| [**DS-啟發學習法**](a-dsheuristics.md)                                   | 否     | **NTDS 服務**                |
...
| [**垃圾 Coll 期間**](a-garbagecollperiod.md)                        | 否     | **NTDS 服務**                |
...
| [**複寫-拓撲-持續執行**](a-repltopologystayofexecution.md)  | 否     | **NTDS 服務**                |
...
| [**SPN 對應**](a-spnmappings.md)                                     | 否     | **NTDS 服務**                |
...
| [**標記-存留期**](a-tombstonelifetime.md)                         | 否     | **NTDS 服務**                |
...
| [**ms DS-其他-設定**](a-msds-other-settings.md)                       | 否     | **NTDS 服務**                |
...
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)           | 否     | [**返回頁首**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                        | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DS-已刪除-物件-存留期**](a-msds-deletedobjectlifetime.md)            | 否     | **NTDS 服務**                |
