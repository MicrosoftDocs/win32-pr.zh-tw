...
---
# <a name="msmq-prev-site-gates-attribute"></a>MSMQ-上一個網站-閘道屬性

**Msmq-上站-閘道** 屬性包含 msmq 混合模式資訊。
...
|-------------------|-----------------------------------------|
| CN                | MSMQ-上站-閘道                    |
| Ldap-顯示名稱 | mSMQPrevSiteGates                       |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.1225                 |
| 系統識別碼-Guid    | 2df90d75-009f-11d2-aa4c-00c04fd7d83a    |
