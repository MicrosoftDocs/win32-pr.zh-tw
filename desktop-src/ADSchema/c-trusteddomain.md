...
ms.locfileid: "119702938"
---
# <a name="trusted-domain-class"></a>Trusted-Domain 類別

物件，代表 (或信任) 本機網域所信任的網域。
...
|-------------------|--------------------------------------|
| CN                | Trusted-Domain                       |
| Ldap-顯示名稱 | trustedDomain                        |
| 更新許可權  | 此值是由系統所設定。     |
| 更新頻率  | 當新的信任建立時。         |
| 架構識別碼-Guid    | bf967ab8-0de6-11d0-a285-00aa003049e2 |
...
| 屬性                                                                   | 強制性 | 衍生自                    |
|-----------------------------------------------------------------------------|-----------|---------------------------------|
| [**其他受信任的服務名稱**](a-additionaltrustedservicenames.md) | 否     | **信任網域**              |
...
| [**網域交互參考**](a-domaincrossref.md)                                | 否     | **信任網域**              |
| [**網域識別碼**](a-domainidentifier.md)                             | 否     | **信任網域**              |
...
| [**初始-驗證-傳入**](a-initialauthincoming.md)                      | 否     | **信任網域**              |
| [**初始-驗證-外寄**](a-initialauthoutgoing.md)                      | 否     | **信任網域**              |
...
| [**安全性-識別碼**](a-securityidentifier.md)                         | 否     | **信任網域**              |
...
| [**信任-屬性**](a-trustattributes.md)                               | 否     | **信任網域**              |
| [**信任-驗證-連入**](a-trustauthincoming.md)                          | 否     | **信任網域**              |
| [**信任-驗證-外寄**](a-trustauthoutgoing.md)                          | 否     | **信任網域**              |
| [**信任-方向**](a-trustdirection.md)                                 | 否     | **信任網域**              |
| [**信任-合作夥伴**](a-trustpartner.md)                                     | 否     | **信任網域**              |
| [**信任-Posix-Offset**](a-trustposixoffset.md)                            | 否     | **信任網域**              |
| [**信任類型**](a-trusttype.md)                                           | 否     | **信任網域**              |
...
| 輔助類別           | \-                                                                                                                                                                                            |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                                                                                  |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPLCLORC;;;AU)  (OA;;WP; 736e4812-af31-11d2-b7df-00805f48caeb; bf967ab8-0de6-11d0-a285-00aa003049e2; CO)  (A;;SD;;;共同)  |
| System-Flags                | 0x00000010                                                                                                                                                                                    |
...
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)      | 否     | [**返回頁首**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                   | 否     | [**返回頁首**](c-top.md)<br/> |
| [**MS-DS-Creator-SID**](a-ms-ds-creatorsid.md)                             | 否     | **信任網域**              |
...
| [**ms-DS-信任-樹系信任資訊**](a-msds-trustforesttrustinfo.md)        | 否     | **信任網域**              |
...
| [**支援的 ms DS-加密類型**](a-msds-supportedencryptiontypes.md)    | 否     | **信任網域**              |
| [**ms-chap---------BL**](a-msds-tasksforazrolebl.md)                  | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms DS-工作--Az-Task-BL**](a-msds-tasksforaztaskbl.md)                  | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DS-信任-樹系信任資訊**](a-msds-trustforesttrustinfo.md)           | 否     | **信任網域**              |
| [**Ms-exch-assistant-name-擁有者-BL**](a-ownerbl.md)                                          | 否     | [**返回頁首**](c-top.md)<br/> |
...
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                                      | 否     | [**返回頁首**](c-top.md)<br/> |
| [**MS-DS-Creator-SID**](a-ms-ds-creatorsid.md)                                                | 否     | **信任網域**              |
| [**ms-DS-Egress-宣告-轉換-原則**](a-msds-egressclaimstransformationpolicy.md)   | 否     | **信任網域**              |
| [**啟用 ms DS-功能-BL**](a-msds-enabledfeaturebl.md)                                    | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DS-服務-帳戶-BL**](a-msds-hostserviceaccountbl.md)                           | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DS-輸入-宣告-轉換-原則**](a-msds-ingressclaimstransformationpolicy.md) | 否     | **信任網域**              |
| [**ms-DS-Is-Domain-For**](a-msds-isdomainfor.md)                                              | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DS-Is-Full-Replica-For**](a-msds-isfullreplicafor.md)                                   | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-chap-為部分複本**](a-msds-ispartialreplicafor.md)                             | 否     | [**返回頁首**](c-top.md)<br/> |
