...
ms.locfileid: "118960317"
---
# <a name="ms-rras-vendor-attribute-entry-attribute"></a>ms RRAS-廠商-屬性-Entry 屬性

字串，可讓廠商將路由器屬性新增至 DS 以用於查詢，格式為 AttributeName： vendorID： AttributeType。



| 進入 | 值 |
|-------------------|---------------------------------------------|
| CN                | ms RRAS-廠商-屬性-Entry              |
| Ldap-顯示名稱 | msRRASVendorAttributeEntry                  |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.883                      |
| 系統識別碼-Guid    | f39b98ac-938d-11d1-aebd-0000f80367c1        |
...
| 中使用的類別        | [**RRAS-管理-字典**](c-rrasadministrationdictionary.md)<br/> |
