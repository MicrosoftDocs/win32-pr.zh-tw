...
ms.locfileid: "119834568"
---
# <a name="ms-authz-central-access-policy-class"></a>ms-Authz-存取原則類別
...
|-------------------|--------------------------------------|
| CN                | ms-Authz-存取-原則       |
| Ldap-顯示名稱 | msAuthz-CentralAccessPolicy          |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | a5679cb0-6f9d-432c-8b75-1e3e834f02aa |
...
| 可能的 Superiors          | [**ms-Authz-存取-原則**](c-msauthz-centralaccesspolicies.md)                  |
| 輔助類別           | \-                                                                                           |
...
| [**ms-Authz-存取原則-識別碼**](a-msauthz-centralaccesspolicyid.md)                         | 否     | **ms-Authz-存取-原則** |
| [**ms Authz-成員--內建-存取原則**](a-msauthz-memberrulesincentralaccesspolicy.md) | 否     | **ms-Authz-存取-原則** |
