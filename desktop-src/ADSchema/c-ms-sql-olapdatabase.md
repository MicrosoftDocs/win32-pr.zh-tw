---
title: OLAPDatabase 類別 SQL
description: 用於儲存 MS SQL OLAPCube 物件的容器。
ms.assetid: 651593bd-4c2a-47bf-a601-8f110291f6f6
ms.tgt_platform: multiple
keywords:
- OLAPDatabase 類別 AD 架構 SQL
- OLAPDatabase 類別 AD 架構 SQL
topic_type:
- apiref
api_name:
...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: b5edbfcb234258b9fbff61d3325bb1d1e55a6b707071c15f29ab77db941c4015
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119441208"
---
# <a name="ms-sql-olapdatabase-class"></a>OLAPDatabase 類別 SQL

用於儲存 [**MS SQL OLAPCube**](c-ms-sql-olapcube.md)物件的容器。



| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | 毫秒-SQL-OLAPDatabase                  |
| Ldap-顯示名稱 | 毫秒-SQL-OLAPDatabase                  |
| 更新許可權  | 此值是由系統所設定。     |
| 更新頻率  | 在系統設定時。                     |
| 架構識別碼-Guid    | 20af031a-ccef-11d2-9993-0000f87a57d4 |
...
| 可能的 Superiors          | [**毫秒-SQL-olapserver.server**](c-ms-sql-olapserver.md)                                             |
| 輔助類別           | \-                                                                                           |
...
| [**MS SQL-應用程式**](a-ms-sql-applications.md)                      | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**毫秒-SQL-ConnectionURL**](a-ms-sql-connectionurl.md)                    | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**MS-SQL-Contact**](a-ms-sql-contact.md)                                | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**毫秒-SQL-描述**](a-ms-sql-description.md)                        | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**毫秒-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**ms-chap-SQL 關鍵字**](a-ms-sql-keywords.md)                              | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**毫秒-SQL-LastBackupDate**](a-ms-sql-lastbackupdate.md)                  | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**毫秒-SQL-LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**毫秒-SQL-名稱**](a-ms-sql-name.md)                                      | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**毫秒-SQL-PublicationURL**](a-ms-sql-publicationurl.md)                  | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**毫秒-SQL 大小**](a-ms-sql-size.md)                                      | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**毫秒-SQL-狀態**](a-ms-sql-status.md)                                  | 否     | **毫秒-SQL-OLAPDatabase**         |
| [**毫秒-SQL 類型**](a-ms-sql-type.md)                                      | 否     | **毫秒-SQL-OLAPDatabase**         |
