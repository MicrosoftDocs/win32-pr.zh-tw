...
---
# <a name="ms-sql-olapdatabase-class"></a>OLAPDatabase 類別

用於儲存 [**OLAPCube**](c-ms-sql-olapcube.md) 物件的容器。
...
| 可能的 Superiors          | [**Olapserver.server**](c-ms-sql-olapserver.md)                                             |
| 輔助類別           | \-                                                                                           |
...
| [**MS-SQL-應用程式**](a-ms-sql-applications.md)                      | 否     | **OLAPDatabase**         |
| [**ConnectionURL**](a-ms-sql-connectionurl.md)                    | 否     | **OLAPDatabase**         |
| [**MS-SQL-連絡人**](a-ms-sql-contact.md)                                | 否     | **OLAPDatabase**         |
| [**MS-SQL-Description**](a-ms-sql-description.md)                        | 否     | **OLAPDatabase**         |
| [**InformationURL**](a-ms-sql-informationurl.md)                  | 否     | **OLAPDatabase**         |
| [**MS-CHAP-關鍵字**](a-ms-sql-keywords.md)                              | 否     | **OLAPDatabase**         |
| [**LastBackupDate**](a-ms-sql-lastbackupdate.md)                  | 否     | **OLAPDatabase**         |
| [**LastUpdatedDate**](a-ms-sql-lastupdateddate.md)                | 否     | **OLAPDatabase**         |
| [**MS-SQL-名稱**](a-ms-sql-name.md)                                      | 否     | **OLAPDatabase**         |
| [**PublicationURL**](a-ms-sql-publicationurl.md)                  | 否     | **OLAPDatabase**         |
| [**MS-SQL-大小**](a-ms-sql-size.md)                                      | 否     | **OLAPDatabase**         |
| [**MS-SQL-狀態**](a-ms-sql-status.md)                                  | 否     | **OLAPDatabase**         |
| [**MS-CHAP 類型**](a-ms-sql-type.md)                                      | 否     | **OLAPDatabase**         |
