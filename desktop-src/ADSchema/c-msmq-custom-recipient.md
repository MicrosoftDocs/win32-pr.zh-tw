...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: aa2a3b08f22f8827972a9785ee6ed0e48a22ff2051c0506ce3d586bc9341ba5e
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118175634"
---
# <a name="msmq-custom-recipient-class"></a>MSMQ-自訂收件者類別

用來定義自訂的 MSMQ 收件者 (也稱為別名佇列) 。 定義企業外佇列的別名。 包含該佇列的格式名稱。
...
|-------------------|------------------------------------------|
| CN                | MSMQ-自訂-收件者                    |
| Ldap-顯示名稱 | msMQ-自訂-收件者                    |
| 更新許可權  | 佇列擁有者。                         |
| 更新頻率  | 只有在移動外部佇列之後。 |
| 架構識別碼-Guid    | 876d6817-35cc-436c-acea-5ef7174dd9be     |
...
| Object-Category             | 1                                                                                                                    |
| 預設-物件-類別     | \-                                                                                                                   |
| Governs-Id                  | 1.2.840.113556.1.5.218                                                                                               |
| 預設值-隱藏-值        | 0                                                                                                                    |
| Rdn-Att-Id                  | \-                                                                                                                   |
...
| [**MSMQ-收件者-Msmq.formatname**](a-msmq-recipient-formatname.md)            | 否     | **MSMQ-自訂-收件者**       |
