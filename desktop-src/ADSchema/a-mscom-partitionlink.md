...
---
# <a name="ms-com-partitionlink-attribute"></a>PartitionLink 屬性

用來將 COM + PartitionSet 與其組成的 COM + 分割相關聯的連結。
...
|-------------------|-----------------------------------------|
| CN                | PartitionLink                    |
| Ldap-顯示名稱 | msCOM-PartitionLink                     |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.1423                 |
| 系統識別碼-Guid    | 09abac62-043f-4702-ac2b-6ca15eee5754    |
...
| 中使用的類別        | [**PartitionSet**](c-mscom-partitionset.md)<br/> |
