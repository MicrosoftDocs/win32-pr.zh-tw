...
---
# <a name="ms-dfsr-priority-attribute"></a>ms-DFSR-Priority 屬性
...
|-------------------|--------------------------------------|
| CN                | ms-DFSR-優先順序                     |
| Ldap-顯示名稱 | msDFSR-Priority                      |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.6.13.3.25           |
| 系統識別碼-Guid    | eb20e7d6-32ad-42de-b141-16ad2631b01b |
...
| 中使用的類別        | [**ms-DFSR-ContentSet**](c-msdfsr-contentset.md)<br/> [**ms-DFSR-連接**](c-msdfsr-connection.md)<br/> |
