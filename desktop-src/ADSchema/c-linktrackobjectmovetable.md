...
---
# <a name="link-track-object-move-table-class"></a>連結-追蹤-物件-移動資料表類別

連結-追蹤-OMT-Entry 物件的容器。
...
|-------------------|--------------------------------------|
| CN                | 連結-追蹤-物件-移動資料表         |
| Ldap-顯示名稱 | linkTrackObjectMoveTable             |
| 更新許可權  | 此值是由系統所設定。     |
| 更新頻率  | 每當檔案的連結變更時。   |
| 架構識別碼-Guid    | ddac0cf5-af8f-11d0-afeb-00c04fd930c9 |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.91                                                                        |
| 預設值-隱藏-值        | 1                                                                                            |
