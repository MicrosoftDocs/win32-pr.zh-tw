...
---
# <a name="reports-attribute"></a>Reports 屬性

包含直接向使用者報告的使用者清單。 列為 [報表] 的使用者，是將 [屬性管理員] 屬性設定為 [此使用者] 的使用者。 清單中的每個專案都是代表使用者之物件的連結參考。
...
|-------------------|-------------------------------------------------|
| CN                | 報表                                         |
| Ldap-顯示名稱 | directReports                                   |
| 大小              | \-                                              |
| 更新許可權  | 此值是由系統所設定。                |
| 更新頻率  | 當使用者的直屬員工變更時。 |
| Attribute-Id      | 1.2.840.113556.1.2.436                          |
| 系統識別碼-Guid    | bf967a1c-0de6-11d0-a285-00aa003049e2            |
