...
---
# <a name="meetingscope-attribute"></a>meetingScope 屬性

可以是 global、local 或其他值。 其轉譯為特定應用程式。
...
|-------------------|---------------------------------------------|
| CN                | meetingScope                                |
| Ldap-顯示名稱 | meetingScope                                |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.581                      |
| 系統識別碼-Guid    | 11b6cc8a-48c4-11d1-a9c3-0000f80367c1        |
