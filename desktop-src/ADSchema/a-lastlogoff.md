...
ms.locfileid: "119924758"
---
# <a name="last-logoff-attribute"></a>Last-Logoff 屬性
...
|-------------------|--------------------------------------|
| CN                | Last-Logoff                          |
| Ldap-顯示名稱 | lastLogoff                           |
| 大小              | 8 個位元組                              |
| 更新許可權  | 此值是由系統所設定。     |
| 更新頻率  | 每次使用者登出。         |
| Attribute-Id      | 1.2.840.113556.1.4.51                |
| 系統識別碼-Guid    | bf967996-0de6-11d0-a285-00aa003049e2 |
