...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 7f561288-5301-11d1-a9c5-0000f80367c1 |
...
| 屬性                                                                        | 強制性 | 衍生自                    |
|----------------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-匯總-權杖-每位使用者的費率**](a-acsaggregatetokenrateperuser.md)      | 否     | **ACS-原則**                  |
...
| [**ACS-許可權位**](a-acspermissionbits.md)                               | 否     | **ACS-原則**                  |
| [**ACS-優先順序**](a-acspriority.md)                                            | 否     | **ACS-原則**                  |
| [**ACS-服務類型**](a-acsservicetype.md)                                     | 否     | **ACS-原則**                  |
| [**ACS-當日時間**](a-acstimeofday.md)                                        | 否     | **ACS-原則**                  |
| [**ACS-總計-無流程**](a-acstotalnoofflows.md)                             | 否     | **ACS-原則**                  |
