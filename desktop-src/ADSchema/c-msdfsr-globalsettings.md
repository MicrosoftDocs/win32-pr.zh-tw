...
ms.locfileid: "118680788"
---
# <a name="ms-dfsr-globalsettings-class"></a>ms-chap GlobalSettings 類別
...
| Ldap-顯示名稱 | msDFSR-GlobalSettings                |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 7b35dbad-b3ec-486a-aad4-2fec9d6ea6f6 |
...
| [**ms-DFSR-擴充功能**](a-msdfsr-extension.md)                             | 否     | **ms-DFSR-GlobalSettings**      |
| [**ms-DFSR-旗標**](a-msdfsr-flags.md)                                     | 否     | **ms-DFSR-GlobalSettings**      |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                 | 否     | **ms-DFSR-GlobalSettings**      |
...
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                    | 否     | **ms-DFSR-GlobalSettings**      |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                  | 否     | **ms-DFSR-GlobalSettings**      |
| [**ms-DS-Immed-從屬**](a-msds-approx-immed-subordinates.md)    | 否     | [**返回頁首**](c-top.md)<br/> |
...
**GlobalSettings** 類別是分散式檔案系統 (DFS) Replication service 支援的一部分。
