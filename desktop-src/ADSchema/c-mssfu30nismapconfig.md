...
---
# <a name="mssfu-30-nis-map-config-class"></a>msSFU-30-NIS-對應-Config 類別

表示 server for NIS 所使用的內部資料結構。



| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | msSFU-30-NIS-對應-Config              |
| Ldap-顯示名稱 | msSFU30NISMapConfig                  |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | faf733d0-f8eb-4dcf-8d75-f1753af6a50b |
...
| [**msSFU-30-欄位-分隔符號**](a-mssfu30fieldseparator.md)                 | 否     | **msSFU-30-NIS-對應-Config**     |
| [**msSFU-30-欄位內-分隔符號**](a-mssfu30intrafieldseparator.md)      | 否     | **msSFU-30-NIS-對應-Config**     |
| [**msSFU-30-索引鍵-屬性**](a-mssfu30keyattributes.md)                   | 否     | **msSFU-30-NIS-對應-Config**     |
| [**msSFU-30-地圖-篩選**](a-mssfu30mapfilter.md)                           | 否     | **msSFU-30-NIS-對應-Config**     |
| [**msSFU-30-NSMAP-欄位-位置**](a-mssfu30nsmapfieldposition.md)        | 否     | **msSFU-30-NIS-對應-Config**     |
| [**msSFU-30-Posix-成員**](a-mssfu30posixmemberof.md)                  | 否     | [**返回頁首**](c-top.md)<br/> |
| [**msSFU-30-結果-屬性**](a-mssfu30resultattributes.md)             | 否     | **msSFU-30-NIS-對應-Config**     |
| [**msSFU-30-搜尋-屬性**](a-mssfu30searchattributes.md)             | 否     | **msSFU-30-NIS-對應-Config**     |
