...
---
# <a name="ms-ds-tasks-for-az-task-bl-attribute"></a>ms-chap---------BL 屬性

從 Az-Task 到連結的 Az-Task 物件的反向連結。



| 進入 | 值 |
|-------------------|-----------------------------------------|
| CN                | ms DS-工作--Az-Task-BL              |
| Ldap-顯示名稱 | TasksForAzTaskBL                   |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | 此值是由系統所設定。        |
| Attribute-Id      | 1.2.840.113556.1.4.1811                 |
| 系統識別碼-Guid    | df446e52-b5fa-4ca2-a42f-13f98a526c8f    |
