...
---
# <a name="sites-container-class"></a>Sites-Container 類別

用於儲存網站物件的容器。 位於設定命名內容中。
...
|-------------------|------------------------------------------|
| CN                | Sites-Container                          |
| Ldap-顯示名稱 | sitesContainer                           |
| 更新許可權  | 此物件是由系統維護。 |
| 更新頻率  | 建立目錄服務時。   |
| 架構識別碼-Guid    | 7a4117da-cd67-11d0-afff-0000f80367c1     |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.107                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
