...
---
# <a name="other-name-attribute"></a>Other-Name 屬性

使用者的其他名稱。 例如，中間名、patronymic、matronymic 或其他。
...
|-------------------|---------------------------------------------|
| CN                | Other-Name                                  |
| Ldap-顯示名稱 | middleName                                  |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 2.16.840.1.113730.3.1.34                    |
| 系統識別碼-Guid    | bf9679f2-0de6-11d0-a285-00aa003049e2        |
