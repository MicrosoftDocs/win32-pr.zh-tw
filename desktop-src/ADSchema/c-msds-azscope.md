...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 04fdac06abba4a34cef5e2598620ac2c2c49b2a5ba003d11fe07b870c79a5dc3
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119880327"
---
# <a name="ms-ds-az-scope-class"></a>ms DS-Az-Scope 類別
...
| 更新許可權  | AzRoles 系統管理員                           |
| 更新頻率  | 在初始化或原則變更期間。 |
| 架構識別碼-Guid    | 4feae054-ce55-47bb-860e-5b12063a51de    |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.5.237                                                                                                           |
| 預設值-隱藏-值        | 1                                                                                                                                |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                                                           |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                  |
| 可能的 Superiors          | [**ms DS-Az-應用程式**](c-msds-azapplication.md)                                                                             |
| 輔助類別           | \-                                                                                                                               |
...
| [**描述**](a-description.md)                                        | 否     | **ms DS-Az-範圍** [**頂端**](c-top.md)<br/> |
...
| [**ms DS-Az-應用程式-資料**](a-msds-azapplicationdata.md)               | 否     | **ms DS-Az-範圍**                                 |
| [**ms-chap-Az-範圍名稱**](a-msds-azscopename.md)                           | 是      | **ms DS-Az-範圍**                                 |
...
| [**ms DS-Az-應用程式-資料**](a-msds-azapplicationdata.md)                  | 否     | **ms DS-Az-範圍**                                 |
| [**ms DS-Az-Generic-資料**](a-msds-azgenericdata.md)                          | 否     | **ms DS-Az-範圍**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                            | 否     | **ms DS-Az-範圍**                                 |
| [**ms-chap-Az-範圍名稱**](a-msds-azscopename.md)                              | 是      | **ms DS-Az-範圍**                                 |
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)         | 否     | [**返回頁首**](c-top.md)<br/>                    |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | 否     | [**返回頁首**](c-top.md)<br/>                    |
