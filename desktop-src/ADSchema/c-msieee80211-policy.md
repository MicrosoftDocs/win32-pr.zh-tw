...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: f254d0013f23faae6c9042b0768fe3b6584a33bdf5230ec8a9630115ea324f15
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118175752"
---
# <a name="ms-ieee-80211-policy-class"></a>ms-ieee-80211-原則類別
...
|-------------------|----------------------------------------------------------------------------------|
| CN                | ms-ieee-80211-原則                                                             |
| Ldap-顯示名稱 | msieee80211-原則                                                               |
| 更新許可權  | 網域系統管理員                                                             |
| 更新頻率  | 每次網域管理員變更網域或 OU 的無線網路原則時。 |
| 架構識別碼-Guid    | 7b9a2d92-b7eb-4382-9772-c3e0f9baaf94                                             |
...
| Object-Category             | 1                                                                                                                 |
| 預設-物件-類別     | \-                                                                                                                |
| Governs-Id                  | 1.2.840.113556.1.5.240                                                                                            |
| 預設值-隱藏-值        | 1                                                                                                                 |
...
| [**ms-ieee-80211-資料**](a-msieee80211-data.md)                            | 否     | **ms-ieee-80211-原則**        |
| [**ms-chap-ieee-80211-資料類型**](a-msieee80211-datatype.md)                   | 否     | **ms-ieee-80211-原則**        |
| [**ms-chap-ieee-80211-識別碼**](a-msieee80211-id.md)                                | 否     | **ms-ieee-80211-原則**        |
