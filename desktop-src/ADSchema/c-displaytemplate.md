...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: be4bfce249882c46cd0773a4a13b77fc15ab6d11ad90d3e2abac1d88b9212fbe
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119081242"
---
# <a name="display-template-class"></a>Display-Template 類別
...
|-------------------|--------------------------------------|
| CN                | Display-Template                     |
| Ldap-顯示名稱 | displayTemplate                      |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 5fd4250c-1262-11d0-a060-00aa006c33ed |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.3.59                                                                        |
| 預設值-隱藏-值        | 1                                                                                            |
...
| 屬性                                                                    | 強制性 | 衍生自                                         |
|------------------------------------------------------------------------------|-----------|------------------------------------------------------|
| [**位址-輸入-顯示資料表**](a-addressentrydisplaytable.md)            | 否     | **顯示範本**                                 |
| [**位址-輸入-顯示資料表-MSDOS.SYS**](a-addressentrydisplaytablemsdos.md) | 否     | **顯示範本**                                 |
...
| [**一般名稱**](a-cn.md)                                                  | 是      | **顯示範本** [ **Top**](c-top.md)<br/> |
...
| [**說明-Data16**](a-helpdata16.md)                                          | 否     | **顯示範本**                                 |
| [**說明-Data32**](a-helpdata32.md)                                          | 否     | **顯示範本**                                 |
| [**說明檔-檔案名**](a-helpfilename.md)                                     | 否     | **顯示範本**                                 |
...
| [**原始-顯示資料表**](a-originaldisplaytable.md)                     | 否     | **顯示範本**                                 |
| [**原始-顯示資料表-MSDOS.SYS**](a-originaldisplaytablemsdos.md)          | 否     | **顯示範本**                                 |
