...
ms.locfileid: "118015009"
---
# <a name="ms-ds-az-operation-id-attribute"></a>ms-DS-Az-Operation-ID 屬性

讓應用程式成為唯一作業的應用程式特定識別碼。
...
| Ldap-顯示名稱 | AzOperationID                      |
| 大小              | \-                                      |
| 更新許可權  | AzRoles 系統管理員                           |
| 更新頻率  | 在初始化或原則變更期間。 |
| Attribute-Id      | 1.2.840.113556.1.4.1800                 |
| 系統識別碼-Guid    | a5f3b553-5d76-4cbe-ba3f-4312152cab18    |
