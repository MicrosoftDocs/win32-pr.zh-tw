...
ms.locfileid: "119922558"
---
# <a name="ipsec-base-class"></a>Ipsec-Base 類別

從中衍生所有 IPSEC 類別的 IPSEC 基類。
...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | b40ff825-427a-11d1-a9c2-0000f80367c1 |
...
| Object-Category             | 2                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.7000.56                                                                   |
| 預設值-隱藏-值        | 1                                                                                            |
...
| [**Ipsec-資料**](a-ipsecdata.md)                                         | 否     | **Ipsec-基礎**                  |
| [**Ipsec-資料類型**](a-ipsecdatatype.md)                                | 否     | **Ipsec-基礎**                  |
| [**Ipsec 識別碼**](a-ipsecid.md)                                             | 否     | **Ipsec-基礎**                  |
| [**Ipsec-名稱**](a-ipsecname.md)                                         | 否     | **Ipsec-基礎**                  |
| [**Ipsec-擁有者-參考**](a-ipsecownersreference.md)                  | 否     | **Ipsec-基礎**                  |
