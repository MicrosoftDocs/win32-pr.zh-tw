...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 0a1d05967f42d86f7b98d4f308a339553c93c63ab2af7f19332314f4053d50e8
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119880268"
---
# <a name="ms-ds-az-task-class"></a>ms DS-Az-Task 類別
...
| 更新許可權  | AzRoles 系統管理員                           |
| 更新頻率  | 在初始化或原則變更期間。 |
| 架構識別碼-Guid    | 1ed3a473-9b1b-418a-bfa0-3a37b95a5306    |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.5.238                                                                                                           |
| 預設值-隱藏-值        | 1                                                                                                                                |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                                                           |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                  |
| 可能的 Superiors          | [**MS DS-az-應用程式**](c-msds-azapplication.md)-[**ds-az-範圍**](c-msds-azscope.md)[**容器**](c-container.md)     |
| 輔助類別           | \-                                                                                                                               |
...
| [**描述**](a-description.md)                                             | 否     | **ms DS-Az-** 工作 [**頂端**](c-top.md)<br/> |
...
| [**ms DS-Az-應用程式-資料**](a-msds-azapplicationdata.md)                    | 否     | **ms DS-Az-Task**                                 |
| [**ms-chap-Az-Biz-Rule**](a-msds-azbizrule.md)                                    | 否     | **ms DS-Az-Task**                                 |
| [**ms-chap-Az-Biz-Rule-Language**](a-msds-azbizrulelanguage.md)                   | 否     | **ms DS-Az-Task**                                 |
| [**ms-chap-Az-最後匯入-Biz-規則-路徑**](a-msds-azlastimportedbizrulepath.md) | 否     | **ms DS-Az-Task**                                 |
| [**ms-chap-Az-Task-角色定義**](a-msds-aztaskisroledefinition.md)        | 否     | **ms DS-Az-Task**                                 |
...
| [**ms DS-作業--Az-Task**](a-msds-operationsforaztask.md)               | 否     | **ms DS-Az-Task**                                 |
...
| [**ms DS-工作--Az-Task**](a-msds-tasksforaztask.md)                         | 否     | **ms DS-Az-Task**                                 |
...
| [**ms-chap-Az-Biz-Rule**](a-msds-azbizrule.md)                                    | 否     | **ms DS-Az-Task**                                 |
| [**ms-chap-Az-Biz-Rule-Language**](a-msds-azbizrulelanguage.md)                   | 否     | **ms DS-Az-Task**                                 |
| [**ms DS-Az-Generic-資料**](a-msds-azgenericdata.md)                            | 否     | **ms DS-Az-Task**                                 |
| [**ms-chap-Az-最後匯入-Biz-規則-路徑**](a-msds-azlastimportedbizrulepath.md) | 否     | **ms DS-Az-Task**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                              | 否     | **ms DS-Az-Task**                                 |
| [**ms-chap-Az-Task-角色定義**](a-msds-aztaskisroledefinition.md)        | 否     | **ms DS-Az-Task**                                 |
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)           | 否     | [**返回頁首**](c-top.md)<br/>                   |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                        | 否     | [**返回頁首**](c-top.md)<br/>                   |
