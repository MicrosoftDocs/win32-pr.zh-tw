...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: ade4a1b134ec4797546012233211fafdffe2fa40840511cc54c05f25afb75098
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118959567"
---
# <a name="rid-manager-class"></a>RID-Manager 類別

包含 rid 管理員所使用的 RID FSMO 和 RID 可用集區位置。 RID 管理員是在 DC 上執行的元件，負責配置安全識別碼。
...
|-------------------|-------------------------------------------|
| CN                | RID-Manager                               |
| Ldap-顯示名稱 | rIDManager                                |
| 更新許可權  | 此值是由系統所設定。          |
| 更新頻率  | 當 RID 集區配置變更時。 |
| 架構識別碼-Guid    | 6617188d-8f3c-11d0-afda-00c04fd930c9      |
...
| [**RID 可用-集區**](a-ridavailablepool.md)                          | 是      | **RID 管理員**                 |
...
| 輔助類別           | \-                                                                                                              |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                    |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPLCLORC;;;AU) S： (AU; SA;CRWP;;;WD)  |
| System-Flags                | 0x00000010                                                                                                      |
