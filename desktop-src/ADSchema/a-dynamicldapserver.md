...
ms.locfileid: "119656538"
---
# <a name="dynamic-ldap-server-attribute"></a>動態 LDAP-伺服器屬性

伺服器的 DNS 名稱，可處理此帳戶的動態屬性。
...
|-------------------|-----------------------------------------|
| CN                | 動態-LDAP-伺服器                     |
| Ldap-顯示名稱 | dynamicLDAPServer                       |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.537                  |
| 系統識別碼-Guid    | 52458021-ca6a-11d0-afff-0000f80367c1    |
