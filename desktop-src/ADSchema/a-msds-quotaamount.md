...
ms.locfileid: "118425750"
---
# <a name="ms-ds-quota-amount-attribute"></a>ms DS-配額-金額屬性

指派的配額，以資料庫中所擁有的物件數目為依據。
...
|-------------------|--------------------------------------|
| CN                | ms DS-配額-數量                   |
| Ldap-顯示名稱 | QuotaAmount                     |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.1845              |
| 系統識別碼-Guid    | fbb9a00d-3a8c-4233-9cf9-7189264903a1 |
