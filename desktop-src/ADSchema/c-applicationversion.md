...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 31026572e28575c5460e3eb99764f43a9907cb967153b8219233f62480e88065
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119021896"
---
# <a name="application-version-class"></a>Application-Version 類別

應用程式開發人員可以使用它來儲存有關其應用程式或其架構的版本資訊。
...
| Ldap-顯示名稱 | applicationVersion                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | ddc790ac-af4d-442a-8f0f-a1d4caa7dd92 |
...
| [**應用程式架構版本**](a-appschemaversion.md)                            | 否     | **應用程式版本**                                          |
...
| [**關鍵字**](a-keywords.md)                                              | 否     | **應用程式版本**                                          |
| [**最後一個已知-父系**](a-lastknownparent.md)                              | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**管理者**](a-managedby.md)                                           | 否     | **應用程式版本**                                          |
...
| [**廠商**](a-vendor.md)                                                  | 否     | **應用程式版本**                                          |
| [**版本號碼**](a-versionnumber.md)                                   | 否     | **應用程式版本**                                          |
| [**版本號碼-Hi**](a-versionnumberhi.md)                              | 否     | **應用程式版本**                                          |
| [**版本號碼-Lo**](a-versionnumberlo.md)                              | 否     | **應用程式版本**                                          |
