...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: ab0b72b3b51b755a9dfdada54c7c83e4ccabccc7912369aede78d673888f52e8
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119922448"
---
# <a name="ms-ds-claim-type-class"></a>ms DS-宣告類型類別

這個類別的實例會保存可在安全性主體上定義之宣告類型的定義。
...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 81a3857c-5469-4d8f-aae6-c27699762604 |
...
| 的子類別                 | [**ms-DS------Property-Base**](c-msds-claimtypepropertybase.md)<br/>            |
| 可能的 Superiors          | [**ms-DS-宣告類型**](c-msds-claimtypes.md)                                               |
| 輔助類別           | \-                                                                                           |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                 |
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;EA)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPLCLORC;;;AU)  |
...
| [**啟用**](a-enabled.md)                                                                 | 否     | [**ms-DS------Property-Base**](c-msds-claimtypepropertybase.md)<br/> |
...
| [**ms-DS-宣告-屬性-來源**](a-msds-claimattributesource.md)                          | 否     | **ms-DS-宣告類型**                                                              |
| [**ms-chap-----單一值**](a-msds-claimissinglevalued.md)                           | 否     | **ms-DS-宣告類型**                                                              |
| [**ms DS-----------------限制**](a-msds-claimisvaluespacerestricted.md)          | 否     | **ms-DS-宣告類型**                                                              |
| [**ms DS-宣告-可能值**](a-msds-claimpossiblevalues.md)                            | 否     | [**ms-DS------Property-Base**](c-msds-claimtypepropertybase.md)<br/> |
| [**ms DS--------可能值-**](a-msds-claimsharespossiblevalueswith.md)      | 否     | [**ms-DS------Property-Base**](c-msds-claimtypepropertybase.md)<br/> |
| [**ms-chap--------可能-值-BL**](a-msds-claimsharespossiblevalueswithbl.md) | 否     | [**返回頁首**](c-top.md)<br/>                                                   |
| [**ms-DS-宣告-來源**](a-msds-claimsource.md)                                             | 否     | **ms-DS-宣告類型**                                                              |
| [**ms-DS-宣告-來源類型**](a-msds-claimsourcetype.md)                                    | 否     | **ms-DS-宣告類型**                                                              |
| [**ms-DS-宣告類型-適用于類別**](a-msds-claimtypeappliestoclass.md)                  | 否     | **ms-DS-宣告類型**                                                              |
| [**ms-DS-宣告-數值型別**](a-msds-claimvaluetype.md)                                      | 否     | **ms-DS-宣告類型**                                                              |
