...
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 7f561289-5301-11d1-a9c5-0000f80367c1 |
...
| 屬性                                                                   | 強制性 | 衍生自                    |
|-----------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-Allocable-RSVP-頻寬**](a-acsallocablersvpbandwidth.md)         | 否     | **ACS-子網**                  |
| [**ACS-快取-超時**](a-acscachetimeout.md)                              | 否     | **ACS-子網**                  |
| [**ACS-DSBM-DeadTime**](a-acsdsbmdeadtime.md)                              | 否     | **ACS-子網**                  |
| [**ACS-DSBM-Priority**](a-acsdsbmpriority.md)                              | 否     | **ACS-子網**                  |
| [**ACS-DSBM-重新整理**](a-acsdsbmrefresh.md)                                | 否     | **ACS-子網**                  |
| [**ACS-啟用-ACS-服務**](a-acsenableacsservice.md)                     | 否     | **ACS-子網**                  |
...
| [**ACS-非保留-權杖-大小**](a-acsnonreservedtokensize.md)            | 否     | **ACS-子網**                  |
| [**ACS-非保留的 Tx-限制**](a-acsnonreservedtxlimit.md)                | 否     | **ACS-子網**                  |
| [**ACS-非保留-德克薩斯維大小**](a-acsnonreservedtxsize.md)                  | 否     | **ACS-子網**                  |
| [**ACS-RSVP-帳戶-檔案-位置**](a-acsrsvpaccountfileslocation.md)    | 否     | **ACS-子網**                  |
| [**ACS-RSVP-記錄檔-位置**](a-acsrsvplogfileslocation.md)            | 否     | **ACS-子網**                  |
| [**ACS-伺服器清單**](a-acsserverlist.md)                                  | 否     | **ACS-子網**                  |
