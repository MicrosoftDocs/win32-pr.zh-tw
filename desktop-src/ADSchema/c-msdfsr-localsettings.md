...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: be07fe2136991a51056aa23ef9690e111c75ecd479a67a6bcbc62915c9365537
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "120065358"
---
# <a name="ms-dfsr-localsettings-class"></a>ms-chap LocalSettings 類別

包含適用于本機電腦的分散式檔案系統 (DFS) Replication service 設定。
...
| Ldap-顯示名稱 | msDFSR-LocalSettings                 |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | fa85c591-197f-477e-83bd-ea5a43df2239 |
...
| [**ms-DFSR-擴充功能**](a-msdfsr-extension.md)                             | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DFSR-旗標**](a-msdfsr-flags.md)                                     | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                 | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DFSR-版本**](a-msdfsr-version.md)                                 | 否     | **ms-DFSR-LocalSettings**       |
...
| [**PartitionSetLink**](a-mscom-partitionsetlink.md)                               | 否     | [**返回頁首**](c-top.md)<br/> |
| [**UserLink**](a-mscom-userlink.md)                                               | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-CommonStagingPath**](a-msdfsr-commonstagingpath.md)                           | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DFSR-CommonStagingSizeInMb**](a-msdfsr-commonstagingsizeinmb.md)                   | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DFSR-ComputerReferenceBL**](a-msdfsr-computerreferencebl.md)                       | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-擴充功能**](a-msdfsr-extension.md)                                           | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DFSR-旗標**](a-msdfsr-flags.md)                                                   | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                           | 否     | [**返回頁首**](c-top.md)<br/> |
| [**ms-DFSR-選項**](a-msdfsr-options.md)                                               | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DFSR-Options2**](a-msdfsr-options2.md)                                             | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DFSR-StagingCleanupTriggerInPercent**](a-msdfsr-stagingcleanuptriggerinpercent.md) | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DFSR-版本**](a-msdfsr-version.md)                                               | 否     | **ms-DFSR-LocalSettings**       |
| [**ms-DS-Immed-從屬**](a-msds-approx-immed-subordinates.md)               | 否     | [**返回頁首**](c-top.md)<br/> |
...
**MS DFSR LocalSettings** 類別是 DFS 複寫服務支援的一部分。
