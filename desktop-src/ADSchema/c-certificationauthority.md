...
ms.locfileid: "119701958"
---
# <a name="certification-authority-class"></a>Certification-Authority 類別

代表發出公開金鑰憑證的進程，例如憑證伺服器。
...
| Ldap-顯示名稱 | certificationAuthority               |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 3fdfee50-47f4-11d1-a9c3-0000f80367c1 |
...
| [**授權單位-撤銷清單**](a-authorityrevocationlist.md)            | 是      | **憑證授權單位單位**                                 |
| [**橋頭-伺服器-清單-BL**](a-bridgeheadserverlistbl.md)             | 否     | [**返回頁首**](c-top.md)<br/>                             |
| [**CA-憑證**](a-cacertificate.md)                                 | 是      | **憑證授權單位單位**                                 |
| [**CA-憑證-DN**](a-cacertificatedn.md)                            | 否     | **憑證授權單位單位**                                 |
| [**CA-連線**](a-caconnect.md)                                         | 否     | **憑證授權單位單位**                                 |
| [**標準名稱**](a-canonicalname.md)                                 | 否     | [**返回頁首**](c-top.md)<br/>                             |
| [**CA-使用方式**](a-causages.md)                                           | 否     | **憑證授權單位單位**                                 |
| [**CA-WEB-URL**](a-caweburl.md)                                          | 否     | **憑證授權單位單位**                                 |
| [**憑證-撤銷清單**](a-certificaterevocationlist.md)        | 是      | **憑證授權單位單位**                                 |
| [**憑證範本**](a-certificatetemplates.md)                   | 否     | **憑證授權單位單位**                                 |
| [**一般名稱**](a-cn.md)                                               | 是      | **憑證授權單位** 單位 [**排名**](c-top.md)<br/> |
| [**建立時間戳記**](a-createtimestamp.md)                            | 否     | [**返回頁首**](c-top.md)<br/>                             |
| [**CRL-物件**](a-crlobject.md)                                         | 否     | **憑證授權單位單位**                                 |
| [**跨憑證配對**](a-crosscertificatepair.md)                  | 否     | **憑證授權單位單位**                                 |
| [**Current-父系-CA**](a-currentparentca.md)                            | 否     | **憑證授權單位單位**                                 |
| [**差異-撤銷清單**](a-deltarevocationlist.md)                    | 否     | **憑證授權單位單位**                                 |
...
| [**DNS-主機名稱**](a-dnshostname.md)                                    | 否     | **憑證授權單位單位**                                 |
| [**網域識別碼**](a-domainid.md)                                           | 否     | **憑證授權單位單位**                                 |
| [**網域原則-物件**](a-domainpolicyobject.md)                      | 否     | **憑證授權單位單位**                                 |
| [**DSA-簽章**](a-dsasignature.md)                                   | 否     | [**返回頁首**](c-top.md)<br/>                             |
| [**DS-核心-傳播-資料**](a-dscorepropagationdata.md)               | 否     | [**返回頁首**](c-top.md)<br/>                             |
| [**註冊-提供者**](a-enrollmentproviders.md)                     | 否     | **憑證授權單位單位**                                 |
...
| [**父系-CA**](a-parentca.md)                                           | 否     | **憑證授權單位單位**                                 |
| [**上層 CA-憑證鏈**](a-parentcacertificatechain.md)         | 否     | **憑證授權單位單位**                                 |
| [**部分屬性-刪除-清單**](a-partialattributedeletionlist.md) | 否     | [**返回頁首**](c-top.md)<br/>                             |
| [**部分屬性集**](a-partialattributeset.md)                    | 否     | [**返回頁首**](c-top.md)<br/>                             |
| [**擱置-CA-憑證**](a-pendingcacertificates.md)                | 否     | **憑證授權單位單位**                                 |
| [**暫止-父系-CA**](a-pendingparentca.md)                            | 否     | **憑證授權單位單位**                                 |
| [**可能-Inferiors**](a-possibleinferiors.md)                         | 否     | [**返回頁首**](c-top.md)<br/>                             |
| [**上一個 CA-憑證**](a-previouscacertificates.md)              | 否     | **憑證授權單位單位**                                 |
| [**上一個-父系-CA**](a-previousparentca.md)                          | 否     | **憑證授權單位單位**                                 |
...
| [**支援-應用程式內容**](a-supportedapplicationcontext.md)    | 否     | **憑證授權單位單位**                                 |
| [**系統旗標**](a-systemflags.md)                                     | 否     | [**返回頁首**](c-top.md)<br/>                             |
| [**Teletex-終端機-識別碼**](a-teletexterminalidentifier.md)        | 否     | **憑證授權單位單位**                                 |
