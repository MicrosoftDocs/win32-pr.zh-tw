...
|-------------------|---------------------------------------------------------------|
| CN                | ms DS-日期時間                                               |
| Ldap-顯示名稱 | get-help-DateTime                                                 |
| 大小              | \-                                                            |
| 更新許可權  | \-                                                            |
| 更新頻率  | \-                                                            |
| Attribute-Id      | 1.2.840.113556.1.4.1832                                       |
| 系統識別碼-Guid    | 234fcbd8-fb52-4908-a328-fd9f6e58e403                          |
...
| 中使用的類別        | [**ms DS-應用程式-設定**](c-msds-app-configuration.md)<br/> [**ms DS-應用程式-資料**](c-msds-appdata.md)<br/> |
