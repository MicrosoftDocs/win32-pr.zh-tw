...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: e9f0ed4bb8c5b6e1012649f5dca66f33fe7972c872dcb17483ee603fdeb35f09
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118422209"
---
# <a name="ms-wmi-policytype-class"></a>PolicyType 類別
...
|-------------------|--------------------------------------|
| CN                | PolicyType                    |
| Ldap-顯示名稱 | msWMI-PolicyType                     |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 595b2613-4109-4e77-9013-a3bb4ef277c7 |
...
| Object-Category             | 1                                                                                                    |
| 預設-物件-類別     | \-                                                                                                   |
| Governs-Id                  | 1.2.840.113556.1.5.211                                                                               |
| 預設值-隱藏-值        | 1                                                                                                    |
...
| [**ms-WMI-作者**](a-mswmi-author.md)                                     | 否     | **PolicyType**           |
| [**ChangeDate**](a-mswmi-changedate.md)                             | 否     | **PolicyType**           |
| [**CreationDate**](a-mswmi-creationdate.md)                         | 否     | **PolicyType**           |
| [**ms-WMI-識別碼**](a-mswmi-id.md)                                             | 是      | **PolicyType**           |
| [**intFlags1**](a-mswmi-intflags1.md)                               | 否     | **PolicyType**           |
| [**intFlags2**](a-mswmi-intflags2.md)                               | 否     | **PolicyType**           |
| [**intFlags3**](a-mswmi-intflags3.md)                               | 否     | **PolicyType**           |
| [**intFlags4**](a-mswmi-intflags4.md)                               | 否     | **PolicyType**           |
| [**Parm1**](a-mswmi-parm1.md)                                       | 否     | **PolicyType**           |
| [**Parm2**](a-mswmi-parm2.md)                                       | 否     | **PolicyType**           |
| [**Parm3**](a-mswmi-parm3.md)                                       | 否     | **PolicyType**           |
| [**Parm4**](a-mswmi-parm4.md)                                       | 否     | **PolicyType**           |
| [**SourceOrganization**](a-mswmi-sourceorganization.md)             | 否     | **PolicyType**           |
| [**TargetObject**](a-mswmi-targetobject.md)                         | 是      | **PolicyType**           |
