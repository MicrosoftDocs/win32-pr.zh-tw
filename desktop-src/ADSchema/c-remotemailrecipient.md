...
ms.locfileid: "119752778"
---
# <a name="remote-mail-recipient-class"></a>遠端-郵件收件者類別
...
|-------------------|--------------------------------------|
| CN                | 遠端郵件-收件者                |
| Ldap-顯示名稱 | remoteMailRecipient                  |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | bf967aa9-0de6-11d0-a285-00aa003049e2 |
...
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)  (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPLCLORC;;;AU)  (OA;;CR; ab721a55-1e2f-11d0-9819-00aa0040529b;;AU)  |
...
| [**遠端來源**](a-remotesource.md)                                   | 否     | **遠端郵件-收件者**                                                            |
| [**遠端來源類型**](a-remotesourcetype.md)                          | 否     | **遠端郵件-收件者**                                                            |
