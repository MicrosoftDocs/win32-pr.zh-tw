...
---
# <a name="ms-ds-operations-for-az-role-bl-attribute"></a>BL 屬性（DS）----------

從 Az-Operation 到連結的 Az-Role 物件的反向連結。
...
|-------------------|-----------------------------------------|
| CN                | BL-------------------         |
| Ldap-顯示名稱 | OperationsForAzRoleBL              |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | 此值是由系統所設定。        |
| Attribute-Id      | 1.2.840.113556.1.4.1813                 |
| 系統識別碼-Guid    | f85b6228-3734-4525-b6b7-3f3bb220902c    |
