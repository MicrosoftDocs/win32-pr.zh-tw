...
---
# <a name="ms-ds-az-operation-class"></a>ms DS-Az-Operation 類別
...
| 進入 | 值 |
|-------------------|-----------------------------------------|
| CN                | ms-chap-Az-Operation                      |
| Ldap-顯示名稱 | AzOperation                        |
| 更新許可權  | AzRoles 系統管理員                           |
| 更新頻率  | 在初始化或原則變更期間。 |
| 架構識別碼-Guid    | 860abe37-9a9b-4fa4-b3d2-b8ace5df9ec5    |
...
| Object-Category             | 1                                                                                                                                |
| 預設-物件-類別     | \-                                                                                                                               |
| Governs-Id                  | 1.2.840.113556.1.5.236                                                                                                           |
| 預設值-隱藏-值        | 1                                                                                                                                |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                                                           |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                  |
| 可能的 Superiors          | [**ms DS-Az-應用程式**](c-msds-azapplication.md)[**容器**](c-container.md)                                             |
| 輔助類別           | \-                                                                                                                               |
...
| [**描述**](a-description.md)                                        | 否     | **ms-DS-Az-Operation** [ **Top**](c-top.md)<br/> |
...
| [**ms DS-Az-應用程式-資料**](a-msds-azapplicationdata.md)               | 否     | **ms-chap-Az-Operation**                                 |
| [**ms-DS-Az-Operation-ID**](a-msds-azoperationid.md)                       | 對      | **ms-chap-Az-Operation**                                 |
...
| [**ms DS-Az-應用程式-資料**](a-msds-azapplicationdata.md)                  | 否     | **ms-chap-Az-Operation**                                 |
| [**ms DS-Az-Generic-資料**](a-msds-azgenericdata.md)                          | 否     | **ms-chap-Az-Operation**                                 |
| [**ms-DS-Az-Object-Guid**](a-msds-azobjectguid.md)                            | 否     | **ms-chap-Az-Operation**                                 |
| [**ms-DS-Az-Operation-ID**](a-msds-azoperationid.md)                          | 對      | **ms-chap-Az-Operation**                                 |
| [**MS DS-一致性-子計數**](a-ms-ds-consistencychildcount.md)         | 否     | [**返回頁首**](c-top.md)<br/>                        |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | 否     | [**返回頁首**](c-top.md)<br/>                        |
