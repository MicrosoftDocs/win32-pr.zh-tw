...
ms.locfileid: "118961547"
---
# <a name="enabled-attribute"></a>Enabled 屬性

這個屬性是用來表示是否已啟用指定的交叉引用。
...
| 系統識別碼-Guid    | a8df73f2-c5ea-11d1-bbcb-0080c76670c0 |
...
| Search-Flags           | 0x00000000                                                                                                                                                          |
| System-Flags           | 0x00000010                                                                                                                                                          |
| 中使用的類別        | [**交叉參考**](c-crossref.md)<br/> [**ms-DS-服務-連接點-發行集-服務**](c-msds-serviceconnectionpointpublicationservice.md)<br/> |
