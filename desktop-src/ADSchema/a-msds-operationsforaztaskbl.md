...
ms.locfileid: "118683428"
---
# <a name="ms-ds-operations-for-az-task-bl-attribute"></a>ms-chap----------BL 屬性

從 Az-Operation 到連結的 Az-Task 物件的反向連結。
...
|-------------------|-----------------------------------------|
| CN                | BL-------------工作-         |
| Ldap-顯示名稱 | OperationsForAzTaskBL              |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | 此值是由系統所設定。        |
| Attribute-Id      | 1.2.840.113556.1.4.1809                 |
| 系統識別碼-Guid    | a637d211-5739-4ed1-89b2-88974548bc59    |
