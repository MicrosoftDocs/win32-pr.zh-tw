...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: adfd272d1f5056cb5c62e87a19c5012a1dc9e55af09aaaaa1987f897f3c329a5
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118175644"
---
# <a name="ms-kds-prov-serverconfiguration-class"></a>Kds 根金鑰->prov-ServerConfiguration 類別
...
| 進入 | 值 |
|-------------------|--------------------------------------|
| CN                | Kds 根金鑰->prov-ServerConfiguration      |
| Ldap-顯示名稱 | msKds-ProvServerConfiguration        |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 5ef243a8-2a25-45a6-8b73-08a71ae677ce |
...
| Object-Category             | 1                                                                                                              |
| 預設-物件-類別     | \-                                                                                                             |
| Governs-Id                  | 1.2.840.113556.1.5.277                                                                                         |
| 預設值-隱藏-值        | 1                                                                                                              |
...
| 預設安全描述項 | D： (;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;EA)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)  (A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;D)  |
...
| [**Kds 根金鑰-KDF-AlgorithmID**](a-mskds-kdfalgorithmid.md)                                     | 否     | **Kds 根金鑰->prov-ServerConfiguration** |
| [**Kds 根金鑰-KDF-Param**](a-mskds-kdfparam.md)                                                 | 否     | **Kds 根金鑰->prov-ServerConfiguration** |
| [**Kds 根金鑰-PrivateKey-Length**](a-mskds-privatekeylength.md)                                 | 否     | **Kds 根金鑰->prov-ServerConfiguration** |
| [**Kds 根金鑰-PublicKey-Length**](a-mskds-publickeylength.md)                                   | 否     | **Kds 根金鑰->prov-ServerConfiguration** |
| [**Kds 根金鑰-SecretAgreement-AlgorithmID**](a-mskds-secretagreementalgorithmid.md)             | 否     | **Kds 根金鑰->prov-ServerConfiguration** |
| [**Kds 根金鑰-SecretAgreement-Param**](a-mskds-secretagreementparam.md)                         | 否     | **Kds 根金鑰->prov-ServerConfiguration** |
| [**Kds 根金鑰-版本**](a-mskds-version.md)                                                    | 是      | **Kds 根金鑰->prov-ServerConfiguration** |
