...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 8e85c6331180eb1abfe68d75af0a6753646557c4567bcf6367b70509ccd42bc6
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119880598"
---
# <a name="ms-ds-app-configuration-class"></a>ms DS-應用程式-設定類別

用來儲存應用程式的設定資訊。 應該使用 [**ms DS 設定**](a-msds-settings.md)屬性來儲存實際值。
...
| 更新頻率  | \-                                             |
| 架構識別碼-Guid    | 90df3c3e-1854-4455-a5d7-cad40d56657a           |
...
| Object-Category             | 1                                                                                                                 |
| 預設-物件-類別     | \-                                                                                                                |
| Governs-Id                  | 1.2.840.113556.1.5.220                                                                                            |
| 預設值-隱藏-值        | 1                                                                                                                 |
...
| [**關鍵字**](a-keywords.md)                                              | 否     | **ms DS-應用程式-設定**                                      |
| [**最後一個已知-父系**](a-lastknownparent.md)                              | 否     | [**返回頁首**](c-top.md)<br/>                                  |
| [**管理者**](a-managedby.md)                                           | 否     | **ms DS-應用程式-設定**                                      |
...
| [**ms-DS-位元組陣列**](a-msds-bytearray.md)                                | 否     | **ms DS-應用程式-設定**                                      |
...
| [**ms DS-日期時間**](a-msds-datetime.md)                                  | 否     | **ms DS-應用程式-設定**                                      |
| [**ms DS-整數**](a-msds-integer.md)                                     | 否     | **ms DS-應用程式-設定**                                      |
...
| [**ms-DS-物件參考**](a-msds-objectreference.md)                    | 否     | **ms DS-應用程式-設定**                                      |
...
| [**擁有者**](a-owner.md)                                                    | 否     | **ms DS-應用程式-設定**                                      |
