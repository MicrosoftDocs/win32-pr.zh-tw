...
---
# <a name="ms-ts-broken-connection-action-attribute"></a>ms-TS-連接-動作屬性

終端機服務會話中斷連接動作指定達到終端機服務會話限制時要採取的動作。
...
| Ldap-顯示名稱 | msTSBrokenConnectionAction           |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.1985              |
| 系統識別碼-Guid    | 1cf41bba-5604-463e-94d6-1a1287b72ca3 |
