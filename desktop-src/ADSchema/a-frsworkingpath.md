...
---
# <a name="frs-working-path-attribute"></a>FRS-工作路徑屬性
...
|-------------------|---------------------------------------------|
| CN                | FRS-工作路徑                            |
| Ldap-顯示名稱 | fRSWorkingPath                              |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.486                      |
| 系統識別碼-Guid    | 1be8f173-a9ff-11d0-afe2-00c04fd930c9        |
...
| 中使用的類別        | [**NTFRS-訂閱**](c-ntfrssubscriptions.md)<br/> |
