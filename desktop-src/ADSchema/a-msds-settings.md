...
| 系統識別碼-Guid    | 0e1b47d7-40a3-4b48-8d1b-4cac0c1cdf21        |
...
| 中使用的類別        | [**應用程式-設定**](c-applicationsettings.md)<br/> [**連接點**](c-connectionpoint.md)<br/> |
...
| Search-Flags           | 0x00000000                                                       |
| System-Flags           | 0x00000000                                                       |
| 中使用的類別        | [**應用程式-設定**](c-applicationsettings.md)<br/> |
