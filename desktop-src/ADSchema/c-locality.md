...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 29dba1efc9e9460e7764589467c966c768fb2d8f8194aedf665a82ad0c7f8fb5
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119834918"
---
# <a name="locality-class"></a>位置類別
...
| CN                | 位置                                                                 |
| Ldap-顯示名稱 | 地區                                                                 |
| 更新許可權  | 此值是由網域系統管理員或帳戶擁有者所設定。          |
| 更新頻率  | 建立使用者記錄時，以及每次需要變更位置時。 |
| 架構識別碼-Guid    | bf967aa0-0de6-11d0-a285-00aa003049e2                                     |
...
| Governs-Id                  | 2.5.6.3                                                                                                                           |
| 預設值-隱藏-值        | 0                                                                                                                                 |
| Rdn-Att-Id                  | [**位置名稱**](a-l.md)<br/>                                                                                           |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                   |
| 可能的 Superiors          | **位置**[**組織**](c-organization.md)[**組織-單位**](c-organizationalunit.md)[**國家/地區**](c-country.md) |
| 輔助類別           | \-                                                                                                                                |
...
| [**搜尋指南**](a-searchguide.md)                                     | 否     | **位置**                    |
| [**請參閱-也**](a-seealso.md)                                             | 否     | **位置**                    |
...
| Rdn-Att-Id                  | [**位置名稱**](a-l.md)<br/>                                                                                                                            |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                                                                                                    |
| 可能的 Superiors          | **位置**[**組織**](c-organization.md)[**組織-單位**](c-organizationalunit.md)[**國家**](c-country.md)[**網域-DNS**](c-domaindns.md) |
| 輔助類別           | \-                                                                                                                                                                 |
| NT-Security-描述元      | O:BAG：不正確： S：                                                                                                                                                       |
| 預設安全描述項 | D:(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;DA)(A;;RPWPCRCCDCLCLORCWOWDSDDTSW;;;SY)(A;;RPLCLORC;;;AU)                                                                       |
| System-Flags                | 0x00000010                                                                                                                                                         |
