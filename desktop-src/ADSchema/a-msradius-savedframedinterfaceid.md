...
ms.locfileid: "119081592"
---
# <a name="ms-radius-savedframedinterfaceid-attribute"></a>ms-chap-SavedFramedInterfaceId 屬性

指出要為使用者設定的 IPv6 介面識別碼。
...
| Ldap-顯示名稱 | msRADIUS-SavedFramedInterfaceId      |
| 大小              | \-                                   |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| Attribute-Id      | 1.2.840.113556.1.4.1914              |
| 系統識別碼-Guid    | a4da7289-92a3-42e5-b6b6-dad16d280ac9 |
