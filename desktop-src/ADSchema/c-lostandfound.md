...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 528892aef2aaa18b0f2badcd744448203539d531935a9832b6e8e17d2bc3a3d2
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119324108"
---
# <a name="lost-and-found-class"></a>遺失和找到的類別
...
|-------------------|-----------------------------------------------------------|
| CN                | 遺失並找出                                            |
| Ldap-顯示名稱 | lostAndFound                                              |
| 更新許可權  | 此容器是由系統所管理。                  |
| 更新頻率  | 每次無法協調物件的位置時。 |
| 架構識別碼-Guid    | 52ab8671-5709-11d1-a9c6-0000f80367c1                      |
...
| Object-Category             | 1                                                                                             |
| 預設-物件-類別     | \-                                                                                            |
| Governs-Id                  | 1.2.840.113556.1.5.139                                                                        |
| 預設值-隱藏-值        | 1                                                                                             |
| Rdn-Att-Id                  | [**一般名稱**](a-cn.md)<br/>                                                        |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                               |
| 可能的 Superiors          | [**DMD**](c-dmd.md)[**網域 DNS**](c-domaindns.md)[](c-configuration.md)設定 |
| 輔助類別           | \-                                                                                            |
...
| [**移動樹狀結構狀態**](a-movetreestate.md)                                | 否     | **遺失並找出**              |
