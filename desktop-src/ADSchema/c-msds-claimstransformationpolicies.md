...
---
# <a name="ms-ds-claims-transformation-policies-class"></a>ms-DS-宣告-轉換-原則類別
...
|-------------------|--------------------------------------|
| CN                | ms-DS-宣告-轉換-原則 |
| Ldap-顯示名稱 | ClaimsTransformationPolicies    |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | c8fca9b1-7d88-bb4f-827a-448927710762 |
