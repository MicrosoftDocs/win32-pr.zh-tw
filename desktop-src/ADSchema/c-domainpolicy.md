...
---
# <a name="domain-policy-class"></a>Domain-Policy 類別
...
|-------------------|--------------------------------------|
| CN                | Domain-Policy                        |
| Ldap-顯示名稱 | domainPolicy                         |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | bf967a99-0de6-11d0-a285-00aa003049e2 |
...
| 可能的 Superiors          | [**容器**](c-container.md)[**網域-DNS**](c-domaindns.md)[**組織單位**](c-organizationalunit.md) |
| 輔助類別           | \-                                                                                                                   |
...
| [**驗證-選項**](a-authenticationoptions.md)                 | 否     | **網域原則**               |
...
| [**預設-本機-原則-物件**](a-defaultlocalpolicyobject.md)         | 否     | **網域原則**               |
...
| [**Ipsec-原則-參考**](a-ipsecpolicyreference.md)                  | 否     | **網域原則**               |
...
| [**鎖定-持續時間**](a-lockoutduration.md)                             | 否     | **網域原則**               |
| [**鎖定-觀察-視窗**](a-lockoutobservationwindow.md)         | 否     | **網域原則**               |
| [**鎖定-閾值**](a-lockoutthreshold.md)                           | 否     | **網域原則**               |
| [**管理者**](a-managedby.md)                                         | 否     | **網域原則**               |
| [**Managed 物件**](a-managedobjects.md)                               | 否     | [**返回頁首**](c-top.md)<br/> |
| [**主要**](a-masteredby.md)                                       | 否     | [**返回頁首**](c-top.md)<br/> |
| [**最大-Pwd-使用期限**](a-maxpwdage.md)                                        | 否     | **網域原則**               |
| [**最大續約-期限**](a-maxrenewage.md)                                    | 否     | **網域原則**               |
| [**最大票證-存留期**](a-maxticketage.md)                                  | 否     | **網域原則**               |
| [**最小-Pwd-使用期限**](a-minpwdage.md)                                        | 否     | **網域原則**               |
| [**最小-Pwd-長度**](a-minpwdlength.md)                                  | 否     | **網域原則**               |
| [**最小票證-年齡**](a-minticketage.md)                                  | 否     | **網域原則**               |
...
| [**Proxy-存留期**](a-proxylifetime.md)                                 | 否     | **網域原則**               |
| [**公開金鑰-原則**](a-publickeypolicy.md)                            | 否     | **網域原則**               |
| [**Pwd-歷程記錄-長度**](a-pwdhistorylength.md)                          | 否     | **網域原則**               |
| [**Pwd-屬性**](a-pwdproperties.md)                                 | 否     | **網域原則**               |
| [**服務品質**](a-qualityofservice.md)                          | 否     | **網域原則**               |
