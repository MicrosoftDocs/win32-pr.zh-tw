...
[**MS DS-AuthenticatedAt-DC**](a-msds-authenticatedatdc.md)的反向連結。 識別哪些使用者已向這部電腦驗證。
...
| Ldap-顯示名稱 | msDS-AuthenticatedToAccountlist         |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.1957                 |
| 系統識別碼-Guid    | e8b2c971-a6df-47bc-8d6f-62770d527aa5    |
