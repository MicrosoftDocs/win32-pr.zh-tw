...
ms.locfileid: "119703078"
---
# <a name="notification-list-attribute"></a>Notification-List 屬性
...
| Ldap-顯示名稱 | notificationList                        |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.303                  |
| 系統識別碼-Guid    | 19195a56-6da0-11d0-afd3-00c04fd930c9    |
...
| 中使用的類別        | [**應用程式-設定**](c-applicationsettings.md)<br/> [**應用程式-網站-設定**](c-applicationsitesettings.md)<br/> [**網站**](c-site.md)<br/> |
