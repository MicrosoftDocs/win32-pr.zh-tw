...
ms.locfileid: "118959957"
---
# <a name="sync-with-object-attribute"></a>Sync With-Object 屬性

針對 SAM 內建群組/本機原則同步處理進行同步處理之物件的辨別名稱。
...
|-------------------|-----------------------------------------|
| CN                | Sync-With-Object                        |
| Ldap-顯示名稱 | syncWithObject                          |
| 大小              | \-                                      |
| 更新許可權  | \-                                      |
| 更新頻率  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.664                  |
| 系統識別碼-Guid    | 037651e2-441d-11d1-a9c3-0000f80367c1    |
