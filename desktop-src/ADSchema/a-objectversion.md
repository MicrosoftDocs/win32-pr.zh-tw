...
ms.locfileid: "119704548"
---
# <a name="object-version-attribute"></a>Object-Version 屬性
...
|-------------------|----------------------------------------------------------------|
| CN                | Object-Version                                                 |
| Ldap-顯示名稱 | objectVersion                                                  |
| 大小              | 4 個位元組                                                        |
| 更新許可權  | 物件的設計工具會設定此值。               |
| 更新頻率  | 每次物件變更時，這個值就會遞增。 |
| Attribute-Id      | 1.2.840.113556.1.2.76                                          |
| 系統識別碼-Guid    | 16775848-47f3-11d1-a9c3-0000f80367c1                           |
