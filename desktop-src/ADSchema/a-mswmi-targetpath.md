...
---
# <a name="ms-wmi-targetpath-attribute"></a>TargetPath 屬性

用來唯一識別 WMI 物件的索引鍵/值組清單。
...
|-------------------|---------------------------------------------|
| CN                | TargetPath                           |
| Ldap-顯示名稱 | msWMI-TargetPath                            |
| 大小              | 少於100個字元。                   |
| 更新許可權  | 群組原則系統管理員                  |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.1648                     |
| 系統識別碼-Guid    | 5006a79a-6bfe-4561-9f52-13cf4dd3e560        |
...
| 中使用的類別        | [**PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
