...
ms.locfileid: "119801778"
---
# <a name="ms-authz-central-access-rules-class"></a>ms-Authz-存取-規則類別

此類別的容器可以包含集中存取原則專案物件。
...
|-------------------|--------------------------------------|
| CN                | ms-Authz-集中存取-規則        |
| Ldap-顯示名稱 | msAuthz-CentralAccessRules           |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 99bb1b7a-606d-4f8b-800e-e15be554ca8d |
