...
---
# <a name="ms-net-ieee-80211-grouppolicy-class"></a>ms-chap-ieee-80211-GroupPolicy 類別

這個類別代表 802.11 無線網路群組原則物件。 這個類別包含 802.11 無線網路的相關識別碼及組態資料。
...
| Ldap-顯示名稱 | ms-net-ieee-80211-GroupPolicy        |
| 更新許可權  | \-                                   |
| 更新頻率  | \-                                   |
| 架構識別碼-Guid    | 1cb81863-b822-4379-9ea2-5ff7bdc6386d |
...
| [**ms-net-ieee-80211-GP-PolicyData**](a-ms-net-ieee-80211-gp-policydata.md)         | 否     | **ms-net-ieee-80211-GroupPolicy** |
| [**ms-net-ieee-80211-GP-PolicyGUID**](a-ms-net-ieee-80211-gp-policyguid.md)         | 否     | **ms-net-ieee-80211-GroupPolicy** |
| [**ms-net-ieee-80211-GP-PolicyReserved**](a-ms-net-ieee-80211-gp-policyreserved.md) | 否     | **ms-net-ieee-80211-GroupPolicy** |
