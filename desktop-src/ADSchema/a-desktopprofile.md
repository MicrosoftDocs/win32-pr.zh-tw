...
|-------------------|---------------------------------------------|
| CN                | Desktop-Profile                             |
| Ldap-顯示名稱 | desktopProfile                              |
| 大小              | \-                                          |
| 更新許可權  | \-                                          |
| 更新頻率  | \-                                          |
| Attribute-Id      | 1.2.840.113556.1.4.346                      |
| 系統識別碼-Guid    | eea65906-8ac6-11d0-afda-00c04fd930c9        |
...
| Search-Flags           | 0x00000000                                                                                         |
| System-Flags           | 0x00000010                                                                                         |
| 中使用的類別        | [**Group**](c-group.md)<br/> [**組織單位**](c-organizationalunit.md)<br/> |
