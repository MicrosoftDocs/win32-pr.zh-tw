...
---
# <a name="logon-workstation-attribute"></a>Logon-Workstation 屬性

未使用此屬性。 請參閱 [**使用者工作站**](a-userworkstations.md) 屬性。
...
| Ldap-顯示名稱 | logonWorkstation                                      |
| 大小              | \-                                                    |
| 更新許可權  | \-                                                    |
| 更新頻率  | \-                                                    |
| Attribute-Id      | 1.2.840.113556.1.4.65                                 |
| 系統識別碼-Guid    | bf9679ac-0de6-11d0-a285-00aa003049e2                  |
