...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: b0f17bc919f4bc493833778776a531fb4c54e7dd252c19c5a51a474cf15aecd4
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119879408"
---
# <a name="ms-tapi-rt-conference-class"></a>ms-TAPI-Rt-會議類別
...
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CN                | ms-TAPI-Rt-會議                                                                                                                                                                                    |
| Ldap-顯示名稱 | msTAPI-RtConference                                                                                                                                                                                      |
| 更新許可權  | 不需要任何特殊許可權。                                                                                                                                                                          |
| 更新頻率  | 每次需要發佈 TAPI 會議時，建立頻率會依使用者的決定而定。 一旦建立，TAPI 會議物件的一般存留期可以是30分鐘到1年的範圍。 |
| 架構識別碼-Guid    | ca7b9735-4b2a-4e49-89c3-99025334dc94                                                                                                                                                                     |
...
| Object-Category             | 1                                                                                            |
| 預設-物件-類別     | \-                                                                                           |
| Governs-Id                  | 1.2.840.113556.1.5.221                                                                       |
| 預設值-隱藏-值        | 1                                                                                            |
| Rdn-Att-Id                  | [**ms-TAPI-唯一識別碼**](a-mstapi-uid.md)<br/>                                 |
| 的子類別                 | [**返回頁首**](c-top.md)<br/>                                                              |
| 可能的 Superiors          | [**組織單位**](c-organizationalunit.md)                                          |
| 輔助類別           | \-                                                                                           |
...
| [**ms-TAPI-會議-Blob**](a-mstapi-conferenceblob.md)                  | 否     | **ms-TAPI-Rt-會議**       |
| [**ms-chap-通訊協定-識別碼**](a-mstapi-protocolid.md)                          | 否     | **ms-TAPI-Rt-會議**       |
| [**ms-TAPI-唯一識別碼**](a-mstapi-uid.md)                           | 是      | **ms-TAPI-Rt-會議**       |
