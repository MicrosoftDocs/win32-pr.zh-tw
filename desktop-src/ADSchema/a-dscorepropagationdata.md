...
ms.locfileid: "119706198"
---
# <a name="ds-core-propagation-data-attribute"></a>DS-核心-傳播-資料屬性

**DS-核心-傳播-資料** 屬性僅供內部使用。
...
|-------------------|---------------------------------------------------------------|
| CN                | DS-核心-傳播-資料                                      |
| Ldap-顯示名稱 | dSCorePropagationData                                         |
| 大小              | \-                                                            |
| 更新許可權  | \-                                                            |
| 更新頻率  | \-                                                            |
| Attribute-Id      | 1.2.840.113556.1.4.1357                                       |
| 系統識別碼-Guid    | d167aa4b-8b08-11d2-9939-0000f87a57d4                          |
