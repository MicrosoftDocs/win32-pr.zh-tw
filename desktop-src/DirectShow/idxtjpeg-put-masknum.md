...
ms.locfileid: "119584608"
---
# <a name="idxtjpegput_masknum-method"></a>IDxtJpeg：:p 的 \_ MaskNum 方法
...
方法會指定抹除的 `put_MaskNum` SMPTE 清除程式碼。
...
指定 SMPTE 清除程式碼。 如需支援的 SMPTE 清除清單，請參閱 [smpte 抹除轉換](smpte-wipe-transition.md)。
