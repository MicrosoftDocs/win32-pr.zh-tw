...
ms.locfileid: "118400756"
---
# <a name="iamtimelineobjgetsubobjectguid-method"></a>IAMTimelineObj：： GetSubObjectGUID 方法
...
方法會抓取 `GetSubObjectGUID` 與這個時間軸物件相關聯的子物件的 GUID。
...
接收子物件的 GUID， \_ 如果物件沒有子物件，則為 guid Null。
