...
ms.locfileid: "119905038"
---
# <a name="iamtimelinegroupsetmediatypeforvb-method"></a>IAMTimelineGroup：： SetMediaTypeForVB 方法
...
`SetMediaTypeForVB`方法會指定 Automation 用戶端的群組媒體類型。
...
此方法適用于 Automation 用戶端。 若是 c + + 應用程式，請使用 [**IAMTimelineGroup：： SetMediaType**](iamtimelinegroup-setmediatype.md) 方法。
