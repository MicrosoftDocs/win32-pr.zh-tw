...
`IMediaObjectImpl`類別樣板提供 [**IMediaObject**](/previous-versions/windows/desktop/api/Mediaobj/nn-mediaobj-imediaobject)介面的基底實作為基底。 如需使用此範本的詳細資訊，請參閱 [使用 Sql-dmo 類別範本](using-the-dmo-class-template.md)。

此 `IMediaObjectImpl` 範本會公開下列成員。



| Nested 類別                              | Description                                  |
|-------------------------------------------|----------------------------------------------|
| [**LockIt**](imediaobjectimpl-lockit.md) | 鎖定和解除鎖定的 Helper 類別。 |
...
| [**鎖定**](/previous-versions/ms809100(v=msdn.10))                                       | 鎖定                                                        |
...
| [**Unlock**](/previous-versions/ms809101(v=msdn.10))                                   | 解除鎖定                                                      |
...
[使用 SQL-DMO 類別範本](using-the-dmo-class-template.md)
</dt> </dl>
