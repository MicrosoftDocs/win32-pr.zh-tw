...
---
# <a name="video-streaming-sample-code"></a><span data-ttu-id="24a7a-103">影片串流範例程式碼</span><span class="sxs-lookup"><span data-stu-id="24a7a-103">Video Streaming Sample Code</span></span>

> [!Note]  
> <span data-ttu-id="24a7a-104">這些 Api 已被取代。</span><span class="sxs-lookup"><span data-stu-id="24a7a-104">These APIs are deprecated.</span></span> <span data-ttu-id="24a7a-105">應用程式應該使用 [**範例捕獲**](sample-grabber-filter.md) 篩選器或執行自訂篩選，以從 DirectShow 篩選圖形取得資料。</span><span class="sxs-lookup"><span data-stu-id="24a7a-105">Applications should use the [**Sample Grabber**](sample-grabber-filter.md) filter or implement a custom filter to get data from a DirectShow filter graph.</span></span>

 

<span data-ttu-id="24a7a-106">此範例程式碼會讀取檔案，並將它轉譯為主要 DirectDraw 介面。</span><span class="sxs-lookup"><span data-stu-id="24a7a-106">This sample code reads a file and renders it to a primary DirectDraw surface.</span></span> <span data-ttu-id="24a7a-107">為了簡潔起見，此範例會執行基本的錯誤檢查。</span><span class="sxs-lookup"><span data-stu-id="24a7a-107">For brevity, this example performs minimal error checking.</span></span>
