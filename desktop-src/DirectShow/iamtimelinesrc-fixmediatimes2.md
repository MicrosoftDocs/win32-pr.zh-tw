...
ms.locfileid: "118399618"
---
# <a name="iamtimelinesrcfixmediatimes2-method"></a>IAMTimelineSrc：： FixMediaTimes2 方法
...
方法會將 `FixMediaTimes2` 指定的時間值四捨五入到最接近的框架界限（如輸出畫面播放速率所定義）。 這個方法相當於 [**IAMTimelineSrc：： FixMediaTimes**](iamtimelinesrc-fixmediatimes.md)，但會接受 [**REFTIME**](reftime.md) 的值。
