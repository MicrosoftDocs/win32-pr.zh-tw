...
-   **AMMultimediaStream** 物件會公開 [**IAMMultiMediaStream**](/previous-versions/windows/desktop/api/amstream/nn-amstream-iammultimediastream)介面。 就內部而言，此物件會包裝 DirectShow 的篩選圖形。
