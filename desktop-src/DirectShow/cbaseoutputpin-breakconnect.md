...
ms.locfileid: "119793217"
---
# <a name="cbaseoutputpinbreakconnect-method"></a>CBaseOutputPin. BreakConnect 方法
...
這個方法會覆寫 [**CBasePin：： BreakConnect**](cbasepin-breakconnect.md) 方法。 它會解除配置器，並釋放 [**IMemAllocator**](/windows/desktop/api/Strmif/nn-strmif-imemallocator) 和 [**IPin**](/windows/desktop/api/Strmif/nn-strmif-ipin) 介面。
