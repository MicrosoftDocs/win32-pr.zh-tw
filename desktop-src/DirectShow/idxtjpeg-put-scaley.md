...
ms.locfileid: "119213308"
---
# <a name="idxtjpegput_scaley-method"></a>IDxtJpeg：:p 的 \_ ScaleY 方法
...
抹除垂直延展的量（以原始抹除定義的百分比表示）。 例如，值1.0 表示無延展，2.0 表示200% 延展。
