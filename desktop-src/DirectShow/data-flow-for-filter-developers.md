---
description: 篩選準則開發人員的資料 Flow
ms.assetid: cc7378c8-e268-4caa-98eb-6dc9c3b5bcad
title: 篩選準則開發人員的資料 Flow
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119749368"
---
# <a name="data-flow-for-filter-developers"></a>篩選準則開發人員的資料 Flow

本節將詳細說明如何透過篩選圖形來移動資料。 它著重于使用 [**IMemInputPin**](/windows/desktop/api/Strmif/nn-strmif-imeminputpin) 或 [**IAsyncReader**](/windows/desktop/api/Strmif/nn-strmif-iasyncreader) 介面的本機記憶體傳輸。 它適用于撰寫自己的自訂篩選器的開發人員。 如需 Microsoft DirectShow 如何處理資料流程的一般簡介，請參閱[篩選 Graph 中的資料 Flow](data-flow-in-the-filter-graph.md)。
