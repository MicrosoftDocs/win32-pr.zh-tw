...
ms.locfileid: "118400849"
---
# <a name="iamtimelineobjsettimelinetype-method"></a>IAMTimelineObj：： SetTimelineType 方法
...
不支援。 呼叫 [**IAMTimeline：： CreateEmptyNode**](iamtimeline-createemptynode.md) 方法，以建立新的時間軸物件。 一旦建立物件之後，您就無法變更其類型。
