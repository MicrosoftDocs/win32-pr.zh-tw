...
ms.locfileid: "119998432"
---
# <a name="czech-republic"></a>捷克共和國

如需下列資料表的說明，請參閱 [資料表和指派](tables-and-assignments.md)。

捷克共和國資料表中的頻率索引不適合作為通道號碼使用。

-   [Windows 7 和更新版本](#windows-7-and-later)
    -   [捷克共和國廣播指派](#czech-republic-broadcast-assignments)
    -   [捷克共和國纜線指派](#czech-republic-cable-assignments)
...
### <a name="czech-republic-broadcast-assignments"></a>捷克共和國廣播指派
...
### <a name="czech-republic-cable-assignments"></a>捷克共和國纜線指派
