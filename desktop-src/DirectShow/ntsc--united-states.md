...
NTSC 表格適用于使用 NTSC 標準頻道行的任何地區設定。 廣播和纜線 lineup 都是標準化且穩定的。 此外，頻率索引也適合作為通道號碼使用。

### <a name="ntsc-broadcast-assignments"></a>NTSC 廣播指派
...
### <a name="ntsc-cable-assignments"></a>NTSC 纜線指派
