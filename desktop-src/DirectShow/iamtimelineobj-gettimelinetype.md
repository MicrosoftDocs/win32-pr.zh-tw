...
ms.locfileid: "118155332"
---
# <a name="iamtimelineobjgettimelinetype-method"></a>IAMTimelineObj：： GetTimelineType 方法
...
接收 [**時間軸 \_ 主要 \_ 型**](timeline-major-type.md) 別列舉型別的成員，指出物件的型別。
