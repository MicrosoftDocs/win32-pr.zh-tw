...
法國資料表中的頻率索引不適合作為通道號碼使用。

-   [Windows 7 和更新版本](#windows-7-and-later)
    -   [法國廣播指派](#france-broadcast-assignments)
    -   [法國纜線指派](#france-cable-assignments)
...
### <a name="france-broadcast-assignments"></a>法國廣播指派
...
### <a name="france-cable-assignments"></a>法國纜線指派
