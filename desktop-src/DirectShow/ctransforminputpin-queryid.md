...
---
# <a name="ctransforminputpinqueryid-method"></a>CTransformInputPin. QueryId 方法
...
Pin 識別碼會用於圖形持續性。 此類別的 pin 識別碼在中。 這個類別會覆寫 [**CBasePin**](cbasepin.md) 類別的行為。 在 **CBasePin** 類別中，pin 識別碼與在類別的函式中指定的 pin 碼名稱相同。 在 **CTransformInputPin** 類別中，pin 識別碼和 pin 名稱不相同。
