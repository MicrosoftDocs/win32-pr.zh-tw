...
ms.locfileid: "118158450"
---
# <a name="cbasecontrolwindowgetminidealimagesize-method"></a>CBaseControlWindow. GetMinIdealImageSize 方法

方法會抓取 `GetMinIdealImageSize` 最小的理想影像大小。
