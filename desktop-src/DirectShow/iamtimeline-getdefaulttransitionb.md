...
ms.locfileid: "120107838"
---
# <a name="iamtimelinegetdefaulttransitionb-method"></a>IAMTimeline：： GetDefaultTransitionB 方法
...
`GetDefaultTransitionB`方法會捕獲預設轉換。 這個方法相當於 [**IAMTimeline：： GetDefaultTransition**](iamtimeline-getdefaulttransition.md)，但會接收 BSTR 值，而不是 GUID。
