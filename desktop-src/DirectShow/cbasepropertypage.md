...
| [**啟動**](cbasepropertypage-activate.md)                         | 建立對話方塊視窗。                                                                                                    |
...
| [**Help**](cbasepropertypage-help.md)                                 | 叫用屬性頁說明。                                                                                                   |
...
請記得也要覆寫篩選準則的 **NonDelegatingQueryInterface** 方法。 如需詳細資訊，請參閱 [DirectShow 和 COM](directshow-and-com.md) 與 [**INonDelegatingUnknown**](inondelegatingunknown.md)。
