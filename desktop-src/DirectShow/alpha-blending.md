...
---
# <a name="alpha-blending-directshow"></a> (DirectShow) 的 Alpha 混色

\[此 API 不受支援，而且可能會在未來變更或無法使用。\]

本文說明 (DES) 的 [DirectShow 編輯服務](directshow-editing-services.md) 中的 Alpha 混色。
...
-   您可以使用已具有 Alpha 資料的32位 RGB 影片的 AVI 檔案。 目前， (WMF) 原始程式檔中的 MPEG 或 Microsoft Windows Media 格式不支援 Alpha。
-   DES 支援32位點陣圖 ( .bmp) 和 Targa (. 使用 Alpha 資料 tga) 檔。
