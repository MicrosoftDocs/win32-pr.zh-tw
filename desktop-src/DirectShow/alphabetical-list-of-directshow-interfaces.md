...
<td>設定及抓取影片捕獲篩選器中的類比到數位轉換流程的相關資訊。</td>
</tr>
<tr class="even">
...
<td>將認證的輸出保護通訊協定 (COPP) 訊息傳送到圖形驅動程式。</td>
</tr>
<tr class="odd">
...
<td>設定舊版 Windows Media Player 6.4 來源篩選。</td>
</tr>
<tr class="odd">
...
<td>設定及抓取舊版 Windows Media Player 6.4 來源篩選器的預先進行設定。</td>
</tr>
<tr class="odd">
...
<td>報告舊版 Windows Media Player 6.4 來源篩選器的網路連線品質。</td>
</tr>
<tr class="even">
...
<td>顯示 Windows (VFW) 編解碼器的影片所提供的對話方塊。</td>
</tr>
<tr class="odd">
...
<td>啟用影片解碼篩選器以存取 DirectX Video 加速 (DXVA) 1.0 功能。</td>
</tr>
<tr class="even">
...
<td>控制特定的影片捕獲作業，例如列舉可用的畫面播放速率和影像方向。</td>
</tr>
<tr class="odd">
...
<td>設定影片屬性，例如目的地和來源矩形。</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Control/nn-control-ibasicvideo2"><strong>IBasicVideo2</strong></a></td>
<td>擴充 <a href="/windows/desktop/api/Control/nn-control-ibasicvideo"><strong>IBasicVideo</strong></a> 介面。</td>
</tr>
<tr class="odd">
...
<td>設定 <a href="wm-asf-writer-filter.md">WM ASF 寫入</a> 器篩選器。</td>
</tr>
<tr class="odd">
...
<td>擴充 <a href="/previous-versions/windows/desktop/api/dshowasf/nn-dshowasf-iconfigasfwriter"><strong>IConfigAsfWriter</strong></a> 介面。</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iconfigavimux"><strong>IConfigAviMux</strong></a></td>
<td>設定 <a href="avi-mux-filter.md">AVI Mux</a> 篩選器。</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iconfiginterleaving"><strong>IConfigInterleaving</strong></a></td>
<td>控制 AVI Mux 交錯音訊和影片範例的方式。</td>
</tr>
<tr class="even">
...
<td>啟用在 DirectDraw 專屬全螢幕模式下播放影片。</td>
</tr>
<tr class="even">
...
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iddrawexclmodevideocallback"><strong>IDDrawExclModeVideoCallback</strong></a>介面的回呼介面。</td>
</tr>
<tr class="odd">
...
<td>使用 <a href="/windows/desktop/api/Control/nn-control-iqueuecommand"><strong>IQueueCommand</strong></a> 介面取消或修改已排入佇列的圖形控制命令。</td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/api/Amvideo/nn-amvideo-idirectdrawvideo"><strong>IDirectDrawVideo</strong></a></td>
<td>查詢有關 DirectDraw 表面和硬體功能的 <a href="video-renderer-filter.md">影片</a> 轉譯器篩選器。</td>
</tr>
<tr class="even">
...
<td>列舉) 的封包識別碼對應至 <a href="mpeg-2-demultiplexer.md">Mpeg-2 信號</a> 碼篩選器上的輸出圖釘 (PID。</td>
</tr>
<tr class="even">
...
<td>擴充 <a href="/windows/desktop/api/Strmif/nn-strmif-igraphbuilder"><strong>IGraphBuilder</strong></a> 介面。</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-ifiltergraph3"><strong>IFilterGraph3</strong></a></td>
<td>擴充 <a href="/windows/desktop/api/Strmif/nn-strmif-ifiltergraph2"><strong>IFilterGraph2</strong></a> 介面。</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-ifiltermapper2"><strong>IFilterMapper2</strong></a></td>
<td>註冊和取消註冊篩選，並在登錄中尋找篩選。</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-ifiltermapper3"><strong>IFilterMapper3</strong></a></td>
<td>擴充 <a href="/windows/desktop/api/Strmif/nn-strmif-ifiltermapper2"><strong>IFilterMapper2</strong></a> 介面。</td>
</tr>
<tr class="odd">
...
<td>當圖形正在執行時重新配置篩選圖形。</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-igraphconfigcallback"><strong>IGraphConfigCallback</strong></a></td>
<td><a href="/windows/desktop/api/Strmif/nn-strmif-igraphconfig"><strong>IGraphConfig</strong></a>介面的回呼介面。</td>
</tr>
<tr class="even">
...
<td>擴充 <a href="/windows/desktop/api/Control/nn-control-imediaevent"><strong>IMediaEvent</strong></a> 介面。</td>
</tr>
<tr class="odd">
...
<td>設定及抓取 Audio-Video 交錯 (AVI) 檔中的資訊和中的區塊。</td>
</tr>
<tr class="odd">
...
<td>擴充 <a href="/windows/desktop/api/Strmif/nn-strmif-imediasample"><strong>IMediaSample</strong></a> 介面。</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-imediasample2config"><strong>IMediaSample2Config</strong></a></td>
<td>傳回代表 VRAM 捕捉緩衝區的 Direct3D 介面指標。</td>
</tr>
<tr class="even">
...
<td><a href="/windows/desktop/api/Strmif/nn-strmif-imemallocatorcallbacktemp"><strong>IMemAllocatorCallbackTemp</strong></a>介面的回呼介面。
<blockquote>
[!Note]<br />
已取代。
</blockquote>
...
<td><a href="/previous-versions/windows/desktop/api/mixerocx/nn-mixerocx-imixerocx"><strong>IMixerOCX</strong></a>介面的回呼介面。</td>
</tr>
<tr class="odd">
...
<td>在 Audio-Video 交錯的 (AVI) 資料流程中，設定和抓取資訊和中的區塊。</td>
</tr>
<tr class="odd">
...
<td>在篩選圖形上將命令排入佇列，以在指定的時間進行處理。</td>
</tr>
<tr class="odd">
...
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iresourcemanager"><strong>IResourceManager</strong></a>介面的回呼介面。</td>
</tr>
<tr class="odd">
...
<td>控制在捕獲裝置上 (ProcAmp) 設定的映射調整。</td>
</tr>
<tr class="odd">
...
<td>控制 <a href="video-mixing-renderer-filter-7.md">影片混合轉譯器篩選 7</a> (VMR-7) 是否保留來源影片的外觀比例。</td>
</tr>
<tr class="odd">
...
<td>在 VMR-9 所使用的影像展示者上設定轉譯喜好設定。</td>
</tr>
<tr class="even">
...
<td>配置 VMR-9 配置器（展示者）所使用的 Direct3D 表面。</td>
</tr>
<tr class="odd">
...
<td>擴充 <a href="/previous-versions/windows/desktop/api/vmr9/nn-vmr9-ivmrsurfaceallocator9"><strong>IVMRSurfaceAllocator9</strong></a> 介面。</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-ivmrsurfaceallocatornotify"><strong>IVMRSurfaceAllocatorNotify</strong></a></td>
<td>讓配置器呈現者可以通知 VMR-7。</td>
</tr>
<tr class="odd">
...
<td>控制 VMR-9 呈現影片資料流程的方式。</td>
</tr>
<tr class="even">
<td><a href="/previous-versions/windows/desktop/api/vpconfig/nn-vpconfig-ivpbaseconfig"><strong>IVPBaseConfig</strong></a></td>
<td><a href="/previous-versions/windows/desktop/api/vpconfig/nn-vpconfig-ivpconfig"><strong>IVPConfig</strong></a>介面的基底介面。</td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/api/Vpnotify/nn-vpnotify-ivpbasenotify"><strong>IVPBaseNotify</strong></a></td>
<td><a href="/previous-versions/windows/desktop/api/Vpnotify/nn-vpnotify-ivpnotify"><strong>IVPNotify</strong></a>介面的基底介面。</td>
</tr>
<tr class="even">
...
<td>擴充 <a href="/previous-versions/windows/desktop/api/Vpnotify/nn-vpnotify-ivpnotify"><strong>IVPNotify</strong></a> 介面。</td>
</tr>
<tr class="even">
