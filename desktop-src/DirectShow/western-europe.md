...
---
# <a name="western-europe"></a>西歐

如需下列資料表的說明，請參閱 [資料表和指派](tables-and-assignments.md)。

西歐資料表中的頻率索引不適合作為通道號碼使用。

### <a name="western-europe-broadcast-assignments"></a>西歐廣播指派
...
### <a name="western-europe-cable-assignments"></a>西歐纜線指派

有資料可支援某些國家/地區的標準化纜線組合。 針對未報告頻道組合資料的國家/地區，則會使用 [Unicable Frequency 資料表](unicable-frequency-table.md) 。
