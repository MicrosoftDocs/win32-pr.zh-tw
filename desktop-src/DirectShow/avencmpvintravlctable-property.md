...
指定要用於熵編碼的 (VLC) 資料表的可變長度編碼。 這個屬性會套用至 MPEG 視頻編碼器。
...
**CODECAPI \_ AVEncMPVIntraVLCTable**

## <a name="property-value"></a>屬性值

這個屬性的值是 [**eAVEncMPVIntraVLCTable**](/windows/desktop/api/codecapi/ne-codecapi-eavencmpvintravlctable) 列舉的成員。
