...
本主題包含 Microsoft® DirectShow®核心介面的參考資訊。 為了提供各種類型硬體、檔案格式和串流作業的廣泛支援，可執行大量的介面。 有些是由應用程式所使用;其他會由篩選器和其他 DirectShow 元件在內部使用。
...
-   [檔案編碼和解碼介面](file-encoding-and-decoding-interfaces.md)
-   [影片轉譯和重迭的介面](interfaces-for-video-rendering-and-overlay.md)
