...
---
# <a name="ctransinplacefilterinputpin-method"></a>CTransInPlaceFilter. InputPin 方法

方法會抓取 `InputPin` 篩選的輸入圖釘指標。
...
傳回 [**CTransformFilter：： m \_ pInput**](ctransformfilter-m-pinput.md) 成員變數。
