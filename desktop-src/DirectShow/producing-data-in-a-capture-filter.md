---
description: 本主題說明自訂 DirectShow capture 篩選器應該如何產生輸出資料。
...
ms.locfileid: "119748178"
---
# <a name="producing-data-in-a-capture-filter"></a>在 Capture 篩選器中產生資料

本主題說明自訂 DirectShow capture 篩選器應該如何產生輸出資料。

## <a name="filter-state-changes"></a>篩選狀態變更

只有在執行篩選時，才會產生資料的捕獲篩選。 當篩選暫停時，請勿從您的 pin 傳送資料。 此外，當篩選暫停時，傳回 VFW 無法從 [**CBaseFilter：： >getstate**](cbasefilter-getstate.md)方法 **\_ \_ \_ 提示**。 此傳回值會告知篩選 Graph 管理員，在篩選暫停時，不應等候篩選中的任何資料。 如需詳細資訊，請參閱 [篩選狀態](filter-states.md)。
...
[DirectShow影片捕獲篩選](directshow-video-capture-filters.md)
</dt> <dt>
