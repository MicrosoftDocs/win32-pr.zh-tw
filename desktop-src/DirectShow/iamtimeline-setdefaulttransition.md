...
ms.locfileid: "119812408"
---
# <a name="iamtimelinesetdefaulttransition-method"></a>IAMTimeline：： SetDefaultTransition 方法
...
`SetDefaultTransition`方法會設定預設轉換。 如果轉譯引擎無法轉譯轉換，則會替代預設轉換。
...
如果您未設定預設轉換，或您指定為預設值的轉換造成錯誤，DES 會使用自己的預設轉換。
