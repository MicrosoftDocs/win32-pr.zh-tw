...
例如，假設音效工程師正在混用數位主磁帶，而且想要對關切這個領域區段套用稍微延遲，以填滿音效。 如果延遲突然剪下，則會 jarring 效果。 相反地，效果應該會開始100% 的 (不會有延遲) ，而且濕/試混合應該會逐漸增加，直到達到所需的層級為止。 此外，這種轉換應該遵循平滑曲線或線性進展。 為了支援此案例，您可以公開下列介面：
