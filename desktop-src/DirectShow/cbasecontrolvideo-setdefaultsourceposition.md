...
ms.locfileid: "120087488"
---
# <a name="cbasecontrolvideosetdefaultsourceposition-method"></a>CBaseControlVideo. SetDefaultSourcePosition 方法

方法會將轉譯器 `SetDefaultSourcePosition` 設定回使用預設來源位置 (通常是所有原生影片) 。
