...
---
# <a name="cbasefiltergetsyncsource-method"></a>CBaseFilter. GetSyncSource 方法

`GetSyncSource`方法會抓取篩選所使用的參考時鐘。 這個方法會實 [**IMediaFilter：： GetSyncSource**](/windows/desktop/api/Strmif/nf-strmif-imediafilter-getsyncsource) 方法。
...
如果篩選未使用參考時鐘， *\* pClock* 會設為 **Null**。 當方法傳回時，如果 *\* pClock* 為非 **Null**，則 **IReferenceClock** 介面具有未處理的參考計數。 當您完成時，請務必放開。
