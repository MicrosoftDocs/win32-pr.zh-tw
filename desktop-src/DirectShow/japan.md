...
日本資料表中的頻率索引適合作為通道號碼使用。

### <a name="japan-broadcast-assignments"></a>日本廣播指派
...
### <a name="japan-cable-assignments"></a>日本纜線指派
...
## <a name="revised-channel-assignments"></a>修改過的通道指派

下表列出需要 Windows XP Media Center Edition 1.1 和更新版本的有線通道指派。

此日本資料表中的頻率索引適合作為通道號碼使用。
