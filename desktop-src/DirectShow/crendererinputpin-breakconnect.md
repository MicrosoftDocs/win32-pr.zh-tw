...
ms.locfileid: "119908498"
---
# <a name="crendererinputpinbreakconnect-method"></a>CRendererInputPin. BreakConnect 方法

**BreakConnect** 方法會從連接釋放 pin。 這個方法會覆寫 [**CBaseInputPin：： BreakConnect**](cbaseinputpin-breakconnect.md) 方法。
