...
ms.locfileid: "117819381"
---
# <a name="idxtkeyput_luminance-method"></a>IDxtKey：:p 的 ui \_ 亮度方法
...
`put_Luminance`方法會指定要做為索引鍵的亮度值。 這個屬性只適用于金鑰類型為 DXTKEY \_ 亮度時。
