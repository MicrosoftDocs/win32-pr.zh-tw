---
description: CBaseDispatch 類別是用來在 DirectShow 濾波器中實作為 IDispatch 介面的基類。
...
| [**~ CBaseDispatch**](cbasedispatch--cbasedispatch.md)     | 函式方法。                                                                                                  |
| [**GetIDsOfNames**](cbasedispatch-getidsofnames.md)       | 地圖一組名稱一組對應的 Dispid。                                                              |
