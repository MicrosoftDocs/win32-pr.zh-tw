...
ms.locfileid: "119997768"
---
# <a name="iamtimelinegetdefaulteffectb-method"></a>IAMTimeline：： GetDefaultEffectB 方法
...
方法會抓取 `GetDefaultEffectB` 預設效果。 這個方法相當於 [**IAMTimeline：： GetDefaultEffect**](iamtimeline-getdefaulteffect.md)，但會接收 **BSTR** 值，而不是 GUID。
