...
ms.locfileid: "119905278"
---
# <a name="iamtimelineeffectsenabled-method"></a>IAMTimeline：： EffectsEnabled 方法
...
`EffectsEnabled`方法會判斷是否已啟用效果。 如果已停用效果，它們會保留在時間軸中，但不會呈現。
...
接收布林值，指出是否已啟用效果。 若 **為 TRUE**，則會啟用效果。 如果 **為 FALSE**，則會停用效果。
