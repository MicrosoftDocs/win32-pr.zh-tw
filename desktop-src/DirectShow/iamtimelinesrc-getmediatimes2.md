...
ms.locfileid: "120052308"
---
# <a name="iamtimelinesrcgetmediatimes2-method"></a>IAMTimelineSrc：： GetMediaTimes2 方法
...
方法會抓取 `GetMediaTimes2` 媒體的開始和停止時間。 這個方法相當於 [**IAMTimelineSrc：： GetMediaTimes**](iamtimelinesrc-getmediatimes.md)，但會接受 [**REFTIME**](reftime.md) 的值。
