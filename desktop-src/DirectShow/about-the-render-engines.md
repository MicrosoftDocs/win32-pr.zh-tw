...
> [!IMPORTANT]
> 這兩種轉譯引擎都會建立一個不可見的視窗來處理訊息。 建立轉譯引擎的執行緒必須有訊息迴圈，才能分派訊息。 此外，必須等到轉譯引擎和篩選 Graph 管理員釋放之後，該執行緒才能結束。 否則，應用程式可能會鎖死。
...
[預覽 Project](previewing-a-project.md)
</dt> <dt>

[將 Project 寫入檔案](writing-a-project-to-a-file.md)
</dt> </dl>
