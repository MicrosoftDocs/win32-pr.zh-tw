---
title: DNS WMI 提供者範例—管理 DNS 伺服器
description: DNS WMI 提供者範例—管理 DNS 伺服器
...
ms.locfileid: "104509750"
---
# <a name="dns-wmi-provider-samplesmanaging-a-dns-server"></a><span data-ttu-id="6bd00-103">DNS WMI 提供者範例—管理 DNS 伺服器</span><span class="sxs-lookup"><span data-stu-id="6bd00-103">DNS WMI Provider Samples—Managing a DNS Server</span></span>

> [!NOTE]
> <span data-ttu-id="6bd00-104">本文包含「從屬」一詞的參考，Microsoft 已不再使用該字詞。</span><span class="sxs-lookup"><span data-stu-id="6bd00-104">This article contains references to the term slave, a term that Microsoft no longer uses.</span></span> <span data-ttu-id="6bd00-105">從軟體中移除該字詞時，我們也會將其從本文中移除。</span><span class="sxs-lookup"><span data-stu-id="6bd00-105">When the term is removed from the software, we’ll remove it from this article.</span></span>

<span data-ttu-id="6bd00-106">本節將示範與管理 DNS 伺服器相關聯的腳本工作。</span><span class="sxs-lookup"><span data-stu-id="6bd00-106">This section demonstrates scripting tasks associated with managing a DNS Server.</span></span> <span data-ttu-id="6bd00-107">下列連結會跳到腳本檔案中的副程式：</span><span class="sxs-lookup"><span data-stu-id="6bd00-107">The links below jump to subroutines in the script file:</span></span>

-   [<span data-ttu-id="6bd00-108">列出 DNS 伺服器屬性</span><span class="sxs-lookup"><span data-stu-id="6bd00-108">List DNS Server properties</span></span>](#list-dns-server-properties)
-   [<span data-ttu-id="6bd00-109">停止、啟動或重新開機 DNS 伺服器</span><span class="sxs-lookup"><span data-stu-id="6bd00-109">Stop, start, or restart a DNS Server</span></span>](#stop-start-or-restart-a-dns-server)
-   [<span data-ttu-id="6bd00-110">修改 DNS 伺服器屬性</span><span class="sxs-lookup"><span data-stu-id="6bd00-110">Modify DNS Server properties</span></span>](#modify-dns-server-properties)
-   [<span data-ttu-id="6bd00-111">新增 IP 位址</span><span class="sxs-lookup"><span data-stu-id="6bd00-111">Add an IP address</span></span>](#add-an-ip-address)
-   [<span data-ttu-id="6bd00-112">刪除 IP 位址</span><span class="sxs-lookup"><span data-stu-id="6bd00-112">Delete an IP address</span></span>](#delete-an-ip-address)
-   [<span data-ttu-id="6bd00-113">列出區域</span><span class="sxs-lookup"><span data-stu-id="6bd00-113">List Zones</span></span>](#list-zones)
...
## <a name="list-dns-server-properties"></a><span data-ttu-id="6bd00-114">列出 DNS 伺服器屬性</span><span class="sxs-lookup"><span data-stu-id="6bd00-114">List DNS Server properties</span></span>
...
## <a name="stop-start-or-restart-a-dns-server"></a><span data-ttu-id="6bd00-115">停止、啟動或重新開機 DNS 伺服器</span><span class="sxs-lookup"><span data-stu-id="6bd00-115">Stop, Start, or Restart a DNS Server</span></span>
...
## <a name="modify-dns-server-properties"></a><span data-ttu-id="6bd00-116">修改 DNS 伺服器屬性</span><span class="sxs-lookup"><span data-stu-id="6bd00-116">Modify DNS Server Properties</span></span>
...
## <a name="add-an-ip-address"></a><span data-ttu-id="6bd00-117">新增 IP 位址</span><span class="sxs-lookup"><span data-stu-id="6bd00-117">Add an IP Address</span></span>
...
## <a name="delete-an-ip-address"></a><span data-ttu-id="6bd00-118">刪除 IP 位址</span><span class="sxs-lookup"><span data-stu-id="6bd00-118">Delete an IP Address</span></span>
...
## <a name="list-zones"></a><span data-ttu-id="6bd00-119">列出區域</span><span class="sxs-lookup"><span data-stu-id="6bd00-119">List Zones</span></span>
