---
title: DNS WMI 提供者範例—管理 DNS 資源記錄
description: DNS WMI 提供者範例—管理 DNS 資源記錄
...
本節將示範與管理 DNS 資源記錄相關聯的腳本工作。 下列連結會跳至腳本檔中的副程式。

-   [列出資源記錄](#list-resource-records)
...
1.  針對每個資源記錄類型建立類別。
2.  您可以透過使用者命令列輸入和每個記錄類型類別的 DNS WMI 提供者資訊來提供資源記錄資料。
3.  系統會建立常用的函式（例如 list、delete 和 modify），並可用於個別的資源記錄類型類別。

這個程式碼範例會顯示與管理 DNS 資源記錄相關聯的工作。
...
## <a name="list-resource-records"></a>列出資源記錄

這個程式碼範例會顯示與列出資源記錄相關聯的工作。
...
## <a name="add-a-resource-record"></a>新增資源記錄

這個程式碼範例會顯示與新增資源記錄相關聯的工作。
...
## <a name="delete-a-resource-record"></a>刪除資源記錄

這個程式碼範例會顯示與刪除資源記錄相關聯的工作。
...
## <a name="modify-a-resource-record"></a>修改資源記錄

這個程式碼範例會顯示與變更資源記錄相關聯的工作。
