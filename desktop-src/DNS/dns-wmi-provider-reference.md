---
title: DNS WMI 提供者參考
description: DNS WMI 提供者是在 Dnsprov 中定義，其中包含在 Windows Server CD 上。
...
DNS WMI 提供者是在 Dnsprov 中定義，其中包含在 Windows Server CD 上。



| 區段                                | 目錄                                                                              |
|----------------------------------------|---------------------------------------------------------------------------------------|
| [DNS WMI 類別](dns-wmi-classes.md) | DNS WMI 提供者類別參考頁面，包括與每個類別相關聯的方法。 |
