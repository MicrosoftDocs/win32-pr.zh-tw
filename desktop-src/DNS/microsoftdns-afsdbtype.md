...
代表 Andrew 檔案系統資料庫伺服器 (AFSDB) 記錄之 [**MicrosoftDNS \_ ResourceRecord**](microsoftdns-resourcerecord.md) 的子類別。
...
**MicrosoftDNS \_ AFSDBType** 類別具有下列類型的成員：
...
**MicrosoftDNS \_ AFSDBType** 類別具有這些方法。
...
**MicrosoftDNS \_ AFSDBType** 類別具有這些屬性。
