...
ms.locfileid: "118163847"
---
# <a name="dns-wmi-provider-samplesmanaging-dns-zones"></a>DNS WMI 提供者範例—管理 DNS 區域

本節將示範與管理 DNS 區域相關聯的腳本工作。 下列連結會連結到腳本檔案中的副程式。

-   [建立 DNS 區域](#create-a-dns-zone)
-   [修改 DNS 區域](#modify-a-dns-zone)
-   [刪除 DNS 區域](#delete-a-dns-zone)
-   [新增區域 IP 位址](#add-a-zone-ip-address)
-   [刪除區域 IP 位址](#delete-a-zone-ip-address)
-   [暫停區域](#pause-a-zone)
-   [繼續區域](#resume-a-zone)
-   [更新區域](#update-a-zone)
-   [重載區域](#reload-a-zone)
-   [重新整理區域](#refresh-a-zone)
...
## <a name="modify-a-dns-zone"></a>修改 DNS 區域
...
## <a name="add-a-zone-ip-address"></a>新增區域 IP 位址
...
## <a name="delete-a-zone-ip-address"></a>刪除區域 IP 位址
...
## <a name="refresh-a-zone"></a>重新整理區域
