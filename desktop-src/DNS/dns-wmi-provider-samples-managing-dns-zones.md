---
title: DNS WMI 提供者範例—管理 DNS 區域
description: DNS WMI 提供者範例—管理 DNS 區域
ms.assetid: 12958b71-b47d-4dd7-bd08-409ecd369e4f
keywords:
- DNS WMI 提供者範例 8212;管理 DNS 區域
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104372115"
---
# <a name="dns-wmi-provider-samplesmanaging-dns-zones"></a><span data-ttu-id="21f97-104">DNS WMI 提供者範例—管理 DNS 區域</span><span class="sxs-lookup"><span data-stu-id="21f97-104">DNS WMI Provider Samples—Managing DNS Zones</span></span>

<span data-ttu-id="21f97-105">本節將示範與管理 DNS 區域相關聯的腳本工作。</span><span class="sxs-lookup"><span data-stu-id="21f97-105">This section demonstrates scripting tasks associated with managing DNS zones.</span></span> <span data-ttu-id="21f97-106">下列連結會連結到腳本檔案中的副程式。</span><span class="sxs-lookup"><span data-stu-id="21f97-106">The following links link to subroutines in the script file.</span></span>

-   [<span data-ttu-id="21f97-107">建立 DNS 區域</span><span class="sxs-lookup"><span data-stu-id="21f97-107">Create a DNS zone</span></span>](#create-a-dns-zone)
-   [<span data-ttu-id="21f97-108">修改 DNS 區域</span><span class="sxs-lookup"><span data-stu-id="21f97-108">Modify a DNS zone</span></span>](#modify-a-dns-zone)
-   [<span data-ttu-id="21f97-109">刪除 DNS 區域</span><span class="sxs-lookup"><span data-stu-id="21f97-109">Delete a DNS zone</span></span>](#delete-a-dns-zone)
-   [<span data-ttu-id="21f97-110">新增區域 IP 位址</span><span class="sxs-lookup"><span data-stu-id="21f97-110">Add a zone IP address</span></span>](#add-a-zone-ip-address)
-   [<span data-ttu-id="21f97-111">刪除區域 IP 位址</span><span class="sxs-lookup"><span data-stu-id="21f97-111">Delete a zone IP address</span></span>](#delete-a-zone-ip-address)
-   [<span data-ttu-id="21f97-112">暫停區域</span><span class="sxs-lookup"><span data-stu-id="21f97-112">Pause a zone</span></span>](#pause-a-zone)
-   [<span data-ttu-id="21f97-113">繼續區域</span><span class="sxs-lookup"><span data-stu-id="21f97-113">Resume a zone</span></span>](#resume-a-zone)
-   [<span data-ttu-id="21f97-114">更新區域</span><span class="sxs-lookup"><span data-stu-id="21f97-114">Update a zone</span></span>](#update-a-zone)
-   [<span data-ttu-id="21f97-115">重載區域</span><span class="sxs-lookup"><span data-stu-id="21f97-115">Reload a zone</span></span>](#reload-a-zone)
-   [<span data-ttu-id="21f97-116">重新整理區域</span><span class="sxs-lookup"><span data-stu-id="21f97-116">Refresh a zone</span></span>](#refresh-a-zone)
...
## <a name="create-a-dns-zone"></a><span data-ttu-id="21f97-117">建立 DNS 區域</span><span class="sxs-lookup"><span data-stu-id="21f97-117">Create a DNS Zone</span></span>
...
## <a name="modify-a-dns-zone"></a><span data-ttu-id="21f97-118">修改 DNS 區域</span><span class="sxs-lookup"><span data-stu-id="21f97-118">Modify a DNS Zone</span></span>
...
## <a name="delete-a-dns-zone"></a><span data-ttu-id="21f97-119">刪除 DNS 區域</span><span class="sxs-lookup"><span data-stu-id="21f97-119">Delete a DNS Zone</span></span>
...
## <a name="add-a-zone-ip-address"></a><span data-ttu-id="21f97-120">新增區域 IP 位址</span><span class="sxs-lookup"><span data-stu-id="21f97-120">Add a Zone IP Address</span></span>
...
## <a name="delete-a-zone-ip-address"></a><span data-ttu-id="21f97-121">刪除區域 IP 位址</span><span class="sxs-lookup"><span data-stu-id="21f97-121">Delete a Zone IP Address</span></span>
...
## <a name="pause-a-zone"></a><span data-ttu-id="21f97-122">暫停區域</span><span class="sxs-lookup"><span data-stu-id="21f97-122">Pause a Zone</span></span>
...
## <a name="resume-a-zone"></a><span data-ttu-id="21f97-123">繼續區域</span><span class="sxs-lookup"><span data-stu-id="21f97-123">Resume a Zone</span></span>
...
## <a name="update-a-zone"></a><span data-ttu-id="21f97-124">更新區域</span><span class="sxs-lookup"><span data-stu-id="21f97-124">Update a Zone</span></span>
...
## <a name="reload-a-zone"></a><span data-ttu-id="21f97-125">重載區域</span><span class="sxs-lookup"><span data-stu-id="21f97-125">Reload a Zone</span></span>
...
## <a name="refresh-a-zone"></a><span data-ttu-id="21f97-126">重新整理區域</span><span class="sxs-lookup"><span data-stu-id="21f97-126">Refresh a Zone</span></span>
