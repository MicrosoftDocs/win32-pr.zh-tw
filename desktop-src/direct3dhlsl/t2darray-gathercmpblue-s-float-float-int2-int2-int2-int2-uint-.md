...
ms.locfileid: "117723826"
---
# <a name="texture2darraygathercmpbluesfloatfloatint2int2int2int2uint-function"></a>Texture2DArray：： GatherCmpBlue (S、float、float、int2、int2、int2、int2、uint) 函數
