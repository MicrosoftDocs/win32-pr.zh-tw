...
ms.locfileid: "118285018"
---
# <a name="texture2dgathercmpbluesfloatfloatint2int2int2int2-function"></a>Texture2D：： GatherCmpBlue (S、float、float、int2、int2、int2、int2) 函數
