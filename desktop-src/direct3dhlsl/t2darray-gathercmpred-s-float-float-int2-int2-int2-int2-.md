...
ms.locfileid: "119485868"
---
# <a name="texture2darraygathercmpredsfloatfloatint2int2int2int2-function"></a>Texture2DArray：： GatherCmpRed (S、float、float、int2、int2、int2、int2) 函數
