...
ms.locfileid: "118986218"
---
# <a name="samplesfloatintfloat-function-hlsl-reference"></a>範例 (S、float、int、float) 函數 (HLSL 參考) 

使用選擇性值來取樣 [**Texture2D**](sm5-object-texture2d.md) ，以將範例層級 (」 lod) 值設為。
