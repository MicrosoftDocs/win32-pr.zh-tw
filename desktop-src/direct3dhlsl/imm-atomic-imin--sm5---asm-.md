...
---
# <a name="imm_atomic_imin-sm5---asm"></a>imm 不可部分完成 \_ \_ imin (sm5-asm) 

立即可部分完成的帶正負號的最小記憶體。 傳回 max 作業之前的記憶體值。



| imm \_ 不可 \_ 部分完成 imin dst0 \[ 。單一 \_ 元件 \_ 遮罩 \] 、dst1、dstAddress \[ . swizzle \] 、src0 \[ 。選取 \_ 元件\] |
|--------------------------------------------------------------------------------------------------------------|
...
Thisi 指令會執行單一元件32位帶正負號的最小運算元 *src0* ，每個元件位址 *dstAddress* 的 *dst1* 為32位。
