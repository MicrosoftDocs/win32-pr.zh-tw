...
ms.locfileid: "117723985"
---
# <a name="texture2dgathercmpredsfloatfloatint2int2int2int2uint-function"></a>Texture2D：： GatherCmpRed (S、float、float、int2、int2、int2、int2、uint) 函數
