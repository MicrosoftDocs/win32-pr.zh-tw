...
ms.locfileid: "118789157"
---
# <a name="samplecmpsamplecmpsfloatfloatintfloat-function-for-texture1d"></a>Texture1D 的 SampleCmp：： SampleCmp (S、float、float、int、float) 函數
