...
ms.locfileid: "118788446"
---
# <a name="texture2darraygatherredsfloatint2int2int2int2uint-function"></a>Texture2DArray：： GatherRed (S、float、int2、int2、int2、int2、uint) 函數
