...
ms.locfileid: "119485938"
---
# <a name="texture2darraygatherbluesfloatint2int2int2int2uint-function"></a>Texture2DArray：： GatherBlue (S、float、int2、int2、int2、int2、uint) 函數
