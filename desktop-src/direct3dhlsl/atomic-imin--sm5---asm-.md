...
ms.locfileid: "118287741"
---
# <a name="atomic_imin-sm5---asm"></a>不可部分完成 \_ 的 imin (sm5-asm) 

記憶體的最小原子帶正負號整數。



| 不可 \_ 部分完成的 imin dst，dstAddress \[ . swizzle \] ，src0 \[ . select \_ component\] |
|----------------------------------------------------------------------|
...
此指令會針對每個元件位址 DstAddress，32在每個元件位址的 *dst* 中執行單一元件32位帶正負號的最小運算元 *src0* ，以不可部分完成。
