...
---
# <a name="samplecmplevelzerosamplecmplevelzerosfloatfloatintuint-function-for-texture1d"></a>Texture1D 的 SampleCmpLevelZero：： SampleCmpLevelZero (S、float、float、int、uint) 函數
...
[SampleCmpLevelZero 方法](texture1d-samplecmplevelzero.md)
</dt> </dl>
