...
---
# <a name="samplebiassamplebiassfloatfloatfloatuint-function-for-texturecube"></a>TextureCube 的 SampleBias：： SampleBias (S、float、float、float、uint) 函數
...
[SampleBias 方法](texturecube-samplebias.md)
</dt> <dt>
