...
ms.locfileid: "119043436"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloat-function-for-texture2darray"></a>Texture2DArray 的 SampleGrad：： SampleGrad (S、float、float、float、int、float) 函數
...
[SampleGrad 方法](texture2darray-samplegrad.md)
</dt> <dt>
