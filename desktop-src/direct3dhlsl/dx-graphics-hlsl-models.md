...
- Direct3D 9 引進了著色器模型1、2和3。
- Direct3D 10 引進了著色器模型4。
- Direct3D 10.1 引進了著色器模型4.1。
...
- Direct3D 9 引進了效果-架構設定檔 fx \_ 1 \_ 0 和 fx \_ 2 \_ 0。
- Direct3D 10 引進了效果-架構設定檔 fx \_ 4 \_ 0。
- Direct3D 10.1 引進了效果-架構設定檔 fx \_ 4 \_ 1。
- Direct3D 11 引進效果-framework 設定檔 fx \_ 5 \_ 0。
