...
| ： mad \[ \_ sat \] dest \[ . mask \] 、 \[ - \] src0 \[ \_ abs \] \[ . swizzle \] 、 \[ - \] src1 \[ \_ abs \] \[ . swizzle \] 、 \[ - \] src2 收取 \[ \_ abs \] \[ . swizzle\] |
|-----------------------------------------------------------------------------------------------------------------------------|
...
| 項目                                                            | 描述                                                                                  |
|-----------------------------------------------------------------|----------------------------------------------------------------------------------------------|
| <span id="dest"></span><span id="DEST"></span>*目標*<br/> | \[在作業的 \] 結果中。<br/> *目的地*  = *src0* \**src1*  + *src2 收取*<br/> |
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/> | \[在 \] 被乘數中。<br/>                                                          |
| <span id="src1"></span><span id="SRC1"></span>*src1*<br/> | \[在 \] 乘數中。<br/>                                                            |
| <span id="src2"></span><span id="SRC2"></span>*src2 收取*<br/> | \[在 \] 加數中。<br/>                                                                |
