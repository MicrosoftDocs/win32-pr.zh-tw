...
ms.locfileid: "118506876"
---
# <a name="texture2dmsarrayloadintintintuint-function"></a>Texture2DMSArray：： Load (int，int，int，uint) 函數
...
傳回型別符合 [**Texture2DMSArray**](sm5-object-texture2dmsarray.md) 物件宣告中的型別。
