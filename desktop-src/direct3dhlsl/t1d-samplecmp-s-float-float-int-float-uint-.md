...
ms.locfileid: "117724302"
---
# <a name="samplecmpsamplecmpsfloatfloatintfloatuint-function-for-texture1d"></a>Texture1D 的 SampleCmp：： SampleCmp (S、float、float、int、float、uint) 函數
...
[SampleCmp 方法](texture1d-samplecmp.md)
</dt> </dl>
