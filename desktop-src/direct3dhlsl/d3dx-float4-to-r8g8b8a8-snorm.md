...
ms.locfileid: "118286726"
---
# <a name="d3dx_float4_to_r8g8b8a8_snorm-function"></a>D3DX \_ FLOAT4 \_ to \_ R8G8B8A8 \_ SNORM function

將指定的 XMFLOAT4 重新封裝回 DXGI \_ 格式 \_ R8G8B8A8 \_ SNORM。
