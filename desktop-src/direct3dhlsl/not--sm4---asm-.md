...
---
# <a name="not-sm4---asm"></a>不 (sm4-asm) 

位 not。



| not dest \[ \] 、src0 \[ . swizzle\] |
|-------------------------------------|
...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/> | \[在 \] 原始的元件中。<br/>                    |
...
此指令會在 *src0* 中執行每個32位值的元件一補數。 32位的結果會儲存在 *dest* 中。
