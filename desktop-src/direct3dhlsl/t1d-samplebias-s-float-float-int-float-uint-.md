...
ms.locfileid: "118508278"
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture1d"></a>Texture1D 的 SampleBias：： SampleBias (S、float、float、int、float、uint) 函數
...
[SampleBias 方法](texture1d-samplebias.md)
</dt> </dl>
