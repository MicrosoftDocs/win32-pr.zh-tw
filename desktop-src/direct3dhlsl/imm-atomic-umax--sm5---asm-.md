...
ms.locfileid: "118986508"
---
# <a name="imm_atomic_umax-sm5---asm"></a>imm 不可部分完成 \_ \_ umax (sm5-asm) 

立即不可部分完成的不帶正負號最大記憶體。 傳回 max 作業之前的記憶體值。



| imm \_ 不可 \_ 部分完成 umax dst0 \[ 。單一 \_ 元件 \_ 遮罩 \] 、dst1、dstAddress \[ . swizzle \] 、src0 \[ 。選取 \_ 元件\] |
|--------------------------------------------------------------------------------------------------------------|
