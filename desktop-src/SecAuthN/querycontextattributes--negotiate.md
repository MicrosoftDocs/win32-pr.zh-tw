...
---
# <a name="querycontextattributes-negotiate-function"></a>QueryCoNtextAttributes (Negotiate) 函數

**QueryCoNtextAttributes (Negotiate)** 函數可讓傳輸應用程式查詢 [*安全性內容*](../secgloss/s-gly.md)特定 [*屬性*](../secgloss/a-gly.md#_security_attribute_gly)的 Negotiate [*安全性封裝*](../secgloss/s-gly.md)。
...
| <span id="SECPKG_ATTR_ROOT_STORE"></span><span id="secpkg_attr_root_store"></span><dl> <dt>**SECPKG \_ATTR \_ 根 \_ 存放區**</dt> <dt>0x55</dt> </dl>                                           | *PBuffer* 參數包含 **HCERTCONTEXT** 的指標。 <br/> 尋找包含根存放區所提供之憑證的憑證內容。<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
