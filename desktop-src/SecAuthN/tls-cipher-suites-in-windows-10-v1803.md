---
description: 瞭解 Windows 10 v1803 中的 TLS 加密套件。 加密套件只能針對支援的 TLS 版本進行協商。
...
ms.locfileid: "118916147"
---
# <a name="tls-cipher-suites-in-windows-10-v1803"></a>Windows 10 v1803 中的 TLS 加密套件
...
針對 Windows 10 （1803版），使用 Microsoft Schannel 提供者預設會啟用下列加密套件，並依照此優先順序排序：
