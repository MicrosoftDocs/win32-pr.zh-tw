...
ms.locfileid: "117786197"
---
# <a name="tls-cipher-suites-in-windows-10-v1607"></a>Windows 10 v1607 中的 TLS 加密套件
...
-   當應用程式傳遞 .SCH \_ 使用強式加密時允許 \_ \_ ： Microsoft 安全通道提供者會在應用程式使用 .sch 時，篩選出已知的弱式加密套件（ \_ 使用強式 \_ \_ 加密旗標）。 在 Windows 10 中，除了 RC4、DES、匯出和 null 加密套件之外，還會篩選掉1607和 Windows Server 2016 版本。
...
針對 Windows 10、1607版和 Windows Server 2016，會根據預設使用 Microsoft Schannel 提供者來啟用下列加密套件，並依照此優先順序排列：
...
| \_ \_ \_ \_ 具有 \_ DES \_ CBC \_ SHA 的 TLS DHE DSS EXPORT1024<br/>                                        | No<br/>                       | TLS 1.2、TLS 1.1、TLS 1.0、SSL 3。0<br/> |



 

從 Windows 10，1607版和 Windows Server 2016 開始，預設會啟用下列 PSK 加密套件，並依預設使用 Microsoft Schannel 提供者：
