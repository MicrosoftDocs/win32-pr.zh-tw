...
ms.locfileid: "119141061"
---
# <a name="iscardverifyresetsecuritystate-method"></a>ISCardVerify：： ResetSecurityState 方法

\[**ResetSecurityState** 方法可用於 [需求] 區段中指定的作業系統。 它無法用於 Windows Server 2003 Service Pack 1 (SP1) 和更新版本、Windows Vista、Windows Server 2008 和後續版本的作業系統。 [智慧卡模組](/previous-versions/windows/desktop/secsmart/smart-card-modules)提供類似的功能。\]
