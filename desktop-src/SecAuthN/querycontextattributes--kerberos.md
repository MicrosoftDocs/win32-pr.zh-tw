---
description: 可讓傳輸應用程式查詢 [*安全性內容*](../secgloss/s-gly.md)特定屬性的 Kerberos [*安全性封裝*](../secgloss/s-gly.md)。
ms.assetid: 8e80a9ed-0631-4932-aacc-ba3badcbd0a5
title: QueryContextAttributes (Kerberos) 函式 (Sspi.h)
ms.topic: reference
ms.date: 07/25/2019
...
ms.locfileid: "118920163"
---
# <a name="querycontextattributes-kerberos-function"></a>QueryCoNtextAttributes (Kerberos) 函數

**QueryCoNtextAttributes (Kerberos)** 函數可讓傳輸應用程式查詢 [*安全性內容*](../secgloss/s-gly.md)特定 [*屬性*](../secgloss/a-gly.md#_security_attribute_gly)的 Kerberos [*安全性封裝*](../secgloss/s-gly.md)。
