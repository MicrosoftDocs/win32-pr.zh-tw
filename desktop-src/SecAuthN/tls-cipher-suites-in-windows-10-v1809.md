...
ms.locfileid: "117786167"
---
# <a name="tls-cipher-suites-in-windows-10-v1809"></a>Windows 10 v1809 中的 TLS 加密套件
...
若為 Windows 10 版本1809，則會根據預設使用 Microsoft Schannel 提供者，啟用下列加密套件並依此優先順序排序：
