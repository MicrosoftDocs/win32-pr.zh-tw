...
ms.locfileid: "119883138"
---
# <a name="getting-a-certificate-for-schannel"></a>取得 Schannel 的憑證

下列範例顯示取得憑證 [**\_ 內容**](/windows/desktop/api/wincrypt/ns-wincrypt-cert_context) 結構的步驟，其中包含憑證; 您應該選取適用于您應用程式的憑證和憑證存放區。

此範例示範如何透過安全通道 [**認證結構， \_**](/windows/desktop/api/Schannel/ns-schannel-schannel_cred)開啟 [*憑證存放區*](/windows/desktop/SecGloss/c-gly)並尋找將傳遞給 [**AcquireCredentialsHandle**](/windows/win32/api/sspi/nf-sspi-acquirecredentialshandlea)函數的憑證。
