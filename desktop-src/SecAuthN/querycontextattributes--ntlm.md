---
description: 可讓傳輸應用程式查詢 [安全性內容](../secgloss/s-gly.md)特定屬性的 NTLM [*安全性封裝*](../secgloss/s-gly.md)。
ms.assetid: cfa545e7-c5d9-4ffd-bbba-669d2bd3df2d
title: QueryContextAttributes (NTLM) 函式 (Sspi.h)
ms.topic: reference
ms.date: 07/25/2019
...
ms.locfileid: "118920096"
---
# <a name="querycontextattributes-ntlm-function"></a>QueryCoNtextAttributes (NTLM) 函數

**QueryCoNtextAttributes (NTLM)** 函數可讓傳輸應用程式查詢 [安全性內容](../secgloss/s-gly.md)特定 [*屬性*](../secgloss/a-gly.md#_security_attribute_gly)的 NTLM [*安全性封裝*](../secgloss/s-gly.md)。
