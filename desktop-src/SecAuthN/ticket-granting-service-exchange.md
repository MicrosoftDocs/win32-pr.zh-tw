...
1.  使用者工作站上的 Kerberos 用戶端會藉由傳送至 [*金鑰發佈中心*](../secgloss/k-gly.md) (KDC) 的訊息來要求服務的 [*認證*](../secgloss/c-gly.md)，該訊息類型為 KRB \_ TGS \_ 要求 (Kerberos Ticket-Granting 服務要求) 。 此訊息包含用戶端要求認證的服務身分識別、以使用者的新登入 [*工作階段金鑰*](../secgloss/s-gly.md)加密的驗證器訊息，以及從 [驗證服務交換](authentication-service-exchange.md)取得的 TGT。
