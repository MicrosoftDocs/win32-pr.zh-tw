...
---
# <a name="iscardcmdget_replystatus-method"></a>ISCardCmd：： get \_ ReplyStatus 方法

\[**Get \_ ReplyStatus** 方法可用於 [需求] 區段中指定的作業系統。 它無法在 Windows Server 2003 （含 Service Pack 1） (SP1) 和更新版本、Windows Vista、Windows Server 2008 和後續版本的作業系統中使用。 [智慧卡模組](/previous-versions/windows/desktop/secsmart/smart-card-modules)提供類似的功能。\]

**Get \_ ReplyStatus** 方法會抓取 [*回復 APDU 的*](../secgloss/r-gly.md)訊息狀態字組。
...
| <dl> <dt>**E \_ INVALIDARG**</dt> </dl>  | *PwStatus* 參數無效。<br/>  |
| <dl> <dt>**E \_ 指標**</dt> </dl>     | 在 *pwStatus* 中傳遞了錯誤指標。<br/> |
...
若要設定回復 APDU 的訊息狀態文字，請呼叫 [**put \_ ReplyStatus**](iscardcmd-put-replystatus.md)。
...
下列範例示範如何取出 [*回復 APDU*](../secgloss/r-gly.md)的訊息狀態字組。 此範例假設 pISCardCmd 是 [**ISCardCmd**](iscardcmd.md) 介面實例的有效指標。
