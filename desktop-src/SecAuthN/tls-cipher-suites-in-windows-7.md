...
Windows 7、Windows 8 和 Windows Server 2012 會由變更優先順序的3042058更新 Windows Update 更新。 如需詳細資訊，請參閱 [Microsoft 資訊安全諮詢 3042058](/security-updates/SecurityAdvisories/2015/3042058) 。 依預設，Microsoft Schannel 提供者預設會啟用下列加密套件，並依此優先順序排列：
