...
ms.locfileid: "117786177"
---
# <a name="tls-cipher-suites-in-windows-10-v1709"></a>Windows 10 v1709 中的 TLS 加密套件
...
針對 Windows 10 （1709版），使用 Microsoft Schannel 提供者預設會啟用下列加密套件，並依照此優先順序排序：
