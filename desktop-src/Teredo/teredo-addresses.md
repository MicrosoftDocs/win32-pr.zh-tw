...
-   **Teredo 首碼**
    ...
    前32位是針對 Teredo 首碼，這對所有 Teredo 位址都相同。 Windows XP 和 Windows Server 2003 一開始使用的是3FFE：831F：：/32 Teredo 前置詞。 在 RFC 4380 中為 Teredo 定義的前置詞是2001::/32，而是 Windows Vista 和 Windows Server 2008 中 Teredo 所使用的前置詞。 使用 Microsoft 資訊安全公告 MS06-064 更新時，執行 Windows XP 和 Windows Server 2003 的電腦將使用 2001::/32 Teredo 首碼。
