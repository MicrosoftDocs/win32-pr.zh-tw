---
title: DirectDraw 介面
description: 本章節包含與 DirectDraw 元件搭配使用之介面的相關參考資訊。
...
ms.locfileid: "106968668"
---
# <a name="directdraw-interfaces"></a>DirectDraw 介面

本章節包含與 DirectDraw 元件搭配使用之介面的相關參考資訊。 涵蓋下列介面：
