---
title: 允許和封鎖應用程式和使用者
description: 下列範例程式碼示範如何新增依使用者或應用程式識別碼評估的篩選準則。
...
---
# <a name="permitting-and-blocking-applications-and-users"></a><span data-ttu-id="e8cd5-103">允許和封鎖應用程式和使用者</span><span class="sxs-lookup"><span data-stu-id="e8cd5-103">Permitting and Blocking Applications and Users</span></span>

<span data-ttu-id="e8cd5-104">下列範例程式碼示範如何新增依使用者或應用程式識別碼評估的篩選準則。</span><span class="sxs-lookup"><span data-stu-id="e8cd5-104">The following sample code demonstrates how to add a filter that evaluates by user or application ID.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="e8cd5-105">相關主題</span><span class="sxs-lookup"><span data-stu-id="e8cd5-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="e8cd5-106">**篩選每個篩選層級的可用條件**</span><span class="sxs-lookup"><span data-stu-id="e8cd5-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
