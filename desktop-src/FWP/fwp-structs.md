...
-   FWPM \_ NET \_ 活動：
    -   [**FWPM \_NET \_ EVENT0**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event0) (Windows Vista) 
...
-   FWPM \_ NET \_ 事件 \_ 分類 \_ 捨棄：
    -   [**FWPM \_\_ \_ \_ DROP0**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_classify_drop0) (Windows Vista) 的淨活動分類
...
-   FWPM \_ NET \_ EVENT \_ IKEEXT \_ EM \_ 失敗：
    ...
    -   [**FWPM \_NET \_ EVENT \_ IKEEXT \_ EM \_ FAILURE1**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_ikeext_em_failure1) (Windows 7 和更新版本) 
-   FWPM \_ NET \_ EVENT \_ IKEEXT \_ MM \_ 失敗：
    ...
    -   [**FWPM \_NET \_ EVENT \_ IKEEXT \_ MM \_ FAILURE1**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_net_event_ikeext_mm_failure1) (Windows 7 和更新版本) 
...
-   FWPM \_ 提供者 \_ 內容：
    -   [**FWPM \_PROVIDER \_ CONTEXT0**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_provider_context0) (Windows Vista) 
    -   [**FWPM \_PROVIDER \_ CONTEXT1**](/windows/desktop/api/Fwpmtypes/ns-fwpmtypes-fwpm_provider_context1) (Windows 7) 
...
-   IKEEXT \_ 驗證 \_ 方法：
    -   [**IKEEXT \_驗證 \_ METHOD0**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_authentication_method0) (Windows Vista) 
    -   [**IKEEXT \_驗證 \_ METHOD1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_authentication_method1) (Windows 7) 
...
-   IKEEXT \_ 憑證 \_ 驗證：
    -   [**IKEEXT \_憑證 \_ AUTHENTICATION0**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_certificate_authentication0) (Windows Vista) 
    -   [**IKEEXT \_憑證 \_ AUTHENTICATION1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_certificate_authentication1) (Windows 7) 
    -   [**IKEEXT \_憑證 \_ AUTHENTICATION2**](/windows/win32/api/iketypes/ns-iketypes-ikeext_certificate_authentication2) (Windows 8) 
-   IKEEXT \_ \_ 憑證認證：
    -   [**IKEEXT \_憑證 \_ CREDENTIAL0**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_certificate_credential0) (Windows Vista) 
    -   [**IKEEXT \_憑證 \_ CREDENTIAL1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_certificate_credential1) (Windows 7 和更新版本) 
...
-   IKEEXT \_ 一般 \_ 統計資料：
    -   [**IKEEXT \_COMMON \_ STATISTICS0**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_common_statistics0) (Windows Vista) 
...
-   IKEEXT \_ 認證：
    ...
    -   [**IKEEXT \_CREDENTIAL1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_credential1) (Windows 7 和更新版本) 
-   IKEEXT \_ 認證 \_ 配對：
    -   [**IKEEXT \_認證 \_ PAIR0**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_credential_pair0) (Windows Vista) 
    -   [**IKEEXT \_認證 \_ PAIR1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_credential_pair1) (Windows 7 和更新版本) 
-   IKEEXT \_ 認證：
    -   [**IKEEXT \_CREDENTIALS0**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_credentials0) (Windows Vista) 
    -   [**IKEEXT \_CREDENTIALS1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_credentials1) (Windows 7 和更新版本) 
-   [**IKEEXT \_ EAP \_ AUTHENTICATION0**](/windows/win32/api/iketypes/ns-iketypes-ikeext_eap_authentication0)
-   IKEEXT \_ EM \_ 原則：
    -   [**IKEEXT \_ (\_**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_em_policy0) Windows Vista) 的 EM POLICY0
    -   [**IKEEXT \_EM \_ POLICY1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_em_policy1) (Windows 7) 
...
-   IKEEXT \_ IP \_ 版本的 \_ 特定 \_ 一般 \_ 統計資料：
    ...
    -   [**IKEEXT \_IP \_ 版本 \_ 特定的 \_ COMMON \_ STATISTICS1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_ip_version_specific_common_statistics1) (Windows 7 和更新版本) 
...
-   IKEEXT \_ KEYMODULE \_ 統計資料：
    -   [**IKEEXT \_KERBEROS \_ AUTHENTICATION0**](/windows/win32/api/iketypes/ns-iketypes-ikeext_kerberos_authentication0) (Windows Vista 和 Windows 7) 
    -   [**IKEEXT \_KERBEROS \_ AUTHENTICATION1**](/windows/win32/api/iketypes/ns-iketypes-ikeext_kerberos_authentication1) (Windows 8) 
-   -   IKEEXT \_ KEYMODULE \_ 統計資料：
    -   [**IKEEXT \_KEYMODULE \_ STATISTICS0**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_keymodule_statistics0) (Windows Vista) 
    -   [**IKEEXT \_KEYMODULE \_ STATISTICS1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_keymodule_statistics1) (Windows 7 和更新版本) 
...
-   IKEEXT \_ 預先共用 \_ 金鑰 \_ 驗證：
    -   [**IKEEXT \_預先共用的 \_ 金鑰 \_ AUTHENTICATION0**](/windows/win32/api/iketypes/ns-iketypes-ikeext_preshared_key_authentication0) (Windows Vista) 
    -   [**IKEEXT \_預先共用的 \_ 金鑰 \_ AUTHENTICATION1**](/windows/win32/api/iketypes/ns-iketypes-ikeext_preshared_key_authentication1) (Windows 7 和更新版本) 
...
-   IKEEXT \_ SA \_ 詳細資料：
    -   [**IKEEXT \_SA \_ DETAILS0**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_sa_details0) (Windows Vista) 
    -   [**IKEEXT \_SA \_ DETAILS1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_sa_details1) (Windows 7 和更新版本) 
...
-   IKEEXT \_ 統計資料：
    ...
    -   [**IKEEXT \_STATISTICS1**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_statistics1) (Windows 7 和更新版本) 
...
-   IPSEC \_ 匯總 \_ 捨棄封 \_ 包 \_ 統計資料：
    -   [**IPSEC \_匯總 \_ 捨棄封 \_ 包 \_ STATISTICS0**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_aggregate_drop_packet_statistics0) (Windows Vista) 
    -   [**IPSEC \_匯總 \_ 捨棄封 \_ 包 \_ STATISTICS1**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_aggregate_drop_packet_statistics1) (Windows 7 和更新版本) 
...
-   IPSEC \_ GETSPI：
    ...
    -   [**IPSEC \_GETSPI1**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_getspi1) (Windows 7 和更新版本) 
...
-   IPSEC \_ 加密 \_ 原則：
    -   [**IPSEC \_加密 \_ POLICY0**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_keying_policy0) (Windows Vista 和 Windows 7) 
...
-   IPSEC \_ SA 配套 \_ ：
    -   [**IPSEC \_SA \_ BUNDLE0**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_sa_bundle0) (Windows Vista) 
    -   [**IPSEC \_SA \_ BUNDLE1**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_sa_bundle1) (Windows 7 和更新版本) 
-   [**IPSEC \_ SA \_ 加密 \_ INFORMATION0**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_sa_cipher_information0)
-   IPSEC \_ SA 內容 \_ ：
    -   [**IPSEC \_SA \_ CONTEXT0**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_sa_context0) (Windows Vista) 
    -   [**IPSEC \_SA \_ CONTEXT1**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_sa_context1) (Windows 7 和更新版本) 
...
-   IPSEC \_ SA \_ 詳細資料：
    -   [**IPSEC \_SA \_ DETAILS0**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_sa_details0) (Windows Vista) 
    -   [**IPSEC \_SA \_ DETAILS1**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_sa_details1) (Windows 7 和更新版本) 
...
-   IPSEC \_ 統計資料：
    ...
    -   [**IPSEC \_STATISTICS1**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_statistics1) (Windows 7 和更新版本) 
...
-   IPSEC \_ 流量：
    ...
    -   [**IPSEC \_流量 1**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_traffic1) (Windows 7 和更新版本) 
-   IPSEC \_ 流量 \_ 統計資料：
    -   [**IPSEC \_ (\_**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_traffic_statistics0) Windows Vista) 的流量 STATISTICS0
    -   [**IPSEC \_流量 \_ STATISTICS1**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_traffic_statistics1) (Windows 7 和更新版本) 
-   IPSEC \_ 傳輸 \_ 原則：
    -   [**IPSEC \_傳輸 \_ POLICY0**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_transport_policy0) (Windows Vista) 
...
-   IPSEC \_ 通道 \_ 端點：
    -   [**IPSEC \_通道 \_ ENDPOINTS0**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_tunnel_endpoints0) (Windows Vista) 
...
-   IPSEC \_ 通道 \_ 原則：
    -   [**IPSEC \_通道 \_ POLICY0**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_tunnel_policy0) (Windows Vista) 
