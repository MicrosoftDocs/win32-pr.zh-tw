---
title: 保留埠
description: 下列範例程式碼示範如何使用資源指派層，為系統管理員保留一系列的埠。
...
ms.locfileid: "104372669"
---
# <a name="reserving-ports"></a><span data-ttu-id="7aa19-103">保留埠</span><span class="sxs-lookup"><span data-stu-id="7aa19-103">Reserving Ports</span></span>

<span data-ttu-id="7aa19-104">下列範例程式碼示範如何使用資源指派層，為系統管理員保留一系列的埠。</span><span class="sxs-lookup"><span data-stu-id="7aa19-104">The following sample code demonstrates how to use the resource assignment layers to reserve a range of ports for administrators.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="7aa19-105">相關主題</span><span class="sxs-lookup"><span data-stu-id="7aa19-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="7aa19-106">**篩選每個篩選層級的可用條件**</span><span class="sxs-lookup"><span data-stu-id="7aa19-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
