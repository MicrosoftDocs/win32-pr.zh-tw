...
Windows 篩選平台 (WFP) 功能與網際網路通訊協定安全性 (IPsec) 如下所示。
...
-   IPsecGetStatistics:
    ...
    -   [**IPsecGetStatistics1**](/windows/desktop/api/Fwpmu/nf-fwpmu-ipsecgetstatistics1) (Windows 7 及更新版本) 
...
-   IPsecSaCoNtextAddInbound:
    ...
    -   [**IPsecSaCoNtextAddInbound1**](/windows/desktop/api/Fwpmu/nf-fwpmu-ipsecsacontextaddinbound1) (Windows 7 及更新版本) 
-   IPsecSaCoNtextAddOutbound:
    ...
    -   [**IPsecSaCoNtextAddOutbound1**](/windows/desktop/api/Fwpmu/nf-fwpmu-ipsecsacontextaddoutbound1) (Windows 7 及更新版本) 
-   IPsecSaCoNtextCreate:
    -   [**IPsecSaCoNtextCreate0**](/windows/desktop/api/Fwpmu/nf-fwpmu-ipsecsacontextcreate0) (Windows Vista) 
    -   [**IPsecSaCoNtextCreate1**](/windows/desktop/api/Fwpmu/nf-fwpmu-ipsecsacontextcreate1) (Windows 7 及更新版本) 
...
-   IPsecSaCoNtextEnum:
    ...
    -   [**IPsecSaCoNtextEnum1**](/windows/desktop/api/Fwpmu/nf-fwpmu-ipsecsacontextenum1) (Windows 7 及更新版本) 
...
-   IPsecSaCoNtextGetById:
    ...
    -   [**IPsecSaCoNtextGetById1**](/windows/desktop/api/Fwpmu/nf-fwpmu-ipsecsacontextgetbyid1) (Windows 7 及更新版本) 
-   IPsecSaCoNtextGetSpi:
    -   [**IPsecSaCoNtextGetSpi0**](/windows/desktop/api/Fwpmu/nf-fwpmu-ipsecsacontextgetspi0) (Windows Vista) 
    -   [**IPsecSaCoNtextGetSpi1**](/windows/desktop/api/Fwpmu/nf-fwpmu-ipsecsacontextgetspi1) (Windows 7 及更新版本) 
...
-   IPsecSaEnum:
    ...
    -   [**IPsecSaEnum1**](/windows/desktop/api/Fwpmu/nf-fwpmu-ipsecsaenum1) (Windows 7 及更新版本) 
