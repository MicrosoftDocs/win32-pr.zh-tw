---
title: UDP 封包流程
description: 在典型的 UDP 會話期間，會將 Windows 篩選平台 (WFP) 篩選引擎的各層的順序。
...
ms.locfileid: "119746638"
---
# <a name="udp-packet-flows"></a>UDP 封包流程

本節說明在一般 UDP 會話期間，Windows 篩選平台 (WFP) 篩選引擎的層級的順序。
...
-   bind： FWPM \_ LAYER ALE 系結重新 \_ \_ \_ 導向 \_ V4 (Windows 7/Windows Server 2008 R2) 
...
-   bind： FWPM \_ LAYER ALE 系結重新 \_ \_ \_ 導向 \_ V4 (Windows 7/Windows Server 2008 R2) 
-   bind： FWPM \_ LAYER \_ ALE \_ 資源 \_ 指派 \_ V4
-   sendto： FWPM \_ LAYER \_ ALE \_ CONNECT 重新 \_ 導向 \_ V4 (Windows 7/Windows Server 2008 R2) 
