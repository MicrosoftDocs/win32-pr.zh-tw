...
ms.locfileid: "119535368"
---
# <a name="using-classify-options"></a>使用分類選項

下列程式碼範例示範如何使用篩選分類選項來改變篩選進程。

## <a name="enable-loose-source-mapping-for-a-remote-udp-port"></a>啟用遠端 UDP 埠的鬆散來源對應
...
## <a name="modify-the-idle-lifetimes-for-ale-flows"></a>修改 ALE 流程的閒置存留期
