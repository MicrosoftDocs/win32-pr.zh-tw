---
title: 阻礙刪除篩選
description: 下列範例程式碼示範如何藉由設定 DACL 來讓篩選難以刪除。
...
ms.locfileid: "104301363"
---
# <a name="hindering-filter-deletion"></a><span data-ttu-id="a5cea-103">阻礙刪除篩選</span><span class="sxs-lookup"><span data-stu-id="a5cea-103">Hindering Filter Deletion</span></span>

<span data-ttu-id="a5cea-104">下列範例程式碼示範如何藉由設定 DACL 來讓篩選變得難以刪除。</span><span class="sxs-lookup"><span data-stu-id="a5cea-104">The following example code demonstrates how to make a filter difficult to delete by setting a DACL.</span></span>
