---
title: 手動 SA 金鑰
description: 下列範例程式碼示範如何使用 Windows 篩選平台 (SA) 建立安全性關聯。
...
ms.locfileid: "104507012"
---
# <a name="manual-sa-keying"></a><span data-ttu-id="06df9-103">手動 SA 金鑰</span><span class="sxs-lookup"><span data-stu-id="06df9-103">Manual SA Keying</span></span>

<span data-ttu-id="06df9-104">下列範例程式碼示範如何使用 Windows 篩選平台 (SA) 建立安全性關聯。</span><span class="sxs-lookup"><span data-stu-id="06df9-104">The following sample code demonstrates how to create Security Associations (SA) using Windows Filtering Platform.</span></span>
