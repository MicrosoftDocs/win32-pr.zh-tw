---
title: 防止埠掃描
description: 下列範例程式碼示範如何使用隱匿捨棄和無訊息卸載來防止埠掃描。
...
---
# <a name="preventing-port-scanning"></a><span data-ttu-id="135ab-103">防止埠掃描</span><span class="sxs-lookup"><span data-stu-id="135ab-103">Preventing Port Scanning</span></span>

<span data-ttu-id="135ab-104">下列範例程式碼示範如何使用隱匿捨棄和無訊息卸載來防止埠掃描。</span><span class="sxs-lookup"><span data-stu-id="135ab-104">The following sample code demonstrates how to prevent port scanning using stealth discards and silent drops.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="135ab-105">相關主題</span><span class="sxs-lookup"><span data-stu-id="135ab-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="135ab-106">**篩選每個篩選層級的可用條件**</span><span class="sxs-lookup"><span data-stu-id="135ab-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
