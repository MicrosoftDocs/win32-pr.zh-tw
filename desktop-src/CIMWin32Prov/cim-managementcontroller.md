...
**CIM \_ ManagementController** 類別與管理控制器的功能和管理有關。
...
**CIM \_ ManagementController** 類別具有下列類型的成員：
...
**CIM \_ ManagementController** 類別具有這些方法。



| 方法                                                                          | 描述                                                                                                                              |
|:--------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-managementcontroller.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-managementcontroller.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
**CIM \_ ManagementController** 類別具有這些屬性。
...
**Cim \_ ManagementController** 類別衍生自 [**cim \_ 控制器**](cim-controller.md)。
