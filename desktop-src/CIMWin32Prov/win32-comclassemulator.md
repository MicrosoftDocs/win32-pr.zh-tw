...
ms.locfileid: "119751378"
---
# <a name="win32_comclassemulator-class"></a>Win32 \_ ComClassEmulator 類別

**Win32 \_ ComClassEmulator** 關聯 [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)會將元件物件模型的兩個版本關聯 (COM) 類別。
...
**Win32 \_ ComClassEmulator** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ ComClassEmulator** 類別具有這些屬性。
...
代表 COM 元件的實例的參考，該元件包含模擬舊版元件的介面。
...
代表 COM 元件之實例的參考，該元件具有可由新版本的元件模擬的介面。
