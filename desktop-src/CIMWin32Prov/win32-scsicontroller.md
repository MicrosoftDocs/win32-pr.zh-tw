...
**Win32 \_ microsoft.hyperv.powershell.scsicontroller** 類別具有下列類型的成員：
...
**Win32 \_ microsoft.hyperv.powershell.scsicontroller** 類別具有這些方法。



| 方法            | 描述                                                                                                                                                                                      |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **重設**         | 未實作。 若要執行此方法，請參閱 [**CIM \_ microsoft.hyperv.powershell.scsicontroller**](cim-scsicontroller.md)中的 [**Reset**](reset-method-in-class-cim-controller.md)方法。<br/>                 |
| **SetPowerState** | 未實作。 若要執行此方法，請參閱 [**CIM \_ microsoft.hyperv.powershell.scsicontroller**](cim-scsicontroller.md)中的 [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md)方法。<br/> |
...
**Win32 \_ microsoft.hyperv.powershell.scsicontroller** 類別具有這些屬性。
...
**TimeOfLastReset** 值之後發生的超時時間。

這個屬性繼承自 [**CIM \_ microsoft.hyperv.powershell.scsicontroller**](cim-scsicontroller.md)。
...
限定詞： [**Key**](../wmisdk/key-qualifier.md)、 [**Override**](../wmisdk/standard-qualifiers.md) ( "DeviceId" ) 、 [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32Registry \| 硬體 \\ \\ DeviceMap \\ \\ Scsi" ) 
</dt> </dl>

具有系統上其他裝置之 SCSI 控制器的唯一識別碼。
...
限定詞：已 [**淘汰**](../wmisdk/standard-wmi-qualifiers.md)， [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32Registry \| 硬體 \\ \\ DeviceMap \\ \\ Scsi \| ScsiPort" ) 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Services \\ \\ Class \| PortDriver" ) 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Enum \\ \\ Root \| HWRevision" ) 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32Registry \| 硬體 \\ \\ DeviceMap \\ \\ Scsi \| ScsiPort" ) 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Enum \\ \\ Root \| 製造業" ) 
</dt> </dl>
...
**Win32 \_ microsoft.hyperv.powershell.scsicontroller** 類別衍生自 [**CIM \_ microsoft.hyperv.powershell.scsicontroller**](cim-scsicontroller.md)。
