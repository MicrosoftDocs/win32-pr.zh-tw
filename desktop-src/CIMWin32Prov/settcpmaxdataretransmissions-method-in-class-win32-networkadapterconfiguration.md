...
ms.locfileid: "119439268"
---
# <a name="settcpmaxdataretransmissions-method-of-the-win32_networkadapterconfiguration-class"></a>Win32 >networkadapterconfiguration 類別的 SetTcpMaxDataRetransmissions 方法 \_

**SetTcpMaxDataRetransmissions** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)靜態方法是用來設定在中止連接之前 TCP 重新傳輸個別資料區段的次數。
...
*TcpMaxDataRetransmissions* \[在\]
</dt> <dd>

在中止連接之前 TCP 重新傳輸個別資料區段的次數。 有效範圍： 0-0xFFFFFFFF。
...
重新傳輸超時會加倍，並在連線上每次重新傳輸。

## <a name="examples"></a>範例

[ [修改允許的 TCP 資料重新傳輸的最大值](https://Gallery.TechNet.Microsoft.Com/8a581692-7950-412e-bd28-74f223b27827) ] VBScript 範例會設定 tcp 在放棄工作之前，會嘗試重新傳輸個別資料區段的次數。
