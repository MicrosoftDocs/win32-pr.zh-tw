...
---
# <a name="copyex-method-of-the-win32_directory-class"></a>Win32 目錄類別的 CopyEx 方法 \_

**CopyEx** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會將物件路徑中指定的邏輯目錄專案檔或目錄複寫到 *FileName* 參數所指定的位置。 這個方法是 [**複製**](copy-method-in-class-win32-directory.md) 方法的擴充版本。 如果需要覆寫現有的邏輯檔案，則不支援複製。
...
**CopyEx** 方法失敗之檔案或目錄的名稱。 如果方法成功，此參數將會是 **null** 。
...
若 **為 true**，則會在 [**CIM \_ LogicalFile**](cim-logicalfile.md) 實例指定的目錄中以遞迴方式複製檔案和目錄。
