...
---
# <a name="changesecuritypermissions-method-of-the-win32_pagefile-class"></a>Win32 \_ 分頁檔類別的 ChangeSecurityPermissions 方法

**ChangeSecurityPermissions** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會變更物件路徑中所指定之邏輯分頁檔的安全性許可權。 如果邏輯檔案是目錄，則 **ChangeSecurityPermissions** 是遞迴的，並且會變更目錄包含的所有檔案和子目錄的安全性許可權。
