...
ms.locfileid: "119919088"
---
# <a name="cim_system-class-cimwin32-wmi-providers"></a>CIM_System 類別 (CIMWin32 WMI 提供者) 

**CIM \_ 系統** 類別會匯總 managed 系統專案的可列舉集合。 匯總會以整體功能的形式運作。 在系統的任何特定子類別內，都有一個定義完善的 managed 系統專案類別清單，這些類別的實例必須加以匯總。

**Cim \_ 系統** 物件及其衍生型為 cim 的最上層物件。 它們提供許多元件的範圍，而且必須有唯一的系統金鑰。
...
**Cim \_ 系統** 類別衍生自 [**cim \_ LogicalElement**](cim-logicalelement.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ 系統** 的 WMI 類別，請參閱 [Win32 類別](win32-provider.md)。
