...
**Copy** 方法會將物件路徑中指定的邏輯檔案 (或目錄) 複製到輸入參數所指定的位置。 如果需要覆寫現有的邏輯檔案，則不支援複製。 這個方法繼承自 [**CIM \_ LogicalFile**](cim-logicalfile.md)。
...
[CIM \_ 目錄](copy-method-in-class-cim-directory.md)
</dt> <dt>
