...
**Cim \_ 轉速計** 類別存在，可回溯相容于舊版 CIM 架構定義。 在2.2 版中，有 [**cim \_ 感應器**](cim-sensor.md) 和 [**cim \_ NumericSensor**](cim-numericsensor.md) 類別的新增功能，不再需要。 您可以藉由將 **SensorType** 屬性（繼承自 **CIM \_ 感應器**）設定為 5 ( 「轉速計」 ) 來定義轉速計。 此類別的其他屬性會硬式編碼為對應至感應器階層中定義的常數值。
...
| 方法                                                                | 描述                                                                                                                              |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-tachometer.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-tachometer.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
限定詞： [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( 「百分之一%」 ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "CurrentReading" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "LowerThresholdCritical" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "LowerThresholdFatal" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "LowerThresholdNonCritical" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MaxReadable" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MinReadable" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "NominalReading" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "NormalMax" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "NormalMin" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( 「解析」 ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( 「每分鐘的十分之一度」 ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( 「容錯」 ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( 「每分鐘的旋轉」 ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "UpperThresholdCritical" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "UpperThresholdFatal" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "UpperThresholdNonCritical" ) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "每分鐘旋轉" ) 
</dt> </dl>
...
**Cim \_ 流速計** 類別衍生自 [**cim \_ NumericSensor**](cim-numericsensor.md)。
