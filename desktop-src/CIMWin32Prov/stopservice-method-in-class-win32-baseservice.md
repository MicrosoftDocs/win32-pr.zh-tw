...
ms.locfileid: "119751898"
---
# <a name="stopservice-method-of-the-win32_baseservice-class"></a>Win32 BaseService 類別的 StopService 方法 \_

**StopService** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會停止衍生自 [**Win32 \_ BaseService**](win32-baseservice.md)的物件所代表的服務。
