...
**CIM \_ 目錄** 類別代表以邏輯方式分組其包含之資料檔案的檔案類型，並提供群組檔案的路徑資訊。
...
| 方法                                                                                           | 描述                                                                                                                                              |
|:-------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**ChangeSecurityPermissions**](changesecuritypermissions-method-in-class-cim-directory.md)     | 變更物件路徑中指定之邏輯檔案的安全性許可權。 不是由 WMI 所執行。<br/>                                   |
| [**ChangeSecurityPermissionsEx**](changesecuritypermissionsex-method-in-class-cim-directory.md) | 變更物件路徑中指定之邏輯檔案的安全性許可權。 不是由 WMI 所執行。<br/>                                   |
| [**壓縮**](compress-method-in-class-cim-directory.md)                                       | 壓縮物件路徑中指定的邏輯檔案 (或目錄) 。 不是由 WMI 所執行。<br/>                                              |
| [**CompressEx**](compressex-method-in-class-cim-directory.md)                                   | 壓縮物件路徑中指定的邏輯檔案 (或目錄) 。 不是由 WMI 所執行。<br/>                                              |
| [**複製**](copy-method-in-class-cim-directory.md)                                               | 將物件路徑中指定的邏輯檔案 (或目錄) 複製到輸入參數所指定的位置。 不是由 WMI 所執行。<br/> |
| [**CopyEx**](copyex-method-in-class-cim-directory.md)                                           | 將物件路徑中指定的邏輯檔案 (或目錄) 複製到輸入參數所指定的位置。 不是由 WMI 所執行。<br/> |
| [**刪除**](delete-method-in-class-cim-directory.md)                                           | 刪除在物件路徑中指定的邏輯檔案 (或目錄) 。 不是由 WMI 所執行。<br/>                                                 |
| [**DeleteEx**](deleteex-method-in-class-cim-directory.md)                                       | 刪除在物件路徑中指定的邏輯檔案 (或目錄) 。 不是由 WMI 所執行。<br/>                                                 |
| [**GetEffectivePermission**](geteffectivepermission-method-in-class-cim-directory.md)           | 判斷呼叫端是否具有 **許可權** 引數所指定的匯總許可權。 不是由 WMI 所執行。<br/>                |
| [**重新命名**](rename-method-in-class-cim-directory.md)                                           | 重新命名在物件路徑中指定的邏輯檔案 (或目錄) 。 不是由 WMI 所執行。<br/>                                                 |
| [**TakeOwnerShip**](takeownership-method-in-class-cim-directory.md)                             | 取得物件路徑中指定之邏輯檔案的擁有權。 不是由 WMI 所執行。<br/>                                                   |
| [**TakeOwnerShipEx**](takeownershipex-method-in-class-cim-directory.md)                         | 取得物件路徑中指定之邏輯檔案的擁有權。 不是由 WMI 所執行。<br/>                                                   |
| [**解壓**](uncompress-method-in-class-cim-directory.md)                                   | Uncompresses 邏輯檔案 (或在物件路徑中指定的目錄) 。 不是由 WMI 所執行。<br/>                                            |
| [**UncompressEx**](uncompressex-method-in-class-cim-directory.md)                               | Uncompresses 邏輯檔案 (或在物件路徑中指定的目錄) 。 不是由 WMI 所執行。<br/>                                            |
...
位元遮罩，表示存取或執行目錄上特定作業所需的存取權限。 如需值，請參閱檔案 [**和目錄存取權限常數**](/windows/desktop/WmiSdk/file-and-directory-access-rights-constants)。
...
DOS 相容的檔案名。 這個屬性繼承自 [**CIM \_ LogicalFile**](cim-logicalfile.md)。
...
檔案的路徑，包括開頭和尾端的反斜線。 這個屬性繼承自 [**CIM \_ LogicalFile**](cim-logicalfile.md)。
...
**Cim \_ 目錄** 類別衍生自 [**cim \_ LogicalFile**](cim-logicalfile.md)。

WMI 不會執行這個類別。 如需衍生自 **CIM \_ 目錄** 之類別的詳細資訊，請參閱 [Win32 類別](win32-provider.md)。
