...
**Win32 \_ MotherboardDevice** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)代表包含 Windows 電腦系統中央元件的裝置。
...
**Win32 \_ MotherboardDevice** 類別具有下列類型的成員：
...
**Win32 \_ MotherboardDevice** 類別具有這些方法。
...
**Win32 \_ MotherboardDevice** 類別具有這些屬性。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "Win32Registry \| HKEY \_ LOCAL \_ MACHINE \\ \\ 硬體 \\ \\ DESCRIPTION \\ \\ System \\ \\ MultifunctionAdapter \| Identifier" ) 
</dt> </dl>
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "Win32Registry \| HKEY \_ LOCAL \_ MACHINE \\ \\ 硬體 \\ \\ DESCRIPTION \\ \\ System" ) 
</dt> </dl>
...
**Win32 \_ MotherboardDevice** 類別衍生自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。

## <a name="examples"></a>範例

下列 [JavaScript](https://Gallery.TechNet.Microsoft.Com/05bbadf8-1356-43a6-82fc-fcab40233fe5) 和 [PowerShell](https://Gallery.TechNet.Microsoft.Com/cb520044-836e-425c-8c12-a9586d1c0e6e) 程式碼範例會取出主機板資訊。

下列 VBScript 程式碼範例會取出主機板資訊。
