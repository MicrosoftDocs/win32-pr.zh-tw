...
---
# <a name="pauseservice-method-of-the-win32_baseservice-class"></a>Win32 BaseService 類別的 PauseService 方法 \_

**PauseService** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會嘗試將參考的服務置於暫停狀態。
