...
---
# <a name="win32_pnpdevicepropertyreal32array-class"></a>Win32 \_ PnPDevicePropertyReal32Array 類別

代表由 **real32** 元素陣列組成的 PnP 裝置屬性。
...
**Win32 \_ PnPDevicePropertyReal32Array** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ PnPDevicePropertyReal32Array** 類別具有這些屬性。
