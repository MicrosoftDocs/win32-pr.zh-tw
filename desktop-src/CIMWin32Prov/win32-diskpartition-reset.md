...
ms.locfileid: "118172173"
---
# <a name="reset-method-of-the-win32_diskpartition-class"></a>Win32 DiskPartition 類別的 Reset 方法 \_

要求重設邏輯裝置。 這個方法繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
