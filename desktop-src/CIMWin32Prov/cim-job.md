...
**CIM \_ 作業** 類別代表系統的工作單位，例如列印工作。 作業與進程不同，因為可以排程工作。
...
**Cim \_ 作業** 類別衍生自 [**cim \_ LogicalElement**](cim-logicalelement.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ 工作** 的類別，請參閱 [Win32 類別](win32-provider.md)。
