...
ms.locfileid: "119700778"
---
# <a name="reset-method-of-the-cim_tapedrive-class"></a>CIM Disable-tapedrive 類別的 Reset 方法 \_

CIM Disable-tapedrive 類別的 **reset** 方法會 \_ 要求重設邏輯裝置。 這個方法繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
...
[CIM \_ disable-tapedrive](reset-method-in-class-cim-tapedrive.md)
</dt> <dt>
