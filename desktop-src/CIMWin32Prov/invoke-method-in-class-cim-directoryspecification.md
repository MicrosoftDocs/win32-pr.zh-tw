...
ms.locfileid: "118419302"
---
# <a name="invoke-method-of-the-cim_directoryspecification-class"></a>CIM DirectorySpecification 類別的 Invoke 方法 \_

[**CIM \_ DirectorySpecification**](cim-directoryspecification.md)類別的 **Invoke** 方法會評估特定檢查。 有關方法如何評估 CIM 內容中特定檢查的詳細資料，請參閱非抽象 [**cim \_ 檢查**](cim-check.md) 子類別。 此方法繼承自 **CIM \_ 檢查**。
...
如果成功，則傳回0，如果不支援方法，則傳回1，而任何其他值則表示錯誤。
