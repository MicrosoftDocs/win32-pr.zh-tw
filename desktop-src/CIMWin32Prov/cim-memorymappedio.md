...
ms.locfileid: "119021056"
---
# <a name="cim_memorymappedio-class"></a>CIM \_ MemoryMappedIO 類別

**CIM \_ MemoryMappedIO** 類別代表電腦架構記憶體對應 i/o。 此類別會解決記憶體和埠 i/o 資源。
...
**CIM \_ MemoryMappedIO** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ MemoryMappedIO** 類別具有這些屬性。
...
限定詞： [**CIM \_ Key**](/windows/desktop/WmiSdk/standard-wmi-qualifiers)， [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) (」 MIF。DMTF \| 記憶體對應 i/o 001.1」 \| ) 
</dt> </dl>
...
**Cim \_ MemoryMappedIO** 類別衍生自 [**cim \_ SystemResource**](cim-systemresource.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ MemoryMappedIO** 的類別，請參閱 [Win32 類別](win32-provider.md)。
