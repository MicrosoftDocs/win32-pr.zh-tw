...
**CIM \_ BinarySensor** 類別提供布林輸出。 **CurrentState** 和 **PossibleStates** 屬性已新增至 sensoring，因此不再需要 **CIM \_ BinarySensor** 子類別，不過，它是為了回溯相容性而保留。 您可以具現化具有兩種可能狀態的感應器，以建立二進位感應器。
...
**CIM \_ BinarySensor** 類別具有下列類型的成員：
...
**CIM \_ BinarySensor** 類別具有這些方法。



| 方法                                                                  | 描述                                                                                                                                |
|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-binarysensor.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-binarysensor.md) | 定義邏輯裝置的預期電源狀態，以及裝置何時應進入該狀態。 不是由 WMI 所執行。<br/> |
...
二進位感應器的 ' False ' 值描述。 您可以向使用者顯示此資訊。
...
二進位感應器的 ' True ' 值的描述。 您可以向使用者顯示此資訊。
...
**Cim \_ BinarySensor** 類別衍生自 [**cim \_ 感應器**](cim-sensor.md)。
