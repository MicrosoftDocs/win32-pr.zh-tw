...
ms.locfileid: "119504948"
---
# <a name="copy-method-of-the-win32_codecfile-class"></a>Win32 CodecFile 類別的 Copy 方法 \_

**複製** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會將物件路徑中指定的邏輯編解碼器檔案或目錄複寫到輸入參數所指定的位置。 如果需要覆寫現有的邏輯檔案，則不支援複製。
