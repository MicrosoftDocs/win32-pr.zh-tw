...
---
# <a name="cim_diskspacecheck-class"></a>CIM \_ DiskSpaceCheck 類別

**CIM \_ DiskSpaceCheck** 類別會檢查系統的可用磁碟空間量，並在 **AvailableDiskSpace** 屬性中指定它。 詳細資料會 [**與 cim \_**](cim-computersystem.md) FileSystem 物件（描述系統內容）相關聯之 [**Cim \_ FileSystem**](cim-filesystem.md)物件的 **AvailableSpace** 屬性中的值進行比較。 當 **AvailableSpace** 屬性的值大於或等於 **AvailableDiskSpace** 屬性中指定的值時，就會滿足條件。
...
**CIM \_ DiskSpaceCheck** 類別具有下列類型的成員：
...
**CIM \_ DiskSpaceCheck** 類別具有這些方法。



| 方法                                                      | 描述                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**調用**](invoke-method-in-class-cim-diskspacecheck.md) | 採取特定動作。 不是由 WMI 所執行。<br/> |
...
限定詞： [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ( 「[**CIM \_ 檔案系統**](cim-filesystem.md)」。**AvailableSpace** ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" kb ") 
</dt> </dl>
