...
api_location:
- CIMWin32.dll
ms.openlocfilehash: f3c5021af0a6c022a2247b6e7360dfe8cfa1cbc021edff2aee048efecd8cd290
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118008249"
---
# <a name="win32_pnpdevicepropertyuint8-class"></a>Win32 \_ PnPDevicePropertyUint8 類別

代表 **Uint8** 類型的 PnP 裝置屬性。
...
**Win32 \_ PnPDevicePropertyUint8** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ PnPDevicePropertyUint8** 類別具有這些屬性。
