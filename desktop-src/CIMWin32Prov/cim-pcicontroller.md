...
---
# <a name="cim_pcicontroller-class"></a>CIM \_ PCIController 類別

**CIM \_ PCIController** 類別代表 PCI 控制器的屬性和管理。 此類別中的屬性及其子類別會定義于 PCI SIG 所發佈的各種 PCI 規格中。
...
**CIM \_ PCIController** 類別具有下列類型的成員：
...
**CIM \_ PCIController** 類別具有這些方法。



| 方法                                                                   | 描述                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-pcicontroller.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
裝置的可用性和狀態。 這個屬性繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
...
支援 [**SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) 方法。
...
您可以叫用 [**SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) 方法，並將 *>powerstate* 參數設定為 5 ( 「電源週期」 ) 。
...
您可以叫用 [**SetPowerState**](setpowerstate-method-in-class-cim-pcicontroller.md) 方法，並將 *>powerstate* 參數設定為 5 ( 「電源週期」 ) ，並將 *時間* 參數設定為特定日期和時間（或間隔），以進行電源開啟。
...
**Cim \_ PCIController** 類別衍生自 [**cim \_ 控制器**](cim-controller.md)。
