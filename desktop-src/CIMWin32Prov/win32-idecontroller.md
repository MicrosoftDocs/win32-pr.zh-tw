...
ms.locfileid: "120085778"
---
# <a name="win32_idecontroller-class"></a>Win32 \_ IDEController 類別

**Win32 \_ IDEController** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)管理 (IDE) 控制器裝置的整合式裝置電子產品的功能。
...
**Win32 \_ IDEController** 類別具有下列類型的成員：
...
**Win32 \_ IDEController** 類別具有這些方法。



| 方法            | 描述                                                                                                                                                                                                |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **重設**         | 未實作。 若要執行此方法，請參閱 [**CIM \_ 控制器**](cim-controller.md)中的 [**Reset**](reset-method-in-class-cim-controller.md)方法以取得檔。<br/>                 |
| **SetPowerState** | 未實作。 若要執行此方法，請參閱 [**CIM \_ 控制器**](cim-controller.md)中的 [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md)方法，以取得檔。<br/> |
...
**Win32 \_ IDEController** 類別具有這些屬性。
...
**LastErrorCode** 屬性中所記錄錯誤的詳細資訊，以及任何可能採取之矯正措施的相關資訊。
...
若 **為 TRUE**，則裝置可以處於電源管理狀態並進入暫停模式，依此類推。 屬性不表示電源管理功能目前已啟用，只有邏輯裝置能夠進行電源管理。
...
**Win32 \_ IDEController** 類別衍生自 [**CIM \_ 控制器**](cim-controller.md)。
