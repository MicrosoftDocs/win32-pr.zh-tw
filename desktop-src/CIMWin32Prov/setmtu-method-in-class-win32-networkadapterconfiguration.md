...
**SetMTU** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)靜態方法是用來設定網路介面 (MTU) 的預設最大傳輸單位。
...
網路介面的預設最大傳輸單位 (MTU) 。 此值的範圍會跨越基礎網路所支援的 MTU (68) 的最小封包大小。
...
MTU 是傳輸會透過基礎網路傳輸的封包大小上限 (位元組) 。 大小包含傳輸標頭。

請注意，IP 資料包可以橫跨多個封包。 大於基礎網路預設值的值，會導致使用網路預設 MTU 的傳輸。 小於68的值會導致使用68的 MTU 進行傳輸。

## <a name="examples"></a>範例

[ [修改所有網路介面卡的 MTU](https://Gallery.TechNet.Microsoft.Com/49c26363-d46c-4288-9c8d-feb0a1982998) ] VBScript 範例會設定電腦上安裝之所有網路介面卡的最大傳輸單位。
