...
ms.locfileid: "118958917"
---
# <a name="win32_pnpdevicepropertydatetime-class"></a>Win32 \_ PnPDevicePropertyDateTime 類別

表示 **datetime** 類型的 PnP 裝置屬性。
...
**Win32 \_ PnPDevicePropertyDateTime** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ PnPDevicePropertyDateTime** 類別具有這些屬性。
