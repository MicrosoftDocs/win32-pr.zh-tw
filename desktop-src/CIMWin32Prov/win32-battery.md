...
電池所支援的資料規格版本號碼。 如果電池不支援此功能，此值應保留空白。
...
[列出 UPS 資訊](https://Gallery.TechNet.Microsoft.Com/7196121e-97de-4290-9939-26d0ce266270)Perl 範例會列出連接到電腦的不斷電供應系統來源的相關資訊。
