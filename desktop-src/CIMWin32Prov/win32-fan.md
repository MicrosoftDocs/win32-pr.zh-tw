...
api_location:
- CIMWin32.dll
ms.openlocfilehash: 6540125e89303d60e4f56eccb0921b5f7359d2683ec79407f8495953e7d2ad33
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "120085798"
---
# <a name="win32_fan-class"></a>Win32 \_ 風扇類別

**Win32 \_ 風扇** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)代表電腦系統中的風扇裝置屬性。 例如，CPU 冷卻風扇。
...
| 方法            | 描述                                                                                                                                                                                  |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **重設**         | 未實作。 若要執行此方法，請參閱 [**CIM \_ 風扇**](cim-fan.md)中的 [**Reset**](reset-method-in-class-cim-controller.md)方法以取得檔。<br/>                 |
| **SetPowerState** | 未實作。 若要執行此方法，請參閱 [**CIM \_ 風扇**](cim-fan.md)中適用于檔的 [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md)方法。<br/> |
| **SetSpeed**      | 未實作。<br/>                                                                                                                                                                  |
...
若 **為 True**，則冷卻裝置會提供作用中的 (，而非被動) 冷卻。

這個屬性繼承自 [**CIM \_ CoolingDevice**](cim-coolingdevice.md)。
...
第一個具體類別的名稱，這個類別會出現在建立實例時所使用的繼承鏈中。 當搭配類別的其他索引鍵屬性使用時，屬性允許唯一識別此類別的所有實例和其子類別。
...
限定詞： [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( 「每分鐘的旋轉」 ) 
</dt> </dl>

目前要求的風扇速度（在每分鐘的旋轉中定義），當支援變速風扇時 (**VariableSpeed** 為 **TRUE**) 。 目前的速度取決於與使用 [**cim \_ AssociatedSensor**](cim-associatedsensor.md)關聯性之風扇相關聯的感應器 ([**CIM \_ 流速**](cim-tachometer.md)) 。

這個屬性繼承自 [**CIM \_ 風扇**](cim-fan.md)。
...
識別風扇裝置。 這個屬性繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
...
**Win32 \_ 風扇** 類別衍生自 [**CIM \_ 風扇**](cim-fan.md)。

## <a name="examples"></a>範例

[列出電腦風扇資訊](https://Gallery.TechNet.Microsoft.Com/d1534503-704f-4450-8dab-f3e760bf818c)PowerShell 範例會捕獲電腦上所安裝之冷卻風扇的相關資訊。

下列範例會捕獲電腦上所安裝之冷卻風扇的相關資訊。
