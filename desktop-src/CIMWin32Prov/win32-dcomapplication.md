...
**Win32 \_ DCOMApplication** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)代表 DCOM 應用程式的屬性。
...
**Win32 \_ DCOMApplication** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ DCOMApplication** 類別具有這些屬性。
...
**Win32 \_ DCOMApplication** 類別衍生自 [**win32 \_ COMApplication**](win32-comapplication.md)。
