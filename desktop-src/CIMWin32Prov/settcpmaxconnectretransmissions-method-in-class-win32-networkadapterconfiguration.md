...
ms.locfileid: "119020456"
---
# <a name="settcpmaxconnectretransmissions-method-of-the-win32_networkadapterconfiguration-class"></a>Win32 >networkadapterconfiguration 類別的 SetTcpMaxConnectRetransmissions 方法 \_

**SetTcpMaxConnectRetransmissions** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)靜態方法是用來設定在中止之前 TCP 將會重新傳輸連接要求的嘗試次數。
...
*TcpMaxConnectRetransmissions* \[在\]
</dt> <dd>

TCP 在中止之前將會重新傳輸連接要求的次數。 值的有效範圍為 0-0xFFFFFFFF。
...
初始重新傳輸超時為三秒鐘，每次後續嘗試都會有雙精度浮點數。

## <a name="examples"></a>範例

[ [修改允許的 TCP 連接重新傳輸的最大值](https://Gallery.TechNet.Microsoft.Com/e599c6bc-fa37-457d-b7e3-3c003517ed46) ] VBScript 範例會設定 tcp 在放棄工作之前，會重新傳輸連接嘗試的次數。
...
| 需求 | 值 |
|-------------------------------------|-----------------------------------------------------------------------------------------|
| 最低支援的用戶端<br/> | Windowsvista，Windows vista<br/>                                                 |
| 最低支援的伺服器<br/> | Windows伺服器2008、Windows server 2008<br/>                                     |
| 命名空間<br/>                | 根 \\ CIMV2<br/>                                                                  |
