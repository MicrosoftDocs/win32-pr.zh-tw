...
ms.locfileid: "119971889"
---
# <a name="win32_pnpdevicepropertysecuritydescriptorarray-class"></a>Win32 \_ PnPDevicePropertySecurityDescriptorArray 類別

代表由 [**Win32 \_ SecurityDescriptor**](/previous-versions/windows/desktop/secrcw32prov/win32-securitydescriptor) 元素陣列組成的 PnP 裝置屬性。
...
**Win32 \_ PnPDevicePropertySecurityDescriptorArray** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ PnPDevicePropertySecurityDescriptorArray** 類別具有這些屬性。
...
資料類型： **[**Win32 \_ SecurityDescriptor**](/previous-versions/windows/desktop/secrcw32prov/win32-securitydescriptor)** 陣列
</dt> <dt>
