...
ms.locfileid: "119439948"
---
# <a name="setkeepalivetime-method-of-the-win32_networkadapterconfiguration-class"></a>Win32 >networkadapterconfiguration 類別的 SetKeepAliveTime 方法 \_

**SetKeepAliveTime** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)靜態方法是用來設定 TCP 嘗試驗證閒置連線是否仍可供使用的頻率，方法是傳送 keep-alive 封包。
...
如果遠端系統仍然可連線且正常運作，它會確認「保持運作傳輸」。 預設不會傳送存活的封包。 這項功能可以在應用程式的連接中啟用。

## <a name="examples"></a>範例

[ [修改所有網路介面卡的即時存留時間](https://Gallery.TechNet.Microsoft.Com/35c1b0ac-285d-4baa-be6e-d3fb0b461676) ] VBScript 範例會將電腦上所有網路介面卡的存留時間設定為300000毫秒 (5 分鐘) 。
