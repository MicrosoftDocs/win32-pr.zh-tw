...
ms.locfileid: "119322288"
---
# <a name="cim_collectedcollections-class"></a>CIM \_ CollectedCollections 類別

**CIM \_ CollectedCollections** 類別是一種匯總關聯，代表 mse 集合中所包含之受管理系統元素 (MSE) 。
...
**CIM \_ CollectedCollections** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ CollectedCollections** 類別具有這些屬性。
