...
**Win32 \_ ParallelPort** [WMI 類別](../wmisdk/retrieving-a-class.md)代表執行 Windows 之電腦系統上的平行埠屬性。
...
**Win32 \_ ParallelPort** 類別具有下列類型的成員：
...
**Win32 \_ ParallelPort** 類別具有這些方法。



| 方法            | 描述                                                                                                                                                                                              |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **重設**         | 未實作。 若要執行此方法，請參閱 [**CIM \_ ParallelController**](cim-parallelcontroller.md)中的 [**Reset**](reset-method-in-class-cim-controller.md)方法。<br/>                 |
| **SetPowerState** | 未實作。 若要執行此方法，請參閱 [**CIM \_ ParallelController**](cim-parallelcontroller.md)中的 [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md)方法。<br/> |
...
限定詞： [**ArrayType**](../wmisdk/standard-qualifiers.md) ( 「已編制索引」 ) ， [**MAPPINGSTRINGS**](../wmisdk/standard-qualifiers.md) (」 MIF。DMTF \| Parallel 埠 \| 003.8 ") ， [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ ParallelController**](cim-parallelcontroller.md).**CapabilityDescriptions**") 
</dt> </dl>

平行控制器的功能陣列。

這個屬性繼承自 [**CIM \_ ParallelController**](cim-parallelcontroller.md)。
...
限定詞： [**ArrayType**](../wmisdk/standard-qualifiers.md) ( "Indexed" ) ， [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ( "[**CIM \_ ParallelController**](cim-parallelcontroller.md)。**功能**") 
</dt> </dl>

**功能** 陣列中所指出之任何平行控制器功能的更詳細說明的陣列。 這個陣列的每個專案都與位於相同索引的 **功能** 陣列中的專案相關。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 平行埠 \| 003.7 ") 
</dt> </dl>
...
有關 **LastErrorCode** 中所記錄錯誤的詳細資訊，以及可能採取之矯正措施的相關資訊。
...
若 **為 TRUE**，則作業系統會自動偵測到平行埠。 如果 **為 FALSE**，則表示埠是以其他方式偵測 (例如透過主控台) 手動新增。
...
這個屬性繼承自 [**CIM \_ 控制器**](cim-controller.md)。 值會顯示在下列清單中。
...
上次重設控制器的日期和時間。 這可能表示控制器已關機或重新初始化。
...
**Win32 \_ ParallelPort** 類別衍生自 [**CIM \_ ParallelController**](cim-parallelcontroller.md)。
