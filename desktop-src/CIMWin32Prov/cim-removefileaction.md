...
**CIM \_ RemoveFileAction** 類別會卸載檔案。
...
**CIM \_ RemoveFileAction** 類別具有下列類型的成員：
...
**CIM \_ RemoveFileAction** 類別具有這些方法。
...
**CIM \_ RemoveFileAction** 類別具有這些屬性。
...
**Cim \_ RemoveFileAction** 類別衍生自 [**cim \_ FileAction**](cim-fileaction.md)。
