...
**Win32 \_ 冷藏庫取出** [WMI 類別](../wmisdk/retrieving-a-class.md)代表冷藏庫取出裝置的屬性。
...
**Win32 \_ 冷藏庫取出** 類別具有這些方法。



| 方法            | 描述                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **重設**         | 未實作。 若要執行此方法，請參閱 [**CIM \_ 冷藏庫取出**](cim-refrigeration.md)中的 [**Reset**](reset-method-in-class-cim-controller.md)方法。<br/>                 |
| **SetPowerState** | 未實作。 若要執行此方法，請參閱 [**CIM \_ 冷藏庫取出**](cim-refrigeration.md)中的 [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md)方法。<br/> |
...
**Win32 \_ 冷藏庫取出** 類別衍生自 [**CIM \_ 冷藏庫取出**](cim-refrigeration.md)。
