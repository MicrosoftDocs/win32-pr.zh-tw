...
ms.locfileid: "120077488"
---
# <a name="geteffectivepermission-method-of-the-cim_devicefile-class"></a>CIM DeviceFile 類別的 GetEffectivePermission 方法 \_

**GetEffectivePermission** 方法會判斷呼叫端是否具有 [**CIM \_ DeviceFile**](cim-devicefile.md)物件的匯總許可權，以及檔案或目錄所在的共用（如同 **許可權** 引數所指定）。 這個方法繼承自 [**CIM \_ LogicalFile**](cim-logicalfile.md)。
...
如果呼叫具有必要的許可權，則傳回 **True** ;否則，它會傳回 **True**。
