...
ms.locfileid: "119920758"
---
# <a name="cim_redundancygroup-class"></a>CIM \_ RedundancyGroup 類別

**CIM \_ RedundancyGroup** 類別代表 managed 系統專案的集合，這些元素表示匯總的元件會一起提供冗余。 在冗余群組中匯總的所有元素都應該是相同物件類別的具現化。
...
**CIM \_ RedundancyGroup** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ RedundancyGroup** 類別具有這些屬性。
...
**Cim \_ RedundancyGroup** 類別衍生自 [**cim \_ LogicalElement**](cim-logicalelement.md)。
