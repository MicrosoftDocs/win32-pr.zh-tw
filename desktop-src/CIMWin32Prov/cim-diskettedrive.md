...
api_location:
- CIMWin32.dll
ms.openlocfilehash: d1a1f50838cdb6f0fe6a9a633484c59f1f6f76690128d073e0955c5d0e50ac21
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119080732"
---
# <a name="cim_diskettedrive-class-cimwin32-wmi-providers"></a>CIM_DisketteDrive 類別 (CIMWin32 WMI 提供者) 

**CIM \_ DisketteDrive** 類別代表磁片磁碟機的功能和管理。
...
**CIM \_ DisketteDrive** 類別具有下列類型的成員：
...
**Cim \_ DisketteDrive** 類別衍生自 [**cim \_ MediaAccessDevice**](cim-mediaaccessdevice.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ DisketteDrive** 的類別，請參閱 [Win32 類別](win32-provider.md)。
