...
CIM Microsoft.hyperv.powershell.scsicontroller 類別的 **reset** 方法會 \_ 要求重設邏輯裝置。 這個方法繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
...
[CIM \_ microsoft.hyperv.powershell.scsicontroller](reset-method-in-class-cim-scsicontroller.md)
</dt> <dt>
