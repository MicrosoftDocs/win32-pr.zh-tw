...
ms.locfileid: "118678280"
---
# <a name="cim_physicalcomponent-class"></a>CIM \_ PhysicalComponent 類別

**CIM \_ PhysicalComponent** 類別代表封裝內的低層級或基本元件。 不是連結、連接器或封裝的實體元素是此類別 (或成員) 的子系。 例如，內接式數據機卡上的 UART 晶片組會是子類別 (如果有定義其他屬性或關聯) 或 **CIM \_ PhysicalComponent** 的實例。
...
**CIM \_ PhysicalComponent** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ PhysicalComponent** 類別具有這些屬性。
...
**Cim \_ PhysicalComponent** 類別衍生自 [**cim \_ PhysicalElement**](cim-physicalelement.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ PHYSICALCOMPONENT** 的 WMI 類別，請參閱 [Win32 類別](win32-provider.md)。
