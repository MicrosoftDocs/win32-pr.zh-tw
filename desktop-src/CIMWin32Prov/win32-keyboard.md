...
api_location:
- CIMWin32.dll
ms.openlocfilehash: e71e81c75a28656dbeccdb9fb5133e2521a5821e6db7c75ac51560c0516bf9bb
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119878638"
---
# <a name="win32_keyboard-class"></a>Win32 \_ 鍵盤類別

**Win32 \_ 鍵盤** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)代表安裝在執行 Windows 之電腦系統上的鍵盤。
...
| 方法            | 描述                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **重設**         | 未實作。 若要執行此方法，請參閱 [**CIM \_ 鍵盤**](cim-keyboard.md)中的 [**Reset**](reset-method-in-class-cim-controller.md)方法以取得檔。<br/>                 |
| **SetPowerState** | 未實作。 若要執行此方法，請參閱 [**CIM \_ 鍵盤**](cim-keyboard.md)中的 [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md)方法，以取得檔。<br/> |
...
限定詞：覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "DeviceId" ) ， [**金鑰**](/windows/desktop/WmiSdk/key-qualifier)
</dt> </dl>
...
**LastErrorCode** 中所記錄錯誤的詳細資訊，以及可能採取的更正動作。
...
這個屬性繼承自 [**CIM \_ 鍵盤**](cim-keyboard.md)。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| 系統硬體安全性 \| 001.2」 ) 
</dt> </dl>

在鍵盤上啟用的硬體層級密碼狀態 (值 = 4) ，防止本機輸入。
...
**Win32 \_ 鍵盤** 類別衍生自 [**CIM \_ 鍵盤**](cim-keyboard.md)。

## <a name="examples"></a>範例

下列 PowerShell 程式碼會尋找無線鍵盤和滑鼠。
