...
---
# <a name="win32_voltageprobe-class"></a>Win32 \_ VoltageProbe 類別

**Win32 \_ VoltageProbe** [WMI 類別](../wmisdk/retrieving-a-class.md)代表電壓感應器的屬性 (電子電壓表) 。
...
**Win32 \_ VoltageProbe** 類別具有下列類型的成員：
...
**Win32 \_ VoltageProbe** 類別具有這些方法。



| 方法            | 描述                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **重設**         | 未實作。 若要執行此方法，請參閱 [**CIM \_ 電壓感應器**](cim-voltagesensor.md)中的 [**Reset**](reset-method-in-class-cim-controller.md)方法。<br/>                 |
| **SetPowerState** | 未實作。 若要執行此方法，請參閱 [**CIM \_ 電壓感應器**](cim-voltagesensor.md)中的 [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md)方法。<br/> |
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.19 ") 
</dt> </dl>

測量的屬性之感應器的精確度。 精確度值會記錄為加號或減號百分之一%。 精確度（連同解析和容錯）是用來計算測量實體屬性的實際值。 精確度可能會有所不同，取決於裝置在其動態範圍中是否為線性。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.5 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.13 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.15 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>

感應器閾值會指定 (最小值和最大值的範圍，) 判斷感應器是否在正常、非關鍵性、重大或嚴重狀況下運作。 如果 **CurrentReading** 低於 **LowerThresholdFatal**，則目前的狀態為「嚴重」。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.11 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>

感應器閾值會指定 (最小值和最大值的範圍，) 判斷感應器是否在正常、非關鍵性、重大或嚴重狀況下運作。 如果 **CurrentReading** 介於 **LowerThresholdNonCritical** 和 **UpperThresholdNonCritical** 之間，則感應器會回報正常值。 如果 **CurrentReading** 介於 **LowerThresholdNonCritical** 和 **LowerThresholdCritical** 之間，則目前的狀態為非關鍵性。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.9 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.10 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.6 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.7 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.8 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>

指示，讓使用者指出數值感應器的一般最小範圍。
...
若 **為 TRUE**，則裝置可以是電源管理的，這表示它可以進入暫停模式，依此類推。 屬性不會指出電源管理功能目前已啟用，但它會指出邏輯裝置能夠進行電源管理。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.17 「) ， [**單位**](../wmisdk/standard-qualifiers.md) ( 「十分之一個毫伏」 ) 
</dt> </dl>

感應器解決測量屬性差異的能力。 此值可能會不同，且取決於裝置在其動態範圍中是否為線性。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.18 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>

測量屬性之感應器的容錯。 容錯功能以及解析度和精確度，可用來計算測量實體屬性的實際值。 容錯可能會有所不同，取決於裝置在其動態範圍中是否為線性。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.14 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>

感應器臨界值會指定範圍 (最小值和最大值，) 判斷感應器是否正常運作、非關鍵性、重大或嚴重狀況。 如果 **CurrentReading** 介於 **UpperThresholdCritical** 和 **UpperThresholdFatal** 之間，則目前的狀態為「嚴重」。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.16 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>

感應器臨界值會指定範圍 (最小值和最大值，) 判斷感應器是否正常運作、非關鍵性、重大或嚴重狀況。 如果 **CurrentReading** 超過 **UpperThresholdFatal**，則目前的狀態為「嚴重」。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 電壓探查 \| 001.12 ") ， [**單位**](../wmisdk/standard-qualifiers.md) (" 毫伏 ") 
</dt> </dl>

感應器臨界值會指定範圍 (最小值和最大值，) 判斷感應器是否正常運作、非關鍵性、重大或嚴重狀況。 如果 **CurrentReading** 介於 **LowerThresholdNonCritical** 和 **UpperThresholdNonCritical** 之間，則感應器會回報正常值。 如果 **CurrentReading** 介於 **UpperThresholdNonCritical** 和 **UpperThresholdCritical** 之間，則目前的狀態為非關鍵性。
...
**Win32 \_ VoltageProbe** 類別衍生自 [**CIM \_ 電壓感應器**](cim-voltagesensor.md)。
