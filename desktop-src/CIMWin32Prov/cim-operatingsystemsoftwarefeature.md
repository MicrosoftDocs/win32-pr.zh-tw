...
ms.locfileid: "119080492"
---
# <a name="cim_operatingsystemsoftwarefeature-class"></a>CIM \_ OperatingSystemSoftwareFeature 類別

**CIM \_ OperatingSystemSoftwareFeature** 類別代表組成作業系統的軟體功能。
...
**CIM \_ OperatingSystemSoftwareFeature** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ OperatingSystemSoftwareFeature** 類別具有這些屬性。
...
描述作業系統的 [**CIM \_ 作業系統**](cim-operatingsystem.md) 。
...
[**CIM \_ SoftwareFeature**](cim-softwarefeature.md) ，描述構成作業系統的軟體功能。
