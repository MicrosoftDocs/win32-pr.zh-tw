...
**CIM \_ CreateDirectoryAction** 類別會為要安裝在本機的軟體元素建立空的目錄。
...
**CIM \_ CreateDirectoryAction** 類別具有下列類型的成員：
...
**CIM \_ CreateDirectoryAction** 類別具有這些方法。
...
**CIM \_ CreateDirectoryAction** 類別具有這些屬性。
...
**Cim \_ CreateDirectoryAction** 類別衍生自 [**cim \_ DirectoryAction**](cim-directoryaction.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ CreateDirectoryAction** 的類別，請參閱 [Win32 類別](win32-provider.md)。
