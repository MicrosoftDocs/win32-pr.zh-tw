...
**Win32 \_ 群組** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)代表群組帳戶的相關資料。 群組帳戶允許變更使用者清單的存取權限。 範例： Marketing2。
...
| 方法                                               | 描述                        |
|:-----------------------------------------------------|:-----------------------------------|
| [**重新命名**](rename-method-in-class-win32-group.md) | 變更組名。<br/> |
...
**Win32 \_ 群組** 類別衍生自 [**win32 \_ 帳戶**](win32-account.md)。

## <a name="examples"></a>範例

下列程式碼是取自 TechNet 資源庫上使用 WMI VBScript 程式碼範例的 [清單本機群組](https://Gallery.TechNet.Microsoft.Com/4474e390-776d-428e-906d-20668ce5933f) ，會使用 **Win32 \_ 群組** 來傳回電腦上找到之本機群組的相關資訊。
