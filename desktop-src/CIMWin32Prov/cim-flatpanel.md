...
**CIM \_ FlatPanel** 類別代表平面化面板邏輯裝置的功能和管理。
...
**CIM \_ FlatPanel** 類別具有這些方法。



| 方法                                                               | 描述                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-flatpanel.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-flatpanel.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
<span id="Passive_Matrix_LCD"></span><span id="passive_matrix_lcd"></span><span id="PASSIVE_MATRIX_LCD"></span>**被動式矩陣 LCD** (2) 
...
<span id="Active_Matrix_LCD"></span><span id="active_matrix_lcd"></span><span id="ACTIVE_MATRIX_LCD"></span>**主動式矩陣 LCD** (3) 
...
<span id="Cholesteric_LCD"></span><span id="cholesteric_lcd"></span><span id="CHOLESTERIC_LCD"></span>**CHOLESTERIC LCD** (4) 
...
<span id="Field_Emission_Display"></span><span id="field_emission_display"></span><span id="FIELD_EMISSION_DISPLAY"></span>**欄位排放顯示** (5) 
...
<span id="Electro_Luminescent_Display"></span><span id="electro_luminescent_display"></span><span id="ELECTRO_LUMINESCENT_DISPLAY"></span>**電磁 Luminescent 顯示器** (6) 
...
<span id="Gas_Plasma"></span><span id="gas_plasma"></span><span id="GAS_PLASMA"></span>**天然氣等離子** (7) 
...
<span id="LED"></span><span id="led"></span>**LED** (8) 
...
限定詞： [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( "圖元" ) 
</dt> </dl>
...
**Cim \_ FlatPanel** 類別衍生自 [**cim \_ 顯示**](cim-display.md)。
