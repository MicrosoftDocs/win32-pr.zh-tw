...
api_location:
- CIMWin32.dll
ms.openlocfilehash: 54830f4849beec37f9e7043e459449d32f32f3dcdc01967a412ba6182347e07d
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119751288"
---
# <a name="win32_heatpipe-class"></a>Win32 \_ HeatPipe 類別

**Win32 \_ HeatPipe** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)代表熱度管道冷卻裝置的屬性。
...
**Win32 \_ HeatPipe** 類別具有這些方法。



| 方法            | 描述                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **重設**         | 未實作。 若要執行此方法，請參閱 [**CIM \_ HeatPipe**](cim-heatpipe.md)中的 [**Reset**](reset-method-in-class-cim-controller.md)方法以取得檔。<br/>                 |
| **SetPowerState** | 未實作。 若要執行此方法，請參閱 [**CIM \_ HeatPipe**](cim-heatpipe.md)中的 [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md)方法，以取得檔。<br/> |
...
若 **為 TRUE**，則裝置可以處於電源管理狀態並進入暫停模式，依此類推。 屬性不會指出電源管理功能目前已啟用，只有邏輯裝置能夠進行電源管理。
...
**Win32 \_ HeatPipe** 類別衍生自 [**CIM \_ HeatPipe**](cim-heatpipe.md)。
