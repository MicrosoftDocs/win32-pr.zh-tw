...
ms.locfileid: "117834169"
---
# <a name="win32_scsicontrollerdevice-class"></a>Win32 \_ SCSIControllerDevice 類別

**Win32 \_ SCSIControllerDevice** 關聯 [WMI 類別](../wmisdk/retrieving-a-class.md)會將小型電腦系統介面與 (SCSI) 控制器以及邏輯裝置 (磁片磁碟機) 連接。
...
**Win32 \_ SCSIControllerDevice** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ SCSIControllerDevice** 類別具有這些屬性。
...
資料類型： **Win32 \_ microsoft.hyperv.powershell.scsicontroller**
</dt> <dt>

存取類型：唯讀
</dt> <dt>

限定詞： [**Key**](../wmisdk/key-qualifier.md)、 [**Override**](../wmisdk/standard-qualifiers.md) ( "Antecedent" ) 、 [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "CIM \| Win32 \_ microsoft.hyperv.powershell.scsicontroller" ) 
</dt> </dl>

[**Win32 \_ microsoft.hyperv.powershell.scsicontroller**](win32-scsicontroller.md) antecedent 參考代表與此裝置相關聯的 SCSI 控制器。
...
[**CIM \_ LogicalDevice**](cim-logicaldevice.md)相依參考代表連接至 SCSI 控制器的邏輯裝置。
...
**Win32 \_ SCSIControllerDevice** 類別衍生自 [**CIM \_ ControlledBy**](cim-controlledby.md)。
