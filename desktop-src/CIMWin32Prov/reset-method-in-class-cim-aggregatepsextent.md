...
---
# <a name="reset-method-of-the-cim_aggregatepsextent-class"></a>CIM AggregatePSExtent 類別的 Reset 方法 \_

CIM AggregatePSExtent 類別的 **reset** 方法會 \_ 要求重設邏輯裝置。 這個方法繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
...
[CIM \_ AggregatePSExtent](reset-method-in-class-cim-aggregatepsextent.md)
</dt> <dt>
