...
---
# <a name="win32_pnpdevicepropertyuint16-class"></a>Win32 \_ PnPDevicePropertyUint16 類別

表示類型為 **Uint16** 的 PnP 裝置屬性。
...
**Win32 \_ PnPDevicePropertyUint16** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ PnPDevicePropertyUint16** 類別具有這些屬性。
