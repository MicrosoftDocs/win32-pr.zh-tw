...
ms.locfileid: "118959087"
---
# <a name="cim_bootserviceaccessbysap-class"></a>CIM \_ BootServiceAccessBySAP 類別

**CIM \_ BootServiceAccessBySAP** 類別會將開機服務及其存取點產生關聯。
...
**CIM \_ BootServiceAccessBySAP** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ BootServiceAccessBySAP** 類別具有這些屬性。
...
描述開機服務的 [**CIM \_ BootService**](cim-bootservice.md) 。
...
描述開機服務存取點的 [**CIM \_ BootSAP**](cim-bootsap.md) 。

</dd> </dl>

## <a name="remarks"></a>備註

**Cim \_ BootServiceAccessBySAP** 類別衍生自 [**cim \_ ServiceAccessBySAP**](cim-serviceaccessbysap.md)。
