...
ms.locfileid: "119020846"
---
# <a name="cim_systemcomponent-class-cimwin32-wmi-providers"></a>CIM_SystemComponent 類別 (CIMWin32 WMI 提供者) 

**Cim \_ SystemComponent** 類別是一種通用訊息模型 (CIM) 關聯類別，可建立系統與其組成之 managed 系統專案之間的關聯性。
...
[**CIM \_ ManagedSystemElement**](cim-managedsystemelement.md) ，描述屬於系統元件的子項目。

</dd> </dl>

## <a name="remarks"></a>備註

WMI 不會執行這個類別。 針對衍生自 **CIM \_ SYSTEMCOMPONENT** 的 WMI 類別，請參閱 [Win32 類別](win32-provider.md)。
