...
ms.locfileid: "119321348"
---
# <a name="cim_directoryspecificationfile-class"></a>CIM \_ DirectorySpecificationFile 類別

**Cim \_ DirectorySpecificationFile** 關聯代表包含透過參考 [**CIM \_ DirectorySpecification**](cim-directoryspecification.md)類別所指定之檔案的目錄。
...
**CIM \_ DirectorySpecificationFile** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ DirectorySpecificationFile** 類別具有這些屬性。
