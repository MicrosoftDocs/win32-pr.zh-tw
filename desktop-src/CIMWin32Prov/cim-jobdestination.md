...
**CIM \_ JobDestination** 類別代表提交工作以進行處理的位置。 它可以參考包含零或多個作業的佇列，例如包含列印工作的列印佇列。 作業目的地裝載于系統上，類似于在系統上託管服務的方式。
...
**CIM \_ JobDestination** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ JobDestination** 類別具有這些屬性。
...
**Cim \_ JobDestination** 類別衍生自 [**cim \_ LogicalElement**](cim-logicalelement.md)。
