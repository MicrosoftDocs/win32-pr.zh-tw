...
api_location:
- CIMWin32.dll
ms.openlocfilehash: de6e7e83a0fc11bd500bc0a569ce0cda07ee7b4f04befa6b6d3b1aa4b118645b
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118172332"
---
# <a name="win32_comclass-class"></a>Win32 \_ comclass.zip 類別

**Win32 \_ Comclass.zip** 抽象 [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)代表元件物件模型 (COM) 元件的屬性。
...
**Win32 \_ comclass.zip** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ comclass.zip** 類別具有這些屬性。
...
**Win32 \_ comclass.zip** 類別衍生自 [**CIM \_ LogicalElement**](cim-logicalelement.md)。
