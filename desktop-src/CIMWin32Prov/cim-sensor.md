...
api_location:
- CIMWin32.dll
ms.openlocfilehash: ff00b806234c90ea56ccdad0ce31c48d3e74d043cb888be531fd0e4330730fb6
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119919938"
---
# <a name="cim_sensor-class"></a>CIM \_ 感應器類別

**CIM \_ 感應器** 類別代表能夠測量實體屬性特性的硬體裝置 (例如，單一電腦系統) 的溫度或電壓特性。
...
| 方法                                                            | 描述                                                                                                                              |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-sensor.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-sensor.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
**Cim \_ 感應器** 類別衍生自 [**cim \_ LogicalDevice**](cim-logicaldevice.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ 感應器** 的 WMI 類別，請參閱 [Win32 類別](win32-provider.md)。
