...
ms.locfileid: "122882854"
---
# <a name="cim_softwareelementversioncheck-class"></a>CIM \_ SoftwareElementVersionCheck 類別

**CIM \_ SoftwareElementVersionCheck** 類別代表必須存在於環境中的 software 元素類型。 這項檢查可以是特定、最小值、最大值或版本範圍。 若要指定特定版本，則較低和最高版本必須相同。 若要指定最小版本，請只指定較低的版本。 若要指定最大版本，請僅指定最高版本。 若要指定範圍，必須指定上限和較低的版本。 檢查的詳細資料會與 cim SoftwareElement 物件（cim [**\_ InstalledSoftwareElement**](cim-installedsoftwareelement.md)關聯）所 [**參考的 cim \_**](cim-computersystem.md) [**\_**](cim-softwareelement.md)物件中所找到的對應詳細資料進行比較。 至少有一個 **CIM \_ SoftwareElement** 需要滿足要滿足的檢查條件詳細資料。
...
**CIM \_ SoftwareElementVersionCheck** 類別具有下列類型的成員：
...
**CIM \_ SoftwareElementVersionCheck** 類別具有這些方法。



| 方法                                                                   | 描述                                                   |
|:-------------------------------------------------------------------------|:--------------------------------------------------------------|
| [**調用**](invoke-method-in-class-cim-softwareelementversioncheck.md) | 採取特定動作。 不是由 WMI 所執行。<br/> |
...
**CIM \_ SoftwareElementVersionCheck** 類別具有這些屬性。
...
若 **為 TRUE**，則條件應該存在於環境中 (例如，如果檔案是在系統上，則叫 [**用方法應該**](invoke-method-in-class-cim-softwareelementversioncheck.md) 會傳回 **TRUE**) 。 如果 **為 FALSE**，則條件不應該存在 (例如，如果檔案不在系統上，則叫用 **方法應該** 會傳回 **FALSE**) 。
...
限定詞： [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64) ， [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ( "[**CIM \_ SoftwareElement**](cim-softwareelement.md)。**版本**") 
</dt> </dl>
...
限定詞： [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256) ， [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ( "[**CIM \_ SoftwareElement**](cim-softwareelement.md)。**名稱**") 
</dt> </dl>
...
限定詞： [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64) ， [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ( "[**CIM \_ SoftwareElement**](cim-softwareelement.md)。**SoftwareElementState**") 
</dt> </dl>
...
限定詞： [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64) ， [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ( "[**CIM \_ SoftwareElement**](cim-softwareelement.md)。**TargetOperatingSystem**") 
</dt> </dl>
...
這個屬性繼承自 [**CIM \_ 檢查**](cim-check.md) 類別。
