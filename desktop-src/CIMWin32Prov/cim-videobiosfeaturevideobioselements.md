...
ms.locfileid: "119817508"
---
# <a name="cim_videobiosfeaturevideobioselements-class"></a>CIM \_ VideoBIOSFeatureVideoBIOSElements 類別

**CIM \_ VideoBIOSFeatureVideoBIOSElements** 類別會將影片 bios 功能與其匯總的影片 bios 專案產生關聯。
...
**CIM \_ VideoBIOSFeatureVideoBIOSElements** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ VideoBIOSFeatureVideoBIOSElements** 類別具有這些屬性。
...
描述影片 BIOS 功能的 [**CIM \_ VideoBIOSFeature**](cim-videobiosfeature.md) 。
...
[**CIM \_ VideoBIOSElement**](cim-videobioselement.md) ，描述可執行影片 bios 功能所描述之功能的影片 bios 元素。

</dd> </dl>

## <a name="remarks"></a>備註

**Cim \_ VideoBIOSFeatureVideoBIOSElements** 類別衍生自 [**cim \_ SoftwareFeatureSoftwareElements**](cim-softwarefeaturesoftwareelements.md)。
