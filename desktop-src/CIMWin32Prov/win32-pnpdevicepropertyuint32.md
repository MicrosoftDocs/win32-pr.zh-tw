...
api_location:
- CIMWin32.dll
ms.openlocfilehash: 32dc0026b291bf1c3825af6576e8a5b8a8ace88cdd818c667f5326370b4e2b1b
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118008274"
---
# <a name="win32_pnpdevicepropertyuint32-class"></a>Win32 \_ PnPDevicePropertyUint32 類別

表示 **Uint32** 類型的 PnP 裝置屬性。
...
**Win32 \_ PnPDevicePropertyUint32** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ PnPDevicePropertyUint32** 類別具有這些屬性。
