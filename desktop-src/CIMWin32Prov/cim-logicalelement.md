...
ms.locfileid: "119438240"
---
# <a name="cim_logicalelement-class-cimwin32-wmi-providers"></a>CIM_LogicalElement 類別 (CIMWin32 WMI 提供者) 

**CIM \_ LogicalElement** 類別是代表抽象系統元件的所有系統元件的基類，例如設定檔、進程或系統功能（以邏輯裝置的形式）。
...
WMI 不會執行這個類別。 針對衍生自 **CIM \_ LogicalElement** 的類別，請參閱 [Win32 類別](win32-provider.md)。
