...
api_location:
- CIMWin32.dll
ms.openlocfilehash: 2ecb25a11040527258939698fc70696422df116024f15cac4a13f63debca272a
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119924888"
---
# <a name="cim_coolingdevice-class"></a>CIM \_ CoolingDevice 類別

**CIM \_ CoolingDevice** 類別代表冷卻裝置的功能和管理。
...
**CIM \_ CoolingDevice** 類別具有下列類型的成員：
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-coolingdevice.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
**Cim \_ CoolingDevice** 類別衍生自 [**cim \_ LogicalDevice**](cim-logicaldevice.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ CoolingDevice** 的類別，請參閱 [Win32 類別](win32-provider.md)。
