...
ms.locfileid: "120002888"
---
# <a name="uncompress-method-of-the-cim_datafile-class"></a>CIM \_ 資料檔案類別的解壓縮方法

**解壓縮** 方法會 uncompresses 邏輯資料檔案 (或物件路徑中指定的目錄) 。 這個方法繼承自 [**CIM \_ LogicalFile**](cim-logicalfile.md)。
...
[**CIM \_ 資料檔案**](cim-datafile.md)中的 **解壓縮** 方法是由 WMI 所執行。
...
[**CIM \_ 資料檔案**](uncompress-method-in-class-cim-datafile.md)
</dt> <dt>
