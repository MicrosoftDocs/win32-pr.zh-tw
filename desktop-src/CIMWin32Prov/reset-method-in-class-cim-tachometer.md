...
ms.locfileid: "119700878"
---
# <a name="reset-method-of-the-cim_tachometer-class"></a>CIM 流速值類別的 Reset 方法 \_

CIM 流速傳送類別的 **reset** 方法會 \_ 要求重設邏輯裝置。 這個方法繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
...
[CIM \_ 流速](reset-method-in-class-cim-tachometer.md)
</dt> <dt>
