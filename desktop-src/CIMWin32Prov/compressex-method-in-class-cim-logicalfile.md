...
ms.locfileid: "119547708"
---
# <a name="compressex-method-of-the-cim_logicalfile-class"></a>CIM LogicalFile 類別的 CompressEx 方法 \_

**CompressEx** 方法會將邏輯檔案壓縮 (或在物件路徑中指定的目錄) 。 這個方法是 [**壓縮**](compress-method-in-class-cim-logicalfile.md) 方法的擴充版本。
...
要做為方法起點的子檔 (或目錄) 。 一般而言，此參數是 *StopFileName* 參數，指定上一次方法呼叫發生錯誤的檔案或目錄。 如果這個參數是 null，則會在 [**ExecMethod**](/windows/desktop/WmiSdk/swbemservices-execmethod) 呼叫中指定的檔案 (或目錄) 上執行作業。
