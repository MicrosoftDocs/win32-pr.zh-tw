...
ms.locfileid: "118677530"
---
# <a name="cim_physicalpackage-class"></a>CIM \_ PhysicalPackage 類別

**CIM \_ PhysicalPackage** 類別代表包含或裝載其他元件的實體元素。 範例包括機架主機殼或介面卡。
...
**CIM \_ PhysicalPackage** 類別具有下列類型的成員：
...
**CIM \_ PhysicalPackage** 類別具有這些方法。



| 方法                                                                   | 描述                                                                                                                                      |
|:-------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| [**IsCompatible**](iscompatible-method-in-class-cim-physicalpackage.md) | 確認參考的實體元素是否可包含或插入實體封裝中。 不是由 WMI 所執行。<br/> |
...
**CIM \_ PhysicalPackage** 類別具有這些屬性。
...
**Cim \_ PhysicalPackage** 類別衍生自 [**cim \_ PhysicalElement**](cim-physicalelement.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ PHYSICALPACKAGE** 的 WMI 類別，請參閱 [Win32 類別](win32-provider.md)。
