...
ms.locfileid: "119079992"
---
# <a name="reset-method-of-the-cim_infraredcontroller-class"></a>CIM InfraredController 類別的 Reset 方法 \_

**Reset** 方法會要求重設邏輯裝置。 這個方法繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
