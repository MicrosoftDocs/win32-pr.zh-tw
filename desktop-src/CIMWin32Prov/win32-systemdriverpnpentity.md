...
**Win32 \_ SystemDriverPNPEntity** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ SystemDriverPNPEntity** 類別具有這些屬性。
...
限定詞： [**Key**](../wmisdk/key-qualifier.md)、 [**Override**](../wmisdk/standard-qualifiers.md) ( "Antecedent" ) 、 [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "WMI \| Win32 \_ PNPEntity" ) 
</dt> </dl>
...
限定詞：索引 [**鍵**](../wmisdk/key-qualifier.md)、覆 [**寫**](../wmisdk/standard-qualifiers.md) ( 「相依」 ) 、 [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( 「WMI \| Win32 >systemdriver」 \_ ) 
</dt> </dl>

[**Win32 \_ >systemdriver**](win32-systemdriver.md) ，表示支援隨插即用裝置的驅動程式。

</dd> </dl>

## <a name="remarks"></a>備註

**Win32 \_ SystemDriverPNPEntity** 類別衍生自 CIM 相依 [**性 \_**](cim-dependency.md)。
