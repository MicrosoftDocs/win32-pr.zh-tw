...
api_location:
- CIMWin32.dll
ms.openlocfilehash: 10a2f8b9d51da08ccf92759fd4ecffe6050492b5067977a6708a5b34f21919dc
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119919908"
---
# <a name="cim_serialcontroller-class-cimwin32-wmi-providers"></a>CIM_SerialController 類別 (CIMWin32 WMI 提供者) 

**CIM \_ SerialController** 類別代表序列埠邏輯裝置的功能和管理。
...
**CIM \_ SerialController** 類別具有這些方法。



| 方法                                                                      | 描述                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-serialcontroller.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-serialcontroller.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
序列控制器的晶片層級相容性。 此屬性描述可能在晶片硬體內的緩衝區和序列控制器的其他功能。 這個屬性是列舉的整數。
...
自由格式字串，提供 **功能** 陣列中所指出之序列控制器功能的詳細說明。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| 序列埠 \| 004.6 「) ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) ( 每秒位數」 ) 
</dt> </dl>
...
**Cim \_ SerialController** 類別衍生自 [**cim \_ 控制器**](cim-controller.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ SERIALCONTROLLER** 的 WMI 類別，請參閱 [Win32 類別](win32-provider.md)。
