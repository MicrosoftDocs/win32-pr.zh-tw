...
ms.locfileid: "118419457"
---
# <a name="deleteex-method-of-the-win32_shortcutfile-class"></a>Win32 ShortcutFile 類別的 DeleteEx 方法 \_

**DeleteEx** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會刪除物件路徑中指定的邏輯快速鍵檔 (或目錄) 。 **DeleteEx** 是 [**刪除**](delete-method-in-class-win32-directory.md) 方法的擴充版本。
...
**DeleteEx** 方法失敗之檔案或目錄的名稱。 如果方法成功，則此參數為 **null** 。
