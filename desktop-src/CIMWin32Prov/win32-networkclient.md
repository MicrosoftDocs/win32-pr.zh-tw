...
**Win32 \_ NetworkClient** [WMI 類別](../wmisdk/retrieving-a-class.md)代表 Windows 系統上的網路用戶端。 網路上具有與系統之間的用戶端關係的任何電腦系統，都是此類別 (或成員) 的子系。
...
**Win32 \_ NetworkClient** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ NetworkClient** 類別具有這些屬性。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32Registry \| SYSTEM \\ \\ CurrentControlSet \\ \\ Services \\ \\ LanmanWorkstation \\ \\ NetworkProvider \| 製造業" ) 
</dt> </dl>

執行 Windows 的電腦系統上執行之網路用戶端的製造商名稱。
...
**Win32 \_ NetworkClient** 類別衍生自 [**CIM \_ LogicalElement**](cim-logicalelement.md)。
