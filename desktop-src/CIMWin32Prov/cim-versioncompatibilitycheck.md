...
**CIM \_ VersionCompatibilityCheck** 類別會指定是否允許建立軟體元素的下一個狀態。
...
**CIM \_ VersionCompatibilityCheck** 類別具有下列類型的成員：
...
**CIM \_ VersionCompatibilityCheck** 類別具有這些方法。
...
**CIM \_ VersionCompatibilityCheck** 類別具有這些屬性。
...
若 **為 TRUE**，則不論環境中是否已有較高或更高版本的 software 專案，軟體專案都可以轉換為下一個狀態。
...
若 **為 TRUE**，則不論環境中是否已有相同版本的軟體專案，軟體專案都可以轉換為下一個狀態。
