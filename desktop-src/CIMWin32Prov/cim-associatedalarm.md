...
---
# <a name="cim_associatedalarm-class"></a>CIM \_ AssociatedAlarm 類別

**CIM \_ AssociatedAlarm** 相依性會將警示與邏輯裝置產生關聯。
...
**CIM \_ AssociatedAlarm** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ AssociatedAlarm** 類別具有這些屬性。
...
包含警報裝置的 [**CIM \_ AlarmDevice**](cim-alarmdevice.md) 。
...
包含發出的邏輯裝置的 [**CIM \_ LogicalDevice**](cim-logicaldevice.md) 。

</dd> </dl>

## <a name="remarks"></a>備註

**Cim \_ AssociatedAlarm** 類別衍生自 cim 相依 [**性 \_**](cim-dependency.md)。
