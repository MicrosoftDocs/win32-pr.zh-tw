...
---
# <a name="win32_logicaldisktopartition-class"></a>Win32 \_ LogicalDiskToPartition 類別

**Win32 \_ LogicalDiskToPartition** 關聯 [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)會建立邏輯磁片磁碟機及其所在磁碟分割的關聯。
...
**Win32 \_ LogicalDiskToPartition** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ LogicalDiskToPartition** 類別具有這些屬性。
...
限定詞： [**key**](/windows/desktop/WmiSdk/key-qualifier)、 [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ( "Antecedent" ) 、 [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "WMI \| Win32 \_ DiskPartition" ) 
</dt> </dl>

代表邏輯磁片所在之磁碟分割的屬性之實例的參考。
...
限定詞：索引 [**鍵**](/windows/desktop/WmiSdk/key-qualifier)、覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( 「相依」 ) 、 [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( 「WMI \| Win32 LogicalDisk」 \_ ) 
</dt> </dl>

代表位於實體磁碟分割上的邏輯磁片屬性之實例的參考。
...
**Win32 \_ LogicalDiskToPartition** 類別衍生自 [**CIM \_ LogicalDiskBasedOnPartition**](cim-logicaldiskbasedonpartition.md)。

如需邏輯磁碟機與實體磁片之間對應的詳細資訊，請參閱 [如何將邏輯磁碟機和實體磁片相互關聯？](https://blogs.technet.com/b/heyscriptingguy/archive/2005/05/23/how-can-i-correlate-logical-drives-and-physical-disks.aspx)。

## <a name="examples"></a>範例

下列 c + + 程式碼範例說明如何取出指定磁片磁碟機的磁碟機號。
