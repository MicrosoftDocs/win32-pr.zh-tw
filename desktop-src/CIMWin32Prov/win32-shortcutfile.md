...
**Win32 \_ ShortcutFile** [WMI 類別](../wmisdk/retrieving-a-class.md)代表的檔案是其他檔案、目錄和命令的快捷方式。
...
**Win32 \_ ShortcutFile** 類別具有下列類型的成員：
...
**Win32 \_ ShortcutFile** 類別具有這些方法。



| 方法                                                                                                | 描述                                                                                                                                                                                                                          |
|:------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**ChangeSecurityPermissions**](changesecuritypermissions-method-in-class-win32-shortcutfile.md)     | 類別方法，這個方法會變更物件路徑中所指定之邏輯檔案的安全性許可權。<br/>                                                                                                                     |
| [**ChangeSecurityPermissionsEx**](changesecuritypermissionsex-method-in-class-win32-shortcutfile.md) | 類別方法，這個方法會變更物件路徑中所指定之邏輯檔案的安全性許可權。<br/>                                                                                                                     |
| [**壓縮**](compress-method-in-class-win32-shortcutfile.md)                                       | 類別方法，會將邏輯檔案壓縮 (或物件路徑中指定的目錄) 。<br/>                                                                                                                                |
| [**CompressEx**](compressex-method-in-class-win32-shortcutfile.md)                                   | 類別方法，會將邏輯檔案壓縮 (或物件路徑中指定的目錄) 。<br/>                                                                                                                                |
| [**複製**](copy-method-in-class-win32-shortcutfile.md)                                               | 類別方法，會將物件路徑中指定的邏輯檔案或目錄複寫到輸入參數所指定的位置。<br/>                                                                                     |
| [**CopyEx**](copyex-method-in-class-win32-shortcutfile.md)                                           | 類別方法，會將物件路徑中指定的邏輯檔案或目錄複寫到 *FileName* 參數所指定的位置。<br/>                                                                                |
| [**刪除**](delete-method-in-class-win32-shortcutfile.md)                                           | 類別方法，會刪除物件路徑中指定的邏輯檔案 (或目錄) 。<br/>                                                                                                                                   |
| [**DeleteEx**](deleteex-method-in-class-win32-shortcutfile.md)                                       | 類別方法，會刪除物件路徑中指定的邏輯檔案 (或目錄) 。<br/>                                                                                                                                   |
| [**GetEffectivePermission**](geteffectivepermission-method-in-class-win32-shortcutfile.md)           | 類別方法，這個方法會判斷呼叫端是否有許可權引數所指定的匯總許可權，不只是在檔案物件上，而是在共用上的檔案或目錄位於共用) 的 (。<br/> |
| [**重新命名**](rename-method-in-class-win32-shortcutfile.md)                                           | 類別方法，會將物件路徑中指定的邏輯檔案 (或目錄) 重新命名。<br/>                                                                                                                                   |
| [**TakeOwnerShip**](takeownership-method-in-class-win32-shortcutfile.md)                             | 取得物件路徑中所指定之邏輯檔案擁有權的類別方法。<br/>                                                                                                                                     |
| [**TakeOwnerShipEx**](takeownershipex-method-in-class-win32-shortcutfile.md)                         | 取得物件路徑中所指定之邏輯檔案擁有權的類別方法。<br/>                                                                                                                                     |
| [**解壓**](uncompress-method-in-class-win32-shortcutfile.md)                                   | Uncompresses 邏輯檔案的類別方法， (或在物件路徑中指定的目錄) 。<br/>                                                                                                                              |
| [**UncompressEx**](uncompressex-method-in-class-win32-shortcutfile.md)                               | Uncompresses 邏輯檔案的類別方法， (或在物件路徑中指定的目錄) 。<br/>                                                                                                                              |
...
位元遮罩，表示存取或執行檔案上特定作業所需的存取權限。 如需位值，請參閱檔案 [**和目錄存取權限常數**](../wmisdk/file-and-directory-access-rights-constants.md)。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32API \| \_ beginthreadex" ) 
</dt> </dl>
...
**Win32 \_ ShortcutFile** 類別衍生自 [**CIM \_ 資料檔案**](cim-datafile.md)。
