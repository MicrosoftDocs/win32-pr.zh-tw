...
ms.locfileid: "119922838"
---
# <a name="win32_usbcontroller-class"></a>Win32 \_ USBController 類別

**Win32 \_ USBController** [WMI 類別](../wmisdk/retrieving-a-class.md)會管理通用序列匯流排 (USB) 控制器的功能。
...
**Win32 \_ USBController** 類別具有下列類型的成員：
...
**Win32 \_ USBController** 類別具有這些方法。



| 方法            | 描述                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **重設**         | 未實作。 若要執行此方法，請參閱 [**CIM \_ USBController**](cim-usbcontroller.md)中的 [**Reset**](reset-method-in-class-cim-controller.md)方法。<br/>                 |
| **SetPowerState** | 未實作。 若要執行此方法，請參閱 [**CIM \_ USBController**](cim-usbcontroller.md)中的 [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md)方法。<br/> |
...
**Win32 \_ USBController** 類別具有這些屬性。
...
這個屬性繼承自 [**CIM \_ USBController**](cim-usbcontroller.md)。
...
<span id="SCSI_Serial_Storage_Architecture"></span><span id="scsi_serial_storage_architecture"></span><span id="SCSI_SERIAL_STORAGE_ARCHITECTURE"></span>**SCSI 序列儲存體架構** (13) 
...
**Win32 \_ USBController** 類別衍生自 [**CIM \_ USBController**](cim-usbcontroller.md)。

您可以使用 [**Win32 \_ USBControllerDevice**](win32-usbcontrollerdevice.md) association 類別來判斷哪些邏輯裝置與控制器相關聯。

## <a name="examples"></a>範例

[列出 Usb 控制器資訊](https://Gallery.TechNet.Microsoft.Com/fc2d92ce-a241-47bf-a5ea-3395d301559e)PowerShell 範例會傳回在電腦上找到的所有 USB 控制器的相關資訊。

下列 VBScript 範例會傳回在電腦上找到的所有 USB 控制器的相關資訊。
