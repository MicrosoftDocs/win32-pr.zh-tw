...
**CIM \_ WORMDrive** 類別代表 WORM 磁片磁碟機（媒體存取裝置的子類型）的功能和管理。
...
**CIM \_ WORMDrive** 類別具有這些方法。



| 方法                                                               | 描述                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-wormdrive.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-wormdrive.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
提供 **功能** 陣列中所指出之存取裝置功能詳細描述的自由格式字串。
...
**Cim \_ WORMDrive** 類別衍生自 [**cim \_ MediaAccessDevice**](cim-mediaaccessdevice.md)。
