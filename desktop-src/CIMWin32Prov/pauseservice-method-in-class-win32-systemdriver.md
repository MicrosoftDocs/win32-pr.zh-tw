...
ms.locfileid: "120003088"
---
# <a name="pauseservice-method-of-the-win32_systemdriver-class"></a>Win32 >systemdriver 類別的 PauseService 方法 \_

**PauseService** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會嘗試將邏輯系統驅動程式所管理的服務置於暫停狀態。
...
如果已接受 **PauseService** 要求，則傳回 0 (零) 的值，如果要求不受支援則為 1 (一個) ，以及表示錯誤的其他任何數位。
