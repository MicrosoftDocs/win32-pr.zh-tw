...
---
# <a name="win32_1394controller-class"></a>Win32 \_ 1394Controller 類別

**Win32 \_ 1394Controller** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)代表1394控制器的功能和管理。 IEEE 1394 是高速串列匯流排的規格。
...
**Win32 \_ 1394Controller** 類別具有下列類型的成員：
...
**Win32 \_ 1394Controller** 類別具有這些方法。
...
**Win32 \_ 1394Controller** 類別具有這些屬性。
...
上次重設日期和時間控制器。 這可能表示控制器已關機或重新初始化。
...
**Win32 \_ 1394Controller** 類別衍生自 [**CIM \_ 控制器**](cim-controller.md)。

## <a name="examples"></a>範例

下列 PowerShell 程式碼範例會捕獲控制器資訊。
