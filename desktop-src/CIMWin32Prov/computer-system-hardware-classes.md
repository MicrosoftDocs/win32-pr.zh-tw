...
| [**Win32 \_ PointingDevice**](win32-pointingdevice.md) | 代表輸入裝置，用來在顯示的電腦系統執行 Windows 時，指向並選取區域。 |



 

## <a name="mass-storage-classes"></a>大量儲存體類別

大量儲存體子類別中的類別代表存放裝置，例如硬碟機、CD-ROM 光碟機和磁帶機。
...
| [**Win32 \_ CDROMDrive**](win32-cdromdrive.md)             | 代表執行 Windows 之電腦系統上的 CD-ROM 光碟機。                              |
...
| [**Win32 \_ disable-tapedrive**](win32-tapedrive.md)               | 代表執行 Windows 之電腦系統上的磁帶機。                                |
...
| [**Win32 \_ ParallelPort**](win32-parallelport.md)                           | 表示執行 Windows 之電腦系統上的平行埠屬性。<br/>                                                                                                                             |
...
| [**Win32 \_ PortResource**](win32-portresource.md)                           | 代表執行 Windows 之電腦系統上的 i/o 埠。<br/>                                                                                                                                                   |
| [**Win32 \_ 處理器**](win32-processor.md)                                 | 代表能夠在執行 Windows 的電腦系統上解讀一系列電腦指令的裝置。<br/>                                                                                           |
| [**Win32 \_ microsoft.hyperv.powershell.scsicontroller**](win32-scsicontroller.md)                       | 代表在執行 Windows 的電腦系統上 (SCSI) 控制器的小型電腦系統介面。<br/>                                                                                                           |
| [**Win32 \_ SCSIControllerDevice**](win32-scsicontrollerdevice.md)           | 將 SCSI 控制器與邏輯裝置 (磁片磁碟機) 連接到該磁片磁碟機。<br/>                                                                                                                                 |
| [**Win32 \_ SerialPort**](win32-serialport.md)                               | 代表執行 Windows 之電腦系統上的序列埠。<br/>                                                                                                                                                 |
...
| [**Win32 \_ SoundDevice**](win32-sounddevice.md)                             | 代表執行 Windows 之電腦系統上的聲音裝置屬性。<br/>                                                                                                                              |
...
| 類別                                                                           | 描述                                                                                                                                                                                                            |
|---------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Win32 \_ NetworkAdapter**](win32-networkadapter.md)                           | 代表執行 Windows 之電腦系統上的網路介面卡。<br/>                                                                                                                                          |
...
| 類別                                                               | 描述                                                                                                                                |
|---------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| [**Win32 \_ POTSModem**](win32-potsmodem.md)                         | 代表在執行 Windows 的電腦系統上， (POTS) 數據機的一般舊電話語音的服務和特性。<br/> |
...
| [**Win32 \_ VideoController**](win32-videocontroller.md)                               | 代表執行 Windows 之電腦系統上視訊控制器的功能和管理能力。<br/>                                                                                                                                                                                                                                                       |
