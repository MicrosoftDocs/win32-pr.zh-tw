...
**CIM \_ ClusteringSAP** 類別代表叢集服務的存取點。
...
**CIM \_ ClusteringSAP** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ ClusteringSAP** 類別具有這些屬性。
...
**Cim \_ ClusteringSAP** 類別衍生自 [**cim \_ ServiceAccessPoint**](cim-serviceaccesspoint.md)。
