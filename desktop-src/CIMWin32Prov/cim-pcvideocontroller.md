...
api_location:
- CIMWin32.dll
ms.openlocfilehash: 988cd3f8927ed3e765f1f01ab172de98607c018c579ce86d8976b920a083df8f
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118678642"
---
# <a name="cim_pcvideocontroller-class"></a>CIM \_ PCVideoController 類別

**CIM \_ PCVideoController** 代表個人電腦影片控制器的功能和管理，也就是影片控制器的子類型。
...
**CIM \_ PCVideoController** 類別具有下列類型的成員：
...
**CIM \_ PCVideoController** 類別具有這些方法。



| 方法                                                                       | 描述                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-pcvideocontroller.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcvideocontroller.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
**CIM \_ PCVideoController** 類別具有這些屬性。
...
限定詞： [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ( "[**CIM \_ VideoController**](cim-videocontroller.md).**CapabilityDescriptions**") 
</dt> </dl>
...
限定詞： [**ArrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ( "Indexed" ) ， [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ( "[**CIM \_ VideoController**](cim-videocontroller.md)。**AcceleratorCapabilities**") 
</dt> </dl>

提供 **AcceleratorCapabilities** 陣列中所指出的影片加速器功能詳細說明的自由格式字串。

> [!Note]  
> 每個陣列專案都與 **AcceleratorCapabilities** 陣列中位於相同索引的專案相關。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.12 ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" bits ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.11 ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" 圖元 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.14 ") 
</dt> </dl>

如果在字元模式中，則為影片控制器的欄數;否則，請輸入0。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.13 ") 
</dt> </dl>

如果在字元模式中，則為此影片控制器的資料列數目;否則，請輸入0。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.15 ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" 赫茲 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.8 ") 
</dt> </dl>

目前的掃描模式。 這個屬性繼承自 [**CIM \_ VideoController**](cim-videocontroller.md)。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.10 ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" 圖元 ") 
</dt> </dl>
...
控制器支援的直接可定址實體數目上限。 如果數位為未知或無限制，則應使用0值。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.5 ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" 赫茲 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.4 ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" 赫茲 ") 
</dt> </dl>
...
目前的色彩平面數目。 如果此值不適用於目前的影片設定，請輸入0。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.2 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.6 ") 
</dt> </dl>
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| Video \| 003.3 ") 
</dt> </dl>
...
**Cim \_ PCVideoController** 類別衍生自 [**cim \_ VideoController**](cim-videocontroller.md)。

WMI 不會執行這個類別。 針對衍生自 [**CIM \_ PCVIDEOCONTROLLER**](cim-videocontroller.md)的 WMI 類別，請參閱 [Win32 類別](win32-provider.md)。
