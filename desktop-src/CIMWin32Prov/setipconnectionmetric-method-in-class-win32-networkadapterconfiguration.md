...
ms.locfileid: "119759728"
---
# <a name="setipconnectionmetric-method-of-the-win32_networkadapterconfiguration-class"></a>Win32 >networkadapterconfiguration 類別的 SetIPConnectionMetric 方法 \_

**SetIPConnectionMetric** 方法是用來設定與此 IP 系結介面卡相關聯的路由度量。
...
*IPConnectionMetric* \[在\]
</dt> <dd>

指出使用此 IP 系結介面卡設定之路由的成本。 IP 路由表中的這些路由會加權值。 如果路由表中有多個目的地的路由，則會使用最低計量的路由。 有效值的範圍為1到9999。 預設值為 1。
...
[ [修改網路介面卡的 Ip 連接](https://Gallery.TechNet.Microsoft.Com/73367c75-7a39-44dc-a8d7-eb2359030969) 計量] VBScript 範例會將網路介面卡的 ip 連接計量設定為100。
