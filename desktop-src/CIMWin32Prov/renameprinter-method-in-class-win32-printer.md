...
---
# <a name="renameprinter-method-of-the-win32_printer-class"></a>Win32 Printer 類別的 RenamePrinter 方法 \_

**RenamePrinter** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會重新命名印表機。
...
下列 VBScript 範例會重新命名印表機和其印表機共用名稱。
