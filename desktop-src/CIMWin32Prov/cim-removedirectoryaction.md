...
**CIM \_ RemoveDirectoryAction** 類別會移除軟體元素的目錄。
...
**CIM \_ RemoveDirectoryAction** 類別具有下列類型的成員：
...
**CIM \_ RemoveDirectoryAction** 類別具有這些方法。
...
**CIM \_ RemoveDirectoryAction** 類別具有這些屬性。
...
這個屬性繼承自 [**CIM \_ DirectoryAction**](cim-directoryaction.md)。
...
**Cim \_ RemoveDirectoryAction** 類別衍生自 [**cim \_ DirectoryAction**](cim-directoryaction.md)。
