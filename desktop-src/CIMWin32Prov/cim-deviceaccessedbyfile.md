...
ms.locfileid: "119321638"
---
# <a name="cim_deviceaccessedbyfile-class"></a>CIM \_ DeviceAccessedByFile 類別

**CIM \_ DeviceAccessedByFile** 關聯類別會使用參考的 [**CIM \_ DeviceFile**](cim-devicefile.md)類別來指定存取的邏輯裝置。
...
**CIM \_ DeviceAccessedByFile** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ DeviceAccessedByFile** 類別具有這些屬性。
...
描述裝置檔案的 [**CIM \_ DeviceFile**](cim-devicefile.md) 。
...
限定詞： [**Max**](/windows/desktop/WmiSdk/standard-qualifiers) (1) ，覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( 「相依」 ) 
</dt> </dl>

[**CIM \_ LogicalDevice**](cim-logicaldevice.md) ，描述使用裝置檔案所存取的裝置。
...
**Cim \_ DeviceAccessedByFile** 類別衍生自 cim 相依 [**性 \_**](cim-dependency.md)。
