...
ms.locfileid: "119020946"
---
# <a name="cim_productfru-class"></a>CIM \_ ProductFRU 類別

**CIM \_ ProductFRU** 類別代表產品與現場可更換單元之間的關聯 (FRU) ，其提供已被取代之產品元件的相關資訊。
...
**CIM \_ ProductFRU** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ ProductFRU** 類別具有這些屬性。
