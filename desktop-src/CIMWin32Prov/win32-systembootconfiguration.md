...
ms.locfileid: "118416751"
---
# <a name="win32_systembootconfiguration-class"></a>Win32 \_ SystemBootConfiguration 類別

**Win32 \_ SystemBootConfiguration** 關聯 [WMI 類別](../wmisdk/retrieving-a-class.md)會使電腦系統與其開機設定產生關聯。
...
**Win32 \_ SystemBootConfiguration** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ SystemBootConfiguration** 類別具有這些屬性。
...
資料類型： **Win32 \_ BootConfiguration**
</dt> <dt>

存取類型：唯讀
</dt> <dt>

限定詞：覆 [**寫**](../wmisdk/standard-qualifiers.md) ( "設定" ) ， [**MAPPINGSTRINGS**](../wmisdk/standard-qualifiers.md) ( "WMI \| Win32 \_ BootConfiguration" ) 
</dt> </dl>
...
**Win32 \_ SystemBootConfiguration** 類別衍生自 [**win32 \_ SystemSetting**](win32-systemsetting.md)。
