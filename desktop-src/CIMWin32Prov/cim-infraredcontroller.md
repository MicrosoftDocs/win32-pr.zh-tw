...
**CIM \_ InfraredController** 類別代表紅外線控制器的功能和管理。
...
**CIM \_ InfraredController** 類別具有下列類型的成員：
...
**CIM \_ InfraredController** 類別具有這些方法。



| 方法                                                                        | 描述                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-infraredcontroller.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-infraredcontroller.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
**CIM \_ InfraredController** 類別具有這些屬性。
...
**Cim \_ InfraredController** 類別衍生自 [**cim \_ 控制器**](cim-controller.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ InfraredController** 的類別，請參閱 [Win32 類別](win32-provider.md)。
