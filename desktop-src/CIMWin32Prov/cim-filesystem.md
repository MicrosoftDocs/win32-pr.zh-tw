...
**CIM \_ FileSystem** 類別代表電腦系統本機的檔案或資料集，或從檔案伺服器遠端掛接的檔案或資料集。
...
**CIM \_ FileSystem** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ FileSystem** 類別具有這些屬性。
...
**Cim \_ FileSystem** 類別衍生自 [**cim \_ LogicalElement**](cim-logicalelement.md)。
