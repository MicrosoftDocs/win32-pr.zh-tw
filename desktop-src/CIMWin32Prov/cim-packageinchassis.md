...
**CIM \_ PackageInChassis** 關聯代表底座可包含其他套件的關聯性，例如其他底座和卡片。
...
**CIM \_ PackageInChassis** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ PackageInChassis** 類別具有這些屬性。
...
[**CIM \_ 底座**](cim-chassis.md)，描述包含其他實體套件的底座。
...
[**CIM \_ PhysicalPackage**](cim-physicalpackage.md) ，描述包含在底座中的實體套件。

</dd> </dl>

## <a name="remarks"></a>備註

**Cim \_ PackageInChassis** 類別衍生自 [**cim \_ 容器**](cim-container.md)。
