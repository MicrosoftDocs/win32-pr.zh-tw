...
---
# <a name="cim_associatedsupplyvoltagesensor-class"></a>CIM \_ AssociatedSupplyVoltageSensor 類別

**CIM \_ AssociatedSupplyVoltageSensor** 類別會將電源供應器與監視其輸入電壓的電壓感應器產生關聯。
...
**CIM \_ AssociatedSupplyVoltageSensor** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ AssociatedSupplyVoltageSensor** 類別具有這些屬性。
...
描述電壓感應器的 [**CIM \_ 電壓感應器**](cim-voltagesensor.md) 。
...
[**CIM 電源 \_ 供應器**](cim-powersupply.md)，描述與電壓感應器相關聯的電源供應器。
...
**Cim \_ AssociatedSupplyVoltageSensor** 類別衍生自 [**cim \_ AssociatedSensor**](cim-associatedsensor.md)。
