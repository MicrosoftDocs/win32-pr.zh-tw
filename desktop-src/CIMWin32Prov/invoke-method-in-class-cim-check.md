...
ms.locfileid: "118958967"
---
# <a name="invoke-method-of-the-cim_check-class"></a>CIM 檢查類別的 Invoke 方法 \_

[**CIM \_ 檢查**](cim-check.md)類別的 **Invoke** 方法會評估特定檢查。

如需方法如何評估 CIM 內容中特定檢查的詳細資訊，請參閱非抽象 [**cim \_ 檢查**](cim-check.md) 子類別。
...
[**CIM \_ 檢查**](invoke-method-in-class-cim-check.md)
</dt> <dt>
