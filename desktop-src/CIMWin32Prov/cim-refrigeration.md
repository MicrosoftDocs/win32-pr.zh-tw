...
api_location:
- CIMWin32.dll
ms.openlocfilehash: 4ace3aa659f87c728c20e8427724aef29044a04a8d432023abcefb4333b36420
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119920648"
---
# <a name="cim_refrigeration-class"></a>CIM \_ 冷藏庫取出類別

**CIM \_ 冷藏庫取出** 類別代表冷藏庫取出冷卻裝置的功能和管理。
...
**CIM \_ 冷藏庫取出** 類別具有這些方法。



| 方法                                                                   | 描述                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-refrigeration.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-refrigeration.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
**Cim \_ 冷藏庫取出** 類別衍生自 [**cim \_ CoolingDevice**](cim-coolingdevice.md)。
