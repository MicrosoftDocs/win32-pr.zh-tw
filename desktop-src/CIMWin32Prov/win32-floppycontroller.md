...
**Win32 \_ FloppyController** 類別具有下列類型的成員：
...
**Win32 \_ FloppyController** 類別具有這些方法。
...
**Win32 \_ FloppyController** 類別具有這些屬性。
...
此控制器支援的直接可定址實體數目上限。 值為 0 (零) 如果數位未知，則應使用此值。
...
**Win32 \_ FloppyController** 類別衍生自 cim [**\_ 控制器**](cim-controller.md)，其衍生自 [**cim \_ LogicalDevice**](cim-logicaldevice.md)。
