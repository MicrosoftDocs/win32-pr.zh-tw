...
ms.locfileid: "119700727"
---
# <a name="reset-method-of-the-cim_usbhub-class"></a>CIM USBHub 類別的 Reset 方法 \_

CIM USBHub 類別的 **reset** 方法會 \_ 要求重設邏輯裝置。 這個方法繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
