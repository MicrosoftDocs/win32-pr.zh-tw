...
**CompressEx** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會壓縮物件路徑中指定 (或目錄) 的邏輯快速鍵檔 (此方法是 [**壓縮**](compress-method-in-class-win32-directory.md)方法) 的擴充版本。
...
[**CompressEx**](compressex-method-in-class-win32-directory.md)方法失敗之檔案或目錄的名稱。 如果方法成功，此參數將會是 **Null** 。
...
將子檔案或目錄命名為 [**CompressEx**](compressex-method-in-class-win32-directory.md)的起點。 *StartFileName* 參數通常是 *StopFileName* 參數，可指定上一個方法呼叫發生錯誤的檔案或目錄。 如果這個參數是 **Null**，則會在 **ExecMethod** 呼叫中指定的檔案或目錄上執行作業。
