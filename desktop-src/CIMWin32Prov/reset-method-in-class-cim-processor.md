...
---
# <a name="reset-method-of-the-cim_processor-class"></a>CIM 處理器類別的 Reset 方法 \_

CIM 處理器類別的 **reset** 方法會 \_ 要求重設邏輯裝置。 這個方法繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
...
[CIM \_ 處理器](reset-method-in-class-cim-processor.md)
</dt> <dt>
