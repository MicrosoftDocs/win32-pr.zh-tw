...
**CIM \_ SoftwareFeatureServiceImplementation** 類別代表服務之間的關聯，以及它在軟體中的執行方式。 服務可以透過多個軟體功能提供，並與另一個功能一起運作。 此外，軟體功能可以提供多項服務。 當多個軟體功能與單一服務相關聯時，會假設這些專案會搭配運作來提供服務。 如果服務有不同的執行，則每個執行都會導致服務物件的個別具現化。 然後，個別具現化會與唯一的實作為關聯。
...
**CIM \_ SoftwareFeatureServiceImplementation** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ SoftwareFeatureServiceImplementation** 類別具有這些屬性。
...
描述相依服務的 [**CIM \_ 服務**](cim-service.md) 。

</dd> </dl>

## <a name="remarks"></a>備註

**Cim \_ SoftwareFeatureServiceImplementation** 類別衍生自 cim 相依 [**性 \_**](cim-dependency.md)。
