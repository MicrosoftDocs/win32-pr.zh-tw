...
**CIM \_ StorageRedundancyGroup** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ StorageRedundancyGroup** 類別具有這些屬性。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| 冗余群組 \| 001.2」 ) 
</dt> </dl>

用於資料冗余和重建的演算法。 在 CIM 架構中，值0是不正確，因為它代表 DMI 中沒有任何冗余存在。 在這種情況下，不應該具現化物件。
...
**Cim \_ StorageRedundancyGroup** 類別衍生自 [**cim \_ RedundancyGroup**](cim-redundancygroup.md)。
