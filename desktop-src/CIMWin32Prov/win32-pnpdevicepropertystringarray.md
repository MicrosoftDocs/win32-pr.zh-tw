...
ms.locfileid: "118008365"
---
# <a name="win32_pnpdevicepropertystringarray-class"></a>Win32 \_ PnPDevicePropertyStringArray 類別

表示 PnP 裝置屬性，由 **string** 元素陣列所組成。
...
**Win32 \_ PnPDevicePropertyStringArray** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ PnPDevicePropertyStringArray** 類別具有這些屬性。
