...
---
# <a name="cim_realizes-class"></a>CIM \_ 意識類別

**CIM \_ 認識** 類別代表定義邏輯裝置與執行裝置之實體元件之間對應的關聯。
...
[**CIM \_ PhysicalElement**](cim-physicalelement.md) ，描述可執行裝置的實體元件。
...
**Cim \_ 認識** 類別衍生自 cim 相依 [**性 \_**](cim-dependency.md)。
