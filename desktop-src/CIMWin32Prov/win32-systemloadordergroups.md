...
ms.locfileid: "117833956"
---
# <a name="win32_systemloadordergroups-class"></a>Win32 \_ SystemLoadOrderGroups 類別

**Win32 \_ SystemLoadOrderGroups** 關聯 [WMI 類別](../wmisdk/retrieving-a-class.md)會建立電腦系統和載入順序群組的關聯。
...
**Win32 \_ SystemLoadOrderGroups** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ SystemLoadOrderGroups** 類別具有這些屬性。
...
限定詞： [**key**](../wmisdk/key-qualifier.md)、 [**Override**](../wmisdk/standard-qualifiers.md) ( "PartComponent" ) 、 [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "WMI \| Win32 \_ LoadOrderGroup" ) 
</dt> </dl>

代表電腦系統上現有的載入順序群組之實例的參考。

</dd> </dl>

## <a name="remarks"></a>備註

**Win32 \_ SystemLoadOrderGroups** 類別衍生自 [**CIM \_ SystemComponent**](cim-systemcomponent.md)。
