...
ms.locfileid: "118674997"
---
# <a name="win32_pnpdevicepropertybinary-class"></a>Win32 \_ PnPDevicePropertyBinary 類別

代表 **Uint8** 陣列形式的二進位 PnP 裝置屬性。
...
**Win32 \_ PnPDevicePropertyBinary** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ PnPDevicePropertyBinary** 類別具有這些屬性。
