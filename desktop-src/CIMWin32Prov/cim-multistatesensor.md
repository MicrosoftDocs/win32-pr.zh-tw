...
---
# <a name="cim_multistatesensor-class"></a>CIM \_ MultiStateSensor 類別

**CIM \_ MultiStateSensor** 類別代表一組二元感應器的多重成員，其中每個二進位感應器都會報告布林結果。
...
**CIM \_ MultiStateSensor** 類別具有下列類型的成員：
...
**CIM \_ MultiStateSensor** 類別具有這些方法。



| 方法                                                                      | 描述                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-multistatesensor.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-multistatesensor.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
**CIM \_ MultiStateSensor** 類別具有這些屬性。
...
**Cim \_ MultiStateSensor** 類別衍生自 [**cim \_ 感應器**](cim-sensor.md)。
