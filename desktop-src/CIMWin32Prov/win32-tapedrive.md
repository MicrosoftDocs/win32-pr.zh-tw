...
**Win32 \_ disable-tapedrive** 類別具有下列類型的成員：
...
**Win32 \_ disable-tapedrive** 類別具有這些方法。



| 方法            | 描述                                                                                                                                                                            |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **重設**         | 未實作。 若要執行此方法，請參閱 [**CIM \_ disable-tapedrive**](cim-tapedrive.md)中的 [**Reset**](reset-method-in-class-cim-controller.md)方法。<br/>                 |
| **SetPowerState** | 未實作。 若要執行此方法，請參閱 [**CIM \_ disable-tapedrive**](cim-tapedrive.md)中的 [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md)方法。<br/> |
...
**Win32 \_ disable-tapedrive** 類別具有這些屬性。
...
限定詞： [**ArrayType**](../wmisdk/standard-qualifiers.md) ( "Indexed" ) ， [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ( "[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md)。**功能**") 
</dt> </dl>

自由格式字串的陣列，可針對 **功能** 陣列中指出的任何存取裝置功能提供更詳細的說明。 請注意，這個陣列的每個專案都與位於相同索引的 **功能** 陣列中的專案相關。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32API \| 磁帶備份結構 \| [**磁帶 \_ 取得 \_ 磁片磁碟機 \_ 參數**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| 壓縮" ) 
</dt> </dl>
...
自由格式字串，指出裝置用來支援壓縮的演算法或工具。 如果不可能或不想要描述壓縮配置 (可能是因為) 不知道，請使用下列文字：「未知」表示不知道裝置是否支援壓縮功能;「已壓縮」表示裝置支援壓縮功能，但其壓縮配置未知或未洩漏;和「未壓縮」表示裝置不支援壓縮功能。
...
限定詞： [**Key**](../wmisdk/key-qualifier.md)、 [**Override**](../wmisdk/standard-qualifiers.md) ( "DeviceId" ) 、 [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32API \| File 函數 \| CreateFile" ) 
</dt> </dl>

磁片磁碟機的唯一識別碼與系統上的其他裝置。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32API \| 磁帶備份結構 \| [**磁帶 \_ 取得 \_ 磁片磁碟機 \_ 參數**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ECC" ) 
</dt> </dl>

若 **為 TRUE**，則表示裝置支援硬體錯誤修正。
...
這個屬性繼承自 [**CIM \_ disable-tapedrive**](cim-tapedrive.md)。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32API \| 磁帶備份結構 \| [**磁帶 \_ 取得 \_ 磁片磁碟機 \_ 參數**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesHigh" ) 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32API \| 磁帶備份結構 \| [**磁帶 \_ 取得 \_ 磁片磁碟機 \_ 參數**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesLow" ) 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "MIF。DMTF \| 順序存取裝置 \| 001.2 「) ， [**單位**](../wmisdk/standard-qualifiers.md) ( 「kb」 ) 
</dt> </dl>
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32 \_ disable-tapedrive \| 媒體媒體磁片 \| 磁碟機" ) 
</dt> </dl>

 (所使用的媒體類型或) 此裝置所存取的媒體類型。 在此情況下，它會設定為「磁帶機」。
...
限定詞： [**MappingStrings**](../wmisdk/standard-qualifiers.md) ( "Win32API \| 磁帶備份結構 \| [**磁帶 \_ 取得 \_ 磁片磁碟機 \_ 參數**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ReportSetmarks" ) 
</dt> </dl>

若 **為 TRUE**，則會啟用 setmark 報告。 Setmark 報告使用未包含使用者資料的特製化記錄元素。 這個錄製的元素可用來提供以階層方式優於標記的分割配置。 Setmarks 可讓您更快速地在高容量磁帶上定位。
...
**Win32 \_ disable-tapedrive** 類別衍生自 [**CIM \_ disable-tapedrive**](cim-tapedrive.md)。
