...
ms.locfileid: "119218938"
---
# <a name="cim_associatedcooling-class"></a>CIM \_ AssociatedCooling 類別

**CIM \_ AssociatedCooling** 關聯會指出風扇或其他冷卻裝置特定于裝置 (與提供主機殼或封包冷卻) 。
...
**CIM \_ AssociatedCooling** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ AssociatedCooling** 類別具有這些屬性。
...
描述冷卻裝置的 [**CIM \_ LogicalDevice**](cim-logicaldevice.md) 。
...
參考要冷卻之邏輯裝置的 [**CIM \_ LogicalDevice**](cim-logicaldevice.md) 。

</dd> </dl>

## <a name="remarks"></a>備註

**Cim \_ AssociatedCooling** 類別衍生自 cim 相依 [**性 \_**](cim-dependency.md)。
