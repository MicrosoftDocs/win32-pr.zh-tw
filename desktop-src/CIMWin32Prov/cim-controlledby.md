...
ms.locfileid: "119080812"
---
# <a name="cim_controlledby-class-cimwin32-wmi-providers"></a>CIM_ControlledBy 類別 (CIMWin32 WMI 提供者) 

**CIM \_ ControlledBy** 關聯性會指出哪些裝置是由控制器邏輯裝置所發出或存取。
...
代表控制器的 [**CIM \_ 控制器**](cim-controller.md) 。
...
代表受控制裝置的 [**CIM \_ LogicalDevice**](cim-logicaldevice.md) 。
...
**Cim \_ ControlledBy** 類別衍生自 [**cim \_ DeviceConnection**](cim-deviceconnection.md)。

WMI 不會執行這個類別。 如需衍生自 **CIM \_ ControlledBy** 之類別的詳細資訊，請參閱 [Win32 類別](win32-provider.md)。
