...
ms.locfileid: "119921308"
---
# <a name="cim_osprocess-class"></a>CIM \_ OSProcess 類別

**CIM \_ OSProcess** 類別會將作業系統以及在作業系統環境中執行的一或多個處理常式產生關聯。
...
**CIM \_ OSProcess** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ OSProcess** 類別具有這些屬性。
...
[**CIM \_ 進程**](cim-process.md)，描述在作業系統內容中執行的進程
