...
**StopService** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會將 [**Win32 \_ >systemdriver**](win32-systemdriver.md)物件所代表的服務放在已停止狀態。
...
下列 PowerShell 程式碼會停止「Microsoft USB 印表機類別」服務。
