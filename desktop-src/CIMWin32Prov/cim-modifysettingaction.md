...
ms.locfileid: "122884253"
---
# <a name="cim_modifysettingaction-class"></a>CIM \_ ModifySettingAction 類別

**CIM \_ ModifySettingAction** 類別代表針對特定專案（具有特定值）修改特定設定檔案的資訊。
...
**CIM \_ ModifySettingAction** 類別具有下列類型的成員：
...
**CIM \_ ModifySettingAction** 類別具有這些方法。



| 方法                                                           | 說明                                                 |
|:-----------------------------------------------------------------|:------------------------------------------------------------|
| [**調用**](invoke-method-in-class-cim-modifysettingaction.md) | 採取特定動作。 不是由 WMI 所執行。<br/> |
...
**CIM \_ ModifySettingAction** 類別具有這些屬性。
...
要在指定的設定專案上執行的動作類型。 系統會假設新增專案區分大小寫;不過，移除會假設為不區分大小寫。

<dt>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>**建立** (0) 
...
<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>**刪除** (1) 
...
<span id="Append"></span><span id="append"></span><span id="APPEND"></span>**附加** (2) 
...
<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>**移除** (3) 
...
**Cim \_ ModifySettingAction** 類別衍生自 [**cim \_ 動作**](cim-action.md)。
