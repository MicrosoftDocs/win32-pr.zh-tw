...
ms.locfileid: "120064878"
---
# <a name="invoke-method-of-the-cim_osversioncheck-class"></a>CIM OSVersionCheck 類別的 Invoke 方法 \_

[**CIM \_ OSVersionCheck**](cim-osversioncheck.md)類別的 **Invoke** 方法會評估特定檢查。 方法會在 CIM 內容中評估特定檢查的詳細資料，由非抽象 [**cim \_ 檢查**](cim-check.md) 子類別描述。 此方法繼承自 **CIM \_ 檢查**。
