...
---
# <a name="cim_scsiinterface-class"></a>CIM \_ SCSIInterface 類別

**Cim \_ SCSIInterface** 類別代表 [**cim \_ ControlledBy**](cim-controlledby.md)關聯性，指出哪些裝置可透過 SCSI 控制器和存取特性來存取。
...
**CIM \_ SCSIInterface** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ SCSIInterface** 類別具有這些屬性。
...
資料類型： **CIM \_ microsoft.hyperv.powershell.scsicontroller**
</dt> <dt>
...
描述 SCSI 控制器的 [**CIM \_ microsoft.hyperv.powershell.scsicontroller**](cim-scsicontroller.md) 。
...
自上次與受控制裝置相關的硬重設和軟重設之後，所發生的 SCSI 重試次數。 上次重設的時間會在 **TimeOfDeviceReset** 屬性中指出，此屬性繼承自 [**CIM \_ ControlledBy**](cim-controlledby.md) 關聯。
...
自上次硬性或軟重設（與受控制裝置相關）以來發生的 SCSI 超時時間。 上次重設的時間會在 **TimeOfDeviceReset** 屬性中指出，此屬性繼承自 [**CIM \_ ControlledBy**](cim-controlledby.md) 關聯。

</dd> </dl>

## <a name="remarks"></a>備註

**Cim \_ SCSIInterface** 類別衍生自 [**cim \_ ControlledBy**](cim-controlledby.md)。
