...
ms.locfileid: "119918798"
---
# <a name="cim_usbdevice-class-cimwin32-wmi-providers"></a>CIM_USBDevice 類別 (CIMWin32 WMI 提供者) 

**CIM \_ USBDevice** 類別代表 USB 裝置的管理特性。
...
| 方法                                                               | 描述                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**GetDescriptor**](getdescriptor-method-in-class-cim-usbdevice.md) | 傳回 USB 裝置描述項。 不是由 WMI 所執行。<br/>                                                                    |
| [**重設**](reset-method-in-class-cim-usbdevice.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbdevice.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
**Cim \_ USBDevice** 類別衍生自 [**cim \_ LogicalDevice**](cim-logicaldevice.md)。

WMI 不會執行這個類別。 如需執行 **CIM \_ USBDEVICE** 的 WMI 類別，請參閱 [Win32 類別](win32-provider.md)。
