...
---
# <a name="uncompressex-method-of-the-win32_shortcutfile-class"></a>Win32 ShortcutFile 類別的 UncompressEx 方法 \_

**UncompressEx** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會 uncompresses 在物件路徑中指定的邏輯快速鍵檔 (或目錄) 。 這個方法是 [**解壓縮**](uncompress-method-in-class-win32-directory.md) 方法的擴充版本。
