...
ms.locfileid: "119322038"
---
# <a name="cim_computersystemmappedio-class"></a>CIM \_ ComputerSystemMappedIO 類別

**CIM \_ ComputerSystemMappedIO** 類別代表電腦系統與其可用記憶體對應 i/o 埠之間的關聯。
...
**CIM \_ ComputerSystemMappedIO** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ ComputerSystemMappedIO** 類別具有這些屬性。
...
CIM 電腦系統，描述對應到 i/o 埠的電腦系統。 [**\_**](cim-computersystem.md)
...
[**CIM \_ MemoryMappedIO**](cim-memorymappedio.md) ，描述電腦系統的記憶體對應 i/o 埠。

</dd> </dl>

## <a name="remarks"></a>備註

**Cim \_ ComputerSystemMappedIO** 類別衍生自 [**cim \_ ComputerSystemResource**](cim-computersystemresource.md)。
