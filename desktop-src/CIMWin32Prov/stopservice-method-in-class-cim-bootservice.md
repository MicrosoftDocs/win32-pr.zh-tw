...
ms.locfileid: "119752278"
---
# <a name="stopservice-method-of-the-cim_bootservice-class"></a>CIM BootService 類別的 StopService 方法 \_

**StopService** 方法會停止衍生自 [**CIM \_ BootService**](cim-bootservice.md)的物件所代表的服務。 這個方法繼承自 [**CIM \_ 服務**](cim-service.md)。
