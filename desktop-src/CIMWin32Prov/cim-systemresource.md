...
ms.locfileid: "119919038"
---
# <a name="cim_systemresource-class"></a>CIM \_ SystemResource 類別

**CIM \_ SystemResource** 類別代表 BIOS 所管理的實體，或是可供軟體和邏輯裝置使用的作業系統。
...
**CIM \_ SystemResource** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ SystemResource** 類別具有這些屬性。
...
**Cim \_ SystemResource** 類別衍生自 [**cim \_ LogicalElement**](cim-logicalelement.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ SYSTEMRESOURCE** 的 WMI 類別，請參閱 [Win32 類別](win32-provider.md)。
