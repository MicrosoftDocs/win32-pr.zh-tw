...
ms.locfileid: "118679586"
---
# <a name="cim_packageinslot-class"></a>CIM \_ PackageInSlot 類別

**CIM \_ PackageInSlot** 關聯代表裝置卡與其掛接之底座之間的關聯性。
...
**CIM \_ PackageInSlot** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ PackageInSlot** 類別具有這些屬性。
...
[**CIM \_ 插槽**](cim-slot.md)，描述插入實體封裝的位置。
...
[**CIM \_ PhysicalPackage**](cim-physicalpackage.md) ，描述插槽中的套件。

</dd> </dl>

## <a name="remarks"></a>備註

**CIM \_PackageInSlot** 衍生自 [**CIM 相依 \_**](cim-dependency.md)性。
