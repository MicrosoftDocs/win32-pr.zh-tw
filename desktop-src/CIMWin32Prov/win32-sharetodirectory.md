...
ms.locfileid: "119917538"
---
# <a name="win32_sharetodirectory-class"></a>Win32 \_ ShareToDirectory 類別

**Win32 \_ ShareToDirectory** 關聯 [WMI 類別](../wmisdk/retrieving-a-class.md)會將電腦系統上的共用資源與其對應的目錄相關聯。
...
**Win32 \_ ShareToDirectory** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ ShareToDirectory** 類別具有這些屬性。
...
限定詞： [**key**](../wmisdk/key-qualifier.md)、 [**MAPPINGSTRINGS**](../wmisdk/standard-qualifiers.md) ( "WMI \| Win32 \_ Share" ) 
</dt> </dl>

此實例的參考，代表可透過目錄取得之共用資源的屬性。
...
限定詞： [**key**](../wmisdk/key-qualifier.md)、 [**MAPPINGSTRINGS**](../wmisdk/standard-qualifiers.md) ( "cim \| cim \_ Directory" ) 
</dt> </dl>

實例的參考，代表已對應至共用資源的目錄屬性。
