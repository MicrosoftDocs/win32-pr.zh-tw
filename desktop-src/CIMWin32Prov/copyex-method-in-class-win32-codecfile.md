...
**CopyEx** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)方法會將物件路徑中指定的邏輯編解碼器檔案或目錄複寫到 *FileName* 參數所指定的位置。 這個方法是 [**複製**](copy-method-in-class-win32-directory.md) 方法的擴充版本。 如果需要覆寫現有的邏輯檔案，則不支援複製。
