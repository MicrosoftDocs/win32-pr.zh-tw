...
ms.locfileid: "119701558"
---
# <a name="reset-method-of-the-cim_pointingdevice-class"></a>CIM PointingDevice 類別的 Reset 方法 \_

CIM PointingDevice 類別的 **reset** 方法會 \_ 要求重設邏輯裝置。 這個方法繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
