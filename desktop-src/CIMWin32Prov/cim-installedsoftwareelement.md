...
ms.locfileid: "119438708"
---
# <a name="cim_installedsoftwareelement-class"></a>CIM \_ InstalledSoftwareElement 類別

**CIM \_ InstalledSoftwareElement** 類別會將電腦系統與已安裝的軟體元素建立關聯。
...
**CIM \_ InstalledSoftwareElement** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ InstalledSoftwareElement** 類別具有這些屬性。
...
限定詞： [**Min**](/windows/desktop/WmiSdk/standard-qualifiers) (0) ， [**最大**](/windows/desktop/WmiSdk/standard-qualifiers) (FALSE) 
</dt> </dl>

電腦系統上所安裝之 software 元素的參考。
...
WMI 不會執行這個類別。 針對衍生自 **CIM \_ InstalledSoftwareElement** 的類別，請參閱 [Win32 類別](win32-provider.md)。
