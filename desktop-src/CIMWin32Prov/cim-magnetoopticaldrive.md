...
---
# <a name="cim_magnetoopticaldrive-class"></a>CIM \_ MagnetoOpticalDrive 類別

**CIM \_ MagnetoOpticalDrive** 類別代表磁光磁片磁碟機的功能和管理，也就是媒體存取裝置的子類型。
...
**CIM \_ MagnetoOpticalDrive** 類別具有下列類型的成員：
...
**CIM \_ MagnetoOpticalDrive** 類別具有這些方法。



| 方法                                                                         | 描述                                                                                                                              |
|:-------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-magnetoopticaldrive.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-magnetoopticaldrive.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
**CIM \_ MagnetoOpticalDrive** 類別具有這些屬性。
...
如果媒體存取裝置支援多個個別媒體，則這個屬性會定義可支援或插入的最大數目。
...
**Cim \_ MagnetoOpticalDrive** 類別衍生自 [**cim \_ MediaAccessDevice**](cim-mediaaccessdevice.md)。
