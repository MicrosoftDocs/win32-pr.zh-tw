...
ms.locfileid: "119917967"
---
# <a name="win32_comapplication-class"></a>Win32 \_ COMApplication 類別

**Win32 \_ COMApplication** abstract [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)代表 (COM) 應用程式的元件物件模型。 在此內容中，COM 應用程式是 COM 類別的邏輯群組。
...
**Win32 \_ COMApplication** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ COMApplication** 類別具有這些屬性。
...
**Win32 \_ COMApplication** 類別衍生自 [**CIM \_ LogicalElement**](cim-logicalelement.md)。
