...
ms.locfileid: "118959117"
---
# <a name="changesecuritypermissions-method-of-the-cim_directory-class"></a>CIM 目錄類別的 ChangeSecurityPermissions 方法 \_

**ChangeSecurityPermissions** 方法會變更物件路徑中所指定邏輯目錄專案檔的安全性許可權。 如果邏輯檔案是目錄，則此方法會以遞迴方式運作，以變更目錄所包含的所有檔案和子目錄的安全性許可權。 這個方法繼承自 [**CIM \_ LogicalFile**](cim-logicalfile.md)。
...
[CIM \_ 目錄](changesecuritypermissions-method-in-class-cim-directory.md)
</dt> <dt>
