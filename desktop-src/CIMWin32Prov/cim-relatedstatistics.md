...
ms.locfileid: "119920588"
---
# <a name="cim_relatedstatistics-class"></a>CIM \_ RelatedStatistics 類別

**Cim \_ RelatedStatistics** 關聯表示階層以及相關 [**CIM \_ StatisticalInformation**](cim-statisticalinformation.md)類別的相依性。
...
**CIM \_ RelatedStatistics** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ RelatedStatistics** 類別具有這些屬性。
