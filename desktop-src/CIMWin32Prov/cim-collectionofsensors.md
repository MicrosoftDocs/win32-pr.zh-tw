...
**CIM \_ CollectionOfSensors** 關聯代表組成 multistate 感應器的二元感應器。
...
**CIM \_ CollectionOfSensors** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ CollectionOfSensors** 類別具有這些屬性。
...
資料類型： **CIM \_ MultiStateSensor**
</dt> <dt>

存取類型：唯讀
</dt> <dt>

限定詞： [**Max**](/windows/desktop/WmiSdk/standard-qualifiers) (1) ，覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "GroupComponent" ) 
</dt> </dl>

描述多重狀態感應器的 [**CIM \_ MultiStateSensor**](cim-multistatesensor.md) 。
...
資料類型： **CIM \_ BinarySensor**
</dt> <dt>

存取類型：唯讀
</dt> <dt>

限定詞： [**Min**](/windows/desktop/WmiSdk/standard-qualifiers) (2) ，覆 [**寫**](/windows/desktop/WmiSdk/standard-qualifiers) ( "PartComponent" ) 
</dt> </dl>

[**CIM \_ BinarySensor**](cim-binarysensor.md) ，描述屬於多重狀態感應器一部分的二進位感應器。
