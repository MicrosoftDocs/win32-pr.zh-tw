...
---
# <a name="cim_hostedfilesystem-class"></a>CIM \_ HostedFileSystem 類別

**CIM \_ HostedFileSystem** 關聯代表電腦系統與電腦系統上所裝載之檔案系統之間的連結。
...
**CIM \_ HostedFileSystem** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ HostedFileSystem** 類別具有這些屬性。
...
[**CIM 檔 \_ 系統**](cim-filesystem.md)，描述電腦系統所擁有的檔案系統。

</dd> </dl>

## <a name="remarks"></a>備註

**Cim \_ HostedFileSystem** 類別衍生自 [**cim \_ SystemComponent**](cim-systemcomponent.md)。
