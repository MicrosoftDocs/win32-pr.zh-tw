...
api_location:
- CIMWin32.dll
ms.openlocfilehash: 4a3a778c2d82be7cdc4cc34ebbb57566b241211b3f25b5a1d970faac5493ef1d
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118008419"
---
# <a name="win32_pnpdevicepropertysint8array-class"></a>Win32 \_ PnPDevicePropertySint8Array 類別

代表由 **Sint8** 元素陣列組成的 PnP 裝置屬性。
...
**Win32 \_ PnPDevicePropertySint8Array** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ PnPDevicePropertySint8Array** 類別具有這些屬性。
