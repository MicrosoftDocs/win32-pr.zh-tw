...
ms.locfileid: "119972048"
---
# <a name="win32_pnpdeviceproperty-class"></a>Win32 \_ PnPDeviceProperty 類別

代表 [**Win32 \_ PnPEntity**](win32-pnpentity.md)：：[**GetDeviceProperties**](getdeviceproperties-win32-pnpentity.md) 方法所傳回之屬性的類別基底類型。
...
**Win32 \_ PnPDeviceProperty** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ PnPDeviceProperty** 類別具有這些屬性。
