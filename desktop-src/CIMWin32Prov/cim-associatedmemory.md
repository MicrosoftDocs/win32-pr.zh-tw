...
**CIM \_ AssociateMemory** 類別會將已安裝或相關聯的記憶體（例如快取記憶體）與邏輯裝置產生關聯。
...
**CIM \_ AssociatedMemory** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ AssociatedMemory** 類別具有這些屬性。
...
**Cim \_ AssociatedMemory** 類別衍生自 cim 相依 [**性 \_**](cim-dependency.md)。
