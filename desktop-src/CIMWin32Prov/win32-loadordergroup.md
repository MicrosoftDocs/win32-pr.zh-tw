...
ms.locfileid: "119699408"
---
# <a name="win32_loadordergroup-class"></a>Win32 \_ LoadOrderGroup 類別

**Win32 \_ LoadOrderGroup** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class)代表一組定義執行相依性的系統服務。 服務必須依「載入順序」群組所指定的順序起始，因為服務彼此相依。 這些相依服務需要有前面的服務才能正確運作。 此類別中的資料是由提供者從登錄機碼衍生： **HKEY \_ LOCAL \_ MACHINE** \\ **System** \\ **CurrentControlSet** \\ **Control** \\ **ServiceGroupOrder**。
...
**Win32 \_ LoadOrderGroup** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Win32 \_ LoadOrderGroup** 類別具有這些屬性。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ GroupOrderList" ) 
</dt> </dl>

指出此載入順序群組是否可包含驅動程式和系統服務。
...
限定詞： [**key**](/windows/desktop/WmiSdk/key-qualifier)、 [**Override**](/windows/desktop/WmiSdk/standard-qualifiers) ( "Name" ) 、 [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ GroupOrderList" ) 
</dt> </dl>
...
**Win32 \_ LoadOrderGroup** 類別衍生自 [**CIM \_ LogicalElement**](cim-logicalelement.md)。
