...
ms.locfileid: "118421887"
---
# <a name="cim_processthread-class"></a>CIM \_ ProcessThread 類別

**CIM \_ ProcessThread** 類別代表進程與進程內容中執行之執行緒之間的連結。
...
**CIM \_ ProcessThread** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ ProcessThread** 類別具有這些屬性。
...
[**CIM \_ 執行緒**](cim-thread.md)，描述在進程內容中執行的執行緒。
