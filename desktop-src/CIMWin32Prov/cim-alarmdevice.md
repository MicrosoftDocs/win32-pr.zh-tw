...
---
# <a name="cim_alarmdevice-class"></a>CIM \_ AlarmDevice 類別

**CIM \_ AlarmDevice** 類別是一種警示裝置，可發出與問題狀況相關的聲音或可見指示。
...
**CIM \_ AlarmDevice** 類別具有這些方法。



| 方法                                                                 | 描述                                                                                                                             |
|:-----------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-alarmdevice.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                                     |
| [**SetPowerState**](setpowerstate-method-in-class-cim-alarmdevice.md) | 設定邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
| [**SetUrgency**](seturgency-method-in-class-cim-alarmdevice.md)       | 設定警示所需的緊急程度等級。 不是由 WMI 所執行。<br/>                                                        |
...
<span id="Informational"></span><span id="informational"></span><span id="INFORMATIONAL"></span>**資訊** (3) 
...
<span id="Non-Critical"></span><span id="non-critical"></span><span id="NON-CRITICAL"></span>**非關鍵性** (4) 
...
<span id="Unrecoverable"></span><span id="unrecoverable"></span><span id="UNRECOVERABLE"></span>**無法** 復原的 (6) 
...
**Cim \_ AlarmDevice** 類別衍生自 [**cim \_ LogicalDevice**](cim-logicaldevice.md)。
