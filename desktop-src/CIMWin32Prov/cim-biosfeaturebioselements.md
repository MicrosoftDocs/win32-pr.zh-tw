...
ms.locfileid: "119701020"
---
# <a name="cim_biosfeaturebioselements-class"></a>CIM \_ BIOSFeatureBIOSElements 類別

**CIM \_ BIOSFeatureBIOSElements** 類別會將 BIOS 功能和其匯總的 bios 專案產生關聯。
...
**CIM \_ BIOSFeatureBIOSElements** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ BIOSFeatureBIOSElements** 類別具有這些屬性。
...
描述 BIOS 功能的 [**CIM \_ BIOSFeature**](cim-biosfeature.md) 。
...
[**CIM \_ BIOSElement**](cim-bioselement.md) ，描述可執行 bios 功能所描述之功能的 bios 元素。

</dd> </dl>

## <a name="remarks"></a>備註

**Cim \_ BIOSFeatureBIOSElements** 類別衍生自 [**cim \_ SoftwareFeatureSoftwareElements**](cim-softwarefeaturesoftwareelements.md)。
