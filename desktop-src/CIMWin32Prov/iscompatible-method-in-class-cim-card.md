...
ms.locfileid: "120064698"
---
# <a name="iscompatible-method-of-the-cim_card-class"></a>CIM 卡片類別的 IsCompatible 方法 \_

**IsCompatible** 方法會驗證所參考的實體元素是否可包含或插入實體封裝中。 在子類別中，可以使用方法上的 **ValueMap** 辨識符號來指定可能的傳回碼組。 您也可以在子類別中，以 **值** 陣列限定詞的形式指定要轉譯之 **ValueMap** 內容的字串。 這個方法繼承自 [**CIM \_ PhysicalPackage**](cim-physicalpackage.md)。
...
[CIM \_ 卡片](iscompatible-method-in-class-cim-card.md)
</dt> <dt>
