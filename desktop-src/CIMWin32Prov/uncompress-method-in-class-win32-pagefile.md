...
ms.locfileid: "119834577"
---
# <a name="uncompress-method-of-the-win32_pagefile-class"></a>Win32 \_ 分頁檔類別的解壓縮方法

[ **解壓縮** [WMI 類別](/windows/desktop/WmiSdk/retrieving-a-class) ] 方法會 uncompresses 邏輯分頁檔案 (或在物件路徑中指定的目錄) 。
