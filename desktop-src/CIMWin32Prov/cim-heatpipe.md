...
**CIM \_ HeatPipe** 類別代表熱度管道冷卻裝置的功能和管理。
...
**CIM \_ HeatPipe** 類別具有這些方法。



| 方法                                                              | 描述                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-heatpipe.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-heatpipe.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
**Cim \_ HeatPipe** 類別衍生自 [**cim \_ CoolingDevice**](cim-coolingdevice.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ HeatPipe** 的類別，請參閱 [Win32 類別](win32-provider.md)。
