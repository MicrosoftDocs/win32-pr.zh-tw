...
**CIM 電源 \_ 供應器** 類別代表電源供應器邏輯裝置的功能和管理。
...
| 方法                                                                 | 描述                                                                                                                              |
|:-----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**重設**](reset-method-in-class-cim-powersupply.md)                 | 要求重設邏輯裝置。 不是由 WMI 所執行。<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-powersupply.md) | 定義邏輯裝置的預期電源狀態，以及何時應將裝置置於該狀態。 不是由 WMI 所執行。<br/> |
...
目前使用中的電壓範圍。 如果供應目前未繪製電源，則可以指定值 6 ( 「不會」 ) 。 這項資訊是在不斷電供應系統供應 (UPS) （ **CIM \_** 電源供應子類別）時所需的資訊。
...
以赫茲為單位的頻率 (在電源供應器輸入頻率範圍1的高階) 。 0值表示 DC。
...
在電源供應器輸入頻率範圍1的低端) 的頻率 (（以赫茲為單位）。 0值表示 DC。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| 電源供應器 \| 002.8 ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" 毫伏 ") 
</dt> </dl>

電源供應器的輸入電壓範圍1的高電壓（以毫伏為單位）。 值為0表示「未知」。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| 電源供應器 \| 002.7 ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" 毫伏 ") 
</dt> </dl>

電源供應器的輸入電壓低電壓範圍1，以毫伏為單位。 值為0表示「未知」。
...
以赫茲為單位的頻率 (，在電源供應器的輸入頻率範圍2的高階) 。 0值表示 DC。
...
在電源供應器輸入頻率範圍2的低端) 的頻率 (（以赫茲為單位）。 0值表示 DC。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| 電源供應器 \| 002.12 ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" 毫伏 ") 
</dt> </dl>

電源供應器的輸入電壓範圍2的高電壓（以毫伏為單位）。 值為0表示「未知」。
...
限定詞： [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ( "MIF。DMTF \| 電源供應器 \| 002.11 ") ， [**單位**](/windows/desktop/WmiSdk/standard-qualifiers) (" 毫伏 ") 
</dt> </dl>

此電源供應器的輸入電壓下限範圍2（以毫伏為單位）。 值為0表示「未知」。
...
**Cim \_ 電源供應** 器類別衍生自 [**cim \_ LogicalDevice**](cim-logicaldevice.md)。

WMI 不會執行這個類別。 針對衍生自 **CIM \_ 電源供應** 器的 WMI 歸類，請參閱 [Win32 類別](win32-provider.md)。
