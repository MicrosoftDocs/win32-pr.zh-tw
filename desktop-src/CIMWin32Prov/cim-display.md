...
---
# <a name="cim_display-class-cimwin32-wmi-providers"></a>CIM_Display 類別 (CIMWin32 WMI 提供者) 

**CIM \_ 顯示** 類別是用來分組其他顯示裝置的父類別。
...
自由格式的字串，提供 **LastErrorCode** 屬性更正動作中所記錄之錯誤的相關資訊，以執行。
...
**Cim \_ 顯示** 類別衍生自 [**cim \_ UserDevice**](cim-userdevice.md)。

WMI 不會執行這個類別。 針對從 **CIM \_ 顯示** 衍生的類別，請參閱 [Win32 類別](win32-provider.md)。
