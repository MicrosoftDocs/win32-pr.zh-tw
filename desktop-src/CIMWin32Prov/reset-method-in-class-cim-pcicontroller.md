...
CIM PCIController 類別的 **reset** 方法會 \_ 要求重設邏輯裝置。 這個方法繼承自 [**CIM \_ LogicalDevice**](cim-logicaldevice.md)。
...
[CIM \_ PCIController](reset-method-in-class-cim-pcicontroller.md)
</dt> <dt>
