...
ms.locfileid: "119656498"
---
# <a name="uncompress-method-of-the-cim_directory-class"></a>CIM 目錄類別的解壓縮方法 \_

**解壓縮** 方法會 uncompresses 邏輯目錄專案檔 (或在物件路徑中指定的目錄) 。 這個方法繼承自 [**CIM \_ LogicalFile**](cim-logicalfile.md)。
...
[**CIM \_ 目錄**](uncompress-method-in-class-cim-directory.md)
</dt> <dt>
