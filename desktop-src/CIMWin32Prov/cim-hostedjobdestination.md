...
ms.locfileid: "119923528"
---
# <a name="cim_hostedjobdestination-class"></a>CIM \_ HostedJobDestination 類別

**CIM \_ HostedJobDestination** 類別代表作業目的地與其所在系統之間的關聯。 系統可能會裝載許多作業佇列。 作業目的地會延後到裝載系統。
...
**CIM \_ HostedJobDestination** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**CIM \_ HostedJobDestination** 類別具有這些屬性。
...
[**CIM \_ JobDestination**](cim-jobdestination.md) ，描述系統上裝載的作業目的地。

</dd> </dl>

## <a name="remarks"></a>備註

**CIM \_HostedJobDestination** 衍生自 [**CIM 相依 \_**](cim-dependency.md)性。
