...
ms.locfileid: "119800738"
---
# <a name="takeownership-method-of-the-cim_logicalfile-class"></a>CIM LogicalFile 類別的 TakeOwnerShip 方法 \_

**TakeOwnerShip** 方法會取得物件路徑中所指定之邏輯檔案的擁有權。 如果邏輯檔案是目錄，則此方法會以遞迴方式運作，並取得目錄包含的所有檔案和子目錄的擁有權。
