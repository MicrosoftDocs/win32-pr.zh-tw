...
ms.locfileid: "118099584"
---
# <a name="d3dx11createtexturefrommemory-function"></a>D3DX11CreateTextureFromMemory 函式
...
所建立資源指標的位址。 請參閱 [**ID3D11Resource**](/windows/desktop/api/D3D11/nn-d3d11-id3d11resource)。
