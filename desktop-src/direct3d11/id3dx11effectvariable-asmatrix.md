...
類型： **[ **ID3DX11EffectMatrixVariable**](id3dx11effectmatrixvariable.md)\***

矩陣變數的指標。 請參閱 [**ID3DX11EffectMatrixVariable**](id3dx11effectmatrixvariable.md)。

## <a name="remarks"></a>備註

AsMatrix 會傳回已特製化至矩陣變數的效果變數版本。 類似于轉換，如果效果變數不包含矩陣資料，則此特製化會傳回不正確物件。
