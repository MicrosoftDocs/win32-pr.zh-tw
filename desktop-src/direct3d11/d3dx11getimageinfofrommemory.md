...
ms.locfileid: "119124703"
---
# <a name="d3dx11getimageinfofrommemory-function"></a>D3DX11GetImageInfoFromMemory 函式
...
> [!Note]  
> 我們建議您不要使用這個函式，而是使用 [DirectXTex](https://github.com/Microsoft/DirectXTex) 程式庫 **GETMETADATAFROMXXXMEMORY** (其中 XXX 是 WIC、DDS 或 TGA;WIC 不支援 DDS 和 TGA;D3DX 9 支援 TGA 作為遊戲) 的常用藝術來源格式。
