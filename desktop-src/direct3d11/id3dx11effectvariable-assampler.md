...
---
# <a name="id3dx11effectvariableassampler-method"></a>ID3DX11EffectVariable：： AsSampler 方法
...
類型： **[ **ID3DX11EffectSamplerVariable**](id3dx11effectsamplervariable.md)\***

取樣器變數的指標。 請參閱 [**ID3DX11EffectSamplerVariable**](id3dx11effectsamplervariable.md)。

## <a name="remarks"></a>備註

AsSampler 會傳回已特製化至取樣器變數的效果變數版本。 類似于轉換，如果效果變數不包含取樣器資料，則此特製化會傳回不正確物件。
