---
description: 本主題列出 AdjustableArrowCap 類別的方法。 如需完整的類別清單，請參閱 AdjustableArrowCap。
...
本主題列出 [**AdjustableArrowCap**](/windows/desktop/api/gdipluslinecaps/nl-gdipluslinecaps-adjustablearrowcap) 類別的方法。 如需完整的類別清單，請參閱 **AdjustableArrowCap**。
