...
本主題列出 [**Bitmap**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-bitmap) 類別的方法。 如需完整的類別清單，請參閱 **Bitmap 類別**。
...
-   [**ApplyEffect (效果 \* ，RECT \*)**](/previous-versions//ms536321(v=vs.85))
-   [**複製 (Rect&、PixelFormat)**](/previous-versions//ms536302(v=vs.85))
...
-   [**Bitmap.setpixel**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-bitmap-setpixel)
