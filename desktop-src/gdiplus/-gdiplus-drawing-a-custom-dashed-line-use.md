---
description: Windows GDI+ 會提供數個在 DashStyle 列舉中列出的虛線樣式。 如果這些標準虛線樣式不符合您的需求，您可以建立自訂虛線模式。
...
ms.locfileid: "120115078"
---
# <a name="drawing-a-custom-dashed-line"></a>繪製自訂虛線

Windows GDI+ 會提供數個在 [**DashStyle**](/windows/desktop/api/Gdiplusenums/ne-gdiplusenums-dashstyle)列舉中列出的虛線樣式。 如果這些標準虛線樣式不符合您的需求，您可以建立自訂虛線模式。
