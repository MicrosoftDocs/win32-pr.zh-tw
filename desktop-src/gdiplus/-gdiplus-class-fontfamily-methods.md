---
description: 本主題列出 FontFamily 類別的方法。 如需完整的類別清單，請參閱 FontFamilyClass。
...
ms.locfileid: "118249529"
---
# <a name="fontfamily-methods"></a>FontFamily 方法

本主題列出 [**FontFamily**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-fontfamily) 類別的方法。 如需完整的類別清單，請參閱 **FontFamilyClass**。

-   [**複製**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-fontfamily-clone)
