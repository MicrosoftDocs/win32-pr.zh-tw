---
description: Windows GDI+ 提供各種品質等級來繪製文字。 通常，高品質轉譯所需的處理時間比較低的品質呈現更多。
...
ms.locfileid: "118249922"
---
# <a name="antialiasing-with-text"></a>使用文字消除鋸齒

Windows GDI+ 提供各種品質等級來繪製文字。 通常，高品質轉譯所需的處理時間比較低的品質呈現更多。
...
GDI+ 提供傳統的消除鋸齒功能，以及一種以 Microsoft ClearType 顯示器技術為基礎的全新消除鋸齒，僅適用于 Windows XP 和 Windows Server 2003 及更新版本的 Windows。 ClearType 凹凸貼圖改進了具有數位介面（例如膝上型電腦中的監視器和高品質的一般桌面顯示器）之彩色 LCD 監視器的可讀性。 CRT 螢幕的可讀性也稍微改進。
