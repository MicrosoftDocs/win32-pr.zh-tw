...
ms.locfileid: "119014566"
---
# <a name="msvm_fcswitchport-class"></a>Msvm \_ FcSwitchPort 類別
...
**Msvm \_ FcSwitchPort** 類別具有下列類型的成員：
...
| [**RequestStateChange**](msvm-fcswitchport-requeststatechange.md) | 要求狀態變更。<br/>      |
| [**重設**](msvm-fcswitchport-reset.md)                           | 重設虛擬裝置。<br/>    |
