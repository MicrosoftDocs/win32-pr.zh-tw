...
---
# <a name="msvm_aggregationmetricdefinition-class"></a>Msvm \_ AggregationMetricDefinition 類別

代表衍生自另一個計量值之度量的定義方面。 **Msvm \_ AggregationMetricDefinition** 物件應該與它所套用的 managed 元素相關聯。
...
**Msvm \_ AggregationMetricDefinition** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Msvm \_ AggregationMetricDefinition** 類別具有這些屬性。
...
識別在基礎度量上執行的基本計算，以到達此衍生度量的值。 這個屬性會繼承自 **CIM \_ AggregationMetricDefinition** ，而且會是下列其中一個值。
...
| 值                                                                                                                                                                                                                                                                       | 意義                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="Unknown"></span><span id="unknown"></span><span id="UNKNOWN"></span><dl> <dt>**未知**</dt>的 <dt>0</dt> </dl>                                                 | 計量設計師未限定時間範圍，或對提供者而言是未知的。<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
識別值的單位，例如「mb」。 這個屬性繼承自 **CIM \_ BaseMetricDefinition**。
