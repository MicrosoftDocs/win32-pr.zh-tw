...
api_location:
- vmms.exe
ms.openlocfilehash: b2f30711cd4e4cbdc2a88787581501f815ba994f6f87e4e841f22c834c960773
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118146707"
---
# <a name="msvm_terminalservice-class"></a>Msvm \_ TerminalService 類別

管理特定主機的所有遠端終端機連接。 服務會使用可設定的埠來起始所有的終端機連接。
...
**Msvm \_ TerminalService** 類別具有下列類型的成員：
...
**Msvm \_ TerminalService** 類別具有這些方法。



| 方法                                                                                        | 描述                                                                                                      |
|:----------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------|
| [**GetInteractiveSessionACL**](getinteractivesessionacl-msvm-terminalservice.md)             | 抓取目前的 DACL，以控制對虛擬機器的互動式會話的存取。<br/>      |
| [**GrantInteractiveSessionAccess**](grantinteractivesessionaccess-msvm-terminalservice.md)   | 將虛擬機器的互動式會話存取權授與指定的受信者清單。<br/>    |
| [**ModifyServiceSettings**](modifyservicesettings-msvm-terminalservice.md)                   | 修改服務的設定資料。<br/>                                                            |
| [**RequestStateChange**](msvm-terminalservice-requeststatechange.md)                         | 要求狀態變更。<br/>                                                                              |
| [**RevokeInteractiveSessionAccess**](revokeinteractivesessionaccess-msvm-terminalservice.md) | 從指定的受信者清單撤銷虛擬機器的互動式會話存取權。<br/> |
| [**StartService**](msvm-terminalservice-startservice.md)                                     | 啟動服務。<br/>                                                                                   |
| [**StopService**](msvm-terminalservice-stopservice.md)                                       | 停止服務。<br/>                                                                                    |
...
**Msvm \_ TerminalService** 類別具有這些屬性。
...
存取 **Msvm \_ TerminalService** 類別可能受 UAC 篩選所限制。 如需詳細資訊，請參閱 [使用者帳戶控制和 WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi)。
