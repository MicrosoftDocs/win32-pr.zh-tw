...
**Msvm \_ Physical3dGraphicsProcessor** 類別具有下列類型的成員：
...
**Msvm \_ Physical3dGraphicsProcessor** 類別具有這些方法。
...
**Msvm \_ Physical3dGraphicsProcessor** 類別具有這些屬性。
...
指定此裝置的 GPU RemoteFX 評等。 目前未使用這個屬性。
