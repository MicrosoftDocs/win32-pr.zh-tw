...
ms.locfileid: "119148311"
---
# <a name="msvm_metricservice-class"></a>Msvm \_ MetricService 類別
...
**Msvm \_ MetricService** 類別具有下列類型的成員：
...
**Msvm \_ MetricService** 類別具有這些方法。



| 方法                                                                    | 描述                                                                             |
|:--------------------------------------------------------------------------|:----------------------------------------------------------------------------------------|
| [**ControlMetrics**](controlmetrics-msvm-metricservice.md)               | 用來控制 managed 元素或元素的計量集合。<br/> |
| [**ControlMetricsByClass**](msvm-metricservice-controlmetricsbyclass.md) | 依類別控制度量。<br/>                                               |
| [**ControlSampleTimes**](msvm-metricservice-controlsampletimes.md)       | 設定控制項取樣時間。<br/>                                               |
| [**GetMetricValues**](msvm-metricservice-getmetricvalues.md)             | 抓取度量值。<br/>                                                 |
| [**ModifyServiceSettings**](modifyservicesettings-msvm-metricservice.md) | 修改服務的設定資料。<br/>                                   |
| [**RequestStateChange**](msvm-metricservice-requeststatechange.md)       | 要求狀態變更。<br/>                                                     |
| [**ShowMetrics**](msvm-metricservice-showmetrics.md)                     | 顯示指定的計量。<br/>                                                 |
| [**ShowMetricsByClass**](msvm-metricservice-showmetricsbyclass.md)       | 依類別顯示度量。<br/>                                                  |
| [**StartService**](msvm-metricservice-startservice.md)                   | 啟動服務。<br/>                                                          |
| [**StopService**](msvm-metricservice-stopservice.md)                     | 停止服務。<br/>                                                           |
...
物件的簡短描述。 這個屬性繼承自 [**CIM \_ ManagedElement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)，一律設定為「hyper-v 計量服務」。
...
建立實例時所使用之類別或子類別的名稱。 這個屬性繼承自 [**CIM \_ 服務**](/windows/desktop/CIMWin32Prov/cim-service)，一律設定為 "Msvm \_ MetricService"。
...
對物件的描述。 這個屬性繼承自 [**CIM \_ ManagedElement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)，一律設定為「提供 hyper-v 計量 WMI 管理」。
...
物件的顯示名稱。 這個屬性繼承自 [**CIM \_ ManagedElement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)，一律設定為「hyper-v 計量服務」。
...
已知物件的標籤。 這個屬性繼承自 [**CIM \_ 服務**](/windows/desktop/CIMWin32Prov/cim-service)，一律設定為 "metricsvc"。
