...
---
# <a name="destroysystem-method-of-the-msvm_virtualethernetswitchmanagementservice-class"></a>Msvm VirtualEthernetSwitchManagementService 類別的 DestroySystem 方法 \_
...
[**Msvm \_ VirtualEthernetSwitch**](msvm-virtualethernetswitch.md)類別實例的參考，代表要終結的虛擬交換器。
