...
ms.locfileid: "118146771"
---
# <a name="msvm_syntheticfcport-class"></a>Msvm \_ SyntheticFcPort 類別
...
**Msvm \_ SyntheticFcPort** 類別具有下列類型的成員：
...
**Msvm \_ SyntheticFcPort** 類別具有這些方法。
...
| [**RequestStateChange**](msvm-syntheticfcport-requeststatechange.md) | 要求狀態變更。<br/>      |
| [**重設**](msvm-syntheticfcport-reset.md)                           | 重設虛擬裝置。<br/>    |
...
**Msvm \_ SyntheticFcPort** 類別具有這些屬性。
...
| 值                                                                                                                                                                              | 意義                  |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|
| <span id="FC"></span><span id="fc"></span><dl> <dt>**FC**</dt> <dt>4</dt> </dl> | 光纖通道<br/> |
