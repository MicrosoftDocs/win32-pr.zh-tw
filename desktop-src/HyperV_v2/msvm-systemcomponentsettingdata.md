---
description: 用來設定資料類別的泛型基類，代表虛擬系統的元件。
ms.assetid: a0c8f5e4-08e2-40c3-92c3-12d51f161871
title: Msvm_SystemComponentSettingData 類別
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119811918"
---
# <a name="msvm_systemcomponentsettingdata-class"></a>Msvm \_ SystemComponentSettingData 類別

用來設定資料類別的泛型基類，代表虛擬系統的元件。
...
**Msvm \_ SystemComponentSettingData** 類別未定義任何成員。
