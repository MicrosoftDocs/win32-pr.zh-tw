...
| <span id="Central_Office_Switch"></span><span id="central_office_switch"></span><span id="CENTRAL_OFFICE_SWITCH"></span><dl> <dt>**中央辦公室交換器**</dt> <dt>7</dt> </dl>                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| <span id="Storage_Device_Enclosure"></span><span id="storage_device_enclosure"></span><span id="STORAGE_DEVICE_ENCLOSURE"></span><dl> <dt>**存放裝置主機殼**</dt> <dt>31</dt> </dl>         | 表示此實例代表包含存放裝置的主機殼。 <br/>                                                                                                                                                                                                                                                                                                                                                                                                                                           |
