...
ms.locfileid: "119431490"
---
# <a name="destroysnapshot-method-of-the-msvm_collectionsnapshotservice-class"></a>Msvm CollectionSnapshotService 類別的 DestroySnapshot 方法 \_

終結虛擬系統集合的現有快照集。 這個方法可能會損毀其他相依于受影響快照集的快照集。
...
參考描述受影響之虛擬系統快照集集合的 [**CIM \_ 集合**](cim-collection.md) 。
