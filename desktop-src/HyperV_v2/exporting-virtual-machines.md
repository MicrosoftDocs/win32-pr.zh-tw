...
---
# <a name="exporting-a-snapshot-of-a-virtual-machine"></a><span data-ttu-id="b8b6c-103">匯出虛擬機器的快照集</span><span class="sxs-lookup"><span data-stu-id="b8b6c-103">Exporting a snapshot of a virtual machine</span></span>

<span data-ttu-id="b8b6c-104">下列 c # 和 Visual Basic Scripting Edition (VBScript) 範例會示範如何匯出虛擬機器的快照集。</span><span class="sxs-lookup"><span data-stu-id="b8b6c-104">The following C# and Visual Basic Scripting Edition (VBScript) samples demonstrate exporting a snapshot of a virtual machine.</span></span> <span data-ttu-id="b8b6c-105">您可以在 [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) 主題中找到示範匯出虛擬機器的範例。</span><span class="sxs-lookup"><span data-stu-id="b8b6c-105">Samples that demonstrate exporting a virtual machine can be found on the [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) topic.</span></span>

<span data-ttu-id="b8b6c-106">您可以在 [虛擬化範例 (V2) 的一般公用程式 ](common-utilities-for-the-virtualization-samples-v2.md)中找到參考的 c # 公用程式。</span><span class="sxs-lookup"><span data-stu-id="b8b6c-106">The referenced C# utilities can be found in [Common utilities for the virtualization samples (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="b8b6c-107">相關主題</span><span class="sxs-lookup"><span data-stu-id="b8b6c-107">Related topics</span></span>

[<span data-ttu-id="b8b6c-108">匯出虛擬機器的設定</span><span class="sxs-lookup"><span data-stu-id="b8b6c-108">Exporting the configuration of a virtual machine</span></span>](exporting-the-configuration-of-a-virtual-machine.md)

[<span data-ttu-id="b8b6c-109">**ExportSystemDefinition**</span><span class="sxs-lookup"><span data-stu-id="b8b6c-109">**ExportSystemDefinition**</span></span>](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)
