...
ms.locfileid: "119561498"
---
# <a name="msvm_resourcepoolconfigurationservice-class"></a>Msvm \_ ResourcePoolConfigurationService 類別
...
**Msvm \_ ResourcePoolConfigurationService** 類別具有下列類型的成員：
...
**Msvm \_ ResourcePoolConfigurationService** 類別具有這些方法。



| 方法                                                                                   | 描述                                                                                  |
|:-----------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------|
| [**>batchclient.pooloperations.createpool**](createpool-msvm-resourcepoolconfigurationservice.md)                   | 建立子資源集區。<br/>                                                    |
| [**DeletePool**](deletepool-msvm-resourcepoolconfigurationservice.md)                   | 刪除資源集區。<br/>                                                          |
| [**ModifyPoolResources**](modifypoolresources-msvm-resourcepoolconfigurationservice.md) | 變更指派給子集區之資源的父集區資源設定。<br/> |
| [**ModifyPoolSettings**](modifypoolsettings-msvm-resourcepoolconfigurationservice.md)   | 變更非配置相關的子集區設定。<br/>             |
...
**Msvm \_ ResourcePoolConfigurationService** 類別具有這些屬性。
