...
---
# <a name="reversereplicationrelationship-method-of-the-msvm_replicationservice-class"></a>Msvm ReplicationService 類別的 ReverseReplicationRelationship 方法 \_
...
[**CIM \_**](/windows/desktop/CIMWin32Prov/cim-computersystem)實例類型的參考，代表應反轉複寫的虛擬機器。
...
定義複寫設定之 [**Msvm \_ ReplicationSettingData**](msvm-replicationsettingdata.md) 類別實例的字串表示。
