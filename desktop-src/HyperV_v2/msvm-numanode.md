...
ms.locfileid: "119520998"
---
# <a name="msvm_numanode-class"></a>Msvm \_ NumaNode 類別

表示虛擬系統 (NUMA) 節點的非統一記憶體存取。
...
此 NUMA 節點中的處理器核心總數。 如果每個處理器核心支援多個計算執行緒，這可能會與此節點相關聯的 [**Msvm \_ 處理器**](msvm-processor.md) 物件數目不同。
