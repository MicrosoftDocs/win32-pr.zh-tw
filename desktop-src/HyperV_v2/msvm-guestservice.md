...
---
# <a name="msvm_guestservice-class"></a>Msvm \_ GuestService 類別

**Msvm \_GuestService** 是來賓中可從主機存取之服務的抽象基類。 此類別衍生自 [**CIM \_ 服務**](/windows/desktop/CIMWin32Prov/cim-service) 類別。
...
**Msvm \_ GuestService** 類別具有下列類型的成員：
...
**Msvm \_ GuestService** 類別具有這些方法。



| 方法                                                             | 描述                                                                                |
|:-------------------------------------------------------------------|:-------------------------------------------------------------------------------------------|
| [**RequestStateChange**](requeststatechange-msvm-guestservice.md) | 要求來賓服務的狀態變更為指定的值。<br/> |
| [**StartService**](startservice-msvm-guestservice.md)             | 將來賓服務置於啟動狀態。 <br/>                                     |
| [**StopService**](stopservice-msvm-guestservice.md)               | 停止來賓服務。 <br/>                                                       |
