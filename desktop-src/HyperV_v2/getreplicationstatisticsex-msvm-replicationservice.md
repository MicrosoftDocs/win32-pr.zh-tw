...
ms.locfileid: "119253698"
---
# <a name="msvm_replicationservicegetreplicationstatisticsex-method"></a>Msvm \_ ReplicationService：： GetReplicationStatisticsEx 方法

抓取與虛擬機器的指定複寫關聯性相關聯的複寫統計資料。
...
[**Msvm \_ ReplicationRelationship**](msvm-replicationrelationship.md)類別之內嵌實例的字串表示，它會定義要取得其複寫統計資料的複寫關聯性。
...
如果成功，則會收到 [**Msvm \_ ReplicationStatistics**](msvm-replicationstatistics.md) 類別的內嵌實例，其中包含所要求複寫關聯性的複寫統計資料。
