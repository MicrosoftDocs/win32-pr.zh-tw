---
description: '下列 c # 範例會針對指定的參數抓取並顯示實體和虛擬網路資訊。'
...
ms.locfileid: "106979726"
---
# <a name="querying-networking-objects"></a><span data-ttu-id="1c27b-103">查詢網路物件</span><span class="sxs-lookup"><span data-stu-id="1c27b-103">Querying networking objects</span></span>

<span data-ttu-id="1c27b-104">下列 c # 範例會針對指定的參數抓取並顯示實體和虛擬網路資訊。</span><span class="sxs-lookup"><span data-stu-id="1c27b-104">The following C# sample retrieves and displays physical and virtual network information for the specified switch.</span></span> <span data-ttu-id="1c27b-105">此程式碼取自 [hyper-v 網路範例](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking)。</span><span class="sxs-lookup"><span data-stu-id="1c27b-105">This code is taken from the [Hyper-V networking sample](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span></span>

<span data-ttu-id="1c27b-106">執行此範例的命令列語法為：</span><span class="sxs-lookup"><span data-stu-id="1c27b-106">The command-line syntax to run this sample is:</span></span>

<span data-ttu-id="1c27b-107">**NetworkingSamples.exe EnumerateSwitch** *SwitchName*</span><span class="sxs-lookup"><span data-stu-id="1c27b-107">**NetworkingSamples.exe EnumerateSwitch** *SwitchName*</span></span>

<span data-ttu-id="1c27b-108">其中 *SwitchName* 是要顯示資訊的參數名稱。</span><span class="sxs-lookup"><span data-stu-id="1c27b-108">where *SwitchName* is the name of the switch to display the information for.</span></span> <span data-ttu-id="1c27b-109">參數名稱包含在 [**Msvm VirtualEthernetSwitch 的 [ \_ ElementName**](msvm-virtualethernetswitch.md) ] 屬性中。</span><span class="sxs-lookup"><span data-stu-id="1c27b-109">The switch name is contained in the [**Msvm\_VirtualEthernetSwitch.ElementName**](msvm-virtualethernetswitch.md) property.</span></span>
