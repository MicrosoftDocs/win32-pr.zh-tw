...
ms.locfileid: "119014446"
---
# <a name="querying-networking-objects"></a>查詢網路物件

下列 c # 範例會針對指定的參數抓取並顯示實體和虛擬網路資訊。 此程式碼取自 [hyper-v 網路範例](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking)。

執行此範例的命令列語法為：

**NetworkingSamples.exe EnumerateSwitch** *SwitchName*

其中 *SwitchName* 是要顯示資訊的參數名稱。 參數名稱包含在 [**Msvm VirtualEthernetSwitch 的 [ \_ ElementName**](msvm-virtualethernetswitch.md) ] 屬性中。
