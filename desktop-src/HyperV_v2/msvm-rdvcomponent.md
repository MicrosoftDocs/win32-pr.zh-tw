...
---
# <a name="msvm_rdvcomponent-class"></a>Msvm \_ RdvComponent 類別

代表 RDV 元件的狀態，該元件負責將父系的傳輸提供給來賓以供設定之用。
...
**Msvm \_ RdvComponent** 類別具有下列類型的成員：
...
| [**EnableEndPoints**](enableendpoints-msvm-rdvcomponent.md) | 要求遠端桌面服務的虛擬裝置啟動與虛擬機器的管道連接。 如果傳回零 (0) ，表示作業成功。 任何其他傳回碼表示錯誤狀況。<br/> |
