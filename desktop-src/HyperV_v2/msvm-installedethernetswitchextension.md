...
ms.locfileid: "119522478"
---
# <a name="msvm_installedethernetswitchextension-class"></a>Msvm \_ InstalledEthernetSwitchExtension 類別
...
**Msvm \_ InstalledEthernetSwitchExtension** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**Msvm \_ InstalledEthernetSwitchExtension** 類別具有這些屬性。
