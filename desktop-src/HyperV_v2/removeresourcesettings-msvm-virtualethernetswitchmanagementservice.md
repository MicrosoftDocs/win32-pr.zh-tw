...
ms.locfileid: "119147771"
---
# <a name="removeresourcesettings-method-of-the-msvm_virtualethernetswitchmanagementservice-class"></a>Msvm VirtualEthernetSwitchManagementService 類別的 RemoveResourceSettings 方法 \_
...
[**CIM \_ ResourceAllocationSettingData**](/previous-versions/windows/desktop/clushyperv/cim-resourceallocationsettingdata)類別實例的參考陣列，其中每個實例代表要移除之虛擬交換器設定內的虛擬資源設定。
