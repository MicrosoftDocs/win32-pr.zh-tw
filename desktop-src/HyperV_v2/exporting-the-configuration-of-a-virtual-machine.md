...
---
# <a name="exporting-the-configuration-of-a-virtual-machine"></a>匯出虛擬機器的設定

下列 c # 和 Visual Basic Scripting Edition (VBScript) 範例會示範如何匯出虛擬機器的設定。 您可以在 [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) 和 [匯出虛擬機器的快照](exporting-virtual-machines.md) 集主題中找到顯示匯出虛擬機器的範例。
...
[匯出虛擬機器的快照集](exporting-virtual-machines.md)
