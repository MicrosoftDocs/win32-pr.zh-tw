---
description: '下列 c # 和 Visual Basic Scripting Edition (VBScript) 範例會示範如何匯出虛擬機器的設定。'
...
ms.locfileid: "106988517"
---
# <a name="exporting-the-configuration-of-a-virtual-machine"></a><span data-ttu-id="2728a-103">匯出虛擬機器的設定</span><span class="sxs-lookup"><span data-stu-id="2728a-103">Exporting the configuration of a virtual machine</span></span>

<span data-ttu-id="2728a-104">下列 c # 和 Visual Basic Scripting Edition (VBScript) 範例會示範如何匯出虛擬機器的設定。</span><span class="sxs-lookup"><span data-stu-id="2728a-104">The following C# and Visual Basic Scripting Edition (VBScript) samples demonstrate exporting the configuration of a virtual machine.</span></span> <span data-ttu-id="2728a-105">您可以在 [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) 和 [匯出虛擬機器的快照](exporting-virtual-machines.md) 集主題中找到顯示匯出虛擬機器的範例。</span><span class="sxs-lookup"><span data-stu-id="2728a-105">Samples that show exporting a virtual machine can be found on the [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) and [Exporting a snapshot of a virtual machine](exporting-virtual-machines.md) topics.</span></span>

<span data-ttu-id="2728a-106">您可以在 [虛擬化範例 (V2) 的一般公用程式 ](common-utilities-for-the-virtualization-samples-v2.md)中找到參考的 c # 公用程式。</span><span class="sxs-lookup"><span data-stu-id="2728a-106">The referenced C# utilities can be found in [Common utilities for the virtualization samples (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="2728a-107">相關主題</span><span class="sxs-lookup"><span data-stu-id="2728a-107">Related topics</span></span>

[<span data-ttu-id="2728a-108">匯出虛擬機器的快照集</span><span class="sxs-lookup"><span data-stu-id="2728a-108">Exporting a snapshot of a virtual machine</span></span>](exporting-virtual-machines.md)

[<span data-ttu-id="2728a-109">**ExportSystemDefinition**</span><span class="sxs-lookup"><span data-stu-id="2728a-109">**ExportSystemDefinition**</span></span>](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)
