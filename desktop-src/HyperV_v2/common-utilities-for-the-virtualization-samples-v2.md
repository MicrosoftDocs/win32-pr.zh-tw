---
description: '某些 c # 虛擬化範例會使用下列公用程式。'
ms.assetid: EB0F305D-806D-4ACB-8024-3A6FB125629D
title: 虛擬化範例 (V2) 的常見公用程式
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119980488"
---
# <a name="common-utilities-for-the-virtualization-samples-v2"></a>虛擬化範例 (V2) 的常見公用程式
