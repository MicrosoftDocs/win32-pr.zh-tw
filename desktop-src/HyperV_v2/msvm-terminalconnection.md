...
api_location:
- vmms.exe
ms.openlocfilehash: 124aa6e4e6ff3b823f16a6d1b2e25055554c35558d7eebc64f38bc9e43f9b86e
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "117810618"
---
# <a name="msvm_terminalconnection-class"></a>Msvm \_ TerminalConnection 類別

表示與虛擬機器互動之作用中遠端會話的狀態。 一次只能有一個連接。
...
**Msvm \_ TerminalConnection** 類別具有下列類型的成員：
...
**Msvm \_ TerminalConnection** 類別具有這些方法。



| 方法                                                                   | 描述                         |
|:-------------------------------------------------------------------------|:------------------------------------|
| [**RequestStateChange**](msvm-terminalconnection-requeststatechange.md) | 要求狀態變更。<br/> |
...
**Msvm \_ TerminalConnection** 類別具有這些屬性。
...
終端連線物件實例的唯一識別碼。 識別碼的格式為 "Microsoft：*VMID* \\ *Index*"。 例如「Microsoft： 67A5D397-A02D-11DB-AC13-001676AA34F0 0」 \\ 。
...
上次要求或預期的專案狀態。 元素的實際狀態是由 **EnabledState** 表示。 這個屬性是用來比較最後一個要求和目前啟用或停用的狀態。 特定的 [**CIM \_ EnabledLogicalElement**](/previous-versions//cc136818(v=vs.85)) 實例可能不支援 **RequestStateChange**。 如果發生這種情況，則會使用值12。 這個屬性繼承自 **CIM \_ EnabledLogicalElement**。
...
存取 **Msvm \_ TerminalConnection** 類別可能受 UAC 篩選所限制。 如需詳細資訊，請參閱 [使用者帳戶控制和 WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi)。
...
[**CIM \_ EnabledLogicalElement**](/previous-versions//cc136818(v=vs.85))
</dt> <dt>
