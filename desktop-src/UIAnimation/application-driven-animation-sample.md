...
description: 使用 Direct2D 以動畫顯示視窗的背景色彩，並同步處理至重新整理率，以顯示應用程式驅動設定中的 Windows 動畫。
...
ms.locfileid: "119137371"
---
# <a name="application-driven-animation-sample"></a>Application-Driven 的動畫範例

使用 Direct2D 以動畫顯示視窗的背景色彩，並同步處理至重新整理率，以顯示應用程式驅動設定中的 Windows 動畫。
