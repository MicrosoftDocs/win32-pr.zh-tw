...
description: 指出 Windows 的動畫可以盡可能延遲排程的分鏡腳本開始時間，以避免排程衝突。
...
ms.locfileid: "119058156"
---
# <a name="ui_animation_seconds_eventually"></a>\_最終 UI 動畫的 \_ 秒數 \_

指出 Windows 的動畫可以盡可能延遲排程的分鏡腳本開始時間，以避免排程衝突。



| 常數/值                                                                                                                                                                                                                                                                  | Description                       |
|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------|
| <span id="UI_ANIMATION_SECONDS_EVENTUALLY"></span><span id="ui_animation_seconds_eventually"></span><dl> <dt>**UI \_動畫 \_ 秒數 \_ 最後**</dt> <dt>-1.0</dt> </dl> | UI \_ 動畫的 \_ 秒數<br/> |
