---
description: 以下是 IP Helper 應用程式的完整原始碼。 已將其他錯誤檢查新增至原始程式碼。
...
---
# <a name="complete-ip-helper-application-source-code"></a><span data-ttu-id="c9960-104">完整 IP 協助程式的原始程式碼</span><span class="sxs-lookup"><span data-stu-id="c9960-104">Complete IP Helper Application Source Code</span></span>

<span data-ttu-id="c9960-105">以下是 IP Helper 應用程式的完整原始碼。</span><span class="sxs-lookup"><span data-stu-id="c9960-105">The following is the complete source code for the IP Helper application.</span></span> <span data-ttu-id="c9960-106">已將其他錯誤檢查新增至原始程式碼。</span><span class="sxs-lookup"><span data-stu-id="c9960-106">Additional error checking has been added to source code.</span></span>
