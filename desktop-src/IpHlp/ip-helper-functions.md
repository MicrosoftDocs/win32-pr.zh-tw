...
ms.locfileid: "118389129"
---
# <a name="ip-helper-functions"></a>IP Helper 函式

下列函式會在本機電腦上抓取和修改 TCP/IP 傳輸的設定。 下列類別清單可協助您判斷哪一組函數最適合指定的工作。
...
## <a name="adapter-management"></a>介面卡管理
...
## <a name="address-resolution-protocol-arp-management"></a> (ARP) 管理的位址解析通訊協定
...
## <a name="interface-conversion"></a>介面轉換
...
-   [**如果 \_ indextoname**](/windows/win32/api/Netioapi/nf-netioapi-if_indextoname)
-   [**如果 \_ nametoindex**](/windows/win32/api/Netioapi/nf-netioapi-if_nametoindex)
...
## <a name="ip-address-management"></a>IP 位址管理
...
## <a name="ip-address-string-conversion"></a>IP 位址字串轉換
...
## <a name="ip-neighbor-address-management"></a>IP 鄰居位址管理
...
## <a name="ip-path-management"></a>IP 路徑管理
...
## <a name="ip-route-management"></a>IP 路由管理
...
## <a name="ip-table-memory-management"></a>IP 資料表記憶體管理

-   [**FreeMibTable**](/windows/win32/api/Netioapi/nf-netioapi-freemibtable)

## <a name="ip-utility"></a>IP 公用程式
...
## <a name="security-health"></a>安全性健康狀態
...
## <a name="teredo-ipv6-client-management"></a>Teredo IPv6 用戶端管理
...
## <a name="transmission-control-protocol-tcp-and-user-datagram-protocol-udp"></a>傳輸控制通訊協定 (TCP) 和使用者資料包協定 (UDP) 
