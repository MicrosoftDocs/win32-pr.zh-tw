...
ms.locfileid: "117753749"
---
# <a name="ivmdvddriveeventsonmediaeject-method"></a>IVMDVDDriveEvents：： OnMediaEject 方法
...
當媒體 (ISO 映像或主機磁片磁碟機中的光碟) 時，會呼叫此方法。 用戶端程式必須執行這個介面方法，以接收來自 IVMDVDDrive 的 vmDVDDriveEvent \_ OnEject 事件的[](ivmdvddrive.md)通知。
