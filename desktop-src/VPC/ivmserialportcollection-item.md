...
ms.locfileid: "119973798"
---
# <a name="ivmserialportcollectionitem-property"></a>IVMSerialPortCollection：： Item 屬性
...
[**IVMSerialPort**](ivmserialport.md)物件。
...
| <dl> <dt>E \_指標</dt><dt>且顯示 0x80004003</dt> </dl>         | *SerialPort* 參數為 Null。 <br/>                                                |
