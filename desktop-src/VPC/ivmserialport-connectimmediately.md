...
---
# <a name="ivmserialportconnectimmediately-property"></a>IVMSerialPort：： ConnectImmediately 屬性

\[Windows 8 不能再使用 Windows Virtual PC。 請改為使用 [HYPER-V WMI 提供者 (V2) ](/windows/desktop/HyperV_v2/windows-virtualization-portal)。\]

判斷是否應該在不等候數據機命令的情況下開啟序列埠。
...
**變異 \_** 如果應該在不等候數據機命令的情況下開啟序列埠，則為 TRUE;**變異 \_否則為 FALSE** 。
...
只有在 [埠 [**類型**](ivmserialport-type.md) ] 屬性是 [ **vmSerialPort \_ HostPort**] 時，這個屬性才有效。
