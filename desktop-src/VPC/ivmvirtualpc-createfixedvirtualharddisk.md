...
ms.locfileid: "119056596"
---
# <a name="ivmvirtualpccreatefixedvirtualharddisk-method"></a>IVMVirtualPC：： CreateFixedVirtualHardDisk 方法
...
影像的大小（以 mb 為單位）。 大小上限為 2088960 MB (2040GB) 。
...
| <dl> <dt>**E \_INVALIDARG**</dt> <dt>0x80000003</dt> </dl>                                 | *Size* 參數小於或等於0。<br/>                                                                                                     |
...
| <dl> <dt>**HRESULT \_從 \_ WIN32 (錯誤 \_ 的 \_ 路徑名稱錯誤)**</dt> <dt>0x800700a1</dt> </dl>    | 這兩個 *imagePath* 參數都指定空的或相對路徑。 至少有一個參數必須是絕對路徑。<br/>                         |
| <dl> <dt>**HRESULT \_從 \_ WIN32 (錯誤 \_ 緩衝區 \_ 溢出)**</dt> <dt>0x8007006f</dt> </dl> | *ImagePath* 參數所指定的路徑太長。 路徑的長度必須小於 **最大 \_ 路徑** (260) 個字元。<br/>                |
...
| <dl> <dt>**VM \_E \_ 影像 \_ 大小 \_ 太 \_ 大**</dt> <dt>0xA0040683</dt> </dl>                | *Size* 參數必須小於 2088960 MB。 如果格式為 FAT16，則 *size* 參數必須小於 2000 MB。<br/>                    |
| <dl> <dt>**VM \_E \_ 影像 \_ 大小 \_ 太 \_ 小**</dt> <dt>0xA0040684</dt> </dl>                | 未格式化和 FAT16 格式化的虛擬硬碟映射必須至少為 3 MB。 FAT32 格式化的虛擬硬碟映射必須至少為 514 MB。<br/>    |
| <dl> <dt>**VM \_E \_ 檔案 \_ 太 \_ 大 \_ ，無法進行 \_ 磁片**</dt>區 <dt>0xA0040679</dt> </dl>          | 主機磁片區無法支援此大小的檔案。 FAT32 磁片區的檔案大小上限為 4 GB。 FAT16 磁片區的檔案大小上限為 2 GB。<br/> |
