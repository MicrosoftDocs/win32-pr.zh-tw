...
ms.locfileid: "119652908"
---
# <a name="ivmvirtualmachinestartup-method"></a>IVMVirtualMachine：： Startup 方法
...
[**IVMTask**](ivmtask.md)物件，可用來追蹤虛擬機器啟動順序的完成進度。
...
| <dl> <dt>**HRESULT \_從 \_ WIN32 (\_ \_ 拒絕存取錯誤)**</dt> <dt>0x80070005</dt> </dl> | 呼叫端必須具有執行存取權限，才能啟動此虛擬機器。<br/> |
| <dl> <dt>**VM \_E \_ 0xA0040202 \_ 計時**</dt> <dt></dt> </dl>                           | 作業未及時完成。<br/>                             |
| <dl> <dt>**VM \_E \_ 0xA0040203 \_ \_ 資源**</dt> <dt></dt> </dl>                    | 沒有足夠的主機資源。<br/>                                           |
| <dl> <dt>**VM \_電子 \_ 0xA0040204 太 \_ 多 \_ vm**</dt> <dt></dt> </dl>                       | 有太多作用中的虛擬機器。<br/>                                    |
| <dl> <dt>**VM \_E \_ VM \_ 正在**</dt>執行 <dt>0xA0040500</dt> </dl>                          | 虛擬機器已在執行中。<br/>                                        |
| <dl> <dt>**VM \_E \_ 父 \_ 修改過**</dt>的 <dt>0xA00400687</dt> </dl>                    | 因為已修改父 VHD，所以無法啟動虛擬機器。<br/>     |
