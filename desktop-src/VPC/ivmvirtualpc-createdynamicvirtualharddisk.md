...
ms.locfileid: "118998648"
---
# <a name="ivmvirtualpccreatedynamicvirtualharddisk-method"></a>IVMVirtualPC：： CreateDynamicVirtualHardDisk 方法
...
影像的大小（以 mb 為單位）。 此值最多可有 2088960 MB 的 (2040GB) 。
