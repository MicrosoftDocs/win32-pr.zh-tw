...
ms.locfileid: "120007148"
---
# <a name="ivmmousehorizontalposition-property"></a>IVMMouse：： HorizontalPosition 屬性
...
表示滑鼠新位置的 x 座標。 使用絕對座標時，此值會指定滑鼠的新 x 座標。 使用相對座標時，此值會指定要以 x 方向移動滑鼠的圖元數。
