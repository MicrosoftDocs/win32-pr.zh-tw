...
---
# <a name="ivmvirtualpccreatevirtualmachine-method"></a>IVMVirtualPC：： CreateVirtualMachine 方法

\[Windows 8 不能再使用 Windows Virtual PC。 請改為使用 [HYPER-V WMI 提供者 (V2) ](/windows/desktop/HyperV_v2/windows-virtualization-portal)。\]

建立新的虛擬機器設定，並捕獲虛擬機器物件。
...
要建立之虛擬機器的名稱。 名稱的長度不能超過80個字元，且 .VMC 和 >.VMCX 檔案的名稱和路徑的加總長度不能超過 **最大 \_ 路徑** (260) 個字元。 建立設定檔時，會將副檔名 .vmc 和. >.vmcx 附加至虛擬機器名稱的結尾。 如果此參數為 **Null** 或空字串，則 *configurationPath* 參數必須指定 .vmc 檔案的完整路徑。
...
將包含 .VMC 檔案的資料夾路徑。 如果這個資料夾不存在，就會建立此資料夾。 如果 *configurationName* 為 **Null** 或空字串，則必須指定新設定檔的完整路徑。
...
| <dl> <dt>**E \_指標**</dt><dt>且顯示 0x80004003</dt> </dl>                                    | *ConfigurationName* 或 *configurationPath* 參數無效，或 *virtualMachine* 參數為 **Null**。<br/>                                                                               |
...
| <dl> <dt>**HRESULT \_從 \_ WIN32 (錯誤 \_ 緩衝區 \_ 溢出)**</dt> <dt>0x8007006f</dt> </dl> | *ConfigurationName* 和 *configurationPath* 參數所指定的路徑會導致路徑太長。 路徑的總長度必須小於 **最大 \_ 路徑** (260) 個字元。<br/> |
| <dl> <dt>**HRESULT \_從 \_ WIN32 (錯誤 \_ 已 \_ 存在)**</dt> <dt>0x800700b7</dt> </dl>  | 此位置已有同名的設定檔。<br/>                                                                                                                                |
| <dl> <dt>**VM \_E \_ 設定 \_ 沒有 \_ 名稱**</dt> <dt>0xA0040400</dt> </dl>                       | *ConfigurationName* 參數是空的。<br/>                                                                                                                                                         |
