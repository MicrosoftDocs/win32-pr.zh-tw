...
ms.locfileid: "118998488"
---
# <a name="ivmvirtualpcvirtualmachines-property"></a>IVMVirtualPC：： VirtualMachines 屬性
...
[**IVMVirtualMachine**](ivmvirtualmachine.md)物件的集合。 請參閱 [**IVMVirtualMachineCollection**](ivmvirtualmachinecollection.md)。
