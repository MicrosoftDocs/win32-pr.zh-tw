...
ms.locfileid: "120006998"
---
# <a name="ivmparallelportcollectionitem-property"></a>IVMParallelPortCollection：： Item 屬性
...
[**IVMParallelPort**](ivmparallelport.md)物件。
...
| <dl> <dt>E \_指標</dt><dt>且顯示 0x80004003</dt> </dl>         | *VmParallelPort* 參數為 **Null**。 <br/>                                        |
