...
---
# <a name="publisher-configuration-file-schema"></a><span data-ttu-id="6c4de-103">發行者設定檔架構</span><span class="sxs-lookup"><span data-stu-id="6c4de-103">Publisher Configuration File Schema</span></span>

<span data-ttu-id="6c4de-104">以下是發行者設定檔架構的完整清單。</span><span class="sxs-lookup"><span data-stu-id="6c4de-104">The following is the complete listing of the publisher configuration file schema.</span></span>
