...
ms.locfileid: "104193089"
---
# <a name="application-configuration-file-schema"></a><span data-ttu-id="2f9bb-103">應用程式佈建檔架構</span><span class="sxs-lookup"><span data-stu-id="2f9bb-103">Application Configuration File Schema</span></span>

<span data-ttu-id="2f9bb-104">以下是應用程式佈建檔架構的完整清單。</span><span class="sxs-lookup"><span data-stu-id="2f9bb-104">The following is the complete listing of the application configuration file schema.</span></span>
