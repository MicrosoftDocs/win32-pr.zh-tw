...
---
# <a name="manifest-file-schema"></a><span data-ttu-id="d86dd-103">資訊清單檔案架構</span><span class="sxs-lookup"><span data-stu-id="d86dd-103">Manifest File Schema</span></span>

<span data-ttu-id="d86dd-104">以下是資訊清單檔案架構的完整清單。</span><span class="sxs-lookup"><span data-stu-id="d86dd-104">The following is the complete listing of the manifest file schema.</span></span>
