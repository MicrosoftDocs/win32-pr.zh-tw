---
description: 裝置上的 Web 服務程式設計介面會定義和使用下列功能：
...
ms.locfileid: "104513464"
---
# <a name="web-services-on-devices-functions"></a>裝置上的 Web 服務功能

裝置上的 Web 服務程式設計介面會定義和使用下列功能：

-   [**PWSD \_ SOAP \_ 訊息 \_ 處理常式**](/windows/win32/api/wsdtypes/nc-wsdtypes-pwsd_soap_message_handler)
-   [**WSD \_ 存根函式 \_**](/windows/win32/api/wsdtypes/nc-wsdtypes-wsd_stub_function)
