---
description: 取得使用者的顯示名稱。
title: DIDiskQuotaUser DisplayName 屬性
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118969457"
---
# <a name="didiskquotauserdisplayname-property"></a>DIDiskQuotaUser DisplayName 屬性
