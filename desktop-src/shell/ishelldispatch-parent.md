...
ms.locfileid: "118969067"
---
# <a name="ishelldispatchparent-property"></a>IShellDispatch 父系屬性
...
這個屬性是透過 [**Shell. Parent**](shell-parent.md) 屬性來執行和存取。

## <a name="examples"></a>範例

下列範例示範如何在 JScript、VBScript 和 Visual Basic 中使用 **父代**。
