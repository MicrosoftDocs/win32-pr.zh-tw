...
ms.locfileid: "119093132"
---
# <a name="folderitems-method"></a>資料夾. 專案方法

抓取 [**FolderItems**](folderitems.md) 物件，該物件表示資料夾中的專案集合。
...
下列範例會使用 **專案** 來判斷 C： Windows 資料夾中的專案數 \\ 。 JScript、VBScript 和 Visual Basic 都會顯示適當的使用方式。
