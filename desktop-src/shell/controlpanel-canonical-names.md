...
從 Windows Vista 開始，Windows 隨附的主控台專案會獲得可用於 [API 呼叫或命令列指令](executing-control-panel-items.md) ，以程式設計方式啟動該專案的標準名稱。 從 Windows 7 和 Windows Server 2008 R2，正式名稱可在群組原則中用來隱藏特定的主控台專案。 本主題提供每個主控台專案的詳細資料：標準名稱、GUID、模組名稱，以及辨識正式名稱的作業系統版本。

> [!Note]  
> 在 Windows Vista 之前，不支援主控台專案的正式名稱。
...
-   **支援的作業系統**： Windows 7、Windows 8、Windows 8。1
...
-   此值啟動的視窗在 Windows 8 之前的 Windows 版本中，標題為「位置資訊」。 當 Windows 8 時，專案的 UI 會大幅變更。
...
|-------------------------------------------------------------|-----------------------------------|----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| AddHardware                                       | 新增硬體                      | {7A979262-40CE-46ff-AEEE-7884AC3B6136} | 與 Windows 7 的 [DevicesAndPrinters](#devices-and-printers) 對應。                                                                                                                                                                                                                                                                            |
| AudioDevicesAndSoundThemes                        | 音效                             | {F2DDFC82-8F12-4CDD-B7DC-D4FE1425AA4D} | 對應至 Windows 7 的 [Microsoft 音效](#sound) 。                                                                                                                                                                                                                                                                                                        |
| BackupAndRestoreCenter/Microsoft. BackupAndRestore | 備份及還原中心         | {B98A2BEA-7D42-4558-8BD1-832F41BAC6FD} | BackupAndRestoreCenter 對應至 Windows 7 的 BackupAndRestore。 從 Windows 8 移除兩者;請改用 [FileHistory](#file-history) 。                                                                                                                                                                                   |
...
| InfraredOptions                                   | 紅外線                          | {A0275511-0E86-4ECA-97C2-ECD8F1221D08} | 對應至 Windows 7 的 [Microsoft 紅外線](#infrared) 。                                                                                                                                                                                                                                                                                                  |
| Microsoft. Language                                          | 語言                          | {BF782CC9-5A52-4A17-806C-2A894FFEEAC5} | 從 Windows 10 1803 版移除                                                                                                                                                                                                                                                                                                                    |
| LocationAndOtherSensors                           | 定位和其他感應器        | {E9950154-C418-419e-A90A-20C5287AE24B} | 從 Windows 8 對應至 [LocationSettings](#infrared) 。                                                                                                                                                                                                                                                                                          |
| PenAndInputDevices                                | 畫筆和輸入裝置             | {F82DF8F7-8B9F-442E-A48C-818EA735FF9B} | 與 Windows 7 的 [PenAndTouch](#pen-and-touch) 對應。                                                                                                                                                                                                                                                                                          |
...
| PhoneAndModemOptions                              | 電話和數據機                   | {40419485-C444-4567-851A-2DD7BFA1684D} | 與 Windows 7 的 [PhoneAndModem](#phone-and-modem) 對應。                                                                                                                                                                                                                                                                                      |
| Microsoft 印表機                                          | 印表機                          | {2227A280-3AEA-1069-A2DE-08002B30309D} | 與 Windows 7 的 [DevicesAndPrinters](#devices-and-printers) 對應。                                                                                                                                                                                                                                                                            |
| ProblemReportsAndSolutions                        | 問題報告與解決方案     | {FCFEECAE-EE1B-4849-AE50-685DCF7717EC} | 與 Windows 7 的 [ActionCenter](#action-center) 對應。                                                                                                                                                                                                                                                                                         |
| RegionalAndLanguageOptions                        | 地區及語言選項     | {62D8ED13-C9D0-4CE8-A914-47DD628FB1B0} | 與 Windows 7 的 [RegionAndLanguage](#region) 對應。 請注意，從 Windows 8，區域和語言都有各自的主控台專案。 RegionalAndLanguageOptions 和 Microsoft RegionAndLanguage 目前都會開啟區域專案。 您必須使用 [Microsoft 語言](#location-settings) 來存取語言專案。 |
| SecurityCenter                                    | Windows 資訊安全中心           | {087DA31B-0DD3-4537-8E23-64A18591F88B} | 與 Windows 7 的 [ActionCenter](#action-center) 對應。                                                                                                                                                                                                                                                                                         |
| SpeechRecognitionOptions                          | 語音辨識選項        | {58E3C745-D971-4081-9034-86E34B30836A} | 與 Windows 7 的 [SpeechRecognition](#speech-recognition) 對應。                                                                                                                                                                                                                                                                               |
| TaskbarAndStartMenu                               | 工作列和 [開始] 功能表            | {0DF44EAA-FF21-4412-828E-260A8728E7F1} | 從 Windows 8 對應到 [Microsoft 的工作列](#speech-recognition) 。                                                                                                                                                                                                                                                                                         |
| WelcomeCenter                                     | 迎賓中心                    | {CB1B7F8C-C50A-4176-B604-9E24DEE8D4D1} | 對應至 Windows 7 中的 GettingStarted。 從 Windows 8 啟動主控台首頁。                                                                                                                                                                                                                                                      |
| WindowsSidebarProperties                          | Windows 提要欄位屬性        | {37efd44d-ef8d-41b1-940d-96973a50e9e0} | 對應至 Windows 7 中的 DesktopGadgets。 從 Windows 8 移除。                                                                                                                                                                                                                                                                                   |
...
從 Windows 7，您可以使用標準名稱，透過群組原則來限制對個別主控台專案的存取。 這相同的程式可以在 Windows Vista 中使用，但您必須使用模組名稱，而不是正式名稱。
...
您可能會在主控台中看到未列在其中的專案。 這些專案不是 Windows 的一部分，而是在安裝各種軟體和硬體（例如 Microsoft Office 或視訊卡）期間新增。 非 Windows 主控台專案不一定會有正式名稱。 若要找出此處未列出的主控台專案的正式名稱，請在下列路徑中查看登錄：
