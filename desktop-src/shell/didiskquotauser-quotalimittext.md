...
ms.locfileid: "109843229"
---
# <a name="didiskquotauserquotalimittext-property"></a>DIDiskQuotaUser. QuotaLimitText 屬性

取得使用者目前的 [**配額限制**](diskquotacontrol-object.md) ，作為文字字串。
