...
| **NoSharing**     | 在 Windows Vista 或更新版本下不支援。 將此專案設定為1，以防止資料夾共用。                                                                                                                                                                                                                                                                       |
| **IconFile**      | 如果您想要指定資料夾的自訂圖示，請將此專案設定為圖示的檔案名。 .Ico 副檔名是慣用的，但也可以指定 .bmp 檔，或包含圖示的 .exe 和 .dll 檔案。 如果您使用相對路徑，則圖示可供透過網路觀看資料夾的人員使用。 您也必須設定 **>iconindex** 專案。 |
