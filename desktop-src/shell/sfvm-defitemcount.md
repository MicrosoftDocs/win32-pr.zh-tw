...
---
# <a name="sfvm_defitemcount-message"></a>SFVM \_ DEFITEMCOUNT 訊息

允許回呼物件指定資料夾檢視中的專案數。 由 [**IShellFolderViewCB：： MessageSFVCB**](/windows/win32/api/shlobj_core/nf-shlobj_core-ishellfolderviewcb-messagesfvcb)使用。
