...
ms.locfileid: "119937078"
---
# <a name="folderitemmodifydate-property"></a>FolderItem. ModifyDate 屬性

針對檔案，設定或取得上次修改的日期和時間。 針對資料夾，會抓取資料夾上次修改的日期和時間，但無法加以設定。
...
指定或接收上次修改專案之日期和時間的 **日期**。

## <a name="examples"></a>範例

下列範例會使用 **ModifyDate** 來取出記事本的上次修改日期，然後將它重設為很長的一段時間。 JScript、VBScript 和 Visual Basic 都會顯示適當的使用方式。
