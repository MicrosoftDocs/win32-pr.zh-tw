...
ms.locfileid: "118364066"
---
# <a name="setnetworkinfoinblob-function"></a>SetNetworkInfoInBlob 函式

**SetNetworkInfoInBlob** 函式會填入 BLOB 中的 **NETWORKINFO** 結構。
...
函式所填滿之使用者配置 [NETWORKINFO](networkinfo.md) 結構的指標。
