...
---
# <a name="idelaydcquerystations-method"></a>IDelaydC：： QueryStations 方法
...
在輸出時，此結構會傳回每一部電腦的捕獲資料和 [STATIONQUERY](stationquery.md) 結構的電腦數目。 請注意，這份清單可能包含使用早2.0 版的網路監視器版本的電腦。
...
| 傳回碼                                                                                           | Description                                               |
|-------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| <dl> <dt>**NMERR \_ \_ 記憶體不足 \_**</dt> </dl> | 沒有記憶體可用來處理此查詢。<br/> |
