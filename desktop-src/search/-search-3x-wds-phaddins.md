...
-   Windows搜尋通訊協定處理常式會使用類似 SharePoint Server 的設計規格，而且通常可以交換使用。 如需詳細資訊，請參閱[SharePoint Server 開發人員中心](https://developer.microsoft.com/office/docs)。
-   在 Windows 7 和更新版本中，SharePoint Search Server 2008 和 MOSS 2007 SP2 也支援同盟搜尋。 如需使用 Office SharePoint Server 2007 部署同盟搜尋和搜尋伺服器2008的詳細資訊，請參閱同盟[搜尋 \[ 搜尋 \] 伺服器 2008](/previous-versions/office/bb931109(v=office.14))。
