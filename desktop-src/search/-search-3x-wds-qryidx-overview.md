...
> [!Note]  
> 舊版 Microsoft Windows Desktop 搜尋 (WDS) 2x 相容性：在執行 Windows XP 和更新版本的電腦上， [**ISearchDesktop**](/previous-versions//aa965729(v=vs.85))已被取代。 相反地，開發人員應該使用 [**ISearchQueryHelper**](/windows/win32/api/Searchapi/nn-searchapi-isearchqueryhelper)取得連接字串，並將使用者的查詢剖析結構化查詢語言 (SQL)  (SQL) ，然後查詢物件連結與嵌入資料庫 (OLE DB) 。
...
-   若要下載搜尋 SDK 程式碼範例：
    -   針對 Windows 7： [GitHub 上的 Windows Search 範例](https://github.com/Microsoft/Windows-classic-samples/tree/master/Samples/Win7Samples/winui/WindowsSearch)
    -   針對 Windows Vista： [Windows Search SDK 範例](https://www.microsoft.com/downloads/details.aspx?FamilyID=645300AE-5E7A-4CE7-95F0-49793F8F76E8)
-   若要下載 Windows SDK：
    -   針對 Windows 7： [Windows SDK Windows 7 和 .NET Framework](https://msdn.microsoft.com/windowsvista/bb980924.aspx)
    -   針對 Windows vista： [Windows SDK 適用于 Windows vista 和 .NET Framework](https://www.microsoft.com/download/details.aspx?id=31950)

## <a name="related-topics"></a>相關主題

<dl> <dt>

[Windows搜尋開發指南](-search-developers-guide-entry-page.md)
</dt> <dt>
