---
description: 深入瞭解： Windows7Api. JetConfigureProcessForCrashDump 方法
title: 'Windows7Api. JetConfigureProcessForCrashDump 方法 (最為理想的) '
...
ms.locfileid: "106979014"
---
# <a name="windows7apijetconfigureprocessforcrashdump-method"></a>Windows7Api. JetConfigureProcessForCrashDump 方法
...
#### <a name="parameters"></a>參數
  ...
  - grbit  
    型別： [最為理想. CrashDumpGrbit](./crashdumpgrbit-enumeration.md)  
