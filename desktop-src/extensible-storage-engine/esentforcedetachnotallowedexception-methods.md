...
---
# <a name="esentforcedetachnotallowedexception-methods"></a>EsentForceDetachNotAllowedException 方法

包含受保護的成員  
包含繼承的成員  

[EsentForceDetachNotAllowedException](./esentforcedetachnotallowedexception-class.md)類型會公開下列成員。
...
[EsentForceDetachNotAllowedException 類別](./esentforcedetachnotallowedexception-class.md)
