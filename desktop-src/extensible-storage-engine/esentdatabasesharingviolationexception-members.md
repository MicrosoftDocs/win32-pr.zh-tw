...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 589c91718d81c0317e0c3455483abca1d2ee7527be7595d9c67a77a7fe3f0cfb
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118780582"
---
# <a name="esentdatabasesharingviolationexception-members"></a>EsentDatabaseSharingViolationException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。DatabaseSharingViolation 例外狀況。

[EsentDatabaseSharingViolationException](./esentdatabasesharingviolationexception-class.md)類型會公開下列成員。
...
<td><a href="dn334373(v=exchg.10).md">EsentDatabaseSharingViolationException</a></td>
<td>初始化 EsentDatabaseSharingViolationException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentDatabaseSharingViolationException 類別](./esentdatabasesharingviolationexception-class.md)
