...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 17c15189197fc47aae4309c2926e83fc30f9729cba0ca60ffb0a370c53efe3d5
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118779205"
---
# <a name="esenterrorexception-methods"></a>EsentErrorException 方法

包含受保護的成員  
包含繼承的成員  

[EsentErrorException](./esenterrorexception-class.md)類型會公開下列成員。
...
<td>在衍生類別中覆寫時，使用例外狀況的相關資訊設定 <a href="/dotnet/api/system.runtime.serialization.serializationinfo">SerializationInfo</a> 。  (覆寫 <a href="/dotnet/api/system.exception.getobjectdata#System_Exception_GetObjectData_System_Runtime_Serialization_SerializationInfo_System_Runtime_Serialization_StreamingContext_">例外狀況。 GetObjectData (SerializationInfo、StreamingCoNtext) </a>。 ) </td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="公用方法" alt="Public method" /></td>
