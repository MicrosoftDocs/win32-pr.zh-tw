...
<td>您正在執行 MinESE，但未在中編譯所有功能。 只有完整版的 ESE 才支援這項功能。</td>
</tr>
<tr class="even">
<td></td>
<td>UnloadableOSFunctionality</td>
<td>找不到或無法載入/連結所需的 OS 功能。</td>
</tr>
<tr class="odd">
<td></td>
<td>DatabaseBufferDependenciesCorrupted</td>
<td>緩衝區相依性設定不當。 復原失敗</td>
</tr>
<tr class="even">
<td></td>
...
<td>AvailExt cache 不符合 btree</td>
</tr>
<tr class="even">
<td></td>
<td>SPAvailExtCorrupted</td>
<td>AvailExt 空間樹狀結構已損毀</td>
</tr>
<tr class="odd">
<td></td>
<td>SPAvailExtCacheOutOfMemory</td>
<td>記憶體不足，無法配置 AvailExt 快取節點</td>
</tr>
<tr class="even">
<td></td>
<td>SPOwnExtCorrupted</td>
<td>OwnExt 空間樹狀結構已損毀</td>
</tr>
<tr class="odd">
<td></td>
<td>DbTimeCorrupted</td>
<td>目前頁面上的 Dbtime 大於全域資料庫 Dbtime</td>
</tr>
<tr class="even">
<td></td>
<td>KeyTruncated</td>
<td>索引上的索引鍵被截斷，但不允許金鑰截斷</td>
</tr>
<tr class="odd">
<td></td>
<td>DatabaseLeakInSpace</td>
<td>某些資料庫頁面即使從可用樹狀結構變成無法連接，但只有離線磁碟重組可能會傳回遺失的空間。</td>
</tr>
<tr class="even">
<td></td>
<td>BadEmptyPage</td>
<td>資料庫損毀。 搜尋非預期的空白頁面。</td>
</tr>
<tr class="odd">
<td></td>
<td>KeyTooBig</td>
...
<td>不合法的嘗試分隔必須是內建的 LV</td>
</tr>
<tr class="odd">
<td></td>
<td>SeparatedLongValue</td>
<td>分隔的 long 值不支援操作</td>
</tr>
<tr class="even">
<td></td>
<td>MustBeSeparateLongValue</td>
<td>只能 preread 可分隔的 long 值資料行，例如不受限制的大小，使其成為固定或變數資料行</td>
</tr>
<tr class="odd">
<td></td>
<td>InvalidPreread</td>
<td>當目前索引次要時，無法 preread long 值</td>
</tr>
<tr class="even">
<td></td>
...
<td>嘗試在復原重做期間記錄一些內容</td>
</tr>
<tr class="even">
<td></td>
<td>LogGenerationMismatch</td>
<td>記錄檔的名稱與內部世代編號不相符</td>
</tr>
<tr class="odd">
<td></td>
<td>BadLogVersion</td>
<td>記錄檔版本與 Jet 版本不相容</td>
</tr>
<tr class="even">
<td></td>
<td>InvalidLogSequence</td>
<td>下一個記錄檔中的時間戳記不符合預期</td>
</tr>
<tr class="odd">
<td></td>
...
<td>復原期間找不到 Patch file 頁面</td>
</tr>
<tr class="even">
<td></td>
<td>BadPatchPage</td>
<td>Patch file 頁面無效</td>
</tr>
<tr class="odd">
<td></td>
<td>RedoAbruptEnded</td>
<td>由於從記錄檔讀取記錄檔突然失敗，重做突然結束</td>
</tr>
<tr class="even">
<td></td>
...
<td>資料庫與資料流程檔案彼此不相符</td>
</tr>
<tr class="even">
<td></td>
<td>LogFileSizeMismatch</td>
<td>實際記錄檔大小不符合 JET_paramLogFileSize</td>
</tr>
<tr class="odd">
<td></td>
...
<td>「軟復原」適用于備份資料庫。 應改用 Restore</td>
</tr>
<tr class="even">
<td></td>
<td>LogFileSizeMismatchDatabasesConsistent</td>
<td>已復原資料庫，但復原期間使用的記錄檔大小不符 JET_paramLogFileSize</td>
</tr>
<tr class="odd">
<td></td>
<td>LogSectorSizeMismatch</td>
<td>記錄檔磁區大小與目前磁片區的磁區大小不符</td>
</tr>
<tr class="even">
<td></td>
<td>LogSectorSizeMismatchDatabasesConsistent</td>
<td>已復原資料庫，但在復原期間使用的記錄檔磁區大小 () 不符合目前磁片區的磁區大小</td>
</tr>
<tr class="odd">
<td></td>
<td>LogSequenceEndDatabasesConsistent</td>
<td>已復原資料庫，但目前的序列中會使用所有可能的記錄層代;先刪除所有記錄檔和檢查點檔案，然後備份資料庫，再繼續進行</td>
</tr>
<tr class="even">
<td></td>
<td>StreamingDataNotLogged</td>
<td>嘗試重新執行未記錄資料的串流檔案作業時，不合法。 可能是因為嘗試向前復原已啟用迴圈記錄所致</td>
</tr>
<tr class="odd">
<td></td>
<td>DatabaseDirtyShutdown</td>
<td>資料庫未完全關閉。 必須先執行復原，才能正確完成先前關機的資料庫作業。</td>
</tr>
<tr class="even">
<td></td>
...
<td>嘗試使用只部分轉換為目前格式的資料庫--必須從備份還原</td>
</tr>
<tr class="odd">
<td></td>
<td>MissingCurrentLogFiles</td>
<td>部分目前的記錄檔遺漏了連續還原</td>
</tr>
<tr class="even">
<td></td>
<td>DbTimeTooOld</td>
<td>dbtime 在頁面上小於 dbtimeBefore 的記錄</td>
</tr>
<tr class="odd">
<td></td>
<td>DbTimeTooNew</td>
<td>在 dbtimeBefore 的記錄中預先 dbtime 頁面</td>
</tr>
<tr class="even">
<td></td>
<td>MissingFileToBackup</td>
<td>備份期間缺少某些記錄檔或修補檔案</td>
</tr>
<tr class="odd">
<td></td>
<td>LogTornWriteDuringHardRestore</td>
<td>在硬式還原期間于備份組中偵測到損毀寫入</td>
</tr>
<tr class="even">
<td></td>
<td>LogTornWriteDuringHardRecovery</td>
<td>硬碟上偵測到損毀寫入 (記錄檔不是備份組的一部分) </td>
</tr>
<tr class="odd">
<td></td>
<td>LogCorruptDuringHardRestore</td>
<td>在硬還原期間于備份組中偵測到損毀</td>
</tr>
<tr class="even">
<td></td>
<td>LogCorruptDuringHardRecovery</td>
<td>硬碟上偵測到損毀 (記錄檔不是備份組的一部分) </td>
</tr>
<tr class="odd">
<td></td>
<td>MustDisableLoggingForDbUpgrade</td>
<td>嘗試升級 db 時，無法啟用記錄功能</td>
</tr>
<tr class="even">
<td></td>
<td>BadRestoreTargetInstance</td>
<td>找不到指定給 restore 的 TargetInstance 或記錄檔不相符</td>
</tr>
<tr class="odd">
<td></td>
<td>RecoveredWithoutUndo</td>
<td>軟復原已成功重新執行所有作業，但已略過復原的復原階段</td>
</tr>
<tr class="even">
<td></td>
<td>DatabasesNotFromSameSnapshot</td>
<td>要還原的資料庫不是來自相同的陰影複本備份</td>
</tr>
<tr class="odd">
<td></td>
<td>SoftRecoveryOnSnapshot</td>
<td>從陰影複本備份集對資料庫進行軟復原</td>
</tr>
<tr class="even">
<td></td>
<td>CommittedLogFilesMissing</td>
<td>遺漏一或多個已認可至此資料庫的記錄。 這些記錄檔是維護持久 ACID 語義的必要項，但如果在復原期間指定了 JET_bitReplayIgnoreLostLogs 位，則不需要維護一致性。</td>
</tr>
<tr class="odd">
<td></td>
<td>SectorSizeNotSupported</td>
<td>特定檔案類型的 ESE 不支援磁片子系統所報告的實體磁區大小。</td>
</tr>
<tr class="even">
<td></td>
<td>RecoveredWithoutUndoDatabasesConsistent</td>
<td>軟復原已成功重新執行所有作業，目的是略過復原的復原階段，但不需要復原階段</td>
</tr>
<tr class="odd">
<td></td>
<td>CommittedLogFileCorrupt</td>
<td>在復原期間發現一或多個記錄檔已損毀。 這些記錄檔是維護持久 ACID 語義的必要項，但如果在復原期間指定了 JET_bitIgnoreLostLogs 位和 JET_paramDeleteOutOfRangeLogs，則不需要維護一致性。</td>
</tr>
<tr class="even">
<td></td>
<td>UnicodeTranslationBufferTooSmall</td>
<td>Unicode 轉譯緩衝區太小</td>
</tr>
<tr class="odd">
<td></td>
...
<td>作業系統不支援 Unicode normalisation (，且未指定 normalisation 回呼) </td>
</tr>
<tr class="odd">
<td></td>
...
<td>檢查點和目前世代之間有太多未完成的層代</td>
</tr>
<tr class="odd">
<td></td>
<td>RestoreOfNonBackupDatabase</td>
<td>在不是備份資料庫的資料庫上嘗試進行硬復原</td>
</tr>
<tr class="even">
<td></td>
<td>LogFileNotCopied</td>
<td>已嘗試記錄截斷，但未複製所有必要的記錄檔</td>
</tr>
<tr class="odd">
<td></td>
...
<td>藉由使用 JET_bitTermStopBackup 呼叫 JetTerm 或呼叫 JetStopBackup，伺服器中止備份</td>
</tr>
<tr class="odd">
<td></td>
<td>InvalidGrbit</td>
...
<td>LCMapString () 的旗標無效</td>
</tr>
<tr class="even">
<td></td>
<td>VersionStoreEntryTooBig</td>
<td>嘗試建立 (RCE) 大於版本值區的版本存放區專案</td>
</tr>
<tr class="odd">
<td></td>
<td>VersionStoreOutOfMemoryAndCleanupTimedOut</td>
<td>版本存放區記憶體不足 (和清除嘗試無法完成) </td>
</tr>
<tr class="even">
<td></td>
<td>VersionStoreOutOfMemory</td>
<td>版本存放區記憶體不足 (清除已嘗試) </td>
</tr>
<tr class="odd">
<td></td>
<td>CurrencyStackOutOfMemory</td>
<td>未使用： lCSRPerfFUCB * g_lCursorsMax 超過 (僅限 XJET) </td>
</tr>
<tr class="even">
<td></td>
<td>CannotIndex</td>
<td>無法為的資料行或 SLV 資料行建立索引</td>
</tr>
<tr class="odd">
<td></td>
...
<td>要求的 mempool 專案太多</td>
</tr>
<tr class="odd">
<td></td>
<td>OutOfObjectIDs</td>
<td>超出 btree Objectid (執行離線磁碟重組來回收釋出/未使用的 Objectid) </td>
</tr>
<tr class="even">
<td></td>
<td>OutOfLongValueIDs</td>
<td>長值識別碼計數器已達到最大值。  (執行離線磁碟重組來回收免費/未使用的 LongValueIDs) </td>
</tr>
<tr class="odd">
<td></td>
<td>OutOfAutoincrementValues</td>
<td>自動遞增計數器已達到最大值 (離線重組將無法回收免費/未使用的自動遞增值) 。</td>
</tr>
<tr class="even">
<td></td>
<td>OutOfDbtimeValues</td>
<td>Dbtime 計數器已達到最大值 (執行離線磁碟重組，以回收可用/未使用的 Dbtime 值) </td>
</tr>
<tr class="odd">
<td></td>
<td>OutOfSequentialIndexValues</td>
<td>連續索引計數器已達到最大值 (執行離線磁碟重組，以回收可用/未使用的 SequentialIndex 值) </td>
</tr>
<tr class="even">
<td></td>
<td>RunningInOneInstanceMode</td>
<td>啟用單一實例模式的多重實例呼叫</td>
</tr>
<tr class="odd">
<td></td>
<td>RunningInMultiInstanceMode</td>
<td>啟用多重實例模式的單一實例呼叫</td>
</tr>
<tr class="even">
<td></td>
...
<td>已有另一個資料庫實例使用的系統路徑</td>
</tr>
<tr class="even">
<td></td>
<td>LogFilePathInUse</td>
<td>已有另一個資料庫實例使用的記錄檔路徑</td>
</tr>
<tr class="odd">
<td></td>
<td>TempPathInUse</td>
<td>已有另一個資料庫實例使用的暫存路徑</td>
</tr>
<tr class="even">
<td></td>
...
<td>因為發生嚴重錯誤，所以無法使用這個實例</td>
</tr>
<tr class="even">
<td></td>
<td>DatabaseUnavailable</td>
<td>無法使用此資料庫，因為發生嚴重錯誤</td>
</tr>
<tr class="odd">
<td></td>
<td>InstanceUnavailableDueToFatalLogDiskFull</td>
<td>無法使用這個實例，因為它在執行作業時發生記錄磁片-完整錯誤 (可能是交易回復) 無法容忍失敗</td>
</tr>
<tr class="even">
<td></td>
<td>OutOfSessions</td>
...
<td>嘗試以相同會話中的兩個 diffrerent 資料指標取代相同的記錄</td>
</tr>
<tr class="odd">
<td></td>
<td>RecordTooBigForBackwardCompatibility</td>
<td>如果以舊版 Jet 的資料庫格式表示，記錄將會太大</td>
</tr>
<tr class="even">
<td></td>
<td>CannotMaterializeForwardOnlySort</td>
<td>因為與 JET_bitTTForwardOnly 衝突的參數，所以無法建立臨時表</td>
</tr>
<tr class="odd">
<td></td>
<td>SesidTableIdMismatch</td>
<td>此會話控制碼無法搭配此資料表識別碼使用</td>
</tr>
<tr class="even">
<td></td>
...
<td></td>
<td>DirtyShutdown</td>
<td>已成功關閉實例，但透過要求的要求已將所有附加的資料庫保持為中途狀態 JET_bitTermDirty</td>
</tr>
<tr class="even">
<td></td>
<td>ReadPgnoVerifyFailure</td>
<td>從磁片讀取的資料庫頁面有錯誤的頁面號碼。</td>
</tr>
<tr class="odd">
<td></td>
<td>ReadLostFlushVerifyFailure</td>
<td>從磁片讀取的資料庫頁面上有先前的寫入未在頁面上表示。</td>
</tr>
<tr class="even">
<td></td>
<td>FileSystemCorruption</td>
<td>檔案系統作業失敗，並出現錯誤，指出檔案系統已損毀。</td>
</tr>
<tr class="odd">
<td></td>
<td>RecoveryVerifyFailure</td>
<td>復原期間從磁片讀取的一或多個資料庫頁面不符合預期的狀態。</td>
</tr>
<tr class="even">
<td></td>
<td>FilteredMoveNotSupported</td>
<td>嘗試在不支援的案例中，提供 JetSetCursorFilter () 的篩選準則。</td>
</tr>
<tr class="odd">
<td></td>
<td>MustCommitDistributedTransactionToLevel0</td>
<td>嘗試將分散式交易 PrepareToCommit 至非零層級</td>
</tr>
<tr class="even">
<td></td>
<td>DistributedTransactionAlreadyPreparedToCommit</td>
<td>在分散式交易呼叫 PrepareToCommit 之後嘗試寫入作業</td>
</tr>
<tr class="odd">
<td></td>
<td>NotInDistributedTransaction</td>
<td>嘗試 PrepareToCommit 非分散式交易</td>
</tr>
<tr class="even">
<td></td>
<td>DistributedTransactionNotYetPreparedToCommit</td>
<td>已嘗試認可分散式交易，但尚未呼叫 PrepareToCommit</td>
</tr>
<tr class="odd">
<td></td>
<td>CannotNestDistributedTransactions</td>
<td>未在層級0時嘗試開始分散式交易</td>
</tr>
<tr class="even">
<td></td>
<td>DTCMissingCallback</td>
<td>已嘗試開始分散式交易，但 initialisation 上未指定 DTC 協調的回呼</td>
</tr>
<tr class="odd">
<td></td>
<td>DTCMissingCallbackOnRecovery</td>
<td>已嘗試復原分散式交易，但 initialisation 上未指定 DTC 協調的回呼</td>
</tr>
<tr class="even">
<td></td>
<td>DTCCallbackUnexpectedError</td>
<td>從 DTC 回呼傳回未預期的錯誤代碼</td>
</tr>
<tr class="odd">
<td></td>
...
<td>不同的資料庫實例正在使用此資料庫</td>
</tr>
<tr class="even">
<td></td>
<td>AttachedDatabaseMismatch</td>
<td>在復原開始或結束時偵測到未處理的資料庫附件，但資料庫遺失或與附件資訊不符</td>
</tr>
<tr class="odd">
<td></td>
...
<td>正在將已在使用中的識別碼指派給資料庫</td>
</tr>
<tr class="odd">
<td></td>
<td>ForceDetachNotAllowed</td>
<td>只有在正常卸離錯誤之後，才允許強制卸離</td>
</tr>
<tr class="even">
<td></td>
...
<td>復原嘗試重新執行資料庫建立，但是資料庫原本是以不相容 (可能較舊的資料庫引擎) 版本所建立</td>
</tr>
<tr class="odd">
<td></td>
<td>DatabaseIncompleteIncrementalReseed</td>
<td>無法附加資料庫，因為正在將它重建為累加式重設種子的一部分。</td>
</tr>
<tr class="even">
<td></td>
<td>DatabaseInvalidIncrementalReseed</td>
<td>資料庫不是執行累加式重設種子的有效狀態。</td>
</tr>
<tr class="odd">
<td></td>
<td>DatabaseFailedIncrementalReseed</td>
<td>因為發生嚴重錯誤，所以無法完成在指定的資料庫上執行的增量重設種子。 復原此資料庫需要完整重設種子。</td>
</tr>
<tr class="even">
<td></td>
<td>NoAttachmentsFailedIncrementalReseed</td>
<td>在指定的資料庫上執行的增量重設種子無法完成，因為所需的最小記錄檔不包含附件資訊。 復原此資料庫需要完整重設種子。</td>
</tr>
<tr class="odd">
<td></td>
<td>TableLocked</td>
...
<td>使用 CloseTable 而非 >deletetable.java 來刪除臨時表</td>
</tr>
<tr class="even">
<td></td>
...
<td></td>
<td>FixedDDL</td>
<td>此資料表禁止的 DDL 作業</td>
</tr>
<tr class="even">
<td></td>
<td>FixedInheritedDDL</td>
<td>在衍生資料表上，ddl 作業在 DDL 的繼承部分上禁止</td>
</tr>
<tr class="odd">
<td></td>
<td>CannotNestDDL</td>
<td>目前不支援階層式 DDL 的嵌套。</td>
</tr>
<tr class="even">
<td></td>
<td>DDLNotInheritable</td>
<td>嘗試從未標示為範本資料表的資料表繼承 DDL。</td>
</tr>
<tr class="odd">
<td></td>
...
<td>範本資料表是使用 NoFixedVarColumnsInDerivedTables 所建立</td>
</tr>
<tr class="even">
<td></td>
...
<td>為多重值索引產生的非唯一的記錄索引鍵</td>
</tr>
<tr class="odd">
<td></td>
<td>IndexBuildCorrupted</td>
<td>無法建立正確反映主要索引的次要索引</td>
</tr>
<tr class="even">
<td></td>
<td>PrimaryIndexCorrupted</td>
<td>主要索引已損毀。 資料庫必須經過磁碟重組或刪除資料表。</td>
</tr>
<tr class="odd">
<td></td>
<td>SecondaryIndexCorrupted</td>
<td>次要索引已損毀。 資料庫必須經過磁碟重組，或必須刪除受影響的索引。 如果損毀的索引超出 Unicode 文字，可能會導致排序次序變更。</td>
</tr>
<tr class="even">
<td></td>
...
<td>元組索引必須位於 text/binary 資料行</td>
</tr>
<tr class="odd">
<td></td>
<td>IndexTuplesVarSegMacNotAllowed</td>
<td>元組索引不允許設定 cbVarSegMac</td>
</tr>
<tr class="even">
<td></td>
<td>IndexTuplesInvalidLimits</td>
<td>指定索引的最小/最大元組長度或最大字元數無效</td>
</tr>
<tr class="odd">
<td></td>
<td>IndexTuplesCannotRetrieveFromIndex</td>
<td>無法在元組索引上使用 RetrieveFromIndex 呼叫 RetrieveColumn () </td>
</tr>
<tr class="even">
<td></td>
<td>IndexTuplesKeyTooSmall</td>
<td>指定的索引鍵不符合最小元組長度</td>
</tr>
<tr class="odd">
<td></td>
<td>ColumnLong</td>
...
<td>在資料正規化之後，于唯一的多重值資料行上偵測到重複的資料，並在比較之前正規化截斷的資料</td>
</tr>
<tr class="odd">
<td></td>
...
<td>已嘗試將資料行轉換為主要索引預留位置，但資料行不符合必要準則</td>
</tr>
<tr class="odd">
<td></td>
<td>ColumnCannotBeCompressed</td>
<td>只有 JET_coltypLongText 和 JET_coltypLongBinary 資料行可以壓縮</td>
</tr>
<tr class="even">
<td></td>
...
<td>已嘗試在記錄更新進行時更新記錄</td>
</tr>
<tr class="even">
<td></td>
<td>KeyNotMade</td>
<td>沒有呼叫 JetMakeKey</td>
</tr>
<tr class="odd">
<td></td>
<td>UpdateNotPrepared</td>
<td>沒有呼叫 JetPrepareUpdate</td>
</tr>
<tr class="even">
<td></td>
...
<td>多個執行緒正在使用相同的會話</td>
</tr>
<tr class="even">
<td></td>
<td>EntryPointNotFound</td>
<td>找不到 DLL 中所需的進入點</td>
</tr>
<tr class="odd">
<td></td>
...
<td>已嘗試重設會話內容，但目前的執行緒未 orignally 設定會話內容</td>
</tr>
<tr class="odd">
<td></td>
<td>SessionInUse</td>
...
<td>動態記錄格式轉換期間發生內部錯誤</td>
</tr>
<tr class="odd">
<td></td>
<td>OneDatabasePerSession</td>
<td>每個會話僅允許一個開啟的使用者資料庫 (JET_paramOneDatabasePerSession) </td>
</tr>
<tr class="even">
<td></td>
<td>RollbackError</td>
...
<td>因為資料庫已在指定的資料庫上執行維護，所以操作未順利完成</td>
</tr>
<tr class="even">
<td></td>
...
<td>JET 空間提示結構的元素不正確或可採取動作。</td>
</tr>
<tr class="odd">
<td></td>
<td>SLVSpaceCorrupted</td>
<td></td>
</tr>
<tr class="even">
<td></td>
...
<td>無效順序中使用的 OS 陰影複製 API</td>
</tr>
<tr class="even">
<td></td>
<td>OSSnapshotTimeOut</td>
<td>OS 陰影複製已結束，已超時</td>
</tr>
<tr class="odd">
<td></td>
<td>OSSnapshotNotAllowed</td>
<td> (進行備份或復原時，不允許 OS 陰影複製) </td>
</tr>
<tr class="even">
<td></td>
<td>OSSnapshotInvalidSnapId</td>
<td>不正確 JET_OSSNAPID</td>
</tr>
<tr class="odd">
<td></td>
...
<td>提供的記錄資料與實例目前狀態的順序不正確</td>
</tr>
<tr class="even">
<td></td>
<td>LSCallbackNotSpecified</td>
<td>在未指定回呼函數的情況下，嘗試使用本機儲存體</td>
</tr>
<tr class="odd">
<td></td>
<td>LSAlreadySet</td>
...
<td>讀取已發出至 EOF 以外的位置 (寫入將會展開檔案) </td>
</tr>
<tr class="odd">
<td></td>
<td>FileIOAbort</td>
<td>指示 JET_ABORTRETRYFAILCALLBACK 呼叫端中止指定的 i/o</td>
</tr>
<tr class="even">
<td></td>
<td>FileIORetry</td>
<td>指示 JET_ABORTRETRYFAILCALLBACK 呼叫端重試指定的 i/o</td>
</tr>
<tr class="odd">
<td></td>
<td>FileIOFail</td>
<td>指示 JET_ABORTRETRYFAILCALLBACK 呼叫端使指定的 i/o 失敗</td>
</tr>
<tr class="even">
<td></td>
<td>FileCompressed</td>
<td>壓縮檔案不支援讀取/寫入存取</td>
</tr>
</tbody>
</table>
