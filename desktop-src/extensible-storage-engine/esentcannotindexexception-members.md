...
---
# <a name="esentcannotindexexception-members"></a>EsentCannotIndexException 成員
...
[EsentCannotIndexException](./esentcannotindexexception-class.md)類型會公開下列成員。
...
<td><a href="dn274115(v=exchg.10).md">EsentCannotIndexException</a></td>
<td>初始化 EsentCannotIndexException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentCannotIndexException 類別](./esentcannotindexexception-class.md)
