...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 1ce2b06a28b6a694006293db1c3f2579be1583a8d5c92f2445166c6baa25c5e5
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119972778"
---
# <a name="esentinitinprogressexception-members"></a>EsentInitInProgressException 成員

包含受保護的成員  
包含繼承的成員  

JET_err.InitInProgress 例外狀況的基類。

[EsentInitInProgressException](./esentinitinprogressexception-class.md)類型會公開下列成員。
...
<td><a href="dn350506(v=exchg.10).md">EsentInitInProgressException</a></td>
<td>初始化 EsentInitInProgressException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInitInProgressException 類別](./esentinitinprogressexception-class.md)
