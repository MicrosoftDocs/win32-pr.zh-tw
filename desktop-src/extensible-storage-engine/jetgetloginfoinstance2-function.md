...
**Windows xp： JetGetLogInfoInstance2** 是在 windows xp 中引進的。
...
<td><p>實作為 <strong>JetGetLogInfoInstance2W</strong> (Unicode) 和 <strong>JetGetLogInfoInstance2A</strong> (ANSI) 。</p></td>
</tr>
</tbody>
</table>
