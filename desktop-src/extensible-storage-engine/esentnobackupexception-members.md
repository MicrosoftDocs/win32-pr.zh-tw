---
description: 深入瞭解： EsentNoBackupException 成員
title: EsentNoBackupException 成員
TOCTitle: EsentNoBackupException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentNoBackupException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentnobackupexception_members(v=EXCHG.10)
ms:contentKeyID: 55102355
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 03e735dce21fc50fb4ef034e89e84f8471d54ce31c0653e5ce8289fad23dd6a0
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118263646"
---
# <a name="esentnobackupexception-members"></a>EsentNoBackupException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。NoBackup 例外狀況。

[EsentNoBackupException](./esentnobackupexception-class.md)類型會公開下列成員。
...
<td><a href="dn319685(v=exchg.10).md">EsentNoBackupException</a></td>
<td>初始化 EsentNoBackupException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentNoBackupException 類別](./esentnobackupexception-class.md)
