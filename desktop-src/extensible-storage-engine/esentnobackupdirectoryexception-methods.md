---
description: 深入瞭解： EsentNoBackupDirectoryException 方法
title: EsentNoBackupDirectoryException 方法
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentnobackupdirectoryexception_methods(v=EXCHG.10)
