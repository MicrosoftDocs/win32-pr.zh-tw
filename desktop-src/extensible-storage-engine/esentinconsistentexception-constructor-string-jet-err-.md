...
ms.locfileid: "118268060"
---
# <a name="esentinconsistentexception-constructor-string-jet_err"></a>EsentInconsistentException (字串 JET_err) 的函式

初始化 EsentInconsistentException 類別的新實例。
