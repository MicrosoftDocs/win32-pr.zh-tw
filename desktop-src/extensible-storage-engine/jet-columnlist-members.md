---
description: 深入瞭解： JET_COLUMNLIST 成員
title: JET_COLUMNLIST 成員
TOCTitle: JET_COLUMNLIST members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.JET_COLUMNLIST
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.jet_columnlist_members(v=EXCHG.10)
...
ms.locfileid: "104553845"
---
# <a name="jet_columnlist-members"></a>JET_COLUMNLIST 成員

包含受保護的成員  
包含繼承的成員  

臨時表的相關資訊，其中包含指定資料表之所有資料行的相關資訊。

[JET_COLUMNLIST](./jet-columnlist-class.md)類型會公開下列成員。
...
<td><a href="dn335099(v=exchg.10).md">JET_COLUMNLIST</a></td>
<td></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="公用方法" alt="Public method" /></td>
<td><a href="dn335098(v=exchg.10).md">ToString</a></td>
<td>傳回表示目前<a href="dn335047(v=exchg.10).md">JET_COLUMNLIST</a>的<a href="/dotnet/api/system.string">字串</a>。  (會覆寫 <a href="/dotnet/api/system.object.tostring#System_Object_ToString">物件 ToString () </a>。 ) </td>
</tr>
</tbody>
</table>
