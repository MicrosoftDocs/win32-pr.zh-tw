...
JET_err 的基類。InvalidBookmark 例外狀況。

[EsentInvalidBookmarkException](./esentinvalidbookmarkexception-class.md)類型會公開下列成員。
...
<td><a href="dn319439(v=exchg.10).md">EsentInvalidBookmarkException</a></td>
<td>初始化 EsentInvalidBookmarkException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInvalidBookmarkException 類別](./esentinvalidbookmarkexception-class.md)
