---
description: 深入瞭解： EsentInvalidParameterException 的函式
title: EsentInvalidParameterException 函式
...
初始化 EsentInvalidParameterException 類別的新實例。
...
[EsentInvalidParameterException 成員](./esentinvalidparameterexception-members.md)
