...
| <p><strong>Unicode</strong></p> | <p>實作為 <strong>JetCreateTableColumnIndexW</strong> (Unicode) 和 <strong>JetCreateTableColumnIndexA</strong> (ANSI) 。</p> | 
