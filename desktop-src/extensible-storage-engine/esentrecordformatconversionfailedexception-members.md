...
---
# <a name="esentrecordformatconversionfailedexception-members"></a>EsentRecordFormatConversionFailedException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。RecordFormatConversionFailed 例外狀況。

[EsentRecordFormatConversionFailedException](./esentrecordformatconversionfailedexception-class.md)類型會公開下列成員。
...
<td><a href="dn319839(v=exchg.10).md">EsentRecordFormatConversionFailedException</a></td>
<td>初始化 EsentRecordFormatConversionFailedException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentRecordFormatConversionFailedException 類別](./esentrecordformatconversionfailedexception-class.md)
