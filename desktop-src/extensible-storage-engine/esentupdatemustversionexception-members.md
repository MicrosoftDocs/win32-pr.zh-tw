...
---
# <a name="esentupdatemustversionexception-members"></a>EsentUpdateMustVersionException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。UpdateMustVersion 例外狀況。

[EsentUpdateMustVersionException](./esentupdatemustversionexception-class.md)類型會公開下列成員。
...
<td><a href="dn350840(v=exchg.10).md">EsentUpdateMustVersionException</a></td>
<td>初始化 EsentUpdateMustVersionException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentUpdateMustVersionException 類別](./esentupdatemustversionexception-class.md)
