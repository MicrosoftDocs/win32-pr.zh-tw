...
---
# <a name="apijetgettableinfo-method-jet_sesid-jet_tableid-jet_dbid-jet_tblinfo"></a>JetGetTableInfo 方法 (JET_SESID、JET_TABLEID、JET_DBID JET_TblInfo) 
...
這個多載會搭配 [Dbid](./jet-tblinfo-enumeration.md)使用。
