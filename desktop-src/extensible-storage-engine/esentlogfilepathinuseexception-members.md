---
description: 深入瞭解： EsentLogFilePathInUseException 成員
title: EsentLogFilePathInUseException 成員
TOCTitle: EsentLogFilePathInUseException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentLogFilePathInUseException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentlogfilepathinuseexception_members(v=EXCHG.10)
ms:contentKeyID: 55102182
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 9ca797d2193e7d2b56dda02b93c1d790bb1c9f27b7af171b82ab3fa90df7e26d
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "117900487"
---
# <a name="esentlogfilepathinuseexception-members"></a>EsentLogFilePathInUseException 成員
...
[EsentLogFilePathInUseException](./esentlogfilepathinuseexception-class.md)類型會公開下列成員。
...
<td><a href="dn334628(v=exchg.10).md">EsentLogFilePathInUseException</a></td>
<td>初始化 EsentLogFilePathInUseException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentLogFilePathInUseException 類別](./esentlogfilepathinuseexception-class.md)
