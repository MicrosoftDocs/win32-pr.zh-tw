---
description: 深入瞭解： JET_OSSNAPID 成員
title: JET_OSSNAPID 成員
...
ms.locfileid: "118979678"
---
# <a name="jet_ossnapid-members"></a>JET_OSSNAPID 成員

包含受保護的成員  
包含繼承的成員  

JET_OSSNAPID 包含資料庫快照集的控制碼。

[JET_OSSNAPID](./jet-ossnapid-structure.md)類型會公開下列成員。
...
<td><a href="hh566820(v=exchg.10).md">零</a></td>
<td>取得 null JET_OSSNAPID。</td>
</tr>
</tbody>
</table>
...
<td><a href="hh596770(v=exchg.10).md">等於 (物件) </a></td>
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="公用方法" alt="Public method" /></td>
<td><a href="hh163478(v=exchg.10).md">等於 (JET_OSSNAPID) </a></td>
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="公用方法" alt="Public method" /></td>
<td><a href="hh557619(v=exchg.10).md">ToString (字串，IFormatProvider) </a></td>
...
<td><a href="hh579206(v=exchg.10).md">等式</a></td>
<td>判斷 JET_OSSNAPID 的兩個指定實例是否相等。</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="公用運算子" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="靜態成員" alt="Static member" /></td>
<td><a href="hh557443(v=exchg.10).md">不等於</a></td>
<td>判斷 JET_OSSNAPID 的兩個指定實例是否不相等。</td>
</tr>
</tbody>
</table>
