...
ms.locfileid: "118271518"
---
# <a name="apiretrievecolumnasint16-method-jet_sesid-jet_tableid-jet_columnid-retrievecolumngrbit"></a>RetrieveColumnAsInt16 方法 (JET_SESID、JET_TABLEID、JET_COLUMNID、RetrieveColumnGrbit) 

從目前的記錄抓取 int16 資料行值。 記錄是與索引項目相關聯的記錄，位於資料指標的目前位置。
...
類型： [可為 null](/dotnet/api/system.nullable-1)\<[Int16](/dotnet/api/system.int16)\>  
從資料行中取出的資料（簡短）。 如果資料行是 null，則為 null。  
...
[RetrieveColumnAsInt16 多載](./api.retrievecolumnasint16-method.md)
