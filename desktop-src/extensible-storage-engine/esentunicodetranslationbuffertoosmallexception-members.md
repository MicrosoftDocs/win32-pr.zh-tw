...
---
# <a name="esentunicodetranslationbuffertoosmallexception-members"></a>EsentUnicodeTranslationBufferTooSmallException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。UnicodeTranslationBufferTooSmall 例外狀況。

[EsentUnicodeTranslationBufferTooSmallException](./esentunicodetranslationbuffertoosmallexception-class.md)類型會公開下列成員。
...
<td><a href="dn350825(v=exchg.10).md">EsentUnicodeTranslationBufferTooSmallException</a></td>
<td>初始化 EsentUnicodeTranslationBufferTooSmallException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentUnicodeTranslationBufferTooSmallException 類別](./esentunicodetranslationbuffertoosmallexception-class.md)
