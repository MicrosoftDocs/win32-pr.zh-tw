...
[EsentTooManyAttachedDatabasesException](./esenttoomanyattacheddatabasesexception-class.md)類型會公開下列成員。
...
<td><a href="dn335012(v=exchg.10).md">EsentTooManyAttachedDatabasesException</a></td>
<td>初始化 EsentTooManyAttachedDatabasesException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentTooManyAttachedDatabasesException 類別](./esenttoomanyattacheddatabasesexception-class.md)
