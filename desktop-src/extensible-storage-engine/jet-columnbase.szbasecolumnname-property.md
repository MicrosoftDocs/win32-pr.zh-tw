---
description: 深入瞭解： JET_COLUMNBASE szBaseColumnName 屬性
title: JET_COLUMNBASE szBaseColumnName 屬性
...
ms.topic: reference
f1_keywords:
- Microsoft.Isam.Esent.Interop.JET_COLUMNBASE.szBaseColumnName
dev_langs:
- CSharp
- JScript
- VB
...
api_name:
- Microsoft.Isam.Esent.Interop.JET_COLUMNBASE.szBaseColumnName
- Microsoft.Isam.Esent.Interop.JET_COLUMNBASE.get_szBaseColumnName
- Microsoft.Isam.Esent.Interop.JET_COLUMNBASE.set_szBaseColumnName
topic_type:
- apiref
- kbSyntax
api_type:
...
ms.locfileid: "119945838"
---
# <a name="jet_columnbaseszbasecolumnname-property"></a>JET_COLUMNBASE szBaseColumnName 屬性
