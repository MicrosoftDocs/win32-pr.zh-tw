---
description: 深入瞭解： JET_DBINFOMISC logtimeGenMaxCreate 屬性
title: JET_DBINFOMISC logtimeGenMaxCreate 屬性
...
取得 [genMaxRequired](./jet-dbinfomisc.genmaxrequired-property.md) 記錄檔的建立時間。
