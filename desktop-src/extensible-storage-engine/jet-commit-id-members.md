---
description: 深入瞭解： JET_COMMIT_ID 成員
title: 'JET_COMMIT_ID (Windows8 的成員) '
...
資訊內容會括住從 JET_PFNEMITLOGDATA 發出的資料。

[JET_COMMIT_ID](./jet-commit-id-class.md)類型會公開下列成員。
...
<td>傳回值，這個值會比較這個實例與另一個實例。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="公用方法" alt="Public method" /></td>
<td><a href="dn335458(v=exchg.10).md">等於 (物件) </a></td>
<td>傳回值，這個值表示這個實例是否等於另一個實例。  (覆寫 <a href="/dotnet/api/system.object.equals#System_Object_Equals_System_Object_"> (物件) 的 Equals </a>。 ) </td>
</tr>
<tr class="odd">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="公用方法" alt="Public method" /></td>
<td><a href="dn335328(v=exchg.10).md">等於 (JET_COMMIT_ID) </a></td>
...
<td><a href="dn335331(v=exchg.10).md">等式</a></td>
<td>判斷其中一個 commitid 是否等於另一個 commitid。</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="公用運算子" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="靜態成員" alt="Static member" /></td>
<td><a href="dn335457(v=exchg.10).md">GreaterThan</a></td>
<td>判斷其中一個 commitid 是否在另一個 commitid 之前。</td>
</tr>
<tr class="odd">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="公用運算子" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="靜態成員" alt="Static member" /></td>
...
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="公用運算子" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="靜態成員" alt="Static member" /></td>
<td><a href="dn335462(v=exchg.10).md">不等於</a></td>
<td>判斷其中一個 commitid 是否不等於另一個 commitid。</td>
</tr>
<tr class="odd">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="公用運算子" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="靜態成員" alt="Static member" /></td>
