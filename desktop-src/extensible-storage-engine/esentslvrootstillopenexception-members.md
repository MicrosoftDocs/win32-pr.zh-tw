...
---
# <a name="esentslvrootstillopenexception-members"></a>EsentSLVRootStillOpenException 成員

包含受保護的成員  
包含繼承的成員  

[EsentSLVRootStillOpenException](./esentslvrootstillopenexception-class.md)類型會公開下列成員。
...
<td><a href="dn350753(v=exchg.10).md">EsentSLVRootStillOpenException</a></td>
<td></td>
</tr>
</tbody>
</table>
...
[EsentSLVRootStillOpenException 類別](./esentslvrootstillopenexception-class.md)
