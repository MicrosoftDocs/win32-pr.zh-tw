...
---
# <a name="jet_objectinfo-methods"></a>JET_OBJECTINFO 方法

包含受保護的成員  
包含繼承的成員  

[JET_OBJECTINFO](./jet-objectinfo-class.md)類型會公開下列成員。
...
<td>傳回表示目前<a href="dn335219(v=exchg.10).md">JET_OBJECTINFO</a>的<a href="/dotnet/api/system.string">字串</a>。  (會覆寫 <a href="/dotnet/api/system.object.tostring#System_Object_ToString">物件 ToString () </a>。 ) </td>
</tr>
</tbody>
</table>
