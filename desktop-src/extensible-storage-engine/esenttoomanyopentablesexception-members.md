...
---
# <a name="esenttoomanyopentablesexception-members"></a>EsentTooManyOpenTablesException 成員
...
[EsentTooManyOpenTablesException](./esenttoomanyopentablesexception-class.md)類型會公開下列成員。
...
<td><a href="dn350790(v=exchg.10).md">EsentTooManyOpenTablesException</a></td>
<td>初始化 EsentTooManyOpenTablesException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentTooManyOpenTablesException 類別](./esenttoomanyopentablesexception-class.md)
