---
description: 深入瞭解： JET_OPENTEMPORARYTABLE。ToString 方法
title: 'JET_OPENTEMPORARYTABLE。ToString 方法 (< a0/&gt; < a1/&gt;) '
...
傳回表示目前[JET_OPENTEMPORARYTABLE](./jet-opentemporarytable-class.md)的[字串](/dotnet/api/system.string)。
...
表示目前[JET_OPENTEMPORARYTABLE](./jet-opentemporarytable-class.md)的[字串](/dotnet/api/system.string)。  
