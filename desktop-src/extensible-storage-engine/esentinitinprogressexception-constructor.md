...
---
# <a name="esentinitinprogressexception-constructor"></a>EsentInitInProgressException 函式

初始化 EsentInitInProgressException 類別的新實例。
...
[EsentInitInProgressException 成員](./esentinitinprogressexception-members.md)
