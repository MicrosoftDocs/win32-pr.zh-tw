...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 00fb7390713774bdc8c9821f8935bec1865b75b2dadd7a643662212df1e0c280
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "120019768"
---
# <a name="esentlsnotsetexception-members"></a>EsentLSNotSetException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。LSNotSet 例外狀況。

[EsentLSNotSetException](./esentlsnotsetexception-class.md)類型會公開下列成員。
...
<td><a href="dn334678(v=exchg.10).md">EsentLSNotSetException</a></td>
<td>初始化 EsentLSNotSetException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentLSNotSetException 類別](./esentlsnotsetexception-class.md)
