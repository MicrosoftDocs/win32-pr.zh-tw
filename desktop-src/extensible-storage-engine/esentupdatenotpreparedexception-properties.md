...
---
# <a name="esentupdatenotpreparedexception-properties"></a>EsentUpdateNotPreparedException 屬性

包含受保護的成員  
包含繼承的成員  

[EsentUpdateNotPreparedException](./esentupdatenotpreparedexception-class.md)類型會公開下列成員。
...
[EsentUpdateNotPreparedException 類別](./esentupdatenotpreparedexception-class.md)
