...
---
# <a name="backupgrbit-enumeration"></a>BackupGrbit 列舉

[JetBackupInstance (JET_INSTANCE、String、BackupGrbit JET_PFNSTATUS) ](./api.jetbackupinstance-method.md)的選項。
...
<td></td>
<td>增量</td>
<td>建立增量備份，而不是完整備份。 這表示只會備份自上次完整或增量備份之後所建立的記錄檔。</td>
</tr>
<tr class="odd">
<td></td>
<td>原子</td>
<td>建立資料庫的完整備份。 這可在新備份失敗時，將現有的備份保留在相同的目錄中。</td>
</tr>
</tbody>
</table>
