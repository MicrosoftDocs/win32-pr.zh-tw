...
[EsentOutOfSessionsException](./esentoutofsessionsexception-class.md)類型會公開下列成員。
...
<td><a href="dn319760(v=exchg.10).md">EsentOutOfSessionsException</a></td>
<td>初始化 EsentOutOfSessionsException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentOutOfSessionsException 類別](./esentoutofsessionsexception-class.md)
