...
[EsentBadBackupDatabaseSizeException](./esentbadbackupdatabasesizeexception-class.md)類型會公開下列成員。
...
<td><a href="dn273986(v=exchg.10).md">EsentBadBackupDatabaseSizeException</a></td>
<td>初始化 EsentBadBackupDatabaseSizeException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentBadBackupDatabaseSizeException 類別](./esentbadbackupdatabasesizeexception-class.md)
