...
---
# <a name="esentdefaultvaluetoobigexception-members"></a>EsentDefaultValueTooBigException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。DefaultValueTooBig 例外狀況。

[EsentDefaultValueTooBigException](./esentdefaultvaluetoobigexception-class.md)類型會公開下列成員。
...
<td><a href="dn334426(v=exchg.10).md">EsentDefaultValueTooBigException</a></td>
<td>初始化 EsentDefaultValueTooBigException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentDefaultValueTooBigException 類別](./esentdefaultvaluetoobigexception-class.md)
