---
description: 深入瞭解： IndexInfo ToString 方法
title: IndexInfo ToString 方法
...
ms.locfileid: "119039466"
---
# <a name="indexinfotostring-method"></a>IndexInfo ToString 方法

傳回表示目前[IndexInfo](./indexinfo-class.md)的[字串](/dotnet/api/system.string)。
...
表示目前[IndexInfo](./indexinfo-class.md)的[字串](/dotnet/api/system.string)。  
