---
description: 深入瞭解： EsentBadEmptyPageException 成員
title: EsentBadEmptyPageException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentbademptypageexception_members(v=EXCHG.10)
...
<td><a href="dn274064(v=exchg.10).md">EsentBadEmptyPageException</a></td>
<td>初始化 EsentBadEmptyPageException 類別的新實例。</td>
</tr>
</tbody>
</table>
