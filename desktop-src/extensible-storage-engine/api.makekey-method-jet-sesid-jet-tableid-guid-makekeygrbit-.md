...
ms.locfileid: "118084775"
---
# <a name="apimakekey-method-jet_sesid-jet_tableid-guid-makekeygrbit"></a>MakeKey 方法 (JET_SESID、JET_TABLEID、Guid、MakeKeyGrbit) 
...
<!-- end list -->
  ...
  - data  
    類型： [System. Guid](/dotnet/api/system.guid)  
