...
---
# <a name="esentexistinglogfileisnotcontiguousexception-properties"></a>EsentExistingLogFileIsNotContiguousException 屬性

包含受保護的成員  
包含繼承的成員  

[EsentExistingLogFileIsNotContiguousException](./esentexistinglogfileisnotcontiguousexception-class.md)類型會公開下列成員。
...
[EsentExistingLogFileIsNotContiguousException 類別](./esentexistinglogfileisnotcontiguousexception-class.md)
