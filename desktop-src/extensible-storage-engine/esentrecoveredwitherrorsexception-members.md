...
---
# <a name="esentrecoveredwitherrorsexception-members"></a>EsentRecoveredWithErrorsException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。RecoveredWithErrors 例外狀況。
...
<td><a href="dn319878(v=exchg.10).md">EsentRecoveredWithErrorsException</a></td>
<td>初始化 EsentRecoveredWithErrorsException 類別的新實例。</td>
</tr>
</tbody>
</table>
