---
description: 深入瞭解： EsentSessionInUseException 的函式
title: EsentSessionInUseException 函式
...
ms.locfileid: "104115904"
---
# <a name="esentsessioninuseexception-constructor"></a>EsentSessionInUseException 函式

初始化 EsentSessionInUseException 類別的新實例。
