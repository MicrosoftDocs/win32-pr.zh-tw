...
JET_err 的基類。BadRestoreTargetInstance 例外狀況。
...
<td><a href="dn274046(v=exchg.10).md">EsentBadRestoreTargetInstanceException</a></td>
<td>初始化 EsentBadRestoreTargetInstanceException 類別的新實例。</td>
</tr>
</tbody>
</table>
