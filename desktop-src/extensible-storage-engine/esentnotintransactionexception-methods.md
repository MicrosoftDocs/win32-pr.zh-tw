---
description: 深入瞭解： EsentNotInTransactionException 方法
title: EsentNotInTransactionException 方法
TOCTitle: EsentNotInTransactionException methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.EsentNotInTransactionException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentnotintransactionexception_methods(v=EXCHG.10)
ms:contentKeyID: 55102379
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 0432bded6c061cf8ad09d8dd3cef7236d69b9b1aa244d6a5707434599ec1853c
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119040456"
---
# <a name="esentnotintransactionexception-methods"></a>EsentNotInTransactionException 方法

包含受保護的成員  
包含繼承的成員  

[EsentNotInTransactionException](./esentnotintransactionexception-class.md)類型會公開下列成員。
...
[EsentNotInTransactionException 類別](./esentnotintransactionexception-class.md)
