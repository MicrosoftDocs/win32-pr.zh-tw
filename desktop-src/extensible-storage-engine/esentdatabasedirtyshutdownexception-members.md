---
description: 深入瞭解： EsentDatabaseDirtyShutdownException 成員
title: EsentDatabaseDirtyShutdownException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentdatabasedirtyshutdownexception_members(v=EXCHG.10)
...
JET_err 的基類。DatabaseDirtyShutdown 例外狀況。
...
<td><a href="dn334292(v=exchg.10).md">EsentDatabaseDirtyShutdownException</a></td>
<td>初始化 EsentDatabaseDirtyShutdownException 類別的新實例。</td>
</tr>
</tbody>
</table>
