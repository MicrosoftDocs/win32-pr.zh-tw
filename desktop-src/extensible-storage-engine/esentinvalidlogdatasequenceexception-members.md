...
---
# <a name="esentinvalidlogdatasequenceexception-members"></a>EsentInvalidLogDataSequenceException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。InvalidLogDataSequence 例外狀況。

[EsentInvalidLogDataSequenceException](./esentinvalidlogdatasequenceexception-class.md)類型會公開下列成員。
...
<td><a href="dn319537(v=exchg.10).md">EsentInvalidLogDataSequenceException</a></td>
<td>初始化 EsentInvalidLogDataSequenceException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInvalidLogDataSequenceException 類別](./esentinvalidlogdatasequenceexception-class.md)
