...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 0c4f58b78d49188c689d27edbd4a80fdf8f721fec24f78c9ba4098e572b5f866
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118981048"
---
# <a name="esenttaggednotnullexception-members"></a>EsentTaggedNotNullException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。TaggedNotNull 例外狀況。

[EsentTaggedNotNullException](./esenttaggednotnullexception-class.md)類型會公開下列成員。
...
<td><a href="dn334956(v=exchg.10).md">EsentTaggedNotNullException</a></td>
<td>初始化 EsentTaggedNotNullException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentTaggedNotNullException 類別](./esenttaggednotnullexception-class.md)
