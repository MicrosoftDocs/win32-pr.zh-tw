...
---
# <a name="esentslvspacewriteconflictexception-members"></a>EsentSLVSpaceWriteConflictException 成員

包含受保護的成員  
包含繼承的成員  

[EsentSLVSpaceWriteConflictException](./esentslvspacewriteconflictexception-class.md)類型會公開下列成員。
...
<td><a href="dn334844(v=exchg.10).md">EsentSLVSpaceWriteConflictException</a></td>
<td></td>
</tr>
</tbody>
</table>
...
[EsentSLVSpaceWriteConflictException 類別](./esentslvspacewriteconflictexception-class.md)
