---
description: 深入瞭解： JET_RSTMAP 的函式
title: JET_RSTMAP 的函式
...
ms:contentKeyID: 55107662
ms.date: 07/30/2014
ms.topic: reference
f1_keywords:
- Microsoft.Isam.Esent.Interop.JET_RSTMAP.JET_RSTMAP
dev_langs:
- CSharp
- JScript
- VB
- other
api_name:
- Microsoft.Isam.Esent.Interop.JET_RSTMAP..ctor
topic_type:
- kbSyntax
- apiref
api_type:
...
ms.locfileid: "103847839"
---
# <a name="jet_rstmap-constructor"></a>JET_RSTMAP 的函式
...
Dim instance As New JET_RSTMAP()
```
