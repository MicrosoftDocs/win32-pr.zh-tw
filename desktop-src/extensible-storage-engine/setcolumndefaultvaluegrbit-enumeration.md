...
ms.locfileid: "119107252"
---
# <a name="setcolumndefaultvaluegrbit-enumeration"></a>SetColumnDefaultValueGrbit 列舉

[JetSetColumnDefaultValue (JET_SESID、JET_DBID、字串、字串、 \[ \] 、Int32、SetColumnDefaultValueGrbit) ](./api.jetsetcolumndefaultvalue-method.md)的選項。
