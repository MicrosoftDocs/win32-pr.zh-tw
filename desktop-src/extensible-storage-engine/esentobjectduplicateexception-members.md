---
description: 深入瞭解： EsentObjectDuplicateException 成員
title: EsentObjectDuplicateException 成員
TOCTitle: EsentObjectDuplicateException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentObjectDuplicateException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentobjectduplicateexception_members(v=EXCHG.10)
ms:contentKeyID: 55102346
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 77adef94dbb302cfee79dba0964e8f16e5ba2a5905ae0d19d3cbdd17dd9c8425
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119947848"
---
# <a name="esentobjectduplicateexception-members"></a>EsentObjectDuplicateException 成員
...
[EsentObjectDuplicateException](./esentobjectduplicateexception-class.md)類型會公開下列成員。
...
<td><a href="dn319657(v=exchg.10).md">EsentObjectDuplicateException</a></td>
<td>初始化 EsentObjectDuplicateException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentObjectDuplicateException 類別](./esentobjectduplicateexception-class.md)
