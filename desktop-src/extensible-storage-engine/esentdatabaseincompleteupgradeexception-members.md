---
description: 深入瞭解： EsentDatabaseIncompleteUpgradeException 成員
title: EsentDatabaseIncompleteUpgradeException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentdatabaseincompleteupgradeexception_members(v=EXCHG.10)
...
<td><a href="dn334315(v=exchg.10).md">EsentDatabaseIncompleteUpgradeException</a></td>
<td>初始化 EsentDatabaseIncompleteUpgradeException 類別的新實例。</td>
</tr>
</tbody>
</table>
