...
| <p>JET_errRunningInMultiInstanceMode</p> | <p>使用具有多個實例模式的 <strong>JetStopService</strong> 時，不會清除要準備終止的實例。</p><p><strong>Windows XP：</strong> 此傳回值會在 Windows XP 中引進。</p> | 
