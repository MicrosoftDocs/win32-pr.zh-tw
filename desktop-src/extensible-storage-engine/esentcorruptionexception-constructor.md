---
description: 深入瞭解： EsentCorruptionException 的函式
title: EsentCorruptionException 函式
...
ms:contentKeyID: 55101400
ms.date: 07/30/2014
ms.topic: article
f1_keywords:
- Microsoft.Isam.Esent.Interop.EsentCorruptionException.EsentCorruptionException
dev_langs:
- CSharp
- JScript
- VB
...
ms.locfileid: "104320799"
---
# <a name="esentcorruptionexception-constructor"></a>EsentCorruptionException 函式
...
<td>初始化 EsentCorruptionException 類別的新實例。 這個函式是用來將序列化的例外狀況還原序列化。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="受保護的方法" alt="Protected method" /></td>
<td><a href="dn334330(v=exchg.10).md">EsentCorruptionException (字串 JET_err) </a></td>
<td>初始化 EsentCorruptionException 類別的新實例。</td>
</tr>
</tbody>
</table>
