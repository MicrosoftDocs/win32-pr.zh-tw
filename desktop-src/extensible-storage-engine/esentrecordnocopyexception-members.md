...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 29b6ec7a077a478b7cfe75a7d7206a5b8a546a71604259053427c1e160354286
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119971228"
---
# <a name="esentrecordnocopyexception-members"></a>EsentRecordNoCopyException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。RecordNoCopy 例外狀況。

[EsentRecordNoCopyException](./esentrecordnocopyexception-class.md)類型會公開下列成員。
...
<td><a href="dn319836(v=exchg.10).md">EsentRecordNoCopyException</a></td>
<td>初始化 EsentRecordNoCopyException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentRecordNoCopyException 類別](./esentrecordnocopyexception-class.md)
