...
ms.locfileid: "119115688"
---
# <a name="esentlogsequenceendexception-members"></a>EsentLogSequenceEndException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。LogSequenceEnd 例外狀況。

[EsentLogSequenceEndException](./esentlogsequenceendexception-class.md)類型會公開下列成員。
...
<td><a href="dn334603(v=exchg.10).md">EsentLogSequenceEndException</a></td>
<td>初始化 EsentLogSequenceEndException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentLogSequenceEndException 類別](./esentlogsequenceendexception-class.md)
