---
description: 深入瞭解： EsentTableDuplicateException 方法
title: EsentTableDuplicateException 方法
TOCTitle: EsentTableDuplicateException methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.EsentTableDuplicateException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esenttableduplicateexception_methods(v=EXCHG.10)
...
[EsentTableDuplicateException](./esenttableduplicateexception-class.md)類型會公開下列成員。
...
[EsentTableDuplicateException 類別](./esenttableduplicateexception-class.md)
