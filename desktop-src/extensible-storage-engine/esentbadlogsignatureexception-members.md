...
---
# <a name="esentbadlogsignatureexception-members"></a>EsentBadLogSignatureException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。BadLogSignature 例外狀況。
...
<td>初始化 EsentBadLogSignatureException 類別的新實例。</td>
</tr>
</tbody>
</table>
