---
description: 深入瞭解： JET_OBJECTLIST。ToString 方法
title: JET_OBJECTLIST。ToString 方法
...
ms.locfileid: "118254104"
---
# <a name="jet_objectlisttostring-method"></a>JET_OBJECTLIST。ToString 方法

傳回表示目前[JET_OBJECTLIST](./jet-objectlist-class.md)的[字串](/dotnet/api/system.string)。
...
表示目前[JET_OBJECTLIST](./jet-objectlist-class.md)的[字串](/dotnet/api/system.string)。  
