---
description: 深入瞭解： EsentMustDisableLoggingForDbUpgradeException 成員
title: EsentMustDisableLoggingForDbUpgradeException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentmustdisableloggingfordbupgradeexception_members(v=EXCHG.10)
...
ms.locfileid: "104026479"
---
# <a name="esentmustdisableloggingfordbupgradeexception-members"></a>EsentMustDisableLoggingForDbUpgradeException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。MustDisableLoggingForDbUpgrade 例外狀況。

[EsentMustDisableLoggingForDbUpgradeException](./esentmustdisableloggingfordbupgradeexception-class.md)類型會公開下列成員。
...
<td><a href="dn334715(v=exchg.10).md">EsentMustDisableLoggingForDbUpgradeException</a></td>
<td>初始化 EsentMustDisableLoggingForDbUpgradeException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentMustDisableLoggingForDbUpgradeException 類別](./esentmustdisableloggingfordbupgradeexception-class.md)
