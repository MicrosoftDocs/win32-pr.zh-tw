...
---
# <a name="esentcommittedlogfilecorruptexception-members"></a>EsentCommittedLogFileCorruptException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類（Base class）。 CommittedLogFileCorrupt 例外狀況。

[EsentCommittedLogFileCorruptException](./esentcommittedlogfilecorruptexception-class.md)類型會公開下列成員。
...
<td><a href="dn274207(v=exchg.10).md">EsentCommittedLogFileCorruptException</a></td>
<td>初始化 EsentCommittedLogFileCorruptException 類別的新實例。</td>
</tr>
</tbody>
</table>
