---
description: 深入瞭解： JET_COLUMNLIST columnidCp 屬性
title: JET_COLUMNLIST columnidCp 屬性
...
ms.locfileid: "104319987"
---
# <a name="jet_columnlistcolumnidcp-property"></a>JET_COLUMNLIST columnidCp 屬性

取得臨時表中儲存資料行字碼頁之資料行的 columnid。
