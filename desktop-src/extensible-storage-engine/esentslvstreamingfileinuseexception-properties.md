---
description: 深入瞭解： EsentSLVStreamingFileInUseException 屬性
title: EsentSLVStreamingFileInUseException 屬性
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentslvstreamingfileinuseexception_properties(v=EXCHG.10)
