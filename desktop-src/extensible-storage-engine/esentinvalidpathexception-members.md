...
---
# <a name="esentinvalidpathexception-members"></a>EsentInvalidPathException 成員
...
[EsentInvalidPathException](./esentinvalidpathexception-class.md)類型會公開下列成員。
...
<td><a href="dn319620(v=exchg.10).md">EsentInvalidPathException</a></td>
<td>初始化 EsentInvalidPathException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInvalidPathException 類別](./esentinvalidpathexception-class.md)
