...
---
# <a name="esentmemoryexception-constructor-serializationinfo-streamingcontext"></a>EsentMemoryException 函式 (SerializationInfo、StreamingCoNtext) 

初始化 EsentMemoryException 類別的新實例。 這個函式是用來將序列化的例外狀況還原序列化。
