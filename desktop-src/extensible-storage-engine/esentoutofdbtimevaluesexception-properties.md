---
description: 深入瞭解： EsentOutOfDbtimeValuesException 屬性
title: EsentOutOfDbtimeValuesException 屬性
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentoutofdbtimevaluesexception_properties(v=EXCHG.10)
