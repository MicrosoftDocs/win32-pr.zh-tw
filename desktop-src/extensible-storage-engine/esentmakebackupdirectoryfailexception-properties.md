---
description: 深入瞭解： EsentMakeBackupDirectoryFailException 屬性
title: EsentMakeBackupDirectoryFailException 屬性
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentmakebackupdirectoryfailexception_properties(v=EXCHG.10)
ms:contentKeyID: 55102250
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: f91763e9d8b7b10c18cd3f60ef67a1afde7f5b3a95a6a7adfdf1f52fe687b31d
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119040836"
---
# <a name="esentmakebackupdirectoryfailexception-properties"></a>EsentMakeBackupDirectoryFailException 屬性

包含受保護的成員  
包含繼承的成員  

[EsentMakeBackupDirectoryFailException](./esentmakebackupdirectoryfailexception-class.md)類型會公開下列成員。
...
[EsentMakeBackupDirectoryFailException 類別](./esentmakebackupdirectoryfailexception-class.md)
