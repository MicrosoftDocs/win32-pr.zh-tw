...
---
# <a name="esentdiskexception-class"></a>EsentDiskException 類別
      ...
      [EsentErrorException （.）](./esenterrorexception-class.md)  
        [EsentOperationException （.）](./esentoperationexception-class.md)  
          [EsentResourceException （.）](./esentresourceexception-class.md)  
            EsentDiskException （.）  
              [EsentDiskFullException （.）](./esentdiskfullexception-class.md)  
              [EsentLogDiskFullException （.）](./esentlogdiskfullexception-class.md)  
