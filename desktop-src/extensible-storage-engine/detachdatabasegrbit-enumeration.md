...
[JetDetachDatabase2 (JET_SESID、String、DetachDatabaseGrbit) ](./api.jetdetachdatabase2-method.md)的選項。
...
<td></td>
<td>ForceDetach</td>
<td><strong>已淘汰。</strong> 如果使用 ForceDetach，則會傳回 <a href="dn350463(v=exchg.10).md">EsentForceDetachNotAllowedException</a> 。</td>
</tr>
<tr class="odd">
<td></td>
<td>ForceClose</td>
<td><strong>已淘汰。</strong> 不再使用 ForceClose。</td>
</tr>
<tr class="even">
<td></td>
<td>ForceCloseAndDetach</td>
<td><strong>已淘汰。</strong> 如果使用 ForceCloseAndDetach，則會傳回 <a href="dn350463(v=exchg.10).md">EsentForceDetachNotAllowedException</a> 。</td>
</tr>
</tbody>
</table>
