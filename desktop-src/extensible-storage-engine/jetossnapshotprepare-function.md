...
<td><p>複製快照集 (一般或累加) ，而不會截斷記錄。</p></td>
</tr>
<tr class="even">
<td><p>JET_bitContinueAfterThaw</p></td>
<td><p>快照會話會在 <a href="gg269229(v=exchg.10).md">JetOSSnapshotThaw</a> 之後發生，而且需要 <a href="gg294136(v=exchg.10).md">JetOSSnapshotEnd</a> 函式呼叫。</p></td>
</tr>
<tr class="odd">
<td><p>JET_bitExplicitPrepare</p></td>
<td><p>預設不會準備任何實例。</p>
<p><strong>Windows 7：</strong>  JET_bitExplicitPrepare 是在 Windows 7 中引進的。</p></td>
</tr>
</tbody>
</table>
...
<td><p>快照集識別碼指標為 Null 或 <em>grbit</em> 參數無效。</p></td>
</tr>
<tr class="odd">
<td><p>JET_errOSSnapshotInvalidSequence</p></td>
<td><p>快照集會話已在進行中，而且在任何指定的時間，作業不允許有多個快照集會話。</p></td>
</tr>
</tbody>
</table>
