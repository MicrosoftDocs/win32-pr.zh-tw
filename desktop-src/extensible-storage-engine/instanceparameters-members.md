...
這個類別會提供屬性，以在 ESENT 實例上設定和取得系統參數。 這個類別提供靜態屬性來設定和取得每個實例的 ESENT 系統參數。
...
<td>初始化 InstanceParameters 類別的新實例。</td>
</tr>
</tbody>
</table>
...
<td>傳回表示目前<a href="dn350942(v=exchg.10).md">InstanceParameters</a>的<a href="/dotnet/api/system.string">字串</a>。  (會覆寫 <a href="/dotnet/api/system.object.tostring#System_Object_ToString">物件 ToString () </a>。 ) </td>
</tr>
</tbody>
</table>
