---
description: 深入瞭解： EsentBadEmptyPageException 的函式
title: EsentBadEmptyPageException 函式
...
ms.locfileid: "106989984"
---
# <a name="esentbademptypageexception-constructor"></a>EsentBadEmptyPageException 函式

初始化 EsentBadEmptyPageException 類別的新實例。
