---
description: 深入瞭解： EsentOSSnapshotInvalidSequenceException 成員
title: EsentOSSnapshotInvalidSequenceException 成員
TOCTitle: EsentOSSnapshotInvalidSequenceException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentOSSnapshotInvalidSequenceException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentossnapshotinvalidsequenceexception_members(v=EXCHG.10)
...
JET_err 的基類。OSSnapshotInvalidSequence 例外狀況。

[EsentOSSnapshotInvalidSequenceException](./esentossnapshotinvalidsequenceexception-class.md)類型會公開下列成員。
...
<td><a href="dn319730(v=exchg.10).md">EsentOSSnapshotInvalidSequenceException</a></td>
<td>初始化 EsentOSSnapshotInvalidSequenceException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentOSSnapshotInvalidSequenceException 類別](./esentossnapshotinvalidsequenceexception-class.md)
