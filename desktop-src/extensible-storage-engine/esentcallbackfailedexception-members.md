...
---
# <a name="esentcallbackfailedexception-members"></a>EsentCallbackFailedException 成員
...
[EsentCallbackFailedException](./esentcallbackfailedexception-class.md)類型會公開下列成員。
...
<td><a href="dn274103(v=exchg.10).md">EsentCallbackFailedException</a></td>
<td>初始化 EsentCallbackFailedException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentCallbackFailedException 類別](./esentcallbackfailedexception-class.md)
