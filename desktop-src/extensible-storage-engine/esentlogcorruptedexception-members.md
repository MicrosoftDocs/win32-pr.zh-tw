...
---
# <a name="esentlogcorruptedexception-members"></a>EsentLogCorruptedException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。LogCorrupted 例外狀況。

[EsentLogCorruptedException](./esentlogcorruptedexception-class.md)類型會公開下列成員。
...
<td><a href="dn334580(v=exchg.10).md">EsentLogCorruptedException</a></td>
<td>初始化 EsentLogCorruptedException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentLogCorruptedException 類別](./esentlogcorruptedexception-class.md)
