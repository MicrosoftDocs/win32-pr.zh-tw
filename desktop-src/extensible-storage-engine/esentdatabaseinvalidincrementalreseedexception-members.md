---
description: 深入瞭解： EsentDatabaseInvalidIncrementalReseedException 成員
title: EsentDatabaseInvalidIncrementalReseedException 成員
TOCTitle: EsentDatabaseInvalidIncrementalReseedException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentDatabaseInvalidIncrementalReseedException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentdatabaseinvalidincrementalreseedexception_members(v=EXCHG.10)
ms:contentKeyID: 55101382
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 01b5ebd559409e9bcf1a1346e38e2dcb328dd031
ms.sourcegitcommit: 831e8f3db78ab820e1710cede244553c70e50500
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 01/07/2021
ms.locfileid: "104551244"
---
# <a name="esentdatabaseinvalidincrementalreseedexception-members"></a>EsentDatabaseInvalidIncrementalReseedException 成員
...
[EsentDatabaseInvalidIncrementalReseedException](./esentdatabaseinvalidincrementalreseedexception-class.md)類型會公開下列成員。
...
<td><a href="dn334453(v=exchg.10).md">EsentDatabaseInvalidIncrementalReseedException</a></td>
<td>初始化 EsentDatabaseInvalidIncrementalReseedException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentDatabaseInvalidIncrementalReseedException 類別](./esentdatabaseinvalidincrementalreseedexception-class.md)
