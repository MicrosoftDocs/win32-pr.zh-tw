...
---
# <a name="jet_setinfo-methods"></a>JET_SETINFO 方法
...
<td>傳回表示目前<a href="dn351059(v=exchg.10).md">JET_SETINFO</a>的<a href="/dotnet/api/system.string">字串</a>。  (會覆寫 <a href="/dotnet/api/system.object.tostring#System_Object_ToString">物件 ToString () </a>。 ) </td>
</tr>
</tbody>
</table>
