...
---
# <a name="esentdatabasesigninuseexception-constructor"></a>EsentDatabaseSignInUseException 函式

初始化 EsentDatabaseSignInUseException 類別的新實例。
...
[EsentDatabaseSignInUseException 成員](./esentdatabasesigninuseexception-members.md)
