...
---
# <a name="esentcannotnestdistributedtransactionsexception-methods"></a>EsentCannotNestDistributedTransactionsException 方法

包含受保護的成員  
包含繼承的成員  

[EsentCannotNestDistributedTransactionsException](./esentcannotnestdistributedtransactionsexception-class.md)類型會公開下列成員。
...
[EsentCannotNestDistributedTransactionsException 類別](./esentcannotnestdistributedtransactionsexception-class.md)
