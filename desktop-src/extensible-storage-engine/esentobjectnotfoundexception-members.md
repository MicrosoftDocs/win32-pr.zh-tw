...
---
# <a name="esentobjectnotfoundexception-members"></a>EsentObjectNotFoundException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。ObjectNotFound 例外狀況。
...
<td><a href="dn319662(v=exchg.10).md">EsentObjectNotFoundException</a></td>
<td>初始化 EsentObjectNotFoundException 類別的新實例。</td>
</tr>
</tbody>
</table>
