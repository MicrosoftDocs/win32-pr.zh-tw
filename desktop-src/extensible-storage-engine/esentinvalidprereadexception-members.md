...
---
# <a name="esentinvalidprereadexception-members"></a>EsentInvalidPrereadException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。InvalidPreread 例外狀況。

[EsentInvalidPrereadException](./esentinvalidprereadexception-class.md)類型會公開下列成員。
...
<td><a href="dn319583(v=exchg.10).md">EsentInvalidPrereadException</a></td>
<td>初始化 EsentInvalidPrereadException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInvalidPrereadException 類別](./esentinvalidprereadexception-class.md)
