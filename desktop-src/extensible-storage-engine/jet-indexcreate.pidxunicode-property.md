---
description: 深入瞭解： JET_INDEXCREATE pidxUnicode 屬性
title: JET_INDEXCREATE pidxUnicode 屬性
...
ms:contentKeyID: 55103654
ms.date: 07/30/2014
ms.topic: reference
f1_keywords:
- Microsoft.Isam.Esent.Interop.JET_INDEXCREATE.pidxUnicode
dev_langs:
- CSharp
- JScript
- VB
- other
api_name:
- Microsoft.Isam.Esent.Interop.JET_INDEXCREATE.set_pidxUnicode
- Microsoft.Isam.Esent.Interop.JET_INDEXCREATE.pidxUnicode
- Microsoft.Isam.Esent.Interop.JET_INDEXCREATE.get_pidxUnicode
topic_type:
- apiref
- kbSyntax
api_type:
...
ms.locfileid: "104194892"
---
# <a name="jet_indexcreatepidxunicode-property"></a>JET_INDEXCREATE pidxUnicode 屬性

取得或設定選擇性的 unicode 比較選項。
