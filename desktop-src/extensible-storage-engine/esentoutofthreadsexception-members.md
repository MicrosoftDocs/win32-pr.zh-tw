...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: bfb35ca92844a5001e85c247f5653ded5805500ef5c6bf5b76b2b9d89c003d9a
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119782928"
---
# <a name="esentoutofthreadsexception-members"></a>EsentOutOfThreadsException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。OutOfThreads 例外狀況。

[EsentOutOfThreadsException](./esentoutofthreadsexception-class.md)類型會公開下列成員。
...
<td><a href="dn319813(v=exchg.10).md">EsentOutOfThreadsException</a></td>
<td>初始化 EsentOutOfThreadsException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentOutOfThreadsException 類別](./esentoutofthreadsexception-class.md)
