---
description: 深入瞭解： IJET_LOGTIME 介面
title: IJET_LOGTIME 介面
...
ms.locfileid: "118980678"
---
# <a name="ijet_logtime-interface"></a>IJET_LOGTIME 介面

JET_LOGTIME 和 JET_BKLOGTIME 之間的通用方法介面。
...
``` vb
'Declaration
Public Interface IJET_LOGTIME _
    Inherits INullableJetStruct
'Usage
