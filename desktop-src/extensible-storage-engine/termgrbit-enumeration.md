...
[JetTerm2 (JET_INSTANCE、TermGrbit) ](./api.jetterm2-method.md)的選項。
...
<td></td>
<td>完成</td>
<td>要求完全關閉實例。 通常會在執行時間于背景中完成的任何選擇性清除工作會立即完成。</td>
</tr>
<tr class="odd">
<td></td>
<td>突然</td>
<td>要求實例盡可能快速關閉。 在執行時間，通常會在背景中完成的任何選擇性工作都會被放棄。</td>
</tr>
</tbody>
</table>
...
[髒](./windows7grbits.dirty-field.md)
