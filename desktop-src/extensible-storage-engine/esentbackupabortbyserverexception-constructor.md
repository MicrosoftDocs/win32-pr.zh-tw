---
description: 深入瞭解： EsentBackupAbortByServerException 的函式
title: EsentBackupAbortByServerException 函式
...
- other
api_name:
- Microsoft.Isam.Esent.Interop.EsentBackupAbortByServerException..ctor
topic_type:
- kbSyntax
- apiref
api_type:
...
初始化 EsentBackupAbortByServerException 類別的新實例。
...
Dim instance As New EsentBackupAbortByServerException()
```
