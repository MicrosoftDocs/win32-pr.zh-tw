---
description: 深入瞭解： EsentInstanceNameInUseException 成員
title: EsentInstanceNameInUseException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentinstancenameinuseexception_members(v=EXCHG.10)
ms:contentKeyID: 55101873
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 2afc4e6b4b1fd6f168b24a96af79292d5a2818c1
ms.sourcegitcommit: 831e8f3db78ab820e1710cede244553c70e50500
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 01/07/2021
ms.locfileid: "104513216"
---
# <a name="esentinstancenameinuseexception-members"></a>EsentInstanceNameInUseException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。InstanceNameInUse 例外狀況。

[EsentInstanceNameInUseException](./esentinstancenameinuseexception-class.md)類型會公開下列成員。
...
<td><a href="dn319386(v=exchg.10).md">EsentInstanceNameInUseException</a></td>
<td>初始化 EsentInstanceNameInUseException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInstanceNameInUseException 類別](./esentinstancenameinuseexception-class.md)
