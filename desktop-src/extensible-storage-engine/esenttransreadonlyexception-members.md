...
---
# <a name="esenttransreadonlyexception-members"></a>EsentTransReadOnlyException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。TransReadOnly 例外狀況。

[EsentTransReadOnlyException](./esenttransreadonlyexception-class.md)類型會公開下列成員。
...
<td><a href="dn350805(v=exchg.10).md">EsentTransReadOnlyException</a></td>
<td>初始化 EsentTransReadOnlyException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentTransReadOnlyException 類別](./esenttransreadonlyexception-class.md)
