...
ms.locfileid: "118084397"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-uint64"></a>SetColumn 方法 (JET_SESID、JET_TABLEID、JET_COLUMNID、UInt64) 
...
<!-- end list -->
  ...
  - data  
    類型： [system.object](/dotnet/api/system.uint64)  
