...
ms.locfileid: "119039166"
---
# <a name="jet_handletostring-method-string-iformatprovider"></a>JET_HANDLE。ToString 方法 (字串，IFormatProvider) 
...
[ToString 多載](./jet-handle.tostring-method.md)
