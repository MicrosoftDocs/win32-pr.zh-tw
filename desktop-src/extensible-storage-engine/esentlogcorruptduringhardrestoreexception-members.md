---
description: 深入瞭解： EsentLogCorruptDuringHardRestoreException 成員
title: EsentLogCorruptDuringHardRestoreException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentlogcorruptduringhardrestoreexception_members(v=EXCHG.10)
ms:contentKeyID: 55102070
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 3df7e698612c652e40ee55295cdcc2a419c4034aa44602b804c7fc63f6936d51
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "120064788"
---
# <a name="esentlogcorruptduringhardrestoreexception-members"></a>EsentLogCorruptDuringHardRestoreException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。LogCorruptDuringHardRestore 例外狀況。

[EsentLogCorruptDuringHardRestoreException](./esentlogcorruptduringhardrestoreexception-class.md)類型會公開下列成員。
...
<td><a href="dn334572(v=exchg.10).md">EsentLogCorruptDuringHardRestoreException</a></td>
<td>初始化 EsentLogCorruptDuringHardRestoreException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentLogCorruptDuringHardRestoreException 類別](./esentlogcorruptduringhardrestoreexception-class.md)
