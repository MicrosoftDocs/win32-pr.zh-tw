...
| <p>值</p> | <p>意義</p> | 
|--------------|----------------|
| <p>JET_ColInfo</p> | <p>JET_ColInfo 和 JET_ColInfoByColid 都會取得相同的資訊。 <em>pvResult</em> 會被視為 <a href="gg294130(v=exchg.10).md">JET_COLUMNDEF</a>，而 <a href="gg294130(v=exchg.10).md">JET_COLUMNDEF</a> 結構的欄位會適當地填入。</p> | 
...
| <p>JET_ColInfoByColid</p> | <p>就像 JET_ColInfo 一樣， <em>pvResult</em> 會被視為 <a href="gg294130(v=exchg.10).md">JET_COLUMNDEF</a>，但此 <em>InfoLevel</em> 表示要求的資料行 (<em>szColumName</em>) 不是字串資料行名稱，而是指向 <a href="gg294104(v=exchg.10).md">JET_COLUMNID</a>的指標。</p> | 
| <p>JET_ColInfoList</p> | <p><em>pvResult</em> 會被視為 <a href="gg269228(v=exchg.10).md">JET_COLUMNLIST</a> 結構。 如果此函式成功，則會以適當的值填入結構。 臨時表會開啟，並由<a href="gg269228(v=exchg.10).md">JET_COLUMNLIST</a>結構的<strong>tableid</strong>成員識別。 資料表必須以 <a href="gg294087(v=exchg.10).md">JetCloseTable</a>關閉。 如果此函式失敗，結構會包含未定義的資料。</p> | 
| <p>JET_ColInfoListCompact</p> | <p>與 JET_ColInfoList 相同。</p> | 
| <p>JET_ColInfoListSortColumnid</p> | <p>等同于 JET_ColInfoList;不過，產生的資料表會依 columnid 排序，而不是資料行名稱。</p> | 
| <p>JET_ColInfoSysTabCursor</p> | <p>JET_ColInfoSysTabCursor 已被取代，而且使用它將會傳回 JET_errFeatureNotAvailable。</p> | 
| <p>JET_ColInfoBaseByColId</p> | <p>就像 JET_ColInfoBase 一樣， <em>pvResult</em> 會被視為 <a href="gg269194(v=exchg.10).md">JET_COLUMNBASE</a>，但此 <em>InfoLevel</em> 表示要求的資料行 (<em>szColumName</em>) 不是字串資料行名稱，而是指向 <a href="gg294104(v=exchg.10).md">JET_COLUMNID</a>的指標。</p><p><strong>Windows Vista：</strong>此值會在 Windows Vista 中引進。</p> | 
| <p>JET_ColInfoGrbitNonDerivedColumnsOnly</p> | <p>只有當資料表衍生自範本) 時，才會傳回非衍生的資料行 (。</p><p>當基底<em>InfoLevel</em> JET_ColInfoList 時，此值可以邏輯或進入<em>InfoLevel</em>。</p><p><strong>Windows Vista：</strong>此值是 Windows Vista 引進。</p> | 
...
| | | <p><strong>用戶端</strong></p> | <p>需要 Windows Vista、Windows XP 或 Windows 2000 Professional。</p> | | <p><strong>伺服器</strong></p> | <p>需要 Windows server 2008、Windows Server 2003 或 Windows 2000 Server。</p> | | <p><strong>標頭</strong></p> | <p>宣告于 Esent. h 中。</p> | | <p><strong>程式庫</strong></p> | <p>使用 ESENT。</p> | | <p><strong>DLL</strong></p> | <p>需要 ESENT.dll。</p> | | <p><strong>Unicode</strong></p> | <p>實作為 <strong>JetGetColumnInfoW</strong> (Unicode) 和 <strong>JetGetColumnInfoA</strong> (ANSI) 。</p> | 
