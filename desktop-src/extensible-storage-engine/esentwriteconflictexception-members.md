...
---
# <a name="esentwriteconflictexception-members"></a>EsentWriteConflictException 成員
...
[EsentWriteConflictException](./esentwriteconflictexception-class.md)類型會公開下列成員。
...
<td><a href="dn350878(v=exchg.10).md">EsentWriteConflictException</a></td>
<td>初始化 EsentWriteConflictException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentWriteConflictException 類別](./esentwriteconflictexception-class.md)
