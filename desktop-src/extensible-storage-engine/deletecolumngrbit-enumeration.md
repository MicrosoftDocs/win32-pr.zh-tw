...
[JetDeleteColumn2 (JET_SESID、JET_TABLEID、String、DeleteColumnGrbit) ](./api.jetdeletecolumn2-method.md)的選項。
...
<td>API 應該只會嘗試刪除衍生資料表中的資料行。 如果基表中有該名稱的資料行，則會忽略該名稱的資料行。</td>
</tr>
</tbody>
</table>
