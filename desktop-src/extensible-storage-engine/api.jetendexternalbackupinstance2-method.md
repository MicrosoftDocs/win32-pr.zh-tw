...
ms.locfileid: "117903441"
---
# <a name="apijetendexternalbackupinstance2-method"></a>JetEndExternalBackupInstance2 方法
...
<!-- end list -->
  ...
  - grbit  
    型別： [EndExternalBackupGrbit](./endexternalbackupgrbit-enumeration.md) 。  
