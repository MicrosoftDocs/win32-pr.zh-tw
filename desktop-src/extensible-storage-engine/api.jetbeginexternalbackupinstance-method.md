...
---
# <a name="apijetbeginexternalbackupinstance-method"></a>JetBeginExternalBackupInstance 方法

當引擎和資料庫在線上且作用中時，起始外部備份。
...
<!-- end list -->
  ...
  - grbit  
    型別： [BeginExternalBackupGrbit](./beginexternalbackupgrbit-enumeration.md) 。  
