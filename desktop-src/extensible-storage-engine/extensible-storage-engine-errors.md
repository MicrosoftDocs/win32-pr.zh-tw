...
---
# <a name="extensible-storage-engine-errors"></a>可擴充儲存引擎錯誤
...
可延伸儲存引擎所傳回的所有可能錯誤 (ESE) API 都是由 [JET_ERR](./jet-err.md) 資料類型所定義。 如需為此 API 定義的錯誤旗標清單，請參閱可延伸 [儲存引擎錯誤碼](./extensible-storage-engine-error-codes.md)。
