...
---
# <a name="jet_rstinfotostring-method"></a>JET_RSTINFO。ToString 方法

傳回表示目前[JET_RSTINFO](./jet-rstinfo-class.md)的[字串](/dotnet/api/system.string)。
...
表示目前[JET_RSTINFO](./jet-rstinfo-class.md)的[字串](/dotnet/api/system.string)。  
