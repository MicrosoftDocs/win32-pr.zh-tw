---
description: 深入瞭解： JET_INDEXCREATE cbVarSegMac 屬性
title: JET_INDEXCREATE cbVarSegMac 屬性
...
ms.locfileid: "119039046"
---
# <a name="jet_indexcreatecbvarsegmac-property"></a>JET_INDEXCREATE cbVarSegMac 屬性

取得或設定要儲存在索引中之每個資料行的最大長度（以位元組為單位）。
