---
description: 深入瞭解： EsentNullInvalidException 的函式
title: EsentNullInvalidException 函式
...
ms.locfileid: "106988494"
---
# <a name="esentnullinvalidexception-constructor"></a>EsentNullInvalidException 函式

初始化 EsentNullInvalidException 類別的新實例。
