---
description: 深入瞭解： Windows7Grbits. IntrinsicLVsOnly 欄位
title: 'Windows7Grbits. IntrinsicLVsOnly 欄位 (欄位，最為理想) '
...
ms.locfileid: "106979030"
---
# <a name="windows7grbitsintrinsiclvsonly-field"></a>Windows7Grbits. IntrinsicLVsOnly 欄位

只允許內建的 LV (所以不需要 materialisation，因為 TT 有 LV 資料行) 。
