---
description: 深入瞭解： ByteColumnValue 屬性
title: ByteColumnValue 屬性
...
ms.locfileid: "104564741"
---
# <a name="bytecolumnvalue-properties"></a>ByteColumnValue 屬性

包含受保護的成員  
包含繼承的成員  

[ByteColumnValue](./bytecolumnvalue-class.md)類型會公開下列成員。
...
<td><a href="dn334116(v=exchg.10).md">大小</a></td>
