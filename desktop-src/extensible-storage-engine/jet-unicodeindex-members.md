---
description: 深入瞭解： JET_UNICODEINDEX 成員
title: JET_UNICODEINDEX 成員
...
ms.locfileid: "104555551"
---
# <a name="jet_unicodeindex-members"></a>JET_UNICODEINDEX 成員

包含受保護的成員  
包含繼承的成員  

自訂在 Unicode 資料行上建立索引時，如何將 Unicode 資料正規化。 自訂在 Unicode 資料行上建立索引時，如何將 Unicode 資料正規化。

[JET_UNICODEINDEX](./jet-unicodeindex-class.md)類型會公開下列成員。
...
<td><a href="dn351107(v=exchg.10).md">JET_UNICODEINDEX</a></td>
<td></td>
</tr>
</tbody>
</table>
...
<td>取得或設定正規化 unicode 資料時，要與 LCMapString 搭配使用的旗標。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="dn351144(v=exchg.10).md">lcid</a></td>
<td>取得或設定標準化 unicode 資料時要使用的 LCID。</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="dn351147(v=exchg.10).md">szLocaleName</a></td>
<td>取得或設定標準化 unicode 資料時要使用的 >localename。</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="公用方法" alt="Public method" /></td>
<td><a href="dn351109(v=exchg.10).md">GetEffectiveLocaleName</a></td>
<td>為了因應沒有 LCID 支援之系統的因應措施，我們會將非常有限數目的 Lcid 轉換成地區設定名稱。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="公用方法" alt="Public method" /></td>
