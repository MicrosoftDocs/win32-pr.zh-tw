...
---
# <a name="esentkeyboundaryexception-members"></a>EsentKeyBoundaryException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。KeyBoundary 例外狀況。

[EsentKeyBoundaryException](./esentkeyboundaryexception-class.md)類型會公開下列成員。
...
<td><a href="dn334535(v=exchg.10).md">EsentKeyBoundaryException</a></td>
<td>初始化 EsentKeyBoundaryException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentKeyBoundaryException 類別](./esentkeyboundaryexception-class.md)
