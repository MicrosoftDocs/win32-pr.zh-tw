...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 3a61e4de7f52ac0580749d7fb47cf54cff6f0bd1a497db7683ab6c8a4a2fabc3
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118265805"
---
# <a name="esentinvalidobjectexception-members"></a>EsentInvalidObjectException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。InvalidObject 例外狀況。

[EsentInvalidObjectException](./esentinvalidobjectexception-class.md)類型會公開下列成員。
...
<td><a href="dn319567(v=exchg.10).md">EsentInvalidObjectException</a></td>
<td>初始化 EsentInvalidObjectException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInvalidObjectException 類別](./esentinvalidobjectexception-class.md)
