...
---
# <a name="esentbadlogsignatureexception-properties"></a>EsentBadLogSignatureException 屬性

包含受保護的成員  
包含繼承的成員  

[EsentBadLogSignatureException](./esentbadlogsignatureexception-class.md)類型會公開下列成員。
...
[EsentBadLogSignatureException 類別](./esentbadlogsignatureexception-class.md)
