...
ms.locfileid: "120019868"
---
# <a name="esentlsalreadysetexception-members"></a>EsentLSAlreadySetException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。LSAlreadySet 例外狀況。
...
<td><a href="dn334615(v=exchg.10).md">EsentLSAlreadySetException</a></td>
<td>初始化 EsentLSAlreadySetException 類別的新實例。</td>
</tr>
</tbody>
</table>
