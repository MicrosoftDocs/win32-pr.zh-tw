...
ms.locfileid: "119840358"
---
# <a name="apiretrievecolumnasdouble-method-jet_sesid-jet_tableid-jet_columnid"></a>RetrieveColumnAsDouble 方法 (JET_SESID、JET_TABLEID、JET_COLUMNID) 

從目前的記錄抓取雙資料行值。 記錄是與索引項目相關聯的記錄，位於資料指標的目前位置。
...
類型： [可為 null](/dotnet/api/system.nullable-1)\<[Double](/dotnet/api/system.double)\>  
從資料行取出為雙精度浮點數的資料。 如果資料行是 null，則為 null。  
...
[RetrieveColumnAsDouble 多載](./api.retrievecolumnasdouble-method.md)
