---
description: 深入瞭解： JET_COLUMNCREATE coltyp 屬性
title: JET_COLUMNCREATE coltyp 屬性
...
ms:contentKeyID: 55103398
ms.date: 07/30/2014
ms.topic: reference
f1_keywords:
- Microsoft.Isam.Esent.Interop.JET_COLUMNCREATE.coltyp
dev_langs:
- CSharp
- JScript
- VB
- other
api_name:
- Microsoft.Isam.Esent.Interop.JET_COLUMNCREATE.get_coltyp
- Microsoft.Isam.Esent.Interop.JET_COLUMNCREATE.set_coltyp
- Microsoft.Isam.Esent.Interop.JET_COLUMNCREATE.coltyp
topic_type:
- kbSyntax
- apiref
...
類型： [Microsoft.Isam.Esent.Interop.JET_coltyp](./jet-coltyp-enumeration.md)  
