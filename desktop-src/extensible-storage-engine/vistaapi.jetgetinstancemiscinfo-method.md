...
---
# <a name="vistaapijetgetinstancemiscinfo-method"></a>VistaApi. JetGetInstanceMiscInfo 方法
...
<!-- end list -->
  ...
  - infoLevel  
    類型： [Microsoft.Isam.Esent.Interop.Vista.JET_InstanceMiscInfo](./jet-instancemiscinfo-enumeration.md)  
