---
description: 深入瞭解： JetIndexColumnGrbit 列舉
title: JetIndexColumnGrbit 列舉 (Windows8) 的列舉
...
ms.locfileid: "119719098"
---
# <a name="jetindexcolumngrbit-enumeration"></a>JetIndexColumnGrbit 列舉

[JET_INDEX_COLUMN](./jet-index-column-class.md)的選項。
