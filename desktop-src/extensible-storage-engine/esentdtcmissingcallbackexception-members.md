---
description: 深入瞭解： EsentDTCMissingCallbackException 成員
title: EsentDTCMissingCallbackException 成員
TOCTitle: EsentDTCMissingCallbackException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentDTCMissingCallbackException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentdtcmissingcallbackexception_members(v=EXCHG.10)
ms:contentKeyID: 55101635
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 2801e213734f643ef97a92f08b9a5cc6ee68feb69ac6816a563266f51baf8f0e
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "117711270"
---
# <a name="esentdtcmissingcallbackexception-members"></a>EsentDTCMissingCallbackException 成員
...
[EsentDTCMissingCallbackException](./esentdtcmissingcallbackexception-class.md)類型會公開下列成員。
...
<td><a href="dn334506(v=exchg.10).md">EsentDTCMissingCallbackException</a></td>
<td>初始化 EsentDTCMissingCallbackException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentDTCMissingCallbackException 類別](./esentdtcmissingcallbackexception-class.md)
