---
description: 深入瞭解： EsentUnloadableOSFunctionalityException 成員
title: EsentUnloadableOSFunctionalityException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentunloadableosfunctionalityexception_members(v=EXCHG.10)
...
ms.locfileid: "104550952"
---
# <a name="esentunloadableosfunctionalityexception-members"></a>EsentUnloadableOSFunctionalityException 成員
...
[EsentUnloadableOSFunctionalityException](./esentunloadableosfunctionalityexception-class.md)類型會公開下列成員。
...
<td><a href="dn350834(v=exchg.10).md">EsentUnloadableOSFunctionalityException</a></td>
<td>初始化 EsentUnloadableOSFunctionalityException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentUnloadableOSFunctionalityException 類別](./esentunloadableosfunctionalityexception-class.md)
