...
---
# <a name="esentslvstreamingfilemissingexception-properties"></a>EsentSLVStreamingFileMissingException 屬性

包含受保護的成員  
包含繼承的成員  

[EsentSLVStreamingFileMissingException](./esentslvstreamingfilemissingexception-class.md)類型會公開下列成員。
...
[EsentSLVStreamingFileMissingException 類別](./esentslvstreamingfilemissingexception-class.md)
