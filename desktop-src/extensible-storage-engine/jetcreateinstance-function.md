...
**Windows xp： JetCreateInstance** 是在 Windows xp 引進。
...
| <p>JET_errInvalidParameter</p> | <p>提供的其中一個參數包含未預期的值，或包含的值在與另一個參數的值結合時並沒有意義。 當<em>pinstance</em>為<strong>Null</strong>時， <strong>JetCreateInstance</strong>可能會發生這種情況。</p> | 
...
| <p><strong>Unicode</strong></p> | <p>實作為 <strong>JetCreateInstanceW</strong> (Unicode) 和 <strong>JetCreateInstanceA</strong> (ANSI) 。</p> | 
