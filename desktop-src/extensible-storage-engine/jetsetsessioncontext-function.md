...
<td><p>提供的其中一個參數包含未預期的值，或多個參數值的組合產生了非預期的結果。 <strong>JetSetSessionCoNtext</strong>會在下列情況下傳回此錯誤：</p>
<ul>
<li><p><em>ulCoNtext</em> 為 Null</p></li>
<li><p><em>ulCoNtext</em> 為-1</p></li>
</ul></td>
</tr>
<tr class="odd">
...
<td><p>會話無法與目前的執行緒建立關聯，因為它已經與執行緒相關聯。</p></td>
</tr>
<tr class="even">
