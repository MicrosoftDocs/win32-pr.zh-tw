---
description: 深入瞭解： EsentBadCheckpointSignatureException 成員
title: EsentBadCheckpointSignatureException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentbadcheckpointsignatureexception_members(v=EXCHG.10)
...
ms.locfileid: "104553860"
---
# <a name="esentbadcheckpointsignatureexception-members"></a>EsentBadCheckpointSignatureException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。BadCheckpointSignature 例外狀況。
...
<td><a href="dn273998(v=exchg.10).md">EsentBadCheckpointSignatureException</a></td>
<td>初始化 EsentBadCheckpointSignatureException 類別的新實例。</td>
</tr>
</tbody>
</table>
