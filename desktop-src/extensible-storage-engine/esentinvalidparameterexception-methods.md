...
---
# <a name="esentinvalidparameterexception-methods"></a>EsentInvalidParameterException 方法

包含受保護的成員  
包含繼承的成員  

[EsentInvalidParameterException](./esentinvalidparameterexception-class.md)類型會公開下列成員。
...
[EsentInvalidParameterException 類別](./esentinvalidparameterexception-class.md)
