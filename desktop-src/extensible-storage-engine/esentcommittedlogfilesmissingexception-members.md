...
ms.locfileid: "118782995"
---
# <a name="esentcommittedlogfilesmissingexception-members"></a>EsentCommittedLogFilesMissingException 成員
...
[EsentCommittedLogFilesMissingException](./esentcommittedlogfilesmissingexception-class.md)類型會公開下列成員。
...
<td><a href="dn334317(v=exchg.10).md">EsentCommittedLogFilesMissingException</a></td>
<td>初始化 EsentCommittedLogFilesMissingException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentCommittedLogFilesMissingException 類別](./esentcommittedlogfilesmissingexception-class.md)
