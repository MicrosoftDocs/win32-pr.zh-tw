---
description: 深入瞭解： EsentTooManyColumnsException 的函式
title: EsentTooManyColumnsException 函式
...
初始化 EsentTooManyColumnsException 類別的新實例。
...
[EsentTooManyColumnsException 成員](./esenttoomanycolumnsexception-members.md)
