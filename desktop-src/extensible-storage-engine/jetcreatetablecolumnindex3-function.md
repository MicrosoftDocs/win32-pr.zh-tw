...
| <p><strong>Unicode</strong></p> | <p>實作為 <strong>JetCreateTableColumnIndex3W</strong> (Unicode) 和 <strong>JetCreateTableColumnIndex3A</strong> (ANSI) 。</p> | 
