---
description: 深入瞭解： EsentMustCommitDistributedTransactionToLevel0Exception 成員
title: EsentMustCommitDistributedTransactionToLevel0Exception 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentmustcommitdistributedtransactiontolevel0exception_members(v=EXCHG.10)
ms:contentKeyID: 55102272
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 6a6a16be9e5c4721c9975f75e343f92ecf4b97d21e5fea5e69eea93035883cff
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119734151"
---
# <a name="esentmustcommitdistributedtransactiontolevel0exception-members"></a>EsentMustCommitDistributedTransactionToLevel0Exception 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。MustCommitDistributedTransactionToLevel0 例外狀況。

[EsentMustCommitDistributedTransactionToLevel0Exception](./esentmustcommitdistributedtransactiontolevel0exception-class.md)類型會公開下列成員。
...
<td><a href="dn319641(v=exchg.10).md">EsentMustCommitDistributedTransactionToLevel0Exception</a></td>
<td>初始化 EsentMustCommitDistributedTransactionToLevel0Exception 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentMustCommitDistributedTransactionToLevel0Exception 類別](./esentmustcommitdistributedtransactiontolevel0exception-class.md)
