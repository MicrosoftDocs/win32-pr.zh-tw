---
description: 深入瞭解： EsentDbTimeTooOldException 成員
title: EsentDbTimeTooOldException 成員
...
ms.locfileid: "104554058"
---
# <a name="esentdbtimetoooldexception-members"></a>EsentDbTimeTooOldException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。DbTimeTooOld 例外狀況。
...
<td><a href="dn274246(v=exchg.10).md">EsentDbTimeTooOldException</a></td>
<td>初始化 EsentDbTimeTooOldException 類別的新實例。</td>
</tr>
</tbody>
</table>
