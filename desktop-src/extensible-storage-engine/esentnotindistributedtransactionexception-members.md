...
---
# <a name="esentnotindistributedtransactionexception-members"></a>EsentNotInDistributedTransactionException 成員
...
[EsentNotInDistributedTransactionException](./esentnotindistributedtransactionexception-class.md)類型會公開下列成員。
...
<td><a href="dn334736(v=exchg.10).md">EsentNotInDistributedTransactionException</a></td>
<td>初始化 EsentNotInDistributedTransactionException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentNotInDistributedTransactionException 類別](./esentnotindistributedtransactionexception-class.md)
