...
---
# <a name="esentoutofbuffersexception-members"></a>EsentOutOfBuffersException 成員
...
[EsentOutOfBuffersException](./esentoutofbuffersexception-class.md)類型會公開下列成員。
...
<td><a href="dn319718(v=exchg.10).md">EsentOutOfBuffersException</a></td>
<td>初始化 EsentOutOfBuffersException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentOutOfBuffersException 類別](./esentoutofbuffersexception-class.md)
