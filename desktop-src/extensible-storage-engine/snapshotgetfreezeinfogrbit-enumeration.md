---
description: 深入瞭解： SnapshotGetFreezeInfoGrbit 列舉
title: 'SnapshotGetFreezeInfoGrbit 列舉 (的列舉) '
...
ms:contentKeyID: 39513373
ms.date: 07/30/2014
ms.topic: reference
f1_keywords:
- Microsoft.Isam.Esent.Interop.Vista.SnapshotGetFreezeInfoGrbit
- Microsoft.Isam.Esent.Interop.Vista.SnapshotGetFreezeInfoGrbit.None
dev_langs:
- CSharp
- JScript
- VB
...
[JetOSSnapshotGetFreezeInfo (JET_OSSNAPID、Int32、 \[ \] 、SnapshotGetFreezeInfoGrbit) ](./vistaapi.jetossnapshotgetfreezeinfo-method.md)的選項。
