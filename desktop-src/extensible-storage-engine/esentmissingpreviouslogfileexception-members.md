---
description: 深入瞭解： EsentMissingPreviousLogFileException 成員
title: EsentMissingPreviousLogFileException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentmissingpreviouslogfileexception_members(v=EXCHG.10)
...
<td><a href="dn334756(v=exchg.10).md">EsentMissingPreviousLogFileException</a></td>
<td>初始化 EsentMissingPreviousLogFileException 類別的新實例。</td>
</tr>
</tbody>
</table>
