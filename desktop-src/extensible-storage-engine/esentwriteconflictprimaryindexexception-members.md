---
description: 深入瞭解： EsentWriteConflictPrimaryIndexException 成員
title: EsentWriteConflictPrimaryIndexException 成員
TOCTitle: EsentWriteConflictPrimaryIndexException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentWriteConflictPrimaryIndexException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentwriteconflictprimaryindexexception_members(v=EXCHG.10)
ms:contentKeyID: 55103209
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 22c72619b35bbec1435b9b1b8f1da195be321138
ms.sourcegitcommit: 831e8f3db78ab820e1710cede244553c70e50500
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 01/08/2021
ms.locfileid: "104550531"
---
# <a name="esentwriteconflictprimaryindexexception-members"></a>EsentWriteConflictPrimaryIndexException 成員
...
[EsentWriteConflictPrimaryIndexException](./esentwriteconflictprimaryindexexception-class.md)類型會公開下列成員。
...
<td><a href="dn350895(v=exchg.10).md">EsentWriteConflictPrimaryIndexException</a></td>
<td>初始化 EsentWriteConflictPrimaryIndexException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentWriteConflictPrimaryIndexException 類別](./esentwriteconflictprimaryindexexception-class.md)
