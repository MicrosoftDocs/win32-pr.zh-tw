---
description: 深入瞭解： EsentInstanceUnavailableException 成員
title: EsentInstanceUnavailableException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentinstanceunavailableexception_members(v=EXCHG.10)
...
ms.locfileid: "119116048"
---
# <a name="esentinstanceunavailableexception-members"></a>EsentInstanceUnavailableException 成員
...
[EsentInstanceUnavailableException](./esentinstanceunavailableexception-class.md)類型會公開下列成員。
...
<td><a href="dn319393(v=exchg.10).md">EsentInstanceUnavailableException</a></td>
<td>初始化 EsentInstanceUnavailableException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInstanceUnavailableException 類別](./esentinstanceunavailableexception-class.md)
