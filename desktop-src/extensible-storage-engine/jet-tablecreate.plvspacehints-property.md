---
description: 深入瞭解： JET_TABLECREATE pLVSpacehints 屬性
title: JET_TABLECREATE pLVSpacehints 屬性
...
api_name:
- Microsoft.Isam.Esent.Interop.JET_TABLECREATE.pLVSpacehints
- Microsoft.Isam.Esent.Interop.JET_TABLECREATE.get_pLVSpacehints
- Microsoft.Isam.Esent.Interop.JET_TABLECREATE.set_pLVSpacehints
topic_type:
- apiref
- kbSyntax
api_type:
...
取得或設定類型為 [JET_SPACEHINTS](./jet-spacehints-class.md)的分隔 LV 樹狀目錄的空間配置、維護和使用方式提示。
