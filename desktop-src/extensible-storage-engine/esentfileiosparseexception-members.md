...
---
# <a name="esentfileiosparseexception-members"></a>EsentFileIOSparseException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。FileIOSparse 例外狀況。

[EsentFileIOSparseException](./esentfileiosparseexception-class.md)類型會公開下列成員。
...
<td><a href="dn274370(v=exchg.10).md">EsentFileIOSparseException</a></td>
<td>初始化 EsentFileIOSparseException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentFileIOSparseException 類別](./esentfileiosparseexception-class.md)
