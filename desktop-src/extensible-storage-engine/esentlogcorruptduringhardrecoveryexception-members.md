...
ms.locfileid: "119620628"
---
# <a name="esentlogcorruptduringhardrecoveryexception-members"></a>EsentLogCorruptDuringHardRecoveryException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。LogCorruptDuringHardRecovery 例外狀況。
...
<td><a href="dn319631(v=exchg.10).md">EsentLogCorruptDuringHardRecoveryException</a></td>
<td>初始化 EsentLogCorruptDuringHardRecoveryException 類別的新實例。</td>
</tr>
</tbody>
</table>
