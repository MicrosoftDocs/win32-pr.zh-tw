...
---
# <a name="jet_enumcolumnvaluetostring-method"></a>JET_ENUMCOLUMNVALUE。ToString 方法

傳回表示目前[JET_ENUMCOLUMNVALUE](./jet-enumcolumnvalue-class.md)的[字串](/dotnet/api/system.string)。
...
表示目前[JET_ENUMCOLUMNVALUE](./jet-enumcolumnvalue-class.md)的[字串](/dotnet/api/system.string)。  
