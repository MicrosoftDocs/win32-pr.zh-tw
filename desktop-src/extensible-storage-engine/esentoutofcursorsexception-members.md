...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: d10317686c101a37ed92f09aae71280321e975ddf7bdca1e00a6f1cf2d3cd538
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119040126"
---
# <a name="esentoutofcursorsexception-members"></a>EsentOutOfCursorsException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。OutOfCursors 例外狀況。

[EsentOutOfCursorsException](./esentoutofcursorsexception-class.md)類型會公開下列成員。
...
<td><a href="dn319763(v=exchg.10).md">EsentOutOfCursorsException</a></td>
<td>初始化 EsentOutOfCursorsException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentOutOfCursorsException 類別](./esentoutofcursorsexception-class.md)
