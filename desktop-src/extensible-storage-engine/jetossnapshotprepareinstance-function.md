...
| <p>JET_errInvalidParameter</p> | <p>快照集識別碼指標為 <strong>Null</strong> 或 <em>grbit</em> 參數無效。</p> | 
| <p>JET_errOSSnapshotInvalidSequence</p> | <p>快照會話已在進行中。</p> | 
