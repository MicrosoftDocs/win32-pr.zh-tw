...
ms.locfileid: "118493671"
---
# <a name="esentoperationexception-constructor-string-jet_err"></a>EsentOperationException (字串 JET_err) 的函式

初始化 EsentOperationException 類別的新實例。
