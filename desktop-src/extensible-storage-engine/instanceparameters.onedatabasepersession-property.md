...
---
# <a name="instanceparametersonedatabasepersession-property"></a>InstanceParameters. OneDatabasePerSession 屬性

取得或設定值，這個值表示一次是否允許指定的會話使用 JetOpenDatabase 來開啟單一資料庫。 這項限制會排除暫存資料庫。
