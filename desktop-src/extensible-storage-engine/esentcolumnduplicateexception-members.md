...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 1e505e799d0d55ff02febfdca779a09c772778a9e7e728470ebce475cc0ad9e6
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119041826"
---
# <a name="esentcolumnduplicateexception-members"></a>EsentColumnDuplicateException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。ColumnDuplicate 例外狀況。

[EsentColumnDuplicateException](./esentcolumnduplicateexception-class.md)類型會公開下列成員。
...
<td><a href="dn334256(v=exchg.10).md">EsentColumnDuplicateException</a></td>
<td>初始化 EsentColumnDuplicateException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentColumnDuplicateException 類別](./esentcolumnduplicateexception-class.md)
