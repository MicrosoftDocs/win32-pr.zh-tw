...
ms.locfileid: "118085210"
---
# <a name="apijetgettablecolumninfo-method-jet_sesid-jet_tableid-string-jet_columndef"></a>JetGetTableColumnInfo 方法 (JET_SESID、JET_TABLEID、字串、JET_COLUMNDEF) 
