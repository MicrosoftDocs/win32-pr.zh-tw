---
description: 深入瞭解： EsentTaskDroppedException 方法
title: EsentTaskDroppedException 方法
TOCTitle: EsentTaskDroppedException methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.EsentTaskDroppedException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esenttaskdroppedexception_methods(v=EXCHG.10)
