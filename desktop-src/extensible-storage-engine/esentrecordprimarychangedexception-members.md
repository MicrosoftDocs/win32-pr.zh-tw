...
---
# <a name="esentrecordprimarychangedexception-members"></a>EsentRecordPrimaryChangedException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。RecordPrimaryChanged 例外狀況。

[EsentRecordPrimaryChangedException](./esentrecordprimarychangedexception-class.md)類型會公開下列成員。
...
<td><a href="dn350516(v=exchg.10).md">EsentRecordPrimaryChangedException</a></td>
<td>初始化 EsentRecordPrimaryChangedException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentRecordPrimaryChangedException 類別](./esentrecordprimarychangedexception-class.md)
