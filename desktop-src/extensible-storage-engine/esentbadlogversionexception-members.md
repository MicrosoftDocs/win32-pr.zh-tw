...
---
# <a name="esentbadlogversionexception-members"></a>EsentBadLogVersionException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。BadLogVersion 例外狀況。

[EsentBadLogVersionException](./esentbadlogversionexception-class.md)類型會公開下列成員。
...
<td><a href="dn274027(v=exchg.10).md">EsentBadLogVersionException</a></td>
<td>初始化 EsentBadLogVersionException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentBadLogVersionException 類別](./esentbadlogversionexception-class.md)
