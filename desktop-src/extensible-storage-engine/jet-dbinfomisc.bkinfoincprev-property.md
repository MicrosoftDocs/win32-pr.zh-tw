...
ms.locfileid: "119617578"
---
# <a name="jet_dbinfomiscbkinfoincprev-property"></a>JET_DBINFOMISC bkinfoIncPrev 屬性

取得上一次成功增量備份的相關資訊。 設定 [bkinfoFullPrev](./jet-dbinfomisc.bkinfofullprev-property.md) 時，會重設此值。
