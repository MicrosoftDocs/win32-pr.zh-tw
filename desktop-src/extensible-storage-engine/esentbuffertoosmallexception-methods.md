...
ms.locfileid: "119622463"
---
# <a name="esentbuffertoosmallexception-methods"></a>EsentBufferTooSmallException 方法

包含受保護的成員  
包含繼承的成員  

[EsentBufferTooSmallException](./esentbuffertoosmallexception-class.md)類型會公開下列成員。
