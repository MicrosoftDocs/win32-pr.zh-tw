...
**Windows xp： JetGetSecondaryIndexBookmark** 是在 windows xp 中引進的。
...
<td><p>作業已順利完成，但其中一個輸出緩衝區太小，無法接收要求的資料。</p>
<p>輸出緩衝區已填滿適當的書簽。 如果要求，也會傳回書簽的實際大小。</p></td>
</tr>
<tr class="odd">
...
<td><p>資料指標目前不在次要索引上。</p>
<p>當資料指標目前未使用次要索引時，抓取次要索引書簽並沒有意義。 當資料指標不在次要索引上時，應使用<a href="gg269221(v=exchg.10).md">JetGetBookmark</a> 。</p></td>
</tr>
<tr class="even">
<td><p>JET_errNoCurrentRecord</p></td>
<td><p>資料指標未放置在記錄上。</p>
<p>此情況具有許多不同的原因。 例如，如果資料指標目前位於目前索引的最後一筆記錄之後，就會發生這種情況。</p></td>
</tr>
<tr class="odd">
...
書簽通常應該視為不透明的資料區塊。 不應嘗試利用此資料的內部結構。 不過，您可以知道所有 ESENT 書簽的下列屬性：
  ...
  - 在 Windows Vista 之前，書簽一律小於或等於 JET_cbBookmarkMost (256) 位元組。 在 Windows Vista 和更新版本中，書簽可以更大。 書簽的大小上限等於 JET_paramKeyMost + 1 目前的值。
