...
---
# <a name="extensible-storage-engine"></a>可擴充儲存引擎
...
可延伸儲存引擎是 Windows 2000 中引進的 Windows 元件。 並非所有的功能或 Api 都適用于所有版本的 Windows 作業系統。
...
**注意**  Windows XP 64 位版與 Windows Server 2003 相同，目的是要決定支援的 ESE 功能集。
...
[可擴充儲存引擎參考](./extensible-storage-engine-reference.md)
