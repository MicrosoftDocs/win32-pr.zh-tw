...
ms.locfileid: "119115828"
---
# <a name="esentioexception-constructor-serializationinfo-streamingcontext"></a>EsentIOException 函式 (SerializationInfo、StreamingCoNtext) 

初始化 EsentIOException 類別的新實例。 這個函式是用來將序列化的例外狀況還原序列化。
