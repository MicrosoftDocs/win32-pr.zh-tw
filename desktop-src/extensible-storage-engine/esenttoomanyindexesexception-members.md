---
description: 深入瞭解： EsentTooManyIndexesException 成員
title: EsentTooManyIndexesException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esenttoomanyindexesexception_members(v=EXCHG.10)
ms:contentKeyID: 55103086
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: b8b2c123fc9762278bbcdef115ee8ddaa7b86041a206de80ac62bad7f0cd50a0
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119850598"
---
# <a name="esenttoomanyindexesexception-members"></a>EsentTooManyIndexesException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。TooManyIndexes 例外狀況。

[EsentTooManyIndexesException](./esenttoomanyindexesexception-class.md)類型會公開下列成員。
...
<td><a href="dn334993(v=exchg.10).md">EsentTooManyIndexesException</a></td>
<td>初始化 EsentTooManyIndexesException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentTooManyIndexesException 類別](./esenttoomanyindexesexception-class.md)
