...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 076037f53ced8d5e124c8023f67d601c811835f115e358f9d1b2035a8be099c6
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119041046"
---
# <a name="esentinvalidoperationexception-members"></a>EsentInvalidOperationException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。InvalidOperation 例外狀況。

[EsentInvalidOperationException](./esentinvalidoperationexception-class.md)類型會公開下列成員。
...
<td><a href="dn319573(v=exchg.10).md">EsentInvalidOperationException</a></td>
<td>初始化 EsentInvalidOperationException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInvalidOperationException 類別](./esentinvalidoperationexception-class.md)
