...
JET_err 的基類。IndexTuplesInvalidLimits 例外狀況。

[EsentIndexTuplesInvalidLimitsException](./esentindextuplesinvalidlimitsexception-class.md)類型會公開下列成員。
...
<td><a href="dn319413(v=exchg.10).md">EsentIndexTuplesInvalidLimitsException</a></td>
<td>初始化 EsentIndexTuplesInvalidLimitsException 類別的新實例。</td>
</tr>
</tbody>
</table>
