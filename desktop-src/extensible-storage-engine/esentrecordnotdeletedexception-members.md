...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: c7080337b4330d8d3772257a802d816b7d242245f4eee354191924a549a602ff
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118079486"
---
# <a name="esentrecordnotdeletedexception-members"></a>EsentRecordNotDeletedException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。RecordNotDeleted 例外狀況。

[EsentRecordNotDeletedException](./esentrecordnotdeletedexception-class.md)類型會公開下列成員。
...
<td><a href="dn350513(v=exchg.10).md">EsentRecordNotDeletedException</a></td>
<td>初始化 EsentRecordNotDeletedException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentRecordNotDeletedException 類別](./esentrecordnotdeletedexception-class.md)
