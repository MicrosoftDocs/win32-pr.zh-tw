...
---
# <a name="esentdbtimetoooldexception-methods"></a>EsentDbTimeTooOldException 方法

包含受保護的成員  
包含繼承的成員  

[EsentDbTimeTooOldException](./esentdbtimetoooldexception-class.md)類型會公開下列成員。
...
[EsentDbTimeTooOldException 類別](./esentdbtimetoooldexception-class.md)
