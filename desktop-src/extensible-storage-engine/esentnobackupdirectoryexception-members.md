---
description: 深入瞭解： EsentNoBackupDirectoryException 成員
title: EsentNoBackupDirectoryException 成員
TOCTitle: EsentNoBackupDirectoryException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentNoBackupDirectoryException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentnobackupdirectoryexception_members(v=EXCHG.10)
ms:contentKeyID: 55102283
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 5a96aaa6c3334b9282a50dad8de69801507d2924e8455f8eeaf40824144519d1
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119734018"
---
# <a name="esentnobackupdirectoryexception-members"></a>EsentNoBackupDirectoryException 成員
...
[EsentNoBackupDirectoryException](./esentnobackupdirectoryexception-class.md)類型會公開下列成員。
...
<td><a href="dn319661(v=exchg.10).md">EsentNoBackupDirectoryException</a></td>
<td>初始化 EsentNoBackupDirectoryException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentNoBackupDirectoryException 類別](./esentnobackupdirectoryexception-class.md)
