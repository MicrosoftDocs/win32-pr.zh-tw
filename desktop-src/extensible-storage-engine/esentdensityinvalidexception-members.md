...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: cecbc31bd607989df2181bfb35c0ff131ecea2a3a2141618caf1b1082470d289
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118270920"
---
# <a name="esentdensityinvalidexception-members"></a>EsentDensityInvalidException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。DensityInvalid 例外狀況。

[EsentDensityInvalidException](./esentdensityinvalidexception-class.md)類型會公開下列成員。
...
<td><a href="dn334435(v=exchg.10).md">EsentDensityInvalidException</a></td>
<td>初始化 EsentDensityInvalidException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentDensityInvalidException 類別](./esentdensityinvalidexception-class.md)
