---
description: 深入瞭解： VistaParam. EnableAdvanced 欄位
title: VistaParam. EnableAdvanced 欄位)  (的欄位
...
ms.locfileid: "104112029"
---
# <a name="vistaparamenableadvanced-field"></a>VistaParam. EnableAdvanced 欄位

這個參數是用來控制 database engine 接受或拒絕系統參數子集之變更的時間。 此參數會搭配 [設定使用，以防止](./vistaparam.configuration-field.md) 某些系統參數從選取的設定的預設值中退出。
