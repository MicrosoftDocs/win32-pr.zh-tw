---
description: 深入瞭解： Session ToString 方法
title: Session ToString 方法
...
傳回表示目前[會話](./session-class.md)的[字串](/dotnet/api/system.string)。
...
表示目前[會話](./session-class.md)的[字串](/dotnet/api/system.string)。  
