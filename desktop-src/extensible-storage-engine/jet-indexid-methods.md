---
description: 深入瞭解： JET_INDEXID 方法
title: JET_INDEXID 方法
TOCTitle: JET_INDEXID methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.JET_INDEXID
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.jet_indexid_methods(v=EXCHG.10)
...
[JET_INDEXID](./jet-indexid-structure2.md)類型會公開下列成員。
...
<td><a href="hh579282(v=exchg.10).md">等於 (物件) </a></td>
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="公用方法" alt="Public method" /></td>
<td><a href="hh596198(v=exchg.10).md">等於 (JET_INDEXID) </a></td>
