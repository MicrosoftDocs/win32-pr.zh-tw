---
description: 深入瞭解： JET_RSTINFO 方法
title: JET_RSTINFO 方法
...
ms.locfileid: "103943297"
---
# <a name="jet_rstinfo-methods"></a>JET_RSTINFO 方法

包含受保護的成員  
包含繼承的成員  

[JET_RSTINFO](./jet-rstinfo-class.md)類型會公開下列成員。
...
<td>傳回表示目前<a href="dn335235(v=exchg.10).md">JET_RSTINFO</a>的<a href="/dotnet/api/system.string">字串</a>。  (會覆寫 <a href="/dotnet/api/system.object.tostring#System_Object_ToString">物件 ToString () </a>。 ) </td>
</tr>
</tbody>
</table>
