...
---
# <a name="esentindextuplestextbinarycolumnsonlyexception-members"></a>EsentIndexTuplesTextBinaryColumnsOnlyException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。IndexTuplesTextBinaryColumnsOnly 例外狀況。
...
<td><a href="dn350492(v=exchg.10).md">EsentIndexTuplesTextBinaryColumnsOnlyException</a></td>
<td>初始化 EsentIndexTuplesTextBinaryColumnsOnlyException 類別的新實例。</td>
</tr>
</tbody>
</table>
