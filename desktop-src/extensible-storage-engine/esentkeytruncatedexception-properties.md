---
description: 深入瞭解： EsentKeyTruncatedException 屬性
title: EsentKeyTruncatedException 屬性
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentkeytruncatedexception_properties(v=EXCHG.10)
