...
---
# <a name="esentfileiofailexception-members"></a>EsentFileIOFailException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。FileIOFail 例外狀況。

[EsentFileIOFailException](./esentfileiofailexception-class.md)類型會公開下列成員。
...
<td><a href="dn274362(v=exchg.10).md">EsentFileIOFailException</a></td>
<td>初始化 EsentFileIOFailException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentFileIOFailException 類別](./esentfileiofailexception-class.md)
