---
description: 深入瞭解： JET_OBJECTLIST 成員
title: JET_OBJECTLIST 成員
...
ms.locfileid: "118765984"
---
# <a name="jet_objectlist-members"></a>JET_OBJECTLIST 成員

包含受保護的成員  
包含繼承的成員  

臨時表的相關資訊，其中包含指定資料庫的所有資料表的相關資訊。

[JET_OBJECTLIST](./jet-objectlist-class.md)類型會公開下列成員。
...
<td>傳回表示目前<a href="dn335206(v=exchg.10).md">JET_OBJECTLIST</a>的<a href="/dotnet/api/system.string">字串</a>。  (會覆寫 <a href="/dotnet/api/system.object.tostring#System_Object_ToString">物件 ToString () </a>。 ) </td>
</tr>
</tbody>
</table>
