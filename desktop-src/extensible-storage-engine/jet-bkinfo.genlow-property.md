---
description: 深入瞭解： JET_BKINFO genLow 屬性
title: JET_BKINFO genLow 屬性
...
- other
api_name:
- Microsoft.Isam.Esent.Interop.JET_BKINFO.set_genLow
- Microsoft.Isam.Esent.Interop.JET_BKINFO.genLow
- Microsoft.Isam.Esent.Interop.JET_BKINFO.get_genLow
topic_type:
- kbSyntax
- apiref
api_type:
...
ms.locfileid: "118255602"
---
# <a name="jet_bkinfogenlow-property"></a>JET_BKINFO genLow 屬性
...
``` vb
'Declaration
Public Property genLow As Integer
    Get
    Friend Set
'Usage
