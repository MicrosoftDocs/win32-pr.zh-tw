---
description: 深入瞭解： JET_ENUMCOLUMN。ToString 方法
title: JET_ENUMCOLUMN。ToString 方法
...
傳回表示目前[JET_ENUMCOLUMN](./jet-enumcolumn-class.md)的[字串](/dotnet/api/system.string)。
...
表示目前[JET_ENUMCOLUMN](./jet-enumcolumn-class.md)的[字串](/dotnet/api/system.string)。  
