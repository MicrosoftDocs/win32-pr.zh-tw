---
description: 深入瞭解： EsentInvalidIndexIdException 成員
title: EsentInvalidIndexIdException 成員
TOCTitle: EsentInvalidIndexIdException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentInvalidIndexIdException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentinvalidindexidexception_members(v=EXCHG.10)
ms:contentKeyID: 55101938
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: f24f72c3c1bf56018f9a97f866dbcdebd0905d2d4c2663a2c02d7e8f0b105446
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119783671"
---
# <a name="esentinvalidindexidexception-members"></a>EsentInvalidIndexIdException 成員
...
[EsentInvalidIndexIdException](./esentinvalidindexidexception-class.md)類型會公開下列成員。
...
<td><a href="dn319524(v=exchg.10).md">EsentInvalidIndexIdException</a></td>
<td>初始化 EsentInvalidIndexIdException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInvalidIndexIdException 類別](./esentinvalidindexidexception-class.md)
