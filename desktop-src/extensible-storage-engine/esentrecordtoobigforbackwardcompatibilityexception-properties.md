...
---
# <a name="esentrecordtoobigforbackwardcompatibilityexception-properties"></a>EsentRecordTooBigForBackwardCompatibilityException 屬性

包含受保護的成員  
包含繼承的成員  

[EsentRecordTooBigForBackwardCompatibilityException](./esentrecordtoobigforbackwardcompatibilityexception-class.md)類型會公開下列成員。
...
[EsentRecordTooBigForBackwardCompatibilityException 類別](./esentrecordtoobigforbackwardcompatibilityexception-class.md)
