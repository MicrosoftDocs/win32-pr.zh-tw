---
description: 深入瞭解： Int64ColumnValue 方法
title: Int64ColumnValue 方法
TOCTitle: Int64ColumnValue methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.Int64ColumnValue
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.int64columnvalue_methods(v=EXCHG.10)
ms:contentKeyID: 55103334
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 7711f7d925d5fa5cb761304e10e489adbaab1deb
ms.sourcegitcommit: 831e8f3db78ab820e1710cede244553c70e50500
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 01/08/2021
ms.locfileid: "104550761"
---
# <a name="int64columnvalue-methods"></a>Int64ColumnValue 方法

包含受保護的成員  
包含繼承的成員  

[Int64ColumnValue](./int64columnvalue-class.md)類型會公開下列成員。
