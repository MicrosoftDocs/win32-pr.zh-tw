---
description: 深入瞭解： EsentRecordNoCopyException 的函式
title: EsentRecordNoCopyException 函式
...
ms.locfileid: "118079567"
---
# <a name="esentrecordnocopyexception-constructor"></a>EsentRecordNoCopyException 函式

初始化 EsentRecordNoCopyException 類別的新實例。
...
[EsentRecordNoCopyException 成員](./esentrecordnocopyexception-members.md)
