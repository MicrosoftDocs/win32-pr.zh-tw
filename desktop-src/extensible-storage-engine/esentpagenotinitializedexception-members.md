...
---
# <a name="esentpagenotinitializedexception-members"></a>EsentPageNotInitializedException 成員
...
[EsentPageNotInitializedException](./esentpagenotinitializedexception-class.md)類型會公開下列成員。
...
<td><a href="dn319827(v=exchg.10).md">EsentPageNotInitializedException</a></td>
<td>初始化 EsentPageNotInitializedException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentPageNotInitializedException 類別](./esentpagenotinitializedexception-class.md)
