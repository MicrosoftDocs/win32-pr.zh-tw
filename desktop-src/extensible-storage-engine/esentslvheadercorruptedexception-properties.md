---
description: 深入瞭解： EsentSLVHeaderCorruptedException 屬性
title: EsentSLVHeaderCorruptedException 屬性
TOCTitle: EsentSLVHeaderCorruptedException properties
ms:assetid: Properties.T:Microsoft.Isam.Esent.Interop.EsentSLVHeaderCorruptedException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentslvheadercorruptedexception_properties(v=EXCHG.10)
ms:contentKeyID: 55102856
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: eceeb7d1c3d523720e47f6873fb8ef86cf1ef85d750924e856ddff9dfef3bfcd
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118772873"
---
# <a name="esentslvheadercorruptedexception-properties"></a>EsentSLVHeaderCorruptedException 屬性

包含受保護的成員  
包含繼承的成員  

[EsentSLVHeaderCorruptedException](./esentslvheadercorruptedexception-class.md)類型會公開下列成員。
...
[EsentSLVHeaderCorruptedException 類別](./esentslvheadercorruptedexception-class.md)
