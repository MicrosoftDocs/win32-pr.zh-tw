...
---
# <a name="indexinfo-members"></a>IndexInfo 成員

包含受保護的成員  
包含繼承的成員  

一個 esent 索引的相關資訊。 這不是 interop 類別，而是由中繼資料 helper 方法所使用。

[IndexInfo](./indexinfo-class.md)類型會公開下列成員。
...
<td>取得索引的 CompareOptions。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="dn350921(v=exchg.10).md">CultureInfo</a></td>
<td>取得索引排序依據的 CultureInfo。</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="dn350907(v=exchg.10).md">項目</a></td>
<td>取得索引中的專案數。 此值不是最新值，而且只會由 JetComputeStats 更新。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
...
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="dn350926(v=exchg.10).md">[索引鍵]</a></td>
<td>取得索引中的唯一索引鍵數目。 此值不是最新值，而且只會由 JetComputeStats 更新。</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="dn350911(v=exchg.10).md">名稱</a></td>
<td>取得索引的名稱。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="dn350928(v=exchg.10).md">頁面</a></td>
<td>取得索引中的頁面數目。 此值不是最新值，而且只會由 JetComputeStats 更新。</td>
</tr>
</tbody>
</table>
...
<td>傳回表示目前<a href="dn350919(v=exchg.10).md">IndexInfo</a>的<a href="/dotnet/api/system.string">字串</a>。  (會覆寫 <a href="/dotnet/api/system.object.tostring#System_Object_ToString">物件 ToString () </a>。 ) </td>
</tr>
</tbody>
</table>
