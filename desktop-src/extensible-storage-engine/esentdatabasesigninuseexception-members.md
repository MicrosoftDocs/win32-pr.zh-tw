...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: c939514354232326537ab587c61707138585d22ecdbc9f16d8fd5e3877005be6
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118982518"
---
# <a name="esentdatabasesigninuseexception-members"></a>EsentDatabaseSignInUseException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。DatabaseSignInUse 例外狀況。

[EsentDatabaseSignInUseException](./esentdatabasesigninuseexception-class.md)類型會公開下列成員。
...
<td><a href="dn334491(v=exchg.10).md">EsentDatabaseSignInUseException</a></td>
<td>初始化 EsentDatabaseSignInUseException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentDatabaseSignInUseException 類別](./esentdatabasesigninuseexception-class.md)
