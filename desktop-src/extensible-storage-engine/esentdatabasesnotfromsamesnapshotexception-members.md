...
---
# <a name="esentdatabasesnotfromsamesnapshotexception-members"></a>EsentDatabasesNotFromSameSnapshotException 成員
...
[EsentDatabasesNotFromSameSnapshotException](./esentdatabasesnotfromsamesnapshotexception-class.md)類型會公開下列成員。
...
<td><a href="dn334382(v=exchg.10).md">EsentDatabasesNotFromSameSnapshotException</a></td>
<td>初始化 EsentDatabasesNotFromSameSnapshotException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentDatabasesNotFromSameSnapshotException 類別](./esentdatabasesnotfromsamesnapshotexception-class.md)
