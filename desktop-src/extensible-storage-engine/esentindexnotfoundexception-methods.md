...
---
# <a name="esentindexnotfoundexception-methods"></a>EsentIndexNotFoundException 方法

包含受保護的成員  
包含繼承的成員  

[EsentIndexNotFoundException](./esentindexnotfoundexception-class.md)類型會公開下列成員。
...
[EsentIndexNotFoundException 類別](./esentindexnotfoundexception-class.md)
