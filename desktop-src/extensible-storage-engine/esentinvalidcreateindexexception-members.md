...
JET_err 的基類。InvalidCreateIndex 例外狀況。

[EsentInvalidCreateIndexException](./esentinvalidcreateindexexception-class.md)類型會公開下列成員。
...
<td><a href="dn319508(v=exchg.10).md">EsentInvalidCreateIndexException</a></td>
<td>初始化 EsentInvalidCreateIndexException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentInvalidCreateIndexException 類別](./esentinvalidcreateindexexception-class.md)
