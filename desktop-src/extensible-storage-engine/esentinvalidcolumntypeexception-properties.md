---
description: 深入瞭解： EsentInvalidColumnTypeException 屬性
title: EsentInvalidColumnTypeException 屬性
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentinvalidcolumntypeexception_properties(v=EXCHG.10)
