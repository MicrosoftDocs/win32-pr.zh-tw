---
description: 深入瞭解： JET_RSTMAP。ToString 方法
title: JET_RSTMAP。ToString 方法
...
ms.locfileid: "106970846"
---
# <a name="jet_rstmaptostring-method"></a>JET_RSTMAP。ToString 方法

傳回表示目前[JET_RSTMAP](./jet-rstmap-class.md)的[字串](/dotnet/api/system.string)。
...
表示目前[JET_RSTMAP](./jet-rstmap-class.md)的[字串](/dotnet/api/system.string)。  
