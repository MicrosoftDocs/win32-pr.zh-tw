...
ms.locfileid: "118085153"
---
# <a name="apijetgettableindexinfo-method-jet_sesid-jet_tableid-string-jet_indexid-jet_idxinfo"></a>JetGetTableIndexInfo 方法 (JET_SESID、JET_TABLEID、字串、JET_INDEXID JET_IdxInfo) 
