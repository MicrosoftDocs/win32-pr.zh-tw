---
description: 深入瞭解： EsentStreamingDataNotLoggedException 方法
title: EsentStreamingDataNotLoggedException 方法
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentstreamingdatanotloggedexception_methods(v=EXCHG.10)
