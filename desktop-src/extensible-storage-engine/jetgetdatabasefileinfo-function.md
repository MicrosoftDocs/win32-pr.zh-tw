...
<td><p><strong>Windows Vista：  </strong>這個 <em>InfoLevel</em> 值是在 Windows Vista 中引進的。</p>
<p><em>pvResult</em> 會被視為 DWORD 指標。 傳回列舉值，這個值表示引擎將此視為何種檔案類型。 下表列出檔案類型。 如需這些檔案類型及其使用方式的詳細資訊，請參閱 <a href="gg294069(v=exchg.10).md">可擴充儲存引擎</a>檔案。</p>
