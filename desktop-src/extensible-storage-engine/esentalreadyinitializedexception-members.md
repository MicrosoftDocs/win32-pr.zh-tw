---
description: 深入瞭解： EsentAlreadyInitializedException 成員
title: EsentAlreadyInitializedException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentalreadyinitializedexception_members(v=EXCHG.10)
...
JET_err 的基類。AlreadyInitialized 例外狀況。
...
<td><a href="dn273991(v=exchg.10).md">EsentAlreadyInitializedException</a></td>
<td>初始化 EsentAlreadyInitializedException 類別的新實例。</td>
</tr>
</tbody>
</table>
