...
---
# <a name="esentaccessdeniedexception-constructor"></a>EsentAccessDeniedException 函式

初始化 EsentAccessDeniedException 類別的新實例。
...
[EsentAccessDeniedException 成員](./esentaccessdeniedexception-members.md)
