...
附加資料庫檔案以與資料庫實例搭配使用。 若要使用資料庫，就必須使用 [JetOpenDatabase (JET_SESID、string、string、JET_DBID、OpenDatabaseGrbit) ](./api.jetopendatabase-method.md)來開啟它。
...
<!-- end list -->
  ...
  - grbit  
    型別： [AttachDatabaseGrbit](./attachdatabasegrbit-enumeration.md) 。  
