---
description: 深入瞭解： ColumnStream ToString 方法
title: ColumnStream ToString 方法
...
ms.locfileid: "119454968"
---
# <a name="columnstreamtostring-method"></a>ColumnStream ToString 方法

傳回表示目前[ColumnStream](./columnstream-class.md)的[字串](/dotnet/api/system.string)。
...
表示目前[ColumnStream](./columnstream-class.md)的[字串](/dotnet/api/system.string)。  
