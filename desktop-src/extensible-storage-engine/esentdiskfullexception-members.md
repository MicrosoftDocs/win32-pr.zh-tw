...
ms.locfileid: "119840208"
---
# <a name="esentdiskfullexception-members"></a>EsentDiskFullException 成員
...
[EsentDiskFullException](./esentdiskfullexception-class.md)類型會公開下列成員。
...
<td><a href="dn334468(v=exchg.10).md">EsentDiskFullException</a></td>
<td>初始化 EsentDiskFullException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentDiskFullException 類別](./esentdiskfullexception-class.md)
