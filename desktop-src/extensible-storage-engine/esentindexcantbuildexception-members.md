...
[EsentIndexCantBuildException](./esentindexcantbuildexception-class.md)類型會公開下列成員。
...
<td><a href="dn350500(v=exchg.10).md">EsentIndexCantBuildException</a></td>
<td>初始化 EsentIndexCantBuildException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentIndexCantBuildException 類別](./esentindexcantbuildexception-class.md)
