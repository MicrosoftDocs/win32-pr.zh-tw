---
description: 深入瞭解： EsentDirtyShutdownException 成員
title: EsentDirtyShutdownException 成員
TOCTitle: EsentDirtyShutdownException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentDirtyShutdownException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentdirtyshutdownexception_members(v=EXCHG.10)
ms:contentKeyID: 55101617
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 00bc011e28ee36a48ebf8be13dfc1bdbe585740d67b7c3e37ac9432e7305b59e
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119973998"
---
# <a name="esentdirtyshutdownexception-members"></a>EsentDirtyShutdownException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。DirtyShutdown 例外狀況。

[EsentDirtyShutdownException](./esentdirtyshutdownexception-class.md)類型會公開下列成員。
...
<td><a href="dn334456(v=exchg.10).md">EsentDirtyShutdownException</a></td>
<td>初始化 EsentDirtyShutdownException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentDirtyShutdownException 類別](./esentdirtyshutdownexception-class.md)
