...
JET_err 的基類。OutOfDatabaseSpace 例外狀況。
...
<td><a href="dn319770(v=exchg.10).md">EsentOutOfDatabaseSpaceException</a></td>
<td>初始化 EsentOutOfDatabaseSpaceException 類別的新實例。</td>
</tr>
</tbody>
</table>
