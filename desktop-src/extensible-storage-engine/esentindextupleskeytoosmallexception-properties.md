---
description: 深入瞭解： EsentIndexTuplesKeyTooSmallException 屬性
title: EsentIndexTuplesKeyTooSmallException 屬性
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentindextupleskeytoosmallexception_properties(v=EXCHG.10)
