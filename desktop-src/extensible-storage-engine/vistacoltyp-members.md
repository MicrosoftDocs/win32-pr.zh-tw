---
description: 深入瞭解： VistaColtyp 成員
title: " (的 VistaColtyp 成員) 的成員"
...
ms.locfileid: "104194457"
---
# <a name="vistacoltyp-members"></a>VistaColtyp 成員

包含受保護的成員  
包含繼承的成員  

已加入至 Vista 版本 ESENT 的資料行類型。

[VistaColtyp](./vistacoltyp-class.md)類型會公開下列成員。
