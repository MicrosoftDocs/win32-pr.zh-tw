...
ms.locfileid: "118769661"
---
# <a name="esentstateexception-constructor-serializationinfo-streamingcontext"></a>EsentStateException 函式 (SerializationInfo、StreamingCoNtext) 

初始化 EsentStateException 類別的新實例。 這個函式是用來將序列化的例外狀況還原序列化。
