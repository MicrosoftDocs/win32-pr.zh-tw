---
description: 深入瞭解： JET_BKINFO 屬性
title: JET_BKINFO 屬性
...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: c4abdf12aded2f74fe73467a464d0b5dbf13df04
ms.sourcegitcommit: 831e8f3db78ab820e1710cede244553c70e50500
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 01/08/2021
ms.locfileid: "103945467"
---
# <a name="jet_bkinfo-properties"></a>JET_BKINFO 屬性
...
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="hh163405(v=exchg.10).md">601.Hasvalue</a></td>
<td>取得值，指出此備份資訊是否為 null。</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
