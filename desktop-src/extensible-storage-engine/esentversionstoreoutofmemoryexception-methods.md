---
description: 深入瞭解： EsentVersionStoreOutOfMemoryException 方法
title: EsentVersionStoreOutOfMemoryException 方法
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentversionstoreoutofmemoryexception_methods(v=EXCHG.10)
