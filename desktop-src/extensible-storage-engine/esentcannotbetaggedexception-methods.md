---
description: 深入瞭解： EsentCannotBeTaggedException 方法
title: EsentCannotBeTaggedException 方法
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentcannotbetaggedexception_methods(v=EXCHG.10)
