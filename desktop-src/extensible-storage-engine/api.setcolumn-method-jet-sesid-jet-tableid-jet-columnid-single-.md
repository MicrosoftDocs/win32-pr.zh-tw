...
ms.locfileid: "118982918"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-single"></a>SetColumn 方法 (JET_SESID、JET_TABLEID、JET_COLUMNID、單一) 
...
<!-- end list -->
  ...
  - data  
    類型： [system.object](/dotnet/api/system.single)  
