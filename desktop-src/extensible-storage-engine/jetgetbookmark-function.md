...
<td><p>作業已順利完成，但輸出緩衝區太小，無法接收整個書簽。 輸出緩衝區已填滿適當的書簽。 如果要求，也會傳回書簽的實際大小。</p></td>
</tr>
<tr class="odd">
...
<p><strong>WINDOWS XP：  </strong>此傳回值是在 Windows XP 中引進的。</p></td>
</tr>
<tr class="odd">
<td><p>JET_errNoCurrentRecord</p></td>
<td><p>資料指標未放置在記錄上。 此情況具有許多不同的原因。 例如，如果游標位於目前索引的最後一筆記錄之後，就會發生這種情況。</p></td>
</tr>
<tr class="even">
...
書簽通常應該視為不透明的資料區塊。 不應嘗試利用此資料的內部結構。 但是，下列條件適用于所有的 ESENT 書簽：
  ...
  - 在 Windows Vista 之前，書簽一律會小於或等於 JET_cbBookmarkMost (256) 位元組長度。
    
**Windows Vista：** 在 Windows Vista 和更新版本中，書簽可能會大於 JET_cbBookmarkMost (256) 個位元組。 書簽的大小上限等於 JET_paramKeyMost + 1 目前的值。
