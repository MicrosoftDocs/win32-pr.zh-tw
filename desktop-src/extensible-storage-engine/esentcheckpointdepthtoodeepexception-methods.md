---
description: 深入瞭解： EsentCheckpointDepthTooDeepException 方法
title: EsentCheckpointDepthTooDeepException 方法
TOCTitle: EsentCheckpointDepthTooDeepException methods
ms:assetid: Methods.T:Microsoft.Isam.Esent.Interop.EsentCheckpointDepthTooDeepException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentcheckpointdepthtoodeepexception_methods(v=EXCHG.10)
ms:contentKeyID: 55101253
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 2e95d0a4bd873fc524a621da23200c33433df1ea
ms.sourcegitcommit: 831e8f3db78ab820e1710cede244553c70e50500
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 01/08/2021
ms.locfileid: "104553214"
---
# <a name="esentcheckpointdepthtoodeepexception-methods"></a>EsentCheckpointDepthTooDeepException 方法

包含受保護的成員  
包含繼承的成員  

[EsentCheckpointDepthTooDeepException](./esentcheckpointdepthtoodeepexception-class.md)類型會公開下列成員。
...
[EsentCheckpointDepthTooDeepException 類別](./esentcheckpointdepthtoodeepexception-class.md)
