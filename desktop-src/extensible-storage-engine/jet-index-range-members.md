---
description: 深入瞭解： JET_INDEX_RANGE 成員
title: 'JET_INDEX_RANGE (Windows8 的成員) '
...
ms.locfileid: "104571691"
---
# <a name="jet_index_range-members"></a>JET_INDEX_RANGE 成員

包含受保護的成員  
包含繼承的成員  

包含[JetPrereadIndexRanges (JET_SESID、JET_TABLEID、 \[ \] 、int32、int32、int32、 \[ \] 、PrereadIndexRangesGrbit) ](./windows8api.jetprereadindexranges-method.md)的定義。

[JET_INDEX_RANGE](./jet-index-range-class.md)類型會公開下列成員。
...
<td><a href="dn335483(v=exchg.10).md">JET_INDEX_RANGE</a></td>
<td></td>
</tr>
</tbody>
</table>
...
<td>傳回表示目前<a href="dn335481(v=exchg.10).md">JET_INDEX_RANGE</a>的<a href="/dotnet/api/system.string">字串</a>。  (會覆寫 <a href="/dotnet/api/system.object.tostring#System_Object_ToString">物件 ToString () </a>。 ) </td>
</tr>
</tbody>
</table>
