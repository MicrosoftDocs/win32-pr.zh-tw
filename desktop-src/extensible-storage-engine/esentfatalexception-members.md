---
description: 深入瞭解： EsentFatalException 成員
title: EsentFatalException 成員
TOCTitle: EsentFatalException members
ms:assetid: AllMembers.T:Microsoft.Isam.Esent.Interop.EsentFatalException
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentfatalexception_members(v=EXCHG.10)
...
[EsentFatalException](./esentfatalexception-class.md)類型會公開下列成員。
...
<td>初始化 EsentFatalException 類別的新實例。 這個函式是用來將序列化的例外狀況還原序列化。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="受保護的方法" alt="Protected method" /></td>
<td><a href="dn274274(v=exchg.10).md">EsentFatalException (字串 JET_err) </a></td>
<td>初始化 EsentFatalException 類別的新實例。</td>
</tr>
</tbody>
</table>
