...
| <p><strong>Unicode</strong></p> | <p>實作為 <strong>JetCreateTableColumnIndex2W</strong> (Unicode) 和 <strong>JetCreateTableColumnIndex2A</strong> (ANSI) 。</p> | 
