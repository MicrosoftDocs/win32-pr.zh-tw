---
description: 深入瞭解： JET_INDEX_COLUMN 成員
title: 'JET_INDEX_COLUMN (Windows8 的成員) '
...
ms.locfileid: "119401698"
---
# <a name="jet_index_column-members"></a>JET_INDEX_COLUMN 成員

包含受保護的成員  
包含繼承的成員  

包含[JetPrereadIndexRanges (JET_SESID、JET_TABLEID、 \[ \] 、int32、int32、int32、 \[ \] 、PrereadIndexRangesGrbit) ](./windows8api.jetprereadindexranges-method.md)和[JetSetCursorFilter (JET_SESID、JET_TABLEID、 \[ \] 、CursorFilterGrbit) ](./windows8api.jetsetcursorfilter-method.md)的篩選定義。

[JET_INDEX_COLUMN](./jet-index-column-class.md)類型會公開下列成員。
...
<td><a href="dn335353(v=exchg.10).md">JET_INDEX_COLUMN</a></td>
<td></td>
</tr>
</tbody>
</table>
...
<td>取得或設定此資料行比較的選項。</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="dn335479(v=exchg.10).md">pvData</a></td>
<td>取得或設定要用來 comparte 資料行的值。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
...
<td>傳回表示目前<a href="dn335349(v=exchg.10).md">JET_INDEX_COLUMN</a>的<a href="/dotnet/api/system.string">字串</a>。  (會覆寫 <a href="/dotnet/api/system.object.tostring#System_Object_ToString">物件 ToString () </a>。 ) </td>
</tr>
</tbody>
</table>
