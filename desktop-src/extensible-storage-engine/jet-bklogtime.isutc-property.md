---
description: 深入瞭解： JET_BKLOGTIME。IsUtc 屬性
title: JET_BKLOGTIME。IsUtc 屬性
...
ms:contentKeyID: 39510831
ms.date: 07/30/2014
ms.topic: reference
f1_keywords:
- Microsoft.Isam.Esent.Interop.JET_BKLOGTIME.IsUtc
dev_langs:
- CSharp
- JScript
- VB
- other
api_name:
- Microsoft.Isam.Esent.Interop.JET_BKLOGTIME.get_IsUtc
- Microsoft.Isam.Esent.Interop.JET_BKLOGTIME.IsUtc
topic_type:
- apiref
- kbSyntax
...
---
# <a name="jet_bklogtimeisutc-property"></a>JET_BKLOGTIME。IsUtc 屬性

取得值，指出 JET_BKLOGTIME 是否以 UTC 表示。
