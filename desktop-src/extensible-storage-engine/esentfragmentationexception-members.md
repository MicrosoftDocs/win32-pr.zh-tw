---
description: 深入瞭解： EsentFragmentationException 成員
title: EsentFragmentationException 成員
...
ms:mtpsurl: https://msdn.microsoft.com/library/microsoft.isam.esent.interop.esentfragmentationexception_members(v=EXCHG.10)
ms:contentKeyID: 55101728
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 2b70a9e26e5ef41eb19a858923fa3e1649d607ae9ab375a7592481158eaf8264
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119838578"
---
# <a name="esentfragmentationexception-members"></a>EsentFragmentationException 成員
...
[EsentFragmentationException](./esentfragmentationexception-class.md)類型會公開下列成員。
...
<td>初始化 EsentFragmentationException 類別的新實例。 這個函式是用來將序列化的例外狀況還原序列化。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="受保護的方法" alt="Protected method" /></td>
<td><a href="dn350469(v=exchg.10).md">EsentFragmentationException (字串 JET_err) </a></td>
<td>初始化 EsentFragmentationException 類別的新實例。</td>
</tr>
</tbody>
</table>
