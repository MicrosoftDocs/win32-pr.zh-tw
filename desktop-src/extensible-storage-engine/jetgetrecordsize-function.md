...
- ESENT.DLL
ROBOTS: INDEX,FOLLOW
ms.openlocfilehash: 8033209cedb39e398200c64b49e0eba85fb5ece3853e48ac32519170a28cda7b
ms.sourcegitcommit: e6600f550f79bddfe58bd4696ac50dd52cb03d7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119849888"
---
...
<td><p>當指定這個位時，在填滿內容之前， <a href="gg294072(v=exchg.10).md">JET_RECSIZE</a> 不會歸零，可有效地做為已造訪或已更新之多筆記錄的統計資料累積。</p></td>
</tr>
<tr class="odd">
...
<td><p>其中一個要求的選項無效或未執行。 當指定了不合法的<em>grbit</em>時， <strong>JetGetRecordSize</strong>函數會傳回這個錯誤。</p></td>
</tr>
<tr class="odd">
...
<p><strong>Windows XP：</strong> 只有 Windows XP 和更新版本才會傳回 JET_errInstanceUnavailable。</p></td>
</tr>
<tr class="even">
