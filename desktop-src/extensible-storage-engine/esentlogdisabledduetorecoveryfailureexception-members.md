...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 7752000950c0391975bcd3d6da61d7db95639937199664f86c2b82555818b0ad
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119115788"
---
# <a name="esentlogdisabledduetorecoveryfailureexception-members"></a>EsentLogDisabledDueToRecoveryFailureException 成員

包含受保護的成員  
包含繼承的成員  

JET_err 的基類。LogDisabledDueToRecoveryFailure 例外狀況。

[EsentLogDisabledDueToRecoveryFailureException](./esentlogdisabledduetorecoveryfailureexception-class.md)類型會公開下列成員。
...
<td><a href="dn334590(v=exchg.10).md">EsentLogDisabledDueToRecoveryFailureException</a></td>
<td>初始化 EsentLogDisabledDueToRecoveryFailureException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentLogDisabledDueToRecoveryFailureException 類別](./esentlogdisabledduetorecoveryfailureexception-class.md)
