...
<td></td>
<td>UniqueKey</td>
<td>搜尋非唯一索引時產生了唯一索引鍵</td>
</tr>
<tr class="even">
<td></td>
<td>SeparateLongValue</td>
<td>資料行是分隔的 long 值</td>
</tr>
<tr class="odd">
<td></td>
...
<td>指定用於還原的 TargetInstance 正在執行</td>
</tr>
<tr class="odd">
<td></td>
<td>CommittedLogFilesLost</td>
<td>未復原一或多個已認可至此資料庫的記錄。 資料庫仍保持乾淨/一致，如同遺失記錄的交易是延遲的 (，並遺失) 。</td>
</tr>
<tr class="even">
<td></td>
<td>CommittedLogFilesRemoved</td>
<td>已認可至此資料庫的一或多個記錄未復原。 資料庫仍保持乾淨/一致，因為損毀的記錄檔交易是以延遲的方式認可 (而且) 遺失。</td>
</tr>
<tr class="odd">
<td></td>
<td>FinishWithUndo</td>
<td>用戶端用來指出 JetInit () 已完成復原的信號</td>
</tr>
<tr class="even">
<td></td>
...
<td></td>
<td>ColumnSetNull</td>
<td>將資料行設定為 Null 值</td>
</tr>
<tr class="even">
<td></td>
<td>ShrinkNotPossible</td>
<td>無法壓縮資料庫檔案，因為沒有足夠的內部可用空間，或有無法移動的資料存在。</td>
</tr>
<tr class="odd">
<td></td>
<td>DTCCommitTransaction</td>
<td>如果要認可指定的交易，則會傳回警告程式碼 DTC 回呼</td>
</tr>
<tr class="even">
<td></td>
<td>DTCRollbackTransaction</td>
<td>如果要復原指定的交易，則會傳回警告程式碼 DTC 回呼</td>
</tr>
<tr class="odd">
<td></td>
<td>TableEmpty</td>
...
<td>使用不相容的作業系統排序版本建立主要索引。 不能安全地修改資料表。</td>
</tr>
<tr class="odd">
<td></td>
<td>SecondaryIndexOutOfDate</td>
<td>一或多個次要索引是使用不相容的 OS 排序版本所建立。 任何 Unicode 文字的索引都應該刪除。</td>
</tr>
<tr class="even">
<td></td>
...
<td></td>
<td>CopyLongValue</td>
<td>單一實例資料行 bursted</td>
</tr>
<tr class="even">
<td></td>
<td>TaggedColumnsRemaining</td>
<td>RetrieveTaggedColumnList 在取出所有標記的資料行之前，已用完複製緩衝區</td>
</tr>
<tr class="odd">
<td></td>
<td>ColumnSkipped</td>
<td>因為對應的資料行識別碼或針對列舉要求的 itagSequence 為 null，所以不會傳回資料行值 (s) </td>
</tr>
<tr class="even">
<td></td>
<td>ColumnNotLocal</td>
<td>不會傳回資料行值 (s) ，因為它們無法從手邊的資料重建</td>
</tr>
<tr class="odd">
<td></td>
...
<td>由於 JET_bitEnumerateCompressOutput，JET_COLUMNENUM 傳回的資料行值</td>
</tr>
<tr class="odd">
<td></td>
<td>ColumnDefault</td>
<td>) 不會傳回資料行值 (s，因為它們已設定為預設值 (s) 和指定 JET_bitEnumerateIgnoreDefault</td>
</tr>
<tr class="even">
<td></td>
<td>ColumnNotInRecord</td>
<td>因為無法從記錄中的資料重建資料行值 (s) 不會傳回</td>
</tr>
<tr class="odd">
<td></td>
...
<td>已在指定的資料庫上執行線上磁碟重組</td>
</tr>
<tr class="even">
<td></td>
<td>DefragNotRunning</td>
<td>未在指定的資料庫上執行線上磁碟重組</td>
</tr>
<tr class="odd">
<td></td>
<td>DatabaseScanAlreadyRunning</td>
<td>JetDatabaseScan 已在指定的資料庫上執行</td>
</tr>
<tr class="even">
<td></td>
<td>DatabaseScanNotRunning</td>
<td>JetDatabaseScan 未在指定的資料庫上執行</td>
</tr>
<tr class="odd">
<td></td>
...
<td>提供的記錄資料突然跳到下一個記錄，我們已將不完整的記錄檔刪除為預防措施</td>
</tr>
</tbody>
</table>
