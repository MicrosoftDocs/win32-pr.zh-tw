...
---
# <a name="vistagrbitsindexdisallowtruncation-field"></a>VistaGrbits. IndexDisallowTruncation 欄位

指定此旗標將會導致索引的任何更新會導致截斷的金鑰因 [KeyTruncated](./jet-err-enumeration.md)而失敗。 否則，將會以無訊息方式截斷金鑰。
