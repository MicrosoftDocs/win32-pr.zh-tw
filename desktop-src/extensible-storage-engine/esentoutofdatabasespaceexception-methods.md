...
---
# <a name="esentoutofdatabasespaceexception-methods"></a>EsentOutOfDatabaseSpaceException 方法

包含受保護的成員  
包含繼承的成員  

[EsentOutOfDatabaseSpaceException](./esentoutofdatabasespaceexception-class.md)類型會公開下列成員。
...
[EsentOutOfDatabaseSpaceException 類別](./esentoutofdatabasespaceexception-class.md)
