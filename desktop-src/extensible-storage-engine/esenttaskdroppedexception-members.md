...
---
# <a name="esenttaskdroppedexception-members"></a>EsentTaskDroppedException 成員
...
[EsentTaskDroppedException](./esenttaskdroppedexception-class.md)類型會公開下列成員。
...
<td><a href="dn334967(v=exchg.10).md">EsentTaskDroppedException</a></td>
<td>初始化 EsentTaskDroppedException 類別的新實例。</td>
</tr>
</tbody>
</table>
...
[EsentTaskDroppedException 類別](./esenttaskdroppedexception-class.md)
