...
ms.date: 07/30/2014
ms.topic: article
ms.openlocfilehash: 87d89ac71181be6a48c0f06a729461d04ec5467b18d1f154f905bed8640ef300
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "118493626"
---
# <a name="esentoperationexception-members"></a>EsentOperationException 成員
...
[EsentOperationException](./esentoperationexception-class.md)類型會公開下列成員。
...
<td>初始化 EsentOperationException 類別的新實例。 這個函式是用來將序列化的例外狀況還原序列化。</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="受保護的方法" alt="Protected method" /></td>
<td><a href="dn319686(v=exchg.10).md">EsentOperationException (字串 JET_err) </a></td>
<td>初始化 EsentOperationException 類別的新實例。</td>
</tr>
</tbody>
</table>
