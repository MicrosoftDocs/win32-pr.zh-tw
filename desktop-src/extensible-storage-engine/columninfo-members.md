---
description: 深入瞭解： ColumnInfo 成員
title: ColumnInfo 成員
...
ms.locfileid: "104551665"
---
# <a name="columninfo-members"></a>ColumnInfo 成員

包含受保護的成員  
包含繼承的成員  

一個 Esent 資料行的相關資訊。 這不是 interop 類別，而是由中繼資料 helper 方法所使用。

[ColumnInfo](./columninfo-class.md)類型會公開下列成員。
...
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="dn334141(v=exchg.10).md">MaxLength</a></td>
<td>取得資料行的最大長度。</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="公用屬性" alt="Public property" /></td>
<td><a href="dn334188(v=exchg.10).md">名稱</a></td>
<td>取得資料行的名稱。</td>
</tr>
</tbody>
</table>
...
<td>傳回表示目前<a href="dn334128(v=exchg.10).md">ColumnInfo</a>的<a href="/dotnet/api/system.string">字串</a>。  (會覆寫 <a href="/dotnet/api/system.object.tostring#System_Object_ToString">物件 ToString () </a>。 ) </td>
</tr>
</tbody>
</table>
