...
---
# <a name="desktop-app-technologies"></a><span data-ttu-id="45bf2-103">桌面應用程式技術</span><span class="sxs-lookup"><span data-stu-id="45bf2-103">Desktop app technologies</span></span>

<span data-ttu-id="45bf2-104">本節提供有關 Windows 功能的深入指引和程式碼範例，這些功能可供桌面應用程式使用 WIN32 API 使用。</span><span class="sxs-lookup"><span data-stu-id="45bf2-104">This section provides in-depth guidance and code examples about Windows features that are available to desktop applications by using the Win32 API.</span></span>

## <a name="in-this-section"></a><span data-ttu-id="45bf2-105">本節內容</span><span class="sxs-lookup"><span data-stu-id="45bf2-105">In this section</span></span>

| <span data-ttu-id="45bf2-106">主題</span><span class="sxs-lookup"><span data-stu-id="45bf2-106">Topic</span></span> | <span data-ttu-id="45bf2-107">描述</span><span class="sxs-lookup"><span data-stu-id="45bf2-107">Description</span></span>  |  
|----------------------------------|---|
| [<span data-ttu-id="45bf2-108">協助工具</span><span class="sxs-lookup"><span data-stu-id="45bf2-108">Accessibility</span></span>](accessibility/accessibility.md) | <span data-ttu-id="45bf2-109">提供適用于設計可存取應用程式的 Windows 開發人員、輔助技術開發人員（例如螢幕閱讀程式和放大鏡），以及建立自動化腳本來測試 Windows 應用程式的軟體測試工程師的指引。</span><span class="sxs-lookup"><span data-stu-id="45bf2-109">Provides guidance for Windows developers designing accessible applications, assistive technology developers building tools such as screen readers and magnifiers, and software test engineers creating automated scripts for testing Windows applications.</span></span> |
| [<span data-ttu-id="45bf2-110">傳統型使用者介面</span><span class="sxs-lookup"><span data-stu-id="45bf2-110">Desktop user interface</span></span>](windows-application-ui-development.md) | <span data-ttu-id="45bf2-111">提供可讓您為應用程式開發圖形使用者介面的資訊，包括 windows 和訊息、資源和控制項等功能。</span><span class="sxs-lookup"><span data-stu-id="45bf2-111">Provides information that enables you to develop graphical user interfaces for your apps, including features such as windows and messages, resources, and controls.</span></span> |
| [<span data-ttu-id="45bf2-112">桌面環境</span><span class="sxs-lookup"><span data-stu-id="45bf2-112">Desktop environment</span></span>](user-interface.md) | <span data-ttu-id="45bf2-113">提供整合和延伸桌面使用者面向功能的指引，包括工作列、桌面及檔案總管。</span><span class="sxs-lookup"><span data-stu-id="45bf2-113">Provides guidance for integrating and extending the desktop user-facing features of Windows, including the Taskbar, the desktop, and File Explorer.</span></span> |
| [<span data-ttu-id="45bf2-114">應用程式安裝和維護</span><span class="sxs-lookup"><span data-stu-id="45bf2-114">Application installation and servicing</span></span>](application-installing-and-servicing.md) | <span data-ttu-id="45bf2-115">提供有關使用 Windows 所提供的 Api 和服務來安裝、管理和服務您的桌面應用程式的資訊。</span><span class="sxs-lookup"><span data-stu-id="45bf2-115">Provides information about using APIs and services provided by Windows to install, manage, and service your desktop apps.</span></span> |
| [<span data-ttu-id="45bf2-116">音訊與視訊</span><span class="sxs-lookup"><span data-stu-id="45bf2-116">Audio and video</span></span>](audio-and-video.md) | <span data-ttu-id="45bf2-117">提供使用 Windows 所提供之音訊和影片功能的相關指引。</span><span class="sxs-lookup"><span data-stu-id="45bf2-117">Provides guidance about using audio and video features provided by Windows.</span></span> |
| [<span data-ttu-id="45bf2-118">資料存取與儲存</span><span class="sxs-lookup"><span data-stu-id="45bf2-118">Data access and storage</span></span>](data-access-and-storage.md) | <span data-ttu-id="45bf2-119">提供您可以在桌面應用程式中使用的資料存取和儲存功能的相關資訊，包括檔案系統管理和雲端同步引擎。</span><span class="sxs-lookup"><span data-stu-id="45bf2-119">Provides information about data access and storage features you can use in your desktop applications, including file system management and cloud sync engines.</span></span>  |
| [<span data-ttu-id="45bf2-120">裝置</span><span class="sxs-lookup"><span data-stu-id="45bf2-120">Devices</span></span>](devices.md) | <span data-ttu-id="45bf2-121">說明與裝置和感應器互動的 Api。</span><span class="sxs-lookup"><span data-stu-id="45bf2-121">Describes APIs for interacting with devices and sensors.</span></span> |
| [<span data-ttu-id="45bf2-122">診斷</span><span class="sxs-lookup"><span data-stu-id="45bf2-122">Diagnostics</span></span>](diagnostics.md) | <span data-ttu-id="45bf2-123">提供有關偵錯工具和錯誤處理、效能分析、網路監視和其他診斷功能的指引。</span><span class="sxs-lookup"><span data-stu-id="45bf2-123">Provides guidance about debugging and error handling, performance profiling, network monitoring, and other diagnostics features.</span></span> |
| [<span data-ttu-id="45bf2-124">檔和列印</span><span class="sxs-lookup"><span data-stu-id="45bf2-124">Documents and printing</span></span>](printdocs/documents-and-printing.md) | <span data-ttu-id="45bf2-125">說明 Windows 的檔和列印功能，可讓應用程式儲存、查看和列印。</span><span class="sxs-lookup"><span data-stu-id="45bf2-125">Describes the documents and printing features of Windows that enable applications to save, view, and print.</span></span>  |
| [<span data-ttu-id="45bf2-126">圖形和遊戲</span><span class="sxs-lookup"><span data-stu-id="45bf2-126">Graphics and gaming</span></span>](graphics-and-multimedia.md) | <span data-ttu-id="45bf2-127">提供 Windows 圖形和遊戲功能的相關資訊，包括 DirectX 和數位影像處理。</span><span class="sxs-lookup"><span data-stu-id="45bf2-127">Provides information about graphics and gaming features of Windows, including DirectX and digital imaging.</span></span>  |
| [<span data-ttu-id="45bf2-128">網路功能和網際網路</span><span class="sxs-lookup"><span data-stu-id="45bf2-128">Networking and Internet</span></span>](networking.md) | <span data-ttu-id="45bf2-129">提供有關 Windows 網路和網際網路相關功能的指引，包括網路管理、HTTP Api 和遠端程序呼叫， (RPC) 。</span><span class="sxs-lookup"><span data-stu-id="45bf2-129">Provides guidance about the networking and Internet-related features of Windows, including network management, HTTP APIs, and Remote Procedure Call (RPC).</span></span> |
| [<span data-ttu-id="45bf2-130">安全性與身分識別</span><span class="sxs-lookup"><span data-stu-id="45bf2-130">Security and identity</span></span>](security.md) | <span data-ttu-id="45bf2-131">提供有關 Windows 驗證、授權、加密和其他安全性功能的資訊。</span><span class="sxs-lookup"><span data-stu-id="45bf2-131">Provides information about authentication, authorization, cryptography, and other security features of Windows.</span></span> |
| [<span data-ttu-id="45bf2-132">系統服務</span><span class="sxs-lookup"><span data-stu-id="45bf2-132">System services</span></span>](system-services.md) | <span data-ttu-id="45bf2-133">提供基本作業系統功能的相關指引，例如進程和執行緒、服務、動態連結程式庫、COM、登錄等等。</span><span class="sxs-lookup"><span data-stu-id="45bf2-133">Provides guidance about fundamental OS features such as process and threads, services, dynamic-link libraries, COM, the registry, and more.</span></span> |
