...
當您搜尋時，其他篩選器可能會變成可用，例如 **Windows 安全性**、 **Windows 圖形和多媒體**，或是 **Windows 訊息中心和協同** 作業。
...
-   在 [ **目前** 的調整] 清單中，按一下您要移除之搜尋篩選準則後面的 **(x)** 。 例如，若要從 **目前** 的調整中移除 **檔 &** 發行項，請按一下下列 **檔 & 文章** 中的 **(x)** 。 您也可以按一下 [ **全部移除** ]，從 MSDN 搜尋移除所有篩選。

## <a name="suggested-keywords"></a>建議的關鍵字

以下是搜尋安全性 SDK 內容時所使用的一些常用關鍵字：
