...
ms.locfileid: "118744610"
---
# <a name="mobile-broadband-profile-schema-v1"></a>Mobile 寬頻設定檔架構 v1

Windows 的7Mobile 寬頻設定檔架構 v1 可在命名空間中取得 `https://www.microsoft.com/networking/WWAN/profile/v1` 。

-   [Mobile 寬頻設定檔架構 v1 元素](schema-elements.md)
-   [Mobile 寬頻設定檔架構 v1 簡單類型](schema-simple-types.md)
-   [Mobile 寬頻設定檔架構 v1 複雜類型](schema-complex-types.md)
