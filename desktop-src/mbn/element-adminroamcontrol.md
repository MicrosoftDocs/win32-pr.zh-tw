...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 46a6e1c5faee1c74001134669ae269f7ecefa263
ms.sourcegitcommit: 9b5faa61c38b2d0c432b7f2dbee8c127b0e28a7e
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/19/2021
ms.locfileid: "122475154"
---
...
指定設定檔是否為系統管理漫遊控制。 此元素是 v4 的新專案。 這個元素的值是 [**roamControlType**](simpletype-roamcontroltype.md) 值。 這是選擇性元素;如果未指定任何值，則 **AllRoamAllowed** 為預設值。
