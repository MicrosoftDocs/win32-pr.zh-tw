...
**Mci \_ VCR \_ 播放 \_ PARMS** 結構包含適用于 video/卡帶燒錄機之 [**mci \_ play**](mci-play.md)命令的參數。
...
影響 [**MCI \_ 播放**](mci-play.md) 或 [**MCI \_ 提示**](mci-cue.md) 命令的時間值。 在 [**MCI \_ 播放**](mci-play-parms.md)中，這是開始播放的時間。 對於 **MCI \_ 提示**，這是 Cued 裝置到達 **dwFrom** 中指定位置的時間。
