...
---
# <a name="preparing-to-draw-data"></a><span data-ttu-id="f65ce-107">準備繪製資料</span><span class="sxs-lookup"><span data-stu-id="f65ce-107">Preparing to Draw Data</span></span>

<span data-ttu-id="f65ce-108">下列範例會顯示指示解壓縮程式繪製全螢幕的初始化順序。</span><span class="sxs-lookup"><span data-stu-id="f65ce-108">The following example shows the initialization sequence that instructs the decompressor to draw full-screen.</span></span> <span data-ttu-id="f65ce-109">它會使用 [**ICDrawBegin**](/windows/desktop/api/Vfw/nf-vfw-icdrawbegin) 和 [**ICDrawEnd**](/windows/desktop/api/Vfw/nf-vfw-icdrawend) 宏。</span><span class="sxs-lookup"><span data-stu-id="f65ce-109">It uses the [**ICDrawBegin**](/windows/desktop/api/Vfw/nf-vfw-icdrawbegin) and [**ICDrawEnd**](/windows/desktop/api/Vfw/nf-vfw-icdrawend) macros.</span></span>
