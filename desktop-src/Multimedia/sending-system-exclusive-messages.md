...
MIDI 系統專屬訊息是唯一不符合單一雙全半值的 MIDI 訊息。 系統專屬訊息可以是任何長度。 Windows 提供 [**midiOutLongMsg**](/windows/win32/api/mmeapi/nf-mmeapi-midioutlongmsg) 函式，可將系統專屬訊息傳送至 MIDI 輸出裝置。 若要指定 MIDI 系統專屬資料區塊，請使用 [**MIDIHDR**](/windows/win32/api/mmeapi/ns-mmeapi-midihdr) 結構。
