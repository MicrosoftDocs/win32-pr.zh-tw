...
ms.topic: article
ms.date: 05/31/2018
ms.openlocfilehash: 74977fbc5d1bd426c220a28ffbb85aede53d700fd2a891ec128e38d43b82368f
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "117988269"
---
...
因為您的應用程式不需要繪製解壓縮的資料，所以不需要特定的輸出格式。 但是，它必須確保轉譯器可以使用輸入格式來繪製，方法是使用 [**ICM \_ 繪製 \_ 查詢**](icm-draw-query.md)訊息 (或使用 [**ICDrawQuery**](/windows/desktop/api/Vfw/nf-vfw-icdrawquery)宏) 。 此訊息無法判斷轉譯器是否可以繪製點陣圖。 如果您的應用程式必須判斷轉譯器是否可以繪製點陣圖，請使用此訊息搭配 [**ICDrawBegin**](/windows/desktop/api/Vfw/nf-vfw-icdrawbegin) 函數。
...
您可以傳送 [**ICM \_ draw \_ GETTIME**](icm-draw-gettime.md) message (或使用 [**ICDrawGetTime**](/windows/desktop/api/Vfw/nf-vfw-icdrawgettime)宏) 來監視轉譯器的時鐘，也可以設定轉譯器的時鐘，以藉由傳送 [**ICM \_ draw \_ SETTIME**](icm-draw-settime.md)訊息 (或使用 [**ICDrawSetTime**](/windows/desktop/api/Vfw/nf-vfw-icdrawsettime)宏) 來繪製資料。
