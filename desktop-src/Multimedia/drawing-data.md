...
---
# <a name="drawing-data"></a><span data-ttu-id="5c0cf-110">繪製資料</span><span class="sxs-lookup"><span data-stu-id="5c0cf-110">Drawing Data</span></span>

<span data-ttu-id="5c0cf-111">下列範例會使用 [**ICDraw**](/windows/desktop/api/Vfw/nf-vfw-icdraw) 函式和 [**ICDrawStart**](/windows/desktop/api/Vfw/nf-vfw-icdrawstart)、 [**ICDrawStop**](/windows/desktop/api/Vfw/nf-vfw-icdrawstop)、 [**ICDrawFlush**](/windows/desktop/api/Vfw/nf-vfw-icdrawflush)和 [**ICDrawEnd**](/windows/desktop/api/Vfw/nf-vfw-icdrawend) 宏來繪製螢幕上的資料。</span><span class="sxs-lookup"><span data-stu-id="5c0cf-111">The following example uses the [**ICDraw**](/windows/desktop/api/Vfw/nf-vfw-icdraw) function and the [**ICDrawStart**](/windows/desktop/api/Vfw/nf-vfw-icdrawstart), [**ICDrawStop**](/windows/desktop/api/Vfw/nf-vfw-icdrawstop), [**ICDrawFlush**](/windows/desktop/api/Vfw/nf-vfw-icdrawflush), and [**ICDrawEnd**](/windows/desktop/api/Vfw/nf-vfw-icdrawend) macros to draw data on the screen.</span></span>
