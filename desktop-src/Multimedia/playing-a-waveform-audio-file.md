...
ms.locfileid: "118372649"
---
# <a name="playing-a-waveform-audio-file"></a>播放 Waveform-Audio 檔案

下列範例會開啟波形音訊裝置，並使用 [**mciSendCommand**](/previous-versions//dd757160(v=vs.85))函式播放 *lpszWAVEFileName* 參數所指定的波形音訊檔案。
