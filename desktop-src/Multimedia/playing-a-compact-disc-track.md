...
---
# <a name="playing-a-compact-disc-track"></a><span data-ttu-id="0af41-104">播放光碟軌</span><span class="sxs-lookup"><span data-stu-id="0af41-104">Playing a Compact Disc Track</span></span>

<span data-ttu-id="0af41-105">下列範例會開啟 CD 音訊裝置、播放 *bTrack* 參數所指定的播放軌，並在播放完成之後關閉裝置。</span><span class="sxs-lookup"><span data-stu-id="0af41-105">The following example opens a CD audio device, plays the track specified by the *bTrack* parameter, and closes the device after playback is complete.</span></span> <span data-ttu-id="0af41-106">它會使用 [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) 函數。</span><span class="sxs-lookup"><span data-stu-id="0af41-106">It uses the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
...
<span data-ttu-id="0af41-107">若要指定相對於光碟片播放軌的位置，您必須使用曲目/分鐘/秒/框架 (TMSF) 時間格式。</span><span class="sxs-lookup"><span data-stu-id="0af41-107">To specify a position relative to a track on a compact disc, you must use the track/minute/second/frame (TMSF) time format.</span></span>
