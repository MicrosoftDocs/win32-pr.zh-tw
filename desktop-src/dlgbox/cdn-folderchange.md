...
ms.locfileid: "118786138"
---
# <a name="cdn_folderchange-notification-code"></a>CDN \_FOLDERCHANGE 通知碼

\[從 Windows Vista 開始，[[一般專案] 對話方塊](../shell/common-file-dialog.md)已取代 [**開啟**] 和 [**另存** 新檔] 對話方塊。 我們建議您從通用對話方塊程式庫使用通用專案對話方塊 API，而不是這些對話方塊。\]

開啟新資料夾時，由 Explorer 樣式的 [ **開啟** ] 或 [ **另存** 新檔] 對話方塊傳送。
...
[**OFNOTIFY**](/windows/desktop/api/Commdlg/ns-commdlg-ofnotifya)結構的指標。 **OFNOTIFY** 結構包含 [**NMHDR**](/windows/win32/api/richedit/ns-richedit-nmhdr)結構，其程式 **代碼** 成員指出 **CDN 的 \_ FOLDERCHANGE** 通知訊息。
...
若要取得新開啟之資料夾的路徑，攔截程式可以將 [**CDM \_ GETFOLDERPATH**](cdm-getfolderpath.md) 訊息傳送至對話方塊。
