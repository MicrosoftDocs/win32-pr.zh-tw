...
ms.locfileid: "119787358"
---
# <a name="wm_psd_yafullpagerect-message"></a>WM \_ PSD \_ YAFULLPAGERECT 訊息

通知 [*PagePaintHook*](/windows/win32/api/commdlg/nc-commdlg-lppagepainthook)**頁面設定** 對話方塊的攔截程式，此對話方塊即將繪製信封範例頁面的傳回位址部分。
...
如果攔截程式傳回 **TRUE**，對話方塊就不會繪製信封範例頁面的傳回位址部分。

如果攔截程式傳回 **FALSE**，則對話方塊會繪製信封範例頁面的傳回位址部分。

如果紙張類型不是信封，則傳回值沒有任何作用。
