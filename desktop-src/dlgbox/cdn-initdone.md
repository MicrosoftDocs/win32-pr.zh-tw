...
---
# <a name="cdn_initdone-notification-code"></a>CDN \_ INITDONE 通知碼
...
[**OFNOTIFY**](/windows/desktop/api/Commdlg/ns-commdlg-ofnotifya)結構的指標。 **OFNOTIFY** 結構包含 [**NMHDR**](/windows/win32/api/richedit/ns-richedit-nmhdr)結構，其程式 **代碼** 成員會指出 **CDN \_ INITDONE** 通知訊息。
