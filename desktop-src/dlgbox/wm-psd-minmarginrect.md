...
ms.locfileid: "118503313"
---
# <a name="wm_psd_minmarginrect-message"></a>WM \_ PSD \_ MINMARGINRECT 訊息

通知範例頁面中邊界矩形座標的 [*PagePaintHook*](/windows/win32/api/commdlg/nc-commdlg-lppagepainthook) 勾點程式。 當 [版面 **設定** ] 對話方塊即將繪製範例頁面的內容時，就會傳送此訊息。
...
[**矩形**](/previous-versions//dd162897(v=vs.85))結構的指標，其中包含最小邊界矩形的座標（以圖元為單位）。
