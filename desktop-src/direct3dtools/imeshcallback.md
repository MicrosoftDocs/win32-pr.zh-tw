---
description: 回呼，以傳回包含管線階段網格的緩衝區。
MS-HAID: vspixengine.IMeshCallback
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: IMeshCallback 介面
ms.topic: reference
ms.date: 05/31/2018
...
**IMeshCallback** 介面繼承自 [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown)介面。 **IMeshCallback** 也有下列類型的成員：
