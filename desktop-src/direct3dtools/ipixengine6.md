---
description: IPixEngine5 介面的延伸模組，包含用於判斷遠端引擎版本的新增專案。
MS-HAID: vspixengine.IPixEngine6
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: IPixEngine6 介面
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "104109312"
---
# <a name="span-idvspixengineipixengine6spanipixengine6-interface"></a><span id="vspixengine.ipixengine6"></span>IPixEngine6 介面

IPixEngine5 介面的延伸模組，包含用於判斷遠端引擎版本的新增專案。

## <a name="members"></a>成員

**IPixEngine6** 介面繼承自 [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown)介面。 **IPixEngine6** 也有下列類型的成員：
