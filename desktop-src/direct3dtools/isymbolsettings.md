---
description: 將符號伺服器資訊傳遞給桌上型電腦捕獲引擎。
MS-HAID: vspixengine.ISymbolSettings
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: ISymbolSettings 介面
ms.topic: reference
ms.date: 05/31/2018
...
將符號伺服器資訊傳遞給桌上型電腦捕獲引擎。

## <a name="members"></a>成員

**ISymbolSettings** 介面繼承自 [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown)介面。 **ISymbolSettings** 也有下列類型的成員：
