---
description: 回呼，以 XML 格式傳回物件的內容。
MS-HAID: vspixengine.IGenericBufferDataCallback
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: IGenericBufferDataCallback 介面
ms.topic: reference
ms.date: 05/31/2018
...
**IGenericBufferDataCallback** 介面繼承自 [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown)介面。 **IGenericBufferDataCallback** 也有下列類型的成員：
