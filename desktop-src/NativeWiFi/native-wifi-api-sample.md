...
原生 Wifi 範例可以在 Windows Vista 和更新版本上編譯及執行，Windows XP Service pack 3 (SP3) ，以及 Windows xp service pack 2 (SP2) 的無線區域網路 API。 Windows XP SP3 和適用于 Windows XP SP2 的無線區域網路 API 不支援範例的部分功能。 如需 Windows XP （含 SP3）和 Windows XP SP2 的無線區域網路 api 所支援的功能清單，請參閱[Windows XP 上的原生 Wifi api 支援](about-wireless-lan-api-for-windows-xp-service-pack-2.md)。
...
-   取得介面的功能。 請參閱 [**WlanGetInterfaceCapability**](/windows/desktop/api/wlanapi/nf-wlanapi-wlangetinterfacecapability)。
    ...
    * * Windows XP 搭配 SP3 和適用于 Windows XP SP2 的無線區域網路 API： * * 這項功能不受支援。
...
-   連線與無線網路的連線或中斷連線。 請參閱 [**WlanConnect**](/windows/desktop/api/wlanapi/nf-wlanapi-wlanconnect) 和 [**WlanDisconnect**](/windows/desktop/api/wlanapi/nf-wlanapi-wlandisconnect)。
...
[WindowsVista 無線 SDK 論壇](https://social.msdn.microsoft.com/Forums/b6bbd8f0-a921-480f-9b4b-845336462bc0/welcome-to-the-windows-vista-wireless-sdk-forum)
</dt> <dt>
