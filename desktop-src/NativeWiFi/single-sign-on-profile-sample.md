...
此範例設定為使用在企業模式下執行的 Wi-Fi Protected Access 2 安全性 (WPA2-Enterprise) 。 受保護的可延伸驗證通訊協定，使用 Microsoft 挑戰交握驗證通訊協定第2版 (PEAP Eap-mschapv2) 用於網路驗證。 Windows 登入認證是用來 PEAP-MSCHAPv2 驗證。
