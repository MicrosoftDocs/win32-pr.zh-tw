...
ms.locfileid: "120072468"
---
# <a name="june-monthstype-element"></a>六月 (monthsType) 元素
...
**六月** 元素是由 [**monthsType**](taskschedulerschema-monthstype-complextype.md)複雜型別定義。
