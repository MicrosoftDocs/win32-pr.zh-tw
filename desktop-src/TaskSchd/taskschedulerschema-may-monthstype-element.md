...
ms.locfileid: "119905608"
---
# <a name="may-monthstype-element"></a>可 (monthsType) 元素
...
**可能** 元素是由 [**monthsType**](taskschedulerschema-monthstype-complextype.md)複雜型別定義。
