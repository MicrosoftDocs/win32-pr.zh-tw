---
title: 工作排程器架構
description: 工作排程器架構會定義用來向工作排程器服務註冊工作的有效 XML。 開發人員可以建立自己的 XML、針對此架構進行驗證，以及使用 ITaskFolder RegisterTask 方法來註冊工作。
ms.assetid: 9b1b8e34-c635-413a-a230-79a58017cf21
keywords:
- 工作排程器工作排程器、參考、XML 架構
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
---
# <a name="task-scheduler-schema"></a><span data-ttu-id="66115-105">工作排程器架構</span><span class="sxs-lookup"><span data-stu-id="66115-105">Task Scheduler Schema</span></span>

<span data-ttu-id="66115-106">工作排程器架構會定義用來向工作排程器服務註冊工作的有效 XML。</span><span class="sxs-lookup"><span data-stu-id="66115-106">The Task Scheduler schema defines valid XML used to register tasks with the Task Scheduler service.</span></span> <span data-ttu-id="66115-107">開發人員可以建立自己的 XML、針對此架構進行驗證，以及使用 [**ITaskFolder：： RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) 方法註冊工作。</span><span class="sxs-lookup"><span data-stu-id="66115-107">Developers can create their own XML, validate it against this schema, and register tasks using the [**ITaskFolder::RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) method.</span></span>

<span data-ttu-id="66115-108">工作排程器架構的類型和元素會個別記載于下列各節中。</span><span class="sxs-lookup"><span data-stu-id="66115-108">The types and elements of the Task Scheduler schema are individually documented in the following sections.</span></span>

-   [<span data-ttu-id="66115-109">工作排程器架構元素</span><span class="sxs-lookup"><span data-stu-id="66115-109">Task Scheduler Schema Elements</span></span>](task-scheduler-schema-elements.md)
-   [<span data-ttu-id="66115-110">工作排程器架構簡單類型</span><span class="sxs-lookup"><span data-stu-id="66115-110">Task Scheduler Schema Simple Types</span></span>](task-scheduler-schema-simple-types.md)
-   [<span data-ttu-id="66115-111">工作排程器架構複雜類型</span><span class="sxs-lookup"><span data-stu-id="66115-111">Task Scheduler Schema Complex Types</span></span>](task-scheduler-schema-complex-types.md)
-   [<span data-ttu-id="66115-112">工作排程器架構群組</span><span class="sxs-lookup"><span data-stu-id="66115-112">Task Scheduler Schema Groups</span></span>](task-scheduler-schema-groups.md)

<span data-ttu-id="66115-113">整個工作排程器架構都是由下列 XSD 檔案所定義。</span><span class="sxs-lookup"><span data-stu-id="66115-113">The entire Task Scheduler schema is defined by the following XSD file.</span></span>
