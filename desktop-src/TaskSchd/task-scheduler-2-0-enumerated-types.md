...
---
# <a name="task-scheduler-20-enumerated-types"></a>工作排程器2.0 列舉類型

描述列舉型別，這些列舉型別會定義工作排程器 2.0 Api 所使用的常數。
...
| [**TASK \_ PROCESSTOKENSID \_ 類型**](/windows/win32/api/taskschd/ne-taskschd-task_processtokensid_type)             | 定義工作可使用的進程 SID 類型。                                                      |
