...
---
# <a name="listing-profiles-policies-and-clients"></a><span data-ttu-id="d8255-103">列出設定檔、原則和用戶端</span><span class="sxs-lookup"><span data-stu-id="d8255-103">Listing Profiles, Policies, and Clients</span></span>

<span data-ttu-id="d8255-104">下列 VBScript 程式碼會列舉本機電腦上的設定檔、原則和用戶端。</span><span class="sxs-lookup"><span data-stu-id="d8255-104">The following VBScript code enumerates the profiles, policies, and clients on the local computer.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d8255-105">相關主題</span><span class="sxs-lookup"><span data-stu-id="d8255-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="d8255-106">**CLIENTPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="d8255-106">**CLIENTPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-clientproperties)
</dt> <dt>

[<span data-ttu-id="d8255-107">列舉集合中的物件</span><span class="sxs-lookup"><span data-stu-id="d8255-107">Enumerating Objects in a Collection</span></span>](/windows/desktop/Nps/sdo-enumerating-objects-in-a-collection)
</dt> <dt>

[<span data-ttu-id="d8255-108">**IASCOMMONPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="d8255-108">**IASCOMMONPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-iascommonproperties)
</dt> <dt>

[<span data-ttu-id="d8255-109">**IASPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="d8255-109">**IASPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-iasproperties)
</dt> <dt>

[<span data-ttu-id="d8255-110">**ISdo**</span><span class="sxs-lookup"><span data-stu-id="d8255-110">**ISdo**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdo)
</dt> <dt>

[<span data-ttu-id="d8255-111">**ISdoMachine**</span><span class="sxs-lookup"><span data-stu-id="d8255-111">**ISdoMachine**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdomachine)
</dt> <dt>

[<span data-ttu-id="d8255-112">**RADIUSPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="d8255-112">**RADIUSPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-radiusproperties)
</dt> </dl>
