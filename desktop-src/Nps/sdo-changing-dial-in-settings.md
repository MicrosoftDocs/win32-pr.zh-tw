...
ms.locfileid: "106996368"
---
# <a name="changing-dial-in-settings"></a><span data-ttu-id="1631f-103">變更撥號設定</span><span class="sxs-lookup"><span data-stu-id="1631f-103">Changing Dial-In Settings</span></span>

<span data-ttu-id="1631f-104">下列 VBScript 程式碼會設定使用者的撥入位和回呼號碼。</span><span class="sxs-lookup"><span data-stu-id="1631f-104">The following VBScript code sets the dial-in bit and callback number for a user.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="1631f-105">相關主題</span><span class="sxs-lookup"><span data-stu-id="1631f-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="1631f-106">**CLIENTPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="1631f-106">**CLIENTPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-clientproperties)
</dt> <dt>

[<span data-ttu-id="1631f-107">列舉集合中的物件</span><span class="sxs-lookup"><span data-stu-id="1631f-107">Enumerating Objects in a Collection</span></span>](/windows/desktop/Nps/sdo-enumerating-objects-in-a-collection)
</dt> <dt>

[<span data-ttu-id="1631f-108">**IASPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="1631f-108">**IASPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-iasproperties)
</dt> <dt>

[<span data-ttu-id="1631f-109">**ISdo**</span><span class="sxs-lookup"><span data-stu-id="1631f-109">**ISdo**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdo)
</dt> <dt>

[<span data-ttu-id="1631f-110">**ISdoMachine**</span><span class="sxs-lookup"><span data-stu-id="1631f-110">**ISdoMachine**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdomachine)
</dt> <dt>

[<span data-ttu-id="1631f-111">**RADIUSPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="1631f-111">**RADIUSPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-radiusproperties)
</dt> </dl>
