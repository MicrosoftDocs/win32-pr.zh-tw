...
下列範例程式碼示範如何使用 NUMA 函數 [**GetNumaHighestNodeNumber**](/windows/win32/api/systemtopologyapi/nf-systemtopologyapi-getnumahighestnodenumber)、 [**GetNumaProcessorNode**](/windows/win32/api/winbase/nf-winbase-getnumaprocessornode)和 [**VirtualAllocExNuma**](/windows/win32/api/memoryapi/nf-memoryapi-virtualallocexnuma)。 它也會示範如何使用 [**QueryWorkingSetEx**](/windows/win32/api/psapi/nf-psapi-queryworkingsetex) 函式來取出配置頁面的 NUMA 節點。
...
[NUMA 支援](../procthread/numa-support.md)
</dt> </dl>
