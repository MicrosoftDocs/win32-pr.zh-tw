---
description: 下列範例程式說明視窗化延伸模組的位址。
...
---
# <a name="awe-example"></a><span data-ttu-id="415c7-103">AWE 範例</span><span class="sxs-lookup"><span data-stu-id="415c7-103">AWE Example</span></span>

<span data-ttu-id="415c7-104">下列範例程式說明視窗化 [**延伸**](address-windowing-extensions.md)模組的位址。</span><span class="sxs-lookup"><span data-stu-id="415c7-104">The following sample program illustrates the [**Address Windowing Extensions**](address-windowing-extensions.md).</span></span>
