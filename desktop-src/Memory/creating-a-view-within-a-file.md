...
1.  <span data-ttu-id="37c7b-115">建立至少139264個位元組的檔案對應物件 (136K) 的大小。</span><span class="sxs-lookup"><span data-stu-id="37c7b-115">Create a file mapping object of at least 139,264 bytes (136K) in size.</span></span>
