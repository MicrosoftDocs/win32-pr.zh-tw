---
description: Microsoft XPS Document Writer (MXDW) 是一種列印到檔的驅動程式，可讓 Windows 應用程式在 (XP Service Pack 2) SP2 Windows 開始的版本上，建立 XML 檔規格 Windows XPS (檔檔。
...
ms.locfileid: "119938881"
---
# <a name="microsoft-xps-document-writer-mxdw"></a>Microsoft XPS Document Writer (MXDW) 

Microsoft XPS Document Writer (MXDW) 是一種列印到檔的驅動程式，可讓 Windows 應用程式在 (XP Service Pack 2) SP2 Windows 開始的版本上，建立 XML 檔規格 Windows XPS (檔檔。 使用 MXDW 可讓 Windows 應用程式將其內容儲存為 XPS 檔，而不需要變更應用程式的任何程式碼。
...
MXDW 會自動安裝在 Windows Vista 和更新版本的 Windows 上，並可在 Windows XP SP2 和 Windows Server 2003 中下載並安裝。

## <a name="installation"></a>安裝

在 Windows Vista 和更新版本的 Windows 中，安裝作業系統時，會自動安裝 MXDW。
...
下圖顯示在 Windows Vista 一般列印] 對話方塊中選取為印表機的 MXDW。
