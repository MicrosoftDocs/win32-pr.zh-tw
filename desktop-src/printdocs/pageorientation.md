...
| 選項                       | 定義                                                                                              |
|------------------------------|---------------------------------------------------------------------------------------------------------|
| 橫向 <br/>        | 內容會在頁面90上旋轉？相對於標準 (直向) 方向的角度。<br/>  |
| 直向 <br/>         | 標準方向。<br/>                                                                        |
| ReverseLandscape <br/> | 內容會在頁面270上旋轉？相對於標準 (直向) 方向的角度。<br/> |
| ReversePortrait <br/>  | 內容會在頁面180上旋轉？相對於標準 (縱向) 方向的度數。<br/>     |
...
| 項目類型 <br/>   | 功能<br/>                                                                                                                                                                                      |
| 範圍前置詞 <br/> | 頁面<br/>                                                                                                                                                                                         |
| 備註 <br/>          | 如果印表機裝置只能支援一種橫向方向，而且此方向稱為「反向橫向」，則頁面方向仍會被視為「橫向」。<br/> |
