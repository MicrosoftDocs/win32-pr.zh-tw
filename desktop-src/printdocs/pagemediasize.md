...
---
# <a name="pagemediasize"></a><span data-ttu-id="4fa88-104">PageMediaSize</span><span class="sxs-lookup"><span data-stu-id="4fa88-104">PageMediaSize</span></span>

<span data-ttu-id="4fa88-105">本主題並非最新的。</span><span class="sxs-lookup"><span data-stu-id="4fa88-105">This topic is not current.</span></span> <span data-ttu-id="4fa88-106">如需最新資訊，請參閱 [列印架構規格](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)。</span><span class="sxs-lookup"><span data-stu-id="4fa88-106">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="4fa88-107">描述用於輸出的實體媒體維度。</span><span class="sxs-lookup"><span data-stu-id="4fa88-107">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="4fa88-108">下圖說明 PageMediaSize 變數使用量 (選項 ISOA4 作為範例) 使用。</span><span class="sxs-lookup"><span data-stu-id="4fa88-108">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![顯示頁面維度的圖表](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="4fa88-110">項目資訊</span><span class="sxs-lookup"><span data-stu-id="4fa88-110">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="4fa88-111">結構化內容</span><span class="sxs-lookup"><span data-stu-id="4fa88-111">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="4fa88-112">可延伸標記語言 (XML)  (XML) 內容</span><span class="sxs-lookup"><span data-stu-id="4fa88-112">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="4fa88-113">項目資訊</span><span class="sxs-lookup"><span data-stu-id="4fa88-113">Element Information</span></span>



|                            |                    |
|----------------------------|--------------------|
| <span data-ttu-id="4fa88-114">Name</span><span class="sxs-lookup"><span data-stu-id="4fa88-114">Name</span></span>                       |                    |
| <span data-ttu-id="4fa88-115">項目類型</span><span class="sxs-lookup"><span data-stu-id="4fa88-115">Element Type</span></span> <br/>   | <span data-ttu-id="4fa88-116">功能</span><span class="sxs-lookup"><span data-stu-id="4fa88-116">Feature</span></span><br/> |
| <span data-ttu-id="4fa88-117">範圍前置詞</span><span class="sxs-lookup"><span data-stu-id="4fa88-117">Scoping Prefix</span></span> <br/> | <span data-ttu-id="4fa88-118">頁面</span><span class="sxs-lookup"><span data-stu-id="4fa88-118">Page</span></span><br/>    |
| <span data-ttu-id="4fa88-119">注意</span><span class="sxs-lookup"><span data-stu-id="4fa88-119">Notes</span></span> <br/>          | <span data-ttu-id="4fa88-120">None</span><span class="sxs-lookup"><span data-stu-id="4fa88-120">None</span></span><br/>    |



 

## <a name="structural-content"></a><span data-ttu-id="4fa88-121">結構化內容</span><span class="sxs-lookup"><span data-stu-id="4fa88-121">Structural Content</span></span>

<span data-ttu-id="4fa88-122">此元素的 XML 結構為：</span><span class="sxs-lookup"><span data-stu-id="4fa88-122">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="4fa88-123">結構變數</span><span class="sxs-lookup"><span data-stu-id="4fa88-123">Structure Variables</span></span>

<span data-ttu-id="4fa88-124">下表概述 XML 結構中所定義之變數的特性。</span><span class="sxs-lookup"><span data-stu-id="4fa88-124">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="4fa88-125">Name</span><span class="sxs-lookup"><span data-stu-id="4fa88-125">Name</span></span>                                | <span data-ttu-id="4fa88-126">資料類型</span><span class="sxs-lookup"><span data-stu-id="4fa88-126">Data type</span></span>          | <span data-ttu-id="4fa88-127">單位</span><span class="sxs-lookup"><span data-stu-id="4fa88-127">Unit</span></span>                  | <span data-ttu-id="4fa88-128">支援的值</span><span class="sxs-lookup"><span data-stu-id="4fa88-128">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="4fa88-129">總結</span><span class="sxs-lookup"><span data-stu-id="4fa88-129">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="4fa88-130">\_選項名稱\_</span><span class="sxs-lookup"><span data-stu-id="4fa88-130">\_OptionName\_</span></span><br/>           | <span data-ttu-id="4fa88-131">字串</span><span class="sxs-lookup"><span data-stu-id="4fa88-131">string</span></span><br/>  | <span data-ttu-id="4fa88-132">字元</span><span class="sxs-lookup"><span data-stu-id="4fa88-132">characters</span></span><br/> | <span data-ttu-id="4fa88-133">以 [XML 命名空間](https://www.w3.org/TR/1999/REC-xml-names-19990114/)所定義的有效完整名稱。</span><span class="sxs-lookup"><span data-stu-id="4fa88-133">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="4fa88-134">如果未指定命名空間，則會假設為預設命名空間。</span><span class="sxs-lookup"><span data-stu-id="4fa88-134">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="4fa88-135">指定媒體的名稱。</span><span class="sxs-lookup"><span data-stu-id="4fa88-135">Specifies the name of the media.</span></span> <span data-ttu-id="4fa88-136">命名應使用下列慣例： " \_ OptionNameStandard \_ " " \_ OptionNameCommonName \_ " " \_ OptionNameDescriptor \_ "。</span><span class="sxs-lookup"><span data-stu-id="4fa88-136">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="4fa88-137">\_IdentityOptionValue\_</span><span class="sxs-lookup"><span data-stu-id="4fa88-137">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="4fa88-138">字串</span><span class="sxs-lookup"><span data-stu-id="4fa88-138">string</span></span><br/>  | <span data-ttu-id="4fa88-139">n/a</span><span class="sxs-lookup"><span data-stu-id="4fa88-139">n/a</span></span><br/>        | <span data-ttu-id="4fa88-140">True、False。</span><span class="sxs-lookup"><span data-stu-id="4fa88-140">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="4fa88-141">定義選項，當選取此選項時，會停用此功能。</span><span class="sxs-lookup"><span data-stu-id="4fa88-141">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="4fa88-142">\_OptionNameStandard\_</span><span class="sxs-lookup"><span data-stu-id="4fa88-142">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="4fa88-143">字串</span><span class="sxs-lookup"><span data-stu-id="4fa88-143">string</span></span><br/>  | <span data-ttu-id="4fa88-144">字元</span><span class="sxs-lookup"><span data-stu-id="4fa88-144">characters</span></span><br/> | <span data-ttu-id="4fa88-145">「ISO」、「JIS」、「日本」、「北美洲」、「OtherMetric」、「中國」、「無」。</span><span class="sxs-lookup"><span data-stu-id="4fa88-145">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="4fa88-146">指出媒體大小是否由特定標準定義。</span><span class="sxs-lookup"><span data-stu-id="4fa88-146">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="4fa88-147">\_OptionNameCommonName\_</span><span class="sxs-lookup"><span data-stu-id="4fa88-147">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="4fa88-148">字串</span><span class="sxs-lookup"><span data-stu-id="4fa88-148">string</span></span><br/>  | <span data-ttu-id="4fa88-149">字元</span><span class="sxs-lookup"><span data-stu-id="4fa88-149">characters</span></span><br/> | <span data-ttu-id="4fa88-150">以 [XML 命名空間](https://www.w3.org/TR/1999/REC-xml-names-19990114/)所定義的有效完整名稱。</span><span class="sxs-lookup"><span data-stu-id="4fa88-150">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="4fa88-151">如果未指定命名空間，則會假設為預設命名空間。</span><span class="sxs-lookup"><span data-stu-id="4fa88-151">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="4fa88-152">媒體大小的一般名稱。</span><span class="sxs-lookup"><span data-stu-id="4fa88-152">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="4fa88-153">\_OptionNameDescriptor\_</span><span class="sxs-lookup"><span data-stu-id="4fa88-153">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="4fa88-154">字串</span><span class="sxs-lookup"><span data-stu-id="4fa88-154">string</span></span><br/>  | <span data-ttu-id="4fa88-155">字元</span><span class="sxs-lookup"><span data-stu-id="4fa88-155">characters</span></span><br/> | <span data-ttu-id="4fa88-156">大型、信封、額外的加號、明信片、旋轉、紙、' none '。</span><span class="sxs-lookup"><span data-stu-id="4fa88-156">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="4fa88-157">大型、信封、額外的加號、明信片、旋轉、紙、' none '。</span><span class="sxs-lookup"><span data-stu-id="4fa88-157">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="4fa88-158">\_MediaSizeWidth\_</span><span class="sxs-lookup"><span data-stu-id="4fa88-158">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="4fa88-159">整數</span><span class="sxs-lookup"><span data-stu-id="4fa88-159">integer</span></span><br/> | <span data-ttu-id="4fa88-160">微米</span><span class="sxs-lookup"><span data-stu-id="4fa88-160">microns</span></span><br/>    | <span data-ttu-id="4fa88-161">大於0，小於裝置的支援媒體大小上限。</span><span class="sxs-lookup"><span data-stu-id="4fa88-161">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="4fa88-162">指定實體媒體的寬度。</span><span class="sxs-lookup"><span data-stu-id="4fa88-162">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="4fa88-163">\_MediaSizeHeight\_</span><span class="sxs-lookup"><span data-stu-id="4fa88-163">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="4fa88-164">整數</span><span class="sxs-lookup"><span data-stu-id="4fa88-164">integer</span></span><br/> | <span data-ttu-id="4fa88-165">微米</span><span class="sxs-lookup"><span data-stu-id="4fa88-165">microns</span></span><br/>    | <span data-ttu-id="4fa88-166">大於0，小於裝置的支援媒體大小上限。</span><span class="sxs-lookup"><span data-stu-id="4fa88-166">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="4fa88-167">指定實體媒體的高度。</span><span class="sxs-lookup"><span data-stu-id="4fa88-167">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="4fa88-168">可延伸標記語言 (XML)  (XML) 內容</span><span class="sxs-lookup"><span data-stu-id="4fa88-168">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="4fa88-169">公用列印架構關鍵字是在 `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` 命名空間中定義。</span><span class="sxs-lookup"><span data-stu-id="4fa88-169">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="4fa88-170">此關鍵字的 public 可延伸標記語言 (XML)  (XML) 內容定義如下：</span><span class="sxs-lookup"><span data-stu-id="4fa88-170">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="4fa88-171">相關主題</span><span class="sxs-lookup"><span data-stu-id="4fa88-171">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="4fa88-172">列印架構規格</span><span class="sxs-lookup"><span data-stu-id="4fa88-172">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
