...
---
# <a name="pagemediasize"></a><span data-ttu-id="abd4c-105">PageMediaSize</span><span class="sxs-lookup"><span data-stu-id="abd4c-105">PageMediaSize</span></span>

<span data-ttu-id="abd4c-106">本主題並非最新的。</span><span class="sxs-lookup"><span data-stu-id="abd4c-106">This topic is not current.</span></span> <span data-ttu-id="abd4c-107">如需最新資訊，請參閱 [列印架構規格](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)。</span><span class="sxs-lookup"><span data-stu-id="abd4c-107">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="abd4c-108">描述用於輸出的實體媒體維度。</span><span class="sxs-lookup"><span data-stu-id="abd4c-108">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="abd4c-109">下圖說明 PageMediaSize 變數使用量 (選項 ISOA4 作為範例) 使用。</span><span class="sxs-lookup"><span data-stu-id="abd4c-109">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![顯示頁面維度的圖表](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="abd4c-111">項目資訊</span><span class="sxs-lookup"><span data-stu-id="abd4c-111">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="abd4c-112">結構化內容</span><span class="sxs-lookup"><span data-stu-id="abd4c-112">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="abd4c-113">可延伸標記語言 (XML)  (XML) 內容</span><span class="sxs-lookup"><span data-stu-id="abd4c-113">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="abd4c-114">項目資訊</span><span class="sxs-lookup"><span data-stu-id="abd4c-114">Element Information</span></span>

| <span data-ttu-id="abd4c-115">Name</span><span class="sxs-lookup"><span data-stu-id="abd4c-115">Name</span></span>                 | <span data-ttu-id="abd4c-116">值</span><span class="sxs-lookup"><span data-stu-id="abd4c-116">Value</span></span>        |
|----------------------|--------------|
| <span data-ttu-id="abd4c-117">項目類型</span><span class="sxs-lookup"><span data-stu-id="abd4c-117">Element Type</span></span> <br/>   | <span data-ttu-id="abd4c-118">功能</span><span class="sxs-lookup"><span data-stu-id="abd4c-118">Feature</span></span><br/> |
| <span data-ttu-id="abd4c-119">範圍前置詞</span><span class="sxs-lookup"><span data-stu-id="abd4c-119">Scoping Prefix</span></span> <br/> | <span data-ttu-id="abd4c-120">頁面</span><span class="sxs-lookup"><span data-stu-id="abd4c-120">Page</span></span><br/>    |
| <span data-ttu-id="abd4c-121">注意</span><span class="sxs-lookup"><span data-stu-id="abd4c-121">Notes</span></span> <br/>          | <span data-ttu-id="abd4c-122">None</span><span class="sxs-lookup"><span data-stu-id="abd4c-122">None</span></span><br/>    |

## <a name="structural-content"></a><span data-ttu-id="abd4c-123">結構化內容</span><span class="sxs-lookup"><span data-stu-id="abd4c-123">Structural Content</span></span>

<span data-ttu-id="abd4c-124">此元素的 XML 結構為：</span><span class="sxs-lookup"><span data-stu-id="abd4c-124">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="abd4c-125">結構變數</span><span class="sxs-lookup"><span data-stu-id="abd4c-125">Structure Variables</span></span>

<span data-ttu-id="abd4c-126">下表概述 XML 結構中所定義之變數的特性。</span><span class="sxs-lookup"><span data-stu-id="abd4c-126">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="abd4c-127">Name</span><span class="sxs-lookup"><span data-stu-id="abd4c-127">Name</span></span>                                | <span data-ttu-id="abd4c-128">資料類型</span><span class="sxs-lookup"><span data-stu-id="abd4c-128">Data type</span></span>          | <span data-ttu-id="abd4c-129">單位</span><span class="sxs-lookup"><span data-stu-id="abd4c-129">Unit</span></span>                  | <span data-ttu-id="abd4c-130">支援的值</span><span class="sxs-lookup"><span data-stu-id="abd4c-130">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="abd4c-131">總結</span><span class="sxs-lookup"><span data-stu-id="abd4c-131">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="abd4c-132">\_選項名稱\_</span><span class="sxs-lookup"><span data-stu-id="abd4c-132">\_OptionName\_</span></span><br/>           | <span data-ttu-id="abd4c-133">string</span><span class="sxs-lookup"><span data-stu-id="abd4c-133">string</span></span><br/>  | <span data-ttu-id="abd4c-134">字元</span><span class="sxs-lookup"><span data-stu-id="abd4c-134">characters</span></span><br/> | <span data-ttu-id="abd4c-135">以 [XML 命名空間](https://www.w3.org/TR/1999/REC-xml-names-19990114/)所定義的有效完整名稱。</span><span class="sxs-lookup"><span data-stu-id="abd4c-135">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="abd4c-136">如果未指定命名空間，則會假設為預設命名空間。</span><span class="sxs-lookup"><span data-stu-id="abd4c-136">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="abd4c-137">指定媒體的名稱。</span><span class="sxs-lookup"><span data-stu-id="abd4c-137">Specifies the name of the media.</span></span> <span data-ttu-id="abd4c-138">命名應使用下列慣例： " \_ OptionNameStandard \_ " " \_ OptionNameCommonName \_ " " \_ OptionNameDescriptor \_ "。</span><span class="sxs-lookup"><span data-stu-id="abd4c-138">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="abd4c-139">\_IdentityOptionValue\_</span><span class="sxs-lookup"><span data-stu-id="abd4c-139">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="abd4c-140">string</span><span class="sxs-lookup"><span data-stu-id="abd4c-140">string</span></span><br/>  | <span data-ttu-id="abd4c-141">n/a</span><span class="sxs-lookup"><span data-stu-id="abd4c-141">n/a</span></span><br/>        | <span data-ttu-id="abd4c-142">True、False。</span><span class="sxs-lookup"><span data-stu-id="abd4c-142">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="abd4c-143">定義選項，當選取此選項時，會停用此功能。</span><span class="sxs-lookup"><span data-stu-id="abd4c-143">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="abd4c-144">\_OptionNameStandard\_</span><span class="sxs-lookup"><span data-stu-id="abd4c-144">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="abd4c-145">string</span><span class="sxs-lookup"><span data-stu-id="abd4c-145">string</span></span><br/>  | <span data-ttu-id="abd4c-146">字元</span><span class="sxs-lookup"><span data-stu-id="abd4c-146">characters</span></span><br/> | <span data-ttu-id="abd4c-147">「ISO」、「JIS」、「日本」、「北美洲」、「OtherMetric」、「中國」、「無」。</span><span class="sxs-lookup"><span data-stu-id="abd4c-147">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="abd4c-148">指出媒體大小是否由特定標準定義。</span><span class="sxs-lookup"><span data-stu-id="abd4c-148">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="abd4c-149">\_OptionNameCommonName\_</span><span class="sxs-lookup"><span data-stu-id="abd4c-149">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="abd4c-150">string</span><span class="sxs-lookup"><span data-stu-id="abd4c-150">string</span></span><br/>  | <span data-ttu-id="abd4c-151">字元</span><span class="sxs-lookup"><span data-stu-id="abd4c-151">characters</span></span><br/> | <span data-ttu-id="abd4c-152">以 [XML 命名空間](https://www.w3.org/TR/1999/REC-xml-names-19990114/)所定義的有效完整名稱。</span><span class="sxs-lookup"><span data-stu-id="abd4c-152">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="abd4c-153">如果未指定命名空間，則會假設為預設命名空間。</span><span class="sxs-lookup"><span data-stu-id="abd4c-153">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="abd4c-154">媒體大小的一般名稱。</span><span class="sxs-lookup"><span data-stu-id="abd4c-154">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="abd4c-155">\_OptionNameDescriptor\_</span><span class="sxs-lookup"><span data-stu-id="abd4c-155">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="abd4c-156">string</span><span class="sxs-lookup"><span data-stu-id="abd4c-156">string</span></span><br/>  | <span data-ttu-id="abd4c-157">字元</span><span class="sxs-lookup"><span data-stu-id="abd4c-157">characters</span></span><br/> | <span data-ttu-id="abd4c-158">大型、信封、額外的加號、明信片、旋轉、紙、' none '。</span><span class="sxs-lookup"><span data-stu-id="abd4c-158">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="abd4c-159">大型、信封、額外的加號、明信片、旋轉、紙、' none '。</span><span class="sxs-lookup"><span data-stu-id="abd4c-159">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="abd4c-160">\_MediaSizeWidth\_</span><span class="sxs-lookup"><span data-stu-id="abd4c-160">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="abd4c-161">整數</span><span class="sxs-lookup"><span data-stu-id="abd4c-161">integer</span></span><br/> | <span data-ttu-id="abd4c-162">微米</span><span class="sxs-lookup"><span data-stu-id="abd4c-162">microns</span></span><br/>    | <span data-ttu-id="abd4c-163">大於0，小於裝置的支援媒體大小上限。</span><span class="sxs-lookup"><span data-stu-id="abd4c-163">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="abd4c-164">指定實體媒體的寬度。</span><span class="sxs-lookup"><span data-stu-id="abd4c-164">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="abd4c-165">\_MediaSizeHeight\_</span><span class="sxs-lookup"><span data-stu-id="abd4c-165">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="abd4c-166">整數</span><span class="sxs-lookup"><span data-stu-id="abd4c-166">integer</span></span><br/> | <span data-ttu-id="abd4c-167">微米</span><span class="sxs-lookup"><span data-stu-id="abd4c-167">microns</span></span><br/>    | <span data-ttu-id="abd4c-168">大於0，小於裝置的支援媒體大小上限。</span><span class="sxs-lookup"><span data-stu-id="abd4c-168">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="abd4c-169">指定實體媒體的高度。</span><span class="sxs-lookup"><span data-stu-id="abd4c-169">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="abd4c-170">可延伸標記語言 (XML)  (XML) 內容</span><span class="sxs-lookup"><span data-stu-id="abd4c-170">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="abd4c-171">公用列印架構關鍵字是在 `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` 命名空間中定義。</span><span class="sxs-lookup"><span data-stu-id="abd4c-171">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="abd4c-172">此關鍵字的 public 可延伸標記語言 (XML)  (XML) 內容定義如下：</span><span class="sxs-lookup"><span data-stu-id="abd4c-172">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="abd4c-173">相關主題</span><span class="sxs-lookup"><span data-stu-id="abd4c-173">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="abd4c-174">列印架構規格</span><span class="sxs-lookup"><span data-stu-id="abd4c-174">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
