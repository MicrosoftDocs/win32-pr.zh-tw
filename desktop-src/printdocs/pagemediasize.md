...
---
# <a name="pagemediasize"></a><span data-ttu-id="1f6d9-104">PageMediaSize</span><span class="sxs-lookup"><span data-stu-id="1f6d9-104">PageMediaSize</span></span>

<span data-ttu-id="1f6d9-105">本主題並非最新的。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-105">This topic is not current.</span></span> <span data-ttu-id="1f6d9-106">如需最新資訊，請參閱 [列印架構規格](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-106">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="1f6d9-107">描述用於輸出的實體媒體維度。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-107">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="1f6d9-108">下圖說明 PageMediaSize 變數使用量 (選項 ISOA4 作為範例) 使用。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-108">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![顯示頁面維度的圖表](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="1f6d9-110">項目資訊</span><span class="sxs-lookup"><span data-stu-id="1f6d9-110">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="1f6d9-111">結構化內容</span><span class="sxs-lookup"><span data-stu-id="1f6d9-111">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="1f6d9-112">可延伸標記語言 (XML)  (XML) 內容</span><span class="sxs-lookup"><span data-stu-id="1f6d9-112">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="1f6d9-113">項目資訊</span><span class="sxs-lookup"><span data-stu-id="1f6d9-113">Element Information</span></span>



|                            |                    |
|----------------------------|--------------------|
| <span data-ttu-id="1f6d9-114">Name</span><span class="sxs-lookup"><span data-stu-id="1f6d9-114">Name</span></span> | <span data-ttu-id="1f6d9-115">值</span><span class="sxs-lookup"><span data-stu-id="1f6d9-115">Value</span></span> |
| <span data-ttu-id="1f6d9-116">項目類型</span><span class="sxs-lookup"><span data-stu-id="1f6d9-116">Element Type</span></span> <br/>   | <span data-ttu-id="1f6d9-117">功能</span><span class="sxs-lookup"><span data-stu-id="1f6d9-117">Feature</span></span><br/> |
| <span data-ttu-id="1f6d9-118">範圍前置詞</span><span class="sxs-lookup"><span data-stu-id="1f6d9-118">Scoping Prefix</span></span> <br/> | <span data-ttu-id="1f6d9-119">頁面</span><span class="sxs-lookup"><span data-stu-id="1f6d9-119">Page</span></span><br/>    |
| <span data-ttu-id="1f6d9-120">注意</span><span class="sxs-lookup"><span data-stu-id="1f6d9-120">Notes</span></span> <br/>          | <span data-ttu-id="1f6d9-121">None</span><span class="sxs-lookup"><span data-stu-id="1f6d9-121">None</span></span><br/>    |



 

## <a name="structural-content"></a><span data-ttu-id="1f6d9-122">結構化內容</span><span class="sxs-lookup"><span data-stu-id="1f6d9-122">Structural Content</span></span>

<span data-ttu-id="1f6d9-123">此元素的 XML 結構為：</span><span class="sxs-lookup"><span data-stu-id="1f6d9-123">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="1f6d9-124">結構變數</span><span class="sxs-lookup"><span data-stu-id="1f6d9-124">Structure Variables</span></span>

<span data-ttu-id="1f6d9-125">下表概述 XML 結構中所定義之變數的特性。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-125">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="1f6d9-126">Name</span><span class="sxs-lookup"><span data-stu-id="1f6d9-126">Name</span></span>                                | <span data-ttu-id="1f6d9-127">資料類型</span><span class="sxs-lookup"><span data-stu-id="1f6d9-127">Data type</span></span>          | <span data-ttu-id="1f6d9-128">單位</span><span class="sxs-lookup"><span data-stu-id="1f6d9-128">Unit</span></span>                  | <span data-ttu-id="1f6d9-129">支援的值</span><span class="sxs-lookup"><span data-stu-id="1f6d9-129">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="1f6d9-130">總結</span><span class="sxs-lookup"><span data-stu-id="1f6d9-130">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="1f6d9-131">\_選項名稱\_</span><span class="sxs-lookup"><span data-stu-id="1f6d9-131">\_OptionName\_</span></span><br/>           | <span data-ttu-id="1f6d9-132">字串</span><span class="sxs-lookup"><span data-stu-id="1f6d9-132">string</span></span><br/>  | <span data-ttu-id="1f6d9-133">字元</span><span class="sxs-lookup"><span data-stu-id="1f6d9-133">characters</span></span><br/> | <span data-ttu-id="1f6d9-134">以 [XML 命名空間](https://www.w3.org/TR/1999/REC-xml-names-19990114/)所定義的有效完整名稱。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-134">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="1f6d9-135">如果未指定命名空間，則會假設為預設命名空間。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-135">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="1f6d9-136">指定媒體的名稱。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-136">Specifies the name of the media.</span></span> <span data-ttu-id="1f6d9-137">命名應使用下列慣例： " \_ OptionNameStandard \_ " " \_ OptionNameCommonName \_ " " \_ OptionNameDescriptor \_ "。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-137">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="1f6d9-138">\_IdentityOptionValue\_</span><span class="sxs-lookup"><span data-stu-id="1f6d9-138">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="1f6d9-139">字串</span><span class="sxs-lookup"><span data-stu-id="1f6d9-139">string</span></span><br/>  | <span data-ttu-id="1f6d9-140">n/a</span><span class="sxs-lookup"><span data-stu-id="1f6d9-140">n/a</span></span><br/>        | <span data-ttu-id="1f6d9-141">True、False。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-141">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="1f6d9-142">定義選項，當選取此選項時，會停用此功能。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-142">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="1f6d9-143">\_OptionNameStandard\_</span><span class="sxs-lookup"><span data-stu-id="1f6d9-143">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="1f6d9-144">字串</span><span class="sxs-lookup"><span data-stu-id="1f6d9-144">string</span></span><br/>  | <span data-ttu-id="1f6d9-145">字元</span><span class="sxs-lookup"><span data-stu-id="1f6d9-145">characters</span></span><br/> | <span data-ttu-id="1f6d9-146">「ISO」、「JIS」、「日本」、「北美洲」、「OtherMetric」、「中國」、「無」。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-146">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="1f6d9-147">指出媒體大小是否由特定標準定義。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-147">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="1f6d9-148">\_OptionNameCommonName\_</span><span class="sxs-lookup"><span data-stu-id="1f6d9-148">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="1f6d9-149">字串</span><span class="sxs-lookup"><span data-stu-id="1f6d9-149">string</span></span><br/>  | <span data-ttu-id="1f6d9-150">字元</span><span class="sxs-lookup"><span data-stu-id="1f6d9-150">characters</span></span><br/> | <span data-ttu-id="1f6d9-151">以 [XML 命名空間](https://www.w3.org/TR/1999/REC-xml-names-19990114/)所定義的有效完整名稱。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-151">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="1f6d9-152">如果未指定命名空間，則會假設為預設命名空間。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-152">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="1f6d9-153">媒體大小的一般名稱。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-153">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="1f6d9-154">\_OptionNameDescriptor\_</span><span class="sxs-lookup"><span data-stu-id="1f6d9-154">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="1f6d9-155">字串</span><span class="sxs-lookup"><span data-stu-id="1f6d9-155">string</span></span><br/>  | <span data-ttu-id="1f6d9-156">字元</span><span class="sxs-lookup"><span data-stu-id="1f6d9-156">characters</span></span><br/> | <span data-ttu-id="1f6d9-157">大型、信封、額外的加號、明信片、旋轉、紙、' none '。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-157">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="1f6d9-158">大型、信封、額外的加號、明信片、旋轉、紙、' none '。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-158">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="1f6d9-159">\_MediaSizeWidth\_</span><span class="sxs-lookup"><span data-stu-id="1f6d9-159">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="1f6d9-160">整數</span><span class="sxs-lookup"><span data-stu-id="1f6d9-160">integer</span></span><br/> | <span data-ttu-id="1f6d9-161">微米</span><span class="sxs-lookup"><span data-stu-id="1f6d9-161">microns</span></span><br/>    | <span data-ttu-id="1f6d9-162">大於0，小於裝置的支援媒體大小上限。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-162">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="1f6d9-163">指定實體媒體的寬度。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-163">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="1f6d9-164">\_MediaSizeHeight\_</span><span class="sxs-lookup"><span data-stu-id="1f6d9-164">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="1f6d9-165">整數</span><span class="sxs-lookup"><span data-stu-id="1f6d9-165">integer</span></span><br/> | <span data-ttu-id="1f6d9-166">微米</span><span class="sxs-lookup"><span data-stu-id="1f6d9-166">microns</span></span><br/>    | <span data-ttu-id="1f6d9-167">大於0，小於裝置的支援媒體大小上限。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-167">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="1f6d9-168">指定實體媒體的高度。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-168">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="1f6d9-169">可延伸標記語言 (XML)  (XML) 內容</span><span class="sxs-lookup"><span data-stu-id="1f6d9-169">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="1f6d9-170">公用列印架構關鍵字是在 `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` 命名空間中定義。</span><span class="sxs-lookup"><span data-stu-id="1f6d9-170">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="1f6d9-171">此關鍵字的 public 可延伸標記語言 (XML)  (XML) 內容定義如下：</span><span class="sxs-lookup"><span data-stu-id="1f6d9-171">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="1f6d9-172">相關主題</span><span class="sxs-lookup"><span data-stu-id="1f6d9-172">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="1f6d9-173">列印架構規格</span><span class="sxs-lookup"><span data-stu-id="1f6d9-173">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
