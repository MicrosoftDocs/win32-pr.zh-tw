...
---
# <a name="xps-om-gradients"></a><span data-ttu-id="d258d-103">XPS OM 漸層</span><span class="sxs-lookup"><span data-stu-id="d258d-103">XPS OM Gradients</span></span>

<span data-ttu-id="d258d-104">本主題提供在 XPS OM 中使用漸層的範例。</span><span class="sxs-lookup"><span data-stu-id="d258d-104">This topic provides an example of using gradients in an XPS OM.</span></span>

## <a name="add-a-new-stop-to-an-existing-gradient"></a><span data-ttu-id="d258d-105">將新的停用新增至現有的漸層</span><span class="sxs-lookup"><span data-stu-id="d258d-105">Add a new stop to an existing gradient</span></span>

<span data-ttu-id="d258d-106">下列程式碼範例會將新的停止加入至線性漸層筆刷的漸層。</span><span class="sxs-lookup"><span data-stu-id="d258d-106">The following code example adds a new stop to the gradient of a linear-gradient brush.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d258d-107">相關主題</span><span class="sxs-lookup"><span data-stu-id="d258d-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="d258d-108">**IXpsOMGradientStop 介面**</span><span class="sxs-lookup"><span data-stu-id="d258d-108">**IXpsOMGradientStop Interface**</span></span>](/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstop)
</dt> <dt>

[<span data-ttu-id="d258d-109">**IXpsOMGradientStopCollection 介面**</span><span class="sxs-lookup"><span data-stu-id="d258d-109">**IXpsOMGradientStopCollection Interface**</span></span>](/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstopcollection)
</dt> </dl>
