...
描述裝置中已安裝的輸入 bin，或裝置支援的 bin 完整清單。 JobInputBin、DocumentInputBin 和 PageInputBin 關鍵字都是互斥的。 這兩者不能同時在 PrintTicket 或列印功能檔中指定。
...
| 項目類型 <br/>   | 功能<br/>                                                                                                             |
| 範圍前置詞 <br/> | 文件<br/>                                                                                                            |
| 備註 <br/>          | 目前未安裝的支援的 bin 應該在 PrintCapabilities 檔中標示為受限制。<br/> |
