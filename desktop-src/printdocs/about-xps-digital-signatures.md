...
ms.locfileid: "119950938"
---
# <a name="about-xps-digital-signature-api"></a>關於 XPS 數位簽章 API

XPS 檔可以有數位簽章，讓使用者可以簽署檔、確認簽署者的身分識別，並指出 XPS 檔在簽署之後是否已經變更。 原生 Windows 應用程式可使用 xps 數位簽章 API 的介面來執行 xps 檔的數位簽章作業。 本節提供 XPS 數位簽章 API 的總覽。
