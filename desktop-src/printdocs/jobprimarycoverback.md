...
描述) 封面工作表的後 (結尾。 每個作業都會有個別的主表。 您應該在 PageMediaSize 和 PageMediaType 上列印頁首工作表，以用於作業的最後一頁。 封面工作表應該整合至處理選項 (例如 JobDuplexAllDocumentsContiguously、JobNUpAllDocumentsContiguously) ，如指定的選項所指定。
