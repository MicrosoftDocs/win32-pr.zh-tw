...
ms.locfileid: "119590338"
---
# <a name="iinkanalyzersetstrokeslanguageid-method"></a>IInkAnalyzer：： SetStrokesLanguageId 方法
...
如果這個方法會從非未分類筆墨節點的 [**ICoNtextNode**](icontextnode.md) 移動筆劃，這個方法也會將筆劃的周框方塊新增至筆跡分析器的中途區域 (請參閱 [**IInkAnalyzer：： GetDirtyRegion 方法**](iinkanalyzer-getdirtyregion.md)) 。
...
當 strokeIds 為 **Null** 時，這個方法會傳回錯誤碼。
