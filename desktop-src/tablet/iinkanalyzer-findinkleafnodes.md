...
---
# <a name="iinkanalyzerfindinkleafnodes-method"></a>IInkAnalyzer：： FindInkLeafNodes 方法
...
[**ICoNtextNodes**](icontextnodes.md)集合的指標，其中包含所有筆墨分葉節點。
...
分葉節點不包含子節點。 筆墨節點包含筆觸資料。 筆墨分葉節點的範例包括 InkWord、InkDrawing 和 InkBullet [**ICoNtextNode**](icontextnode.md) 物件。 如需詳細資訊，請參閱 [內容節點類型](context-node-types.md)。
