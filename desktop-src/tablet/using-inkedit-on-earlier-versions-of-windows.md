...
由於 Microsoft Windows XP 的非平板電腦版本上缺乏辨識器，因此您無法使用 [InkEdit](inkedit-control.md) 在 windows 2000、windows Server 2003 和非 tablet pc 版本的 windows xp 上轉譯筆墨，也無法使用控制項在這些作業系統上輸入筆墨。
