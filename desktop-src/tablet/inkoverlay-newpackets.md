...
---
# <a name="inkoverlaynewpackets-event"></a>NewPackets 事件

當筆墨 collecto rreceives 封包時發生
...
指定 [**IInkStrokeDisp**](/windows/desktop/api/msinkaut/nn-msinkaut-iinkstrokedisp) 物件。
...
在收集筆劃時接收封包。 封包事件會快速發生，且 [**NewPackets**](inkcollector-newpackets.md) 事件處理常式必須快速或效能受到影響。
...
[**NewInAirPackets 事件**](inkcollector-newinairpackets.md)
</dt> <dt>
