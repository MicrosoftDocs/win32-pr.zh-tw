...
ms.locfileid: "119939988"
---
# <a name="iinkanalyzeraddstrokes-method"></a>IInkAnalyzer：： AddStrokes 方法

將多個筆劃的筆觸資料新增至 [**IInkAnalyzer**](iinkanalyzer.md) ，並將使用中輸入執行緒的文化特性識別碼指派給筆劃。
...
> [!Note]  
> **IInkAnalyzer：： AddStrokes 方法** 的單一呼叫中只能新增具有相同封包描述的筆劃。
