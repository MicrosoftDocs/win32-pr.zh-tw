...
<td style="text-align: left;">停用所有其他 factoids 和字典。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">西方語言的 factoids 預設設定包括系統字典、使用者字典、各種標點符號，以及 Web 和數位的模擬。 東亞語言的 factoids 預設設定包含辨識器支援的所有字元。 <br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指出辨識器僅使用系統字典。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">指示辨識器使用以程式設計方式定義的單字清單。 單字清單是由<a href="inkrecognizercontext-class.md"><strong>InkRecognizerCoNtext</strong></a>物件的 [<a href="/windows/desktop/api/msinkaut/nf-msinkaut-iinkrecognizercontext-get_wordlist"><strong>單詞表</strong></a>] 屬性所定義。 <br/>
<blockquote>
[!Note]<br />
如果將字串加入至字組清單，也會隱含地加入其大寫版本。 比方說，加入 hello 時，會 &quot; &quot; 隱含地加入 &quot; hello &quot; 和 &quot; hello &quot; 。
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指示辨識器尋找電子郵件地址。<br/>
<blockquote>
[!Note]<br />
&quot; someone@example.com 此模擬程式必須使用完整的電子郵件地址（例如 &quot; ）。 無法辨識獨立的別名，例如 &quot; 他人 &quot; 。
</blockquote>
<br/>
...
<td style="text-align: left;">指示辨識器尋找網址。<br/>
...
<td style="text-align: left;">指示辨識器尋找單一字元。<br/>
<blockquote>
[!Note]<br />
此模擬程式會尋找任何隔離的 ANSI 字元。
</blockquote>
<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">指示辨識器尋找數位。<br/>
<blockquote>
[!Note]<br />
數值包含分隔符號、小數、序數和其他常用的數位記號。
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指出辨識器要尋找單一位數（0到9）。<br/>
...
<td style="text-align: left;">提供簡單的數值內容給辨識器。<br/>
<blockquote>
[!Note]<br />
此版本的 Tablet PC SDK 不支援此模擬。
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指示辨識器尋找表示貨幣值的字元。<br/>
...
<td style="text-align: left;">指示辨識器尋找郵遞區號。<br/>
...
<td style="text-align: left;">指示辨識器尋找百分比。<br/>
...
<td style="text-align: left;">指示辨識器尋找表示日期的字元。<br/>
...
<td style="text-align: left;">指示辨識器尋找表示時間的字元。<br/>
...
<td style="text-align: left;">指出辨識器尋找代表電話號碼的字元。<br/>
...
<td style="text-align: left;">指示辨識器尋找表示檔案名的字元。<br/>
...
<td style="text-align: left;">指出辨識器要尋找單一大寫字元： A 到 Z。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指出辨識器要尋找單一小寫字元： A 到 Z。<br/>
<blockquote>
[!Note]<br />
此版本的 Tablet PC SDK 不支援此模擬。
</blockquote>
...
<td style="text-align: left;">指示辨識器尋找標點符號字元。<br/>
<blockquote>
[!Note]<br />
此版本的 Tablet PC SDK 不支援此模擬。
</blockquote>
...
<td style="text-align: left;">指示辨識器尋找常用的日文漢字、片假名和平假名字元。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">指出辨識器尋找常用的簡體中文字元。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指出辨識器會尋找常用的繁體中文字元。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">指示辨識器尋找常用的韓文字元。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指出辨識器只尋找平假名字元。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">指出辨識器只尋找片假名字元。<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">指示辨識器尋找常用的中文字元。<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">指出辨識器尋找很少使用的中文字元。<br/>
<blockquote>
[!Note]<br />
此版本的 Tablet PC SDK 不支援此模擬。
</blockquote>
...
<td style="text-align: left;">指出辨識器尋找很少使用的韓文字元。<br/>
<blockquote>
[!Note]<br />
此版本的 Tablet PC SDK 不支援此模擬。
</blockquote>
