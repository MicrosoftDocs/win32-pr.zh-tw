...
---
# <a name="iinkanalysisrecognizergetcapabilities-method"></a>IInkAnalysisRecognizer：： GetCapabilities 方法
...
[**RecognizerCapabilities**](recognizercapabilities.md)值的位元組合。
...
每個 IInkAnalysisRecognizer 的這個值都是常數[ ](iinkanalysisrecognizer.md)
