...
ms.locfileid: "106985117"
---
# <a name="journal-reader-schema-definition"></a><span data-ttu-id="aee10-103">日誌讀取器架構定義</span><span class="sxs-lookup"><span data-stu-id="aee10-103">Journal Reader Schema Definition</span></span>

<span data-ttu-id="aee10-104">本主題包含日誌讀取器架構的定義。</span><span class="sxs-lookup"><span data-stu-id="aee10-104">This topic contains the definition of the Journal Reader schema.</span></span>

## <a name="schema"></a><span data-ttu-id="aee10-105">結構描述</span><span class="sxs-lookup"><span data-stu-id="aee10-105">Schema</span></span>
