...
---
# <a name="iinkanalyzergetanalysishints-method"></a>IInkAnalyzer：： GetAnalysisHints 方法

取得附加至 [**IInkAnalyzer**](iinkanalyzer.md)的所有分析提示 [**ICoNtextNode**](icontextnode.md)物件。
...
[**IInkAnalyzer**](iinkanalyzer.md)中所有分析提示 [**ICoNtextNode**](icontextnode.md)物件的指標。
...
如果沒有任何分析提示節點附加至 [**IInkAnalyzer**](iinkanalyzer.md)，這個方法會傳回空集合。
