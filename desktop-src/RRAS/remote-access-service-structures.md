...
ms.locfileid: "117788347"
---
# <a name="remote-access-service-structures"></a>遠端存取服務結構

使用下列結構來執行 RAS 功能。

[**RAS \_ 投影 \_ 資訊**](/windows/desktop/api/Ras/ns-ras-ras_projection_info)

[**RAS \_ 統計資料**](/windows/desktop/api/Ras/ns-ras-ras_stats)
...
[**RASIKEV2 \_ 投射 \_ 資訊**](/windows/desktop/api/ras/ns-ras-rasikev2_projection_info)
...
[**RASPPP \_ 投射 \_ 資訊**](/windows/desktop/api/Ras/ns-ras-rasppp_projection_info)
...
[**RASPROJECTION \_ 資訊 \_ 類型**](/windows/desktop/api/ras/ne-ras-rasprojection_info_type)
