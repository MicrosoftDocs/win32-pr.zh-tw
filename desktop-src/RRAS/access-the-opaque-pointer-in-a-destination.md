...
ms.locfileid: "104021569"
---
# <a name="access-the-opaque-pointer-in-a-destination"></a><span data-ttu-id="047c0-103">存取目的地中的不透明指標</span><span class="sxs-lookup"><span data-stu-id="047c0-103">Access the Opaque Pointer in a Destination</span></span>

<span data-ttu-id="047c0-104">下列範例程式碼顯示如何存取目的地中的不透明指標。</span><span class="sxs-lookup"><span data-stu-id="047c0-104">The following sample code shows how to access the opaque pointer in a destination.</span></span>
