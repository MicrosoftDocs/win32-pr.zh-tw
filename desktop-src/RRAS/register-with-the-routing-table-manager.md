---
title: 向路由表管理員註冊
description: 下列範例程式碼示範如何使用路由表管理員來註冊新的實體。
...
ms.locfileid: "104021246"
---
# <a name="register-with-the-routing-table-manager"></a><span data-ttu-id="c1256-103">向路由表管理員註冊</span><span class="sxs-lookup"><span data-stu-id="c1256-103">Register with the Routing Table Manager</span></span>

<span data-ttu-id="c1256-104">下列範例程式碼示範如何使用路由表管理員來註冊新的實體。</span><span class="sxs-lookup"><span data-stu-id="c1256-104">The following sample code shows how to register a new entity with the routing table manager.</span></span>
