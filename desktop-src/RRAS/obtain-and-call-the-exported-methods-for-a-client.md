---
title: 取得並呼叫用戶端的匯出方法
description: 下列範例程式碼示範如何取得用戶端匯出的方法清單，以及如何叫用該用戶端的方法。
...
ms.locfileid: "104461984"
---
# <a name="obtain-and-call-the-exported-methods-for-a-client"></a><span data-ttu-id="68277-103">取得並呼叫用戶端的匯出方法</span><span class="sxs-lookup"><span data-stu-id="68277-103">Obtain and Call the Exported Methods for a Client</span></span>

<span data-ttu-id="68277-104">下列範例程式碼示範如何取得用戶端匯出的方法清單，以及如何叫用該用戶端的方法。</span><span class="sxs-lookup"><span data-stu-id="68277-104">The following sample code shows how to obtain a list of methods a client has exported, and how to invoke a method for that client.</span></span>
