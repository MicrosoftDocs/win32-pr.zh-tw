...
本檔說明用來開發軟體來管理 RAS 撥號連線的 RRAS 函數。 這些功能包括：
...
額外的函式可用於 RAS 管理與路由器管理。 下列功能記載于 [路由器管理功能](router-administration-functions.md) 參考中：
...
若要執行 RAS 管理 DLL，請使用下列主題中所述的功能：

-   [RAS 系統管理 DLL 函式](ras-admin-dll-functions.md)

若要管理 RAS 伺服器的使用者，請使用下列主題中所述的功能：
