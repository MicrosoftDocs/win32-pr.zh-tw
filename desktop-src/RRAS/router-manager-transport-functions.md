---
title: 路由器管理員 (傳輸) 函數
description: 使用下列功能來管理路由器管理員。 這些功能也可讓開發人員讀取和寫入路由器管理員的全域資訊，以及路由器用戶端的全域資訊 (例如路由通訊協定) 。
...
ms.locfileid: "117787618"
---
# <a name="router-manager-transport-functions"></a>路由器管理員 (傳輸) 函數

使用下列功能來管理路由器管理員。 這些功能也可讓開發人員讀取和寫入路由器管理員的全域資訊，以及路由器用戶端的全域資訊 (例如路由通訊協定) 。
...
| 沒有管理功能                                   | [**MprConfigTransportDelete**](/windows/desktop/api/Mprapi/nf-mprapi-mprconfigtransportdelete)       |
...
| 沒有管理功能                                   | [**MprConfigTransportEnum**](/windows/desktop/api/Mprapi/nf-mprapi-mprconfigtransportenum)           |
| 沒有管理功能                                   | [**MprConfigTransportGetHandle**](/windows/desktop/api/Mprapi/nf-mprapi-mprconfigtransportgethandle) |
