...
| 視窗控制碼                        | RAS 傳送包含目前連接狀態和錯誤碼資訊之 [**WM \_ RASDIALEVENT**](wm-rasdialevent.md) 訊息的視窗控制碼。 如果您的原始程式碼必須與16位 Windows 相容，請使用這個方法，因為16位 Windows 不支援任何回呼函數。                                                                                                                                                                            |
