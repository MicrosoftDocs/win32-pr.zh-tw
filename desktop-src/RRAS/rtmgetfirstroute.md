...
指定將已刪除的路由集合限制為這些旗標所定義的子集，以及 *CriteriaRoute* 參數所指向之結構的對應成員中的值。 旗標與 [**RtmCreateEnumerationHandle**](rtmcreateenumerationhandle.md)中使用的旗標相同。
...
相較于對應的列舉控制碼函式 [**RtmEnumerateGetNextRoute**](rtmenumerategetnextroute.md)，此函式的效率較低。
