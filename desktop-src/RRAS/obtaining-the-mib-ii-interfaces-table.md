...
ms.locfileid: "120074018"
---
# <a name="obtaining-the-mib-ii-interfaces-table"></a>取得 MIB II 介面資料表

下列程式碼會使用 [**MprAdminMIBEntryGet**](/windows/desktop/api/Mprapi/nf-mprapi-mpradminmibentryget) ，從本機電腦取得 MIB II 介面資料表。
...
[**MIB 不 \_ 透明 \_ 資訊**](/windows/desktop/api/iprtrmib/ns-iprtrmib-mib_opaque_info)
</dt> <dt>

[**MIB 不 \_ 透明 \_ 查詢**](/windows/desktop/api/iprtrmib/ns-iprtrmib-mib_opaque_query)
</dt> <dt>
