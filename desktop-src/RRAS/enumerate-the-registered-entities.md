...
ms.locfileid: "106967426"
---
# <a name="enumerate-the-registered-entities"></a><span data-ttu-id="39575-103">列舉已註冊的實體</span><span class="sxs-lookup"><span data-stu-id="39575-103">Enumerate the Registered Entities</span></span>

<span data-ttu-id="39575-104">下列範例程式碼示範如何建立已註冊之用戶端的列舉，以及如何從路由表管理員取得用戶端資訊。</span><span class="sxs-lookup"><span data-stu-id="39575-104">The following sample code shows how to create an enumeration of registered clients and obtain the client information from the routing table manager.</span></span>
