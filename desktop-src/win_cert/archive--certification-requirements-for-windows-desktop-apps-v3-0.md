...
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v30"></a>封存： Windows 傳統型應用程式的認證需求3.0 版
...
Windows 應用程式認證套件用來驗證這些需求是否符合規範，以及取代在 Windows 7 軟體標誌計畫中用於驗證的 WSLK。 Windows 應用程式認證套件是 Windows 軟體開發套件 (SDK) 中包含的其中一個元件，適用于 Windows 8。 它也會整合到 Microsoft Visual Studio 2012 Express for Windows 8 中。
