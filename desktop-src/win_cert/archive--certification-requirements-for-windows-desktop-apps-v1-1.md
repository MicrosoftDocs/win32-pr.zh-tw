---
title: Windows 桌面應用程式的封存認證需求 v1。1
description: 檔1.1 版檔日期：1月26日，2012檔包含傳統型應用程式必須符合的技術需求和資格資格，才能參與 Windows 8 的桌面應用程式認證計畫。
...
ms.locfileid: "111444239"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v11"></a>封存： Windows 桌面應用程式的認證需求 v1。1
