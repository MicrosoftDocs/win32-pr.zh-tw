...
| <span id="NCRYPT_SCHANNEL_SIGNATURE_INTERFACE"></span><span id="ncrypt_schannel_signature_interface"></span><dl> <dt>**NCRYPT \_SCHANNEL 簽章 \_ \_ 介面**</dt> <dt>0x00010003</dt> </dl>          | Schannel 加密套件介面。<br/> **Windows server 2008、Windows Vista、Windows Server 2003、Windows XP 和 Windows 2000：** 不支援這個值。<br/> |
