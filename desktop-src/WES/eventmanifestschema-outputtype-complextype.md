...
| 輸出類型                    | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|--------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| xs:string                      | 文字資料。 此類型對 UnicodeString 和 AnsiString 輸入類型有效。 從隨附于 Windows Server 2016 SDK 或更新版本的 mc.exe (mc.exe 版本10.0.14251 或更新版本) 中，此類型也適用于 Int8、UInt8 和 UInt16 輸入類型，在這種情況下，資料會轉譯為單一字元。                                                                                                                                                                                                                                                                                                           |
...
| xs:float                       | 4 位元組浮點數。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| xs:double                      | 8 位元組浮點數。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| xs:boolean                     | 布林值。 此類型對於布林輸入類型有效，表示對應至 Win32 BOOL 類型的32位布林值。 從隨附于 Windows Server 2016 SDK 或更新版本的 mc.exe (mc.exe 版本10.0.14251 或更新版本) ，此類型也適用于 UInt8 輸入類型，表示對應至 c + + bool 和 Win32 布林值類型的8位布林值。                                                                                                                                                                                                                                             |
