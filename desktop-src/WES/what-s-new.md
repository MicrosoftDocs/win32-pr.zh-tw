---
title: " (Windows 事件記錄) 的新功能"
description: 此頁面摘要說明每個版本的 Windows 事件記錄檔 API 中新增的功能。
...
ms.locfileid: "119904118"
---
# <a name="whats-new-windows-event-log"></a> (Windows 事件記錄) 的新功能

此頁面摘要說明每個版本的 Windows 事件記錄檔 API 中新增的功能。
...
下列是針對 Windows 7 版 Windows SDK 隨附的 [**訊息編譯器**](message-compiler--mc-exe-.md)版本進行的變更：
