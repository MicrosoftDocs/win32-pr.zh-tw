...
---
# <a name="windows-event-log-reference"></a>Windows 事件記錄檔參考
...
-   [Windows 事件記錄檔常數](windows-event-log-constants.md)
-   [Windows 事件記錄檔資料類型](windows-event-log-data-types.md)
-   [Windows 事件記錄檔列舉](windows-event-log-enumerations.md)
-   [Windows 事件記錄檔函數](windows-event-log-functions.md)
-   [Windows 事件記錄檔結構](windows-event-log-structures.md)
-   [Windows 事件記錄檔工具](windows-event-log-tools.md)
