...
ms.locfileid: "120056238"
---
# <a name="window-macros"></a>視窗宏

-   [**取得 \_ X \_ LPARAM**](/windows/win32/api/windowsx/nf-windowsx-get_x_lparam)
-   [**取得 \_ Y \_ LPARAM**](/windows/win32/api/windowsx/nf-windowsx-get_y_lparam)
