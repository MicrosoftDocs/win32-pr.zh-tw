...
Microsoft RPC 只支援 [**ncacn \_ np**](/windows/desktop/Midl/ncacn-np)和 [**ncalrpc**](/windows/desktop/Midl/ncalrpc)的 Windows 安全性功能。 其他傳輸的安全性選項會被忽略。
