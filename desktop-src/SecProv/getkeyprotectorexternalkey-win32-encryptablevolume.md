...
ms.locfileid: "119667888"
---
# <a name="getkeyprotectorexternalkey-method-of-the-win32_encryptablevolume-class"></a>Win32 EncryptableVolume 類別的 GetKeyProtectorExternalKey 方法 \_

[**Win32 \_ EncryptableVolume**](win32-encryptablevolume.md)類別的 **GetKeyProtectorExternalKey** 方法會針對適當類型的指定金鑰保護裝置，抓取外部金鑰。

金鑰保護裝置識別碼必須參考「外部金鑰」、「TPM 和 PIN 和啟動金鑰」或「TPM 和啟動金鑰」類型的金鑰保護裝置。
...
位元組陣列，指定可以用來解除鎖定對應磁片區的256位外部索引鍵。
