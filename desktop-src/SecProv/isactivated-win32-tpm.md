...
---
# <a name="isactivated-method-of-the-win32_tpm-class"></a>Win32 Tpm 類別的 IsActivated 方法 \_

[**Win32 \_ Tpm**](win32-tpm.md)類別的 **IsActivated** 方法會指出裝置是否已啟用。
...
停用類似于停用，但可能發生操作狀態變更。 根據受信任的運算群組 (TCG) 1.2 規格，只有在裝置處於停用狀態時，才能使用下列命令。
