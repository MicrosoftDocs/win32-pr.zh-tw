...
ms.locfileid: "118890853"
---
# <a name="win32_tpmisautoprovisioningenabled-method"></a>Win32 \_ Tpm：： IsAutoProvisioningEnabled 方法

指出是否已啟用 TPM 的自動布建。 預設會啟用 Windows 8 和 Windows Server 2012 的自動布建。
...
*IsAutoProvisioningEnabled* \[擴展\]
</dt> <dd>

如果已啟用 TPM 自動布建，則設定為 **TRUE** 。
