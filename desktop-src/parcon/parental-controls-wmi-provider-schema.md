---
description: 家長監護是實例和方法提供者。 新類別實例的具現化、讀取或修改現有的實例屬性，以及方法的調用是由 Wpcsprov mof 檔案所控制。
...
---
# <a name="parental-controls-wmi-provider-schema"></a><span data-ttu-id="745a2-104">家長監護的 WMI 提供者架構</span><span class="sxs-lookup"><span data-stu-id="745a2-104">Parental Controls WMI Provider Schema</span></span>

<span data-ttu-id="745a2-105">家長監護是實例和方法提供者。</span><span class="sxs-lookup"><span data-stu-id="745a2-105">The Parental Controls WMI Provider is an instance and method provider.</span></span> <span data-ttu-id="745a2-106">新類別實例的具現化、讀取或修改現有的實例屬性，以及方法的調用是由 Wpcsprov mof 檔案所控制。</span><span class="sxs-lookup"><span data-stu-id="745a2-106">Instantiation of new class instances, reading or modification of existing instance properties, and invocation of methods is controlled by the Wpcsprov.mof file.</span></span>

<span data-ttu-id="745a2-107">下列語法來自命名空間。 mof</span><span class="sxs-lookup"><span data-stu-id="745a2-107">The following syntax is from Namespace.mof</span></span>
...
<span data-ttu-id="745a2-108">以下是來自評等的語法。</span><span class="sxs-lookup"><span data-stu-id="745a2-108">The following syntax is from Ratings.mof</span></span>
...
<span data-ttu-id="745a2-109">以下是來自 WpcSettings 的語法。</span><span class="sxs-lookup"><span data-stu-id="745a2-109">The following syntax is from WpcSettings.mof</span></span>
...
<span data-ttu-id="745a2-110">以下是來自 WpcProvider 的語法。</span><span class="sxs-lookup"><span data-stu-id="745a2-110">The following syntax is from WpcProvider.mof</span></span>
