...
在 Windows 2000 和 Windows XP 上，需要系統管理許可權才能使用 Msizap.exe。

此工具僅適用于[Windows Installer 開發人員的 Windows SDK 元件](platform-sdk-components-for-windows-installer-developers.md)，不應轉散發。 使用 Msizap.exe (版本3.1.4000.2726 或) 更高版本的最新版本，Windows Installer Vista 或更高版本的開發人員可在 Windows SDK 元件中取得。 較低版本的 Msizap.exe 可以移除已套用至使用者電腦上其他應用程式之所有更新的相關資訊。 如果移除此資訊，可能需要移除並重新安裝這些其他應用程式才能接收其他更新。
