...
---
# <a name="sample-ice-in-c"></a><span data-ttu-id="e5f93-106">C + + 中的範例 ICE</span><span class="sxs-lookup"><span data-stu-id="e5f93-106">Sample ICE in C++</span></span>

<span data-ttu-id="e5f93-107">此範例程式碼來自 ( [ICE01](ice01.md)) 的 ICE 自訂動作。</span><span class="sxs-lookup"><span data-stu-id="e5f93-107">This sample code is from an ICE custom action ( [ICE01](ice01.md)).</span></span> <span data-ttu-id="e5f93-108">它會藉由顯示時間來驗證 ICE 機制是否正常運作。</span><span class="sxs-lookup"><span data-stu-id="e5f93-108">It validates that the ICE mechanism is working by displaying the time.</span></span> <span data-ttu-id="e5f93-109">ICE 張貼訊息，提供安裝程式呼叫 ICE 的時間。</span><span class="sxs-lookup"><span data-stu-id="e5f93-109">The ICE posts a message giving the time the installer called the ICE.</span></span> <span data-ttu-id="e5f93-110">這種 ICE 絕對不會傳回錯誤。</span><span class="sxs-lookup"><span data-stu-id="e5f93-110">This ICE should never return an error.</span></span>
