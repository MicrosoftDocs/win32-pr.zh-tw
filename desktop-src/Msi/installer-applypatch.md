...
如果 *InstallType* 是 msiInstallTypeSingleInstance，則安裝程式會將修補程式套用至 *InstallPackage* 所指定的產品。 在此情況下，會忽略 patch 套件中所列的其他合格產品，且 *InstallPackage* 參數會包含以 null 終止的字串，代表要修補之實例的產品代碼。 這種類型的安裝需要 Windows Server 2003 或更新版本或 Windows Installer XP SP1 或更新版本隨附的 Windows Installer 版本。
