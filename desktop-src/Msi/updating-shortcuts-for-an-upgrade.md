...
範例升級套件會更新新檔案和功能的快捷方式。

使用您的資料庫編輯器開啟 MNP2001.msi，並在 [快捷方式資料表](shortcut-table.md)中輸入下列資料。
...
| sMemorial   | MENUDIR     | Memori01.txt   | 紀念    | \[\#Memori01.txt\]   |           |             |        |                |           |         |       |
| sBasketball | MENUDIR     | Basketba01.txt | 籃球  | \[\#Basketba01.txt\] |           |             |        |                |           |         |       |
...
[繼續](updating-upgrade-table-for-an-upgrade.md)
