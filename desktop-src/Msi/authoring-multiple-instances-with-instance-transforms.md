...
-   您的安裝程式應用程式可以檢查在版本的 Windows Vista、Windows Server 2003、Windows XP Service Pack 1 (SP1) 和 Windows Installer 3.0 可轉散發套件上執行的安裝程式是否存在。  (或更新版本) 的任何安裝程式版本都必須使用產品程式碼-變更轉換，從單一套件安裝多個實例。
