...
ms.locfileid: "106977714"
---
# <a name="componentinfostate-property"></a>ComponentInfo。 State 屬性

元件的狀態。 這個屬性會呼叫 [**MsiGetComponentPathEx**](/windows/desktop/api/Msi/nf-msi-msigetcomponentpathexa) 函數。
