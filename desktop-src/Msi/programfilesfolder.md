---
description: 安裝程式會將 ProgramFilesFolder 屬性設定為 [Program Files] 資料夾的完整路徑。
ms.assetid: 3ce700f1-ef35-4226-b78d-eeba97f4dbde
title: ProgramFilesFolder 屬性
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "118627338"
---
# <a name="programfilesfolder-property"></a>ProgramFilesFolder 屬性

安裝程式會將 **ProgramFilesFolder** 屬性設定為 [Program Files] 資料夾的完整路徑。
