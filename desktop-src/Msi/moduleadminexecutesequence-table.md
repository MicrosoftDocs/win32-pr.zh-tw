...
ms.locfileid: "118628714"
---
# <a name="moduleadminexecutesequence-table"></a>ModuleAdminExecuteSequence 資料表

合併工具會評估 ModuleAdminExecuteSequence 資料表，然後將計算的動作以正確的序號插入 [AdminExecuteSequence 資料表](adminexecutesequence-table.md) 中。

ModuleAdminExecuteSequence 資料表具有下列資料行。
...
如果這個資料表存在，則 [AdminExecuteSequence 資料表](adminexecutesequence-table.md) 也必須存在於合併模組中。
