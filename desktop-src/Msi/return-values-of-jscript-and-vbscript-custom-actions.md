---
description: 以 JScript 或 Visual Basic 撰寫的自訂動作、腳本版本 (VBScript) 都可以呼叫選擇性的函式。 這些函數必須傳回下表所示的其中一個值。
ms.assetid: f05d0b94-e79e-440e-9f2b-99fe0e9e2646
title: 傳回 JScript 和 VBScript 自訂動作的值
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118626088"
---
# <a name="return-values-of-jscript-and-vbscript-custom-actions"></a>傳回 JScript 和 VBScript 自訂動作的值

以 JScript 或 Visual Basic 撰寫的自訂動作、腳本版本 (VBScript) 都可以呼叫選擇性的函式。 這些函數必須傳回下表所示的其中一個值。
...
| msiDoActionStatusFailure  | IDABORT = 3  | 無法復原的錯誤。 如果在剖析或執行 JScript 或 VBScript 時發生錯誤，則傳回。 |
