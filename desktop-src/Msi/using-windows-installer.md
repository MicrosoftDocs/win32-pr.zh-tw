...
本節說明如何使用 Windows Installer 將應用程式組織成元件，以及從網際網路位置下載應用程式：
...
-   [使用 Windows Installer 與終端機伺服器](using-windows-installer-with-a-terminal-server.md)
...
-   [在安裝期間隱藏 [取消] 按鈕](hiding-the-cancel-button-during-an-installation.md)
-   [搭配使用 Windows Installer 與 UAC](using-windows-installer-with-uac.md)
-   [搭配使用 Windows Installer 與重新開機管理員](using-windows-installer-with-restart-manager.md)
