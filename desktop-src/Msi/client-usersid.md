...
ms.locfileid: "106982623"
---
# <a name="clientusersid-property"></a>UserSID 屬性

元件的使用者 SID。 這個屬性會呼叫 [**MsiEnumClientsEx**](/windows/desktop/api/Msi/nf-msi-msienumclientsexa) 函數。
