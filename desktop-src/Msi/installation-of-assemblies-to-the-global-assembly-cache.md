...
請注意，在每個使用者[安裝內容](installation-context.md)中，安裝安裝到全域組件快取的元件不會受到 Windows 檔案保護的保護。 在每部電腦安裝內容中，安裝安裝到全域組件快取的元件會受到[Windows 資源保護](../wfp/windows-resource-protection-portal.md)的保護。
