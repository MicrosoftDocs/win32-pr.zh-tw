---
description: 安裝程式物件的唯讀 PatchInfo 屬性會傳回修補程式的相關資訊。
...
ms.locfileid: "119580688"
---
# <a name="installerpatchinfo-property"></a>PatchInfo 屬性

[**安裝程式**](installer-object.md)物件的唯讀 **PatchInfo** 屬性會傳回修補程式的相關資訊。
