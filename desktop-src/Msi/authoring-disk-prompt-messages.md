...
1.  您可以使用安裝程式的撰寫功能，在 [屬性](property-table.md)表中設定 [**DiskPrompt**](diskprompt.md)屬性字串。 這應該包含要安裝的產品名稱，以及在磁片上列印的標題字串內的預留位置參數。 例如，Microsoft Publisher **DiskPrompt** 屬性可以是 "Microsoft Publisher： disk \[ 1 \] "，其中 \[ 1 \] 是磁片標題的預留位置。
