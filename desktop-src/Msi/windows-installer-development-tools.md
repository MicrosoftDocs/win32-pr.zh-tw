...
| [Msiinfo.exe](msiinfo-exe.md)   | 編輯或顯示 [摘要資訊串流](summary-information-stream.md)。                                                                                                                                                                  |
| [Msimerg.exe](msimerg-exe.md)   | 將一個資料庫合併到另一個資料庫。                                                                                                                                                                                                                |
| [Msimsp.exe](msimsp-exe.md)     | 修補程式建立工具。 產生修補程式套件的建議方法是使用修補程式建立工具，例如 Msimsp.exe 與 PATCHWIZ.DLL。                                                                                                 |
| [Msistuff.exe](msistuff-exe.md) | 顯示或設定 Setup.exe 啟動程式可執行檔中的資源。                                                                                                                                                                      |
| [Msitool mak](msitool-mak.md)   | 可以用來建立工具和自訂動作的 Makefile。                                                                                                                                                                                      |
| [Msitran.exe](msitran-exe.md)   | 產生轉換，或將轉換檔案套用至資料庫。                                                                                                                                                                                 |
