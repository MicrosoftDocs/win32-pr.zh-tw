...
本主題提供定義三個顯示清單的程式碼鳶尾花 GL 範例;其中一個顯示清單會參考其定義中的其他顯示清單。 遵循鳶尾花 GL 範例即為程式碼在移植至 OpenGL 時的外觀範例。

## <a name="iris-gl-sample-display-list-code"></a>鳶尾花 GL 範例顯示清單程式碼
...
## <a name="opengl-sample-display-list-code"></a>OpenGL 範例顯示清單程式碼

以下是將上述鳶尾花 GL 程式碼轉譯為 OpenGL：
