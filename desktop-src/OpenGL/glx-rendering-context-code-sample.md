...
---
# <a name="glx-rendering-context-code-sample"></a><span data-ttu-id="f8f35-108">GLX 轉譯內容程式碼範例</span><span class="sxs-lookup"><span data-stu-id="f8f35-108">GLX Rendering Context Code Sample</span></span>

<span data-ttu-id="f8f35-109">下列程式碼範例會示範 X 視窗系統 OpenGL 程式如何使用 GLX 轉譯內容函數。</span><span class="sxs-lookup"><span data-stu-id="f8f35-109">The following code sample shows how an X Window System OpenGL program uses GLX rendering context functions.</span></span>
