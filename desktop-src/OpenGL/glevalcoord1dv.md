...
---
# <a name="glevalcoord1dv-function"></a>glEvalCoord1dv 函式

[**GlEvalCoord1dv**](glevalcoord1d.md)函數會評估啟用的一維對應。
...
**GlEvalCoord1dv** 函式會評估在引數 *u* 啟用一維的地圖。 使用 [**glMap1**](glmap1.md)定義對應。 使用 [**glEnable**](glenable.md) 和 [**glDisable**](gldisable.md)來啟用或停用它們。
...
下列函式會取出與 **glEvalCoord1dv** 函數相關的資訊：
