...
-   [移植 X 視窗系統應用程式](porting-x-window-system-applications.md)
-   [翻譯 GLX 程式庫](translating-the-glx-library.md)
-   [移植裝置內容和像素格式](porting-device-contexts-and-pixel-formats.md)
-   [移植轉譯內容](porting-rendering-contexts.md)
-   [移植 GLX Pixmap 程式碼](porting-glx-pixmap-code.md)
-   [移植其他 GLX 程式碼](porting-other-glx-code.md)
-   [移植範例](a-porting-sample.md)
