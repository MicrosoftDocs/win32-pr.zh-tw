...
ms.locfileid: "120128018"
---
# <a name="glpopmatrix-function"></a>glPopMatrix 函式

[**GlPushMatrix**](glpushmatrix.md)和 **glPopMatrix** 函式會推送並取出目前的矩陣堆疊。
...
[**GlPushMatrix**](glpushmatrix.md)函式會將目前的矩陣堆疊向下推一，以複製目前的矩陣。 也就是說，在 **glPushMatrix** 呼叫之後，堆疊頂端的矩陣與下面的矩陣相同。 **GlPopMatrix** 函式會取出目前的矩陣堆疊，並將目前的矩陣取代為堆疊上的下一個矩陣。 一開始，每個堆疊都會包含一個矩陣，也就是一個識別矩陣。

下列函式會取出 [**glPushMatrix**](glpushmatrix.md) 和 **glPopMatrix** 的相關資訊：
