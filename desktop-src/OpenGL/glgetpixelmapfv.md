...
ms.locfileid: "119554258"
---
# <a name="glgetpixelmapfv-function"></a>glGetPixelMapfv 函式

**GlGetPixelMapfv**、 [**glGetPixelMapuiv**](glgetpixelmapuiv.md)和 [**glGetPixelMapusv**](glgetpixelmapusv.md)函數會傳回指定的圖元對應。
