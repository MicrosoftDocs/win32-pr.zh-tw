...
ms.locfileid: "119493798"
---
# <a name="glgettexgendv-function"></a>glGetTexGendv 函式

**GlGetTexGendv**、 [**glGetTexGenfv**](glgettexgenfv.md)和 [**glGetTexGeniv**](glgettexgeniv.md)函數會傳回材質座標產生參數。
