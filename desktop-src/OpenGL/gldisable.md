...
ms.locfileid: "119625728"
---
# <a name="gldisable-function"></a>glDisable 函式

[**GlEnable**](glenable.md)和 **glDisable** 函數會啟用或停用 OpenGL 功能。
...
[**GlEnable**](glenable.md)和 **glDisable** 函式會啟用和停用各種 OpenGL 圖形功能。 使用 [**glIsEnabled**](glisenabled.md) 或 [**glGet**](glgetbooleanv--glgetdoublev--glgetfloatv--glgetintegerv.md) 來判斷任何功能目前的設定。

[**GlEnable**](glenable.md)和 **glDisable** 都採用單一引數（ *cap*），其可採用下列其中一個值：
