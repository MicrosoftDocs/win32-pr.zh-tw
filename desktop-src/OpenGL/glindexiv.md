...
ms.locfileid: "119493437"
---
# <a name="glindexiv-function"></a>glIndexiv 函式

**GlIndexiv** 函數會設定目前的色彩索引。
...
**GlIndexiv** 函式會更新目前 (單一值) 色彩索引。 它會採用一個引數：目前色彩索引的新值。
...
您可以隨時更新目前的索引。 尤其是，在呼叫 [**glBegin**](/windows/desktop/OpenGL/glbegin)和對應的 [**glEnd**](glend.md)呼叫之間，可以呼叫 **glIndexiv** 。

下列函式會抓取 **glIndexiv** 的相關資訊：
