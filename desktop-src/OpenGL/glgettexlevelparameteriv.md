...
ms.locfileid: "118359764"
---
# <a name="glgettexlevelparameteriv-function"></a>glGetTexLevelParameteriv 函式

[**GlGetTexLevelParameterfv**](glgettexlevelparameterfv.md)和 **glGetTexLevelParameteriv** 函數會傳回特定詳細資料層級的材質參數值。
