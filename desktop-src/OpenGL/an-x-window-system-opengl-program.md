...
---
# <a name="an-x-window-system-opengl-program"></a>X 視窗系統 OpenGL 程式

下列程式是具有 AUXEDEMO 中所使用之相同 OpenGL 程式碼的 X Window 系統 OpenGL 程式。Microsoft Platform SDK 提供的 C 範例程式。 將此程式與 [移植至 Windows 的程式](the-program-ported-to-win32.md)中的 windows OpenGL 程式進行比較。
