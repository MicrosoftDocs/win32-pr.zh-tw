---
title: X 視窗系統 OpenGL 程式
description: 下列程式是具有 AUXEDEMO 中所使用之相同 OpenGL 程式碼的 X Window 系統 OpenGL 程式。Microsoft Platform SDK 提供的 C 範例程式。 將此程式與移植至 Windows 的程式中的 Windows OpenGL 程式進行比較。
...
ms.locfileid: "106996348"
---
# <a name="an-x-window-system-opengl-program"></a><span data-ttu-id="914d5-107">X 視窗系統 OpenGL 程式</span><span class="sxs-lookup"><span data-stu-id="914d5-107">An X Window System OpenGL Program</span></span>

<span data-ttu-id="914d5-108">下列程式是具有 AUXEDEMO 中所使用之相同 OpenGL 程式碼的 X Window 系統 OpenGL 程式。Microsoft Platform SDK 提供的 C 範例程式。</span><span class="sxs-lookup"><span data-stu-id="914d5-108">The following program is an X Window System OpenGL program with the same OpenGL code used in the AUXEDEMO.C sample program supplied with the Microsoft Platform SDK.</span></span> <span data-ttu-id="914d5-109">將此程式與 [移植至 Windows 的程式](the-program-ported-to-win32.md)中的 windows OpenGL 程式進行比較。</span><span class="sxs-lookup"><span data-stu-id="914d5-109">Compare this program with the Windows OpenGL program in [The Program Ported to Windows](the-program-ported-to-win32.md).</span></span>
