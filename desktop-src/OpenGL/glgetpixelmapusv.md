...
ms.locfileid: "119494128"
---
# <a name="glgetpixelmapusv-function"></a>glGetPixelMapusv 函式

[**GlGetPixelMapfv**](glgetpixelmapfv.md)、 [**glGetPixelMapuiv**](glgetpixelmapuiv.md)和 **glGetPixelMapusv** 函數會傳回指定的圖元對應。
