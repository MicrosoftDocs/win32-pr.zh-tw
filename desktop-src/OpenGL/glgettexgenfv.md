...
ms.locfileid: "119493788"
---
# <a name="glgettexgenfv-function"></a>glGetTexGenfv 函式

[**GlGetTexGendv**](glgettexgendv.md)、 **glGetTexGenfv** 和 [**glGetTexGeniv**](glgettexgeniv.md)函數會傳回材質座標產生參數。
