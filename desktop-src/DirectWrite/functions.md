---
title: DirectWrite 函式
description: DirectWrite 提供下列功能。 所有其他作業都是使用由下列函式所建立的 IDWriteFactory 物件所建立的 DirectWrite 介面物件來執行。
...
DirectWrite 提供下列功能。 所有其他作業都是使用由下列函式所建立的 [**IDWriteFactory**](/windows/win32/api/dwrite/nn-dwrite-idwritefactory) 物件所建立的 DirectWrite 介面物件來執行。
