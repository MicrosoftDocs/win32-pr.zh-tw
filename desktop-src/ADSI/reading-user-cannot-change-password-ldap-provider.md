...
4.  列舉物件 (ACE) 的存取控制專案，並搜尋具有 [ [**IADsAccessControlEntry**](iadsaccesscontrolentry-property-methods.md) ] 屬性的 [變更密碼 GUID] ( {AB721A53-1E2F-11D0-9819-00AA0040529B} ) 的 ace，以及 [所有人] 或 [NT 授權單位 \\ ] 的 **IADsAccessControlEntry。**
    > [!Note]  
...
下列程式碼範例示範如何判斷使用者是否無法使用 LDAP 提供者來變更密碼許可權。
