...
---
# <a name="example-code-for-reading-a-constructed-attribute"></a><span data-ttu-id="f54d6-104">用於讀取已建立之屬性的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="f54d6-104">Example Code for Reading a Constructed Attribute</span></span>

<span data-ttu-id="f54d6-105">下列程式碼範例會示範可用來抓取屬性值的方法，該屬性值可搭配所有屬性類型使用。</span><span class="sxs-lookup"><span data-stu-id="f54d6-105">The following code example shows a method that can be used to retrieve an attribute value that will work with all attributes types.</span></span>
...
<span data-ttu-id="f54d6-106">下列程式碼範例會示範可用來抓取屬性值的方法，該屬性值可搭配所有屬性類型使用。</span><span class="sxs-lookup"><span data-stu-id="f54d6-106">The following code example shows a method that can be used to retrieve an attribute value that will work with all attributes types.</span></span>
