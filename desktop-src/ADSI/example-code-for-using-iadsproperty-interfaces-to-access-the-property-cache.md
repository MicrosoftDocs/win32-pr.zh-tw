...
---
# <a name="example-code-for-using-iadsproperty-interfaces-to-access-the-property-cache"></a><span data-ttu-id="2f05f-105">使用 IADsProperty 介面存取屬性快取的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="2f05f-105">Example Code for Using IADsProperty Interfaces to Access the Property Cache</span></span>

<span data-ttu-id="2f05f-106">下列程式碼範例示範如何搭配 c + + 和 ADSI 使用 [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist)、 [**IADsPropertyEntry**](/windows/desktop/api/Iads/nn-iads-iadspropertyentry)和 [**IADsPropertyValue**](/windows/desktop/api/Iads/nn-iads-iadspropertyvalue) 介面。</span><span class="sxs-lookup"><span data-stu-id="2f05f-106">The following code example shows how to use the [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist), [**IADsPropertyEntry**](/windows/desktop/api/Iads/nn-iads-iadspropertyentry), and [**IADsPropertyValue**](/windows/desktop/api/Iads/nn-iads-iadspropertyvalue) interfaces with C++ and ADSI.</span></span>
...
<span data-ttu-id="2f05f-107">下列程式碼範例示範如何使用 Visual Basic 和 ADSI 來使用 [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist)、 [**IADsPropertyEntry**](/windows/desktop/api/Iads/nn-iads-iadspropertyentry)和 [**IADsPropertyValue**](/windows/desktop/api/Iads/nn-iads-iadspropertyvalue) 介面。</span><span class="sxs-lookup"><span data-stu-id="2f05f-107">The following code example shows how to use the [**IADsPropertyList**](/windows/desktop/api/Iads/nn-iads-iadspropertylist), [**IADsPropertyEntry**](/windows/desktop/api/Iads/nn-iads-iadspropertyentry), and [**IADsPropertyValue**](/windows/desktop/api/Iads/nn-iads-iadspropertyvalue) interfaces using Visual Basic and ADSI.</span></span>
