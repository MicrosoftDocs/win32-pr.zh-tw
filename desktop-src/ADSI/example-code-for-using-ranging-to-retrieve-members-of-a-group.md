...
---
# <a name="example-code-for-using-ranging-to-retrieve-members-of-a-group"></a><span data-ttu-id="7283c-105">使用範圍取得群組成員的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="7283c-105">Example Code for Using Ranging to Retrieve Members of a Group</span></span>

<span data-ttu-id="7283c-106">下列程式碼範例使用的範圍與 ActiveX 目錄物件 (ADO) 取得群組的成員。</span><span class="sxs-lookup"><span data-stu-id="7283c-106">The following code example uses ranging with ActiveX Directory Objects (ADO) to retrieve the members of a group.</span></span>

<span data-ttu-id="7283c-107">下列程式碼片段需要 Microsoft ActiveX Data Objects 6.0 程式庫的參考。</span><span class="sxs-lookup"><span data-stu-id="7283c-107">The following code snippet requires a reference to Microsoft ActiveX Data Objects 6.0 Library.</span></span>
