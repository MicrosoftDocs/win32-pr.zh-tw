...
ms.locfileid: "118692788"
---
# <a name="adsi-winnt-provider"></a>ADSI WinNT 提供者

Microsoft ADSI 提供者會執行一組 ADSI 物件來支援各種 ADSI 介面。 Windows 提供者的命名空間名稱是「winnt」，而此提供者通常稱為 winnt 提供者。 若要存取 WinNT 提供者，請使用[Winnt AdsPath](winnt-adspath.md)系結至 winnt 的任何[ADSI 物件](adsi-objects-of-winnt.md)。

WinNT 提供者包含在 Windows 和 Windows Server 的 ADSI 系統元件中。
