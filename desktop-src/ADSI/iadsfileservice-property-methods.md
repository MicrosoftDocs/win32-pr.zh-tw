...
---
# <a name="iadsfileservice-property-methods"></a>IADsFileService 屬性方法

[**IADsFileService**](/windows/desktop/api/Iads/nn-iads-iadsfileservice)介面的屬性方法會取得或設定下表所述的屬性。 如需詳細資訊，請參閱 [介面屬性方法](interface-property-methods.md)。
...
您必須經過檔案服務，才能存取電腦上的檔案共用、會話和資源。

## <a name="examples"></a>範例

下列程式碼範例會寫入的描述，並檢查檔案服務的使用者限制。
...
| IID<br/>                      | IID \_ IADsFileService 定義為 A89D1900-31CA-11CF-A98A-00AA006BC149<br/>      |
