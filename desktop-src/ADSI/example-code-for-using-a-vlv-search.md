...
ms.locfileid: "118428431"
---
# <a name="example-code-for-using-a-vlv-search"></a>使用 VLV 搜尋的範例程式碼

下列程式碼範例會使用 VLV 搜尋來取得搜尋結果。
...
## <a name="getvlvitemcount-example-function"></a>GetVLVItemCount 範例函式

下列程式碼範例示範如何使用 VLV 搜尋來取得搜尋所產生的專案數估計。
...
## <a name="getvlvitemtext-example-function"></a>GetVLVItemText 範例函式

下列程式碼範例示範如何使用 VLV 搜尋，根據索引取得單一專案的文字。
...
## <a name="getvlvitemsbystring-example-function"></a>GetVLVItemsByString 範例函式

下列程式碼範例示範如何使用 VLV 搜尋來取得以字串為基礎之指定專案數目的文字。 此範例會將抓取的 sortings 新增到清單方塊中。
