...
---
# <a name="example-code-for-adding-an-ace-to-a-file"></a>將 ACE 新增至檔案的範例程式碼

下列程式碼範例示範如何使用 [**IADsSecurityUtility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) 介面將 ACE 新增至檔案。
