---
title: 使用 >idirectorysearch 進行範圍的範例程式碼
description: 下列程式碼範例使用範圍，以使用 >idirectorysearch 介面抓取群組的成員。
ms.assetid: 13aba22f-c649-4dda-804f-01ba493cd6d7
ms.tgt_platform: multiple
keywords:
- 使用 >idirectorysearch ADSI 進行範圍的範例程式碼
- 範圍抓取 ADSI，範例程式碼，使用 >idirectorysearch
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "117839998"
---
# <a name="example-code-for-ranging-with-idirectorysearch"></a>使用 >idirectorysearch 進行範圍的範例程式碼

下列程式碼範例使用範圍，以使用 [**>idirectorysearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) 介面抓取群組的成員。
