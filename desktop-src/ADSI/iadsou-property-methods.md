...
ms.locfileid: "118179525"
---
# <a name="iadsou-property-methods"></a>IADsOU 屬性方法

[**IADsOU**](/windows/desktop/api/Iads/nn-iads-iadsou)介面的屬性方法會取得或設定下表所列的屬性。 如需詳細資訊，請參閱 [介面屬性方法](interface-property-methods.md)。
...
下列程式碼範例會顯示容器中所有組織單位的 **BusinessCategory** 和 **描述** 。 它會假設基礎目錄服務支援依組織單位來分組目錄物件。
...
| IID<br/>                      | IID \_ IADsOU 定義為 A2F733B8-EFFE-11CF-8ABC-00C04FD8D503<br/>               |
