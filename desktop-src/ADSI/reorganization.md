...
1.  開啟 Visual Basic 版本6.0，當系統提示您輸入專案類型時，請選取 [**資料 Project**。
2.  在 [**資料 Project** 上，按兩下 [**資料 Environment1**]。
...
8.  按兩下 **Project** 視窗中的 [**資料 report1.rdl** ]。
...
11. 在 [專案] 視窗中，以滑鼠右鍵按一下 [**資料 Project**]，然後選取 [ **DataProject 屬性**]。
12. 在 [ **DataProject-Project 屬性**] 對話方塊視窗的 [**啟始物件**] 下，從下拉式功能表中選取 [ **DataReport1** ]。 按一下 [確定]  以儲存。
