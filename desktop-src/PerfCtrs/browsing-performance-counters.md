...
---
# <a name="browsing-performance-counters"></a>流覽效能計數器

下列範例顯示如何呼叫 [**PdhBrowseCounters**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) 來流覽效能計數器。 此範例也會顯示如何收集和格式化原始計數器資料以供顯示。
