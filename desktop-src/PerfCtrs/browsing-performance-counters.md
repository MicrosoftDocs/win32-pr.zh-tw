...
ms.locfileid: "106979155"
---
# <a name="browsing-performance-counters"></a><span data-ttu-id="8d5a3-103">流覽效能計數器</span><span class="sxs-lookup"><span data-stu-id="8d5a3-103">Browsing Performance Counters</span></span>

<span data-ttu-id="8d5a3-104">下列範例顯示如何呼叫 [**PdhBrowseCounters**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) 來流覽效能計數器。</span><span class="sxs-lookup"><span data-stu-id="8d5a3-104">The following example shows how to call [**PdhBrowseCounters**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) to browse performance counters.</span></span> <span data-ttu-id="8d5a3-105">此範例也會顯示如何收集和格式化原始計數器資料以供顯示。</span><span class="sxs-lookup"><span data-stu-id="8d5a3-105">The example also shows how to collect and format raw counter data for display.</span></span>
