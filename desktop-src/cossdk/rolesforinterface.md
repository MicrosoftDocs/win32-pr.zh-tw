...
---
# <a name="rolesforinterface-collection"></a>RolesForInterface 集合

針對指派給集合所關聯之介面的每個角色，各包含一個物件。 角色必須已在應用層級指派。
...
**RolesForInterface** 集合繼承自 [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown)介面，但沒有其他成員。
