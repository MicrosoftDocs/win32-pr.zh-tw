...
description: 此範例示範如何使用服務 proxy 與使用自訂通道的 HTTP 型計算機服務交談。 自訂通道是分層通道，只會將所有功能委派給現有的 HTTP 通道。
ms.assetid: 897673df-f3a3-4b38-8b79-c9f1119be6d5
keywords:
- HttpCalculatorWithLayeredChannelClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="httpcalculatorwithlayeredchannelclientexample"></a><span data-ttu-id="333ca-107">HttpCalculatorWithLayeredChannelClientExample</span><span class="sxs-lookup"><span data-stu-id="333ca-107">HttpCalculatorWithLayeredChannelClientExample</span></span>

<span data-ttu-id="333ca-108">此範例示範如何使用服務 proxy 與使用自訂通道的 HTTP 型計算機服務交談。</span><span class="sxs-lookup"><span data-stu-id="333ca-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="333ca-109">自訂通道是分層通道，只會將所有功能委派給現有的 HTTP 通道。</span><span class="sxs-lookup"><span data-stu-id="333ca-109">The custom channel is a layered channel which simply delegates all functionality to the existing HTTP channel.</span></span>

-   [<span data-ttu-id="333ca-110">HttpCalculatorWithLayeredChannelClient .cpp</span><span class="sxs-lookup"><span data-stu-id="333ca-110">HttpCalculatorWithLayeredChannelClient.cpp</span></span>](#httpcalculatorwithlayeredchannelclientcpp)
-   [<span data-ttu-id="333ca-111">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="333ca-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="333ca-112">LayeredChannel。h</span><span class="sxs-lookup"><span data-stu-id="333ca-112">LayeredChannel.h</span></span>](#layeredchannelh)
-   [<span data-ttu-id="333ca-113">LayeredChannel .cpp</span><span class="sxs-lookup"><span data-stu-id="333ca-113">LayeredChannel.cpp</span></span>](#layeredchannelcpp)
-   [<span data-ttu-id="333ca-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="333ca-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithlayeredchannelclientcpp"></a><span data-ttu-id="333ca-115">HttpCalculatorWithLayeredChannelClient .cpp</span><span class="sxs-lookup"><span data-stu-id="333ca-115">HttpCalculatorWithLayeredChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="333ca-116">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="333ca-116">CalculatorService.wsdl</span></span>
...
## <a name="layeredchannelh"></a><span data-ttu-id="333ca-117">LayeredChannel。h</span><span class="sxs-lookup"><span data-stu-id="333ca-117">LayeredChannel.h</span></span>
...
## <a name="layeredchannelcpp"></a><span data-ttu-id="333ca-118">LayeredChannel .cpp</span><span class="sxs-lookup"><span data-stu-id="333ca-118">LayeredChannel.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="333ca-119">Makefile</span><span class="sxs-lookup"><span data-stu-id="333ca-119">Makefile</span></span>
