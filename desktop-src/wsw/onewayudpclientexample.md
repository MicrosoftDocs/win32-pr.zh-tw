...
description: 此範例顯示傳送單向訊息的 UDP 用戶端。
ms.assetid: 245876f7-dc79-4ecd-b510-cf5e60eaa9fc
keywords:
- OneWayUdpClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103932512"
---
# <a name="onewayudpclientexample"></a><span data-ttu-id="27ce9-106">OneWayUdpClientExample</span><span class="sxs-lookup"><span data-stu-id="27ce9-106">OneWayUdpClientExample</span></span>

<span data-ttu-id="27ce9-107">此範例顯示傳送單向訊息的 UDP 用戶端。</span><span class="sxs-lookup"><span data-stu-id="27ce9-107">This example shows a UDP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="27ce9-108">OneWayUdpClient .cpp</span><span class="sxs-lookup"><span data-stu-id="27ce9-108">OneWayUdpClient.cpp</span></span>](#onewayudpclientcpp)
-   [<span data-ttu-id="27ce9-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="27ce9-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="27ce9-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="27ce9-110">Makefile</span></span>](#makefile)

## <a name="onewayudpclientcpp"></a><span data-ttu-id="27ce9-111">OneWayUdpClient .cpp</span><span class="sxs-lookup"><span data-stu-id="27ce9-111">OneWayUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="27ce9-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="27ce9-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="27ce9-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="27ce9-113">Makefile</span></span>
