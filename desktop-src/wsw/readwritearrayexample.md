...
---
# <a name="readwritearrayexample"></a><span data-ttu-id="b2df0-106">ReadWriteArrayExample</span><span class="sxs-lookup"><span data-stu-id="b2df0-106">ReadWriteArrayExample</span></span>

<span data-ttu-id="b2df0-107">這個範例會讀取和寫入元素陣列。</span><span class="sxs-lookup"><span data-stu-id="b2df0-107">This example reads and writes an array of elements.</span></span>

## <a name="readwritearraycpp"></a><span data-ttu-id="b2df0-108">ReadWriteArray .cpp</span><span class="sxs-lookup"><span data-stu-id="b2df0-108">ReadWriteArray.cpp</span></span>
