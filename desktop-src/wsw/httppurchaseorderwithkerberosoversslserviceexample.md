---
title: HttpPurchaseOrderWithKerberosOverSslServiceExample
description: 此範例示範如何使用服務主機透過 HTTP （具有 kerberos over SSL 混合模式安全性）來裝載 PurchaseOrder 服務。
ms.assetid: 9fbf5577-6a54-4ce1-ad44-80b9ee91c0d3
keywords:
- HttpPurchaseOrderWithKerberosOverSslServiceExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106969864"
---
# <a name="httppurchaseorderwithkerberosoversslserviceexample"></a><span data-ttu-id="4d0fa-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="4d0fa-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span></span>

<span data-ttu-id="4d0fa-107">此範例示範如何使用服務主機透過 HTTP （具有 kerberos over SSL 混合模式安全性）來裝載 PurchaseOrder 服務。</span><span class="sxs-lookup"><span data-stu-id="4d0fa-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="4d0fa-108">在此設定中，傳輸連線會受到 SSL (簽署、加密) 的 SSL，也提供伺服器驗證。</span><span class="sxs-lookup"><span data-stu-id="4d0fa-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="4d0fa-109">用戶端驗證是由訊息的 WS-Security 標頭中的 kerberos APREQ 票證所提供。</span><span class="sxs-lookup"><span data-stu-id="4d0fa-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="4d0fa-110">PurchaseOrderServiceKerberosOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="4d0fa-110">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>](#purchaseorderservicekerberosoversslcpp)
-   [<span data-ttu-id="4d0fa-111">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="4d0fa-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="4d0fa-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="4d0fa-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderservicekerberosoversslcpp"></a><span data-ttu-id="4d0fa-113">PurchaseOrderServiceKerberosOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="4d0fa-113">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="4d0fa-114">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="4d0fa-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4d0fa-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="4d0fa-115">Makefile</span></span>
