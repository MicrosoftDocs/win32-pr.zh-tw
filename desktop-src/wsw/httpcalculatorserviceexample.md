...
description: 此範例示範如何使用服務主機，透過 HTTP 裝載計算機服務。
ms.assetid: 898bc206-ad64-461c-a734-c8791b6b106d
keywords:
- HttpCalculatorServiceExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="httpcalculatorserviceexample"></a><span data-ttu-id="f9b6f-106">HttpCalculatorServiceExample</span><span class="sxs-lookup"><span data-stu-id="f9b6f-106">HttpCalculatorServiceExample</span></span>

<span data-ttu-id="f9b6f-107">此範例示範如何使用服務主機，透過 HTTP 裝載計算機服務。</span><span class="sxs-lookup"><span data-stu-id="f9b6f-107">This example shows how to use service host for hosting a calculator service over HTTP.</span></span>

-   [<span data-ttu-id="f9b6f-108">HttpCalculatorService .cpp</span><span class="sxs-lookup"><span data-stu-id="f9b6f-108">HttpCalculatorService.cpp</span></span>](#httpcalculatorservicecpp)
-   [<span data-ttu-id="f9b6f-109">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="f9b6f-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="f9b6f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="f9b6f-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorservicecpp"></a><span data-ttu-id="f9b6f-111">HttpCalculatorService .cpp</span><span class="sxs-lookup"><span data-stu-id="f9b6f-111">HttpCalculatorService.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="f9b6f-112">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="f9b6f-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f9b6f-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="f9b6f-113">Makefile</span></span>
