...
description: 此範例顯示接受通道並接收單向訊息的 TCP 伺服器。
ms.assetid: a43fc6a8-f1ee-4f6b-9737-bfe340bb67f0
keywords:
- OneWayTcpServerExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="onewaytcpserverexample"></a><span data-ttu-id="6c4e8-106">OneWayTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="6c4e8-106">OneWayTcpServerExample</span></span>

<span data-ttu-id="6c4e8-107">此範例顯示接受通道並接收單向訊息的 TCP 伺服器。</span><span class="sxs-lookup"><span data-stu-id="6c4e8-107">This example shows a TCP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="6c4e8-108">OneWayTcpServer .cpp</span><span class="sxs-lookup"><span data-stu-id="6c4e8-108">OneWayTcpServer.cpp</span></span>](#onewaytcpservercpp)
-   [<span data-ttu-id="6c4e8-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="6c4e8-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="6c4e8-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="6c4e8-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpservercpp"></a><span data-ttu-id="6c4e8-111">OneWayTcpServer .cpp</span><span class="sxs-lookup"><span data-stu-id="6c4e8-111">OneWayTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="6c4e8-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="6c4e8-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6c4e8-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="6c4e8-113">Makefile</span></span>
