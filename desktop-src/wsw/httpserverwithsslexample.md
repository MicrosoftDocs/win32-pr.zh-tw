...
description: 此範例顯示可接受通道並接收和回復訊息（具有 SSL 傳輸安全性）的 TCP 伺服器。
ms.assetid: 627b6ba8-3bb2-41f3-a456-a811eb3b8e3d
keywords:
- HttpServerWithSslExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104311282"
---
# <a name="httpserverwithsslexample"></a><span data-ttu-id="598e8-106">HttpServerWithSslExample</span><span class="sxs-lookup"><span data-stu-id="598e8-106">HttpServerWithSslExample</span></span>

<span data-ttu-id="598e8-107">此範例顯示可接受通道並接收和回復訊息（具有 SSL 傳輸安全性）的 TCP 伺服器。</span><span class="sxs-lookup"><span data-stu-id="598e8-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="598e8-108">HttpServerWithSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="598e8-108">HttpServerWithSsl.cpp</span></span>](#httpserverwithsslcpp)
-   [<span data-ttu-id="598e8-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="598e8-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="598e8-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="598e8-110">Makefile</span></span>](#makefile)

## <a name="httpserverwithsslcpp"></a><span data-ttu-id="598e8-111">HttpServerWithSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="598e8-111">HttpServerWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="598e8-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="598e8-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="598e8-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="598e8-113">Makefile</span></span>
...
all: $(OUTDIR) $(OUTDIR)\WsHttpServerWithSsl.exe
...
$(OUTDIR)\HttpServerWithSsl.obj: HttpServerWithSsl.cpp $(OUTDIR)\PurchaseOrder.wsdl.c
    $(cc) $(cdebug) $(cflags) $(cvarsmt) /WX -I$(OUTDIR) /Fo"$(OUTDIR)\\" /Fd"$(OUTDIR)\\" HttpServerWithSsl.cpp

$(OUTDIR)\WsHttpServerWithSsl.exe: $(OUTDIR)\HttpServerWithSsl.obj $(OUTDIR)\PurchaseOrder.wsdl.obj
    $(link) $(ldebug) $(conlflags) $(conlibsmt) $(EXTRA_LIBS) -out:$(OUTDIR)\WsHttpServerWithSsl.exe $(OUTDIR)\HttpServerWithSsl.obj $(OUTDIR)\PurchaseOrder.wsdl.obj /PDB:$(OUTDIR)\WsHttpServerWithSsl.PDB
