...
description: 此範例示範如何使用 wsutil 產生的原則協助程式常式來建立服務 proxy，以與具有 SSL 傳輸安全性的計算機服務進行通訊。
ms.assetid: cf2455d4-0670-4ea2-8ee7-073698bfb765
keywords:
- HttpCalculatorWithSslPolicyClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119026476"
---
# <a name="httpcalculatorwithsslpolicyclientexample"></a>HttpCalculatorWithSslPolicyClientExample

此範例示範如何使用 wsutil 產生的原則協助程式常式來建立服務 proxy，以與具有 SSL 傳輸安全性的計算機服務進行通訊。 在此設定中，傳輸連線會受到 SSL (簽署、加密) 的 SSL，也提供伺服器驗證。
