...
description: 此範例說明如何搭配使用自訂標頭與服務 proxy。
ms.assetid: d56e68cd-c910-4f41-a672-c894ba134e3b
keywords:
- HttpCustomHeaderPurchaseOrderClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104372337"
---
# <a name="httpcustomheaderpurchaseorderclientexample"></a><span data-ttu-id="1b792-106">HttpCustomHeaderPurchaseOrderClientExample</span><span class="sxs-lookup"><span data-stu-id="1b792-106">HttpCustomHeaderPurchaseOrderClientExample</span></span>

<span data-ttu-id="1b792-107">此範例說明如何搭配使用自訂標頭與服務 proxy。</span><span class="sxs-lookup"><span data-stu-id="1b792-107">This examples shows how to use custom headers with service proxy.</span></span>

-   [<span data-ttu-id="1b792-108">HttpCustomHeaderClient .cpp</span><span class="sxs-lookup"><span data-stu-id="1b792-108">HttpCustomHeaderClient.cpp</span></span>](#httpcustomheaderclientcpp)
-   [<span data-ttu-id="1b792-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="1b792-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="1b792-110">OrderSessionHeader .xsd</span><span class="sxs-lookup"><span data-stu-id="1b792-110">OrderSessionHeader.xsd</span></span>](#ordersessionheaderxsd)
-   [<span data-ttu-id="1b792-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="1b792-111">Makefile</span></span>](#makefile)

## <a name="httpcustomheaderclientcpp"></a><span data-ttu-id="1b792-112">HttpCustomHeaderClient .cpp</span><span class="sxs-lookup"><span data-stu-id="1b792-112">HttpCustomHeaderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="1b792-113">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="1b792-113">PurchaseOrder.wsdl</span></span>
...
## <a name="ordersessionheaderxsd"></a><span data-ttu-id="1b792-114">OrderSessionHeader .xsd</span><span class="sxs-lookup"><span data-stu-id="1b792-114">OrderSessionHeader.xsd</span></span>
...
## <a name="makefile"></a><span data-ttu-id="1b792-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="1b792-115">Makefile</span></span>
