...
description: 此範例顯示接受通道的 TCP 伺服器，並以串流的方式讀取單向訊息。
ms.assetid: 0b9c6fba-9dee-4409-b715-7827793a5522
keywords:
- StreamingTcpServerExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="streamingtcpserverexample"></a><span data-ttu-id="8f8cc-106">StreamingTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="8f8cc-106">StreamingTcpServerExample</span></span>

<span data-ttu-id="8f8cc-107">此範例顯示接受通道的 TCP 伺服器，並以串流的方式讀取單向訊息。</span><span class="sxs-lookup"><span data-stu-id="8f8cc-107">This example shows a TCP server that accepts a channel, and reads one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="8f8cc-108">StreamingTcpServer .cpp</span><span class="sxs-lookup"><span data-stu-id="8f8cc-108">StreamingTcpServer.cpp</span></span>](#streamingtcpservercpp)
-   [<span data-ttu-id="8f8cc-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="8f8cc-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="8f8cc-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="8f8cc-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpservercpp"></a><span data-ttu-id="8f8cc-111">StreamingTcpServer .cpp</span><span class="sxs-lookup"><span data-stu-id="8f8cc-111">StreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="8f8cc-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="8f8cc-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="8f8cc-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="8f8cc-113">Makefile</span></span>
