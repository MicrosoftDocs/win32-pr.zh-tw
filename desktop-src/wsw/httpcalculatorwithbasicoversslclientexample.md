...
description: 此範例說明如何使用服務 proxy 與具有 SSL 傳輸安全性和 HTTP 標頭基本驗證的計算機服務通訊。
ms.assetid: be1a44e6-642c-42fa-8b95-bd8c6f335696
keywords:
- HttpCalculatorWithBasicOverSslClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106968671"
---
# <a name="httpcalculatorwithbasicoversslclientexample"></a><span data-ttu-id="0df77-106">HttpCalculatorWithBasicOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="0df77-106">HttpCalculatorWithBasicOverSslClientExample</span></span>

<span data-ttu-id="0df77-107">此範例說明如何使用服務 proxy 與具有 SSL 傳輸安全性和 HTTP 標頭基本驗證的計算機服務通訊。</span><span class="sxs-lookup"><span data-stu-id="0df77-107">This example shows how to use the service proxy to talk to a calculator service, with SSL transport security and HTTP header basic authentication.</span></span> <span data-ttu-id="0df77-108">在此設定中，傳輸連線會受到 SSL (簽署、加密) 的 SSL，也提供伺服器驗證。</span><span class="sxs-lookup"><span data-stu-id="0df77-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="0df77-109">用戶端驗證是透過使用基本配置的 HTTP 標頭中提供的使用者名稱/密碼組來提供。</span><span class="sxs-lookup"><span data-stu-id="0df77-109">Client authentication is provided by a username/password pair supplied in HTTP headers using the basic scheme.</span></span>

-   [<span data-ttu-id="0df77-110">HttpCalculatorWithBasicOverSslClient .cpp</span><span class="sxs-lookup"><span data-stu-id="0df77-110">HttpCalculatorWithBasicOverSslClient.cpp</span></span>](#httpcalculatorwithbasicoversslclientcpp)
-   [<span data-ttu-id="0df77-111">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="0df77-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="0df77-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="0df77-112">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithbasicoversslclientcpp"></a><span data-ttu-id="0df77-113">HttpCalculatorWithBasicOverSslClient .cpp</span><span class="sxs-lookup"><span data-stu-id="0df77-113">HttpCalculatorWithBasicOverSslClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="0df77-114">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="0df77-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0df77-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="0df77-115">Makefile</span></span>
