...
description: 此範例是傳送原始 HTTP 要求的用戶端。
ms.assetid: bc9e108e-d4a0-4bdd-82c2-5486ea46364b
keywords:
- HttpRawClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103840340"
---
# <a name="httprawclientexample"></a><span data-ttu-id="9190d-106">HttpRawClientExample</span><span class="sxs-lookup"><span data-stu-id="9190d-106">HttpRawClientExample</span></span>

<span data-ttu-id="9190d-107">此範例是傳送原始 HTTP 要求的用戶端。</span><span class="sxs-lookup"><span data-stu-id="9190d-107">This example is the client side that sends raw HTTP requests.</span></span>

## <a name="httprawclientcpp"></a><span data-ttu-id="9190d-108">HttpRawClient .cpp</span><span class="sxs-lookup"><span data-stu-id="9190d-108">HttpRawClient.cpp</span></span>
