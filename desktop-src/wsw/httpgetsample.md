---
title: HttpGetSample
description: 此範例示範如何使用服務主機透過 HTTP 裝載 PurchaseOrder 服務。 服務會透過 HTTP GET 和 WS-Metadata Exchange v1.1 公開中繼資料。 此服務也會示範如何執行 WWSAPI 服務的封面頁面。
ms.assetid: 5e3a2d24-afd1-451d-94c4-4234c24a4895
keywords:
- HttpGetSample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="httpgetsample"></a><span data-ttu-id="b8379-108">HttpGetSample</span><span class="sxs-lookup"><span data-stu-id="b8379-108">HttpGetSample</span></span>

<span data-ttu-id="b8379-109">此範例示範如何使用服務主機透過 HTTP 裝載 PurchaseOrder 服務。</span><span class="sxs-lookup"><span data-stu-id="b8379-109">This example shows how to use service host for hosting a PurchaseOrder service over HTTP.</span></span> <span data-ttu-id="b8379-110">服務會透過 HTTP GET 和 WS-Metadata Exchange v1.1 公開中繼資料。</span><span class="sxs-lookup"><span data-stu-id="b8379-110">The service exposes metadata over HTTP GET and WS-Metadata Exchange v1.1.</span></span> <span data-ttu-id="b8379-111">此服務也會示範如何執行 WWSAPI 服務的封面頁面。</span><span class="sxs-lookup"><span data-stu-id="b8379-111">The service also shows how to implement a cover page for a WWSAPI service.</span></span>

-   [<span data-ttu-id="b8379-112">HttpGetService .cpp</span><span class="sxs-lookup"><span data-stu-id="b8379-112">HttpGetService.cpp</span></span>](#httpgetservicecpp)
-   [<span data-ttu-id="b8379-113">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="b8379-113">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="b8379-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="b8379-114">Makefile</span></span>](#makefile)

## <a name="httpgetservicecpp"></a><span data-ttu-id="b8379-115">HttpGetService .cpp</span><span class="sxs-lookup"><span data-stu-id="b8379-115">HttpGetService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="b8379-116">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="b8379-116">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="b8379-117">Makefile</span><span class="sxs-lookup"><span data-stu-id="b8379-117">Makefile</span></span>
