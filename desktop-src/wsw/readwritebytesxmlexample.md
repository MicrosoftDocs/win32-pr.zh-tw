...
---
# <a name="readwritebytesxmlexample"></a><span data-ttu-id="278c7-106">ReadWriteBytesXmlExample</span><span class="sxs-lookup"><span data-stu-id="278c7-106">ReadWriteBytesXmlExample</span></span>

<span data-ttu-id="278c7-107">此範例會使用 MTOM 編碼來寫入二進位資料，並將其讀取回。</span><span class="sxs-lookup"><span data-stu-id="278c7-107">This example writes binary data using the MTOM encoding and reads it back out.</span></span>

## <a name="readwritebytesxmlcpp"></a><span data-ttu-id="278c7-108">ReadWriteBytesXml .cpp</span><span class="sxs-lookup"><span data-stu-id="278c7-108">ReadWriteBytesXml.cpp</span></span>
