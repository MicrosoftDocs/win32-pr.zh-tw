...
description: 此範例顯示的 UDP 伺服器會接聽多播位址，並回復傳送至該位址的要求。 此範例使用 IPv6。
ms.assetid: 9e2a254c-dbfc-4b73-a1a5-6a1db1ac5921
keywords:
- MulticastUdpServerExample6 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106967810"
---
# <a name="multicastudpserverexample6"></a><span data-ttu-id="2d8d3-107">MulticastUdpServerExample6</span><span class="sxs-lookup"><span data-stu-id="2d8d3-107">MulticastUdpServerExample6</span></span>

<span data-ttu-id="2d8d3-108">此範例顯示的 UDP 伺服器會接聽多播位址，並回復傳送至該位址的要求。</span><span class="sxs-lookup"><span data-stu-id="2d8d3-108">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span> <span data-ttu-id="2d8d3-109">此範例使用 IPv6。</span><span class="sxs-lookup"><span data-stu-id="2d8d3-109">This example uses IPv6.</span></span>

-   [<span data-ttu-id="2d8d3-110">MulticastUdpServer6 .cpp</span><span class="sxs-lookup"><span data-stu-id="2d8d3-110">MulticastUdpServer6.cpp</span></span>](#multicastudpserver6cpp)
-   [<span data-ttu-id="2d8d3-111">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="2d8d3-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="2d8d3-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="2d8d3-112">Makefile</span></span>](#makefile)

## <a name="multicastudpserver6cpp"></a><span data-ttu-id="2d8d3-113">MulticastUdpServer6 .cpp</span><span class="sxs-lookup"><span data-stu-id="2d8d3-113">MulticastUdpServer6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="2d8d3-114">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="2d8d3-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="2d8d3-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="2d8d3-115">Makefile</span></span>
