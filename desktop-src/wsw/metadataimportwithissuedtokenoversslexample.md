...
description: 此範例說明如何從端點匯入中繼資料，而該端點支援使用從發出安全性權杖服務所取得的發行權杖 (STS) 使用 WsRequestSecurityToken，並使用 ws \_ XML \_ 權杖 \_ 訊息安全性系結搭配 \_ \_ ws \_ SSL \_ 傳輸 \_ 安全性 \_ 系結向服務呈現。 如需詳細資訊，請參閱同盟。
ms.assetid: 31d1386a-1733-4e7a-add1-9050528075c8
keywords:
- MetadataImportWithIssuedTokenOverSslExample Windows Web 服務 API
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="metadataimportwithissuedtokenoversslexample"></a><span data-ttu-id="b2ae5-107">MetadataImportWithIssuedTokenOverSslExample</span><span class="sxs-lookup"><span data-stu-id="b2ae5-107">MetadataImportWithIssuedTokenOverSslExample</span></span>

<span data-ttu-id="b2ae5-108">此範例說明如何從端點匯入中繼資料，而該端點支援使用從發出安全性權杖服務所取得的發行權杖 (STS) 使用 [**WsRequestSecurityToken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) ，並使用 [**ws \_ XML \_ 權杖 \_ 訊息 \_ 安全性 \_**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) 系結搭配 [**ws \_ SSL \_ 傳輸 \_ 安全性 \_**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)系結向服務呈現。</span><span class="sxs-lookup"><span data-stu-id="b2ae5-108">This example illustrates importing metadata from an endpoint that supports using an issued token that is obtained from the issuing security token service (STS) using [**WsRequestSecurityToken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) and presented to the service using [**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span> <span data-ttu-id="b2ae5-109">如需詳細資訊，請參閱 [同盟](federation.md) 。</span><span class="sxs-lookup"><span data-stu-id="b2ae5-109">See [Federation](federation.md) for more information.</span></span>

## <a name="metadataimportwithissuedtokenoversslexamplecpp"></a><span data-ttu-id="b2ae5-110">MetadataImportWithIssuedTokenOverSslExample .cpp</span><span class="sxs-lookup"><span data-stu-id="b2ae5-110">MetadataImportWithIssuedTokenOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="b2ae5-111">相關主題</span><span class="sxs-lookup"><span data-stu-id="b2ae5-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="b2ae5-112">**WsRequestSecurityToken**</span><span class="sxs-lookup"><span data-stu-id="b2ae5-112">**WsRequestSecurityToken**</span></span>](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken)
</dt> <dt>

[<span data-ttu-id="b2ae5-113">**WS \_ XML \_ 權杖 \_ 訊息 \_ 安全性 \_ 系結**</span><span class="sxs-lookup"><span data-stu-id="b2ae5-113">**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding)
</dt> <dt>

[<span data-ttu-id="b2ae5-114">**WS \_ SSL \_ 傳輸 \_ 安全性 \_ 系結**</span><span class="sxs-lookup"><span data-stu-id="b2ae5-114">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> <dt>

[<span data-ttu-id="b2ae5-115">同盟</span><span class="sxs-lookup"><span data-stu-id="b2ae5-115">Federation</span></span>](federation.md)
</dt> </dl>
