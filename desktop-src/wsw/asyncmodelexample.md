---
title: 非同步函式範例
description: 此範例說明如何執行和呼叫非同步函式。
ms.assetid: e71bd231-c69c-409f-874c-a0798b844ee6
keywords:
- 適用于 Windows 的 AsyncModelExample Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104301131"
---
# <a name="asynchronous-function-example"></a><span data-ttu-id="9016d-106">非同步函式範例</span><span class="sxs-lookup"><span data-stu-id="9016d-106">Asynchronous Function Example</span></span>

<span data-ttu-id="9016d-107">此範例說明如何執行和呼叫非同步函式。</span><span class="sxs-lookup"><span data-stu-id="9016d-107">This example illustrates implementing and calling asynchronous functions.</span></span>

<span data-ttu-id="9016d-108">此範例包含下列部分：</span><span class="sxs-lookup"><span data-stu-id="9016d-108">The example consists of the following parts:</span></span>

-   <span data-ttu-id="9016d-109">會以同步或非同步方式加入兩個數字的 Add 函數。</span><span class="sxs-lookup"><span data-stu-id="9016d-109">The Add function which will add two numbers synchronously or asynchronously.</span></span> <span data-ttu-id="9016d-110">它會建立一個執行緒作為非同步案例的實作為詳細資料。</span><span class="sxs-lookup"><span data-stu-id="9016d-110">It creates a thread as an implementation detail for the asynchronous case.</span></span>
-   <span data-ttu-id="9016d-111">CallAddSync 函式會以同步方式叫用加入函數。</span><span class="sxs-lookup"><span data-stu-id="9016d-111">The CallAddSync function invokes the Add functions synchronously.</span></span>
-   <span data-ttu-id="9016d-112">CallAddAsync 函式會以非同步方式叫用加入函數。</span><span class="sxs-lookup"><span data-stu-id="9016d-112">The CallAddAsync function invokes the Add functions asynchronously.</span></span>

## <a name="asyncmodelcpp"></a><span data-ttu-id="9016d-113">AsyncModel .cpp</span><span class="sxs-lookup"><span data-stu-id="9016d-113">AsyncModel.cpp</span></span>
