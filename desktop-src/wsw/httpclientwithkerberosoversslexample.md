...
description: 此範例顯示的 HTTP 用戶端會傳送要求-回復訊息，kerberos over SSL 混合模式安全性。
ms.assetid: 48b20c9b-38e7-472c-9606-b454850e14c1
keywords:
- HttpClientWithKerberosOverSslExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104022112"
---
# <a name="httpclientwithkerberosoversslexample"></a><span data-ttu-id="072f6-106">HttpClientWithKerberosOverSslExample</span><span class="sxs-lookup"><span data-stu-id="072f6-106">HttpClientWithKerberosOverSslExample</span></span>

<span data-ttu-id="072f6-107">此範例顯示的 HTTP 用戶端會傳送要求-回復訊息，kerberos over SSL 混合模式安全性。</span><span class="sxs-lookup"><span data-stu-id="072f6-107">This example shows a HTTP client that sends request-reply messages, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="072f6-108">在此設定中，傳輸連線會受到 SSL (簽署、加密) 的 SSL，也提供伺服器驗證。</span><span class="sxs-lookup"><span data-stu-id="072f6-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="072f6-109">用戶端驗證是由訊息的 WS-Security 標頭中的 kerberos APREQ 票證所提供。</span><span class="sxs-lookup"><span data-stu-id="072f6-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="072f6-110">HttpClientWithKerberosOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="072f6-110">HttpClientWithKerberosOverSsl.cpp</span></span>](#httpclientwithkerberosoversslcpp)
-   [<span data-ttu-id="072f6-111">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="072f6-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="072f6-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="072f6-112">Makefile</span></span>](#makefile)

## <a name="httpclientwithkerberosoversslcpp"></a><span data-ttu-id="072f6-113">HttpClientWithKerberosOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="072f6-113">HttpClientWithKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="072f6-114">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="072f6-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="072f6-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="072f6-115">Makefile</span></span>
