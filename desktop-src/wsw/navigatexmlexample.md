...
---
# <a name="navigatexmlexample"></a><span data-ttu-id="7bdd0-107">NavigateXmlExample</span><span class="sxs-lookup"><span data-stu-id="7bdd0-107">NavigateXmlExample</span></span>

<span data-ttu-id="7bdd0-108">此範例會將 XML 寫入至 XML 緩衝區，然後將它讀回。</span><span class="sxs-lookup"><span data-stu-id="7bdd0-108">This example writes XML to an XML buffer, and then reads it back out.</span></span>

## <a name="navigatexmlcpp"></a><span data-ttu-id="7bdd0-109">NavigateXml .cpp</span><span class="sxs-lookup"><span data-stu-id="7bdd0-109">NavigateXml.cpp</span></span>
