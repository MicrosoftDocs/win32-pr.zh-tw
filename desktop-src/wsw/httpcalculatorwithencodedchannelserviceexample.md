...
ms.locfileid: "104311456"
---
# <a name="httpcalculatorwithencodedchannelserviceexample"></a><span data-ttu-id="11b0f-106">HttpCalculatorWithEncodedChannelServiceExample</span><span class="sxs-lookup"><span data-stu-id="11b0f-106">HttpCalculatorWithEncodedChannelServiceExample</span></span>

<span data-ttu-id="11b0f-107">此範例示範如何使用服務主機來裝載計算機服務，該服務具有在 HTTP 之上階層式自訂通道和接聽程式執行。</span><span class="sxs-lookup"><span data-stu-id="11b0f-107">This example shows how to use service host for hosting a calculator service with a custom channel and listener implementation that layer on top of HTTP.</span></span>

-   [<span data-ttu-id="11b0f-108">HttpCalculatorWithEncodedChannelService .cpp</span><span class="sxs-lookup"><span data-stu-id="11b0f-108">HttpCalculatorWithEncodedChannelService.cpp</span></span>](#httpcalculatorwithencodedchannelservicecpp)
-   [<span data-ttu-id="11b0f-109">EncodedChannel。h</span><span class="sxs-lookup"><span data-stu-id="11b0f-109">EncodedChannel.h</span></span>](#encodedchannelh)
-   [<span data-ttu-id="11b0f-110">EncodedChannel .cpp</span><span class="sxs-lookup"><span data-stu-id="11b0f-110">EncodedChannel.cpp</span></span>](#encodedchannelcpp)
-   [<span data-ttu-id="11b0f-111">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="11b0f-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="11b0f-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="11b0f-112">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithencodedchannelservicecpp"></a><span data-ttu-id="11b0f-113">HttpCalculatorWithEncodedChannelService .cpp</span><span class="sxs-lookup"><span data-stu-id="11b0f-113">HttpCalculatorWithEncodedChannelService.cpp</span></span>
...
## <a name="encodedchannelh"></a><span data-ttu-id="11b0f-114">EncodedChannel。h</span><span class="sxs-lookup"><span data-stu-id="11b0f-114">EncodedChannel.h</span></span>
...
## <a name="encodedchannelcpp"></a><span data-ttu-id="11b0f-115">EncodedChannel .cpp</span><span class="sxs-lookup"><span data-stu-id="11b0f-115">EncodedChannel.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="11b0f-116">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="11b0f-116">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="11b0f-117">Makefile</span><span class="sxs-lookup"><span data-stu-id="11b0f-117">Makefile</span></span>
