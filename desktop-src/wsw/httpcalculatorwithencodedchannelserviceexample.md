...
description: 請參閱 Windows Web 服務 API (WWSAPI) 使用編碼通道服務之 HTTP 計算機的 c + + 範例。
ms.assetid: 3b8d58dd-2f0c-4008-81ad-abda23a26a52
keywords:
- HttpCalculatorWithEncodedChannelServiceExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "112404161"
---
# <a name="httpcalculatorwithencodedchannelserviceexample"></a><span data-ttu-id="76f78-106">HttpCalculatorWithEncodedChannelServiceExample</span><span class="sxs-lookup"><span data-stu-id="76f78-106">HttpCalculatorWithEncodedChannelServiceExample</span></span>

<span data-ttu-id="76f78-107">此範例示範如何使用服務主機來裝載計算機服務，該服務具有在 HTTP 之上階層式自訂通道和接聽程式執行。</span><span class="sxs-lookup"><span data-stu-id="76f78-107">This example shows how to use service host for hosting a calculator service with a custom channel and listener implementation that layer on top of HTTP.</span></span>

-   [<span data-ttu-id="76f78-108">HttpCalculatorWithEncodedChannelService .cpp</span><span class="sxs-lookup"><span data-stu-id="76f78-108">HttpCalculatorWithEncodedChannelService.cpp</span></span>](#httpcalculatorwithencodedchannelservicecpp)
-   [<span data-ttu-id="76f78-109">EncodedChannel。h</span><span class="sxs-lookup"><span data-stu-id="76f78-109">EncodedChannel.h</span></span>](#encodedchannelh)
-   [<span data-ttu-id="76f78-110">EncodedChannel .cpp</span><span class="sxs-lookup"><span data-stu-id="76f78-110">EncodedChannel.cpp</span></span>](#encodedchannelcpp)
-   [<span data-ttu-id="76f78-111">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="76f78-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="76f78-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="76f78-112">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithencodedchannelservicecpp"></a><span data-ttu-id="76f78-113">HttpCalculatorWithEncodedChannelService .cpp</span><span class="sxs-lookup"><span data-stu-id="76f78-113">HttpCalculatorWithEncodedChannelService.cpp</span></span>
...
## <a name="encodedchannelh"></a><span data-ttu-id="76f78-114">EncodedChannel。h</span><span class="sxs-lookup"><span data-stu-id="76f78-114">EncodedChannel.h</span></span>
...
## <a name="encodedchannelcpp"></a><span data-ttu-id="76f78-115">EncodedChannel .cpp</span><span class="sxs-lookup"><span data-stu-id="76f78-115">EncodedChannel.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="76f78-116">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="76f78-116">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="76f78-117">Makefile</span><span class="sxs-lookup"><span data-stu-id="76f78-117">Makefile</span></span>
