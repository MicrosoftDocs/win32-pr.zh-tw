...
---
# <a name="writexmlsimpleexample"></a><span data-ttu-id="96266-106">WriteXmlSimpleExample</span><span class="sxs-lookup"><span data-stu-id="96266-106">WriteXmlSimpleExample</span></span>

<span data-ttu-id="96266-107">此範例會寫入簡單的 xml 檔。</span><span class="sxs-lookup"><span data-stu-id="96266-107">This example writes a simple xml document.</span></span>

-   [<span data-ttu-id="96266-108">WriteXmlSimple .cpp</span><span class="sxs-lookup"><span data-stu-id="96266-108">WriteXmlSimple.cpp</span></span>](#writexmlsimplecpp)
-   [<span data-ttu-id="96266-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="96266-109">Makefile</span></span>](#makefile)

## <a name="writexmlsimplecpp"></a><span data-ttu-id="96266-110">WriteXmlSimple .cpp</span><span class="sxs-lookup"><span data-stu-id="96266-110">WriteXmlSimple.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="96266-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="96266-111">Makefile</span></span>
