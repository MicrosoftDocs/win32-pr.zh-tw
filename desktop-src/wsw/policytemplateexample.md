...
description: 此範例說明如何手動建立原則描述，並使用它來建立服務 proxy。
ms.assetid: 1c7ff0fb-06a2-4285-bbc8-ea8f2d82b15b
keywords:
- PolicyTemplateExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104021684"
---
# <a name="policytemplateexample"></a><span data-ttu-id="e077c-106">PolicyTemplateExample</span><span class="sxs-lookup"><span data-stu-id="e077c-106">PolicyTemplateExample</span></span>

<span data-ttu-id="e077c-107">此範例說明如何手動建立原則描述，並使用它來建立服務 proxy。</span><span class="sxs-lookup"><span data-stu-id="e077c-107">This example illustrates how to manually create policy description and use it to create service proxy.</span></span>

-   [<span data-ttu-id="e077c-108">PolicyTemplate .cpp</span><span class="sxs-lookup"><span data-stu-id="e077c-108">PolicyTemplate.cpp</span></span>](#policytemplatecpp)
-   [<span data-ttu-id="e077c-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="e077c-109">Makefile</span></span>](#makefile)

## <a name="policytemplatecpp"></a><span data-ttu-id="e077c-110">PolicyTemplate .cpp</span><span class="sxs-lookup"><span data-stu-id="e077c-110">PolicyTemplate.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="e077c-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="e077c-111">Makefile</span></span>
