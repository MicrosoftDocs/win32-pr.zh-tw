...
description: 此範例顯示傳送要求-回復訊息的具名管道用戶端。
...
ms.locfileid: "104182963"
---
# <a name="requestreplynamedpipesclientexample"></a><span data-ttu-id="13f4f-103">RequestReplyNamedPipesClientExample</span><span class="sxs-lookup"><span data-stu-id="13f4f-103">RequestReplyNamedPipesClientExample</span></span>

<span data-ttu-id="13f4f-104">此範例顯示傳送要求-回復訊息的具名管道用戶端。</span><span class="sxs-lookup"><span data-stu-id="13f4f-104">This example shows a named pipe client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="13f4f-105">RequestReplyNamedPipesClient .cpp</span><span class="sxs-lookup"><span data-stu-id="13f4f-105">RequestReplyNamedPipesClient.cpp</span></span>](#requestreplynamedpipesclientcpp)
-   [<span data-ttu-id="13f4f-106">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="13f4f-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="13f4f-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="13f4f-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesclientcpp"></a><span data-ttu-id="13f4f-108">RequestReplyNamedPipesClient .cpp</span><span class="sxs-lookup"><span data-stu-id="13f4f-108">RequestReplyNamedPipesClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="13f4f-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="13f4f-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="13f4f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="13f4f-110">Makefile</span></span>
