...
description: 此範例顯示 UDP 用戶端，該用戶端會將要求多播，然後等候來自伺服器的回復訊息。
ms.assetid: 61ca7e05-1a60-43b2-9ff7-cb355fae2f77
keywords:
- MulticastUdpClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104183182"
---
# <a name="multicastudpclientexample"></a><span data-ttu-id="f126c-106">MulticastUdpClientExample</span><span class="sxs-lookup"><span data-stu-id="f126c-106">MulticastUdpClientExample</span></span>

<span data-ttu-id="f126c-107">此範例顯示 UDP 用戶端，該用戶端會將要求多播，然後等候來自伺服器的回復訊息。</span><span class="sxs-lookup"><span data-stu-id="f126c-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers.</span></span>

-   [<span data-ttu-id="f126c-108">MulticastUdpClient .cpp</span><span class="sxs-lookup"><span data-stu-id="f126c-108">MulticastUdpClient.cpp</span></span>](#multicastudpclientcpp)
-   [<span data-ttu-id="f126c-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="f126c-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="f126c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="f126c-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclientcpp"></a><span data-ttu-id="f126c-111">MulticastUdpClient .cpp</span><span class="sxs-lookup"><span data-stu-id="f126c-111">MulticastUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="f126c-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="f126c-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f126c-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="f126c-113">Makefile</span></span>
