---
title: RequestReplyTcpServerWithWindowsTransportSecurity 範例
description: 此範例顯示接受通道並接收和回復訊息的 TCP 伺服器，並提供 Windows SSPI 型傳輸安全性所提供的安全性。
ms.assetid: 690fa5cd-228b-4099-bd2b-cbf9c8d70c53
keywords:
- RequestReplyTcpServerWithWindowsTransportSecurityExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104092485"
---
# <a name="requestreplytcpserverwithwindowstransportsecurity-example"></a><span data-ttu-id="f4e5c-106">RequestReplyTcpServerWithWindowsTransportSecurity 範例</span><span class="sxs-lookup"><span data-stu-id="f4e5c-106">RequestReplyTcpServerWithWindowsTransportSecurity example</span></span>

<span data-ttu-id="f4e5c-107">此範例顯示接受通道並接收和回復訊息的 TCP 伺服器，並提供 Windows SSPI 型傳輸安全性所提供的安全性。</span><span class="sxs-lookup"><span data-stu-id="f4e5c-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with security provided by Windows SSPI-based transport security.</span></span>

-   [<span data-ttu-id="f4e5c-108">RequestReplyTcpServerWithWindowsTransportSecurity .cpp</span><span class="sxs-lookup"><span data-stu-id="f4e5c-108">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplytcpserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="f4e5c-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="f4e5c-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="f4e5c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="f4e5c-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="f4e5c-111">RequestReplyTcpServerWithWindowsTransportSecurity .cpp</span><span class="sxs-lookup"><span data-stu-id="f4e5c-111">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="f4e5c-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="f4e5c-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f4e5c-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="f4e5c-113">Makefile</span></span>
