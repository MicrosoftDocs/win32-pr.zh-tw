...
description: 示範伺服器端呼叫取消的範例服務應用程式。
ms.assetid: a0a862bc-521a-477a-854d-58642d497109
keywords:
- BlockingServiceExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104021527"
---
# <a name="blockingserviceexample"></a><span data-ttu-id="5de3b-106">BlockingServiceExample</span><span class="sxs-lookup"><span data-stu-id="5de3b-106">BlockingServiceExample</span></span>

<span data-ttu-id="5de3b-107">示範伺服器端呼叫取消的範例服務應用程式。</span><span class="sxs-lookup"><span data-stu-id="5de3b-107">Example service application demonstrating server side call cancellation.</span></span>

-   [<span data-ttu-id="5de3b-108">CancellingService .cpp</span><span class="sxs-lookup"><span data-stu-id="5de3b-108">CancellingService.cpp</span></span>](#cancellingservicecpp)
-   [<span data-ttu-id="5de3b-109">BlockUnBlockService .wsdl</span><span class="sxs-lookup"><span data-stu-id="5de3b-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="5de3b-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="5de3b-110">Makefile</span></span>](#makefile)

## <a name="cancellingservicecpp"></a><span data-ttu-id="5de3b-111">CancellingService .cpp</span><span class="sxs-lookup"><span data-stu-id="5de3b-111">CancellingService.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="5de3b-112">BlockUnBlockService .wsdl</span><span class="sxs-lookup"><span data-stu-id="5de3b-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5de3b-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="5de3b-113">Makefile</span></span>
