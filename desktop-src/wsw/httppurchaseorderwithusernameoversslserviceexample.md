...
description: 此範例示範如何使用服務主機，透過 HTTP （具有 SSL 混合模式安全性的使用者名稱）來裝載 PurchaseOrder 服務。
ms.assetid: 3dfedab1-d508-4cff-b179-591871078adb
keywords:
- HttpPurchaseOrderWithUserNameOverSslServiceExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103674367"
---
# <a name="httppurchaseorderwithusernameoversslserviceexample"></a><span data-ttu-id="8538a-106">HttpPurchaseOrderWithUserNameOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="8538a-106">HttpPurchaseOrderWithUserNameOverSslServiceExample</span></span>

<span data-ttu-id="8538a-107">此範例示範如何使用服務主機，透過 HTTP （具有 SSL 混合模式安全性的使用者名稱）來裝載 PurchaseOrder 服務。</span><span class="sxs-lookup"><span data-stu-id="8538a-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="8538a-108">在此設定中，傳輸連線會受到 SSL (簽署、加密) 的 SSL，也提供伺服器驗證。</span><span class="sxs-lookup"><span data-stu-id="8538a-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="8538a-109">用戶端驗證是由訊息中 WS-Security 標頭中的使用者名稱/密碼組所提供。</span><span class="sxs-lookup"><span data-stu-id="8538a-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="8538a-110">PurchaseOrderServiceUserNameOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="8538a-110">PurchaseOrderServiceUserNameOverSsl.cpp</span></span>](#purchaseorderserviceusernameoversslcpp)
-   [<span data-ttu-id="8538a-111">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="8538a-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="8538a-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="8538a-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderserviceusernameoversslcpp"></a><span data-ttu-id="8538a-113">PurchaseOrderServiceUserNameOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="8538a-113">PurchaseOrderServiceUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="8538a-114">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="8538a-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="8538a-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="8538a-115">Makefile</span></span>
