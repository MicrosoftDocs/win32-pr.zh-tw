...
description: 此範例示範使用服務 proxy 與 PurchaseOrder 服務通訊的 HTTP 用戶端，並透過 SSL 混合模式安全性。
ms.assetid: 6756043c-ef4c-4fa6-a27b-7ecb900601f9
keywords:
- HttpPurchaseOrderWithKerberosOverSslClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="httppurchaseorderwithkerberosoversslclientexample"></a><span data-ttu-id="4e7ee-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="4e7ee-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span></span>

<span data-ttu-id="4e7ee-107">此範例示範使用服務 proxy 與 PurchaseOrder 服務通訊的 HTTP 用戶端，並透過 SSL 混合模式安全性。</span><span class="sxs-lookup"><span data-stu-id="4e7ee-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="4e7ee-108">在此設定中，傳輸連線會受到 SSL (簽署、加密) 的 SSL，也提供伺服器驗證。</span><span class="sxs-lookup"><span data-stu-id="4e7ee-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="4e7ee-109">用戶端驗證是由訊息的 WS-Security 標頭中的 kerberos APREQ 票證所提供。</span><span class="sxs-lookup"><span data-stu-id="4e7ee-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="4e7ee-110">PurchaseOrderClientKerberosOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="4e7ee-110">PurchaseOrderClientKerberosOverSsl.cpp</span></span>](#purchaseorderclientkerberosoversslcpp)
-   [<span data-ttu-id="4e7ee-111">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="4e7ee-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="4e7ee-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="4e7ee-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientkerberosoversslcpp"></a><span data-ttu-id="4e7ee-113">PurchaseOrderClientKerberosOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="4e7ee-113">PurchaseOrderClientKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="4e7ee-114">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="4e7ee-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4e7ee-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="4e7ee-115">Makefile</span></span>
