...
description: 此範例顯示以串流方式傳送單向訊息的 TCP 用戶端。
ms.assetid: 29e9e08a-2cff-4467-b889-608a34d4b07e
keywords:
- StreamingTcpClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
all: $(OUTDIR) $(OUTDIR)\WsStreamingTcpClient.exe
...
$(OUTDIR)\StreamingTcpClient.obj: StreamingTcpClient.cpp $(OUTDIR)\PurchaseOrder.wsdl.c
    $(cc) $(cdebug) $(cflags) $(cvarsmt) /WX -I$(OUTDIR) /Fo"$(OUTDIR)\\" /Fd"$(OUTDIR)\\" StreamingTcpClient.cpp

$(OUTDIR)\WsStreamingTcpClient.exe: $(OUTDIR)\StreamingTcpClient.obj $(OUTDIR)\PurchaseOrder.wsdl.obj
    $(link) $(ldebug) $(conlflags) $(conlibsmt) $(EXTRA_LIBS) -out:$(OUTDIR)\WsStreamingTcpClient.exe $(OUTDIR)\StreamingTcpClient.obj $(OUTDIR)\PurchaseOrder.wsdl.obj /PDB:$(OUTDIR)\WsStreamingTcpClient.PDB
