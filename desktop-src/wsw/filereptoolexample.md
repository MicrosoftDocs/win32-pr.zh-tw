...
description: 這是驅動 FileRep 服務的命令列工具。
ms.assetid: e6273036-2e31-4cbb-b72b-8f4d3ade6336
keywords:
- FileRepToolExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104183831"
---
# <a name="filereptoolexample"></a><span data-ttu-id="83f09-106">FileRepToolExample</span><span class="sxs-lookup"><span data-stu-id="83f09-106">FileRepToolExample</span></span>

<span data-ttu-id="83f09-107">這是驅動 [FileRep 服務](filerepserviceexample.md)的命令列工具。</span><span class="sxs-lookup"><span data-stu-id="83f09-107">This is the command line tool that drives the [FileRep service](filerepserviceexample.md).</span></span> <span data-ttu-id="83f09-108">您可以在該處找到此範例的更詳細描述。</span><span class="sxs-lookup"><span data-stu-id="83f09-108">A more detailed description of this sample can be found there.</span></span>

<span data-ttu-id="83f09-109">命令列參數如下所示：</span><span class="sxs-lookup"><span data-stu-id="83f09-109">The command line parameters are as follows:</span></span>

<span data-ttu-id="83f09-110">WsFileRep.exe <Client Service Url> <Server Service Url> <Source File> <Destination File> \[ /encoding： <binary/text/MTOM>\] \[ /sync\]</span><span class="sxs-lookup"><span data-stu-id="83f09-110">WsFileRep.exe <Client Service Url> <Server Service Url> <Source File> <Destination File> \[/encoding:<binary/text/MTOM>\] \[/sync\]</span></span>

<span data-ttu-id="83f09-111">用戶端服務 Url：必要。</span><span class="sxs-lookup"><span data-stu-id="83f09-111">Client Service Url: Mandatory.</span></span> <span data-ttu-id="83f09-112">用戶端服務的 Url。</span><span class="sxs-lookup"><span data-stu-id="83f09-112">Url of the client service.</span></span>

<span data-ttu-id="83f09-113">伺服器服務 Url：必要。</span><span class="sxs-lookup"><span data-stu-id="83f09-113">Server Service Url: Mandatory.</span></span> <span data-ttu-id="83f09-114">伺服器服務的 Url。</span><span class="sxs-lookup"><span data-stu-id="83f09-114">Url of the server service.</span></span>

<span data-ttu-id="83f09-115">來源檔案：必要。</span><span class="sxs-lookup"><span data-stu-id="83f09-115">Source File: Mandatory.</span></span> <span data-ttu-id="83f09-116">來源檔案的完整本機名稱。</span><span class="sxs-lookup"><span data-stu-id="83f09-116">Fully qualified local name of the source file.</span></span> <span data-ttu-id="83f09-117">檔案位於伺服器服務執行所在的電腦上。</span><span class="sxs-lookup"><span data-stu-id="83f09-117">The file is located on the machine where the server service runs.</span></span>

<span data-ttu-id="83f09-118">目的地檔案：必要。</span><span class="sxs-lookup"><span data-stu-id="83f09-118">Destination file: Mandatory.</span></span> <span data-ttu-id="83f09-119">目的地檔案的完整本機名稱。</span><span class="sxs-lookup"><span data-stu-id="83f09-119">Fully qualified local name of the destination file.</span></span> <span data-ttu-id="83f09-120">檔案將位於用戶端服務執行所在的電腦上。</span><span class="sxs-lookup"><span data-stu-id="83f09-120">The file will be located on the machine where the client service runs.</span></span>

<span data-ttu-id="83f09-121">編碼：選擇性。</span><span class="sxs-lookup"><span data-stu-id="83f09-121">Encoding: Optional.</span></span> <span data-ttu-id="83f09-122">指定在用戶端和伺服器服務之間傳送之訊息的訊息編碼方式。</span><span class="sxs-lookup"><span data-stu-id="83f09-122">Specifies the message encoding for the messages sent between the client and server services.</span></span> <span data-ttu-id="83f09-123">為了簡單起見，無法變更命令列工具與用戶端服務之間的通訊所使用的編碼方式。</span><span class="sxs-lookup"><span data-stu-id="83f09-123">The encoding used for the communication between the command line tool and the client service cannot be changed for simplicity reasons.</span></span> <span data-ttu-id="83f09-124">有效的參數為 binary、text 和 MTOM。</span><span class="sxs-lookup"><span data-stu-id="83f09-124">Valid parameters are binary, text and MTOM.</span></span> <span data-ttu-id="83f09-125">如果未指定參數，則會使用傳輸的預設編碼方式。</span><span class="sxs-lookup"><span data-stu-id="83f09-125">If the parameter is not specified the default encoding for transport is used.</span></span>

<span data-ttu-id="83f09-126">同步：選擇性。</span><span class="sxs-lookup"><span data-stu-id="83f09-126">Sync: Optional.</span></span> <span data-ttu-id="83f09-127">當設定時，要求會以同步方式完成。</span><span class="sxs-lookup"><span data-stu-id="83f09-127">When set, the request completes synchronously.</span></span> <span data-ttu-id="83f09-128">否則，要求將會以非同步方式完成。</span><span class="sxs-lookup"><span data-stu-id="83f09-128">Otherwise the request will complete asynchronously.</span></span>

-   [<span data-ttu-id="83f09-129">工具 .cpp</span><span class="sxs-lookup"><span data-stu-id="83f09-129">Tool.cpp</span></span>](#toolcpp)
-   [<span data-ttu-id="83f09-130">一般。h</span><span class="sxs-lookup"><span data-stu-id="83f09-130">common.h</span></span>](#commonh)
-   [<span data-ttu-id="83f09-131">相關主題</span><span class="sxs-lookup"><span data-stu-id="83f09-131">Related topics</span></span>](#related-topics)

## <a name="toolcpp"></a><span data-ttu-id="83f09-132">工具 .cpp</span><span class="sxs-lookup"><span data-stu-id="83f09-132">Tool.cpp</span></span>
...
## <a name="commonh"></a><span data-ttu-id="83f09-133">common.h</span><span class="sxs-lookup"><span data-stu-id="83f09-133">common.h</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="83f09-134">相關主題</span><span class="sxs-lookup"><span data-stu-id="83f09-134">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="83f09-135">FileRepServiceExample</span><span class="sxs-lookup"><span data-stu-id="83f09-135">FileRepServiceExample</span></span>](filerepserviceexample.md)
</dt> </dl>
