...
description: 此範例示範如何使用服務 proxy 來與 HTTP 型計算機服務交談。
ms.assetid: dd97613d-3bb7-427c-a292-220d1efed96c
keywords:
- 適用于 Windows 的 HttpCalculatorClientExample Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106995557"
---
# <a name="httpcalculatorclientexample"></a><span data-ttu-id="4d83c-106">HttpCalculatorClientExample</span><span class="sxs-lookup"><span data-stu-id="4d83c-106">HttpCalculatorClientExample</span></span>

<span data-ttu-id="4d83c-107">此範例示範如何使用服務 proxy 來與 HTTP 型計算機服務交談。</span><span class="sxs-lookup"><span data-stu-id="4d83c-107">This example show how to use the service proxy to talk to an HTTP based calculator service.</span></span>

-   [<span data-ttu-id="4d83c-108">HttpCalculatorClient .cpp</span><span class="sxs-lookup"><span data-stu-id="4d83c-108">HttpCalculatorClient.cpp</span></span>](#httpcalculatorclientcpp)
-   [<span data-ttu-id="4d83c-109">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="4d83c-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="4d83c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="4d83c-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorclientcpp"></a><span data-ttu-id="4d83c-111">HttpCalculatorClient .cpp</span><span class="sxs-lookup"><span data-stu-id="4d83c-111">HttpCalculatorClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="4d83c-112">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="4d83c-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4d83c-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="4d83c-113">Makefile</span></span>
