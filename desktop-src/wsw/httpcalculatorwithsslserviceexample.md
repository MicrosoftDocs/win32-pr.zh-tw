...
description: 此範例示範如何使用服務主機，透過 HTTP （具有 SSL 傳輸安全性）來裝載計算機服務。
ms.assetid: 15e61f32-73b5-4359-957d-9694fe947b1e
keywords:
- HttpCalculatorWithSslServiceExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106965568"
---
# <a name="httpcalculatorwithsslserviceexample"></a><span data-ttu-id="623a8-106">HttpCalculatorWithSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="623a8-106">HttpCalculatorWithSslServiceExample</span></span>

<span data-ttu-id="623a8-107">此範例示範如何使用服務主機，透過 HTTP （具有 SSL 傳輸安全性）來裝載計算機服務。</span><span class="sxs-lookup"><span data-stu-id="623a8-107">This example shows how to use service host for hosting a calculator service over HTTP, with SSL transport security.</span></span>

-   [<span data-ttu-id="623a8-108">HttpCalculatorServiceWithSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="623a8-108">HttpCalculatorServiceWithSsl.cpp</span></span>](#httpcalculatorservicewithsslcpp)
-   [<span data-ttu-id="623a8-109">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="623a8-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="623a8-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="623a8-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorservicewithsslcpp"></a><span data-ttu-id="623a8-111">HttpCalculatorServiceWithSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="623a8-111">HttpCalculatorServiceWithSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="623a8-112">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="623a8-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="623a8-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="623a8-113">Makefile</span></span>
...
all: $(OUTDIR) $(OUTDIR)\WsHttpCalculatorServiceWithSsl.exe
...
$(OUTDIR)\HttpCalculatorServiceWithSsl.obj: HttpCalculatorServiceWithSsl.cpp $(OUTDIR)\CalculatorService.wsdl.c
    $(cc) $(cdebug) $(cflags) $(cvarsmt) /WX -I$(OUTDIR) /Fo"$(OUTDIR)\\" /Fd"$(OUTDIR)\\" HttpCalculatorServiceWithSsl.cpp

$(OUTDIR)\WsHttpCalculatorServiceWithSsl.exe: $(OUTDIR)\HttpCalculatorServiceWithSsl.obj $(OUTDIR)\CalculatorService.wsdl.obj
    $(link) $(ldebug) $(conlflags) $(conlibsmt) $(EXTRA_LIBS) -out:$(OUTDIR)\WsHttpCalculatorServiceWithSsl.exe $(OUTDIR)\HttpCalculatorServiceWithSsl.obj $(OUTDIR)\CalculatorService.wsdl.obj /PDB:$(OUTDIR)\WsHttpCalculatorServiceWithSsl.PDB
