...
description: 此範例顯示 UDP 用戶端，該用戶端會將要求多播，然後使用 IPv6 等候伺服器的回復訊息。
ms.assetid: bd19bd5f-0617-4524-aa48-3d0c28c97747
keywords:
- MulticastUdpClientExample6 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="multicastudpclientexample6"></a><span data-ttu-id="5c1ec-106">MulticastUdpClientExample6</span><span class="sxs-lookup"><span data-stu-id="5c1ec-106">MulticastUdpClientExample6</span></span>

<span data-ttu-id="5c1ec-107">此範例顯示 UDP 用戶端，該用戶端會將要求多播，然後使用 IPv6 等候伺服器的回復訊息。</span><span class="sxs-lookup"><span data-stu-id="5c1ec-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers, using IPv6.</span></span>

-   [<span data-ttu-id="5c1ec-108">MulticastUdpClient6 .cpp</span><span class="sxs-lookup"><span data-stu-id="5c1ec-108">MulticastUdpClient6.cpp</span></span>](#multicastudpclient6cpp)
-   [<span data-ttu-id="5c1ec-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="5c1ec-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="5c1ec-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="5c1ec-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclient6cpp"></a><span data-ttu-id="5c1ec-111">MulticastUdpClient6 .cpp</span><span class="sxs-lookup"><span data-stu-id="5c1ec-111">MulticastUdpClient6.cpp</span></span>
...
int __cdecl wmain(int argc, __in_ecount(argc) wchar_t **argv)
{
    ...
    WS_STRING serviceUrl = WS_STRING_VALUE(L"soap.udp://[FF02::C]:809");
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="5c1ec-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="5c1ec-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5c1ec-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="5c1ec-113">Makefile</span></span>
...
all: $(OUTDIR) $(OUTDIR)\WsMulticastUdpClient6.exe
...
$(OUTDIR)\MulticastUdpClient6.obj: MulticastUdpClient6.cpp $(OUTDIR)\PurchaseOrder.wsdl.c
    $(cc) $(cdebug) $(cflags) $(cvarsmt) /WX -I$(OUTDIR) /Fo"$(OUTDIR)\\" /Fd"$(OUTDIR)\\" MulticastUdpClient6.cpp

$(OUTDIR)\WsMulticastUdpClient6.exe: $(OUTDIR)\MulticastUdpClient6.obj $(OUTDIR)\PurchaseOrder.wsdl.obj
    $(link) $(ldebug) $(conlflags) $(conlibsmt) $(EXTRA_LIBS) -out:$(OUTDIR)\WsMulticastUdpClient6.exe $(OUTDIR)\MulticastUdpClient6.obj $(OUTDIR)\PurchaseOrder.wsdl.obj /PDB:$(OUTDIR)\WsMulticastUdpClient6.PDB
