...
description: 此範例示範如何使用 xml 緩衝區 Api。
ms.assetid: cf4530c7-48f4-4a76-bd3d-1f21b5469902
keywords:
- XmlBufferExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104021513"
---
# <a name="xmlbufferexample"></a><span data-ttu-id="9ca58-106">XmlBufferExample</span><span class="sxs-lookup"><span data-stu-id="9ca58-106">XmlBufferExample</span></span>

<span data-ttu-id="9ca58-107">此範例示範如何使用 xml 緩衝區 Api。</span><span class="sxs-lookup"><span data-stu-id="9ca58-107">This example shows some use of the xml buffer APIs.</span></span>

## <a name="xmlbuffercpp"></a><span data-ttu-id="9ca58-108">XmlBuffer .cpp</span><span class="sxs-lookup"><span data-stu-id="9ca58-108">XmlBuffer.cpp</span></span>
