...
description: 此範例顯示傳送單向訊息的 TCP 用戶端。
ms.assetid: c5e930b5-da13-459c-8a83-eeeb120a79ed
keywords:
- OneWayTcpClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106999785"
---
# <a name="onewaytcpclientexample"></a><span data-ttu-id="104ab-106">OneWayTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="104ab-106">OneWayTcpClientExample</span></span>

<span data-ttu-id="104ab-107">此範例顯示傳送單向訊息的 TCP 用戶端。</span><span class="sxs-lookup"><span data-stu-id="104ab-107">This example shows a TCP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="104ab-108">OneWayTcpClient .cpp</span><span class="sxs-lookup"><span data-stu-id="104ab-108">OneWayTcpClient.cpp</span></span>](#onewaytcpclientcpp)
-   [<span data-ttu-id="104ab-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="104ab-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="104ab-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="104ab-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpclientcpp"></a><span data-ttu-id="104ab-111">OneWayTcpClient .cpp</span><span class="sxs-lookup"><span data-stu-id="104ab-111">OneWayTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="104ab-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="104ab-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="104ab-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="104ab-113">Makefile</span></span>
...
all: $(OUTDIR) $(OUTDIR)\WsOneWayTcpClient.exe
...
$(OUTDIR)\OneWayTcpClient.obj: OneWayTcpClient.cpp $(OUTDIR)\PurchaseOrder.wsdl.c
    $(cc) $(cdebug) $(cflags) $(cvarsmt) /WX -I$(OUTDIR) /Fo"$(OUTDIR)\\" /Fd"$(OUTDIR)\\" OneWayTcpClient.cpp

$(OUTDIR)\WsOneWayTcpClient.exe: $(OUTDIR)\OneWayTcpClient.obj $(OUTDIR)\PurchaseOrder.wsdl.obj
    $(link) $(ldebug) $(conlflags) $(conlibsmt) $(EXTRA_LIBS) -out:$(OUTDIR)\WsOneWayTcpClient.exe $(OUTDIR)\OneWayTcpClient.obj $(OUTDIR)\PurchaseOrder.wsdl.obj /PDB:$(OUTDIR)\WsOneWayTcpClient.PDB
