...
---
# <a name="calculatorwsdl"></a><span data-ttu-id="8b31e-106">CalculatorWsdl</span><span class="sxs-lookup"><span data-stu-id="8b31e-106">CalculatorWsdl</span></span>

<span data-ttu-id="8b31e-107">這是計算機服務範例的 wsdl/schema 範例。</span><span class="sxs-lookup"><span data-stu-id="8b31e-107">This is an example wsdl/schema for the calculator service samples.</span></span>

## <a name="calculatorwsdl"></a><span data-ttu-id="8b31e-108">計算機</span><span class="sxs-lookup"><span data-stu-id="8b31e-108">Calculator.wsdl</span></span>
