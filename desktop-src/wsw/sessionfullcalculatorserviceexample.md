...
description: 使用服務主機的會話計算機服務的執行。
ms.assetid: 7501025b-5692-4f89-ad74-c60694c29163
keywords:
- SessionfullCalculatorServiceExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104311439"
---
# <a name="sessionfullcalculatorserviceexample"></a><span data-ttu-id="33c84-106">SessionfullCalculatorServiceExample</span><span class="sxs-lookup"><span data-stu-id="33c84-106">SessionfullCalculatorServiceExample</span></span>

<span data-ttu-id="33c84-107">使用服務主機的會話計算機服務的執行。</span><span class="sxs-lookup"><span data-stu-id="33c84-107">An implementation of a sessionful calculator service using the Service Host.</span></span>

-   [<span data-ttu-id="33c84-108">SessionfullCalculatorService .cpp</span><span class="sxs-lookup"><span data-stu-id="33c84-108">SessionfullCalculatorService.cpp</span></span>](#sessionfullcalculatorservicecpp)
-   [<span data-ttu-id="33c84-109">SessionBasedCalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="33c84-109">SessionBasedCalculatorService.wsdl</span></span>](#sessionbasedcalculatorservicewsdl)
-   [<span data-ttu-id="33c84-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="33c84-110">Makefile</span></span>](#makefile)

## <a name="sessionfullcalculatorservicecpp"></a><span data-ttu-id="33c84-111">SessionfullCalculatorService .cpp</span><span class="sxs-lookup"><span data-stu-id="33c84-111">SessionfullCalculatorService.cpp</span></span>
...
## <a name="sessionbasedcalculatorservicewsdl"></a><span data-ttu-id="33c84-112">SessionBasedCalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="33c84-112">SessionBasedCalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="33c84-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="33c84-113">Makefile</span></span>
