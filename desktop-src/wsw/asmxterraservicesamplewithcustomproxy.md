...
description: 這則範例會示範使用 WS \_ HTTP \_ proxy \_ 設定 \_ 模式 \_ 自訂通道屬性來與 .asmx TerraService 服務通訊的服務 proxy。
ms.assetid: 200dfcbc-ad16-4ac8-ab16-76291344a980
keywords:
- AsmxTerraServiceSampleWithCustomProxy 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="asmxterraservicesamplewithcustomproxy"></a><span data-ttu-id="97d17-106">AsmxTerraServiceSampleWithCustomProxy</span><span class="sxs-lookup"><span data-stu-id="97d17-106">AsmxTerraServiceSampleWithCustomProxy</span></span>

<span data-ttu-id="97d17-107">這則範例會示範使用 [**WS \_ HTTP \_ proxy \_ 設定 \_ 模式 \_ 自訂**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) 通道屬性來與 .asmx TerraService 服務通訊的服務 proxy。</span><span class="sxs-lookup"><span data-stu-id="97d17-107">This examples shows service proxy talking to a ASMX TerraService service using [**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) channel property.</span></span>

-   [<span data-ttu-id="97d17-108">AsmxCustomProxyClient .cpp</span><span class="sxs-lookup"><span data-stu-id="97d17-108">AsmxCustomProxyClient.cpp</span></span>](#asmxcustomproxyclientcpp)
-   [<span data-ttu-id="97d17-109">terraserviceusa .com</span><span class="sxs-lookup"><span data-stu-id="97d17-109">terraserviceusa.com.wsdl</span></span>](#terraserviceusacomwsdl)
-   [<span data-ttu-id="97d17-110">相關主題</span><span class="sxs-lookup"><span data-stu-id="97d17-110">Related topics</span></span>](#related-topics)

## <a name="asmxcustomproxyclientcpp"></a><span data-ttu-id="97d17-111">AsmxCustomProxyClient .cpp</span><span class="sxs-lookup"><span data-stu-id="97d17-111">AsmxCustomProxyClient.cpp</span></span>
...
## <a name="terraserviceusacomwsdl"></a><span data-ttu-id="97d17-112">terraserviceusa .com</span><span class="sxs-lookup"><span data-stu-id="97d17-112">terraserviceusa.com.wsdl</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="97d17-113">相關主題</span><span class="sxs-lookup"><span data-stu-id="97d17-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="97d17-114">**WS \_ HTTP \_ PROXY \_ 設定 \_ 模式 \_ 自訂**</span><span class="sxs-lookup"><span data-stu-id="97d17-114">**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
</dt> </dl>
