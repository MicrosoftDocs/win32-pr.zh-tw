...
這則範例會示範使用 [**WS \_ HTTP \_ proxy \_ 設定 \_ 模式 \_ 自訂**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) 通道屬性來與 .asmx TerraService 服務通訊的服務 proxy。

-   [AsmxCustomProxyClient .cpp](#asmxcustomproxyclientcpp)
-   [terraserviceusa .com](#terraserviceusacomwsdl)
-   [相關主題](#related-topics)
...
## <a name="terraserviceusacomwsdl"></a>terraserviceusa .com
