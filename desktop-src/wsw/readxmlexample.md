...
---
# <a name="readxmlexample"></a><span data-ttu-id="910e8-106">ReadXmlExample</span><span class="sxs-lookup"><span data-stu-id="910e8-106">ReadXmlExample</span></span>

<span data-ttu-id="910e8-107">此範例會依 node 讀取 XML 節點。</span><span class="sxs-lookup"><span data-stu-id="910e8-107">This example reads XML node by node.</span></span>

## <a name="readxmlcpp"></a><span data-ttu-id="910e8-108">ReadXml .cpp</span><span class="sxs-lookup"><span data-stu-id="910e8-108">ReadXml.cpp</span></span>
