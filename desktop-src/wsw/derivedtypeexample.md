...
此範例會使用 Wsutil 產生的 c + + helper 函數來寫入和讀取衍生型別。 如需衍生型別描述的詳細資訊，請參閱 [**WS \_ 型別 \_ 屬性 \_ 欄位 \_ 對應**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) 。
...
[**WS \_ 類型 \_ 屬性 \_ 欄位 \_ 對應**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
