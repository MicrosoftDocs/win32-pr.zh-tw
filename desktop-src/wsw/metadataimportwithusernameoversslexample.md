...
此範例說明如何從端點（支援使用 [**ws \_ SSL \_ 傳輸 \_ 安全性 \_**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)系結的 [**ws \_ USERNAME \_ MESSAGE \_ security \_**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) binding）匯入中繼資料。
