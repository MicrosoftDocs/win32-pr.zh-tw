...
description: 此範例說明如何從端點（支援 \_ \_ \_ \_ 使用 ws \_ SSL \_ 傳輸 \_ 安全性 \_ 系結的 ws USERNAME MESSAGE security binding）匯入中繼資料。
ms.assetid: 1bce97e2-a841-4c4b-af5e-f747c3fb6e8d
keywords:
- MetadataImportWithUsernameOverSslExample Windows Web 服務 API
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="metadataimportwithusernameoversslexample"></a><span data-ttu-id="19b59-106">MetadataImportWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="19b59-106">MetadataImportWithUsernameOverSslExample</span></span>

<span data-ttu-id="19b59-107">此範例說明如何從端點（支援使用 [**ws \_ SSL \_ 傳輸 \_ 安全性 \_**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)系結的 [**ws \_ USERNAME \_ MESSAGE \_ security \_**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) binding）匯入中繼資料。</span><span class="sxs-lookup"><span data-stu-id="19b59-107">This example illustrates importing metadata from an endpoint that supports [**WS\_USERNAME\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span>

## <a name="metadataimportwithusernameoversslexamplecpp"></a><span data-ttu-id="19b59-108">MetadataImportWithUsernameOverSslExample .cpp</span><span class="sxs-lookup"><span data-stu-id="19b59-108">MetadataImportWithUsernameOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="19b59-109">相關主題</span><span class="sxs-lookup"><span data-stu-id="19b59-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="19b59-110">**WS 使用者 \_ 名稱 \_ 訊息 \_ 安全性 \_ 系結**</span><span class="sxs-lookup"><span data-stu-id="19b59-110">**WS\_USERNAME\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding)
</dt> <dt>

[<span data-ttu-id="19b59-111">**WS \_ SSL \_ 傳輸 \_ 安全性 \_ 系結**</span><span class="sxs-lookup"><span data-stu-id="19b59-111">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> </dl>
