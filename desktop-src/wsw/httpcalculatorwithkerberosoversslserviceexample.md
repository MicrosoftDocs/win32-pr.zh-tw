...
description: 此範例示範如何使用服務主機透過 HTTP （具有 kerberos over SSL 混合模式安全性）來裝載計算機服務。
ms.assetid: a006ce15-9470-49f7-80d6-8d40ffec8651
keywords:
- HttpCalculatorWithKerberosOverSslServiceExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104372672"
---
# <a name="httpcalculatorwithkerberosoversslserviceexample"></a><span data-ttu-id="56ee3-106">HttpCalculatorWithKerberosOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="56ee3-106">HttpCalculatorWithKerberosOverSslServiceExample</span></span>

<span data-ttu-id="56ee3-107">此範例示範如何使用服務主機透過 HTTP （具有 kerberos over SSL 混合模式安全性）來裝載計算機服務。</span><span class="sxs-lookup"><span data-stu-id="56ee3-107">This example shows how to use service host for hosting a calculator service over HTTP, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="56ee3-108">在此設定中，傳輸連線會受到 SSL (簽署、加密) 的 SSL，也提供伺服器驗證。</span><span class="sxs-lookup"><span data-stu-id="56ee3-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="56ee3-109">用戶端驗證是由訊息的 WS-Security 標頭中的 kerberos APREQ 票證所提供。</span><span class="sxs-lookup"><span data-stu-id="56ee3-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="56ee3-110">CalculatorServiceKerberosOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="56ee3-110">CalculatorServiceKerberosOverSsl.cpp</span></span>](#calculatorservicekerberosoversslcpp)
-   [<span data-ttu-id="56ee3-111">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="56ee3-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="56ee3-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="56ee3-112">Makefile</span></span>](#makefile)

## <a name="calculatorservicekerberosoversslcpp"></a><span data-ttu-id="56ee3-113">CalculatorServiceKerberosOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="56ee3-113">CalculatorServiceKerberosOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="56ee3-114">CalculatorService .wsdl</span><span class="sxs-lookup"><span data-stu-id="56ee3-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="56ee3-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="56ee3-115">Makefile</span></span>
