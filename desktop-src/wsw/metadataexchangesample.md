...
description: 此範例示範如何使用服務主機，透過 TCP 裝載 PurchaseOrder 服務。 服務也支援 WS-透過 ws-metadataexchange。
ms.assetid: 8f14e6a8-ccb9-4556-b04f-df08c6c80adf
keywords:
- MetadataExchangeSample Windows Web 服務 API
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119880998"
---
# <a name="metadataexchangesample"></a>MetadataExchangeSample

此範例示範如何使用服務主機，透過 TCP 裝載 PurchaseOrder 服務。 服務也支援 WS-透過 ws-metadataexchange。
