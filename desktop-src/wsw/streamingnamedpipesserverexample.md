...
description: 此範例顯示接受通道的具名管道用戶端，並以串流方式讀取單向訊息。
...
---
# <a name="streamingnamedpipesserverexample"></a><span data-ttu-id="8e06e-103">StreamingNamedPipesServerExample</span><span class="sxs-lookup"><span data-stu-id="8e06e-103">StreamingNamedPipesServerExample</span></span>

<span data-ttu-id="8e06e-104">此範例顯示接受通道的具名管道用戶端，並以串流方式讀取單向訊息。</span><span class="sxs-lookup"><span data-stu-id="8e06e-104">This example shows a named pipes client that accepts a channel, and reads one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="8e06e-105">StreamingNamedPipesServer .cpp</span><span class="sxs-lookup"><span data-stu-id="8e06e-105">StreamingNamedPipesServer.cpp</span></span>](#streamingnamedpipesservercpp)
-   [<span data-ttu-id="8e06e-106">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="8e06e-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="8e06e-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="8e06e-107">Makefile</span></span>](#makefile)

## <a name="streamingnamedpipesservercpp"></a><span data-ttu-id="8e06e-108">StreamingNamedPipesServer .cpp</span><span class="sxs-lookup"><span data-stu-id="8e06e-108">StreamingNamedPipesServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="8e06e-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="8e06e-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="8e06e-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="8e06e-110">Makefile</span></span>
