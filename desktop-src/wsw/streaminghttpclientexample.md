...
description: 此範例顯示使用串流 Api 進行要求-回復的 HTTP 用戶端。
ms.assetid: dd391506-6f14-4d3a-bd65-96a338b3f7cd
keywords:
- StreamingHttpClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="streaminghttpclientexample"></a><span data-ttu-id="0ac0c-106">StreamingHttpClientExample</span><span class="sxs-lookup"><span data-stu-id="0ac0c-106">StreamingHttpClientExample</span></span>

<span data-ttu-id="0ac0c-107">此範例顯示使用串流 Api 進行要求-回復的 HTTP 用戶端。</span><span class="sxs-lookup"><span data-stu-id="0ac0c-107">This example shows an HTTP client that does request-reply using the streaming APIs.</span></span>

-   [<span data-ttu-id="0ac0c-108">StreamingHttpClient .cpp</span><span class="sxs-lookup"><span data-stu-id="0ac0c-108">StreamingHttpClient.cpp</span></span>](#streaminghttpclientcpp)
-   [<span data-ttu-id="0ac0c-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="0ac0c-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0ac0c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="0ac0c-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpclientcpp"></a><span data-ttu-id="0ac0c-111">StreamingHttpClient .cpp</span><span class="sxs-lookup"><span data-stu-id="0ac0c-111">StreamingHttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0ac0c-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="0ac0c-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0ac0c-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="0ac0c-113">Makefile</span></span>
