...
description: 此範例示範如何新增和取出自訂標頭。
ms.assetid: 9c0cabee-4645-4b2d-a132-4494911f05b3
keywords:
- 適用于 Windows 的 CustomHeaderExample Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106968256"
---
# <a name="customheaderexample"></a><span data-ttu-id="c6ea6-106">CustomHeaderExample</span><span class="sxs-lookup"><span data-stu-id="c6ea6-106">CustomHeaderExample</span></span>

<span data-ttu-id="c6ea6-107">此範例示範如何新增和取出自訂標頭。</span><span class="sxs-lookup"><span data-stu-id="c6ea6-107">This example shows how to add and retrieve a custom header.</span></span>

-   [<span data-ttu-id="c6ea6-108">CustomHeader .cpp</span><span class="sxs-lookup"><span data-stu-id="c6ea6-108">CustomHeader.cpp</span></span>](#customheadercpp)
-   [<span data-ttu-id="c6ea6-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="c6ea6-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="c6ea6-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="c6ea6-110">Makefile</span></span>](#makefile)

## <a name="customheadercpp"></a><span data-ttu-id="c6ea6-111">CustomHeader .cpp</span><span class="sxs-lookup"><span data-stu-id="c6ea6-111">CustomHeader.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="c6ea6-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="c6ea6-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c6ea6-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="c6ea6-113">Makefile</span></span>
