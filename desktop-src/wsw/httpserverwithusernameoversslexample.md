...
此範例顯示接受通道的 TCP 伺服器，並透過 SSL 混合模式安全性來接收和回復訊息。 在此設定中，傳輸連線會受到 SSL (簽署、加密) 的 SSL，也提供伺服器驗證。 用戶端驗證是由訊息中 WS-Security 標頭中的使用者名稱/密碼組所提供。

-   [HttpServerWithUsernameOverSsl .cpp](#httpserverwithusernameoversslcpp)
-   [PurchaseOrder .wsdl](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="httpserverwithusernameoversslcpp"></a>HttpServerWithUsernameOverSsl .cpp
