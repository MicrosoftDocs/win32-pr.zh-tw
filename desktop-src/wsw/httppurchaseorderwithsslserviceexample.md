...
description: 此範例示範如何使用服務主機，透過 HTTP （具有 SSL 傳輸安全性）來裝載 PurchaseOrder 服務。
ms.assetid: 814660d7-98d7-4038-8243-d2f37929d516
keywords:
- HttpPurchaseOrderWithSslServiceExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103840343"
---
# <a name="httppurchaseorderwithsslserviceexample"></a><span data-ttu-id="964f4-106">HttpPurchaseOrderWithSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="964f4-106">HttpPurchaseOrderWithSslServiceExample</span></span>

<span data-ttu-id="964f4-107">此範例示範如何使用服務主機，透過 HTTP （具有 SSL 傳輸安全性）來裝載 PurchaseOrder 服務。</span><span class="sxs-lookup"><span data-stu-id="964f4-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with SSL transport security.</span></span>

-   [<span data-ttu-id="964f4-108">HttpPurchaseOrderServiceWithSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="964f4-108">HttpPurchaseOrderServiceWithSsl.cpp</span></span>](#httppurchaseorderservicewithsslcpp)
-   [<span data-ttu-id="964f4-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="964f4-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="964f4-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="964f4-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderservicewithsslcpp"></a><span data-ttu-id="964f4-111">HttpPurchaseOrderServiceWithSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="964f4-111">HttpPurchaseOrderServiceWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="964f4-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="964f4-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="964f4-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="964f4-113">Makefile</span></span>
