...
---
# <a name="asyncadd3explicitexample"></a><span data-ttu-id="482a7-106">AsyncAdd3ExplicitExample</span><span class="sxs-lookup"><span data-stu-id="482a7-106">AsyncAdd3ExplicitExample</span></span>

<span data-ttu-id="482a7-107">此範例說明如何在不使用 [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute)的情況下，執行複雜的非同步函式。</span><span class="sxs-lookup"><span data-stu-id="482a7-107">This example illustrates implementing a complex asynchronous function without using [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span></span>

<span data-ttu-id="482a7-108">此範例會執行非同步函式 ' AddThree '，此函式會藉由建立可非同步新增兩個整數的現有 Add 函數，將三個整數相加。</span><span class="sxs-lookup"><span data-stu-id="482a7-108">The example implements an asynchronous function 'AddThree' which adds three integers together by building upon an existing Add function which can add two integers asynchronously.</span></span>

## <a name="asyncadd3explicitcpp"></a><span data-ttu-id="482a7-109">AsyncAdd3Explicit .cpp</span><span class="sxs-lookup"><span data-stu-id="482a7-109">AsyncAdd3Explicit.cpp</span></span>
