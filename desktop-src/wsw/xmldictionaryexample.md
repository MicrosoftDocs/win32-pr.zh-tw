...
description: 這個範例會使用 WS XML 字典來撰寫檔 \_ \_ 。
ms.assetid: d8185577-3483-4005-84e5-0b10a6698e79
keywords:
- XmlDictionaryExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104301411"
---
# <a name="xmldictionaryexample"></a><span data-ttu-id="41f55-106">XmlDictionaryExample</span><span class="sxs-lookup"><span data-stu-id="41f55-106">XmlDictionaryExample</span></span>

<span data-ttu-id="41f55-107">這個範例會使用 WS XML 字典來撰寫檔 \_ \_ 。</span><span class="sxs-lookup"><span data-stu-id="41f55-107">This example writes a document using a WS\_XML\_DICTIONARY.</span></span>

-   [<span data-ttu-id="41f55-108">Xmldictionary 專案 .cpp</span><span class="sxs-lookup"><span data-stu-id="41f55-108">XmlDictionary.cpp</span></span>](#xmldictionarycpp)
-   [<span data-ttu-id="41f55-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="41f55-109">Makefile</span></span>](#makefile)

## <a name="xmldictionarycpp"></a><span data-ttu-id="41f55-110">Xmldictionary 專案 .cpp</span><span class="sxs-lookup"><span data-stu-id="41f55-110">XmlDictionary.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="41f55-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="41f55-111">Makefile</span></span>
