...
description: 此範例顯示的 UDP 伺服器會接聽多播位址，並回復傳送至該位址的要求。
ms.assetid: 9688756b-3c5e-42ca-a9da-f258d4be2360
keywords:
- MulticastUdpServerExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106968209"
---
# <a name="multicastudpserverexample"></a><span data-ttu-id="8b9ad-106">MulticastUdpServerExample</span><span class="sxs-lookup"><span data-stu-id="8b9ad-106">MulticastUdpServerExample</span></span>

<span data-ttu-id="8b9ad-107">此範例顯示的 UDP 伺服器會接聽多播位址，並回復傳送至該位址的要求。</span><span class="sxs-lookup"><span data-stu-id="8b9ad-107">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span>

-   [<span data-ttu-id="8b9ad-108">MulticastUdpServer .cpp</span><span class="sxs-lookup"><span data-stu-id="8b9ad-108">MulticastUdpServer.cpp</span></span>](#multicastudpservercpp)
-   [<span data-ttu-id="8b9ad-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="8b9ad-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="8b9ad-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="8b9ad-110">Makefile</span></span>](#makefile)

## <a name="multicastudpservercpp"></a><span data-ttu-id="8b9ad-111">MulticastUdpServer .cpp</span><span class="sxs-lookup"><span data-stu-id="8b9ad-111">MulticastUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="8b9ad-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="8b9ad-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="8b9ad-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="8b9ad-113">Makefile</span></span>
