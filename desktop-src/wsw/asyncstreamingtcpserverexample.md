...
description: 此範例顯示以非同步串流方式接收單向訊息的 TCP 伺服器。
ms.assetid: 8b79735b-f238-4d49-8977-2935fc208d48
keywords:
- AsyncStreamingTcpServerExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106965985"
---
# <a name="asyncstreamingtcpserverexample"></a><span data-ttu-id="7ad3f-106">AsyncStreamingTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="7ad3f-106">AsyncStreamingTcpServerExample</span></span>

<span data-ttu-id="7ad3f-107">此範例顯示以非同步串流方式接收單向訊息的 TCP 伺服器。</span><span class="sxs-lookup"><span data-stu-id="7ad3f-107">This example shows a TCP server that receives one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="7ad3f-108">AsyncStreamingTcpServer .cpp</span><span class="sxs-lookup"><span data-stu-id="7ad3f-108">AsyncStreamingTcpServer.cpp</span></span>](#asyncstreamingtcpservercpp)
-   [<span data-ttu-id="7ad3f-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="7ad3f-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="7ad3f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="7ad3f-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpservercpp"></a><span data-ttu-id="7ad3f-111">AsyncStreamingTcpServer .cpp</span><span class="sxs-lookup"><span data-stu-id="7ad3f-111">AsyncStreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="7ad3f-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="7ad3f-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="7ad3f-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="7ad3f-113">Makefile</span></span>
