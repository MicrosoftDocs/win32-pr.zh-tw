...
description: 此範例示範如何在 xml 緩衝區中插入元素。
ms.assetid: 98fed487-77f8-4224-9a73-b20afcb01d47
keywords:
- InsertElementExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104507324"
---
# <a name="insertelementexample"></a><span data-ttu-id="c3fd3-106">InsertElementExample</span><span class="sxs-lookup"><span data-stu-id="c3fd3-106">InsertElementExample</span></span>

<span data-ttu-id="c3fd3-107">此範例示範如何在 xml 緩衝區中插入元素。</span><span class="sxs-lookup"><span data-stu-id="c3fd3-107">This example shows how to insert an element in an xml buffer.</span></span>

## <a name="insertelementcpp"></a><span data-ttu-id="c3fd3-108">InsertElement .cpp</span><span class="sxs-lookup"><span data-stu-id="c3fd3-108">InsertElement.cpp</span></span>
