...
description: 此範例顯示以非同步串流方式傳送單向訊息的 TCP 用戶端。
ms.assetid: b0040b3d-d830-421a-bbf1-afb0cac47599
keywords:
- AsyncStreamingTcpClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104301128"
---
# <a name="asyncstreamingtcpclientexample"></a><span data-ttu-id="8a939-106">AsyncStreamingTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="8a939-106">AsyncStreamingTcpClientExample</span></span>

<span data-ttu-id="8a939-107">此範例顯示以非同步串流方式傳送單向訊息的 TCP 用戶端。</span><span class="sxs-lookup"><span data-stu-id="8a939-107">This example shows a TCP client that sends one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="8a939-108">AsyncStreamingTcpClient .cpp</span><span class="sxs-lookup"><span data-stu-id="8a939-108">AsyncStreamingTcpClient.cpp</span></span>](#asyncstreamingtcpclientcpp)
-   [<span data-ttu-id="8a939-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="8a939-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="8a939-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="8a939-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpclientcpp"></a><span data-ttu-id="8a939-111">AsyncStreamingTcpClient .cpp</span><span class="sxs-lookup"><span data-stu-id="8a939-111">AsyncStreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="8a939-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="8a939-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="8a939-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="8a939-113">Makefile</span></span>
