...
description: 此範例顯示使用服務 proxy 與 PurchaseOrder 服務通訊的 HTTP 用戶端，其使用者名稱為 SSL 混合模式安全性。
ms.assetid: 9874f00d-1efa-47ed-8029-f93962046789
keywords:
- HttpPurchaseOrderWithUsernameOverSslClientExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104183844"
---
# <a name="httppurchaseorderwithusernameoversslclientexample"></a><span data-ttu-id="5496d-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="5496d-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span></span>

<span data-ttu-id="5496d-107">此範例顯示使用服務 proxy 與 PurchaseOrder 服務通訊的 HTTP 用戶端，其使用者名稱為 SSL 混合模式安全性。</span><span class="sxs-lookup"><span data-stu-id="5496d-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="5496d-108">在此設定中，傳輸連線會受到 SSL (簽署、加密) 的 SSL，也提供伺服器驗證。</span><span class="sxs-lookup"><span data-stu-id="5496d-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="5496d-109">用戶端驗證是由訊息中 WS-Security 標頭中的使用者名稱/密碼組所提供。</span><span class="sxs-lookup"><span data-stu-id="5496d-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="5496d-110">PurchaseOrderClientUserNameOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="5496d-110">PurchaseOrderClientUserNameOverSsl.cpp</span></span>](#purchaseorderclientusernameoversslcpp)
-   [<span data-ttu-id="5496d-111">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="5496d-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="5496d-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="5496d-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientusernameoversslcpp"></a><span data-ttu-id="5496d-113">PurchaseOrderClientUserNameOverSsl .cpp</span><span class="sxs-lookup"><span data-stu-id="5496d-113">PurchaseOrderClientUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="5496d-114">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="5496d-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5496d-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="5496d-115">Makefile</span></span>
