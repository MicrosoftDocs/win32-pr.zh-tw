...
description: 此範例顯示接受通道的 HTTP 伺服器，並以串流方式進行要求-回復處理。
ms.assetid: c108a5b3-923c-439c-8d86-7003a76ff45d
keywords:
- StreamingHttpServerExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103840923"
---
# <a name="streaminghttpserverexample"></a><span data-ttu-id="c0484-106">StreamingHttpServerExample</span><span class="sxs-lookup"><span data-stu-id="c0484-106">StreamingHttpServerExample</span></span>

<span data-ttu-id="c0484-107">此範例顯示接受通道的 HTTP 伺服器，並以串流方式進行要求-回復處理。</span><span class="sxs-lookup"><span data-stu-id="c0484-107">This example shows an HTTP server that accepts a channel, and does request-reply processing in a streaming fashion.</span></span>

-   [<span data-ttu-id="c0484-108">StreamingHttpServer .cpp</span><span class="sxs-lookup"><span data-stu-id="c0484-108">StreamingHttpServer.cpp</span></span>](#streaminghttpservercpp)
-   [<span data-ttu-id="c0484-109">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="c0484-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="c0484-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="c0484-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpservercpp"></a><span data-ttu-id="c0484-111">StreamingHttpServer .cpp</span><span class="sxs-lookup"><span data-stu-id="c0484-111">StreamingHttpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="c0484-112">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="c0484-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c0484-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="c0484-113">Makefile</span></span>
