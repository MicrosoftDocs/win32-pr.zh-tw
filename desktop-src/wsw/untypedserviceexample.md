...
description: 此範例說明如何使用服務模型來執行不具類型的服務。 在此情況下，服務模型會提供定案盤子基礎結構。
ms.assetid: 4235554e-19a8-4df7-97a5-2f7544a3c830
keywords:
- UnTypedServiceExample 原生 Web 服務
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="untypedserviceexample"></a><span data-ttu-id="ba06e-107">UnTypedServiceExample</span><span class="sxs-lookup"><span data-stu-id="ba06e-107">UnTypedServiceExample</span></span>

<span data-ttu-id="ba06e-108">此範例說明如何使用服務模型來執行不具類型的服務。</span><span class="sxs-lookup"><span data-stu-id="ba06e-108">This sample shows how implement an untyped service with Service Model.</span></span> <span data-ttu-id="ba06e-109">在此情況下，服務模型會提供定案盤子基礎結構。</span><span class="sxs-lookup"><span data-stu-id="ba06e-109">Service Model in this case provides the boiler plate infrastructure.</span></span>

-   [<span data-ttu-id="ba06e-110">UnTypedService .cpp</span><span class="sxs-lookup"><span data-stu-id="ba06e-110">UnTypedService.cpp</span></span>](#untypedservicecpp)
-   [<span data-ttu-id="ba06e-111">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="ba06e-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="ba06e-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="ba06e-112">Makefile</span></span>](#makefile)

## <a name="untypedservicecpp"></a><span data-ttu-id="ba06e-113">UnTypedService .cpp</span><span class="sxs-lookup"><span data-stu-id="ba06e-113">UnTypedService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="ba06e-114">PurchaseOrder .wsdl</span><span class="sxs-lookup"><span data-stu-id="ba06e-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="ba06e-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="ba06e-115">Makefile</span></span>
