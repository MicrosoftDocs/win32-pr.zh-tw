...
---
# <a name="cd3dx12_pipeline_state_stream_ds-structure"></a>CD3DX12 \_ 管線 \_ 狀態 \_ 資料流程 \_ DS 結構

協助程式結構，用來將網域著色器描述為適合資料流程描述的單一物件。
...
**CD3DX12 \_ 管線 \_ 狀態 \_ 串流 \_ DS**
</dt> <dd>

建立 CD3DX12 \_ 管線 \_ 狀態 \_ 資料流程 DS 的新、未初始化的實例 \_ 。

</dd> <dt>

**CD3DX12 \_ 管線 \_ 狀態 \_ 資料流程 \_ DS (D3D12 \_ 著色器 \_ 位元組位元組常數 &i)**
</dt> <dd>

建立 CD3DX12 \_ 管線 \_ 狀態資料流程 DS 的新實例 \_ \_ ，並以 **D3D12 管線狀態子物件 \_ \_ \_ \_ 類型 \_ DS** 的子物件類型和從 *i* 複製的子物件資料（ [**D3D12 \_ 著色器 \_ 位元組**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_shader_bytecode) 程式化結構）進行初始化。
...
CD3DX12 \_ 管線 \_ 狀態 \_ 串流 \_ DS 是 [**CD3DX12 \_ 管線 \_ 狀態 \_ \_ 資料流程**](cd3dx12-pipeline-state-stream-subobject.md) 子物件範本的 typedef 特製化，其定義如下：
