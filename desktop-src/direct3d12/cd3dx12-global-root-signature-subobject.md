---
title: 'CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT 類別 (D3dx12) '
description: 用來建立全域根簽章狀態 suboject 的 helper 類別。
keywords:
- CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT 類別
topic_type:
- apiref
api_name:
...
ms.locfileid: "121812485"
---
# <a name="cd3dx12_global_root_signature_subobject-class"></a>CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT 類別

用來建立全域根簽章狀態 suboject 的 helper 類別。
...
預設建構函式。 建立 **CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT** 預設初始化的新實例。

`CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT(CD3DX12_STATE_OBJECT_DESC&)`

建立新實例的函式， **CD3DX12_GLOBAL_ROOT_SIGNATURE_SUBOBJECT** 以 [**CD3DX12_STATE_OBJECT_DESC**](cd3dx12-state-object-desc.md) 物件的內容初始化。
...
抓取子物件的類型，由 [D3D12_STATE_SUBOBJECT_TYPE_GLOBAL_ROOT_SIGNATURE](/windows/win32/api/d3d12/ne-d3d12-d3d12_state_subobject_type) 常數表示。
