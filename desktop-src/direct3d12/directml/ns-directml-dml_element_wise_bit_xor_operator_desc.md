...
---
# <a name="dml_element_wise_bit_xor_operator_desc-structure-directmlh"></a>DML_ELEMENT_WISE_BIT_XOR_OPERATOR_DESC 結構 (directml .h) 

在輸入張量的每個對應專案之間計算位 XOR (獨佔或) ，然後將結果寫入輸出 tensor。
