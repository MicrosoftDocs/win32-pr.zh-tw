...
* *OutputIndexTensor* 和 *OutputValueTensor* 的 *大小* 必須相同。

## <a name="tensor-support"></a>Tensor 支援
| 張 | 類型 | 維度 | 支援的維度計數 | 支援的資料類型 |
| ------ | ---- | ---------- | -------------------------- | -------------------- |
| InputTensor | 輸入 | { In0, In1, In2, In3 } | 4 | FLOAT32、FLOAT16、INT32、INT16、INT8、UINT32、UINT16、UINT8 |
| OutputValueTensor | 輸出 | { Out0, Out1, Out2, Out3 } | 4 | FLOAT32、FLOAT16、INT32、INT16、INT8、UINT32、UINT16、UINT8 |
| OutputIndexTensor | 輸出 | { Out0, Out1, Out2, Out3 } | 4 | UINT32 |
