...
---
# <a name="dml_element_wise_bit_and_operator_desc-structure-directmlh"></a>DML_ELEMENT_WISE_BIT_AND_OPERATOR_DESC 結構 (directml .h) 

在輸入張量的每個對應元素之間計算位 AND，然後將結果寫入輸出 tensor。
