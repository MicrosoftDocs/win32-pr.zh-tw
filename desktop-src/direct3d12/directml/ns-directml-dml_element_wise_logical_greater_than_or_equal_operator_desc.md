...
---
# <a name="dml_element_wise_logical_greater_than_or_equal_operator_desc-structure-directmlh"></a>DML_ELEMENT_WISE_LOGICAL_GREATER_THAN_OR_EQUAL_OPERATOR_DESC 結構 (directml .h) 

在輸入張量的每一對對應元素上執行邏輯 *大於或等於* ，將結果 (1 表示 true，將0設為 true) 至對應的 *OutputTensor* 元素。
