...
ms.locfileid: "119822098"
---
# <a name="sh_socket-keyword"></a>sh \_ 通訊端關鍵字

**Sh \_ 通訊端** 關鍵字會指定 `system_handle` 保留通訊端的控制碼。
...
[Windows通訊端2](../winsock/windows-sockets-start-page-2.md)
</dt> </dl>
