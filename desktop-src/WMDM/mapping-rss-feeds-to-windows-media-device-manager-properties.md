---
title: 將 RSS 摘要對應至 Windows 媒體裝置管理員屬性
description: 將 RSS 摘要對應至 Windows 媒體裝置管理員屬性
ms.assetid: 354c98ab-1392-476f-a650-75b948dc971a
keywords:
- Windows媒體裝置管理員，RSS 摘要
- 裝置管理員，RSS 摘要
- 程式設計指南，RSS 摘要
- 桌面應用程式，RSS 摘要
- 建立 Windows 媒體裝置管理員應用程式、rss 摘要
- RSS 摘要
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "120031678"
---
# <a name="mapping-rss-feeds-to-windows-media-device-manager-properties"></a>將 RSS 摘要對應至 Windows 媒體裝置管理員屬性

Windows Media Player 11 提供 RSS 匯總程式功能，可讓使用者在他們的電腦上儲存從播客取得的內容。 本主題說明在 RSS 摘要中找到的 XML 元素。 此外，它會將這些 RSS 元素對應至 Windows 媒體裝置管理員屬性。
...
下表列出 RSS 摘要中的通道元素，以及對應的 Windows 媒體裝置管理員屬性。



| Channel 元素 | 狀態         | 對應 Windows 媒體裝置管理員屬性   |
|-----------------|----------------|-------------------------------------------------------|
...
| Image 項目 | 狀態   | 對應 Windows 媒體裝置管理員屬性 |
|---------------|----------|-----------------------------------------------------|
...
下表列出 RSS 摘要中的專案元素，以及對應的 Windows 媒體裝置管理員屬性。



| Item 項目 | 屬性   | 狀態         | 對應 Windows 媒體裝置管理員屬性            |
|--------------|-------------|----------------|----------------------------------------------------------------|
...
將 RSS 通道元素對應至 Windows 媒體裝置管理員屬性值

下表說明上一個範例中 RSS 通道元素的值如何對應至特定 Windows 媒體裝置管理員屬性。
...
將 RSS 影像元素對應至 Windows 媒體裝置管理員屬性值

下表說明上一個範例中 RSS 影像元素的值如何對應至特定 Windows 媒體裝置管理員屬性。
...
將 RSS 專案元素對應至 Windows 媒體裝置管理員屬性值

下表說明上一個範例中 RSS 專案專案的值如何對應至特定 Windows 媒體裝置管理員屬性。
