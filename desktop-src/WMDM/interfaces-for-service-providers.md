...
keywords:
- Windows媒體裝置管理員、服務提供者介面
- 裝置管理員，服務提供者介面
- 服務提供者，介面
- 程式設計參考，服務提供者介面
- Windows 媒體裝置管理員、服務提供者介面的參考
- 服務提供者介面
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119766701"
---
# <a name="interfaces-for-service-providers"></a>服務提供者的介面

本節說明 Windows Media 裝置管理員服務提供者所執行的介面。 服務提供者會執行大部分與裝置通訊的實際工作，因為它們會執行應用程式所呼叫的大部分 Windows 媒體裝置管理員 SDK 方法。
...
| [**IMDServiceProvider**](/windows/desktop/api/mswmdm/nn-mswmdm-imdserviceprovider)       | 提供用戶端 (通常 Windows 媒體裝置管理員) ，以及此服務提供者所支援裝置的裝置枚舉器。                                                                                                                                                                          |
...
| [**IMDSPDirectTransfer**](/windows/desktop/api/mswmdm/nn-mswmdm-imdspdirecttransfer)     | 可讓 Windows 媒體裝置管理員將內容傳輸委派給服務提供者。 在此情況下 Windows 媒體裝置管理員在將內容傳送給服務提供者之前，不會執行任何內容處理。 服務提供者會取得來源的完全控制權。                                   |
...
[**Windows媒體 DRM-Implemented 介面**](windows-media-drm-implemented-interfaces.md)
</dt> </dl>
