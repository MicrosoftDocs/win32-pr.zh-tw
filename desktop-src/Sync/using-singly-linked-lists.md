...
---
# <a name="using-singly-linked-lists"></a><span data-ttu-id="6893c-103">使用單向連結清單</span><span class="sxs-lookup"><span data-stu-id="6893c-103">Using Singly Linked Lists</span></span>

<span data-ttu-id="6893c-104">下列範例會使用 [**InitializeSListHead**](/windows/win32/api/interlockedapi/nf-interlockedapi-initializeslisthead) 函數來初始化 [單一連結清單](interlocked-singly-linked-lists.md) ，並使用 [**InterlockedPushEntrySList**](/windows/win32/api/interlockedapi/nf-interlockedapi-interlockedpushentryslist) 函式來插入10個專案。</span><span class="sxs-lookup"><span data-stu-id="6893c-104">The following example uses the [**InitializeSListHead**](/windows/win32/api/interlockedapi/nf-interlockedapi-initializeslisthead) function to initialize a [singly linked list](interlocked-singly-linked-lists.md) and the [**InterlockedPushEntrySList**](/windows/win32/api/interlockedapi/nf-interlockedapi-interlockedpushentryslist) function to insert 10 items.</span></span> <span data-ttu-id="6893c-105">此範例會使用 [**InterlockedPopEntrySList**](/windows/win32/api/interlockedapi/nf-interlockedapi-interlockedpopentryslist) 函數來移除10個專案，並使用 [**InterlockedFlushSList**](/windows/win32/api/interlockedapi/nf-interlockedapi-interlockedflushslist) 函數來確認清單是空的。</span><span class="sxs-lookup"><span data-stu-id="6893c-105">The example uses the [**InterlockedPopEntrySList**](/windows/win32/api/interlockedapi/nf-interlockedapi-interlockedpopentryslist) function to remove 10 items and the [**InterlockedFlushSList**](/windows/win32/api/interlockedapi/nf-interlockedapi-interlockedflushslist) function to verify that the list is empty.</span></span>
