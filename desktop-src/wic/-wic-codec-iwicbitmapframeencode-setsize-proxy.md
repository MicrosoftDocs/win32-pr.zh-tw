...
---
# <a name="iwicbitmapframeencode_setsize_proxy-function"></a>IWICBitmapFrameEncode \_ SetSize \_ Proxy 函式

[**SetSize**](/windows/desktop/api/Wincodec/nf-wincodec-iwicbitmapframeencode-setsize)方法的 Proxy 函式。
