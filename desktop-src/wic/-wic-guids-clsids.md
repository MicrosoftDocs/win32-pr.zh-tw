...
ms.locfileid: "118206165"
---
# <a name="wic-guids-and-clsids"></a>WIC Guid 和 Clsid

本檔包含 (clsid) 資料表的 guid 和類別識別碼，Windows 影像處理元件 (WIC) 。

本主題包含下列章節：

-   [內建的 Clsid](#wic-guids-and-clsids)
-   [容器格式](#container-formats)
-   [元件識別碼](#component-identifiers)
-   [格式轉換器](#format-converters)
-   [元資料處理程式](#metadata-handlers)
-   [廠商識別](#vendor-identification)
-   [相關主題](#related-topics)

## <a name="built-in-clsids"></a>內建的 Clsid
...
| CLSID \_ WICJpegDecoder | 0x9456a480、0xe88b、0x43ea、0x9e、0x73、0xb、0x2d、0x9b、0x71、0xb1、元素0xca  |
...
| CLSID \_ WICWmpDecoder  | 0xa26cec36、0x234c、0x4950、0xae、0x16、0xe3、0x4a、0xac、0xe7、bugcheck 0x1d、0x0d |
| **編碼器**          |                                                                            |
...
## <a name="container-formats"></a>容器格式
...
| GUID \_ ContainerFormatTiff | 0x163bcc30、0xe2e9、0x4f0b、0x96、bugcheck 0x1d、0xa3、0xe9、0xfd、0xb7、0x88、0xa3 |
...
| GUID \_ ContainerFormatWebp  | 0xe094b0e2、0x67f2、0x45b3、0xb0、0xea、0x11、0x53、0x37、元素0xca、0x7c、0xf3 |


 

## <a name="component-identifiers"></a>元件識別碼
...
| CLSID \_ WICMetadataReader    | 0x05af94d8、0x7174、0x4cd2、0xbe、0x4a、0x41 向、0x24、0xb8、0x0e、0xe4、0xb8 |
...
## <a name="format-converters"></a>格式轉換器
...
## <a name="metadata-handlers"></a>元資料處理程式
...
| GUID \_ MetadataFormatInterop            | 0xED686F8E、0x681F、0x4C8B、0xBD、0x41 向、0xA8、0xAD、0xDB、0xF6、0xB3、0xFC |
...
| GUID \_ MetadataFormatGCE                | 0x2A25CAD8、0xDEEB、0x4C69、0xA7、0x88、0xE、0xC2、0x26、0x6D、元素0xca、0xFD  |
...
## <a name="vendor-identification"></a>廠商識別

廠商可以透過廠商 GUID 來識別其家族內的元件。 這在協力廠商元件的仲裁方面很有用。 
...
[原生像素格式](-wic-codec-native-pixel-formats.md)
</dt> </dl>
