...
---
# <a name="iwicpalette_hasalpha_proxy-function"></a>IWICPalette \_ HasAlpha \_ Proxy 函式

[**HasAlpha**](/windows/desktop/api/Wincodec/nf-wincodec-iwicpalette-hasalpha)方法的 Proxy 函式。
...
`TRUE`如果調色板包含透明色彩，則為收到的指標; 否則為 `FALSE` 。
