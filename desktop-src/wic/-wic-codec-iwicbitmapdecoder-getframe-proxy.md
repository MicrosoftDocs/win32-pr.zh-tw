...
---
# <a name="iwicbitmapdecoder_getframe_proxy-function"></a>IWICBitmapDecoder \_ GetFrame \_ Proxy 函式

[**GetFrame**](/windows/desktop/api/Wincodec/nf-wincodec-iwicbitmapdecoder-getframe)方法的 Proxy 函式。
...
接收 [**IWICBitmapFrameDecode**](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapframedecode)指標的指標。
