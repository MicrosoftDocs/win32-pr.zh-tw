...
| [**WICCreateBitmapFromSection**](/windows/desktop/api/Wincodec/nf-wincodec-wiccreatebitmapfromsection)<br/>     | 傳回由 Windows 圖形裝置介面的圖元所支援的 [**IWICBitmapSource**](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapsource) (GDI) 區段控制碼。<br/>                                                |
