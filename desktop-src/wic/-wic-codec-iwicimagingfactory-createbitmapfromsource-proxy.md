...
---
# <a name="iwicimagingfactory_createbitmapfromsource_proxy-function"></a>IWICImagingFactory \_ CreateBitmapFromSource \_ Proxy 函式

[**CreateBitmapFromSource**](/windows/desktop/api/Wincodec/nf-wincodec-iwicimagingfactory-createbitmapfromsource)方法的 Proxy 函式。
...
要從中建立點陣圖的 [_ *IWICBitmapSource* *](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapsource) 。
