...
本節包含 Windows 影像處理元件 (WIC) 範例。

WIC 提供兩種類型的範例：

-   範例：使用數個 WIC 功能的程式碼區段。 範例的原始程式碼會在 Windows SDK 中傳遞。
-   程式碼範例：示範特定功能的較短範例。 SDK 不提供範例的原始程式碼。
...
| [使用 Direct2D 範例的 WIC 影像檢視器](-wic-sample-d2d-viewer.md)                                                     | 示範如何使用 WIC 來解碼影像檔案和 Direct2D，以將影像轉譯至螢幕。                                                       |
...
| 程式碼範例                                                                        | Description                                                                               |
|-------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| [How to：使用中繼資料重新編碼 JPEG 影像](-wic-codec-jpegmetadataencoding.md) | 示範如何將影像和其中繼資料重新編碼為相同格式的新檔案。 |
