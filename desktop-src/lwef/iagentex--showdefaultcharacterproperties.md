...
> [!Note]  
> 針對 Windows 2000，可能需要呼叫新的 [**AllowSetForegroundWindow**](/windows/desktop/api/winuser/nf-winuser-allowsetforegroundwindow) API，以確保此視窗成為前景視窗。 如需有關在 Windows 2000 下設定前景視窗的詳細資訊，請參閱 Platform SDK 檔。
