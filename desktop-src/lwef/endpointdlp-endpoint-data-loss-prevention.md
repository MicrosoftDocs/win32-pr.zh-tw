...
## <a name="check-if-endpoint-dlp-is-enabled"></a><span data-ttu-id="a47a8-130">檢查是否已啟用 endpoint DLP</span><span class="sxs-lookup"><span data-stu-id="a47a8-130">Check if endpoint DLP is enabled</span></span>
