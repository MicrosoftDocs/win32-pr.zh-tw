---
title: 使用語言資訊音效編輯工具
description: 使用 Microsoft 語言資訊音效編輯工具
...
-   [建立新的音效檔](creating-a-new-sound-file.md)
-   [載入現有的音效檔](loading-an-existing-sound-file.md)
-   [產生語言資訊](generating-linguistic-information.md)
-   [儲存音效檔](saving-a-sound-file.md)
