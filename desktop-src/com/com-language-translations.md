...
-   [語法差異](syntax-differences.md)
-   [資料類型轉換](data-type-conversions.md)
-   [IDL 檔案](idl-files.md)
-   [轉換程式設計語言的 COM 物件語法](translating-com-object-syntax-for-programming-languages.md)
-   [使用 COM 物件編寫腳本](scripting-with-com-objects.md)

其目的是要解決使用 COM 物件時所發生的最常見語言轉譯問題。 所述的技術和原則適用于任何支援 COM 的程式設計或指令碼語言。 因為指令碼語言和程式設計語言代表不同的程式設計架構，所以不會處理指令碼語言與程式設計語言之間的轉譯。
