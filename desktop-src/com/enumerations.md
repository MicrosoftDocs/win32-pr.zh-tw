...
-   [**系結 \_ 旗標**](/windows/win32/api/objidl/ne-objidl-bind_flags)
-   [**BINDSPEED**](/windows/win32/api/oleidl/ne-oleidl-bindspeed)
-   **BSCO \_ 選項**
-   [**CALLFRAME \_ 複製**](/windows/win32/api/callobj/ne-callobj-callframe_copy)
-   [**\_免費 CALLFRAME**](/windows/desktop/api/CallObj/ne-callobj-callframe_free)
-   [**CALLFRAME \_ 逐步解說**](/windows/desktop/api/CallObj/ne-callobj-callframe_walk)
-   [**CALLTYPE**](/windows/win32/api/objidl/ne-objidl-calltype)
-   [**CLSCTX**](/windows/win32/api/wtypesbase/ne-wtypesbase-clsctx)
-   [**共同 \_ 封送處理 \_ 上下文 \_ 屬性**](/windows/desktop/api/objidl/ne-objidl-co_marshaling_context_attributes)
-   [**COINIT**](/windows/win32/api/objbase/ne-objbase-coinit)
-   [**COMSD**](/windows/win32/api/objbase/ne-objbase-comsd)
-   [**COWAIT \_ 旗標**](/windows/win32/api/combaseapi/ne-combaseapi-cowait_flags)
-   [**EOC \_ ChangeType**](/windows/win32/api/eventsys/ne-eventsys-eoc_changetype)
-   [**EOLE \_ 驗證 \_ 功能**](/windows/win32/api/objidlbase/ne-objidlbase-eole_authentication_capabilities)
-   [**EXTCONN**](/windows/win32/api/objidlbase/ne-objidlbase-extconn)
-   [**GLOBALOPT \_ 屬性**](/windows/win32/api/objidl/ne-objidl-globalopt_properties)
-   [**GLOBALOPT 取消 \_ 封送 \_ 原則 \_ 值**](/windows/win32/api/objidl/ne-objidl-globalopt_unmarshaling_policy_values)
...
-   [**記錄 \_ 讀取 \_ 原則**](/windows/desktop/api/TxLogpub/ne-txlogpub-record_reading_policy)
