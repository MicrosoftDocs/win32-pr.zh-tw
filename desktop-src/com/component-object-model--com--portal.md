...
您可以使用各種程式設計語言來建立 COM 物件。 物件導向的語言（例如 c + +）提供可簡化 COM 物件之執行的程式設計機制。 即使是在遠端電腦上，這些物件也可以在單一進程內，也可以在其他進程中使用。

## <a name="run-time-requirements"></a>執行階段需求求

如需有關使用特定介面或函式之作業系統的詳細資訊，請參閱介面或函式檔集的需求一節。
...
| 主題                                                                     | 描述                                                                                                                                      |
|---------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| [COM 基本概念](com-fundamentals.md)<br/>                       | 說明基本概念和程式設計參考。<br/>                                                                         |
| [OLE 和資料傳輸](ole-and-data-transfer.md)<br/>             | 描述複合檔案和資料傳輸。<br/>                                                                                       |
| [控制項和屬性頁](controls-and-property-pages.md)<br/> | 描述 ActiveX 控制項和屬性頁。<br/>                                                                                        |
| [COM 語言翻譯](com-language-translations.md)<br/>     | 描述程式設計語言之間的差異，並說明如何將 COM 物件語法從某個語言轉譯成另一種語言。<br/> |
