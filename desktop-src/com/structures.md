...
-   [**ACTRL \_ 存取**](/windows/win32/api/accctrl/ns-accctrl-actrl_accessa)
-   [**ACTRL \_ 存取 \_ 專案**](/windows/desktop/api/AccCtrl/ns-accctrl-actrl_access_entrya)
-   [**ACTRL \_ 存取 \_ 專案 \_ 清單**](/windows/desktop/api/AccCtrl/ns-accctrl-actrl_access_entry_lista)
-   [**ACTRL \_ 屬性 \_ 專案**](/windows/desktop/api/AccCtrl/ns-accctrl-actrl_property_entrya)
-   [**系結選擇 \_**](/windows/win32/api/objidl/ns-objidl-bind_opts)
-   [**系結 \_ OPTS2**](/windows/win32/api/objidl/ns-objidl-bind_opts2~r1)
-   [**系結 \_ OPTS3**](/windows/win32/api/objidl/ns-objidl-bind_opts3~r1)
...
-   [**多重 \_ QI**](/windows/win32/api/objidlbase/ns-objidlbase-multi_qi)
-   [**ORPC \_ DBG \_ ALL**](orpc-dbg-all.md)
-   [**ORPC \_ DBG \_ 緩衝區**](orpc-dbg-all.md)
...
-   [**唯一 \_ 驗證 \_ 清單**](/windows/win32/api/objidlbase/ns-objidlbase-sole_authentication_list)
