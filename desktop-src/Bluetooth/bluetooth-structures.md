...
| [**藍牙 \_ 貨 \_ 組**](/windows/desktop/api/BluetoothAPIs/ns-bluetoothapis-bluetooth_cod_pairs)                                          | 提供裝置藍牙類別的規格和抓取 (貨) 資訊。                                         |
...
| [**藍牙 \_ 尋找 \_ 單選 \_ 參數**](/windows/desktop/api/BluetoothAPIs/ns-bluetoothapis-bluetooth_find_radio_params)                         | 協助列舉已安裝的藍牙無線電。                                                                       |
| [**藍牙 \_ 本地 \_ 服務 \_ 資訊**](/windows/win32/api/bluetoothapis/ns-bluetoothapis-bluetooth_local_service_info_struct)                       | 包含藍牙無線電的本機服務資訊。                                                                        |
...
| [**藍牙 \_ 無線電 \_ 資訊**](/windows/desktop/api/BluetoothAPIs/ns-bluetoothapis-bluetooth_radio_info)                                        | 包含藍牙無線電的相關資訊。                                                                                    |
| [**藍牙 \_ 選取 \_ 裝置 \_ 參數**](/windows/desktop/api/BluetoothAPIs/ns-bluetoothapis-bluetooth_select_device_params)                   | 促進及管理藍牙裝置和服務的可見度、驗證及選取。                         |
| [**BTH \_ 裝置 \_ 資訊**](/windows/desktop/api/Bthdef/ns-bthdef-bth_device_info)                                                  | 儲存藍牙裝置的相關資訊。                                                                                     |
| [**BTH \_ HCI \_ 事件 \_ 資訊**](/windows/desktop/api/Bthdef/ns-bthdef-bth_hci_event_info)                                           | 用於連線以取得 \_ 藍牙的 WM DEVICECHANGE 訊息。                                                       |
...
| [**BTH \_ \_ 範圍中的收音機 \_**](/windows/desktop/api/Bthdef/ns-bthdef-bth_radio_in_range)                                           | 儲存位於通訊範圍內之藍牙裝置的相關資料。                                                     |
| [**BTH \_ 設定 \_ 服務**](/windows/desktop/api/Ws2bth/ns-ws2bth-bth_set_service)                                                  | 提供指定之藍牙服務的服務資訊。                                                                |
...
| [**SOCKADDR \_ BTH**](/windows/desktop/api/Ws2bth/ns-ws2bth-sockaddr_bth)                                                         | 與由 AF BTH 位址系列所定義的藍牙通訊端作業搭配使用 \_ 。                                   |
