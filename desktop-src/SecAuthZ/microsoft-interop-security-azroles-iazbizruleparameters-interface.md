...
**Azroles. IAzBizRuleParameters** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzBizRuleParameters** 介面具有下列類型的成員：
...
**AzRoles. IAzBizRuleParameters** 介面具有這些方法。



| 方法                                                                        | 描述                                                                                                 |
|:------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------|
| **Azroles. IAzBizRuleParameters. AddParameter**      | [**IAzBizRuleParameters::AddParameter**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleparameters-addparameter)<br/>           |
| **Azroles. IAzBizRuleParameters. AddParameters**     | [**IAzBizRuleParameters::AddParameters**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleparameters-addparameters)<br/>         |
| **Azroles. IAzBizRuleParameters. GetParameterValue** | [**IAzBizRuleParameters：： GetParameterValue**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleparameters-getparametervalue)<br/> |
| **Azroles. IAzBizRuleParameters. Remove**            | [**IAzBizRuleParameters：： Remove**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleparameters-remove)<br/>                       |
| **Azroles. IAzBizRuleParameters. RemoveAll**         | [**IAzBizRuleParameters：： RemoveAll**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleparameters-removeall)<br/>                 |
...
**AzRoles. IAzBizRuleParameters** 介面具有這些屬性。
