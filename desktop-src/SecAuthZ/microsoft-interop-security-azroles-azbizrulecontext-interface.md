---
description: IAzBizRuleCoNtext 互通性包裝函式方法和屬性的檔連結。
ms.assetid: d4fa67c9-fe4a-4adb-bd3a-a3f33ba5f087
title: AzRoles. IAzBizRuleCoNtext 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
**Azroles. IAzBizRuleCoNtext** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzBizRuleCoNtext** 介面具有下列類型的成員：
...
**AzRoles. IAzBizRuleCoNtext** 介面具有這些方法。



| 方法                                                                | 描述                                                                         |
|:----------------------------------------------------------------------|:------------------------------------------------------------------------------------|
| **Azroles. IAzBizRuleCoNtext. GetParameter** | [**IAzBizRuleCoNtext：： GetParameter**](/windows/desktop/api/Azroles/nf-azroles-iazbizrulecontext-getparameter)<br/> |
...
**AzRoles. IAzBizRuleCoNtext** 介面具有這些屬性。
