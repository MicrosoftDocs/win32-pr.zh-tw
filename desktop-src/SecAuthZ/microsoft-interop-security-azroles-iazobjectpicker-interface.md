---
description: IAzObjectPicker 互通性包裝函式方法和屬性的檔連結。
ms.assetid: 8b3db64c-0772-4810-96bf-6c9334c9bc4c
title: AzRoles. IAzObjectPicker 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
**Azroles. IAzObjectPicker** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzObjectPicker** 介面具有下列類型的成員：
...
**AzRoles. IAzObjectPicker** 介面具有這些方法。



| 方法                                                               | 描述                                                                               |
|:---------------------------------------------------------------------|:------------------------------------------------------------------------------------------|
| **Azroles. IAzObjectPicker. GetPrincipals** | [**IAzObjectPicker::GetPrincipals**](/windows/desktop/api/Azroles/nf-azroles-iazobjectpicker-getprincipals)<br/> |
...
**AzRoles. IAzObjectPicker** 介面具有這些屬性。
