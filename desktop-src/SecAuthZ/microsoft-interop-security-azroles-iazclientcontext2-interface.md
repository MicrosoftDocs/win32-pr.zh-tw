---
description: IAzClientCoNtext2 互通性包裝函式方法和屬性的檔連結。
ms.assetid: f38af05c-f5d5-42e8-a64c-d6f71ad4c1e1
title: AzRoles. IAzClientCoNtext2 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "106995669"
---
# <a name="microsoftinteropsecurityazrolesiazclientcontext2-interface"></a>AzRoles. IAzClientCoNtext2 介面

**Azroles. IAzClientCoNtext2** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzClientCoNtext2** 介面具有下列類型的成員：
...
**AzRoles. IAzClientCoNtext2** 介面具有這些方法。



| 方法                                                                         | 描述                                                                                            |
|:-------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------|
| **Azroles. IAzClientCoNtext2. AccessCheck**           | [**IAzClientCoNtext：： AccessCheck**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-accesscheck)<br/>                       |
| **Azroles. IAzClientCoNtext2. AddApplicationGroups**  | [**IAzClientCoNtext2::AddApplicationGroups**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext2-addapplicationgroups)<br/>   |
| **Azroles. IAzClientCoNtext2. AddRoles**              | [**IAzClientCoNtext2::AddRoles**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext2-addroles)<br/>                           |
| **Azroles. IAzClientCoNtext2. AddStringSids**         | [**IAzClientCoNtext2::AddStringSids**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext2-addstringsids)<br/>                 |
| **Azroles. IAzClientCoNtext2. GetAssignedScopesPage** | [**IAzClientCoNtext2::GetAssignedScopesPage**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext2-getassignedscopespage)<br/> |
| **Azroles. IAzClientCoNtext2. GetBusinessRuleString** | [**IAzClientCoNtext::GetBusinessRuleString**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-getbusinessrulestring)<br/>   |
| **Azroles. IAzClientCoNtext2. GetProperty**           | [**IAzClientCoNtext：： GetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-getproperty)<br/>                       |
| **Azroles. IAzClientCoNtext2. GetRoles**              | [**IAzClientCoNtext::GetRoles**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-getroles)<br/>                             |
...
**AzRoles. IAzClientCoNtext2** 介面具有這些屬性。



| 屬性                                                                               | 存取類型           | Description                                                                                               |
|:---------------------------------------------------------------------------------------|:----------------------|:----------------------------------------------------------------------------------------------------------|
| **Azroles. IAzClientCoNtext2. LDAPQueryDN**<br/>        | 讀取/寫入<br/> | [**IAzClientCoNtext2 的 LDAPQueryDN 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext2-get_ldapquerydn)<br/>             |
| **Azroles. IAzClientCoNtext2. RoleForAccessCheck**<br/> | 讀取/寫入<br/> | [**IAzClientCoNtext 的 RoleForAccessCheck 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-get_roleforaccesscheck)<br/> |
| **Azroles. IAzClientCoNtext2. UserCanonical**<br/>      | 唯讀<br/>  | [**IAzClientCoNtext 的 UserCanonical 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-get_usercanonical)<br/>           |
| **Azroles. IAzClientCoNtext2. UserDisplay**<br/>        | 唯讀<br/>  | [**IAzClientCoNtext 的 UserDisplay 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-get_userdisplay)<br/>               |
| **Azroles. IAzClientCoNtext2. UserDn**<br/>             | 唯讀<br/>  | [**IAzClientCoNtext 的 UserDn 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-get_userdn)<br/>                         |
| **Azroles. IAzClientCoNtext2. UserDnsSamCompat**<br/>   | 唯讀<br/>  | [**IAzClientCoNtext 的 UserDnsSamCompat 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-get_userdnssamcompat)<br/>     |
| **Azroles. IAzClientCoNtext2. UserGuid**<br/>           | 唯讀<br/>  | [**IAzClientCoNtext 的 UserGuid 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-get_userguid)<br/>                     |
| **Azroles. IAzClientCoNtext2. UserSamCompat**<br/>      | 唯讀<br/>  | [**IAzClientCoNtext 的 UserSamCompat 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-get_usersamcompat)<br/>           |
| **Azroles. IAzClientCoNtext2. UserUpn**<br/>            | 唯讀<br/>  | [**IAzClientCoNtext 的 UserUpn 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazclientcontext-get_userupn)<br/>                       |
