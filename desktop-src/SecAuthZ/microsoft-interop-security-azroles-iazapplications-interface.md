---
description: IAzApplications 互通性包裝函式方法和屬性的檔連結。
ms.assetid: 3070abc0-dc5e-4949-b398-ebe68aeb725b
title: AzRoles. IAzApplications 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "106995920"
---
# <a name="microsoftinteropsecurityazrolesiazapplications-interface"></a>AzRoles. IAzApplications 介面

**Azroles. IAzApplications** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzApplications** 介面具有下列類型的成員：
...
**AzRoles. IAzApplications** 介面具有這些方法。



| 方法                                                               | 描述                                                              |
|:---------------------------------------------------------------------|:-------------------------------------------------------------------------|
| **Azroles. IAzApplications. GetEnumerator** | [**IAzApplications：： \_ NewEnum**](/windows/desktop/api/Azroles/nf-azroles-iazapplications-get__newenum)<br/> |
...
**AzRoles. IAzApplications** 介面具有這些屬性。



| 屬性                                                                | 存取類型          | Description                                                                   |
|:------------------------------------------------------------------------|:---------------------|:------------------------------------------------------------------------------|
| **Azroles. IAzApplications. Count**<br/> | 唯讀<br/> | [**IAzApplications 的 Count 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplications-get_count)<br/> |
| **Azroles. IAzApplications. Item**<br/>  | 唯讀<br/> | [**IAzApplications 的 Item 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplications-get_item)<br/>   |
