---
description: IAzApplicationGroup 互通性包裝函式方法和屬性的檔連結。
ms.assetid: 84fb73b1-84e5-4835-b040-f558b92242ef
title: AzRoles. IAzApplicationGroup 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118913174"
---
# <a name="microsoftinteropsecurityazrolesiazapplicationgroup-interface"></a>AzRoles. IAzApplicationGroup 介面

**Azroles. IAzApplicationGroup** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzApplicationGroup** 介面具有下列類型的成員：
...
**AzRoles. IAzApplicationGroup** 介面具有這些方法。



| 方法                                                                         | 描述                                                                                            |
|:-------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------|
| **Azroles. IAzApplicationGroup. AddAppMember**        | [**IAzApplicationGroup::AddAppMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addappmember)<br/>               |
| **Azroles. IAzApplicationGroup. AddAppNonMember**     | [**IAzApplicationGroup::AddAppNonMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addappnonmember)<br/>         |
| **Azroles. IAzApplicationGroup. AddMember**           | [**IAzApplicationGroup::AddMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addmember)<br/>                     |
| **Azroles. IAzApplicationGroup. AddMemberName**       | [**IAzApplicationGroup::AddMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addmembername)<br/>             |
| **Azroles. IAzApplicationGroup. AddNonMember**        | [**IAzApplicationGroup::AddNonMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addnonmember)<br/>               |
| **Azroles. IAzApplicationGroup. AddNonMemberName**    | [**IAzApplicationGroup::AddNonMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addnonmembername)<br/>       |
| **Azroles. IAzApplicationGroup. AddPropertyItem**     | [**IAzApplicationGroup::AddPropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addpropertyitem)<br/>         |
| **Azroles. IAzApplicationGroup. DeleteAppMember**     | [**IAzApplicationGroup：:D eleteAppMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deleteappmember)<br/>         |
| **Azroles. IAzApplicationGroup. DeleteAppNonMember**  | [**IAzApplicationGroup：:D eleteAppNonMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deleteappnonmember)<br/>   |
| **Azroles. IAzApplicationGroup. DeleteMember**        | [**IAzApplicationGroup：:D eleteMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletemember)<br/>               |
| **Azroles. IAzApplicationGroup. DeleteMemberName**    | [**IAzApplicationGroup：:D eleteMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletemembername)<br/>       |
| **Azroles. IAzApplicationGroup. DeleteNonMember**     | [**IAzApplicationGroup：:D eleteNonMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletenonmember)<br/>         |
| **Azroles. IAzApplicationGroup. DeleteNonMemberName** | [**IAzApplicationGroup：:D eleteNonMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletenonmembername)<br/> |
| **Azroles. IAzApplicationGroup. DeletePropertyItem**  | [**IAzApplicationGroup：:D eletePropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletepropertyitem)<br/>   |
| **Azroles. IAzApplicationGroup. GetProperty**         | [**IAzApplicationGroup：： GetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-getproperty)<br/>                 |
| **Azroles. IAzApplicationGroup.。**         | [**IAzApplicationGroup：： SetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-setproperty)<br/>                 |
| **Azroles. IAzApplicationGroup. Submit**              | [**IAzApplicationGroup：： Submit**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-submit)<br/>                           |
...
**AzRoles. IAzApplicationGroup** 介面具有這些屬性。



| 屬性                                                                             | 存取類型           | Description                                                                                             |
|:-------------------------------------------------------------------------------------|:----------------------|:--------------------------------------------------------------------------------------------------------|
| **Azroles. IAzApplicationGroup. AppMembers**<br/>     | 唯讀<br/>  | [**IAzApplicationGroup 的 AppMembers 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_appmembers)<br/>         |
| **Azroles. IAzApplicationGroup. AppNonMembers**<br/>  | 唯讀<br/>  | [**IAzApplicationGroup 的 AppNonMembers 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_appnonmembers)<br/>   |
| **Azroles. IAzApplicationGroup. Description**<br/>    | 讀取/寫入<br/> | [**IAzApplicationGroup 的 Description 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_description)<br/>       |
| **Azroles. IAzApplicationGroup. LdapQuery**<br/>      | 讀取/寫入<br/> | [**IAzApplicationGroup 的 LdapQuery 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_ldapquery)<br/>           |
| **Azroles. IAzApplicationGroup. 成員**<br/>        | 唯讀<br/>  | [**IAzApplicationGroup 的 Members 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_members)<br/>               |
| **Azroles. IAzApplicationGroup. MembersName**<br/>    | 唯讀<br/>  | [**IAzApplicationGroup 的 MembersName 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_membersname)<br/>       |
| **Microsoft.Interop.Security.Azroles.IAzApplicationGroup.Name**<br/>           | 讀取/寫入<br/> | [**IAzApplicationGroup 的 Name 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_name)<br/>                     |
| **Azroles. IAzApplicationGroup. 非成員**<br/>     | 唯讀<br/>  | [**IAzApplicationGroup 的非成員屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_nonmembers)<br/>         |
| **Azroles. IAzApplicationGroup. NonMembersName**<br/> | 唯讀<br/>  | [**IAzApplicationGroup 的 NonMembersName 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_nonmembersname)<br/> |
| **Azroles. IAzApplicationGroup. Type**<br/>           | 讀取/寫入<br/> | [**IAzApplicationGroup 的 Type 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_type)<br/>                     |
| **Azroles. IAzApplicationGroup 可寫入**<br/>       | 唯讀<br/>  | [**IAzApplicationGroup 的可寫入屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_writable)<br/>             |
