---
description: IAzScopes 互通性包裝函式方法和屬性的檔連結。
ms.assetid: 1b80b1c0-58a9-401b-9ddb-bd6eb146751e
title: AzRoles. IAzScopes 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118912546"
---
# <a name="microsoftinteropsecurityazrolesiazscopes-interface"></a>AzRoles. IAzScopes 介面

**Azroles. IAzScopes** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzScopes** 介面具有下列類型的成員：
...
**AzRoles. IAzScopes** 介面具有這些方法。



| 方法                                                         | 描述                                                  |
|:---------------------------------------------------------------|:-------------------------------------------------------------|
| **Azroles. IAzScopes. GetEnumerator** | [**IAzScopes：： \_ NewEnum**](/windows/desktop/api/Azroles/nf-azroles-iazscopes-get__newenum)<br/> |
