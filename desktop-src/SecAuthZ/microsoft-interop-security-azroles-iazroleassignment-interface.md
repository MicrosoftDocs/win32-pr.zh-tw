---
description: IAzRoleAssignment 互通性包裝函式方法和屬性的檔連結。
ms.assetid: abf9afee-9a7e-4572-8ead-497c11d0fac4
title: AzRoles. IAzRoleAssignment 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "117780941"
---
# <a name="microsoftinteropsecurityazrolesiazroleassignment-interface"></a>AzRoles. IAzRoleAssignment 介面

**Azroles. IAzRoleAssignmentAssignment** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzRoleAssignment** 介面具有下列類型的成員：
...
**AzRoles. IAzRoleAssignment** 介面具有這些方法。



| 方法                                                                        | 描述                                                                                          |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------|
| **Azroles. IAzRoleAssignment. AddAppMember**         | [**IAzRole::AddAppMember**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addappmember)<br/>                                     |
| **Azroles. IAzRoleAssignment. AddMember**            | [**IAzRole::AddMember**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addmember)<br/>                                           |
| **Azroles. IAzRoleAssignment. AddMemberName**        | [**IAzRole::AddMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addmembername)<br/>                                   |
| **Azroles. IAzRoleAssignment. AddOperation**         | [**IAzRole::AddOperation**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addoperation)<br/>                                     |
| **Azroles. IAzRoleAssignment. AddPropertyItem**      | [**IAzRole::AddPropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addpropertyitem)<br/>                               |
| **Azroles. IAzRoleAssignment. AddRoleDefinition**    | [**IAzRoleAssignment::AddRoleDefinition**](/windows/desktop/api/Azroles/nf-azroles-iazroleassignment-addroledefinition)<br/>       |
| **Azroles. IAzRoleAssignment. AddTask**              | [**IAzRole：： AddTask**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addtask)<br/>                                               |
| **Azroles. IAzRoleAssignment. DeleteAppMember**      | [**IAzRole：:D eleteAppMember**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deleteappmember)<br/>                               |
| **Azroles. IAzRoleAssignment. DeleteMember**         | [**IAzRole：:D eleteMember**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletemember)<br/>                                     |
| **Azroles. IAzRoleAssignment. DeleteMemberName**     | [**IAzRole：:D eleteMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletemembername)<br/>                             |
| **Azroles. IAzRoleAssignment. DeleteOperation**      | [**IAzRole：:D eleteOperation**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deleteoperation)<br/>                               |
| **Azroles. IAzRoleAssignment. DeletePropertyItem**   | [**IAzRole：:D eletePropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletepropertyitem)<br/>                         |
| **Azroles. IAzRoleAssignment. DeleteRoleDefinition** | [**IAzRoleAssignment：:D eleteRoleDefinition**](/windows/desktop/api/Azroles/nf-azroles-iazroleassignment-deleteroledefinition)<br/> |
| **Azroles. IAzRoleAssignment. DeleteTask**           | [**IAzRole：:D eleteTask**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletetask)<br/>                                         |
| **Azroles. IAzRoleAssignment. GetProperty**          | [**IAzRole：： GetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazrole-getproperty)<br/>                                       |
| **Azroles. IAzRoleAssignment.。**          | [**IAzRole：： SetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazrole-setproperty)<br/>                                       |
| **Azroles. IAzRoleAssignment. Submit**               | [**IAzRole：： Submit**](/windows/desktop/api/Azroles/nf-azroles-iazrole-submit)<br/>                                                 |
...
**AzRoles. IAzRoleAssignment** 介面具有這些屬性。
...
| **Azroles. IAzRoleAssignmentAssignment. Description**<br/>     | 讀取/寫入<br/> | [**IAzRole 的 Description 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_description)<br/>                             |
| **Azroles. IAzRoleAssignmentAssignment. 成員**<br/>         | 唯讀<br/>  | [**IAzRole 的 Members 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_members)<br/>                                     |
| **Azroles. IAzRoleAssignmentAssignment. MembersName**<br/>     | 唯讀<br/>  | [**IAzRole 的 MembersName 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_membersname)<br/>                             |
| **Microsoft.Interop.Security.Azroles.IAzRoleAssignmentAssignment.Name**<br/>            | 讀取/寫入<br/> | [**IAzRole 的 Name 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_name)<br/>                                           |
| **Azroles. IAzRoleAssignmentAssignment. 作業**<br/>      | 唯讀<br/>  | [**IAzRole 的 Operations 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_operations)<br/>                               |
| **Azroles. IAzRoleAssignmentAssignment. RoleDefinitions**<br/> | 唯讀<br/>  | [**IAzRoleAssignment 的 RoleDefinitions 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazroleassignment-get_roledefinitions)<br/> |
| **Azroles. IAzRoleAssignmentAssignment. Scope**<br/>           | 唯讀<br/>  | [**IAzRoleAssignment 的 Scope 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazroleassignment-get_scope)<br/>                     |
| **Azroles. IAzRoleAssignmentAssignment. Tasks**<br/>           | 唯讀<br/>  | [**IAzRole 的 Tasks 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_tasks)<br/>                                         |
| **Azroles. IAzRoleAssignmentAssignment 可寫入**<br/>        | 唯讀<br/>  | [**IAzRole 的可寫入屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_writable)<br/>                                   |
