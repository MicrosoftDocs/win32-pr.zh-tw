---
description: IAzRole 互通性包裝函式方法和屬性的檔連結。
ms.assetid: 657883c2-f43e-4a6f-b18b-d252a2841b36
title: AzRoles. IAzRole 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "106987032"
---
# <a name="microsoftinteropsecurityazrolesiazrole-interface"></a>AzRoles. IAzRole 介面

**Azroles. IAzRole** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzRole** 介面具有下列類型的成員：
...
**AzRoles. IAzRole** 介面具有這些方法。



| 方法                                                            | 描述                                                                  |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------|
| **Azroles. IAzRole. AddAppMember**       | [**IAzRole::AddAppMember**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addappmember)<br/>             |
| **Azroles. IAzRole. AddMember**          | [**IAzRole::AddMember**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addmember)<br/>                   |
| **Azroles. IAzRole. AddMemberName**      | [**IAzRole::AddMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addmembername)<br/>           |
| **Azroles. IAzRole. AddOperation**       | [**IAzRole::AddOperation**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addoperation)<br/>             |
| **Azroles. IAzRole. AddPropertyItem**    | [**IAzRole::AddPropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addpropertyitem)<br/>       |
| **Azroles. IAzRole. AddTask**            | [**IAzRole：： AddTask**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addtask)<br/>                       |
| **Azroles. IAzRole. DeleteAppMember**    | [**IAzRole：:D eleteAppMember**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deleteappmember)<br/>       |
| **Azroles. IAzRole. DeleteMember**       | [**IAzRole：:D eleteMember**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletemember)<br/>             |
| **Azroles. IAzRole. DeleteMemberName**   | [**IAzRole：:D eleteMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletemembername)<br/>     |
| **Azroles. IAzRole. DeleteOperation**    | [**IAzRole：:D eleteOperation**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deleteoperation)<br/>       |
| **Azroles. IAzRole. DeletePropertyItem** | [**IAzRole：:D eletePropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletepropertyitem)<br/> |
| **Azroles. IAzRole. DeleteTask**         | [**IAzRole：:D eleteTask**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletetask)<br/>                 |
| **Azroles. IAzRole. GetProperty**        | [**IAzRole：： GetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazrole-getproperty)<br/>               |
| **Azroles. IAzRole.。**        | [**IAzRole：： SetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazrole-setproperty)<br/>               |
| **Azroles. IAzRole. Submit**             | [**IAzRole：： Submit**](/windows/desktop/api/Azroles/nf-azroles-iazrole-submit)<br/>                         |
...
**AzRoles. IAzRole** 介面具有這些屬性。



| 屬性                                                                  | 存取類型           | Description                                                                       |
|:--------------------------------------------------------------------------|:----------------------|:----------------------------------------------------------------------------------|
| **Azroles. IAzRole. ApplicationData**<br/> | 讀取/寫入<br/> | [**IAzRole 的 ApplicationData 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_applicationdata)<br/> |
| **Azroles. IAzRole. AppMembers**<br/>      | 唯讀<br/>  | [**IAzRole 的 AppMembers 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_appmembers)<br/>           |
| **Azroles. IAzRole. Description**<br/>     | 讀取/寫入<br/> | [**IAzRole 的 Description 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_description)<br/>         |
| **Azroles. IAzRole. 成員**<br/>         | 唯讀<br/>  | [**IAzRole 的 Members 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_members)<br/>                 |
| **Azroles. IAzRole. MembersName**<br/>     | 唯讀<br/>  | [**IAzRole 的 MembersName 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_membersname)<br/>         |
| **Microsoft.Interop.Security.Azroles.IAzRole.Name**<br/>            | 讀取/寫入<br/> | [**IAzRole 的 Name 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_name)<br/>                       |
| **Azroles. IAzRole. 作業**<br/>      | 唯讀<br/>  | [**IAzRole 的 Operations 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_operations)<br/>           |
| **Azroles. IAzRole. Tasks**<br/>           | 唯讀<br/>  | [**IAzRole 的 Tasks 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_tasks)<br/>                     |
| **Azroles. IAzRole 可寫入**<br/>        | 唯讀<br/>  | [**IAzRole 的可寫入屬性**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_writable)<br/>               |
