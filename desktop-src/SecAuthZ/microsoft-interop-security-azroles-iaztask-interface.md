---
description: IAzTask 互通性包裝函式方法和屬性的檔連結。
ms.assetid: 15691d42-f1bd-4bd1-9a01-e482a2c74e20
title: AzRoles. IAzTask 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "117780591"
---
# <a name="microsoftinteropsecurityazrolesiaztask-interface"></a>AzRoles. IAzTask 介面

**Azroles. IAzTask** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzTask** 介面具有下列類型的成員：
...
**AzRoles. IAzTask** 介面具有這些方法。



| 方法                                                            | 描述                                                                  |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------|
| **Azroles. IAzTask. AddOperation**       | [**IAzTask::AddOperation**](/windows/desktop/api/Azroles/nf-azroles-iaztask-addoperation)<br/>             |
| **Azroles. IAzTask. AddPropertyItem**    | [**IAzTask::AddPropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iaztask-addpropertyitem)<br/>       |
| **Azroles. IAzTask. AddTask**            | [**IAzTask：： AddTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-addtask)<br/>                       |
| **Azroles. IAzTask. DeleteOperation**    | [**IAzTask：:D eleteOperation**](/windows/desktop/api/Azroles/nf-azroles-iaztask-deleteoperation)<br/>       |
| **Azroles. IAzTask. DeletePropertyItem** | [**IAzTask：:D eletePropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iaztask-deletepropertyitem)<br/> |
| **Azroles. IAzTask. DeleteTask**         | [**IAzTask：:D eleteTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-deletetask)<br/>                 |
| **Azroles. IAzTask. GetProperty**        | [**IAzTask：： GetProperty**](/windows/desktop/api/Azroles/nf-azroles-iaztask-getproperty)<br/>               |
| **Azroles. IAzTask.。**        | [**IAzTask：： SetProperty**](/windows/desktop/api/Azroles/nf-azroles-iaztask-setproperty)<br/>               |
| **Azroles. IAzTask. Submit**             | [**IAzTask：： Submit**](/windows/desktop/api/Azroles/nf-azroles-iaztask-submit)<br/>                         |
...
| **Azroles. IAzTask. BizRuleImportedPath**<br/> | 讀取/寫入<br/> | [**IAzTask 的 BizRuleImportedPath 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_bizruleimportedpath)<br/> |
| **Azroles. IAzTask. BizRuleLanguage**<br/>     | 讀取/寫入<br/> | [**IAzTask 的 BizRuleLanguage 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_bizrulelanguage)<br/>         |
| **Azroles. IAzTask. Description**<br/>         | 讀取/寫入<br/> | [**IAzTask 的 Description 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_description)<br/>                 |
| **Azroles. IAzTask. IsRoleDefinition**<br/>    | 讀取/寫入<br/> | [**IAzTask 的 IsRoleDefinition 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_isroledefinition)<br/>       |
| **Microsoft.Interop.Security.Azroles.IAzTask.Name**<br/>                | 讀取/寫入<br/> | [**IAzTask 的 Name 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_name)<br/>                               |
| **Azroles. IAzTask. 作業**<br/>          | 唯讀<br/>  | [**IAzTask 的 Operations 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_operations)<br/>                   |
| **Azroles. IAzTask. Tasks**<br/>               | 唯讀<br/>  | [**IAzTask 的 Tasks 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_tasks)<br/>                             |
| **Azroles. IAzTask 可寫入**<br/>            | 唯讀<br/>  | [**IAzTask 的可寫入屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_writable)<br/>                       |
