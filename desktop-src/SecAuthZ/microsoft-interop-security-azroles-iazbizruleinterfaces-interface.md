---
description: IAzBizRuleInterfaces 互通性包裝函式方法和屬性的檔連結。
ms.assetid: 2c9474e3-01d0-412d-9028-89a377d5592d
title: AzRoles. IAzBizRuleInterfaces 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "106989740"
---
# <a name="microsoftinteropsecurityazrolesiazbizruleinterfaces-interface"></a>AzRoles. IAzBizRuleInterfaces 介面

**Azroles. IAzBizRuleInterfaces** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzBizRuleInterfaces** 介面具有下列類型的成員：
...
**AzRoles. IAzBizRuleInterfaces** 介面具有這些方法。



| 方法                                                                        | 描述                                                                                                 |
|:------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------|
| **Azroles. IAzBizRuleInterfaces. AddInterface**      | [**IAzBizRuleInterfaces::AddInterface**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleinterfaces-addinterface)<br/>                  |
| **Azroles. IAzBizRuleInterfaces. AddInterfaces**     | [**IAzBizRuleInterfaces::AddInterfaces**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleinterfaces-addinterfaces)<br/>         |
| **Azroles. IAzBizRuleInterfaces. GetInterfaceValue** | [**IAzBizRuleInterfaces::GetInterfaceValue**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleinterfaces-getinterfacevalue)<br/> |
| **Azroles. IAzBizRuleInterfaces. Remove**            | [**IAzBizRuleInterfaces：： Remove**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleinterfaces-remove)<br/>                       |
| **Azroles. IAzBizRuleInterfaces. RemoveAll**         | [**IAzBizRuleInterfaces：： RemoveAll**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleinterfaces-removeall)<br/>                 |
...
**AzRoles. IAzBizRuleInterfaces** 介面具有這些屬性。



| 屬性                                                                     | 存取類型          | Description                                                                                    |
|:-----------------------------------------------------------------------------|:---------------------|:-----------------------------------------------------------------------------------------------|
| **Azroles. IAzBizRuleInterfaces. Count**<br/> | 唯讀<br/> | [**IAzBizRuleInterfaces 的 Count 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleinterfaces-get_count)<br/> |
