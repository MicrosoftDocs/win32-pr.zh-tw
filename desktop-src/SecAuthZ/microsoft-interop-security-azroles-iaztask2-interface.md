---
description: IAzTask2 互通性包裝函式方法和屬性的檔連結。
ms.assetid: d8119871-0ffe-4a84-92d8-e893b7dd82cb
title: AzRoles. IAzTask2 介面
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
**Azroles. IAzTask2** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzTask2** 介面具有下列類型的成員：
...
**AzRoles. IAzTask2** 介面具有這些方法。



| 方法                                                             | 描述                                                                     |
|:-------------------------------------------------------------------|:--------------------------------------------------------------------------------|
| **Azroles. IAzTask2. AddOperation**       | [**IAzTask::AddOperation**](/windows/desktop/api/Azroles/nf-azroles-iaztask-addoperation)<br/>                |
| **Azroles. IAzTask2. AddPropertyItem**    | [**IAzTask::AddPropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iaztask-addpropertyitem)<br/>          |
| **Azroles. IAzTask2. AddTask**            | [**IAzTask：： AddTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-addtask)<br/>                          |
| **Azroles. IAzTask2. DeleteOperation**    | [**IAzTask：:D eleteOperation**](/windows/desktop/api/Azroles/nf-azroles-iaztask-deleteoperation)<br/>          |
| **Azroles. IAzTask2. DeletePropertyItem** | [**IAzTask：:D eletePropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iaztask-deletepropertyitem)<br/>    |
| **Azroles. IAzTask2. DeleteTask**         | [**IAzTask：:D eleteTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-deletetask)<br/>                    |
| **Azroles. IAzTask2. GetProperty**        | [**IAzTask：： GetProperty**](/windows/desktop/api/Azroles/nf-azroles-iaztask-getproperty)<br/>                  |
| **Azroles. IAzTask2. RoleAssignments**    | [**IAzTask2：： RoleAssignments**](/windows/desktop/api/Azroles/nf-azroles-iaztask2-roleassignments)<br/> |
| **Azroles. IAzTask2.。**        | [**IAzTask：： SetProperty**](/windows/desktop/api/Azroles/nf-azroles-iaztask-setproperty)<br/>                  |
| **Azroles. IAzTask2. Submit**             | [**IAzTask：： Submit**](/windows/desktop/api/Azroles/nf-azroles-iaztask-submit)<br/>                            |
...
**AzRoles. IAzTask2** 介面具有這些屬性。



| 屬性                                                                       | 存取類型           | Description                                                                               |
|:-------------------------------------------------------------------------------|:----------------------|:------------------------------------------------------------------------------------------|
| **Azroles. IAzTask2. ApplicationData**<br/>     | 讀取/寫入<br/> | [**IAzTask 的 ApplicationData 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_applicationdata)<br/>         |
| **Azroles. IAzTask2. BizRule**<br/>             | 讀取/寫入<br/> | [**IAzTask 的 BizRule 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_bizrule)<br/>                         |
| **Azroles. IAzTask2. BizRuleImportedPath**<br/> | 讀取/寫入<br/> | [**IAzTask 的 BizRuleImportedPath 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_bizruleimportedpath)<br/> |
| **Azroles. IAzTask2. BizRuleLanguage**<br/>     | 讀取/寫入<br/> | [**IAzTask 的 BizRuleLanguage 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_bizrulelanguage)<br/>         |
| **Azroles. IAzTask2. Description**<br/>         | 讀取/寫入<br/> | [**IAzTask 的 Description 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_description)<br/>                 |
| **Azroles. IAzTask2. IsRoleDefinition**<br/>    | 讀取/寫入<br/> | [**IAzTask 的 IsRoleDefinition 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_isroledefinition)<br/>       |
| **Microsoft.Interop.Security.Azroles.IAzTask2.Name**<br/>                | 讀取/寫入<br/> | [**IAzTask 的 Name 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_name)<br/>                               |
| **Azroles. IAzTask2. 作業**<br/>          | 唯讀<br/>  | [**IAzTask 的 Operations 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_operations)<br/>                   |
| **Azroles. IAzTask2. Tasks**<br/>               | 唯讀<br/>  | [**IAzTask 的 Tasks 屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_tasks)<br/>                             |
| **Azroles. IAzTask2 可寫入**<br/>            | 唯讀<br/>  | [**IAzTask 的可寫入屬性**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_writable)<br/>                       |
