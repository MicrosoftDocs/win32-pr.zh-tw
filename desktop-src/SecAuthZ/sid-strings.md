...
| LCD<br/> | SDDL \_ CERTSVC \_ DCOM \_ 存取<br/>           | 可使用分散式元件物件模型連接到憑證授權單位單位 (DCOM) 的使用者。 對應的 RID 是網域 \_ 別名 \_ RID \_ CERTSVC \_ DCOM \_ 存取 \_ 群組。<br/>                                                                  |
...
| 你好<br/> | SDDL \_ ML \_ HIGH<br/>                        | 高完整性層級。 對應的 RID 是安全性 \_ 強制性 \_ 高 \_ RID。<br/>                                                                                                                                                                  |
...
| "LW"<br/> | SDDL \_ ML \_ 低<br/>                         | 低完整性層級。 對應的 RID 是安全的 \_ 強制 \_ 低 \_ rid。<br/>                                                                                                                                                                    |
| 諮詢<br/> | SDDL \_ MLMEDIUM<br/>                        | 中度完整性層級。 對應的 RID 是安全的 \_ 強制 \_ 媒體 \_ rid。<br/>                                                                                                                                                              |
| "MU"<br/> | SDDL \_ PERFMON \_ 使用者<br/>                  | 效能監視器的使用者。<br/>                                                                                                                                                                                                                      |
...
| RO<br/> | SDDL \_ ENTERPRISE \_ RO \_ dc<br/>             | 企業唯讀網域控制站。 對應的 RID 是網域 \_ 群組 \_ RID \_ ENTERPRISE \_ READONLY \_ 域 \_ 控制器。<br/>                                                                                                                |
...
| SI<br/> | SDDL \_ ML \_ 系統<br/>                      | 系統完整性層級。 對應的 RID 是安全的 \_ 強制 \_ 系統 \_ RID。<br/>                                                                                                                                                              |
