...
---
# <a name="microsoftinteropsecurityazrolesiazapplicationgroup2-interface"></a>AzRoles. IAzApplicationGroup2 介面

**Azroles. IAzApplicationGroup2** 互通性包裝函式的方法和屬性會記載于方法或屬性的 COM 版本下。 相互關聯 COM 檔的連結會遵循每個成員名稱。

## <a name="members"></a>成員

**AzRoles. IAzApplicationGroup2** 介面具有下列類型的成員：
...
**AzRoles. IAzApplicationGroup2** 介面具有這些方法。



| 方法                                                                          | 描述                                                                                             |
|:--------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------|
| **Azroles. IAzApplicationGroup2. AddAppMember**        | [**IAzApplicationGroup::AddAppMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addappmember)<br/>                |
| **Azroles. IAzApplicationGroup2. AddAppNonMember**     | [**IAzApplicationGroup::AddAppNonMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addappnonmember)<br/>          |
| **Azroles. IAzApplicationGroup2. AddMember**           | [**IAzApplicationGroup::AddMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addmember)<br/>                      |
| **Azroles. IAzApplicationGroup2. AddMemberName**       | [**IAzApplicationGroup::AddMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addmembername)<br/>              |
| **Azroles. IAzApplicationGroup2. AddNonMember**        | [**IAzApplicationGroup::AddNonMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addnonmember)<br/>                |
| **Azroles. IAzApplicationGroup2. AddNonMemberName**    | [**IAzApplicationGroup::AddNonMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addnonmembername)<br/>        |
| **Azroles. IAzApplicationGroup2. AddPropertyItem**     | [**IAzApplicationGroup::AddPropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addpropertyitem)<br/>          |
| **Azroles. IAzApplicationGroup2. DeleteAppMember**     | [**IAzApplicationGroup：:D eleteAppMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deleteappmember)<br/>          |
| **Azroles. IAzApplicationGroup2. DeleteAppNonMember**  | [**IAzApplicationGroup：:D eleteAppNonMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deleteappnonmember)<br/>    |
| **Azroles. IAzApplicationGroup2. DeleteMember**        | [**IAzApplicationGroup：:D eleteMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletemember)<br/>                |
| **Azroles. IAzApplicationGroup2. DeleteMemberName**    | [**IAzApplicationGroup：:D eleteMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletemembername)<br/>        |
| **Azroles. IAzApplicationGroup2. DeleteNonMember**     | [**IAzApplicationGroup：:D eleteNonMember**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletenonmember)<br/>          |
| **Azroles. IAzApplicationGroup2. DeleteNonMemberName** | [**IAzApplicationGroup：:D eleteNonMemberName**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletenonmembername)<br/>  |
| **Azroles. IAzApplicationGroup2. DeletePropertyItem**  | [**IAzApplicationGroup：:D eletePropertyItem**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletepropertyitem)<br/>    |
| **Azroles. IAzApplicationGroup2. GetProperty**         | [**IAzApplicationGroup：： GetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-getproperty)<br/>                  |
| **Azroles. IAzApplicationGroup2. RoleAssignments**     | [**IAzApplicationGroup2：： RoleAssignments**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup2-roleassignments)<br/> |
| **Azroles. IAzApplicationGroup2.。**         | [**IAzApplicationGroup：： SetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-setproperty)<br/>                  |
| **Azroles. IAzApplicationGroup2. Submit**              | [**IAzApplicationGroup：： Submit**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-submit)<br/>                            |
...
**AzRoles. IAzApplicationGroup2** 介面具有這些屬性。



| 屬性                                                                                   | 存取類型           | Description                                                                                                                |
|:-------------------------------------------------------------------------------------------|:----------------------|:---------------------------------------------------------------------------------------------------------------------------|
| **Azroles. IAzApplicationGroup2. AppMembers**<br/>          | 唯讀<br/>  | [**IAzApplicationGroup 的 AppMembers 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_appmembers)<br/>                            |
| **Azroles. IAzApplicationGroup2. AppNonMembers**<br/>       | 唯讀<br/>  | [**IAzApplicationGroup 的 AppNonMembers 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_appnonmembers)<br/>                      |
| **Azroles. IAzApplicationGroup2. BizRule**<br/>             | 讀取/寫入<br/> | [**IAzApplicationGroup2 的 BizRule 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup2-get_bizrule)<br/>                         |
| **Azroles. IAzApplicationGroup2. BizRuleImportedPath**<br/> | 讀取/寫入<br/> | [**IAzApplicationGroup2 的 BizRuleImportedPath 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup2-get_bizruleimportedpath)<br/> |
| **Azroles. IAzApplicationGroup2. BizRuleLanguage**<br/>     | 讀取/寫入<br/> | [**IAzApplicationGroup2 的 BizRuleLanguage 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup2-get_bizrulelanguage)<br/>         |
| **Azroles. IAzApplicationGroup2. Description**<br/>         | 讀取/寫入<br/> | [**IAzApplicationGroup 的 Description 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_description)<br/>                          |
| **Azroles. IAzApplicationGroup2. LdapQuery**<br/>           | 讀取/寫入<br/> | [**IAzApplicationGroup 的 LdapQuery 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_ldapquery)<br/>                              |
| **Azroles. IAzApplicationGroup2. 成員**<br/>             | 唯讀<br/>  | [**IAzApplicationGroup 的 Members 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_members)<br/>                                  |
| **Azroles. IAzApplicationGroup2. MembersName**<br/>         | 唯讀<br/>  | [**IAzApplicationGroup 的 MembersName 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_membersname)<br/>                          |
| **Microsoft.Interop.Security.Azroles.IAzApplicationGroup2.Name**<br/>                | 讀取/寫入<br/> | [**IAzApplicationGroup 的 Name 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_name)<br/>                                        |
| **Azroles. IAzApplicationGroup2. 非成員**<br/>          | 唯讀<br/>  | [**IAzApplicationGroup 的非成員屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_nonmembers)<br/>                            |
| **Azroles. IAzApplicationGroup2. NonMembersName**<br/>      | 唯讀<br/>  | [**IAzApplicationGroup 的 NonMembersName 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_nonmembersname)<br/>                    |
| **Azroles. IAzApplicationGroup2. Type**<br/>                | 讀取/寫入<br/> | [**IAzApplicationGroup 的 Type 屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_type)<br/>                                        |
| **Azroles. IAzApplicationGroup2 可寫入**<br/>            | 唯讀<br/>  | [**IAzApplicationGroup 的可寫入屬性**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_writable)<br/>                                |
