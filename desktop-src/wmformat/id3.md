...
ms.locfileid: "118702979"
---
# <a name="id3-support"></a>ID3 支援

ID3 是定義一組標準的組織，可在 MPEG 層-3 (MP3) 音訊檔案中包含中繼資料。 Windows 媒體格式 SDK 的物件會提供 ID3 相容屬性的支援。 支援三種不同的 ID3 版本： ID3v1. x、ID3v 2.2 和 ID3v 2.3/v2、4。 如需等同于 ID3 框架的屬性清單，請參閱 [Id3 標記支援](id3-tag-support.md)。
