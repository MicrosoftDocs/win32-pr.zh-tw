...
**AM \_ WMT \_ 事件 \_ 資料** 結構的指標，其中包含 **.pdata** 成員指標中事件的相關資訊，以及 Windows 媒體格式 SDK 所傳送的 **HRESULT** 狀態碼。 *LParam2* 的值取決於 *lParam1* 的值，如下表所述。  ("WM \_ " 結構是在 Windows 媒體格式 SDK 中定義。 ) 
