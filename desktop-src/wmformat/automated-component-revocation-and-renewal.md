...
5.  剖析撤銷清單，並檢查 Windows 媒體 DRM 撤銷。 如需詳細資訊，請參閱 [檢查憑證撤銷](checking-certificate-revocation.md)。
