...
ms.locfileid: "119707708"
---
# <a name="localized-system-profiles"></a>當地語系化的系統設定檔

下表列出 Windows 媒體格式 SDK 隨附的當地語系化系統設定檔檔案，以及與每個檔案相關聯的語言。 這些檔案會安裝到 \[ SDKRoot \] \\ WMSDK \\ WMFSDK9 \\ LocalizedProfiles 資料夾中。 若要使用 **IWMProfileManagerLanguage** 方法來存取特定檔案，您必須將它移至系統根目錄以及預設的系統設定檔。
