...
此結構（包括包含工作階段金鑰的緩衝區）必須使用 Windows Media DRM 電腦公開金鑰進行加密，並包含在 [**WMDRM 匯 \_ 入 \_ INIT \_ 結構**](/previous-versions/windows/desktop/api/wmsdkidl/ns-wmsdkidl-wmdrm_import_init_struct)結構的 **pbEncryptedSessionKeyMessage** 成員中。
