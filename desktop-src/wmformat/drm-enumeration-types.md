...
| 列舉型別                                                                      | 描述                                                                                                                                                   |
|----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**DRM \_ 動作 \_ 允許的 \_ 查詢 \_ 結果**](drm-action-allowed-query-results.md) | 由 [**IWMDRMLicenseQuery：： QueryActionAllowed**](iwmdrmlicensequery-queryactionallowed.md) 介面用來指定不允許動作的原因。 |
| [**DRM \_ ATTR \_ 資料類型**](drm-attr-datatype.md)                                 | 定義用於 DRM 屬性和屬性的資料類型。                                                                                                |
| [**DRM \_ 加密 \_ 類型**](drm-crypto-type.md)                                     | 定義可以用來加密內容的密碼編譯演算法類型。                                                                                |
| [**DRM \_ HTTP \_ 狀態**](drmdrm-http-status.md)                                  | 針對 DRM 要求定義 HTTP 狀態的範圍。                                                                                                             |
