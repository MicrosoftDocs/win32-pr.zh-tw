...
description: 如需 Windows Media 編解碼器和數位訊號處理器的最新檔，請參閱 Windows Media 音訊和影片編解碼器和 DSP Api。 |g_wszWMVCComplexityExOffline
ms.assetid: 2887d621-8f23-4b2d-ac49-5b552e10ac3a
keywords:
- g_wszWMVCComplexityExOffline windows Media 格式
topic_type:
- apiref
api_name:
