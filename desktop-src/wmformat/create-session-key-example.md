...
---
# <a name="create-session-key-example"></a><span data-ttu-id="d85a3-125">建立工作階段金鑰範例</span><span class="sxs-lookup"><span data-stu-id="d85a3-125">Create Session Key Example</span></span>

<span data-ttu-id="d85a3-126">工作階段金鑰是用來保護內容金鑰。</span><span class="sxs-lookup"><span data-stu-id="d85a3-126">The session key is used to protect the content key.</span></span> <span data-ttu-id="d85a3-127">下列程式碼示範如何建立工作階段金鑰，但會留下隨機金鑰產生的詳細資料。</span><span class="sxs-lookup"><span data-stu-id="d85a3-127">The following code demonstrates how to create a session key, but leaves out the details of random key generation.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d85a3-128">相關主題</span><span class="sxs-lookup"><span data-stu-id="d85a3-128">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="d85a3-129">**DRM 匯入範例**</span><span class="sxs-lookup"><span data-stu-id="d85a3-129">**DRM Import Examples**</span></span>](drm-import-examples.md)
</dt> </dl>
