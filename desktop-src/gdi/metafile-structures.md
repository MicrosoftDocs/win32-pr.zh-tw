...
ms.locfileid: "104191934"
---
# <a name="metafile-structures"></a>中繼檔結構
...
請注意， [**EMR**](/windows/win32/api/wingdi/ns-wingdi-emr) 結構是用來做為其餘結構的第一個成員。  
...
## <a name="obsolete-structures"></a>過時的結構

下列結構已過時。 提供與 Windows 格式中繼檔的相容性：
