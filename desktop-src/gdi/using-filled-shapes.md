...
---
# <a name="using-filled-shapes"></a><span data-ttu-id="7a32b-104">使用填滿的圖形</span><span class="sxs-lookup"><span data-stu-id="7a32b-104">Using Filled Shapes</span></span>

<span data-ttu-id="7a32b-105">本節說明如何使用填滿的形狀函數。</span><span class="sxs-lookup"><span data-stu-id="7a32b-105">This section illustrates how to use filled shape functions.</span></span> <span data-ttu-id="7a32b-106">此範例會使用應用程式的主視窗程式，讓使用者能夠繪製具有圓角的橢圓形、矩形和矩形。</span><span class="sxs-lookup"><span data-stu-id="7a32b-106">The example uses the main window procedure from an application that enables the user to draw ellipses, rectangles, and rectangles with rounded corners.</span></span>

<span data-ttu-id="7a32b-107">使用者可以從功能表中選取特定圖形、將游標放在)  (圖形的左上角，將游標置於圖形的左上角，然後拖曳滑鼠，直到取得所需的維度為止，藉此繪製填滿的形狀。</span><span class="sxs-lookup"><span data-stu-id="7a32b-107">The user draws a filled shape by selecting a particular shape from the menu, positioning the cursor at the upper-left corner of the shape (or the shape's bounding rectangle in the case of an ellipse), and then dragging the mouse until the desired dimensions are obtained.</span></span>

<span data-ttu-id="7a32b-108">下圖顯示使用本節中的範例程式碼繪製的三個填滿形狀。</span><span class="sxs-lookup"><span data-stu-id="7a32b-108">The following illustration shows three filled shapes drawn using the sample code in this section.</span></span>

![顯示圓形和兩個 rectagles 的螢幕擷取畫面--一個具有正方形邊角，另一個具有圓角](images/fillshape.png)

<span data-ttu-id="7a32b-110">若要讓使用者繪製填滿的圖形，請在您的應用程式中包含下列快顯視窗。</span><span class="sxs-lookup"><span data-stu-id="7a32b-110">To enable the user to draw filled shapes, include the following popup menu in your application.</span></span>
...
<span data-ttu-id="7a32b-111">功能表範本中的功能表項目值是您必須在應用程式的標頭檔中定義如下的常數。</span><span class="sxs-lookup"><span data-stu-id="7a32b-111">The menu item values in the menu template are constants that you must define as follows in your application's header file.</span></span>
...
<span data-ttu-id="7a32b-112">最後，在您的應用程式中包含下列視窗程式。</span><span class="sxs-lookup"><span data-stu-id="7a32b-112">Finally, include the following window procedure in your application.</span></span>
