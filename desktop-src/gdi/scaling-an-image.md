---
description: 某些應用程式會調整影像;亦即，它們會顯示影像的縮放或減少視圖。 例如，繪圖應用程式可能會提供縮放功能，讓使用者以圖元為單位來查看和編輯繪圖。
...
---
# <a name="scaling-an-image"></a><span data-ttu-id="343a2-104">調整影像</span><span class="sxs-lookup"><span data-stu-id="343a2-104">Scaling an Image</span></span>

<span data-ttu-id="343a2-105">某些應用程式會調整影像;亦即，它們會顯示影像的縮放或減少視圖。</span><span class="sxs-lookup"><span data-stu-id="343a2-105">Some applications scale images; that is, they display zoomed or reduced views of an image.</span></span> <span data-ttu-id="343a2-106">例如，繪圖應用程式可能會提供縮放功能，讓使用者以圖元為單位來查看和編輯繪圖。</span><span class="sxs-lookup"><span data-stu-id="343a2-106">For example, a drawing application may provide a zoom feature that enables the user to view and edit a drawing on a pixel-by-pixel basis.</span></span>

<span data-ttu-id="343a2-107">應用程式會藉由呼叫 [**StretchBlt**](/windows/desktop/api/Wingdi/nf-wingdi-stretchblt) 函數來調整影像。</span><span class="sxs-lookup"><span data-stu-id="343a2-107">Applications scale images by calling the [**StretchBlt**](/windows/desktop/api/Wingdi/nf-wingdi-stretchblt) function.</span></span> <span data-ttu-id="343a2-108">如同 [**BitBlt**](/windows/desktop/api/Wingdi/nf-wingdi-bitblt) 函式， **StretchBlt** 會從來源裝置內容中的點陣圖複製點陣圖資料 ([**dc**](/windows/desktop/api/Winuser/nf-winuser-getdcex)) 到目標 DC 中的點陣圖。</span><span class="sxs-lookup"><span data-stu-id="343a2-108">Like the [**BitBlt**](/windows/desktop/api/Wingdi/nf-wingdi-bitblt) function, **StretchBlt** copies bitmap data from a bitmap in a source device context ([**DC**](/windows/desktop/api/Winuser/nf-winuser-getdcex)) into a bitmap in a target DC.</span></span> <span data-ttu-id="343a2-109">但是，與 **BitBlt** 函式不同的是， **StretchBlt** 會根據來源和目標矩形的指定維度來調整影像。</span><span class="sxs-lookup"><span data-stu-id="343a2-109">However, unlike the **BitBlt** function, **StretchBlt** scales the image based on the specified dimensions of the source and target rectangles.</span></span> <span data-ttu-id="343a2-110">如果來源矩形大於目標矩形，結果影像將會顯示為已壓縮;如果來源矩形小於目標矩形，結果影像將會顯示為已展開。</span><span class="sxs-lookup"><span data-stu-id="343a2-110">If the source rectangle is larger than the target rectangle, the resultant image will appear to have shrunk; if the source rectangle is smaller than the target rectangle, the resultant image will appear to have expanded.</span></span>

<span data-ttu-id="343a2-111">如果目標矩形小於來源矩形， [**StretchBlt**](/windows/desktop/api/Wingdi/nf-wingdi-stretchblt) 會根據指定的延展模式來移除影像中的色彩資料，如下表所示。</span><span class="sxs-lookup"><span data-stu-id="343a2-111">If the target rectangle is smaller than the source rectangle, [**StretchBlt**](/windows/desktop/api/Wingdi/nf-wingdi-stretchblt) removes color data from the image according to a specified stretch mode as shown in the following table.</span></span>



| <span data-ttu-id="343a2-112">Stretch 模式</span><span class="sxs-lookup"><span data-stu-id="343a2-112">Stretch mode</span></span> | <span data-ttu-id="343a2-113">方法</span><span class="sxs-lookup"><span data-stu-id="343a2-113">Method</span></span>                                                                                                                    |
|--------------|---------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="343a2-114">BLACKONWHITE</span><span class="sxs-lookup"><span data-stu-id="343a2-114">BLACKONWHITE</span></span> | <span data-ttu-id="343a2-115">針對已刪除的圖元以及剩餘圖元的色彩資料，在色彩資料上執行邏輯 AND 運算。</span><span class="sxs-lookup"><span data-stu-id="343a2-115">Performs a logical AND operation on the color data for the eliminated pixels and the color data for the remaining pixels.</span></span> |
| <span data-ttu-id="343a2-116">WHITEONBLACK</span><span class="sxs-lookup"><span data-stu-id="343a2-116">WHITEONBLACK</span></span> | <span data-ttu-id="343a2-117">針對已刪除的圖元以及剩餘圖元的色彩資料執行邏輯 OR 運算。</span><span class="sxs-lookup"><span data-stu-id="343a2-117">Performs a logical OR operation on the color data for the eliminated pixels and the color data for the remaining pixels.</span></span>  |
| <span data-ttu-id="343a2-118">COLORONCOLOR</span><span class="sxs-lookup"><span data-stu-id="343a2-118">COLORONCOLOR</span></span> | <span data-ttu-id="343a2-119">完全消除已刪除圖元的色彩資料。</span><span class="sxs-lookup"><span data-stu-id="343a2-119">Eliminates the color data of the deleted pixels completely.</span></span>                                                               |
| <span data-ttu-id="343a2-120">半 色調</span><span class="sxs-lookup"><span data-stu-id="343a2-120">HALFTONE</span></span>     | <span data-ttu-id="343a2-121">近似原始 (源) 目的地中的色彩資料。</span><span class="sxs-lookup"><span data-stu-id="343a2-121">Approximates the original (source) color data in the destination.</span></span>                                                         |



 

<span data-ttu-id="343a2-122">您可以藉由呼叫 [**SetStretchBltMode**](/windows/desktop/api/Wingdi/nf-wingdi-setstretchbltmode) 函數來設定延展模式。</span><span class="sxs-lookup"><span data-stu-id="343a2-122">You set the stretch mode by calling the [**SetStretchBltMode**](/windows/desktop/api/Wingdi/nf-wingdi-setstretchbltmode) function.</span></span>

<span data-ttu-id="343a2-123">下列範例程式碼取自應用程式，該應用程式示範 [**StretchBlt**](/windows/desktop/api/Wingdi/nf-wingdi-stretchblt) 函式所提供的四種延展模式。</span><span class="sxs-lookup"><span data-stu-id="343a2-123">The following example code is taken from an application that demonstrates all four of the stretch modes available with the [**StretchBlt**](/windows/desktop/api/Wingdi/nf-wingdi-stretchblt) function.</span></span>
