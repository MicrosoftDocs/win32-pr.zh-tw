---
description: 本節中的範例說明如何使用矩形函數。 它是由應用程式中的主視窗程式所組成，可讓使用者移動點陣圖並調整其大小。
ms.assetid: e8861240-9345-43e6-820d-d237247d1bd7
title: 使用 (Windows GDI) 的矩形
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103945214"
---
# <a name="using-rectangles-windows-gdi"></a><span data-ttu-id="e8bb8-104">使用 (Windows GDI) 的矩形</span><span class="sxs-lookup"><span data-stu-id="e8bb8-104">Using Rectangles (Windows GDI)</span></span>

<span data-ttu-id="e8bb8-105">本節中的範例說明如何使用矩形函數。</span><span class="sxs-lookup"><span data-stu-id="e8bb8-105">The example in this section illustrates how to use the rectangle functions.</span></span> <span data-ttu-id="e8bb8-106">它是由應用程式中的主視窗程式所組成，可讓使用者移動點陣圖並調整其大小。</span><span class="sxs-lookup"><span data-stu-id="e8bb8-106">It consists of the main window procedure from an application that enables the user to move and size a bitmap.</span></span>

<span data-ttu-id="e8bb8-107">當應用程式啟動時，它會在畫面左上角的32圖元點陣圖繪製 32-圖元。</span><span class="sxs-lookup"><span data-stu-id="e8bb8-107">When the application starts, it draws a 32-pixel by 32-pixel bitmap in the upper left corner of the screen.</span></span> <span data-ttu-id="e8bb8-108">使用者可以拖曳點陣圖以移動點陣圖。</span><span class="sxs-lookup"><span data-stu-id="e8bb8-108">The user can move the bitmap by dragging it.</span></span> <span data-ttu-id="e8bb8-109">若要調整點陣圖大小，使用者可以拖曳滑鼠來建立目標矩形，然後在目標矩形上拖曳點陣圖並「卸載」。</span><span class="sxs-lookup"><span data-stu-id="e8bb8-109">To size the bitmap, the user creates a target rectangle by dragging the mouse, then drags the bitmap and "drops" it on the target rectangle.</span></span> <span data-ttu-id="e8bb8-110">應用程式會藉由將點陣圖複製到目標矩形來回應。</span><span class="sxs-lookup"><span data-stu-id="e8bb8-110">The application responds by copying the bitmap into the target rectangle.</span></span>

<span data-ttu-id="e8bb8-111">下列範例提供允許使用者移動和調整點陣圖大小的視窗程式。</span><span class="sxs-lookup"><span data-stu-id="e8bb8-111">The window procedure that allows the user to move and size the bitmap is given in the following example.</span></span>
