...
---
# <a name="icm-enabled-pen-functions"></a>ICM-Enabled Pen 函數

Microsoft 影像色彩管理 (ICM) 可確保色彩影像、圖形或文字物件在任何裝置上都能盡可能接近其原始意圖，儘管裝置之間的映射技術和色彩功能有所差異。 無論您是掃描彩色掃描器上的影像或其他圖形、透過網際網路進行下載、在螢幕上進行觀看或編輯，或是將它輸出到紙張、電影或其他媒體，ICM 版本2.0 都能協助您保持其色彩一致且正確。 如需 ICM 的詳細資訊，請參閱 [Windows 色彩系統](/previous-versions//dd372446(v=vs.85))

圖形裝置介面中有各種不同的函式 (使用或操作色彩資料的 GDI) 。 您可以使用下列畫筆函數搭配 ICM：
