...
ms.locfileid: "118298177"
---
# <a name="d3dxvec2scale-function"></a>D3DXVec2Scale 函式
...
[**D3DXVECTOR2**](d3dxvector2.md)結構的指標，此結構是縮放向量。

## <a name="remarks"></a>備註

此函式的傳回值與 *不悅* 參數中所傳回的值相同。 如此一來， **D3DXVec2Scale** 函式就可以用來做為另一個函式的參數。
