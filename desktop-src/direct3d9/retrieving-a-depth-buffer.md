...
---
# <a name="retrieving-a-depth-buffer-direct3d-9"></a>抓取 (Direct3D 9) 的深度緩衝區

下列程式碼範例示範如何使用 [**IDirect3DDevice9：： GetDepthStencilSurface**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-getdepthstencilsurface) 方法，來取得裝置所擁有之深度緩衝區介面的指標。
