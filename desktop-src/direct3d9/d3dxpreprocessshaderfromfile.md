...
ms.locfileid: "119044739"
---
# <a name="d3dxpreprocessshaderfromfile-function"></a>D3DXPreprocessShaderFromFile 函式

在不執行編譯的情況下，將著色器檔案進行前置檔 這會解析所有的 \# 定義和 \# 包含，提供適用于後續編譯的獨立著色器。
