...
---
# <a name="d3dxintersecttri-function-d3dx9meshh"></a>D3DXIntersectTri 函式 (D3DX9Mesh) 
...
[**D3DXVECTOR3**](d3dxvector3.md)結構的指標，描述第一個三角形頂點的位置。
...
[**D3DXVECTOR3**](d3dxvector3.md)結構的指標，描述第二個三角形頂點的位置。
...
[**D3DXVECTOR3**](d3dxvector3.md)結構的指標，描述第三個三角形頂點的位置。
...
[**D3DXIntersect**](d3dxintersect.md)函式可讓您瞭解三角形中和周圍的點，而不受三角形實際位置的影響。 此函式會使用下列方程式傳回結果點： V1 + U (V2-V1) + V (V3-V1) 。
