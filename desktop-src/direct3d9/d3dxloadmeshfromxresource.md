...
---
# <a name="d3dxloadmeshfromxresource-function"></a>D3DXLoadMeshFromXResource 函式
...
資源所在模組的控制碼，或與作業系統用來建立目前進程的映射相關聯的模組之 **Null** 。 請參閱＜備註＞。
...
字串的指標，這個字串會指定要建立網格的來源資源。 請參閱＜備註＞。
...
若要深入瞭解模組、名稱和類型參數，請參閱 [**FindResource**](/windows/win32/api/winbase/nf-winbase-findresourcea) 。
