...
-   [**D3DBACKBUFFER \_ 類型**](./d3dbackbuffer-type.md)
...
-   
    ...
    |                                                                                                                                                                                |
    |--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Direct3D 9 與 Direct3D 9Ex 之間的差異：<br/> 此列舉僅適用于 Direct3D 9Ex。<br/>[**D3DCOMPOSERECTSOP**](./d3dcomposerectsop.md) |

    

     

-   [**D3DCUBEMAP \_ 臉部**](./d3dcubemap-faces.md)
-   [**D3DCULL**](./d3dcull.md)
...
-   
    ...
    |                                                                                                                                                                                  |
    |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Direct3D 9 與 Direct3D 9Ex 之間的差異：<br/> 此列舉僅適用于 Direct3D 9Ex。<br/>[**D3DDISPLAYROTATION**](./d3ddisplayrotation.md) |
...
-   [**D3DMULTISAMPLE \_ 類型**](./d3dmultisample-type.md)
...
-   [**D3DSAMPLER \_ 材質 \_ 類型**](./d3dsampler-texture-type.md)
-   [**D3DSAMPLERSTATETYPE**](./d3dsamplerstatetype.md)
-   

    |                                                                                                                                                                                    |
    |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Direct3D 9 與 Direct3D 9Ex 之間的差異：<br/> 此列舉僅適用于 Direct3D 9Ex。<br/>[**D3DSCANLINEORDERING**](./d3dscanlineordering.md) |
...
-   [**D3DXFERR 傳回值**](./d3dxferr-return-values.md)
