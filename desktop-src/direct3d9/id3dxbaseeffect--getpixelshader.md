...
ms.locfileid: "118094112"
---
# <a name="id3dxbaseeffectgetpixelshader-method"></a>ID3DXBaseEffect：： GetPixelShader 方法
...
傳回圖元著色器物件。 請參閱 [**IDirect3DPixelShader9**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3dpixelshader9) 物件。
