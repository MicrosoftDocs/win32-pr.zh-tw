...
---
# <a name="templates-x-file-format-binary-encoding"></a><span data-ttu-id="e3811-103"> (X 檔案格式、二進位編碼) 的範本</span><span class="sxs-lookup"><span data-stu-id="e3811-103">Templates (X file format, binary encoding)</span></span>

<span data-ttu-id="e3811-104">範本有下列語法定義。</span><span class="sxs-lookup"><span data-stu-id="e3811-104">A template has the following syntax definition.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="e3811-105">相關主題</span><span class="sxs-lookup"><span data-stu-id="e3811-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="e3811-106">二進位編碼方式</span><span class="sxs-lookup"><span data-stu-id="e3811-106">Binary Encoding</span></span>](binary-encoding.md)
</dt> </dl>
