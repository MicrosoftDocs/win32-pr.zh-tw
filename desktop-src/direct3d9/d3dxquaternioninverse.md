...
ms.locfileid: "117731600"
---
# <a name="d3dxquaternioninverse-function-d3dx9mathh"></a>D3DXQuaternionInverse 函式 (D3dx9math) 
...
[**D3DXQUATERNION**](d3dxquaternion.md)結構的指標，此結構是四元數的反向四元數。
...
此函式的傳回值與 *不悅* 參數中所傳回的值相同。 如此一來， **D3DXQuaternionInverse** 函式就可以用來做為另一個函式的參數。
