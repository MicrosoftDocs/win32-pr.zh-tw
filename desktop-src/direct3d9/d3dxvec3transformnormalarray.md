...
[**D3DXVECTOR3**](d3dxvector3.md)陣列的指標，這是作業的結果。
...
[**D3DXVECTOR3**](d3dxvector3.md)陣列的指標，該陣列為已轉換的陣列。
...
此函式的傳回值與 *不悅* 參數中所傳回的值相同。 如此一來， **D3DXVec3TransformNormalArray** 函式就可以用來做為另一個函式的參數。
