...
從來源四元數建立之 [**D3DXMATRIX**](d3dxmatrix.md) 結構的指標。

## <a name="remarks"></a>備註

此函式的傳回值與 *不悅* 參數中所傳回的值相同。 如此一來， **D3DXMatrixRotationQuaternion** 函式就可以用來做為另一個函式的參數。

如需如何從方向向量計算四元數值 ( x、y、z ) 和旋轉角度的詳細資訊，請參閱 [**D3DXQUATERNION**](d3dxquaternion.md)。
