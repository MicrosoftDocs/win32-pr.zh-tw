...
[**ID3DXBaseMesh**](id3dxbasemesh.md)介面的指標，代表要測試的網格。
...
[**ID3DXBuffer**](id3dxbuffer.md)物件的指標，其中包含 [**D3DXINTERSECTINFO**](d3dxintersectinfo.md)結構的陣列。
...
**D3DXIntersect** 函式可讓您瞭解三角形中和周圍的點，而不受三角形實際位置的影響。 此函式會使用下列方程式傳回結果點： V1 + U (V2-V1) + V (V3-V1) 。
