...
---
# <a name="d3dxmatrixrotationy-function-d3dx9mathh"></a>D3DXMatrixRotationY 函式 (D3dx9math) 
...
圍繞 y 軸旋轉之 [**D3DXMATRIX**](d3dxmatrix.md) 結構的指標。

## <a name="remarks"></a>備註

此函式的傳回值與 *不悅* 參數中所傳回的值相同。 如此一來， **D3DXMatrixRotationY** 函式就可以用來做為另一個函式的參數。
