...
ms.locfileid: "118521234"
---
# <a name="id3dxconstanttablesetvectorarray-method"></a>ID3DXConstantTable：： SetVectorArray 方法
...
向量常數陣列的唯一識別碼。 請參閱 [D3DXHANDLE](dx9-graphics-reference-effects-constants.md)。
