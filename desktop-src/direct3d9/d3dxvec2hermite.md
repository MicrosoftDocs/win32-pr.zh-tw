...
ms.locfileid: "118804049"
---
# <a name="d3dxvec2hermite-function-d3dx9mathh"></a>D3DXVec2Hermite 函式 (D3dx9math) 
...
來源 [**D3DXVECTOR2**](d3dxvector2.md) 結構的指標，也就是正切向量。
...
[**D3DXVECTOR2**](d3dxvector2.md)結構的指標，此結構是 Hermite 曲線插補的結果。
