...
[**D3DXVECTOR3**](d3dxvector3.md)結構的指標，此結構是從螢幕空間投射到物件空間的陣列。

## <a name="remarks"></a>備註

此函式的傳回值與 *不悅* 參數中所傳回的值相同。 如此一來， [**D3DXVec3Unproject**](d3dxvec3unproject.md) 函式就可以用來做為另一個函式的參數。
