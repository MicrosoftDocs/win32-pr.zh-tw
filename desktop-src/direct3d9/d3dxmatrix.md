...
ms.locfileid: "118525329"
---
# <a name="d3dxmatrix-structure-d3dx9mathh"></a>D3DXMATRIX 結構 (D3dx9math .h) 
...
C 程式設計人員無法使用 D3DXMATRIX 結構，必須使用 [**D3DMATRIX**](d3dmatrix.md) 結構。 C + + 程式設計人員可以利用多載的函式和指派、一元和二元 (包括相等) 運算子。
