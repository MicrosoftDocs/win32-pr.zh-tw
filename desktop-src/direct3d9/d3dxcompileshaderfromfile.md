...
ms.locfileid: "119750448"
---
# <a name="d3dxcompileshaderfromfile-function"></a>D3DXCompileShaderFromFile 函式
...
如果函式成功，則傳回值為「D3D \_ 正常」。 如果函式失敗，則傳回值可以是下列其中一項： D3DERR \_ INVALIDCALL、D3DXERR \_ INVALIDDATA、e \_ >notimpl、e \_ OUTOFMEMORY。

\_如果您要使用1.1 著色器 (vs \_ 1 \_ 1 和 ps \_ 1 \_ 1) ，則會傳回 E >notimpl。
