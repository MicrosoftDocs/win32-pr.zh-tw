...
編譯器設定也會決定函式版本。 如果已定義 Unicode，函式呼叫會解析為 D3DXCreateVolumeTextureFromResourceW。 否則，函式呼叫會解析為 D3DXCreateVolumeTextureFromResourceA，因為正在使用 ANSI 字串。

函數相當於 D3DXCreateVolumeTextureFromResourceEx (pDevice、hSrcModule、pSrcResource、D3DX \_ default、D3DX \_ DEFAULT、D3DX \_ default、D3DX \_ DEFAULT、0、D3DFMT \_ UNKNOWN、D3DPOOL \_ MANAGED、D3DX \_ Default、D3DX \_ default、0、 **null**、 **null**、ppVolumeTexture) 。
