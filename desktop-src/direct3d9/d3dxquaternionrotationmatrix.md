...
ms.locfileid: "118988448"
---
# <a name="d3dxquaternionrotationmatrix-function-d3dx9mathh"></a>D3DXQuaternionRotationMatrix 函式 (D3dx9math) 
...
從旋轉矩陣建立之 [**D3DXQUATERNION**](d3dxquaternion.md) 結構的指標。

## <a name="remarks"></a>備註

此函式的傳回值與 *不悅* 參數中所傳回的值相同。 如此一來， **D3DXQuaternionRotationMatrix** 函式就可以用來做為另一個函式的參數。
