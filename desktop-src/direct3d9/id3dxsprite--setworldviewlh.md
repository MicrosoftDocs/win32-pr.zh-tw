...
ms.locfileid: "118292570"
---
# <a name="id3dxspritesetworldviewlh-method"></a>ID3DXSprite：： SetWorldViewLH 方法

為 sprite 設定左手的世界視圖轉換。 在 billboarding 或排序 sprite 之前，需要呼叫此方法。
...
如果您要使用 [D3DXSprite \_ \_ 佈告欄](d3dxsprite.md)、D3DXSprite SORT depth [](id3dxsprite--setworldviewrh.md) \_ \_ \_ \_ FRONTTOBACK 或 D3DXSprite \_ \_ \_ \_ [**：： Begin**](id3dxsprite--begin.md)中的 BACKTOFRONT SORT Depth ID3DXSprite 旗標值來呈現 sprite，則需要呼叫此方法 (或 ID3DXSprite：： SetWorldViewRH) 。
