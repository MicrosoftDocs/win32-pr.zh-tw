...
-   **HKEY \_ 本機 \_ 電腦 \\ 軟體 \\ Microsoft \\ Windows \\ CurrentVersion \\ 執行**
-   **HKEY \_ 目前的 \_ 使用者 \\ 軟體 \\ Microsoft \\ Windows \\ CurrentVersion \\ 執行**
...
根據預設，當電腦以安全模式啟動時，會忽略這些機碼。 RunOnce 索引鍵的值名稱前面可以加上星號 (\*) 來強制程式在安全模式中執行。
