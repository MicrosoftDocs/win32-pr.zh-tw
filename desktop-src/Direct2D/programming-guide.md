...
| [分析 DirectX 應用程式](profiling-directx-applications.md)<br/>                   | 說明如何使用 Windows 效能工具組隨附的 **XPerf** 和 **GPUView** 工具，測量 [DirectX](/previous-versions/windows/apps/jj262109(v=win.10))應用程式的一些最重要效能時間測量。 <br/>                                                                                                |
