---
title: 'ID2D1Geometry GetBounds 方法 (D2d1 \_ 1 .h) '
description: 捕獲幾何的界限。
ms.assetid: 3932189a-7c6b-4144-9d4a-32d2aba70835
keywords:
- GetBounds 方法 Direct2D
topic_type:
- apiref
api_location:
- D2d1.dll
...
ms.locfileid: "106982684"
---
# <a name="id2d1geometrygetbounds-methods"></a><span data-ttu-id="89a56-104">ID2D1Geometry：： GetBounds 方法</span><span class="sxs-lookup"><span data-stu-id="89a56-104">ID2D1Geometry::GetBounds methods</span></span>

<span data-ttu-id="89a56-105">捕獲幾何的界限。</span><span class="sxs-lookup"><span data-stu-id="89a56-105">Retrieves the bounds of the geometry.</span></span>

### <a name="overload-list"></a><span data-ttu-id="89a56-106">多載清單</span><span class="sxs-lookup"><span data-stu-id="89a56-106">Overload list</span></span>



| <span data-ttu-id="89a56-107">方法</span><span class="sxs-lookup"><span data-stu-id="89a56-107">Method</span></span>                                                                                                                   | <span data-ttu-id="89a56-108">描述</span><span class="sxs-lookup"><span data-stu-id="89a56-108">Description</span></span>                                      |
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| <span data-ttu-id="89a56-109">[**GetBounds (D2D1 \_ 矩陣 \_ 3X2 \_ F&，D2D \_ RECT \_ F \*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))</span><span class="sxs-lookup"><span data-stu-id="89a56-109">[**GetBounds(D2D1\_MATRIX\_3X2\_F&,D2D\_RECT\_F\*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))</span></span>   | <span data-ttu-id="89a56-110">捕獲幾何的界限。</span><span class="sxs-lookup"><span data-stu-id="89a56-110">Retrieves the bounds of the geometry.</span></span><br/> |
| <span data-ttu-id="89a56-111">[**GetBounds (D2D1 \_ 矩陣 \_ 3X2 \_ F \* ，D2D1 \_ RECT \_ f \*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f))</span><span class="sxs-lookup"><span data-stu-id="89a56-111">[**GetBounds(D2D1\_MATRIX\_3X2\_F\*,D2D1\_RECT\_F\*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f))</span></span> | <span data-ttu-id="89a56-112">捕獲幾何的界限。</span><span class="sxs-lookup"><span data-stu-id="89a56-112">Retrieves the bounds of the geometry.</span></span><br/> |



## <a name="examples"></a><span data-ttu-id="89a56-113">範例</span><span class="sxs-lookup"><span data-stu-id="89a56-113">Examples</span></span>

<span data-ttu-id="89a56-114">下列程式碼示範如何使用 **GetBounds** 來取出幾何的範圍。</span><span class="sxs-lookup"><span data-stu-id="89a56-114">The following code shows how to use **GetBounds** to retrieve the bounds of the geometry.</span></span>
...
## <a name="requirements"></a><span data-ttu-id="89a56-115">規格需求</span><span class="sxs-lookup"><span data-stu-id="89a56-115">Requirements</span></span>



| <span data-ttu-id="89a56-116">需求</span><span class="sxs-lookup"><span data-stu-id="89a56-116">Requirement</span></span> | <span data-ttu-id="89a56-117">值</span><span class="sxs-lookup"><span data-stu-id="89a56-117">Value</span></span> |
|--------------------|--------------------------------------------------------------------------------------|
| <span data-ttu-id="89a56-118">標頭</span><span class="sxs-lookup"><span data-stu-id="89a56-118">Header</span></span><br/>  | <dl> <span data-ttu-id="89a56-119"><dt>D2d1 \_ 1. h</dt></span><span class="sxs-lookup"><span data-stu-id="89a56-119"><dt>D2d1\_1.h</dt></span></span> </dl> |
| <span data-ttu-id="89a56-120">程式庫</span><span class="sxs-lookup"><span data-stu-id="89a56-120">Library</span></span><br/> | <dl> <span data-ttu-id="89a56-121"><dt>D2d1 .lib</dt></span><span class="sxs-lookup"><span data-stu-id="89a56-121"><dt>D2d1.lib</dt></span></span> </dl>  |
| <span data-ttu-id="89a56-122">DLL</span><span class="sxs-lookup"><span data-stu-id="89a56-122">DLL</span></span><br/>     | <dl> <span data-ttu-id="89a56-123"><dt>D2d1.dll</dt></span><span class="sxs-lookup"><span data-stu-id="89a56-123"><dt>D2d1.dll</dt></span></span> </dl>  |



## <a name="see-also"></a><span data-ttu-id="89a56-124">另請參閱</span><span class="sxs-lookup"><span data-stu-id="89a56-124">See also</span></span>

<dl> <dt>

[<span data-ttu-id="89a56-125">**ID2D1Geometry**</span><span class="sxs-lookup"><span data-stu-id="89a56-125">**ID2D1Geometry**</span></span>](/windows/win32/api/d2d1/nn-d2d1-id2d1geometry)
</dt> </dl>
