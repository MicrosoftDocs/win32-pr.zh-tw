...
ms.locfileid: "119214459"
---
# <a name="id2d1geometrygetbounds-methods"></a>ID2D1Geometry：： GetBounds 方法
...
| 方法                                                                                                                   | 描述                                      |
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| [**GetBounds (D2D1 \_ 矩陣 \_ 3X2 \_ F&，D2D \_ RECT \_ F \*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))   | 捕獲幾何的界限。<br/> |
| [**GetBounds (D2D1 \_ 矩陣 \_ 3X2 \_ F \* ，D2D1 \_ RECT \_ f \*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f)) | 捕獲幾何的界限。<br/> |



## <a name="examples"></a>範例

下列程式碼示範如何使用 **GetBounds** 來取出幾何的範圍。
