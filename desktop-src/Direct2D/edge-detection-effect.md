...
篩選出影像的內容，並在影像的對比區段邊緣留下線條。

這項效果的 CLSID 是 CLSID \_ D2D1EdgeDetection。
...
Edge 偵測效果的屬性是由 [**D2D1 \_ EDGEDETECTION \_**](/windows/desktop/api/d2d1effects_2/ne-d2d1effects_2-d2d1_edgedetection_prop) 屬性列舉所定義。
