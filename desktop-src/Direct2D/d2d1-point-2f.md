...
ms.locfileid: "119586928"
---
# <a name="d2d1_point_2f"></a>D2D1 \_ 點 \_ 2f
...
Direct2D 中的點會以 **D2D1 \_ 點 \_ 2f** 或 [**D2D1 \_ 點 \_ 2u**](d2d1-point-2u.md) 結構表示。 兩者都在二維空間中包含 x 座標和 y 座標組。 **D2D1 \_ 點 \_ 2f** 結構會將座標儲存為 **FLOAT** 值，而 **D2D1 \_ 點 \_ 2u** 結構會將這些座標儲存為 **UINT32** 值。

**D2D1 \_點 \_ 2f** 是已定義之型別 [**D2D \_ 點 \_ 2f**](/windows/desktop/api/dcommon/ns-dcommon-d2d_point_2f)的新名稱。
...
[**D2D1 \_ 點 \_ 2u**](/windows/desktop/Direct2D/d2d1-point-2u)
</dt> <dt>
