...
---
# <a name="id2d1geometrygetwidenedbounds-methods"></a>ID2D1Geometry：： GetWidenedBounds 方法

取得幾何的範圍，它已由指定的筆觸寬度和樣式加寬，並且由指定的矩陣轉換。
...
| 方法                                                                                                                                                                                                 | 描述                                                                                                                                           |
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GetWidenedBounds (FLOAT、ID2D1StrokeStyle \* 、D2D1 \_ MATRIX \_ 3X2 \_ F&、D2D1 \_ RECT \_ F \*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__d2d1_rect_f))              | 取得幾何的範圍，它已由指定的筆觸寬度和樣式加寬，並且由指定的矩陣轉換。<br/> |
| [**GetWidenedBounds (FLOAT，ID2D1StrokeStyle \* ，D2D1 \_ MATRIX \_ 3X2 \_ F \* ，D2D1 \_ RECT \_ F \*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_d2d1_rect_f))             | 取得幾何的範圍，它已由指定的筆觸寬度和樣式加寬，並且由指定的矩陣轉換。<br/> |
| [**GetWidenedBounds (FLOAT、ID2D1StrokeStyle \* 、D2D1 \_ MATRIX \_ 3X2 \_ F&、FLOAT、D2D1 \_ RECT \_ F \*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__float_d2d1_rect_f))  | 取得幾何的範圍，它已由指定的筆觸寬度和樣式加寬，並且由指定的矩陣轉換。<br/> |
| [**GetWidenedBounds (FLOAT，ID2D1StrokeStyle \* ，D2D1 \_ MATRIX \_ 3X2 \_ F \* ，FLOAT，D2D1 \_ RECT \_ F \*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_float_d2d1_rect_f)) | 取得幾何的範圍，它已由指定的筆觸寬度和樣式加寬，並且由指定的矩陣轉換。<br/> |



## <a name="examples"></a>範例

下列程式碼會示範如何使用 **GetWidenedBounds** ，以在指定的筆觸寬度和樣式（由指定的矩陣轉換）加寬之後，取得幾何的界限。
