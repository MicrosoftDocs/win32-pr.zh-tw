...
Windows Internet Explorer 會在可行時支援舊版 Internet Explorer 模型，讓您開發的網站在較新版本的 Internet Explorer 中繼續以預期的方式運作。 從 Windows Internet Explorer 8 開始，您可以選擇依頁面逐一選取轉譯模式，以支援舊版行為。
...
|---------------|---------------------------------------------------------------------------------------|
| IE = 5          | 使用 [不相容] 模式。                                                                      |
| IE = 7          | 一律使用 Windows Internet Explorer 7 模式。                                          |
