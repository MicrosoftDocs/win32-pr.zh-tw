...
一般相容性包含可能會影響用戶端或用戶端和伺服器的主題。 以下是本節所涵蓋的主題清單：

-   [512 位元組模擬 (512e) 磁碟相容性更新](512-byte-emulation--512e--disk-compatibility-update.md)
-   [作業系統版本控制](operating-system-versioning.md)
-   [移除 Windows Mail](removal-of-windows-mail.md)
-   [移除 Windows Movie Maker](removal-of-windows-movie-maker.md)
-   [NLS 排序變更](nls-sorting-changes.md)
-   [Internet Explorer 8-使用者代理程式字串](internet-explorer-8---user-agent-string.md)
