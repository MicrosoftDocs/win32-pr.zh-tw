...
-   Microsoft 不會提供新的授權或續約
-   Microsoft 不會更新 Microsoft 代理程式元件，包括：
    -   "msagent.exe" 執行時間和程式庫
    -   字元 Merlin、瓶精靈、Peedy 和 Robbo
    -   代理程式字元編輯器
    -   所有相關的 Microsoft 代理程式軟體、工具和檔
-   Windows 7 和更新版本將不支援開發 Microsoft Agent 應用程式或字元
...
-   [Robby 字元檔](https://www.microsoft.com/downloads/details.aspx?FamilyID=fa36d1d5-d828-494a-ad0a-7b571db5bd2e)

## <a name="links-to-other-resources"></a>其他資源的連結

<dl>

[Microsoft 代理程式資源](https://support.microsoft.com/kb/969168)  
</dl>
