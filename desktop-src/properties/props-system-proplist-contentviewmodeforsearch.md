---
description: 識別要在搜尋內容中專案內容視圖模式中顯示的屬性清單。
...
```
propertyDescription
   name = System.PropList.ContentViewModeForSearch
   shellPKey = PKEY_PropList_ContentViewModeForSearch
