---
description: 以1為准的單純遞增數位，對應于第一次展示節目的季節。
...
ms.locfileid: "106997597"
---
# <a name="systemmediaseasonnumber"></a>SeasonNumber

以1為准的單純遞增數位，對應于第一次展示節目的季節
...
```
propertyDescription
   name = System.Media.SeasonNumber
   shellPKey = PKEY_Media_SeasonNumber
