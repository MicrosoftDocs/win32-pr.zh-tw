---
description: 以 VT 串流格式表示的縮圖資料 \_ ，Windows GDI+ 和 Windows 編解碼器（例如 .jpg 和 .png）支援。
...
ms.locfileid: "117864254"
---
# <a name="systemthumbnailstream"></a>System. ThumbnailStream

以 VT 串流格式表示的縮圖資料 \_ ，Windows GDI+ 和 Windows 編解碼器（例如 .jpg 和 .png）支援。
