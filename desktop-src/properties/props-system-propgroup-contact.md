---
description: 屬性清單中所使用的屬性群組分隔符號，用來分隔其他類型的連絡人。 請勿使用這個屬性來取得或設定值。 這個屬性僅供標記之用。
...
```
propertyDescription
   name = System.PropGroup.Contact
   shellPKey = PKEY_PropGroup_Contact
   formatID = DF975FD3-250A-4004-858F-34E29A3E37AA
   propID = 100
   SearchInfo
