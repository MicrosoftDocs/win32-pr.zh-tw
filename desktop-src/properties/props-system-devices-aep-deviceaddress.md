---
description: 以裝置關聯端點的通訊協定為基礎的位址。 IP 裝置的 IP 位址、藍牙裝置的藍牙位址等等。
...
```
propertyDescription
   name = System.Devices.Aep.DeviceAddress
   shellPKey = PKEY_Devices_Aep_DeviceAddress
