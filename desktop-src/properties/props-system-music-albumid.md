---
description: 這個屬性會區分具有不同演出者之相同標題的專輯。 它是 AlbumArtist 和 AlbumTitle 的串連方式。
...
這個屬性會區分具有不同演出者之相同標題的專輯。 它是 AlbumArtist 和 AlbumTitle 的串連方式。
...
```
propertyDescription
   name = System.Music.AlbumID
   shellPKey = PKEY_Music_AlbumID
