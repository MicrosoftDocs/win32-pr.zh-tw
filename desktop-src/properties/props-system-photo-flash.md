...
---
# <a name="systemphotoflash"></a><span data-ttu-id="8305a-103">： Flash</span><span class="sxs-lookup"><span data-stu-id="8305a-103">System.Photo.Flash</span></span>

<span data-ttu-id="8305a-104">拍攝相片時的閃爍狀態指示器，從交換影像檔案讀取 (EXIF) 資訊。</span><span class="sxs-lookup"><span data-stu-id="8305a-104">An indicator of the flash status when the photo was taken, as read from the Exchangeable Image File (EXIF) info.</span></span>

## <a name="windows-10-version-1703-windows-10-version-1607-windows-10-version-1511-windows-10-version-1507-windows-81-windows-8-windows-7"></a><span data-ttu-id="8305a-105">Windows 10，1703、Windows 10、1607版、Windows 10、1511版、Windows 10、1507、Windows 8.1、Windows 8、Windows 7 版</span><span class="sxs-lookup"><span data-stu-id="8305a-105">Windows 10, version 1703, Windows 10, version 1607, Windows 10, version 1511, Windows 10, version 1507, Windows 8.1, Windows 8, Windows 7</span></span>
...
## <a name="windows-vista"></a><span data-ttu-id="8305a-106">Windows Vista</span><span class="sxs-lookup"><span data-stu-id="8305a-106">Windows Vista</span></span>
...
## <a name="remarks"></a><span data-ttu-id="8305a-107">備註</span><span class="sxs-lookup"><span data-stu-id="8305a-107">Remarks</span></span>

<span data-ttu-id="8305a-108">PKEY 值定義于 Propkey 中。</span><span class="sxs-lookup"><span data-stu-id="8305a-108">PKEY values are defined in Propkey.h.</span></span>

## <a name="related-topics"></a><span data-ttu-id="8305a-109">相關主題</span><span class="sxs-lookup"><span data-stu-id="8305a-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="8305a-110">數位相機的交換影像檔案格式： Exif 2.2 版</span><span class="sxs-lookup"><span data-stu-id="8305a-110">Exchangeable Image File Format for Digital Still Cameras: Exif Version 2.2</span></span>](https://www.exif.org/Exif2-2.PDF)
</dt> <dt>

[<span data-ttu-id="8305a-111">propertyDescription</span><span class="sxs-lookup"><span data-stu-id="8305a-111">propertyDescription</span></span>](./propdesc-schema-propertydescription.md)
</dt> <dt>

[<span data-ttu-id="8305a-112">searchInfo</span><span class="sxs-lookup"><span data-stu-id="8305a-112">searchInfo</span></span>](./propdesc-schema-searchinfo.md)
</dt> <dt>

[<span data-ttu-id="8305a-113">labelInfo</span><span class="sxs-lookup"><span data-stu-id="8305a-113">labelInfo</span></span>](./propdesc-schema-labelinfo.md)
</dt> <dt>

[<span data-ttu-id="8305a-114">typeInfo</span><span class="sxs-lookup"><span data-stu-id="8305a-114">typeInfo</span></span>](./propdesc-schema-typeinfo.md)
</dt> <dt>

[<span data-ttu-id="8305a-115">displayInfo</span><span class="sxs-lookup"><span data-stu-id="8305a-115">displayInfo</span></span>](./propdesc-schema-displayinfo.md)
</dt> <dt>

[<span data-ttu-id="8305a-116">stringFormat</span><span class="sxs-lookup"><span data-stu-id="8305a-116">stringFormat</span></span>](./propdesc-schema-stringformat.md)
</dt> <dt>

[<span data-ttu-id="8305a-117">booleanFormat</span><span class="sxs-lookup"><span data-stu-id="8305a-117">booleanFormat</span></span>](./propdesc-schema-booleanformat.md)
</dt> <dt>

[<span data-ttu-id="8305a-118">>cultureinfo.numberformat</span><span class="sxs-lookup"><span data-stu-id="8305a-118">numberFormat</span></span>](./propdesc-schema-numberformat.md)
</dt> <dt>

[<span data-ttu-id="8305a-119">dateTimeFormat</span><span class="sxs-lookup"><span data-stu-id="8305a-119">dateTimeFormat</span></span>](./propdesc-schema-datetimeformat.md)
</dt> <dt>

[<span data-ttu-id="8305a-120">enumeratedList</span><span class="sxs-lookup"><span data-stu-id="8305a-120">enumeratedList</span></span>](./propdesc-schema-enumeratedlist.md)
</dt> <dt>

[<span data-ttu-id="8305a-121">drawControl</span><span class="sxs-lookup"><span data-stu-id="8305a-121">drawControl</span></span>](./propdesc-schema-drawcontrol.md)
</dt> <dt>

[<span data-ttu-id="8305a-122">editControl</span><span class="sxs-lookup"><span data-stu-id="8305a-122">editControl</span></span>](./propdesc-schema-editcontrol.md)
</dt> <dt>

[<span data-ttu-id="8305a-123">filterControl</span><span class="sxs-lookup"><span data-stu-id="8305a-123">filterControl</span></span>](./propdesc-schema-filtercontrol.md)
</dt> <dt>

[<span data-ttu-id="8305a-124">queryControl</span><span class="sxs-lookup"><span data-stu-id="8305a-124">queryControl</span></span>](./propdesc-schema-querycontrol.md)
</dt> </dl>
