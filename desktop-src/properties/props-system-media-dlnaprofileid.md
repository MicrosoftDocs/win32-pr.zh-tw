---
description: 媒體內容的 DLNA 設定檔識別碼，由 DLNA 標準定義。
...
```
propertyDescription
   name = System.Media.DlnaProfileID
   shellPKey = PKEY_Media_DlnaProfileID
   formatID = CFA31B45-525D-4998-BB44-3F7D81542FA4
   propID = 100
   SearchInfo
