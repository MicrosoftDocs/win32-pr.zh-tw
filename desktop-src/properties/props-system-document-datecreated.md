---
description: 指出建立檔的日期和時間。 這項資訊會儲存在檔中，而不是從檔案系統取得。
ms.assetid: 00d8faa6-6b9c-4981-aeb1-17f8f14b1926
title: System.Doc>ument。DateCreated
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118466758"
---
# <a name="systemdocumentdatecreated"></a>System.Doc>ument。DateCreated

指出建立檔的日期和時間。 這項資訊會儲存在檔中，而不是從檔案系統取得。
...
```
propertyDescription
   name = System.Document.DateCreated
   shellPKey = PKEY_Document_DateCreated
