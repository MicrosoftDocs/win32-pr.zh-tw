---
description: ConnectedServiceName
ms.assetid: 33af6310-3915-4d59-a0e7-676c6720451c
title: ConnectedServiceName
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "117684992"
---
# <a name="systemcontactconnectedservicename"></a>ConnectedServiceName
...
```
propertyDescription
   name = System.Contact.ConnectedServiceName
   shellPKey = PKEY_Contact_ConnectedServiceName
   formatID = B5C84C9E-5927-46B5-A3CC-933C21B78469
   propID = 100
   SearchInfo
