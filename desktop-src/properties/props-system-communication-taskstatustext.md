---
description: TaskStatus 的使用者易記形式。 此值不能以程式設計方式剖析。
...
```
propertyDescription
   name = System.Communication.TaskStatusText
   shellPKey = PKEY_Communication_TaskStatusText
   formatID = A6744477-C237-475B-A075-54F34498292A
   propID = 100
   SearchInfo
