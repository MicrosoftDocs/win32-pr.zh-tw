---
description: 介於0與100之間的整數值，表示已完成的百分比。
ms.assetid: 88ff4ca0-183c-4e9a-a240-ee69ef6eaf38
title: System.componentmodel.progresschangedeventargs.progresspercentage
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119033296"
---
# <a name="systemsyncprogresspercentage"></a>System.componentmodel.progresschangedeventargs.progresspercentage

介於0與100之間的整數值，表示已完成的百分比。
...
```
propertyDescription
   name = System.Sync.ProgressPercentage
   shellPKey = PKEY_Sync_ProgressPercentage
