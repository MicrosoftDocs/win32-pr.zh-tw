...
適用于 Windows 7 的新。 [RelatedProperty](./propdesc-schema-relatedproperty.md)元素的容器元素。 每個[propertyDescription](./propdesc-schema-propertydescription.md)專案都只能有一個[relatedPropertyInfo]()元素。
