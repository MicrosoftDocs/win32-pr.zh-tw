---
description: 針對麥克風裝置在 Db 中發出雜訊比例資訊的信號。
...
propertyDescription
   ...
   shellPKey = PKEY_Devices_AudioDevice_Microphone_SignalToNoiseRatioInDb
