...
ms.locfileid: "119596718"
---
# <a name="systemphotoaperture"></a>System.servicemodel

影像的光圈值（以頂點單位）。 如需比較[FNumber](./props-system-photo-fnumber.md) [的值]()，請參閱交換影像檔案 (EXIF) 2.2 規格（附錄 C）。 這個屬性是從 [ApertureNumerator](./props-system-photo-aperturenumerator.md) 和 [ApertureDenominator](./props-system-photo-aperturedenominator.md)計算而來。
