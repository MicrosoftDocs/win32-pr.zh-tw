---
description: 表示上次列印檔案的日期和時間。 舊版名稱是 &\# 0034; DocLastPrinted&\# 0034;。
ms.assetid: 57a08471-04b2-4c1e-9212-b76f6ca631f8
title: System.Doc>ument。DatePrinted
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118466695"
---
# <a name="systemdocumentdateprinted"></a>System.Doc>ument。DatePrinted

表示上次列印檔案的日期和時間。 舊名稱為 "DocLastPrinted"。
...
```
propertyDescription
   name = System.Document.DatePrinted
   shellPKey = PKEY_Document_DatePrinted
