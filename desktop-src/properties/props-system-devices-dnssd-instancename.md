---
description: DNS-SD service instance name 的實例部分。 (例如 &\# 0034; myservice&\# 0034; 在 &\# 0034; myservice 中。 \_HTTP。 \_net.tcp&\# 0034; ) 。
...
DNS 的實例部分-SD service 實例名稱。 (例如 "myservice \_ " 中的 "myservice"。HTTP。 \_net.tcp ") 
...
```
propertyDescription
   name = System.Devices.Dnssd.InstanceName
   shellPKey = PKEY_Devices_Dnssd_InstanceName
