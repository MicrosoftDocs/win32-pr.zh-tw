---
description: 這個檔案的儲存提供者計算的檔案版本等高線。 此值可用來偵測檔案是否已變更。
...
這個檔案的儲存提供者計算的檔案版本等高線。 此值可用來偵測檔案是否已變更。
...
```
propertyDescription
   name = System.StorageProviderFileVersionWaterline
   shellPKey = PKEY_StorageProviderFileVersionWaterline
