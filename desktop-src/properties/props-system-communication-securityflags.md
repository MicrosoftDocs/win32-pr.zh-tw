---
description: 與專案相關聯的安全性旗標，指出專案是否已啟用加密、簽署或 DRM。
...
```
propertyDescription
   name = System.Communication.SecurityFlags
   shellPKey = PKEY_Communication_SecurityFlags
   formatID = 8619A4B6-9F4D-4429-8C0F-B996CA59E335
   propID = 100
   SearchInfo
