---
description: AepContainer 屬性指出裝置所屬的類別，例如 [印表機] 或 [相機]。
...
```
propertyDescription
   name = System.Devices.AepContainer.Categories
   shellPKey = PKEY_Devices_AepContainer_Categories
