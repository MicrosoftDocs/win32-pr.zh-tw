---
description: PKEY \_ GPS DestLongitude 的分子 \_ 。
...
```
propertyDescription
   name = System.GPS.DestLongitudeNumerator
   shellPKey = PKEY_GPS_DestLongitudeNumerator
   formatID = A3250282-FB6D-48D5-9A89-DBCACE75CCCF
   propID = 100
   SearchInfo
