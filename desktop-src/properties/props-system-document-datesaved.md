---
description: 表示上次儲存檔的日期和時間。 舊版名稱是 &\# 0034; DocLastSavedTm&\# 0034;。
...
表示上次儲存檔的日期和時間。 舊名稱為 "DocLastSavedTm"。
...
```
propertyDescription
   name = System.Document.DateSaved
   shellPKey = PKEY_Document_DateSaved
