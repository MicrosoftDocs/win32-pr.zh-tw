---
description: 識別 shell 資料夾是否釘選到流覽窗格。
...
ms.locfileid: "119716568"
---
# <a name="systemispinnedtonamespacetree"></a>System. IsPinnedToNameSpaceTree

識別 shell 資料夾是否釘選到流覽窗格。
...
propertyDescription
   ...
   shellPKey = PKEY_IsPinnedToNameSpaceTree
