---
description: 指出拍攝相片時，在相機或輸入裝置上選取的曝光索引。 從 PKEY \_ photo \_ EXPOSUREINDEXNUMERATOR 和 PKEY \_ photo ExposureIndexDenominator 計算 \_ 。
...
```
propertyDescription
   name = System.Photo.ExposureIndex
   shellPKey = PKEY_Photo_ExposureIndex
   formatID = 967B5AF8-995A-46ED-9E11-35B3C5B9782D
   propID = 100
   SearchInfo
