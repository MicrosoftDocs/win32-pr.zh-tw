---
description: 身分識別提供者的圖片。
ms.assetid: 68da1d13-9067-47c8-96a0-22c55984088a
title: IdentityProvider。圖片
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119844718"
---
# <a name="systemidentityproviderpicture"></a>IdentityProvider。圖片
...
```
propertyDescription
   name = System.IdentityProvider.Picture
   shellPKey = PKEY_IdentityProvider_Picture
   formatID = 2425166F-5642-4864-992F-98FD98F294C3
   propID = 100
   SearchInfo
