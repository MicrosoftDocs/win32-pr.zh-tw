...
---
# <a name="systemitemname"></a>System.servicemodel

[ItemNameDisplay](./props-system-itemnamedisplay.md)屬性的基底名稱。
...
如果專案是檔案，則在所有情況下，這個屬性會包含副檔名，而且如果有當地語系化的名稱可供使用，則會進行當地語系化。 如果專案是訊息，這個屬性的值就不會包含轉送或回復首碼。 如需詳細資訊，請參閱 [ItemNamePrefix](./props-system-itemnameprefix.md) 。
