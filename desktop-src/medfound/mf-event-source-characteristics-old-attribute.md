...
---
# <a name="mf_event_source_characteristics_old-attribute"></a>MF \_ 事件 \_ 來源 \_ 特性 \_ 舊屬性

指定媒體來源的先前特性。 屬性資料是 [**MFMEDIASOURCE \_ 特性**](/windows/desktop/api/mfidl/ne-mfidl-mfmediasource_characteristics)列舉中的位 **或** 旗標。
