...
100 Windows Media 音訊10和 Windows Media 音訊10專業版

100適用于 Windows Vista 版本的 Windows Media 音訊10無損

0適用于 Windows 7 release Windows Media 音訊10無損

## <a name="remarks"></a>備註

如果 [**MFPKEY \_ CONSTRAINECOMPLEXITY**](mfpkey-constrainenccomplexityproperty.md) 屬性的值為 **VARIANT \_ TRUE**，編碼器會根據此屬性的值來調整其演算法的複雜度。

針對 Windows Media 音訊10編碼器和 Windows Media 音訊10專業版編碼器，如果此屬性的值為100，則編碼器會對 CPU 產生高需求，並產生最高品質的輸出。 當此屬性的值減少時，CPU 的需求會減少，但輸出品質也會減少。
...
| 作業系統 | 預設行為                                                                                                                                                                                                |
|------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Windows Vista    | Windows Media 音訊10、Windows Media 音訊10專業版和 Windows Media 音訊10個無失真編碼器預設都會使用最複雜的演算法。                                                    |
| Windows 7        | Windows Media 音訊10和 Windows Media 音訊10專業版編碼器預設會使用最複雜的演算法。 Windows Media 音訊10個無失真編碼器預設會使用最不復雜的演算法。 |
