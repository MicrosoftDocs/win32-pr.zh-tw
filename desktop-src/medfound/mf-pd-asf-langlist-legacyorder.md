...
使用這個屬性的目的，只是為了與 Windows Media 格式 SDK 中 [**IWMReaderAdvanced4**](/previous-versions/windows/desktop/api/wmsdkidl/nn-wmsdkidl-iwmreaderadvanced4) 介面的列舉順序進行回溯相容。 語言字串會以不同的順序儲存在 [**MF \_ PD \_ ASF \_ LANGLIST**](mf-pd-asf-langlist-attribute.md) 屬性中。
