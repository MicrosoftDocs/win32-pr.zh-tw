...
針對 (wmvencod.dll) 與 Windows XP 和 Windows Vista 一起發行的影片編碼器，這個屬性應該設定為1、2或4。 其他值將會四捨五入。

針對 (wmvencod.dll) 與 Windows 7 一起發行的影片編碼器，這個屬性應該設定為1、2、4或8。 其他值將會四捨五入。
