...
---
# <a name="mf_mt_h264_supported_slice_modes-attribute"></a>MF \_ MT \_ H264 支援的配量 \_ \_ \_ 模式屬性

為 h.264 影片資料流程指定支援的配量模式。
...
此屬性適用于透過 USB 傳輸之 h.264 資料流程的媒體類型。 值會對應至 UVC 1.5 h.264 視頻格式描述項中的 **bmSupportedSliceModes** 欄位。
