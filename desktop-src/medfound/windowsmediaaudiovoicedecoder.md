...
title: 'WindowsMedia Audio Voice 解碼 (Wmcodecdsp .h) '
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "118057419"
---
# <a name="windows-media-audio-voice-decoder"></a>WindowsMedia Audio Voice 解碼
...
[WindowsMedia Audio Voice 編碼器](windowsmediaaudiovoiceencoder.md)
</dt> </dl>
