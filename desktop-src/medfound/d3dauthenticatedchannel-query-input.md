...
ms.locfileid: "118974686"
---
# <a name="d3dauthenticatedchannel_query_input-structure"></a>D3DAUTHENTICATEDCHANNEL \_ 查詢 \_ 輸入結構

包含 [**IDirect3DAuthenticatedChannel9：： Query**](/windows/desktop/api/d3d9/nf-d3d9-idirect3dauthenticatedchannel9-query) 方法的輸入資料。
...
查詢序號。 在會話開始時，產生以密碼編譯的安全32位亂數字，作為起始序號使用。 針對每個查詢，將序號遞增1。
