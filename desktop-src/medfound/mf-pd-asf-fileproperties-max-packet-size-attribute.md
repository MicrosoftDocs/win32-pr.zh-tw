...
---
# <a name="mf_pd_asf_fileproperties_max_packet_size-attribute"></a>MF \_ PD \_ ASF \_ FILEPROPERTIES \_ MAX \_ PACKET \_ SIZE 屬性

以位元組為單位，指定 Advanced Systems 格式的最大封包大小 (ASF) 檔。
