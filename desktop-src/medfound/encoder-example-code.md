...
ms.locfileid: "117879432"
---
# <a name="encoder-example-code"></a>編碼器範例程式碼

本主題說明在名為的 c + + 類別中包裝 Windows Media 音訊 (WMA) 編碼器的一些範例程式碼 `CWmaEncoder` 。
...
在媒體基礎中，編碼器會實作為 [媒體基礎轉換](media-foundation-transforms.md) (MFTs) 並公開 [**IMFTransform**](/windows/desktop/api/mftransform/nn-mftransform-imftransform) 介面。
