...
---
# <a name="mfnetsource_udp_port_range-property"></a>MFNETSOURCE \_ UDP \_ 埠 \_ 範圍屬性

網路來源可以用來接收串流內容的有效 UDP 埠範圍。 這個屬性的值是格式為 " *m*–*n* " 的字串，其中 *m* 和 *n* 是埠號碼。
...
常數 **MFNETSOURCE \_ UDP \_ 埠 \_ 範圍** 會定義此屬性索引鍵的 GUID。  (PID) 的屬性識別碼為零。
