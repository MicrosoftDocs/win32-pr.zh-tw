...
---
# <a name="d3dauthenticatedchannel_querychanneltype_output-structure"></a>D3DAUTHENTICATEDCHANNEL \_ QUERYCHANNELTYPE \_ 輸出結構

包含對 [**D3DAUTHENTICATEDQUERY \_ CHANNELTYPE**](d3dauthenticatedquery-channeltype.md) 查詢的回應。
...
指定通道類型的 [**D3DAUTHENTICATEDCHANNELTYPE**](d3dauthenticatedchanneltype.md) 值。
