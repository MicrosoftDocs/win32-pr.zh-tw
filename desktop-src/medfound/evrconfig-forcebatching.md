...
---
# <a name="evrconfig_forcebatching-attribute"></a>EVRConfig \_ ForceBatching 屬性

強制增強的影片轉譯器 (EVR) 對 [**IDirect3D9Device：:P 重發**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-present) 的方法進行批次呼叫。
...
設定這個屬性的效果與在 EVR 上設定 **MFVideoRenderPrefs \_ ForceBatching** 旗標相同。 如需此旗標的說明，請參閱 [**MFVideoRenderPrefs**](/windows/desktop/api/evr/ne-evr-mfvideorenderprefs) 。
