...
ms.locfileid: "119102875"
---
# <a name="mf_pd_audio_encoding_bitrate-attribute"></a>MF \_ PD \_ 音訊 \_ 編碼 \_ 位元速率屬性

指定標記法的音訊編碼位元速率（以每秒位數為單位）。 這個屬性會套用至展示描述項。
...
屬性是選擇性的。 某些格式有更複雜的編碼配置，無法使用這個屬性來匯總。 若為 Advanced Systems Format (ASF) 檔案，下列屬性統稱為編碼位元速率：
