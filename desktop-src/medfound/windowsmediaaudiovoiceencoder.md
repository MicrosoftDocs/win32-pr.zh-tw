...
title: 'WindowsMedia Audio Voice 編碼器 (Wmcodecdsp .h) '
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "119462422"
---
# <a name="windows-media-audio-voice-encoder"></a>WindowsMedia Audio Voice 編碼器
...
WindowsMedia Audio Voice 編碼內容是以格式標記0x00A 來識別。
