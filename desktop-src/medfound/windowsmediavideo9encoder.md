...
---
# <a name="windows-media-video-9-encoder"></a>Windows Media 視訊9編碼器
...
<td>指定在錨點框架的圖片 quantizer 與 B 型框架的圖片 quantizer 之間的差異增加。<br/> <dl> Windows XP （含）以後版本。<br />
...
<td>指定要在一組圖片的開頭使用的編碼模式。<br/> <dl> Windows Vista （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile、Image。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定要用於 Windows Media 視訊 9 Advanced Profile 編解碼器的優化類型。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
寫入。<br />
</dl></td>
</tr>
...
<td>指定用來對動作向量資訊進行編碼的方法。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編解碼器是否會在編碼時使用雜訊篩選器。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>針對以品質為基礎 (1-通過) 可變位速率 (VBR) 編碼方式，指定所需的品質等級。<br/> <dl> Windows Vista （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile、Image。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>為編碼的影片指定中繼框架高度。<br/> <dl> Windows XP （含）以後版本。<br />
Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編碼影片的中繼框架寬度。<br/> <dl> Windows XP （含）以後版本。<br />
Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編解碼器是否應在編碼期間使用中位數篩選。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定是否允許編碼器卸載框架。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile、Image。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定在將目前的框架編碼之前，編解碼器將評估之目前畫面格的框架數目。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編解碼器是否應在編碼期間使用 in 迴圈 deblocking 篩選。<br/> <dl> Windows XP （含）以後版本。<br />
主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編解碼器用來判斷要使用哪一個巨大區塊模式的成本方法。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定要用於動作比對的方法。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定用於移動搜尋作業的影片資訊類型。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定用於移動搜尋的範圍。<br/> <dl> Windows XP （含）以後版本。<br />
主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編解碼器是否應嘗試偵測出雜訊的框架邊緣並將其移除。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定 (B 框架) 的雙向預測框架數目。<br/> <dl> Windows XP （含）以後版本。<br />
主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編解碼器將用於編碼的執行緒數目。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編解碼器在編碼時是否應該使用保守感知優化。<br/> <dl> Windows XP （含）以後版本。<br />
主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編解碼器應減少影片有效色彩範圍的程度。<br/> <dl> Windows XP （含）以後版本。<br />
Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編碼器是否使用以 RD 為基礎的子圖元 MV 搜尋。 <br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile、Image。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>若為區段重新編碼，則指定緩衝區大小。<br/> <dl> Windows Vista （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile、Image。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>若為區段重新編碼，則指定要重新編碼之區段的持續時間。<br/> <dl> Windows Vista （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile、Image。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>針對區段重新編碼，指定開始區段之前的框架 quantizer。<br/> <dl> Windows Vista （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile、Image。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>若為區段重新編碼，則指定起始緩衝區飽和度。<br/> <dl> Windows Vista （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile、Image。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編解碼器是否會使用影片調整優化。<br/> <dl> Windows XP （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>若為區段重新編碼，則指定要重新編碼之檔案的編解碼器私用資料。<br/> <dl> Windows Vista （含）以後版本。<br />
簡單設定檔、主要設定檔、Advanced Profile、Image。<br />
唯寫。<br />
</dl></td>
</tr>
...
<td>指定編解碼器將用來偵測交錯式來源影片的邏輯類型。<br/> <dl> Windows XP （含）以後版本。<br />
Advanced Profile。<br />
唯寫。<br />
</dl></td>
</tr>
