...
ms.locfileid: "118243571"
---
# <a name="mfnetsource_enable_udp-property"></a>MFNETSOURCE \_ 啟用 \_ UDP 屬性

指定是否在網路來源中啟用使用者資料包協定 (UDP) 傳輸。
...
常數 **MFNETSOURCE \_ ENABLE \_ UDP** 會定義此屬性索引鍵的 GUID。  (PID) 的屬性識別碼為零。
