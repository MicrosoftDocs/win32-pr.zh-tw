...
指定如何配置媒體範例的 Microsoft Direct3D 11 表面。 使用方式會直接反映範例是否可透過 CPU 或 GPU 來存取。

## <a name="data-type"></a>資料類型

**D3D11 \_使用** 方式儲存為 **UINT32**

## <a name="remarks"></a>備註

這個屬性的值是 [**D3D11 \_ 使用**](/windows/win32/api/d3d11/ne-d3d11-d3d11_usage) 值。
