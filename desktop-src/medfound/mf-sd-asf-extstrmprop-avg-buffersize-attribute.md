...
ms.locfileid: "119955198"
---
# <a name="mf_sd_asf_extstrmprop_avg_buffersize-attribute"></a>MF \_ SD \_ ASF \_ EXTSTRMPROP \_ AVG \_ BUFFERSIZE 屬性

以位元組為單位，指定 Advanced Systems 格式的資料流程所需的平均緩衝區大小 (ASF) 檔。
...
這個屬性會套用至 ASF 內容的資料流程描述項。 它會對應至擴充資料流程屬性物件中的 [緩衝區大小] 欄位，並定義「有漏洞 bucket」模型中所使用的值區大小。 如需詳細資訊，請參閱 ASF 規格。
