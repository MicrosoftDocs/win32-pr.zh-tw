...
---
# <a name="d3dauthenticatedchannel_queryoutputid_input-structure"></a>D3DAUTHENTICATEDCHANNEL \_ QUERYOUTPUTID \_ 輸入結構

包含 [**D3DAUTHENTICATEDQUERY \_ OUTPUTID**](d3dauthenticatedquery-outputid.md) 查詢的輸入資料。
