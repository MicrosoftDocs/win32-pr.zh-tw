...
title: 'WindowsMedia Video 9 螢幕編碼器 (Wmcodecdsp .h) '
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "119713138"
---
# <a name="windows-media-video-9-screen-encoder"></a>WindowsMedia Video 9 螢幕編碼器
...
第9版螢幕編碼程式支援下列輸入類型，當它用來作為 DirectX 媒體物件 (DMO) 。
...
<td>以位元組為單位，指定用來儲存壓縮內容之容器所需的額外負荷（以位元組為單位）。<br/> <dl> WindowsXP 和更新版本。<br />
唯寫。<br />
</dl></td>
</tr>
<tr class="even">
<td><a href="mfpkey-bavgproperty.md">MFPKEY_BAVG</a></td>
<td>以毫秒為單位，以毫秒為單位，指定限制的變數位速率 (VBR) 資料流程的平均位元速率 (由 <a href="mfpkey-ravgproperty.md">MFPKEY_RAVG</a>) 指定。<br/> <dl> WindowsXP 和更新版本。<br />
讀取/寫入<br />
</dl></td>
</tr>
<tr class="odd">
<td><a href="mfpkey-bmaxproperty.md">MFPKEY_BMAX</a></td>
<td>以毫秒為單位，以毫秒為單位指定受限制的變數位速率 (VBR) 資料流程的尖峰位速率 (由 <a href="mfpkey-rmaxproperty.md">MFPKEY_RMAX</a>) 指定。<br/> <dl> WindowsXP 和更新版本。<br />
讀取/寫入<br />
</dl></td>
</tr>
<tr class="even">
...
<td>WindowsXP 和更新版本。 讀取/寫入<br/> 指定編解碼器將用來編碼內容的傳遞數目。<br/> <dl> WindowsXP 和更新版本。<br />
讀取/寫入<br />
</dl></td>
</tr>
<tr class="odd">
<td><a href="mfpkey-qpperframeproperty.md">MFPKEY_QPPERFRAME</a></td>
<td>指定 QP。 可能的值為1.0 到31.0。<br/> <dl> WindowsVista 和更新版本。<br />
唯寫。<br />
</dl></td>
</tr>
<tr class="even">
...
<td>指定尖峰位速率（以每秒位數為單位），用於受條件約束的2傳遞變數位速率 (VBR) 編碼。<br/> <dl> WindowsXP 和更新版本。<br />
讀取/寫入<br />
</dl></td>
</tr>
<tr class="even">
...
<td>可符合模型緩衝區的內容數量（以毫秒為單位）。<br/> <dl> WindowsXP 和更新版本，<br />
唯寫。<br />
</dl></td>
</tr>
<tr class="even">
...
螢幕編碼器物件會公開 **IMediaObject** 介面，讓物件可以作為 DirectX 媒體物件 (DMO) ，並公開 **IMFTransform** 介面，以便將物件當做媒體基礎轉換 (MFT) 使用。

螢幕編碼器會根據您取得的介面以及正在執行的 Windows 版本，以 DMO 或 MFT 的形式運作。 下表顯示幕幕編碼器作為 DMO 或 MFT 運作的條件。



| 作業系統            | 編碼器行為                                                                                                                                    |
|-----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| Windows XP                  | Windows 媒體畫面編碼器一律會以 DMO 的方式運作。                                                                                             |
| WindowsVista 和 Windows 7 | Windows 媒體螢幕編碼器預設會以 DMO 的方式運作。 如果您在螢幕編碼器上取得 **IMFTransform** 介面，它會以 MFT 的形式運作。 |
...
[WindowsMedia Video 9 螢幕解碼](windowsmediavideo9screendecoder.md)
</dt> </dl>
