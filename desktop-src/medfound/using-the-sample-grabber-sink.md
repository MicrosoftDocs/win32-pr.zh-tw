...
ms.locfileid: "117871274"
---
# <a name="using-the-sample-grabber-sink"></a>使用範例捕獲接收器

範例抓取接收器是一個媒體接收，可將接收的資料轉送至應用程式回呼介面。

> [!Note]  
> [來源讀取器](source-reader.md)是範例抓取器接收的替代方案，而且具有更簡單的 progamming 模型。

 

## <a name="1-implement-the-callback-interface"></a>1. 執行回呼介面
...
## <a name="2-create-the-sample-grabber-sink"></a>2. 建立範例捕獲接收器
...
## <a name="3-create-a-topology"></a>3. 建立拓撲
...
## <a name="4-run-the-media-session"></a>4. 執行媒體會話
