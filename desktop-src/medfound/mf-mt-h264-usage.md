...
---
# <a name="mf_mt_h264_usage-attribute"></a>MF \_ MT \_ H264 \_ 使用方式屬性

指定 UVC h.264 編碼器的使用模式。
...
此屬性適用于透過 USB 傳輸之 h.264 資料流程的媒體類型。 值會對應至 UVC 1.2 h.264 探查/commit 控制項中的 **bUsage** 欄位。
