...
ms.locfileid: "119035156"
---
# <a name="mf_mt_h264_svc_capabilities-attribute"></a>MF \_ MT \_ H264 \_ SVC \_ 功能屬性

指定 h.264 影片資料流程的 SVC 功能。
...
此屬性適用于透過 USB 傳輸之 h.264 資料流程的媒體類型。 值會對應至 UVC 1.5 h.264 影片框架描述項中的 **bmSVCCapabilities** 欄位。
