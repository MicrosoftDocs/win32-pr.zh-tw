...
ms.locfileid: "119663868"
---
# <a name="mf_toponode_mediastop-attribute"></a>MF \_ TOPONODE \_ MEDIASTOP 屬性
...
這個屬性會在來源中指定播放停止的位置，相對於開始來源，則會以 100-毫微秒的單位來指定。 如果未設定屬性，則會在來源的結尾處停止播放。 例如，若要在5秒的標記停止播放，請將此屬性設定為50000000。 在拓撲 (節點（類型等於 **MF \_ 拓撲 \_ SOURCESTREAM \_ 節點**) ）的來源節點上設定屬性。 呼叫 [**IMFMediaSession：： SetTopology**](/windows/desktop/api/mfidl/nf-mfidl-imfmediasession-settopology)之前，請先設定屬性。
