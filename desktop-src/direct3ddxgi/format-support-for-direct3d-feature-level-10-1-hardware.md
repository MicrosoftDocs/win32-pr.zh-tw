---
description: 此區段會指定 Direct3D 功能等級10.1 硬體支援的格式 ([ **DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format)值) 。
...
ms.locfileid: "118289415"
---
# <a name="format-support-for-direct3d-feature-level-101-hardware"></a>Direct3D 功能層級 10.1 硬體的格式支援

此區段會指定 Direct3D 功能等級10.1 硬體支援的格式 ([ **DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format)值) 。
