---
description: 此區段會指定 Direct3D 功能等級12.0 硬體支援的格式 ([ **DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format)值) 。
...
ms.locfileid: "119745618"
---
# <a name="format-support-for-direct3d-feature-level-120-hardware"></a>Direct3D 功能層級 12.0 硬體的格式支援

此區段會指定 Direct3D 功能等級12.0 硬體支援的格式 ([ **DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format)值) 。
...
## <a name="dxgi_format_r32g8x24_typeless-19"></a>DXGI_FORMAT_R32G8X24 不 \_ (19) 
| 目標 | 支援 |
| - | - |
| 每個元素的位數 (BPE)  | 64 |
| 格式支援 | ![必要](images/letter-r.jpg) |
...
## <a name="dxgi_format_r32_float_x8x24_typeless-21"></a>DXGI_FORMAT_R32 \_ FLOAT X8X24 無型別 \_ \_ (21) 
| 目標 | 支援 |
| - | - |
| 每個元素的位數 (BPE)  | 64 |
| 格式支援 | ![必要](images/letter-r.jpg) |
...
## <a name="dxgi_format_x32_typeless_g8x24_uint-22"></a>DXGI_FORMAT_X32 無別 \_ \_ G8X24 \_ UINT (22) 
| 目標 | 支援 |
| - | - |
| 每個元素的位數 (BPE)  | 64 |
| 格式支援 | ![必要](images/letter-r.jpg) |
...
## <a name="dxgi_format_r24g8_typeless-44"></a>DXGI_FORMAT_R24G8 不 \_ (44) 
| 目標 | 支援 |
| - | - |
| 每個元素的位數 (BPE)  | 32 |
| 格式支援 | ![必要](images/letter-r.jpg) |
...
## <a name="dxgi_format_r24_unorm_x8_typeless-46"></a>DXGI_FORMAT_R24 \_ UNORM \_ X8 無別 \_ (46) 
| 目標 | 支援 |
| - | - |
| 每個元素的位數 (BPE)  | 32 |
| 格式支援 | ![必要](images/letter-r.jpg) |
...
## <a name="dxgi_format_x24_typeless_g8_uint-47"></a>DXGI_FORMAT_X24 無別 \_ \_ G8 \_ UINT (47) 
| 目標 | 支援 |
| - | - |
| 每個元素的位數 (BPE)  | 32 |
| 格式支援 | ![必要](images/letter-r.jpg) |
