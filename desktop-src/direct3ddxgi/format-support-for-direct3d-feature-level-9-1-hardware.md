...
---
# <a name="format-support-for-direct3d-feature-10level9-91-hardware"></a>Direct3D 功能 10Level9 9.1 硬體的格式支援

本節指定 Direct3D Feature 10Level9 9.1 硬體支援的格式 ([ _* DXGI_FORMAT_* * _](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format)值) 。
