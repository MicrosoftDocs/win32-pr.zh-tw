...
ms.locfileid: "106979969"
---
# <a name="svcconfigcpp"></a><span data-ttu-id="1dceb-103">SvcConfig.cpp</span><span class="sxs-lookup"><span data-stu-id="1dceb-103">SvcConfig.cpp</span></span>

<span data-ttu-id="1dceb-104">以下是範例服務設定 [程式](service-configuration-programs.md)。</span><span class="sxs-lookup"><span data-stu-id="1dceb-104">The following is a sample [service configuration program](service-configuration-programs.md).</span></span>

<span data-ttu-id="1dceb-105">建立範例時，請務必連結 Kernel32.dll .lib 和 Advapi32.dll。</span><span class="sxs-lookup"><span data-stu-id="1dceb-105">When building the sample, be sure to link with Kernel32.lib and Advapi32.lib.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="1dceb-106">相關主題</span><span class="sxs-lookup"><span data-stu-id="1dceb-106">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="1dceb-107">完整的服務範例</span><span class="sxs-lookup"><span data-stu-id="1dceb-107">The Complete Service Sample</span></span>](the-complete-service-sample.md)
</dt> </dl>
