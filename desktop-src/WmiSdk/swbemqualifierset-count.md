---
description: SWbemQualifierSet 物件的 Count 屬性包含 SWbemQualifierSet 集合中的專案數。 這是唯讀的屬性。
ms.assetid: a381916a-a1e2-4b9a-8162-777a04824291
ms.tgt_platform: multiple
title: 'SWbemQualifierSet： Count 屬性 (>wbemdisp.tlb .h) '
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118991798"
---
# <a name="swbemqualifiersetcount-property"></a>SWbemQualifierSet Count 屬性

[**SWbemQualifierSet**](swbemqualifierset.md)物件的 **Count** 屬性包含 **SWbemQualifierSet** 集合中的專案數。 這是唯讀的屬性。
