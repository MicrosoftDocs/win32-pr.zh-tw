---
description: COOKER \_ 範圍計數器類型公式會顯示 Win32 PerfRawData 實例中，屬性的一組原始觀察值之間的最小值和最大值之間的差異 \_ 。
...
ms.locfileid: "106987261"
---
# <a name="cooker_range"></a>COOKER \_ 範圍

COOKER \_ 範圍計數器類型公式會顯示 [**Win32 \_ PerfRawData**](/windows/desktop/CIMWin32Prov/win32-perfrawdata)實例中，屬性的一組原始觀察值之間的 [最小](cooker-min.md)值和 [最大](cooker-max.md)值之間的差異。 此計數器類型只會在 WMI 內定義，而不能用於效能監視技術，例如 [效能計數器6.0 版](/windows/desktop/PerfCtrs/performance-counters-portal)。
