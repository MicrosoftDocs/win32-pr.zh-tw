...
---
# <a name="swbemprivilegeisenabled-property"></a>SWbemPrivilege. IsEnabled 屬性

[**SWbemPrivilege**](swbemprivilege.md)物件的 **IsEnabled** 屬性是用來啟用或停用此許可權的布林值。 如需啟用特定許可權之結果的詳細資訊，請參閱 [**以特殊許可權**](swbemsecurity-privileges.md)執行。
