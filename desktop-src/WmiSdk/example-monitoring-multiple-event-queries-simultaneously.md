...
---
# <a name="example-monitoring-multiple-event-queries-simultaneously"></a>範例：同時監視多個事件查詢

下列腳本範例顯示非同步事件通知，利用 [**SWbemServices.Exe的 cNotificationQueryAsync**](swbemservices-execnotificationqueryasync.md) 方法和 [**SWbemSink**](swbemsink.md) 物件。
