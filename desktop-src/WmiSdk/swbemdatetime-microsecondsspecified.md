...
ms.locfileid: "118816376"
---
# <a name="swbemdatetimemicrosecondsspecified-property"></a>SWbemDateTime. MicrosecondsSpecified 屬性

[**SWbemDateTime**](swbemdatetime.md)物件的 **MicrosecondsSpecified** 屬性是一個布林值，指出 CIM datetime 值中的微秒元件是否包含間隔或萬用字元值。 如果 **MicrosecondsSpecified** 為 **TRUE** 且 [**IsInterval**](swbemdatetime-isinterval.md) 為 **FALSE**，則 [**SWbemDateTime**](swbemdatetime-microseconds.md) 會包含日期時間值。 包含間隔的日期時間值不能轉換成 **VT \_ 日期** 格式或 **FILETIME** 格式。 如果 [**HoursSpecified**](swbemdatetime-hoursspecified.md) 為 **FALSE** 且 **IsInterval** 為 **TRUE**，則 **SWbemDateTime** 會包含間隔。
...
[**SWbemDateTime 微秒**](swbemdatetime-microseconds.md)
</dt> <dt>
