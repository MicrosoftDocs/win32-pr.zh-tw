...
---
# <a name="wmi-tasks-processes"></a>WMI 工作：處理序

進程的 WMI 工作會取得資訊，例如執行進程的帳戶。 您可以執行動作，例如建立進程。 如需其他範例，請參閱 TechNet ScriptCenter，網址為 [https://www.microsoft.com/technet](https://technet.microsoft.com/default.aspx) 。
...
<tr class="odd">
<td>...在隱藏視窗中執行應用程式？</td>
<td>從使用 <a href="/windows/desktop/CIMWin32Prov/win32-process"><strong>Win32_Process</strong></a> 和 <a href="/windows/desktop/CIMWin32Prov/win32-processstartup"><strong>Win32_ProcessStartup</strong></a> 類別的腳本呼叫應用程式。<br/> <span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
<col style="width: 100%" />
</colgroup>
...
<tr class="even">
<td>...判斷哪些腳本正在本機電腦上執行？</td>
<td><p>使用 <a href="/windows/desktop/CIMWin32Prov/win32-process"><strong>Win32_Process</strong></a> 類別，並傳回名稱為 Cscript.exe 或 Wscript.exe 的所有進程。 若要判斷在這些進程中執行的個別腳本，請檢查 [ <strong>命令列</strong> ] 屬性的值。</p>
<div class="code">
...
<tr class="odd">
<td>...找出正在執行進程的帳戶名稱嗎？</td>
<td><p>使用 <a href="/windows/desktop/CIMWin32Prov/win32-process"><strong>Win32_Process</strong></a> 類別和 <a href="/windows/desktop/CIMWin32Prov/getowner-method-in-class-win32-process"><strong>GetOwner</strong></a> 方法。</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>...變更正在執行之進程的優先順序？</td>
<td><p>使用 <a href="/windows/desktop/CIMWin32Prov/win32-process"><strong>Win32_Process</strong></a> 類別和 <a href="/windows/desktop/CIMWin32Prov/setpriority-method-in-class-win32-process"><strong>SetPriority</strong></a> 方法。</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>...使用腳本終止進程？</td>
<td><p>使用 <a href="/windows/desktop/CIMWin32Prov/win32-process"><strong>Win32_Process</strong></a> 類別和 <a href="/windows/desktop/CIMWin32Prov/terminate-method-in-class-win32-process"><strong>Terminate</strong></a> 方法。</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>...判斷每個進程使用的處理器時間和記憶體數量為何？</td>
<td><p>使用 <a href="/windows/desktop/CIMWin32Prov/win32-process"><strong>Win32_Process</strong></a> 類別和屬性，例如 <strong>KernelModeTime</strong>、 <strong>WorkingSetSize</strong>、 <strong>PageFileUsage</strong>和 <strong>PageFaults</strong>。</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>...告訴哪些應用程式正在遠端電腦上執行？</td>
<td><p>使用 <a href="/windows/desktop/CIMWin32Prov/win32-process"><strong>Win32_Process</strong></a> 類別。</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
