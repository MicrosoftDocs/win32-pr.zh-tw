...
ms.locfileid: "119856988"
---
# <a name="swbemprivilegeidentifier-property"></a>SWbemPrivilege 識別碼屬性

[**SWbemPrivilege**](swbemprivilege.md)物件的 **識別碼** 屬性是 [WbemPrivilegeEnum](/windows/desktop/api/Wbemdisp/ne-wbemdisp-wbemprivilegeenum)整數，表示正在設定或抓取的許可權。 這是唯讀的屬性。
