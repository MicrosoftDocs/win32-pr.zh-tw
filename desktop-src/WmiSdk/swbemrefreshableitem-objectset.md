...
**SWbemRefreshableItem. ObjectSet** 屬性代表要重新整理的物件集。 **ObjectSet** 屬性是包含在 [**SWbemRefresher**](swbemrefresher.md)物件中的列舉值或收集項。
...
除非 [**SWbemRefreshableItem**](swbemrefreshableitem-isset.md)為 **TRUE**，否則此屬性為 **Null** 。
