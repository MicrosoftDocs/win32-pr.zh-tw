...
ms.locfileid: "119568878"
---
# <a name="__classdeletionevent-class"></a>\_\_ClassDeletionEvent 類別

**\_ \_ ClassDeletionEvent** 系統類別代表類別刪除事件，這是從命名空間移除類別時所產生的內建 [事件](determining-the-type-of-event-to-receive.md)類型。
...
**\_ \_ ClassDeletionEvent** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**\_ \_ ClassDeletionEvent** 類別具有這些屬性。
...
類別刪除事件所報告之新刪除類別的複本。 這個屬性繼承自 [**\_ \_ ClassOperationEvent**](--classoperationevent.md)。
...
**\_ \_ ClassDeletionEvent** 類別衍生自 [**\_ \_ ClassOperationEvent**](--classoperationevent.md)。
