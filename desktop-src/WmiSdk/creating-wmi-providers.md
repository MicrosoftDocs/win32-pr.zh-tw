...
> [!Note]  
> 您也可以使用 Windows 管理基礎結構 (MI) （新一代的 WMI 版本）來建立提供者。 如需詳細資訊，請參閱 [如何執行 MI 提供者](/previous-versions/windows/desktop/wmi_v2/how-to-implement-an-mi-provider)。
