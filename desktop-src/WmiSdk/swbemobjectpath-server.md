---
description: SWbemObjectPath 物件的 Server 屬性包含屬於物件路徑的伺服器名稱。
ms.assetid: 8d711bc5-dd5e-426f-8398-38f90655ff75
ms.tgt_platform: multiple
title: SWbemObjectPath， (>wbemdisp.tlb) 的伺服器屬性
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "106983905"
---
# <a name="swbemobjectpathserver-property"></a>SWbemObjectPath。伺服器屬性

[**SWbemObjectPath**](swbemobjectpath.md)物件的 **server** 屬性包含屬於物件路徑的伺服器名稱。
