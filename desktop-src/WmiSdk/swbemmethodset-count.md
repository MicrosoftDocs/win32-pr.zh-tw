---
description: SWbemMethodSet 物件的 Count 屬性會定義集合中的專案數。 這是唯讀的屬性。
ms.assetid: 492dabef-f417-4b1e-bc3a-8d39d8f7ee35
ms.tgt_platform: multiple
title: 'SWbemMethodSet： Count 屬性 (>wbemdisp.tlb .h) '
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119732678"
---
# <a name="swbemmethodsetcount-property"></a>SWbemMethodSet Count 屬性

[**SWbemMethodSet**](swbemmethodset.md)物件的 **Count** 屬性會定義集合中的專案數。 這是唯讀的屬性。
