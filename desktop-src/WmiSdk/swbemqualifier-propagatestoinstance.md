---
description: SWbemQualifier 物件的 PropagatesToInstance 屬性是布林值，指出此限定詞是否可以傳播至實例。
ms.assetid: 5cab3498-f7ba-4d82-9f07-90a87e15f270
ms.tgt_platform: multiple
title: 'SWbemQualifier. PropagatesToInstance 屬性 (>wbemdisp.tlb .h) '
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "104192055"
---
# <a name="swbemqualifierpropagatestoinstance-property"></a>SWbemQualifier. PropagatesToInstance 屬性

[**SWbemQualifier**](swbemqualifier.md)物件的 **PropagatesToInstance** 屬性是布林值，指出此限定詞是否可以傳播至實例。
