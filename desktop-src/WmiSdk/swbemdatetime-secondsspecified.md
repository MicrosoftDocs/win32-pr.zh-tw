...
---
# <a name="swbemdatetimesecondsspecified-property"></a>SWbemDateTime. SecondsSpecified 屬性

[**SWbemDateTime**](swbemdatetime.md)物件的 **SecondsSpecified** 屬性是一個布林值，指出 CIM [**DATETIME**](datetime.md)值中的秒陣列件是否包含間隔或萬用字元值。 如果 **SecondsSpecified** 為 **TRUE** 且 [**IsInterval**](swbemdatetime-isinterval.md) 為 **FALSE**，則 [**SWbemDateTime**](swbemdatetime-seconds.md) 會包含日期值。 包含間隔的日期時間值不能轉換成 **VT \_ 日期** 格式或 **FILETIME** 格式。 如果 **SecondsSpecified** 為 **FALSE** 且 **IsInterval** 為 **TRUE**，則 **SWbemDateTime** 會包含間隔。
...
[**SWbemDateTime。秒數**](swbemdatetime-seconds.md)
</dt> <dt>
