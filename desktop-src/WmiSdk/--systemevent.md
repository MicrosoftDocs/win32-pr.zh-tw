...
---
# <a name="__systemevent-class"></a>\_\_SystemEvent 類別

**\_ \_ SystemEvent** 系統類別代表系統事件。
...
**\_ \_ SystemEvent** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**\_ \_ SystemEvent** 類別具有這些屬性。
...
**\_ \_ SystemEvent** 類別衍生自 [**\_ \_ ExtrinsicEvent**](--extrinsicevent.md)類別。
