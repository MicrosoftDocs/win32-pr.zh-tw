...
---
# <a name="swbemobjectpathauthority-property"></a>SWbemObjectPath 授權屬性

[**SWbemObjectPath**](swbemobjectpath.md)物件的 [**授權**] 屬性包含一個字串，該字串會定義物件路徑的授權單位部分。 如需詳細資訊，請參閱 [**wbemscripting.swbemlocator. ConnectServer**](swbemlocator-connectserver.md)方法的 *strAuthority* 參數，以及 [設定 IWbemServices 和其他 proxy 的安全性](setting-the-security-on-iwbemservices-and-other-proxies.md)。
