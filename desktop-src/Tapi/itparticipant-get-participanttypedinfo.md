...
ms.locfileid: "119867148"
---
# <a name="itparticipantget_participanttypedinfo-method"></a>ITParticipant：： get \_ ParticipantTypedInfo 方法

\[**取得 \_ParticipantTypedInfo** 無法在 Windows Vista、Windows Server 2008 及後續版本的作業系統中使用。 RTC 用戶端 API 提供類似的功能。\]
...
| <dl> <dt>**E \_ 失敗**</dt> </dl>         | 儲存體的資訊 *ppInfo* 失敗。<br/>         |
