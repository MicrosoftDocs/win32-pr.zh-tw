...
---
# <a name="whats-new-for-tspi-version-30"></a>TSPI 3.0 版的新功能

TSPI 3.0 新增了函數和訊息，以支援與 [媒體服務提供者 (MSP) ](./about-the-media-service-provider-msp-.md)的通訊。 此外，也已新增函式，使用「呼叫中樞」概念增強追蹤會議的便利性。

針對 TSPI 3.0 版新增或變更的函式和訊息如下所示：
...
-   **LINEADDRCAPFLAGS_NOPSTNADDRESSTRANSLATION** 旗標
-   **LINEERR_INVALADDRESSTYPE** 旗標
