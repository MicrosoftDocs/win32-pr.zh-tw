...
---
# <a name="itconnectionget_numaddresses-method"></a>ITConnection：： get \_ NumAddresses 方法

\[ 在 Windows Vista、Windows Server 2008 和後續版本的作業系統中，無法使用會合 IP 電話語音會議控制項和介面。 RTC 用戶端 API 提供類似的功能。\]

**Get \_ NumAddresses** 方法會取得要用於會話的位址數目。
...
| <dl> <dt>**E \_ 指標**</dt> </dl>     | *PNumAddresse* s 參數不是有效的指標。<br/> |
