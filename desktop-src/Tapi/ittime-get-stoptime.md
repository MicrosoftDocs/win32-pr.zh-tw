...
---
# <a name="ittimeget_stoptime-method"></a>ITTime：： get \_ StopTime 方法

\[ 在 Windows Vista、Windows Server 2008 和後續版本的作業系統中，無法使用會合 IP 電話語音會議控制項和介面。 RTC 用戶端 API 提供類似的功能。\]

**Get \_ StopTime** 方法會取得 NTP (網路時間通訊協定) 結束時間值。 如果結束時間為零，則不會限制會話。
...
[**ITTime：:p 的 \_ StopTime**](ittime-put-stoptime.md)
</dt> </dl>
