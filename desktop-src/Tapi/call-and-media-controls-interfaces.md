...
---
# <a name="call-and-media-controls-interfaces"></a>呼叫和媒體控制項介面

以下是 TAPI 3.x 呼叫和媒體控制介面。 如需這些介面的功能清單，請參閱 [呼叫和媒體控制項快速參考](call-and-media-controls-quick-reference.md)。
...
如果 MSP 與呼叫相關聯，則可以使用下列介面。 MSP 介面可控制媒體串流和通話的終端機。
