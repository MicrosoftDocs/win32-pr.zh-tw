...
---
# <a name="unregister-a-pluggable-terminal"></a><span data-ttu-id="0fdcf-104">取消註冊可插入的終端機</span><span class="sxs-lookup"><span data-stu-id="0fdcf-104">Unregister a Pluggable Terminal</span></span>

<span data-ttu-id="0fdcf-105">一般來說，這個方法會從 **DllUnregisterServer** 呼叫。</span><span class="sxs-lookup"><span data-stu-id="0fdcf-105">In general, this method will be called from **DllUnregisterServer**.</span></span> <span data-ttu-id="0fdcf-106">下列範例程式碼可以放入 **DllUnregisterServer** 的程式碼中。</span><span class="sxs-lookup"><span data-stu-id="0fdcf-106">The following sample code can be put into the code for **DllUnregisterServer**.</span></span>
