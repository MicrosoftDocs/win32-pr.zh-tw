...
---
# <a name="sample-time-provider"></a><span data-ttu-id="4f0e3-104">範例時間提供者</span><span class="sxs-lookup"><span data-stu-id="4f0e3-104">Sample Time Provider</span></span>

<span data-ttu-id="4f0e3-105">下列範例示範如何建立時間提供者的結構。</span><span class="sxs-lookup"><span data-stu-id="4f0e3-105">The following example demonstrates how to structure a time provider.</span></span> <span data-ttu-id="4f0e3-106">在此範例中，DLL 支援兩個硬體時間提供者。</span><span class="sxs-lookup"><span data-stu-id="4f0e3-106">In this example, the DLL supports two hardware time providers.</span></span>
