---
description: 下列範例會使用 GetComputerName、GetUserName、GetSystemDirectory、GetWindowsDirectory 和 ExpandEnvironmentStrings 函數來取得描述系統組態的資訊。
