...
---
# <a name="using-the-waas-assessment-platform"></a><span data-ttu-id="efa60-103">使用 WaaS 評定平臺</span><span class="sxs-lookup"><span data-stu-id="efa60-103">Using the WaaS Assessment Platform</span></span>

<span data-ttu-id="efa60-104">若要使用 WaaS 評定平臺 API，請建立 [**IWaaSAssessor**](/windows/desktop/api/waasapi/nn-waasapi-iwaasassessor) 介面的實例，然後呼叫 [**GetOSUpdateAssessment**](/windows/desktop/api/waasapi/nf-waasapi-iwaasassessor-getosupdateassessment) 方法。</span><span class="sxs-lookup"><span data-stu-id="efa60-104">To use the WaaS Assessment Platform API, create an instance of the [**IWaaSAssessor**](/windows/desktop/api/waasapi/nn-waasapi-iwaasassessor) interface, and then call the [**GetOSUpdateAssessment**](/windows/desktop/api/waasapi/nf-waasapi-iwaasassessor-getosupdateassessment) method.</span></span> <span data-ttu-id="efa60-105">成功時， *結果* 參數會輸出 [**OSUpdateAssessment**](/windows/win32/api/waasapitypes/ns-waasapitypes-osupdateassessment) 物件，其中將包含相關資訊。</span><span class="sxs-lookup"><span data-stu-id="efa60-105">On a success, the *result* parameter will output an [**OSUpdateAssessment**](/windows/win32/api/waasapitypes/ns-waasapitypes-osupdateassessment) object, which will contain the relevant information.</span></span>

<span data-ttu-id="efa60-106">下列程式碼範例示範如何使用 IWaaSAssessor GetOSUpdateAssessment 方法，從您的本機系統取得作業系統評量。</span><span class="sxs-lookup"><span data-stu-id="efa60-106">The following code sample shows how to retrieve an OS assessment from your local system, using the IWaaSAssessor.GetOSUpdateAssessment method.</span></span>
