...
---
# <a name="creating-a-local-group-and-adding-a-user"></a>建立本機群組並新增使用者

若要建立新的本機群組，請呼叫 [**NetLocalGroupAdd**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupadd) 函數。 若要將使用者加入至該群組，請呼叫 [**NetLocalGroupAddMembers**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupaddmembers) 函數。

下列程式可讓您建立使用者和本機群組，然後將使用者新增至本機群組。
