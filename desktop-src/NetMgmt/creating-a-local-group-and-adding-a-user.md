---
title: 建立本機群組並新增使用者
description: 若要建立新的本機群組，請呼叫 NetLocalGroupAdd 函數。 若要將使用者加入至該群組，請呼叫 NetLocalGroupAddMembers 函數。
...
ms.locfileid: "103932245"
---
# <a name="creating-a-local-group-and-adding-a-user"></a><span data-ttu-id="6bf53-104">建立本機群組並新增使用者</span><span class="sxs-lookup"><span data-stu-id="6bf53-104">Creating a Local Group and Adding a User</span></span>

<span data-ttu-id="6bf53-105">若要建立新的本機群組，請呼叫 [**NetLocalGroupAdd**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupadd) 函數。</span><span class="sxs-lookup"><span data-stu-id="6bf53-105">To create a new local group, call the [**NetLocalGroupAdd**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupadd) function.</span></span> <span data-ttu-id="6bf53-106">若要將使用者加入至該群組，請呼叫 [**NetLocalGroupAddMembers**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupaddmembers) 函數。</span><span class="sxs-lookup"><span data-stu-id="6bf53-106">To add a user to that group, call the [**NetLocalGroupAddMembers**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupaddmembers) function.</span></span>

<span data-ttu-id="6bf53-107">下列程式可讓您建立使用者和本機群組，然後將使用者新增至本機群組。</span><span class="sxs-lookup"><span data-stu-id="6bf53-107">The following program allows you to create a user and a local group and add the user to the local group.</span></span>
