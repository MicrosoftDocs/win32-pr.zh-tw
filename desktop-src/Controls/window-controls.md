...
控制項是設計來供 C/c + + 開發人員和 UI 設計人員使用。 一般來說，開發人員需要對 UI 程式設計概念、Windows API 程式設計和 Unicode 進行中等程度的瞭解。
...
| [控制訊息](control-messages.md)<br/>                               | 說明如何使用 Windows 訊息與控制項進行通訊。<br/>                                                                 |
...
| [主題檔案格式](themesfileformat-overview.md)<br/>                     | 討論主題 ( 的格式) Windows 7 和 Windows Vista 中使用的檔案。<br/>                                                    |
