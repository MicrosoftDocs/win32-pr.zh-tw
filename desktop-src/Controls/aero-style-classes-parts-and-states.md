...
本主題說明 Aero 主題所支援的類別、元件和狀態，這定義了 Microsoft Vista 預設使用的視覺化樣式。
...
|                | BP \_ 按鍵              |                                                                                            |
|                | BP \_ 選項按鈕             |                                                                                            |
| Comboboxstyle.dropdownlist  | CP \_ DROPDOWNBUTTON          |                                                                                            |
|                | CP \_ DROPDOWNBUTTONLEFT      |                                                                                            |
|                | CP \_ DROPDOWNBUTTONRIGHT     |                                                                                            |
|                | CP \_ READONLY                |                                                                                            |
| 通訊 | CSST 索引標籤 \_                   | CSTB 經常性 \_ 、CSTB \_ NORMAL、CSTB 已 \_ 選取                                                    |
...
| System.windows.dragdrop.drop>       | DD \_ 複製                    |                                                                                            |
|                | DD \_ CREATELINK              |                                                                                            |
|                | DD \_ 移動                    |                                                                                            |
|                | DD \_ 無                    |                                                                                            |
|                | DD \_ UPDATEMETADATA          |                                                                                            |
...
| Flyout         | 飛出視窗 \_ 主體                | FBS \_ 強調，FBS \_ NORMAL                                                               |
|                | 飛出視窗 \_ 標題              |                                                                                            |
...
|                | 飛出 \_ 視窗視窗              |                                                                                            |
| 標頭         | HP \_ HEADERDROPDOWN          |                                                                                            |
|                | HP \_ HEADERDROPDOWNFILTER    |                                                                                            |
|                | HP \_ HEADERITEM              |                                                                                            |
| ListView       | LVP \_ GROUPHEADER            |                                                                                            |
| 功能表           | 功能表 \_ BARBACKGROUND         |                                                                                            |
|                | 功能表 \_ POPUPBACKGROUND       |                                                                                            |
|                | 功能表 \_ POPUPGUTTER           |                                                                                            |
| 進度       | PP \_ 填滿                    | PBFS \_ 錯誤，PBFS \_ 部分，PBFS 已 \_ 暫停                                                   |
...
| Text           | 文字 \_ BODYTITLE             |                                                                                            |
|                | 文字 \_ BODYTEXT              |                                                                                            |
|                | 文字 \_ CONTROLLABEL          | TS \_ CONTROLLABEL \_ 已停用                                                                 |
|                | 文字已 \_ 展開              |                                                                                            |
