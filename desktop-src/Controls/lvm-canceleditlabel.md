...
keywords:
- LVM_CANCELEDITLABEL 訊息 Windows 控制項
topic_type:
- apiref
api_name:
- LVM_CANCELEDITLABEL
...
ms.locfileid: "119698798"
---
# <a name="lvm_canceleditlabel-message"></a>LVM \_ CANCELEDITLABEL 訊息
...
這則訊息會導致傳送 [LVN \_ ENDLABELEDIT](lvn-endlabeledit.md) 通知。
