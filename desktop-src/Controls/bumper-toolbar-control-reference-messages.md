...
-   [**TB \_ GETDISABLEDIMAGELIST**](tb-getdisabledimagelist.md)
...
-   [**TB \_ SYSTEM.WINDOWS.MEDIA.VISUALTREEHELPER.HITTEST**](tb-hittest.md)
-   [**TB \_ 不定**](tb-indeterminate.md)
...
-   [**TB \_ ISBUTTONENABLED**](tb-isbuttonenabled.md)
-   [**TB \_ ISBUTTONHIDDEN**](tb-isbuttonhidden.md)
-   [**TB \_ ISBUTTONHIGHLIGHTED**](tb-isbuttonhighlighted.md)
-   [**TB \_ ISBUTTONINDETERMINATE**](tb-isbuttonindeterminate.md)
-   [**TB \_ ISBUTTONPRESSED**](tb-isbuttonpressed.md)
-   [**TB \_ LOADIMAGES**](tb-loadimages.md)
-   [**TB \_ MAPACCELERATOR**](tb-mapaccelerator.md)
-   [**TB \_ MARKBUTTON**](tb-markbutton.md)
-   [**TB \_ MOVEBUTTON**](tb-movebutton.md)
-   [**TB \_ PRESSBUTTON**](tb-pressbutton.md)
-   [**TB \_ REPLACEBITMAP**](tb-replacebitmap.md)
-   [**TB \_ SAVERESTORE**](tb-saverestore.md)
-   [**TB \_ SETANCHORHIGHLIGHT**](tb-setanchorhighlight.md)
-   [**TB \_ SETBITMAPSIZE**](tb-setbitmapsize.md)
-   [**TB \_ SETBOUNDINGSIZE**](tb-setboundingsize.md)
-   [**TB \_ SETBUTTONINFO**](tb-setbuttoninfo.md)
-   [**TB \_ SETBUTTONSIZE**](tb-setbuttonsize.md)
-   [**TB \_ SETBUTTONWIDTH**](tb-setbuttonwidth.md)
-   [**TB \_ SETCMDID**](tb-setcmdid.md)
-   [**TB \_ SETCOLORSCHEME**](tb-setcolorscheme.md)
-   [**TB \_ SETDISABLEDIMAGELIST**](tb-setdisabledimagelist.md)
-   [**TB \_ SETDRAWTEXTFLAGS**](tb-setdrawtextflags.md)
