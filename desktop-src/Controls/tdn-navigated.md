...
ms.locfileid: "118166891"
---
# <a name="tdn_navigated-notification-code"></a>TDN \_ 流覽的通知碼

在流覽發生時由工作對話方塊傳送。 此通知碼只會透過工作對話方塊回呼函式接收，此函式可以使用 [**TaskDialogIndirect**](/windows/desktop/api/Commctrl/nf-commctrl-taskdialogindirect) 方法來註冊。
