...
---
# <a name="how-to-create-vertical-toolbars"></a>如何建立垂直工具列

建立垂直工具列的關鍵是在視窗樣式中 [**包含 \_ 垂直 CCS**](common-control-styles.md) ，以及為每個按鈕設定 [**TBSTATE \_ 換行**](toolbar-button-states.md) 樣式。
...
### <a name="create-a-vertical-toolbar"></a>建立垂直工具列

下列範例程式碼會建立如下圖所示的垂直工具列。
