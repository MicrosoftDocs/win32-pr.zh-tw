...
ms.locfileid: "103853868"
---
# <a name="header-control-notifications"></a>標題控制項通知
...
-   [NM \_ CUSTOMDRAW (標頭) ](nm-customdraw-header.md)
-   [NM \_ RCLICK (標頭) ](nm-rclick-header.md)
-   [NM \_ RELEASEDCAPTURE (標頭) ](nm-releasedcapture-header-.md)
