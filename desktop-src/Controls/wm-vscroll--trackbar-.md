...
ms.locfileid: "119077652"
---
# <a name="wm_vscroll-trackbar-notification-code"></a>WM \_ VSCROLL (的) 通知碼

當滑杆變更位置時，會將 **WM \_ VSCROLL** 訊息傳送給垂直的 [對齊程式] 控制項的擁有者。
...
請注意， **WM \_ VSCROLL** 訊息只會攜帶16位的位置資料。 因此，僅依賴 **WM \_ VSCROLL** (和 [**wm \_ HSCROLL**](wm-hscroll--trackbar-.md)) 的滑杆位置資料的應用程式，其實際最大位置值為65535。
