...
-   [**NMITEMACTI加值稅E**](/windows/win32/api/commctrl/ns-commctrl-nmitemactivate)
...
-   [**NMLVEMPTYMARKUP**](/windows/win32/api/commctrl/ns-commctrl-nmlvemptymarkup)
-   [**NMLVFINDITEM**](/windows/win32/api/commctrl/ns-commctrl-nmlvfinditema)
-   [**NMLVGETINFOTIP**](/windows/win32/api/commctrl/ns-commctrl-nmlvgetinfotipa)
-   [**NMLVKEYDOWN**](/windows/win32/api/commctrl/ns-commctrl-nmlvkeydown)
-   [**NMLVLINK**](/windows/win32/api/commctrl/ns-commctrl-nmlvlink)
-   [**NMLVODSTATECHANGE**](/windows/win32/api/commctrl/ns-commctrl-nmlvodstatechange)
-   [**NMLVSCROLL**](/windows/win32/api/commctrl/ns-commctrl-nmlvscroll)
