...
| <span id="TVGN_NEXTSELECTED"></span><span id="tvgn_nextselected"></span><dl> <dt>**TVGN \_ NEXTSELECTED**</dt> </dl>          | **Windows Vista （含）以後版本。** 抓取下一個選取的專案。 您可以使用 [**TreeView \_ GetNextSelected**](/windows/desktop/api/Commctrl/nf-commctrl-treeview_getnextselected) 宏來傳送此訊息。<br/>                                                                                                                                            |
