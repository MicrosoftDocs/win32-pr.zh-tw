...
ms.locfileid: "117833078"
---
# <a name="tree-view-macros"></a>樹狀檢視宏
...
-   [**TreeView \_ 展開**](/windows/desktop/api/Commctrl/nf-commctrl-treeview_expand)
...
-   [**TreeView \_ setindent**](/windows/desktop/api/Commctrl/nf-commctrl-treeview_getindent)
...
-   [**TreeView \_ system.windows.media.visualtreehelper.hittest**](/windows/desktop/api/Commctrl/nf-commctrl-treeview_hittest)
...
-   [**TreeView \_ 選取**](/windows/desktop/api/Commctrl/nf-commctrl-treeview_select)
