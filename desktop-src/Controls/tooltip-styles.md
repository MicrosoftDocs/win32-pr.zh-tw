...
| <span id="TTS_NOANIMATE"></span><span id="tts_noanimate"></span><dl> <dt>**TTS \_ NOANIMATE**</dt> </dl>                | [版本 5.80](common-control-versions.md)。 在 Windows 98 和 Windows 2000 系統上停用滑動工具提示動畫。 舊版系統會忽略這個樣式。<br/>                                                                                                                                                                                      |
