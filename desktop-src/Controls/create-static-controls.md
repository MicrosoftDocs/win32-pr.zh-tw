...
### <a name="create-a-static-control"></a>建立靜態控制項

下列程式碼範例會使用計時器和 [**STM \_ SETICON**](stm-seticon.md) 訊息，以動畫顯示對話方塊中的靜態圖示控制項。
...
靜態圖示控制項的識別碼 (IDI \_ 靜態 \_ 圖示) 定義于全域標頭檔中，並從應用程式資源載入圖示。

## <a name="related-topics"></a>相關主題

<dl> <dt>

[使用靜態控制項](using-static-controls.md)
</dt> <dt>
