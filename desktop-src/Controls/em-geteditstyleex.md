...
keywords:
- EM_GETEDITSTYLEEX 訊息 Windows 控制項
topic_type:
- apiref
api_name:
- EM_GETEDITSTYLEEX
...
| <dl> <dt>**SE \_ EX \_ NOACETATESELECTION**</dt> </dl> | 使用傳統 Windows 選取文字和背景色彩來顯示選取的文字，而非背景 acetate 色彩 (預設值： 0) 。 <br/>                                                                                                               |
