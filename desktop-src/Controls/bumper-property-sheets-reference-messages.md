...
ms.locfileid: "106985846"
---
# <a name="property-sheet-messages"></a>屬性工作表訊息

## <a name="in-this-section"></a>本節內容

-   [**PSM \_ ADDPAGE**](psm-addpage.md)
-   [**適用的 PSM \_**](psm-apply.md)
-   [**PSM \_ CANCELTOCLOSE**](psm-canceltoclose.md)
-   [**\_已變更 PSM**](psm-changed.md)
...
-   [**PSM \_ GETTABCONTROL**](psm-gettabcontrol.md)
-   [**PSM \_ HWNDTOINDEX**](psm-hwndtoindex.md)
-   [**PSM \_ IDTOINDEX**](psm-idtoindex.md)
-   [**PSM \_ INDEXTOHWND**](psm-indextohwnd.md)
-   [**PSM \_ INDEXTOID**](psm-indextoid.md)
-   [**PSM \_ INDEXTOPAGE**](psm-indextopage.md)
-   [**PSM \_ INSERTPAGE**](psm-insertpage.md)
...
-   [**PSM \_ RESTARTWINDOWS**](psm-restartwindows.md)
-   [**PSM \_ SETBUTTONTEXT**](psm-setbuttontext.md)
-   [**PSM \_ SETCURSEL**](psm-setcursel.md)
-   [**PSM \_ SETCURSELID**](psm-setcurselid.md)
-   [**PSM \_ SETFINISHTEXT**](psm-setfinishtext.md)
-   [**PSM \_ SETHEADERBITMAP**](psm-setheaderbitmap.md)
-   [**PSM \_ SETHEADERBITMAPRESOURCE**](psm-setheaderbitmapresource.md)
-   [**PSM \_ SETHEADERSUBTITLE**](psm-setheadersubtitle.md)
-   [**PSM \_ SETHEADERTITLE**](psm-setheadertitle.md)
-   [**PSM \_ SETNEXTTEXT**](psm-setnexttext.md)
-   [**PSM \_ SETTITLE**](psm-settitle.md)
-   [**PSM \_ SETWIZBUTTONS**](psm-setwizbuttons.md)
-   [**PSM \_ SHOWWIZBUTTONS**](psm-showwizbuttons.md)
-   [**PSM \_ 未變更**](psm-unchanged.md)
