...
| [筆跡輸入](input_ink/input-ink-portal.md)<br/> | 瞭解 Windows 應用程式的各種桌面筆跡 api。<br/>  |
...
| [互動內容](input_intcontext/interaction-context-portal.md)<br/> | [互動內容](input_intcontext/interaction-context-reference.md)可讓 Windows 應用程式和 UI 架構，藉由提供手勢偵測和操作處理來支援多個並行互動。<br/> |
...
| [星形控制器輸入](input_radial/radialcontroller-portal.md)<br/> | 瞭解 Windows 輪子配件的各種桌面 api （例如 Surface Dial (可在[Microsoft Store](https://www.microsoft.com/store/d/Surface-Dial/925R551SKTGN?icid=Surface_Accessories_ModB_Surface_Dial_103116)) 購買）。 <br/> |
...
| [舊版使用者互動功能](./legacy-user-interaction-features.md)<br/> | Windows 7 及更早版本的使用者互動功能。 <br/> |
