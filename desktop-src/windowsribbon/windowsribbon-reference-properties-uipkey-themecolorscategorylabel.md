...
description: 識別 UI \_ PKEY \_ ThemeColorsCategoryLabel 屬性。
...
識別 UI \_ PKEY \_ ThemeColorsCategoryLabel 屬性。
...
\_ \_ 應用程式會使用 UI PKEY ThemeColorsCategoryLabel 來查詢與 [**DropDownColorPicker**](windowsribbon-element-dropdowncolorpicker.md)**主題色彩** 分類相關聯的標籤值。
