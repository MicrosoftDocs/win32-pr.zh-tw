...
<span data-ttu-id="af4ad-132">下列螢幕擷取畫面顯示 Windows 7 繪圖的內容索引標籤。</span><span class="sxs-lookup"><span data-stu-id="af4ad-132">The following screen shot shows a contextual tab from Windows 7 Paint.</span></span>
