...
ms.locfileid: "117850761"
---
# <a name="inribbongallerymenulayout-property"></a>InRibbonGallery. MenuLayout 屬性

代表 [功能區圖庫](windowsribbon-controls-inribbongallery.md) 下拉式功能表版面配置的容器。
...
這段程式碼會顯示 **InRibbonGallery MenuLayout** 控制項宣告。
