---
title: 檢查群組成員資格的範例程式碼
description: 下列程式碼範例會以遞迴方式確認物件是否為群組的成員或群組中任何群組的成員，以驗證物件的絕對成員資格。
ms.assetid: 4b6ef607-8d2e-4209-be61-498302749f7c
ms.tgt_platform: multiple
keywords:
- Active Directory 範例 Active Directory，檢查群組中的成員資格
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118191149"
---
# <a name="example-code-for-checking-for-membership-in-a-group"></a>檢查群組成員資格的範例程式碼

下列程式碼範例會以遞迴方式確認物件是否為群組的成員或群組中任何群組的成員，以驗證物件的絕對成員資格。
