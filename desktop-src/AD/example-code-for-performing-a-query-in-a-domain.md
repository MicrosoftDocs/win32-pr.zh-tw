---
title: 搜尋網域中群組的範例程式碼
description: 本主題包含的程式碼範例會在指定容器的子樹中，搜尋具有指定群組類型的所有群組物件。
ms.assetid: 07b27324-4f59-42c2-a42f-8c2cef138928
ms.tgt_platform: multiple
keywords:
- Active Directory 範例 Active Directory，在網域中搜尋群組
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103931886"
---
# <a name="example-code-for-searching-for-groups-in-a-domain"></a><span data-ttu-id="fe920-104">搜尋網域中群組的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="fe920-104">Example Code for Searching for Groups in a Domain</span></span>

<span data-ttu-id="fe920-105">下列 C/c + + 程式碼範例會在指定容器的子樹中，搜尋具有指定群組類型的所有群組物件。</span><span class="sxs-lookup"><span data-stu-id="fe920-105">The following C/C++ code example searches the subtree of the specified container for all group objects that have the specified group type.</span></span>
...
<span data-ttu-id="fe920-106">下列 Visual Basic 程式碼範例會在指定容器的子樹中，搜尋具有指定群組類型的所有群組物件。</span><span class="sxs-lookup"><span data-stu-id="fe920-106">The following Visual Basic code example searches the subtree of the specified container for all group objects that have the specified group type.</span></span>
