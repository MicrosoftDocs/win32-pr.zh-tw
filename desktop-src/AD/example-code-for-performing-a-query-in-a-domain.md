...
---
# <a name="example-code-for-searching-for-groups-in-a-domain"></a>搜尋網域中群組的範例程式碼

下列 C/c + + 程式碼範例會在指定容器的子樹中，搜尋具有指定群組類型的所有群組物件。
...
下列 Visual Basic 程式碼範例會在指定容器的子樹中，搜尋具有指定群組類型的所有群組物件。
