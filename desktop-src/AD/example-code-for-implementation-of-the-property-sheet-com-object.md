...
---
# <a name="example-code-for-implementation-of-the-property-sheet-com-object"></a><span data-ttu-id="71d9f-104">屬性工作表 COM 物件的執行範例程式碼</span><span class="sxs-lookup"><span data-stu-id="71d9f-104">Example Code for Implementation of the Property Sheet COM Object</span></span>

<span data-ttu-id="71d9f-105">下列程式碼範例可以用來執行 Active Directory 的屬性工作表延伸模組。</span><span class="sxs-lookup"><span data-stu-id="71d9f-105">The following code example can be used to implement an Active Directory property sheet extension.</span></span>

## <a name="ishellextinit-implementation"></a><span data-ttu-id="71d9f-106">IShellExtInit 執行</span><span class="sxs-lookup"><span data-stu-id="71d9f-106">IShellExtInit Implementation</span></span>

<span data-ttu-id="71d9f-107">下列 c + + 程式碼範例可以用來執行 [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) 方法。</span><span class="sxs-lookup"><span data-stu-id="71d9f-107">The following C++ code example can be used to implement the [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) methods.</span></span>
...
## <a name="ishellpropsheetext-implementation"></a><span data-ttu-id="71d9f-108">IShellPropSheetExt 執行</span><span class="sxs-lookup"><span data-stu-id="71d9f-108">IShellPropSheetExt Implementation</span></span>

<span data-ttu-id="71d9f-109">下列 c + + 程式碼範例可以用來執行 [**IShellPropSheetExt**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) 方法。</span><span class="sxs-lookup"><span data-stu-id="71d9f-109">The following C++ code example can be used to implement the [**IShellPropSheetExt**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) methods.</span></span>
...
## <a name="miscellaneous-implementation"></a><span data-ttu-id="71d9f-110">其他實作為</span><span class="sxs-lookup"><span data-stu-id="71d9f-110">Miscellaneous Implementation</span></span>

<span data-ttu-id="71d9f-111">下列 c + + 程式碼範例可以用來執行先前程式碼範例中所使用的公用程式方法和函式。</span><span class="sxs-lookup"><span data-stu-id="71d9f-111">The following C++ code example can be used to implement the utility methods and functions used in the previous code example.</span></span>
