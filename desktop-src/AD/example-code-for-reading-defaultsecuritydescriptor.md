---
title: 讀取 defaultSecurityDescriptor 的範例程式碼
description: 下列程式碼範例會讀取指定之物件類別的 defaultSecurityDescriptor。
ms.assetid: 9462686d-654b-40bb-be10-80ca03790ad5
ms.tgt_platform: multiple
keywords:
- Active Directory 範例 Active Directory，讀取 defaultSecurityDescriptor
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118962237"
---
# <a name="example-code-for-reading-defaultsecuritydescriptor"></a>讀取 defaultSecurityDescriptor 的範例程式碼

下列程式碼範例會讀取指定之物件類別的 **defaultSecurityDescriptor** 。
