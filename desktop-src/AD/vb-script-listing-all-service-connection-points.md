...
---
# <a name="vb-script-listing-all-service-connection-points"></a><span data-ttu-id="827bd-103">列出所有服務連接點的 VB 腳本</span><span class="sxs-lookup"><span data-stu-id="827bd-103">VB Script Listing all Service Connection Points</span></span>

<span data-ttu-id="827bd-104">您可以使用 VB 腳本來管理服務連接點。</span><span class="sxs-lookup"><span data-stu-id="827bd-104">Service Connection Points can be managed using VB Script.</span></span> <span data-ttu-id="827bd-105">下列範例程式碼示範如何列出命令列上所提供之功能變數名稱上的所有服務連接點：</span><span class="sxs-lookup"><span data-stu-id="827bd-105">The following sample code shows how to list all Service Connection Points on the domain name provided on the command line:</span></span>
