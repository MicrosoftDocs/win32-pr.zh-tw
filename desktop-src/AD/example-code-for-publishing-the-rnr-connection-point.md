...
---
# <a name="example-code-for-publishing-the-rnr-connection-point"></a><span data-ttu-id="e46f3-106">發行 RnR 連接點的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="e46f3-106">Example Code for Publishing the RnR Connection Point</span></span>

<span data-ttu-id="e46f3-107">Winsock 服務會使用下列程式碼範例來註冊服務的 RnR 連接點。</span><span class="sxs-lookup"><span data-stu-id="e46f3-107">The following code example is used by the Winsock service to register the RnR connection point for the service.</span></span>
