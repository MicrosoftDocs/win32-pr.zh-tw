...
---
# <a name="example-code-for-creating-a-security-descriptor"></a><span data-ttu-id="49d45-104">建立安全描述項的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="49d45-104">Example Code for Creating a Security Descriptor</span></span>

<span data-ttu-id="49d45-105">本主題包含 Visual Basic 程式碼範例，說明如何建立 ADSI 物件的安全描述項物件。</span><span class="sxs-lookup"><span data-stu-id="49d45-105">This topic includes a Visual Basic code example that shows you how to create a security descriptor object for an ADSI object.</span></span>
