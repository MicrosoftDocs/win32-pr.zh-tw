---
title: 安裝 RnR 服務類別的範例程式碼
description: 下列程式會安裝 RnR 服務類別。
ms.assetid: 85605ecf-bc82-48ac-8b36-ee43862a3bc9
ms.tgt_platform: multiple
keywords:
- Windows 通訊端註冊和解析 AD、範例程式碼、安裝 RnR 服務類別
- 安裝 RnR 服務類別 AD、範例程式碼
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104183014"
---
# <a name="example-code-for-installing-an-rnr-service-class"></a><span data-ttu-id="9e5d3-105">安裝 RnR 服務類別的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="9e5d3-105">Example Code for Installing an RnR Service Class</span></span>

<span data-ttu-id="9e5d3-106">下列程式會安裝 RnR 服務類別。</span><span class="sxs-lookup"><span data-stu-id="9e5d3-106">The following program installs an RnR Service class.</span></span>
