---
title: 以程式設計方式延伸架構的範例程式碼
description: 本主題包含以程式設計方式延伸 Active Directory 架構的 c + + 程式碼範例。
...
ms.locfileid: "104183017"
---
# <a name="example-code-for-extending-the-schema-programmatically"></a><span data-ttu-id="b0740-105">以程式設計方式延伸架構的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="b0740-105">Example Code for Extending the Schema Programmatically</span></span>

<span data-ttu-id="b0740-106">本主題包含以程式設計方式延伸 Active Directory 架構的 c + + 程式碼範例。</span><span class="sxs-lookup"><span data-stu-id="b0740-106">This topic includes a C++ code example that programmatically extends the Active Directory Schema.</span></span>
