...
---
# <a name="example-code-for-creating-a-class"></a><span data-ttu-id="fc5bb-105">建立類別的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="fc5bb-105">Example Code for Creating a Class</span></span>

<span data-ttu-id="fc5bb-106">下列 C 和 c + + 程式碼範例顯示如何在 ADSI 快取中建立 [**classSchema**](/windows/desktop/ADSchema/c-classschema) 物件。</span><span class="sxs-lookup"><span data-stu-id="fc5bb-106">The following C and C++ code example shows how to create a [**classSchema**](/windows/desktop/ADSchema/c-classschema) object in the ADSI cache.</span></span>

<span data-ttu-id="fc5bb-107">**CreateClass** 範例函式會示範如何建立 [**classSchema**](/windows/desktop/ADSchema/c-classschema)物件，並將 [**IADs**](/windows/desktop/api/iads/nn-iads-iads)指標傳回至新的物件。</span><span class="sxs-lookup"><span data-stu-id="fc5bb-107">The **CreateClass** example function shows how to create the [**classSchema**](/windows/desktop/ADSchema/c-classschema) object and returns an [**IADs**](/windows/desktop/api/iads/nn-iads-iads) pointer to the new object.</span></span> <span data-ttu-id="fc5bb-108">請注意， **CreateClass** 不會呼叫 [**IADs：： SetInfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) 來認可新的 **classSchema** 物件至目錄。</span><span class="sxs-lookup"><span data-stu-id="fc5bb-108">Be aware that **CreateClass** does not call [**IADs::SetInfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) to commit the new **classSchema** object to the directory.</span></span> <span data-ttu-id="fc5bb-109">呼叫端必須使用傳回的指標進行呼叫。</span><span class="sxs-lookup"><span data-stu-id="fc5bb-109">The caller must make the call using the returned pointer.</span></span>

<span data-ttu-id="fc5bb-110">下列 **BytesToVariantArray** 程式碼範例顯示一個公用程式函式，此函式會將八位字串封裝成 variant 陣列。</span><span class="sxs-lookup"><span data-stu-id="fc5bb-110">The following **BytesToVariantArray** code example shows a utility function that packs an octet string into a variant array.</span></span>
