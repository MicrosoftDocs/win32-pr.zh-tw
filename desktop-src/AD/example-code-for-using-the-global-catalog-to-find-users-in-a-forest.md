---
title: 使用通用類別目錄在樹系中尋找使用者的範例程式碼
description: 本主題包含用來搜尋樹系中使用者的程式碼範例。
...
本主題包含用來搜尋樹系中使用者的程式碼範例。

下列 Visual Basic 程式碼範例示範如何使用 ADSI 來搜尋樹系中的使用者。
