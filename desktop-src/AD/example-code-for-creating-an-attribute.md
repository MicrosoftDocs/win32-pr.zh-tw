---
title: 建立屬性的範例程式碼
description: 下列程式碼範例會在架構容器中建立 attributeSchema 物件。
...
---
# <a name="example-code-for-creating-an-attribute"></a><span data-ttu-id="15516-104">建立屬性的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="15516-104">Example Code for Creating an Attribute</span></span>

<span data-ttu-id="15516-105">下列程式碼範例會在架構容器中建立 [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) 物件。</span><span class="sxs-lookup"><span data-stu-id="15516-105">The following code example creates an [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) object in the schema container.</span></span>

<span data-ttu-id="15516-106">**CreateAttribute** 函式會在架構容器中建立 [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema)物件，但不會將它認可至目錄。</span><span class="sxs-lookup"><span data-stu-id="15516-106">The **CreateAttribute** function creates an [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) object in the schema container, but does not commit it to the directory.</span></span> <span data-ttu-id="15516-107">呼叫 [**IADs. SetInfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) 方法，將新的 **attributeSchema** 物件認可至目錄。</span><span class="sxs-lookup"><span data-stu-id="15516-107">Call the [**IADs.SetInfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) method to commit the new **attributeSchema** object to the directory.</span></span>

<span data-ttu-id="15516-108">**BytesToVariantArray** 函式是一個公用程式函式，可將八位字串封裝成 variant 陣列。</span><span class="sxs-lookup"><span data-stu-id="15516-108">The **BytesToVariantArray** function is a utility function that packs an octet string into a variant array.</span></span>
