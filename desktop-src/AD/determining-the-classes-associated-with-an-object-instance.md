...
<td>識別物件為其實例的結構化和抽象類別。 例如，使用者物件的值可以是：
<ul>
...
<td>識別包含在 <strong>structuralObjectClass</strong>中的類別，再加上任何動態附加的輔助類別。 例如，如果 &quot; 車輛 &quot; 輔助類別附加至使用者物件，則這些值可以是：
<ul>
<li><strong>top</strong></li>
<li><strong>車輛</strong></li>
<li><strong>人</strong></li>
<li><strong>organizationalPerson</strong></li>
<li><strong>user</strong></li>
</ul></td>
