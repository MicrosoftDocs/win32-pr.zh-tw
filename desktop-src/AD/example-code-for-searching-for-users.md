---
title: 搜尋使用者的範例程式碼
description: 下列程式碼範例會在執行呼叫進程的使用者帳戶網域中搜尋使用者。C + + ExampleVisual 基本範例
...
---
# <a name="example-code-for-searching-for-users"></a><span data-ttu-id="7b470-104">搜尋使用者的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="7b470-104">Example Code for Searching for Users</span></span>

<span data-ttu-id="7b470-105">下列程式碼範例會在執行呼叫進程的使用者帳戶網域中搜尋使用者。</span><span class="sxs-lookup"><span data-stu-id="7b470-105">The following code examples search for users in the domain of the user account under which the calling process is running.</span></span>

-   [<span data-ttu-id="7b470-106">C + + 範例</span><span class="sxs-lookup"><span data-stu-id="7b470-106">C++ Example</span></span>](#c-example)
-   [<span data-ttu-id="7b470-107">Visual Basic 範例</span><span class="sxs-lookup"><span data-stu-id="7b470-107">Visual Basic Example</span></span>](#visual-basic-example)

## <a name="c-example"></a><span data-ttu-id="7b470-108">C + + 範例</span><span class="sxs-lookup"><span data-stu-id="7b470-108">C++ Example</span></span>

<span data-ttu-id="7b470-109">下列 c + + 程式碼範例會在目前的網域中搜尋所有使用者，或根據指定的篩選準則來搜尋特定使用者。</span><span class="sxs-lookup"><span data-stu-id="7b470-109">The following C++ code example searches the current domain for all users, or a specific user based on a specified filter.</span></span>
...
## <a name="visual-basic-example"></a><span data-ttu-id="7b470-110">Visual Basic 範例</span><span class="sxs-lookup"><span data-stu-id="7b470-110">Visual Basic Example</span></span>

<span data-ttu-id="7b470-111">下列 Visual Basic 程式碼範例會在目前的網域中搜尋具有指定姓氏的使用者，並傳回所找到物件的 name 和 [**distinguishedName**](/windows/desktop/ADSchema/a-distinguishedname) 屬性。</span><span class="sxs-lookup"><span data-stu-id="7b470-111">The following Visual Basic code example searches the current domain for users with the specified surname and returns the name and [**distinguishedName**](/windows/desktop/ADSchema/a-distinguishedname) attributes for the objects that are found.</span></span> <span data-ttu-id="7b470-112">下列程式碼範例會使用 ADO 來執行搜尋。</span><span class="sxs-lookup"><span data-stu-id="7b470-112">The following code example uses ADO to perform the search.</span></span>
