---
title: 建立群組的範例程式碼
description: 本主題包含建立群組的程式碼範例程式碼。
ms.assetid: f6bba6fc-fec2-4dd9-b7f2-da7782a6caa5
ms.tgt_platform: multiple
keywords:
- Active Directory 範例 Active Directory，建立群組
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104462033"
---
# <a name="example-code-for-creating-a-group"></a><span data-ttu-id="8f7c5-104">建立群組的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="8f7c5-104">Example Code for Creating a Group</span></span>

<span data-ttu-id="8f7c5-105">下列 c + + 程式碼範例包含一個函式，該函式會使用明確設定的基本屬性 (**cn**、 **sAMAccountType**、 **groupType**) 和不包含任何成員的方式來建立群組。</span><span class="sxs-lookup"><span data-stu-id="8f7c5-105">The following C++ code example contains a function that creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
...
<span data-ttu-id="8f7c5-106">下列 Visual Basic 程式碼範例會建立一個群組，其中只會明確設定必要的屬性 (**cn**、 **sAMAccountType**、 **groupType**) 且不包含任何成員。</span><span class="sxs-lookup"><span data-stu-id="8f7c5-106">The following Visual Basic code example creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
