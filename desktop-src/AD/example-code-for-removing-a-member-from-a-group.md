...
ms.locfileid: "106988015"
---
# <a name="example-code-for-removing-a-member-from-a-group"></a><span data-ttu-id="7adb9-104">從群組中移除成員的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="7adb9-104">Example Code for Removing a Member from a Group</span></span>

<span data-ttu-id="7adb9-105">下列程式碼範例包含可從群組中移除成員的函式。</span><span class="sxs-lookup"><span data-stu-id="7adb9-105">The following code example contains a function that removes a member from a group.</span></span>
