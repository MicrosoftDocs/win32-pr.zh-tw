---
title: 設定控制項存取許可權 ACE 的範例程式碼
description: 下列 C/c + + 程式碼範例會將控制項存取權限的 ACE 新增至物件的 ACL。
ms.assetid: 8fb5eb47-27ca-4e60-ad39-ca4392da4e7d
ms.tgt_platform: multiple
keywords:
- 設定控制項存取許可權 ACE AD 的範例程式碼
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104183010"
---
# <a name="example-code-for-setting-a-control-access-right-ace"></a><span data-ttu-id="813f3-104">設定控制項存取許可權 ACE 的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="813f3-104">Example Code for Setting a Control Access Right ACE</span></span>

<span data-ttu-id="813f3-105">下列 C/c + + 程式碼範例會將控制項存取權限的 ACE 新增至物件的 ACL。</span><span class="sxs-lookup"><span data-stu-id="813f3-105">The following C/C++ code example adds an ACE for a control access right to the ACL of an object.</span></span>
