...
---
# <a name="reading-an-objects-objectguid-and-creating-a-string-representation-of-the-guid"></a><span data-ttu-id="04cc8-103">讀取物件的 objectGUID 並建立 GUID 的字串標記法</span><span class="sxs-lookup"><span data-stu-id="04cc8-103">Reading an Object's objectGUID and Creating a String Representation of the GUID</span></span>

<span data-ttu-id="04cc8-104">Active Directory Domain Services 中每個物件的 **objectGUID** 屬性會以八位字串的形式儲存在目錄中。</span><span class="sxs-lookup"><span data-stu-id="04cc8-104">The **objectGUID** property of each object in Active Directory Domain Services is stored in the directory as an octet string.</span></span> <span data-ttu-id="04cc8-105">八位字串是一個位元組字元的陣列。</span><span class="sxs-lookup"><span data-stu-id="04cc8-105">An octet string is an array of one-byte characters.</span></span> <span data-ttu-id="04cc8-106">您可以使用 [**IADs：： get \_ GUID**](/windows/desktop/ADSI/iads-property-methods) 方法來取得目錄物件的 **objectGUID** 的可系結字串形式。</span><span class="sxs-lookup"><span data-stu-id="04cc8-106">Use the [**IADs::get\_GUID**](/windows/desktop/ADSI/iads-property-methods) method to retrieve the bindable string form of a directory object's **objectGUID**.</span></span>

<span data-ttu-id="04cc8-107">下列程式碼範例會顯示一個函式，該函式會讀取 **objectGUID** 屬性，並傳回用來系結至物件之 GUID 的字串表示。</span><span class="sxs-lookup"><span data-stu-id="04cc8-107">The following code examples show a function that reads the **objectGUID** attribute and returns a string representation of the GUID used to bind to the object.</span></span>

-   [<span data-ttu-id="04cc8-108">Visual Basic 範例</span><span class="sxs-lookup"><span data-stu-id="04cc8-108">Visual Basic Example</span></span>](#visual-basic-example)
-   [<span data-ttu-id="04cc8-109">C + + 範例</span><span class="sxs-lookup"><span data-stu-id="04cc8-109">C++ Example</span></span>](#c-example)

## <a name="visual-basic-example"></a><span data-ttu-id="04cc8-110">Visual Basic 範例</span><span class="sxs-lookup"><span data-stu-id="04cc8-110">Visual Basic Example</span></span>
...
## <a name="c-example"></a><span data-ttu-id="04cc8-111">C + + 範例</span><span class="sxs-lookup"><span data-stu-id="04cc8-111">C++ Example</span></span>
