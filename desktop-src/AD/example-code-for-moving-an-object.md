...
---
# <a name="example-code-for-moving-an-object"></a><span data-ttu-id="70b1e-105">移動物件的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="70b1e-105">Example Code for Moving an Object</span></span>

<span data-ttu-id="70b1e-106">本主題包含用來在定義域中移動物件的程式碼範例。</span><span class="sxs-lookup"><span data-stu-id="70b1e-106">This topic includes code examples used to move an object in the domain.</span></span>

<span data-ttu-id="70b1e-107">下列 c + + 程式碼範例示範如何使用 ADSI 來移動網域中的物件。</span><span class="sxs-lookup"><span data-stu-id="70b1e-107">The following C++ code example shows how to use ADSI to move an object in the domain.</span></span>
...
<span data-ttu-id="70b1e-108">下列 Visual Basic 程式碼範例示範如何使用 ADSI 來移動網域中的物件。</span><span class="sxs-lookup"><span data-stu-id="70b1e-108">The following Visual Basic code example shows how to use ADSI to move an object in the domain.</span></span>
