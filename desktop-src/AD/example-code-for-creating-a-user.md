---
title: 建立使用者的範例程式碼
description: 本主題包含在 Active Directory Domain Services 所控制的網域中建立使用者的程式碼範例。
...
ms.locfileid: "118962337"
---
# <a name="example-code-for-creating-a-user"></a>建立使用者的範例程式碼

本主題包含在 Active Directory Domain Services 所控制的網域中建立使用者的程式碼範例。
