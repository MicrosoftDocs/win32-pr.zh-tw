...
---
# <a name="example-code-for-enumerating-local-groups"></a><span data-ttu-id="dc1d1-104">列舉本機群組的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="dc1d1-104">Example Code for Enumerating Local Groups</span></span>

<span data-ttu-id="dc1d1-105">本主題包含的程式碼範例會列舉指定類別的所有物件。</span><span class="sxs-lookup"><span data-stu-id="dc1d1-105">This topic includes a code example that enumerates all objects of a specified class.</span></span>

<span data-ttu-id="dc1d1-106">下列 c + + 程式碼範例會使用 ADSI 來列舉指定類別的所有物件。</span><span class="sxs-lookup"><span data-stu-id="dc1d1-106">The following C++ code example enumerates all objects of a specified class using ADSI.</span></span>
