...
---
# <a name="example-code-for-creating-a-container-object"></a><span data-ttu-id="386fe-104">建立容器物件的範例程式碼</span><span class="sxs-lookup"><span data-stu-id="386fe-104">Example Code for Creating a Container Object</span></span>

<span data-ttu-id="386fe-105">下列程式碼範例會建立兩個物件。</span><span class="sxs-lookup"><span data-stu-id="386fe-105">The following code example creates two objects.</span></span> <span data-ttu-id="386fe-106">第一個是容器物件，第二個是子容器物件。</span><span class="sxs-lookup"><span data-stu-id="386fe-106">First, a container object and, second, a sub-container object.</span></span> <span data-ttu-id="386fe-107">子容器物件的值會新增至容器物件的 [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) 屬性。</span><span class="sxs-lookup"><span data-stu-id="386fe-107">A value for the sub-container object is added to the [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) property of the container object.</span></span> <span data-ttu-id="386fe-108">程式碼範例會使用 WKGUID 系結來系結至子容器物件，並顯示其 ADsPath。</span><span class="sxs-lookup"><span data-stu-id="386fe-108">The code example binds to the sub-container object using the WKGUID binding and displays its ADsPath.</span></span> <span data-ttu-id="386fe-109">然後，它會重新命名子容器物件，並使用相同的 WKGUID 系結再次進行系結。</span><span class="sxs-lookup"><span data-stu-id="386fe-109">It then renames the sub-container object and binds again using the same WKGUID binding.</span></span>
