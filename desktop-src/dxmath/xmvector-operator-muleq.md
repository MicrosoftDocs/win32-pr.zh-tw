...
<td style="text-align: left;">將 <code>XMVECTOR</code> 實例乘以浮點值，並傳回更新的實例的參考。 <br/> 會將 <code>operator *=</code> <a href="xmvector-data-type.md"><strong>XMVECTOR 資料類型</strong></a> 之目前實例的每個元件乘以指定的浮點值，並傳回更新的目前實例的參考。 <br/>
<blockquote>
[!Note]<br />
此運算子僅適用于 c + +。
</blockquote>
...
<td style="text-align: left;">將一個 <code>XMVECTOR</code> 實例乘以第二個實例，並傳回已更新之初始實例的參考。 <br/> 會將 <code>operator *=</code> <a href="xmvector-data-type.md"><strong>XMVECTOR 資料類型</strong></a> 之目前實例的每個元件乘以第二個指定之實例中的對應元件 <code>XMVECTOR</code> ，並傳回已更新之初始實例的參考。 <br/>
<blockquote>
[!Note]<br />
此運算子僅適用于 c + +。
</blockquote>
