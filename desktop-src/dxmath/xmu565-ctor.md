...
結構 [**XMU565**](/windows/win32/api/directxpackedvector/ns-directxpackedvector-xmu565) 結構的實例。
...
<td style="text-align: left;"><code>XMU565</code>從 <code>uint16_t</code> 包含封裝格式之元件資料的變數，初始化的新實例。 <br/> 這個函式會從包含封裝格式之元件資料的變數，初始化 <a href="/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmu565"><strong>XMU565</strong></a> 的新實例 <code>uint16_t</code> 。 <br/>
<blockquote>
[!Note]<br />
這個函式僅適用于 c + +。
</blockquote>
...
<td style="text-align: left;"><code>XMU565</code>從三個元素陣列初始化的新實例 <code>float</code> 。 <br/> 這個函式會從三個元素陣列初始化 <a href="/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmu565"><strong>XMU565</strong></a> 的新實例 <code>float</code> 。 <br/>
<blockquote>
[!Note]<br />
這個函式僅適用于 c + +。
</blockquote>
...
<td style="text-align: left;"><code>XMU565</code>從三個引數初始化的新實例 <code>float</code> 。 <br/> 這個函式會從三個引數初始化 <a href="/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmu565"><strong>XMU565</strong></a> 的新實例 <code>float</code> 。 <br/>
<blockquote>
[!Note]<br />
這個函式僅適用于 c + +。
</blockquote>
...
<td style="text-align: left;">的預設函數 <code>XMU565</code><br/> XMU565 的預設函式<a href="/windows/desktop/api/directxpackedvector/ns-directxpackedvector-xmu565"> <strong></strong></a><br/>
<blockquote>
[!Note]<br />
這僅適用于以 c + + 為基礎的開發。
</blockquote>
...
[XMU565 延伸模組](ovw-xmu565-extensions.md)
</dt> <dt>
