...
將向量元件資料指派給目前的實例 `XMDEC4` 。

將向量元件資料指派給目前的 [**XMDEC4**](/windows/win32/api/directxpackedvector/ns-directxpackedvector-xmdec4)實例。
...
[XMDEC4 運算子](ovw-xmdec4-operators.md)
</dt> <dt>
