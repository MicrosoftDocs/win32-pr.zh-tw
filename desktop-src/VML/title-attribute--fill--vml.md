---
title: 'Title 屬性 (填滿)  (的 VML) '
description: 'Title 屬性 (填滿)  (的 VML) '
...
ms.locfileid: "104315298"
---
# <a name="title-attribute-fillvml"></a>Title 屬性 (填滿)  (的 VML) 
...
如果這個屬性具有值，則會內嵌筆觸影像。 屬性的實際值是當滑鼠指標移至影像上時，要與圖片一起顯示的文字。
