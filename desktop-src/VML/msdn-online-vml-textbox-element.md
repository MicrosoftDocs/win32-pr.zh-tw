...
| [版面配置-Flow](msdn-online-vml-layout-flow-attribute.md)                     | 決定文字方塊中文字的流程。            |
...
| [MSO-Layout-Flow-Alt](msdn-online-vml-mso-layout-flow-alt-attribute.md)     | 定義文字方塊中文字的替代版面配置流程。   |
