...
---
# <a name="vml-top-attribute"></a>VML Top 屬性
...
**指令碼語法**
 ...
 style.top = "*expression*"

*運算式* =** style.top

**備註**

**Top** 屬性類似于樣式的標準 HTML **Top** 屬性。

單位可以對應至父元素，或可能是絕對單位。 這個屬性可能不會針對錨定的內嵌圖形寫出。
...
[Top 屬性範例](/previous-versions/bb264098(v=vs.85))。  (需要 Microsoft Internet Explorer 5 或更高版本。 ) 
