...
---
# <a name="mdm_policy_config01_activexcontrols02-class"></a>MDM \_ 原則 \_ Config01 \_ ActiveXControls02 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

此原則設定可決定您的組織中標準使用者可以使用哪些 ActiveX 安裝網站在其電腦上安裝 ActiveX 控制項。 啟用此設定時，系統管理員可以建立由主機 URL 指定的已核准 Activex 安裝網站清單。
...
**MDM \_ Policy \_ Config01 \_ ActiveXControls02** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ Policy \_ Config01 \_ ActiveXControls02** 類別具有這些屬性。
