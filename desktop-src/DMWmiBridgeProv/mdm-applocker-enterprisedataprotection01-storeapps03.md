...
ms.locfileid: "119077407"
---
# <a name="mdm_applocker_enterprisedataprotection01_storeapps03-class"></a>MDM \_ AppLocker \_ EnterpriseDataProtection01 \_ StoreApps03 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ AppLocker \_ EnterpriseDataProtection01 \_ StoreApps03** 類別會捕捉允許處理企業資料的 Windows 應用程式清單。 應該與/Vendor/MSFT/Policy/ConfigSource/DataProtection 中的設定一起使用。
...
**MDM \_ AppLocker \_ EnterpriseDataProtection01 \_ StoreApps03** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ AppLocker \_ EnterpriseDataProtection01 \_ StoreApps03** 類別具有這些屬性。
...
描述父節點的完整路徑。 針對此類別，字串為 "./Vendor/MSFT/AppLocker/EnterpriseDataProtection/*群組*"
