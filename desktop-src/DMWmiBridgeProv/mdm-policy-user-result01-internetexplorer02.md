...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 22b29f1778e00c9b283ecae641c4dbc73c1e363424103358accd87a9f94c6ab5
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119913638"
---
# <a name="mdm_policy_user_result01_internetexplorer02-class"></a>MDM \_ 原則 \_ 使用者 \_ Result01 \_ InternetExplorer02 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

MDM \_ Policy \_ User \_ Result01 \_ InternetExplorer02 類別代表可用 Internet Explorer 原則。
...
**MDM \_ Policy \_ User \_ Result01 \_ InternetExplorer02** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ Policy \_ User \_ Result01 \_ InternetExplorer02** 類別具有這些屬性。
...
[TrustedSitesZoneDoNotRunAntimalwareAgainstActiveXControls](/windows/client-management/mdm/policy-csp-internetexplorer#internetexplorer-trustedsiteszonedonotrunantimalwareagainstactivexcontrols)
</dt> <dd> <dl> <dt>
