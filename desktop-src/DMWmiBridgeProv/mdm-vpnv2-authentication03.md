...
---
# <a name="mdm_vpnv2_authentication03-class"></a>MDM \_ >vpnv2 \_ Authentication03 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

[**MDM \_ >vpnv2 \_ Authentication03**](mdm-vpnv2-01.md)類別包含原生 VPN 設定檔的驗證資訊。
...
**MDM \_ >vpnv2 \_ Authentication03** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ >vpnv2 \_ Authentication03** 類別具有這些屬性。
