...
---
# <a name="mdm_policy_result01_bluetooth02-class"></a>MDM \_ 原則 \_ Result01 \_ Bluetooth02 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ Policy \_ Result01 \_ Bluetooth02** 類別代表可用的藍牙管理原則。
...
**MDM \_ Policy \_ Result01 \_ Bluetooth02** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ Policy \_ Result01 \_ Bluetooth02** 類別具有這些屬性。
