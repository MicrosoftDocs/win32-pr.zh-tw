...
ms.locfileid: "119655688"
---
# <a name="mdm_devicestatus_cellularidentities01_01-class"></a>MDM \_ DeviceStatus \_ CellularIdentities01 \_ 01 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ DeviceStatus \_ CellularIdentities01 \_ 01** 類別可讓您查詢裝置是否符合企業加密原則。
...
**MDM \_ DeviceStatus \_ CellularIdentities01 \_ 01** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ DeviceStatus \_ CellularIdentities01 \_ 01** 類別具有這些屬性。
