...
description: MDM \_ AppLocker \_ ApplicationLaunchRestrictions01 \_ StoreApps03 類別可讓您指定允許或不允許 Enterprise 資料保護的 EXE 應用程式。
...
**MDM \_ AppLocker \_ ApplicationLaunchRestrictions01 \_ StoreApps03** 類別可讓您指定允許或不允許 Enterprise 資料保護的 EXE 應用程式。
