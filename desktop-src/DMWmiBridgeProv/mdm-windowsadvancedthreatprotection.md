...
ms.locfileid: "119967478"
---
# <a name="mdm_windowsadvancedthreatprotection-class"></a>MDM \_ WindowsAdvancedThreatProtection 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ WindowsAdvancedThreatProtection** 類別是用來上架及下架 Windows Defender Advanced 威脅防護 (WDATP) 的端點。
...
**MDM \_ WindowsAdvancedThreatProtection** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ WindowsAdvancedThreatProtection** 類別具有這些屬性。
...
識別父節點的名稱。 此類別的字串為 "WindowsAdvancedThreatProtection"。

</dd> <dt>

[下線](/windows/client-management/mdm/windowsadvancedthreatprotection-csp#offboarding)
</dt> <dd> <dl> <dt>
...
[入門訓練](/windows/client-management/mdm/windowsadvancedthreatprotection-csp#onboarding)
</dt> <dd> <dl> <dt>
