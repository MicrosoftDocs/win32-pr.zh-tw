...
**MDM \_ PassportForWork \_ PINComplexity03** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ PassportForWork \_ PINComplexity03** 類別具有這些屬性。

<dl> <dt>

[數位](/windows/client-management/mdm/passportforwork-csp#tenantid-policies-pincomplexity-digits)
</dt> <dd> <dl> <dt>
...
[到期](/windows/client-management/mdm/passportforwork-csp#tenantid-policies-pincomplexity-expiration)
</dt> <dd> <dl> <dt>
...
描述父節點的完整路徑。 針對此類別，字串為 "./Vendor/MSFT/PassPortForWork/*TenantID*/Policies"
