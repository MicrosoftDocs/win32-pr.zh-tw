...
**MDM \_ EnterpriseModernAppManagement \_ AppInstallation01 \_ 01** 類別具有下列類型的成員：
...
**MDM \_ EnterpriseModernAppManagement \_ AppInstallation01 \_ 01** 類別具有這些方法。
...
**MDM \_ EnterpriseModernAppManagement \_ AppInstallation01 \_ 01** 類別具有這些屬性。
...
識別父節點的名稱。 此類別的字串為 "AppInstallation"。
...
描述父節點的完整路徑。 此類別的字串為 "./Vendor/MSFT/EnterpriseModernAppManagement/AppInstallation"
...
[狀態](/windows/client-management/mdm/enterprisemodernappmanagement-csp#appinstallation-packagefamilyname-status)
</dt> <dd> <dl> <dt>
