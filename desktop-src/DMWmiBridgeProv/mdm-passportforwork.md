...
---
# <a name="mdm_passportforwork-class"></a>MDM \_ PassportForWork 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ PassportForWork** 可用來布建 Windows Hello 企業版。
...
**MDM \_ PassportForWork** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ PassportForWork** 類別具有這些屬性。
...
以全域唯一識別碼的格式指定租使用者識別碼 (GUID) 沒有大括弧 ( {，} ) ，它將作為 Windows Hello 企業版布建和管理的一部分使用。
