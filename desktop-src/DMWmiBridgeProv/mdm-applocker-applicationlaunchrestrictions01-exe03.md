...
ms.locfileid: "119575319"
---
# <a name="mdm_applocker_applicationlaunchrestrictions01_exe03-class"></a>MDM \_ AppLocker \_ ApplicationLaunchRestrictions01 \_ EXE03 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ AppLocker \_ ApplicationLaunchRestrictions01 \_ EXE03** 類別可讓您指定允許哪些 EXE 應用程式啟動。
...
**MDM \_ AppLocker \_ ApplicationLaunchRestrictions01 \_ EXE03** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ AppLocker \_ ApplicationLaunchRestrictions01 \_ EXE03** 類別具有這些屬性。
