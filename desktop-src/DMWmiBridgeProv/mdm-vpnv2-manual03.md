...
ms.locfileid: "119076942"
---
# <a name="mdm_vpnv2_manual03-class"></a>MDM \_ >vpnv2 \_ Manual03 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ >vpnv2 \_ Manual03** 類別是選擇性節點，其中包含手動伺服器設定。
...
**MDM \_ >vpnv2 \_ Manual03** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ >vpnv2 \_ Manual03** 類別具有這些屬性。
...
描述父節點的完整路徑。 針對此類別，字串為 "./Vendor/MSFT/VPNv2/*ProfileName*/Proxy/"

</dd> <dt>

[伺服器](/windows/client-management/mdm/vpnv2-csp#vpnv2-profilename-proxy-manual-server)
</dt> <dd> <dl> <dt>
