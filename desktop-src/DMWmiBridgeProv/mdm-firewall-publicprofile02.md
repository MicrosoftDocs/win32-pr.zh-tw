...
ms.locfileid: "119825658"
---
# <a name="mdm_firewall_publicprofile02-class"></a>MDM \_ 防火牆 \_ PublicProfile02 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

MDM \_ 防火牆 \_ PublicProfile02 類別可用來設定 Windows Defender 防火牆設定。
...
**MDM \_ 防火牆 \_ PublicProfile02** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ 防火牆 \_ PublicProfile02** 類別具有這些屬性。
