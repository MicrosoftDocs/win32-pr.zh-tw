...
ms.locfileid: "119018176"
---
# <a name="mdm_enterprisemodernappmanagement_appmanagement01_02-class"></a>MDM \_ EnterpriseModernAppManagement \_ AppManagement01 \_ 02 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ EnterpriseModernAppManagement \_ AppManagement01 \_ 02** 類別指定您是否要封鎖特定應用程式，而不是透過自動更新進行更新。
...
**MDM \_ EnterpriseModernAppManagement \_ AppManagement01 \_ 02** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ EnterpriseModernAppManagement \_ AppManagement01 \_ 02** 類別具有這些屬性。
...
描述父節點的完整路徑。 針對此類別，字串為 "./Vendor/MSFT/EnterpriseModernAppManagement/AppManagement/*EnterpriseID*"
