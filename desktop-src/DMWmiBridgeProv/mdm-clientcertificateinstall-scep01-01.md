...
---
# <a name="mdm_clientcertificateinstall_scep01_01-class"></a>MDM \_ ClientCertificateInstall \_ SCEP01 \_ 01 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ ClientCertificateInstall \_ SCEP01 \_ 01** 類別可讓您存取 SCEP 憑證安裝的節點，並使用唯一識別碼來區分不同的憑證安裝要求。

需要安裝 SCEP 憑證。

支援的作業為 Get、Add 和 Delete。

在此節點上呼叫 Delete 應該會刪除對應的 SCEP 憑證。
...
**MDM \_ ClientCertificateInstall \_ SCEP01 \_ 01** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ ClientCertificateInstall \_ SCEP01 \_ 01** 類別具有這些屬性。
...
字串為 "./Vendor/MSFT/ClientCertificateInstall/SCEP"
