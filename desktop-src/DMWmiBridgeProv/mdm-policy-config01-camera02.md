...
ms.locfileid: "119018046"
---
# <a name="mdm_policy_config01_camera02-class"></a>MDM \_ 原則 \_ Config01 \_ Camera02 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ Policy \_ Config01 \_ Camera02** 類別代表可用的相機原則。
...
**MDM \_ Policy \_ Config01 \_ Camera02** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ Policy \_ Config01 \_ Camera02** 類別具有這些屬性。
