...
ms.locfileid: "119018166"
---
# <a name="mdm_enterprisemodernappmanagement_appmanagement01_03-class"></a>MDM \_ EnterpriseModernAppManagement \_ AppManagement01 \_ 03 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ EnterpriseModernAppManagement \_ AppManagement01 \_ 03** 類別提供應用程式的特定資訊，例如名稱、版本和發行者。
...
**MDM \_ EnterpriseModernAppManagement \_ AppManagement01 \_ 03** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ EnterpriseModernAppManagement \_ AppManagement01 \_ 03** 類別具有這些屬性。

<dl> <dt>

[架構](/windows/client-management/mdm/enterprisemodernappmanagement-csp#----packagefamilyname-packagefullname-architecture)
</dt> <dd> <dl> <dt>
...
[名稱](/windows/client-management/mdm/enterprisemodernappmanagement-csp#----packagefamilyname-packagefullname-name)
</dt> <dd> <dl> <dt>
...
描述父節點的完整路徑。 針對此類別，字串為 "./Vendor/MSFT/EnterpriseModernAppManagement/AppManagement/*EnterpriseID* / *PackageFamilyName*"

</dd> <dt>

[發行者](/windows/client-management/mdm/enterprisemodernappmanagement-csp#----packagefamilyname-packagefullname-publisher)
</dt> <dd> <dl> <dt>
...
[使用者](/windows/client-management/mdm/enterprisemodernappmanagement-csp#----packagefamilyname-packagefullname-users)
</dt> <dd> <dl> <dt>
...
[版本](/windows/client-management/mdm/enterprisemodernappmanagement-csp#----packagefamilyname-packagefullname-version)
</dt> <dd> <dl> <dt>
