...
ms.locfileid: "120045608"
---
# <a name="mdm_reporting_enterprisedataprotection01_retrievebytimerange02-class"></a>MDM \_ 報告 \_ EnterpriseDataProtection01 \_ RetrieveByTimeRange02 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ Reporting \_ EnterpriseDataProtection01 \_ RetrieveByTimeRange02** 類別是用來抓取 StartTime 和 StopTime 中存在的記錄。 StartTime 和 StopTime 是以 ISO 8601 格式表示。 如果未指定 StartTime 和 StopTime，則會將值轉譯為第一個現有或最後一個現有的時間。
...
**MDM \_ Reporting \_ EnterpriseDataProtection01 \_ RetrieveByTimeRange02** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ Reporting \_ EnterpriseDataProtection01 \_ RetrieveByTimeRange02** 類別具有這些屬性。
