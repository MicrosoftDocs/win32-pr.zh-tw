...
ms.topic: reference
ms.date: 05/31/2018
ms.openlocfilehash: 26e953748f4bfdb43d5b068ed87252bc5c270c9f0a6657fc887644853fe80407
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/11/2021
ms.locfileid: "119796668"
---
# <a name="mdm_policy_config01_update02-class"></a>MDM \_ 原則 \_ Config01 \_ Update02 類別

\[某些資訊與預先發行的產品有關，在正式發行之前可能會經過大幅修改。 Microsoft 對此處提供的資訊，不做任何明確或隱含的瑕疵擔保。\]

**MDM \_ Policy \_ Config01 \_ Update02** 類別代表可用的更新原則。
...
**MDM \_ Policy \_ Config01 \_ Update02** 類別具有下列類型的成員：

-   [屬性](#properties)

### <a name="properties"></a>屬性

**MDM \_ Policy \_ Config01 \_ Update02** 類別具有這些屬性。
