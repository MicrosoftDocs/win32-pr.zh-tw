---
description: Windows通訊端2提供泛型方法來利用傳輸的 multipoint 和多播功能。
...
如需有關各種 Multipoint 配置的特性，以及如何使用 Windows 通訊端2的適用功能，請參閱[Multipoint 和多播語義](multipoint-and-multicast-semantics-2.md)的詳細資訊。
