...
ms.locfileid: "119794688"
---
# <a name="sample-code-for-a-service-provider"></a>服務提供者的範例程式碼

本節包含的原始程式碼範例將示範如何使用新的、與通訊協定無關的 RNR 函式來執行 **GetXbyY** 函數。 開發人員應該將這些功能實作為起點。 為了符合 Windows 通訊端規格，需要更多的功能。
