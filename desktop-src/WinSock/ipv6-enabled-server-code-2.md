---
description: 下列程式碼是與 IP 無關的 Simples 檔案，它是支援 IPv6 的檔案版本。
ms.assetid: 5e27c731-c9c7-4c49-91bd-6f4dee60460b
title: IPv6-Enabled 伺服器程式碼
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104113056"
---
# <a name="ipv6-enabled-server-code"></a><span data-ttu-id="b7366-103">IPv6-Enabled 伺服器程式碼</span><span class="sxs-lookup"><span data-stu-id="b7366-103">IPv6-Enabled Server Code</span></span>

<span data-ttu-id="b7366-104">下列程式碼是與 IP 無關的 Simples 檔案，它是支援 IPv6 的檔案版本。</span><span class="sxs-lookup"><span data-stu-id="b7366-104">The following code is the IP-agnostic Server.c file, which is an IPv6-enabled version of the Simples.c file.</span></span>
