---
description: 下列程式碼是「IP 中立的用戶端 .c 檔案」，這是 Simplec 的已啟用 IPv6 的檔版本。
ms.assetid: a68439cd-0b27-447b-9766-e661c32eee09
title: IPv6-Enabled 用戶端程式代碼
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103943423"
---
# <a name="ipv6-enabled-client-code"></a><span data-ttu-id="929f3-103">IPv6-Enabled 用戶端程式代碼</span><span class="sxs-lookup"><span data-stu-id="929f3-103">IPv6-Enabled Client Code</span></span>

<span data-ttu-id="929f3-104">下列程式碼是「IP 中立的用戶端 .c 檔案」，這是 Simplec 的已啟用 IPv6 的檔版本。</span><span class="sxs-lookup"><span data-stu-id="929f3-104">The following code is the IP agnostic Client.c file, which is an IPv6-enabled version of the Simplec.c file.</span></span>
