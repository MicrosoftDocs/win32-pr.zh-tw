...
Windows 通訊端2引進重迭的 i/o，而且需要所有的傳輸提供者都支援這項功能。 只有在使用 [**WSPSocket**](/windows/desktop/api/Ws2spi/nc-ws2spi-lpwspsocket) 函式建立的通訊端上，會 \_ 設定 WSA 旗 \_ 標重迭旗標，並遵循 Windows 中所建立的模型，才能執行重迭的 i/o。
...
相關核心介面的描述不在 Windows 通訊端2規格的範圍內。
