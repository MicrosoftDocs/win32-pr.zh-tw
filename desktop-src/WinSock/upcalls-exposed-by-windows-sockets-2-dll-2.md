...
---
# <a name="upcalls-exposed-by-windows-sockets-2-dll"></a>由 Windows 通訊端 2 DLL 公開的 Upcalls
...
| [**WPUPostMessage**](/windows/desktop/api/Ws2spi/nf-ws2spi-wpupostmessage)                             | 以維護回溯相容性的方式執行標準 [**PostMessage**](/windows/win32/api/winuser/nf-winuser-postmessagea) 函式。 | 必要。                      | 僅限 Windows 2000 及 Windows NT。 Windows 95 允許來自核心模式的 post 訊息。                                                                                               |
