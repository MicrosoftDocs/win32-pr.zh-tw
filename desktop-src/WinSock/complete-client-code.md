...
ms.locfileid: "117741428"
---
# <a name="complete-winsock-client-code"></a>完成 Winsock 用戶端程式代碼

以下是基本 Winsock TCP/IP 用戶端應用程式的完整原始碼。

## <a name="winsock-client-source-code"></a>Winsock 用戶端原始程式碼
