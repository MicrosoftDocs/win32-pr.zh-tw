---
description: Windows通訊端 (Winsock) 和通訊協定獨立的 multipoint 和多播功能。
...
ms.locfileid: "118993618"
---
# <a name="protocol-independent-multicast-and-multipoint-in-the-spi"></a>在 SPI 中 Protocol-Independent 多播和 Multipoint

如同 Windows 通訊端2允許以一般方式存取許多傳輸通訊協定的基本資料傳輸功能，它也提供了一般的方式來使用可執行這些功能之傳輸的 multipoint 和多播功能。 為了簡化，此處會使用 *multipoint* 這一詞來參考多播和 multipoint 通訊。
