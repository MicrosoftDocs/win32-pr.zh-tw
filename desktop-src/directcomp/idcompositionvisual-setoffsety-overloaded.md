...
---
# <a name="idcompositionvisualsetoffsety-methods"></a>IDCompositionVisual：： SetOffsetY 方法

變更或繪製此視覺效果之 OffsetY 屬性值的動畫，並改變視覺效果相對於其父系的垂直位置。
...
| 方法                                                                                                | 描述                                           |
|:------------------------------------------------------------------------------------------------------|:------------------------------------------------------|
| [**SetOffsetY (float)**](/windows/win32/api/dcomp/nf-dcomp-idcompositionvisual-setoffsety(float))                                     | 變更 OffsetY 屬性的值。<br/> |
| [**SetOffsetY (IDCompositionAnimation \*)**](/windows/win32/api/dcomp/nf-dcomp-idcompositionvisual-setoffsety(idcompositionanimation)) | OffsetY 屬性值的動畫<br/> |
