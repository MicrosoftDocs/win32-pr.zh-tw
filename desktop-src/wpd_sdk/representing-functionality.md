...
在 Windows 7 作業系統中，服務會藉由提供豐富的功能查詢和抽象的內容群組，來擴充功能物件。 應用程式可以使用服務來探索裝置功能，並更有效率地與內容互動。 例如，應用程式可以藉由尋找連絡人服務物件，來查看裝置支援連絡人同步處理功能，並可將所有連絡人尋找為服務物件的子物件，而不需要以遞迴方式搜尋儲存體階層。
