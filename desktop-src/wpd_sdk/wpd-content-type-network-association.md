...
將其型別描述為 WPD \_ 內容 \_ 類型網路關聯的物件， \_ \_ 代表主機與裝置之間的關聯。
...
| [WPD \_ 物件 \_ 語言 \_ 區域變數](object-properties.md)                                                                                        | 選擇性。                                                             |
| [WPD \_ 網路 \_ 關聯 \_ 主機 \_ 網路 \_ 識別碼](network-association-properties.md) | 必要。                                                             |
| [WPD \_ 網路 \_ 關聯 \_ X509V3SEQUENCE](network-association-properties.md)                       | 選擇性。                                                             |
