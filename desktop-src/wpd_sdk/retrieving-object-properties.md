---
title: 正在抓取物件屬性總覽
description: 應用程式可以取出單一物件或多個物件的屬性。 瞭解單一物件的抓取。
...
ms.locfileid: "112409841"
---
# <a name="retrieving-object-properties-overview"></a>正在抓取物件屬性總覽

應用程式可以針對單一物件、物件識別碼所識別的多個物件，或相同類型的多個物件，取得其屬性。 下列主題描述單一物件的抓取。 如需多個物件的屬性抓取說明，請參閱「 [Advanced Tasks](advanced-tasks.md) 」一節。
