...
---
# <a name="wpd_content_type_folder"></a>WPD \_ 內容 \_ 類型 \_ 資料夾

將其類型描述為 WPD \_ 內容 \_ 類型資料夾的物件 \_ 代表資料夾。
...
| [WPD \_ 物件 \_ 提示 \_ 位置 \_ 顯示 \_ 名稱](miscellaneous-properties.md)      | 如果物件被識別為提示位置，則建議使用。                                                                                                                   |
| [WPD \_ 物件 \_ 可以 \_ 刪除](object-properties.md)                                                                     | 如果無法刪除物件，則為必要。                                                                                                                                     |
| [WPD \_ 物件 \_ 語言 \_ 地區設定](object-properties.md)                                                                | 選擇性。                                                                                                                                                                     |
| [\_允許 WPD 資料夾 \_ 內容 \_ 類型 \_](miscellaneous-properties.md)                 | 選擇性。 如果未包含，則資料夾可以接受任何內容類型。 如果包含，且集合是空的，則應用程式無法在該資料夾內建立子物件。 |
