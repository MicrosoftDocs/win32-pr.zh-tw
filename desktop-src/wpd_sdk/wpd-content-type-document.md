...
| [WPD \_ 媒體 \_ 來源 \_ URL](object-properties.md)                                                                      | 選擇性。                                                                      |
| [WPD \_ 媒體 \_ 目的地 \_ URL](object-properties.md)                                                                 | 選擇性。                                                                      |
| [WPD \_ 媒體 \_ 描述](object-properties.md)                                                                      | 選擇性。                                                                      |
| [WPD \_ 媒體內容類型 \_](object-properties.md)                                                                            | 選擇性。                                                                      |
| [WPD \_ 媒體 \_ 位元組 \_ 書簽](object-properties.md)                                                                   | 選擇性。                                                                      |
| [WPD \_ 媒體 \_ GUID](object-properties.md)                                                                             | 選擇性。                                                                      |
| [WPD \_ 媒體 \_ 子 \_ 描述](object-properties.md)                                                                 | 選擇性。                                                                      |
| [WPD \_ 一般 \_ 資訊](object-properties.md)                                                                     | 建議使用。                                                                   |
...
|--------------------------------------------------------|----------------------|---------------------------------|
| [**WPD \_ 資源 \_ 預設**](wpd-resource-default.md) | 必要             | 包含實體檔。 |
