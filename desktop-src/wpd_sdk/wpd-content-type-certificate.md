...
ms.locfileid: "120109858"
---
# <a name="wpd_content_type_certificate"></a>WPD \_ 內容 \_ 類型 \_ 憑證

將其類型描述為 WPD \_ 內容類型憑證的物件， \_ \_ 代表用於驗證的憑證。
...
|--------------------------------------------------------|----------------------|--------------------|
| [**WPD \_ 資源 \_ 預設**](wpd-resource-default.md) | 必要。            | 包含資料。 |
