---
description: 發出 GetDevicePropValue 命令
...
---
# <a name="issuing-the-getdevicepropvalue-command"></a><span data-ttu-id="9732d-103">發出 GetDevicePropValue 命令</span><span class="sxs-lookup"><span data-stu-id="9732d-103">Issuing the GetDevicePropValue Command</span></span>

<span data-ttu-id="9732d-104">此區段中的範例會叫用 **GetDevicePropValue** MTP 命令以取得 **BatteryLevel** 裝置屬性。</span><span class="sxs-lookup"><span data-stu-id="9732d-104">The example in this section invokes the **GetDevicePropValue** MTP command to retrieve the **BatteryLevel** device property.</span></span> <span data-ttu-id="9732d-105"> (如需此命令及其參數的完整描述，請參閱 [MTP 規格](https://www.usb.org/sites/default/files/MTPv1_1.zip)。 ) </span><span class="sxs-lookup"><span data-stu-id="9732d-105">(For a complete description of this command and its parameters, see the [MTP specification](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span></span>

<span data-ttu-id="9732d-106">在 **GetDevicePropValue** 的案例中，範例程式碼會使用下列順序：</span><span class="sxs-lookup"><span data-stu-id="9732d-106">In the case of **GetDevicePropValue**, the sample code uses the following sequence:</span></span>

1.  <span data-ttu-id="9732d-107">WPD \_ 命令 \_ MTP \_ EXT \_ EXECUTE \_ 命令 \_ 與 \_ \_ 要 \_ 讀取的資料</span><span class="sxs-lookup"><span data-stu-id="9732d-107">WPD\_COMMAND\_MTP\_EXT\_EXECUTE\_COMMAND\_WITH\_DATA\_TO\_READ</span></span>
2.  <span data-ttu-id="9732d-108">WPD \_ 命令 \_ MTP \_ EXT \_ 讀取 \_ 資料</span><span class="sxs-lookup"><span data-stu-id="9732d-108">WPD\_COMMAND\_MTP\_EXT\_READ\_DATA</span></span>
3.  <span data-ttu-id="9732d-109">WPD \_ 命令 \_ MTP \_ EXT \_ END \_ DATA \_ TRANSFER</span><span class="sxs-lookup"><span data-stu-id="9732d-109">WPD\_COMMAND\_MTP\_EXT\_END\_DATA\_TRANSFER</span></span>

<span data-ttu-id="9732d-110">下列程式碼範例顯示應用程式如何 initates 命令順序。</span><span class="sxs-lookup"><span data-stu-id="9732d-110">The following code example shows how the application initates the command sequence.</span></span>
...
<span data-ttu-id="9732d-111">下列程式碼範例會顯示應用程式如何抓取屬性資料。</span><span class="sxs-lookup"><span data-stu-id="9732d-111">The following code example shows how the application retrieves the property data.</span></span>
...
<span data-ttu-id="9732d-112">下列程式碼範例會示範應用程式如何抓取裝置回應至命令。</span><span class="sxs-lookup"><span data-stu-id="9732d-112">The following code example shows how the application retrieves the device response to the command.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="9732d-113">相關主題</span><span class="sxs-lookup"><span data-stu-id="9732d-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="9732d-114">支援 MTP 擴充功能</span><span class="sxs-lookup"><span data-stu-id="9732d-114">Supporting MTP Extensions</span></span>](supporting-mtp-extensions.md)
</dt> </dl>
