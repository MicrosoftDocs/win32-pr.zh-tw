...
此區段中的範例會叫用 **GetDevicePropValue** MTP 命令以取得 **BatteryLevel** 裝置屬性。  (如需此命令及其參數的完整描述，請參閱 [MTP 規格](https://www.usb.org/sites/default/files/MTPv1_1.zip)。 ) 

在 **GetDevicePropValue** 的案例中，範例程式碼會使用下列順序：

1.  WPD \_ 命令 \_ MTP \_ EXT \_ EXECUTE \_ 命令 \_ 與 \_ \_ 要 \_ 讀取的資料
2.  WPD \_ 命令 \_ MTP \_ EXT \_ 讀取 \_ 資料
3.  WPD \_ 命令 \_ MTP \_ EXT \_ END \_ DATA \_ TRANSFER

下列程式碼範例顯示應用程式如何 initates 命令順序。
