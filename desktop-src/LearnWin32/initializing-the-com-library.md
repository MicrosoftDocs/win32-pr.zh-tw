...
ms.locfileid: "119979988"
---
# <a name="initializing-the-com-library"></a>初始化 COM 程式庫

使用 COM 的任何 Windows 程式都必須藉由呼叫 [**CoInitializeEx**](/windows/desktop/api/combaseapi/nf-combaseapi-coinitializeex)函式來初始化 COM 程式庫。 使用 COM 介面的每個執行緒都必須對此函式進行個別呼叫。 **CoInitializeEx** 具有下列簽章：
