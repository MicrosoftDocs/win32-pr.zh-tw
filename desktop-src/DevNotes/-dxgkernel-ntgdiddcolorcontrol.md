...
代表重迭表面之 [**DD \_ 介面 \_ 區域**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) 結構的控制碼。
...
[**DD \_ COLORCONTROLDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_colorcontroldata)結構的指標，其中包含指定之重迭表面的色彩控制項資訊。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdColorControl** 會傳回下列其中一個回呼碼。
