...
[DD \_ 介面 \_ 區域](https://msdn.microsoft.com/library/ms793861.aspx)結構的控制碼，表示正在查詢其 array.blit 狀態的介面。
...
[DD \_ GETBLTSTATUSDATA](https://msdn.microsoft.com/library/ms794243.aspx)結構的指標，其中包含執行 array.blit 狀態查詢所需的資訊。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdGetBltStatus** 會傳回下列其中一個回呼碼。
