...
[DD \_ 介面 \_ 區域](https://msdn.microsoft.com/library/ms793861.aspx)結構的控制碼，描述正在查詢其翻轉狀態的介面。
...
[DD \_ GETFLIPSTATUSDATA](https://msdn.microsoft.com/library/ms793859.aspx)結構的指標，其中包含執行 flip status 查詢所需的資訊。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdGetFlipStatus** 會傳回下列其中一個回呼碼。
