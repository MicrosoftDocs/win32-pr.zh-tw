...
---
# <a name="ntgdiddblt-function"></a>NtGdiDdBlt 函式
...
[**DD \_ 介面 \_ 區域**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local)結構的控制碼，描述要 array.blit 的介面。
...
描述來源介面之 [**DD \_ 介面 \_ 區域**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) 結構的控制碼。
...
[**DD \_ BLTDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_bltdata)結構的指標，其中包含驅動程式執行 array.blit 所需的資訊。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdBlt** 會傳回下列其中一個回呼碼。
