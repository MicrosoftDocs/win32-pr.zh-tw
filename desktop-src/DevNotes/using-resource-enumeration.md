---
description: 下列範例示範如何使用 VerifierEnumerateResource 函式和相關的程式設計專案，以抽象化和分類進程特定的資源資訊。
...
---
# <a name="using-resource-enumeration"></a><span data-ttu-id="5fa0b-103">使用資源列舉</span><span class="sxs-lookup"><span data-stu-id="5fa0b-103">Using Resource Enumeration</span></span>

<span data-ttu-id="5fa0b-104">下列範例示範如何使用 [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) 函式和相關的程式設計專案，以抽象化和分類進程特定的資源資訊。</span><span class="sxs-lookup"><span data-stu-id="5fa0b-104">The following example shows how to use the [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) function and related programming elements to abstract and categorize process-specific resource information.</span></span>
