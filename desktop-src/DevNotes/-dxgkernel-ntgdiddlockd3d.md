...
[**DD \_ 介面 \_ 區域**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local)結構的指標，描述與要鎖定之記憶體區域相關聯的介面。
