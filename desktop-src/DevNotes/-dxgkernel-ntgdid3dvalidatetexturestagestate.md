...
[**D3DNTHAL \_ VALIDATETEXTURESTAGESTATEDATA**](/windows-hardware/drivers/ddi/)結構的指標，其中包含驅動程式所需的資訊，以決定和傳回執行混色作業所需的行程數目。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiD3DValidateTextureStageState** 會傳回下列其中一個回呼碼。
