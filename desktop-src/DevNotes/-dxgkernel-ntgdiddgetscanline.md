...
ms.locfileid: "118004218"
---
# <a name="ntgdiddgetscanline-function"></a>NtGdiDdGetScanLine 函式
...
[**DD \_ GETSCANLINEDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getscanlinedata)結構的指標，其中驅動程式會傳回目前掃描行的編號。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdGetScanLine** 會傳回下列其中一個回呼碼。
