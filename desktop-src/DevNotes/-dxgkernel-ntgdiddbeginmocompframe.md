...
ms.locfileid: "120087998"
---
# <a name="ntgdiddbeginmocompframe-function"></a>NtGdiDdBeginMoCompFrame 函式
...
[**DD \_ BEGINMOCOMPFRAMEDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_beginmocompframedata)結構的指標，其中包含開始解碼新框架所需的資訊。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdBeginMoCompFrame** 會傳回下列其中一個回呼碼。
