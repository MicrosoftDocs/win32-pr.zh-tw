...
---
# <a name="ntgdiddgetmocompformats-function"></a>NtGdiDdGetMoCompFormats 函式
...
[**DD \_ GETMOCOMPFORMATSDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getmocompformatsdata)結構的指標，其中包含硬體未壓縮的格式資訊。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdGetMoCompFormats** 會傳回下列其中一個回呼碼。
