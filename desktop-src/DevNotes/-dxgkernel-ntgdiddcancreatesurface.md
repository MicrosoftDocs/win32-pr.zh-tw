...
[**DD \_ CANCREATESURFACEDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_cancreatesurfacedata)結構的指標，其中包含驅動程式判斷是否可以建立介面所需的資訊。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdCanCreateSurface** 會傳回下列其中一個回呼碼。
