...
ms.locfileid: "118956497"
---
# <a name="ntgdiddendmocompframe-function"></a>NtGdiDdEndMoCompFrame 函式
...
[DD \_ MOTIONCOMP \_ 本機](https://msdn.microsoft.com/library/ms794211.aspx)結構的控制碼，其中包含所要求之動作補償的描述。
...
[DD \_ ENDMOCOMPFRAMEDATA](https://msdn.microsoft.com/library/ms793897.aspx)結構的指標，其中包含完成已解碼框架所需的資訊。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdEndMoCompFrame** 會傳回下列其中一個回呼碼。
