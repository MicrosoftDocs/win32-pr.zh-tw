...
ms.locfileid: "120108938"
---
# <a name="ntgdiddupdateoverlay-function"></a>NtGdiDdUpdateOverlay 函式
...
描述重迭表面之 [**DD \_ 介面 \_ 區域**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) 結構的控制碼。
...
[**DD \_ UPDATEOVERLAYDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_updateoverlaydata)結構的指標，其中包含更新覆迭所需的資訊。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdUpdateOverlay** 會傳回下列其中一個回呼碼。
