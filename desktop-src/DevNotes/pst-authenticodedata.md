...
| <span id="PST_AC_IMMEDIATE_CALLER"></span><span id="pst_ac_immediate_caller"></span><dl> <dt>**PST \_AC \_ 立即 \_ 呼叫者**</dt> <dt>2</dt> </dl>  | 立即呼叫端必須通過檢查，但不需要是最上層的進程。 指定的影像是立即呼叫端，而映射可以是應用程式 (.exe) 或 DLL。<br/> |
