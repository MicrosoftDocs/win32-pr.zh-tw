...
ms.locfileid: "117828019"
---
# <a name="ntgdiddgetmocompguids-function"></a>NtGdiDdGetMoCompGuids 函式
...
包含 **GUID** 資訊之 [**DD \_ GETMOCOMPGUIDSDATA**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getmocompguidsdata)結構的指標。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdGetMoCompGuids** 會傳回下列其中一個回呼碼。
