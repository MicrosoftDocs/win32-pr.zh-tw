...
ms.locfileid: "119076102"
---
# <a name="offline-registry-library"></a>離線登錄庫

## <a name="purpose"></a>目的

離線登錄庫 (Offreg.dll) 用來修改作用中系統登錄之外的登錄 hive。 此程式庫適用于登錄更新案例，例如服務作業系統映射。 此程式庫支援從 Windows Vista 開始的登錄 hive 格式。
...
Offreg.dll Windows 驅動程式套件 (WDK) ，適用于 Windows 10 和舊版的 Windows 作業系統。
