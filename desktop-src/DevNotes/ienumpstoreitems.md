...
**IEnumPStoreItems** 介面繼承自 [**IUnknown**](/windows/win32/api/unknwn/nn-unknwn-iunknown)介面。 **IEnumPStoreItems** 也有下列類型的成員：

-   [方法](#methods)

### <a name="methods"></a>方法

**IEnumPStoreItems** 介面具有這些方法。
...
列舉之後，必須釋放每個專案。 當您不再使用列舉值物件時，也必須釋放它。
