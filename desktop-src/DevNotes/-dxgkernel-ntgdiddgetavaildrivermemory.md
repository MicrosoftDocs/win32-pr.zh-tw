...
[DD \_ GETAVAILDRIVERMEMORYDATA](https://msdn.microsoft.com/library/ms794088.aspx)結構的指標，其中包含執行查詢所需的資訊。

</dd> </dl>

## <a name="return-value"></a>傳回值

**NtGdiDdGetAvailDriverMemory** 會傳回下列其中一個回呼碼。
