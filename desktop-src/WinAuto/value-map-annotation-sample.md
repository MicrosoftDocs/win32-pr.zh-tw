...
---
# <a name="value-map-annotation-sample"></a><span data-ttu-id="78c89-103">值對應注釋範例</span><span class="sxs-lookup"><span data-stu-id="78c89-103">Value Map Annotation Sample</span></span>

<span data-ttu-id="78c89-104">剪下、貼上和修改下列程式碼範例，以供您自己使用。</span><span class="sxs-lookup"><span data-stu-id="78c89-104">Cut, paste, and modify the following code sample for your own use.</span></span> <span data-ttu-id="78c89-105">遵循標示為/TODO/的批註中的指示 \* \* 。</span><span class="sxs-lookup"><span data-stu-id="78c89-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
