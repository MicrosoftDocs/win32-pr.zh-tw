...
ms.locfileid: "106968210"
---
# <a name="server-annotation-sample"></a><span data-ttu-id="2e049-103">伺服器批註範例</span><span class="sxs-lookup"><span data-stu-id="2e049-103">Server Annotation Sample</span></span>

<span data-ttu-id="2e049-104">以下是伺服器批註的範例。</span><span class="sxs-lookup"><span data-stu-id="2e049-104">The following is an example of server annotation.</span></span> <span data-ttu-id="2e049-105">遵循標示為/TODO/的批註中的指示 \* \* 。</span><span class="sxs-lookup"><span data-stu-id="2e049-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
