---
title: 附錄 C IAccessible Dispid
description: DISPID 能讓 IDispatch 的執行查詢不同的雙重介面方法和屬性。
...
ms.locfileid: "104183541"
---
# <a name="appendix-c-iaccessible-dispids"></a><span data-ttu-id="68428-103">附錄 C： IAccessible Dispid</span><span class="sxs-lookup"><span data-stu-id="68428-103">Appendix C: IAccessible DISPIDs</span></span>

<span data-ttu-id="68428-104">DISPID 能讓 [**IDispatch**](idispatch-interface.md) 的執行查詢不同的雙重介面方法和屬性。</span><span class="sxs-lookup"><span data-stu-id="68428-104">A DISPID allows the implementation of the [**IDispatch**](idispatch-interface.md) to look up the various methods and properties of a dual interface.</span></span>
