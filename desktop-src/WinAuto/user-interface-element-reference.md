---
title: 消費者介面元素參考
description: 下表列出由 Microsoft Active Accessibility 提供的系統提供的使用者介面元素。
...
下表列出由 Microsoft Active Accessibility 提供的系統提供的使用者介面元素。
...
| [**標題控制項**](header-control.md)           | [**切換視窗**](switch-window.md)               |
| [**快速鍵控制項**](hot-key-control.md)         | [**索引標籤控制項**](tab-control.md)                   |
| [**清單方塊**](list-box.md)                       | [**Toolbar 控制項**](toolbar-control.md)           |
| [**清單視圖控制項**](list-view-control.md)     | [**Tooltip 控制項**](tooltip-control.md)           |
| [**MDI 用戶端視窗**](mdi-client-window.md)     | [**標題列**](title-bar.md)                       |
| [**功能表列**](menu-bar.md)                       | [**樹狀檢視控制項**](tree-view-control.md)       |
| [**功能表項目**](menu-item.md)                     | [**由上而下控制項**](up-down-control.md)           |
| [**月曆控制項**](calendar-control.md) | [**視窗**](window.md)                             |
