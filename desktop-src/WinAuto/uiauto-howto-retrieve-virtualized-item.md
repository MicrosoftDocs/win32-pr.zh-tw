...
---
# <a name="how-to-retrieve-a-virtualized-item"></a><span data-ttu-id="c47ea-103">如何取出虛擬化專案</span><span class="sxs-lookup"><span data-stu-id="c47ea-103">How to Retrieve a Virtualized Item</span></span>

<span data-ttu-id="c47ea-104">本主題包含範例程式碼，示範如何尋找及取出控制項中虛擬化專案的 UI 資訊。</span><span class="sxs-lookup"><span data-stu-id="c47ea-104">This topic contains example code that shows how to find and retrieve UI information about virtualized items in a control.</span></span>


<span data-ttu-id="c47ea-105">下列範例會在容器中搜尋具有指定名稱的專案，並抓取該專案的 [**IUIAutomationElement**](/windows/desktop/api/UIAutomationClient/nn-uiautomationclient-iuiautomationelement) 介面。</span><span class="sxs-lookup"><span data-stu-id="c47ea-105">The following example searches a container for an item that has the specified name and retrieves the [**IUIAutomationElement**](/windows/desktop/api/UIAutomationClient/nn-uiautomationclient-iuiautomationelement) interface for the item.</span></span> <span data-ttu-id="c47ea-106">此範例會先在消費者介面自動化子樹中尋找。</span><span class="sxs-lookup"><span data-stu-id="c47ea-106">The example looks in the UI Automation subtree first.</span></span> <span data-ttu-id="c47ea-107">如果專案不存在，此範例會使用容器 [**IUIAutomationItemContainerPattern**](/windows/desktop/api/UIAutomationClient/nn-uiautomationclient-iuiautomationitemcontainerpattern) 介面尋找專案，然後使用專案 [**IUIAutomationVirtualizedItemPattern**](/windows/desktop/api/UIAutomationClient/nn-uiautomationclient-iuiautomationvirtualizeditempattern) 介面來實現專案。</span><span class="sxs-lookup"><span data-stu-id="c47ea-107">If the item is not there, the example uses the container [**IUIAutomationItemContainerPattern**](/windows/desktop/api/UIAutomationClient/nn-uiautomationclient-iuiautomationitemcontainerpattern) interface to find the item, and then uses the item [**IUIAutomationVirtualizedItemPattern**](/windows/desktop/api/UIAutomationClient/nn-uiautomationclient-iuiautomationvirtualizeditempattern) interface to realize the item.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="c47ea-108">相關主題</span><span class="sxs-lookup"><span data-stu-id="c47ea-108">Related topics</span></span>

<dl> <dt>

<span data-ttu-id="c47ea-109">**概念**</span><span class="sxs-lookup"><span data-stu-id="c47ea-109">**Conceptual**</span></span>
</dt> <dt>

[<span data-ttu-id="c47ea-110">使用虛擬化專案</span><span class="sxs-lookup"><span data-stu-id="c47ea-110">Working with Virtualized Items</span></span>](uiauto-workingwithvirtualizeditems.md)
</dt> <dt>

[<span data-ttu-id="c47ea-111">消費者介面自動化用戶端的使用說明主題</span><span class="sxs-lookup"><span data-stu-id="c47ea-111">How-To Topics for UI Automation Clients</span></span>](uiauto-howto-topics-for-uiautomation-clients.md)
</dt> </dl>
