...
本節說明 UI 協助工具檢查程式 (AccChecker) 的驗證記錄訊息。

## <a name="in-this-section"></a>本節內容

-   [AccessibleObjectFromPointReturnedNullIAccessible](accessibleobjectfrompointreturnednulliaccessible.md)
-   [AccessibleObjectFromPointReturnedNot \_ S \_ 沒問題](accessibleobjectfrompointreturnednot-s-ok.md)
...
-   [ARIA 資料表錯誤](aria-table-name-and-header.md)
-   [ARIA 資料表格警告](aria-data-table-description.md)
-   [ARIA 方格結構錯誤](aria-grid-structure.md)
-   [ARIA 標籤錯誤](aria-label.md)
-   [ARIA 展示表錯誤](aria-layout-table.md)
...
-   [具有事件處理常式之元素的 ARIA 角色錯誤](aria-role-missing.md)
-   [ARIA Tabindex 錯誤](aria-click-tabindex.md)
...
-   [DragPattern/DragDropPattern 元素需要名稱](dragpattern-dragdroppattern-elements-requires-name-.md)
-   [DragPattern/DragDropPattern 元素需要有效的 DropEffect](dragpattern-dragdroppattern-elements-requires-valid-dropeffect.md)
