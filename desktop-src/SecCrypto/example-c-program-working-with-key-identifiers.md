---
description: 範例 C 程式：使用金鑰識別碼
ms.assetid: 5ca160fd-8a63-46fa-99ce-e01a6acb81f4
title: 範例 C 程式：使用金鑰識別碼
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106989010"
---
# <a name="example-c-program-working-with-key-identifiers"></a><span data-ttu-id="98d87-103">範例 C 程式：使用金鑰識別碼</span><span class="sxs-lookup"><span data-stu-id="98d87-103">Example C Program: Working with Key Identifiers</span></span>

<span data-ttu-id="98d87-104">下列範例示範使用金鑰識別碼的方式。</span><span class="sxs-lookup"><span data-stu-id="98d87-104">The following example demonstrates ways of working with key identifiers.</span></span> <span data-ttu-id="98d87-105">此範例說明下列工作和 CryptoAPI 函數：</span><span class="sxs-lookup"><span data-stu-id="98d87-105">This example illustrates the following tasks and CryptoAPI functions:</span></span>

-   <span data-ttu-id="98d87-106">使用 [**CryptCreateKeyIdentifierFromCSP**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcreatekeyidentifierfromcsp)建立金鑰識別碼。</span><span class="sxs-lookup"><span data-stu-id="98d87-106">Creating a key identifier using [**CryptCreateKeyIdentifierFromCSP**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcreatekeyidentifierfromcsp).</span></span>
-   <span data-ttu-id="98d87-107">使用 [**CryptSetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetkeyidentifierproperty)設定金鑰識別碼的屬性。</span><span class="sxs-lookup"><span data-stu-id="98d87-107">Setting a property on a key identifier using [**CryptSetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetkeyidentifierproperty).</span></span>
-   <span data-ttu-id="98d87-108">使用 [**CryptGetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetkeyidentifierproperty)抓取金鑰識別碼屬性的內容。</span><span class="sxs-lookup"><span data-stu-id="98d87-108">Retrieving the contents of a key identifier property using [**CryptGetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetkeyidentifierproperty).</span></span>
-   <span data-ttu-id="98d87-109">使用 [**CryptEnumKeyIdentifierProperties**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptenumkeyidentifierproperties)列出金鑰識別碼的屬性。</span><span class="sxs-lookup"><span data-stu-id="98d87-109">Listing the properties of a key identifier using [**CryptEnumKeyIdentifierProperties**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptenumkeyidentifierproperties).</span></span>
-   <span data-ttu-id="98d87-110">宣告、定義和使用回呼函數。</span><span class="sxs-lookup"><span data-stu-id="98d87-110">Declaring, defining, and using a callback function.</span></span>
