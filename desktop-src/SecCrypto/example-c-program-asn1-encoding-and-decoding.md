---
description: 顯示使用 CryptEncodeObjectEx 和 CryptDecodeObjectEx。
...
---
# <a name="example-c-program-asn1-encoding-and-decoding"></a><span data-ttu-id="9818f-103">範例 C 程式： asn.1 編碼和解碼</span><span class="sxs-lookup"><span data-stu-id="9818f-103">Example C Program: ASN.1 Encoding and Decoding</span></span>

<span data-ttu-id="9818f-104">下列範例示範如何使用 [**CryptEncodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) 和 [**CryptDecodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex)。</span><span class="sxs-lookup"><span data-stu-id="9818f-104">The following example shows using [**CryptEncodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) and [**CryptDecodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex).</span></span> <span data-ttu-id="9818f-105">您可以輕鬆地修改此範例，以使用 [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) 和 [**CryptDecodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject)。</span><span class="sxs-lookup"><span data-stu-id="9818f-105">This example can easily be modified to use [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) and [**CryptDecodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).</span></span>

<span data-ttu-id="9818f-106">此範例也會使用修改過的函式版本 [**ByteToStr**](bytetostr.md) 來列印 [*抽象語法標記法 (一)*](../secgloss/a-gly.md) (asn.1) 編碼的八位數列。</span><span class="sxs-lookup"><span data-stu-id="9818f-106">This example also uses a modified version of the function [**ByteToStr**](bytetostr.md) to print an [*Abstract Syntax Notation One*](../secgloss/a-gly.md) (ASN.1) encoded series of octets.</span></span> <span data-ttu-id="9818f-107">它也會使用 [**MyHandleError**](myhandleerror.md)。</span><span class="sxs-lookup"><span data-stu-id="9818f-107">It also uses [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="9818f-108">範例中包含這些函式的程式碼。</span><span class="sxs-lookup"><span data-stu-id="9818f-108">Code for these functions is included with the sample.</span></span>
