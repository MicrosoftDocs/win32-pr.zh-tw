...
---
# <a name="extendedpropertypropid-property"></a>ExtendedProperty. PropID 屬性
...
定義 CAPICOM 屬性識別碼之 [**capicom \_ PROPID**](capicom-propid.md) 列舉的值。 下表顯示可能的值。
