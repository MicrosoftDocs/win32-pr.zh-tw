---
description: 擴充功能的 \_ NewEnum 屬性會在可用來列舉集合的物件上，捕獲 IEnumVARIANT 介面。 這個屬性會在 Visual Basic 腳本版本 (VBScript) 中隱藏。
...
ms.locfileid: "119006816"
---
# <a name="extensions_newenum-property"></a>延伸模組。 \_NewEnum 屬性
