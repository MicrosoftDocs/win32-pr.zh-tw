---
description: 列舉系統憑證存放區位置、系統憑證存放區，以及與每個系統存放區相關聯的實體存放區。
...
---
# <a name="example-c-program-listing-system-and-physical-stores"></a><span data-ttu-id="0eeba-103">範例 C 程式：列出系統和實體存放區</span><span class="sxs-lookup"><span data-stu-id="0eeba-103">Example C Program: Listing System and Physical Stores</span></span>

<span data-ttu-id="0eeba-104">下列範例會列舉系統 [*憑證存放區*](../secgloss/c-gly.md) 位置、系統憑證存放區，以及與每個系統存放區相關聯的實體存放區。</span><span class="sxs-lookup"><span data-stu-id="0eeba-104">The following example enumerates the system [*certificate store*](../secgloss/c-gly.md) locations, the system certificate stores, and the physical stores associated with each system store.</span></span> <span data-ttu-id="0eeba-105">這個範例示範如何建立回呼函式，以及呼叫其他回呼函數的回呼函數。</span><span class="sxs-lookup"><span data-stu-id="0eeba-105">This example demonstrates the creation of callback functions and callback functions that call other callback functions.</span></span>

<span data-ttu-id="0eeba-106">此範例說明下列 [*CryptoAPI*](../secgloss/c-gly.md) 函數：</span><span class="sxs-lookup"><span data-stu-id="0eeba-106">This example illustrates the following [*CryptoAPI*](../secgloss/c-gly.md) functions:</span></span>

-   [<span data-ttu-id="0eeba-107">**CertEnumSystemStoreLocation**</span><span class="sxs-lookup"><span data-stu-id="0eeba-107">**CertEnumSystemStoreLocation**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumsystemstorelocation)
-   [<span data-ttu-id="0eeba-108">**CertEnumSystemStore**</span><span class="sxs-lookup"><span data-stu-id="0eeba-108">**CertEnumSystemStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumsystemstore)

<span data-ttu-id="0eeba-109">此範例也會使用函數 [**MyHandleError**](myhandleerror.md)。</span><span class="sxs-lookup"><span data-stu-id="0eeba-109">This example also uses the function [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="0eeba-110">此範例包含此函式的程式碼。</span><span class="sxs-lookup"><span data-stu-id="0eeba-110">Code for this function is included with the sample.</span></span> <span data-ttu-id="0eeba-111">這項功能和其他輔助函式的程式碼也會列在 [一般用途](general-purpose-functions.md)的函式底下。</span><span class="sxs-lookup"><span data-stu-id="0eeba-111">Code for this and other auxiliary functions is also listed under [General Purpose Functions](general-purpose-functions.md).</span></span>
