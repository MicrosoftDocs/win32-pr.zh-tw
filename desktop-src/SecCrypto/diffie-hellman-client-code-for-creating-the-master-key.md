...
---
# <a name="diffie-hellman-client-code-for-creating-the-master-key"></a>建立主要金鑰 Diffie-Hellman 用戶端程式代碼

下列範例顯示用來建立 [*主要金鑰*](../secgloss/m-gly.md)的一般 [*diffie-hellman*](../secgloss/d-gly.md)/Schannel 用戶端程式代碼。
