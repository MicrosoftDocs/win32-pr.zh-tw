---
description: 下列範例顯示一般 Diffie-hellman/Schannel 用戶端程式代碼，用來建立主要金鑰。
ms.assetid: 37b35cd6-b3c9-4a75-83a9-129bcf7a84a3
title: 建立主要金鑰 Diffie-Hellman 用戶端程式代碼
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104321036"
---
# <a name="diffie-hellman-client-code-for-creating-the-master-key"></a><span data-ttu-id="91d4e-103">建立主要金鑰 Diffie-Hellman 用戶端程式代碼</span><span class="sxs-lookup"><span data-stu-id="91d4e-103">Diffie-Hellman Client Code for Creating the Master Key</span></span>

<span data-ttu-id="91d4e-104">下列範例顯示用來建立 [*主要金鑰*](../secgloss/m-gly.md)的一般 [*diffie-hellman*](../secgloss/d-gly.md)/Schannel 用戶端程式代碼。</span><span class="sxs-lookup"><span data-stu-id="91d4e-104">The following example shows typical [*Diffie-Hellman*](../secgloss/d-gly.md)/Schannel client-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
