---
description: 取得和設定憑證屬性，並說明下列工作和 CryptoAPI 函數。
...
---
# <a name="example-c-program-getting-and-setting-certificate-properties"></a><span data-ttu-id="3855c-103">範例 C 程式：取得和設定憑證屬性</span><span class="sxs-lookup"><span data-stu-id="3855c-103">Example C Program: Getting and Setting Certificate Properties</span></span>

<span data-ttu-id="3855c-104">下列範例會取得並設定憑證屬性，並說明下列工作和 [*CryptoAPI*](../secgloss/c-gly.md) 函數。</span><span class="sxs-lookup"><span data-stu-id="3855c-104">The following example gets and sets certificate properties, and illustrates the following tasks and [*CryptoAPI*](../secgloss/c-gly.md) functions.</span></span>

-   <span data-ttu-id="3855c-105">使用 [**CertOpenSystemStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea)開啟系統存放區。</span><span class="sxs-lookup"><span data-stu-id="3855c-105">Opening a system store by using [**CertOpenSystemStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea).</span></span>
-   <span data-ttu-id="3855c-106">使用 [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) 列出開啟存放區中的所有憑證。</span><span class="sxs-lookup"><span data-stu-id="3855c-106">Using [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) to list all of the certificates in the open store.</span></span>
-   <span data-ttu-id="3855c-107">使用 [**CertGetNameString**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa)從憑證中取出主體名稱，並加以列印。</span><span class="sxs-lookup"><span data-stu-id="3855c-107">Retrieving and printing the subject name from the certificate by using [**CertGetNameString**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa).</span></span>
-   <span data-ttu-id="3855c-108">使用 [**CertAddEnhancedKeyUsageIdentifier**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddenhancedkeyusageidentifier)函式在憑證上設定 [*增強金鑰使用*](../secgloss/e-gly.md)方法屬性。</span><span class="sxs-lookup"><span data-stu-id="3855c-108">Setting the [*enhanced key usage*](../secgloss/e-gly.md) property on certificates by using the [**CertAddEnhancedKeyUsageIdentifier**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddenhancedkeyusageidentifier) function.</span></span>
-   <span data-ttu-id="3855c-109">使用 [**CertSetCertificateCoNtextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certsetcertificatecontextproperty)設定憑證的 [顯示名稱] 屬性。</span><span class="sxs-lookup"><span data-stu-id="3855c-109">Setting the display name property on the certificate by using [**CertSetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certsetcertificatecontextproperty).</span></span>
-   <span data-ttu-id="3855c-110">使用 [**CertGetCertificateCoNtextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetcertificatecontextproperty)來取出憑證的屬性。</span><span class="sxs-lookup"><span data-stu-id="3855c-110">Retrieving a certificate's properties by using [**CertGetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetcertificatecontextproperty).</span></span>
-   <span data-ttu-id="3855c-111">使用 [**CertCloseStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) 搭配 CERT \_ CLOSE \_ store \_ 檢查旗標旗標來關閉憑證存放區 \_ 。</span><span class="sxs-lookup"><span data-stu-id="3855c-111">Closing a certificate store by using [**CertCloseStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) with the CERT\_CLOSE\_STORE\_CHECK\_FLAG flag.</span></span>
