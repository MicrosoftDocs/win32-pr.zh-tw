---
description: 下列範例顯示憑證註冊控制項如何與 ICertRequest 物件搭配使用，以建立並提交憑證要求。
...
ms.locfileid: "104386239"
---
# <a name="request-sample-in-c"></a><span data-ttu-id="a445b-103">C + + 中的要求範例</span><span class="sxs-lookup"><span data-stu-id="a445b-103">Request Sample in C++</span></span>

<span data-ttu-id="a445b-104">下列範例顯示憑證註冊控制項如何與 [**ICertRequest**](/windows/desktop/api/Certcli/nn-certcli-icertrequest) 物件搭配使用，以建立並提交憑證要求。</span><span class="sxs-lookup"><span data-stu-id="a445b-104">The following example shows how the Certificate Enrollment Control can be used with the [**ICertRequest**](/windows/desktop/api/Certcli/nn-certcli-icertrequest) object to create and submit a certificate request.</span></span>
