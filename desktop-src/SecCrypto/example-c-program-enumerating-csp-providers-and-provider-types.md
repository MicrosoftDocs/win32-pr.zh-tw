...
ms.locfileid: "119007646"
---
# <a name="example-c-program-enumerating-csp-providers-and-provider-types"></a>範例 C 程式：列舉 CSP 提供者和提供者類型

下列範例會列出電腦上可用的 Csp，並使用下列 [*CryptoAPI*](../secgloss/c-gly.md) 函數：
...
這個範例會使用 [**MyHandleError**](myhandleerror.md)函數。 此範例包含此函式的程式碼。 這項功能和其他輔助函式的程式碼也會列在 [一般用途](general-purpose-functions.md)的函式底下。
