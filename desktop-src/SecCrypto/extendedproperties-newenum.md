---
description: '\_ExtendedProperties 的 NewEnum 屬性會抓取可以用來列舉集合之物件上的 IEnumVARIANT 介面。 這個屬性會在 Visual Basic 腳本版本 (VBScript) 中隱藏。'
...
ms.locfileid: "119007206"
---
# <a name="extendedproperties_newenum-property"></a>ExtendedProperties。 \_NewEnum 屬性
