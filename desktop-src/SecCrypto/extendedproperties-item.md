...
ms.locfileid: "119007256"
---
# <a name="extendedpropertiesitem-property"></a>ExtendedProperties 專案屬性
...
**Item** 屬性會從集合中抓取 [**ExtendedProperty**](extendedproperty.md)物件。 這是預設屬性。
...
[**ExtendedProperty**](extendedproperty.md)物件，表示集合的索引延伸屬性。
