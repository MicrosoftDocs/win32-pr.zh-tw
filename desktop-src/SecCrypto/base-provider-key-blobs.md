...
基底提供者和延伸的提供者會使用相同的 [*金鑰 blob*](../secgloss/k-gly.md)。
...
[*公開金鑰 blob*](../secgloss/p-gly.md)（類型 **PUBLICKEYBLOB**）是用來將 [*公開金鑰*](../secgloss/p-gly.md) 儲存在 [*密碼編譯服務提供者*](../secgloss/c-gly.md) (CSP) 之外。 基底提供者的公開金鑰 Blob 具有下列格式。
...
[*私用金鑰 blob*](../secgloss/p-gly.md)（類型 **PRI加值稅EKEYBLOB**）是用來將 [*私密金鑰*](../secgloss/p-gly.md) 儲存在 CSP 外部。 基底提供者的私密金鑰 Blob 具有下列格式。
...
[*簡單的金鑰 blob*](../secgloss/s-gly.md)（類型 **SIMPLEBLOB**）是用來儲存和傳輸 CSP 外部的工作階段金鑰。 基底提供者簡單金鑰 Blob 一律會以 [*金鑰交換公開金鑰*](../secgloss/k-gly.md)加密。 **SIMPLEBLOB** 的 **>pbdata** 成員是採用下列格式的位元組序列。
