...
[**WinVerifyTrust**](/windows/desktop/api/Wintrust/nf-wintrust-winverifytrust) API 可以用來驗證可移植的可執行檔的簽章。

下列範例示範如何使用 [**WinVerifyTrust**](/windows/desktop/api/Wintrust/nf-wintrust-winverifytrust) API 來驗證已簽署之可執行檔的簽章。
