...
---
# <a name="rsa-client-code-for-creating-the-master-key"></a><span data-ttu-id="91941-103">用來建立主要金鑰的 RSA 用戶端程式代碼</span><span class="sxs-lookup"><span data-stu-id="91941-103">RSA Client Code for Creating the Master Key</span></span>

<span data-ttu-id="91941-104">下列範例顯示用來建立 [*主要金鑰*](../secgloss/m-gly.md)的一般 RSA/Schannel 用戶端程式代碼。</span><span class="sxs-lookup"><span data-stu-id="91941-104">The following example shows typical RSA/Schannel client-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
