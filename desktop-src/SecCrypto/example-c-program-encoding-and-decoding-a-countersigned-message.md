...
ms.locfileid: "119007726"
---
# <a name="example-c-program-encoding-and-decoding-a-countersigned-message"></a>範例 C 程式：編碼和解碼副署訊息

下列範例顯示如何編碼和解碼副署訊息。 此範例會使用 [**MyHandleError**](myhandleerror.md) 範例函數。 **MyHandleError** 函式和其他輔助函式的程式碼也會列在 [[一般用途] 功能](general-purpose-functions.md)底下。
