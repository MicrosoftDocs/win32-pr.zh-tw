---
description: OID 屬性會抓取擴充的物件識別碼。 這是預設屬性。
ms.assetid: 51efd413-f9f0-4577-a554-de6afc32dd87
title: Extension. OID 屬性
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119006896"
---
# <a name="extensionoid-property"></a>Extension. OID 屬性
