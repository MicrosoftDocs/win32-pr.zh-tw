---
description: 下列範例示範上一節中所述的程式。 這個範例會建立一個簡單的憑證要求，其中包含一個簽署者、單一相對辨別名稱 (RDN) 屬性，以及沒有一般屬性。
ms.assetid: bd3d0259-f0e8-460e-9f18-95d2492da3d8
title: 範例 C 程式：提出憑證要求
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104513709"
---
# <a name="example-c-program-making-a-certificate-request"></a><span data-ttu-id="7987b-104">範例 C 程式：提出憑證要求</span><span class="sxs-lookup"><span data-stu-id="7987b-104">Example C Program: Making a Certificate Request</span></span>

<span data-ttu-id="7987b-105">下列範例示範上一節中所述的程式。</span><span class="sxs-lookup"><span data-stu-id="7987b-105">The following example demonstrates the procedure outlined in the previous section.</span></span> <span data-ttu-id="7987b-106">這個範例會建立一個簡單的 [*憑證要求*](../secgloss/c-gly.md) ，其中包含一個簽署者、單一 [*相對辨別名稱*](../secgloss/r-gly.md) (RDN) [*屬性*](../secgloss/a-gly.md)，以及沒有一般屬性。</span><span class="sxs-lookup"><span data-stu-id="7987b-106">This example creates a simple [*certificate request*](../secgloss/c-gly.md) with one signer, a single [*relative distinguished name*](../secgloss/r-gly.md) (RDN) [*attribute*](../secgloss/a-gly.md), and no general attributes.</span></span>

<span data-ttu-id="7987b-107">此範例說明下列 [*CryptoAPI*](../secgloss/c-gly.md) 函數：</span><span class="sxs-lookup"><span data-stu-id="7987b-107">This example illustrates the following [*CryptoAPI*](../secgloss/c-gly.md) functions:</span></span>

-   [<span data-ttu-id="7987b-108">**CryptEncodeObject**</span><span class="sxs-lookup"><span data-stu-id="7987b-108">**CryptEncodeObject**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject)
-   [<span data-ttu-id="7987b-109">**CryptAcquireCoNtext**</span><span class="sxs-lookup"><span data-stu-id="7987b-109">**CryptAcquireContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta)
-   [<span data-ttu-id="7987b-110">**CryptExportPublicKeyInfo**</span><span class="sxs-lookup"><span data-stu-id="7987b-110">**CryptExportPublicKeyInfo**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptexportpublickeyinfo)
-   [<span data-ttu-id="7987b-111">**CryptSignAndEncodeCertificate**</span><span class="sxs-lookup"><span data-stu-id="7987b-111">**CryptSignAndEncodeCertificate**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsignandencodecertificate)

<span data-ttu-id="7987b-112">此範例也會使用 [**ByteToStr**](bytetostr.md) 和 [**MyHandleError**](myhandleerror.md)函數。</span><span class="sxs-lookup"><span data-stu-id="7987b-112">This example also uses the functions [**ByteToStr**](bytetostr.md) and [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="7987b-113">範例中包含這些函式的程式碼。</span><span class="sxs-lookup"><span data-stu-id="7987b-113">Code for these functions is included with the sample.</span></span> <span data-ttu-id="7987b-114">[一般目的函數](general-purpose-functions.md) 會列出這些和其他輔助函式的程式碼。</span><span class="sxs-lookup"><span data-stu-id="7987b-114">[General Purpose Functions](general-purpose-functions.md) lists code for these and other auxiliary functions.</span></span>
