---
description: 下列範例示範使用已簽署的訊息做為封包訊息的內部內容，來編碼已簽署訊息的替代程式。 為了進行解碼的準備，內部內容會經過測試，以判斷其內部內容類型。
...
ms.locfileid: "106983767"
---
# <a name="alternate-code-for-encoding-an-enveloped-message"></a><span data-ttu-id="4455e-104">編碼封包訊息的替代程式碼</span><span class="sxs-lookup"><span data-stu-id="4455e-104">Alternate Code for Encoding an Enveloped Message</span></span>

<span data-ttu-id="4455e-105">下列範例示範使用已簽署的訊息做為封包訊息的 [*內部內容*](../secgloss/i-gly.md) ，來編碼已簽署訊息的替代程式。</span><span class="sxs-lookup"><span data-stu-id="4455e-105">The following example demonstrates an alternate process of encoding a signed message, using that signed message as the [*inner content*](../secgloss/i-gly.md) for an enveloped message.</span></span> <span data-ttu-id="4455e-106">為了進行解碼的準備，內部內容會經過測試，以判斷其內部內容類型。</span><span class="sxs-lookup"><span data-stu-id="4455e-106">In preparation for decoding, the inner content is tested to determine its inner-content type.</span></span>

<span data-ttu-id="4455e-107">此範例說明下列 CryptoAPI 函數：</span><span class="sxs-lookup"><span data-stu-id="4455e-107">This example illustrates the following CryptoAPI functions:</span></span>

-   [<span data-ttu-id="4455e-108">**CryptAcquireCoNtext**</span><span class="sxs-lookup"><span data-stu-id="4455e-108">**CryptAcquireContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta)
-   [<span data-ttu-id="4455e-109">**CertOpenSystemStore**</span><span class="sxs-lookup"><span data-stu-id="4455e-109">**CertOpenSystemStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea)
-   [<span data-ttu-id="4455e-110">**CryptMsgCalculateEncodedLength**</span><span class="sxs-lookup"><span data-stu-id="4455e-110">**CryptMsgCalculateEncodedLength**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcalculateencodedlength)
-   [<span data-ttu-id="4455e-111">**CryptMsgOpenToEncode**</span><span class="sxs-lookup"><span data-stu-id="4455e-111">**CryptMsgOpenToEncode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentoencode)
-   [<span data-ttu-id="4455e-112">**CryptMsgUpdate**</span><span class="sxs-lookup"><span data-stu-id="4455e-112">**CryptMsgUpdate**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate)
-   [<span data-ttu-id="4455e-113">**CryptMsgGetParam**</span><span class="sxs-lookup"><span data-stu-id="4455e-113">**CryptMsgGetParam**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam)
-   [<span data-ttu-id="4455e-114">**CryptMsgOpenToDecode**</span><span class="sxs-lookup"><span data-stu-id="4455e-114">**CryptMsgOpenToDecode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentodecode)
-   [<span data-ttu-id="4455e-115">**CertFindCertificateInStore**</span><span class="sxs-lookup"><span data-stu-id="4455e-115">**CertFindCertificateInStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certfindcertificateinstore)
-   [<span data-ttu-id="4455e-116">**CryptMsgClose**</span><span class="sxs-lookup"><span data-stu-id="4455e-116">**CryptMsgClose**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgclose)
-   [<span data-ttu-id="4455e-117">**CertCloseStore**</span><span class="sxs-lookup"><span data-stu-id="4455e-117">**CertCloseStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore)
-   [<span data-ttu-id="4455e-118">**CryptReleaseCoNtext**</span><span class="sxs-lookup"><span data-stu-id="4455e-118">**CryptReleaseContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptreleasecontext)

<span data-ttu-id="4455e-119">此範例也會使用 [**MyHandleError**](myhandleerror.md) 和 [**GetSignerCert**](getsignercert.md)函數。</span><span class="sxs-lookup"><span data-stu-id="4455e-119">This example also uses the functions [**MyHandleError**](myhandleerror.md) and [**GetSignerCert**](getsignercert.md).</span></span> <span data-ttu-id="4455e-120">範例中包含這些函式的 C 程式碼。</span><span class="sxs-lookup"><span data-stu-id="4455e-120">C code for these functions is included with the example.</span></span> <span data-ttu-id="4455e-121">如需示範這些功能和其他輔助函式的程式碼，請參閱 [一般目的](general-purpose-functions.md)函式。</span><span class="sxs-lookup"><span data-stu-id="4455e-121">For code that demonstrates these and other auxiliary functions, see [General Purpose Functions](general-purpose-functions.md).</span></span>
