...
---
# <a name="declaring-the-device-capability"></a>宣告裝置功能

本主題說明如何宣告裝置功能 GUID。 所有以自訂驅動程式為目標的應用程式都必須宣告這項功能。

在您的應用程式資訊清單中，您必須新增裝置功能，如下所示：

這是自訂裝置的功能聲明範例。 GUID 是裝置介面類別別的 GUID。
