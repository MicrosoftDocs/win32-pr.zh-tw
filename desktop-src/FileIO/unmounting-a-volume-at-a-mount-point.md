...
---
# <a name="deleting-a-mounted-folder"></a>刪除載入的資料夾

本主題中的程式碼範例會示範如何使用 [**DeleteVolumeMountPoint**](/windows/desktop/api/FileAPI/nf-fileapi-deletevolumemountpointw) 函數來刪除已掛接的資料夾。 如需詳細資訊，請參閱 [建立裝載的資料夾](mounting-and-dismounting-a-volume.md)。
