...
---
# <a name="creating-a-mounted-folder"></a>建立載入的資料夾

下列範例示範如何建立裝載的資料夾。 如需詳細資訊，請參閱 [建立裝載的資料夾](mounting-and-dismounting-a-volume.md)。

此範例會使用下列函數： [**GetVolumeNameForVolumeMountPoint**](/windows/desktop/api/FileAPI/nf-fileapi-getvolumenameforvolumemountpointw) 和 [**SetVolumeMountPoint**](/windows/desktop/api/WinBase/nf-winbase-setvolumemountpointa)。
