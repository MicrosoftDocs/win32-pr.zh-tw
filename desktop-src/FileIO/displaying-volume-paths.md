...
ms.locfileid: "117997792"
---
# <a name="displaying-volume-paths"></a>顯示磁片區路徑

下列 c + + 範例顯示如何顯示每個磁片區和裝置的所有路徑。 針對系統中的每個磁片區，此範例會尋找磁片區、取得裝置名稱、取得該磁片區的所有路徑，並顯示路徑。
...
以下是執行應用程式的範例輸出。 針對每個磁片區，輸出中會包含磁片區裝置路徑、磁片區 GUID 路徑和磁碟機號。
