...
ms.locfileid: "119758518"
---
# <a name="structures"></a>結構

## <a name="in-this-section"></a>本節內容

-   [**單元 \_ 關機 \_ 註冊 \_ COOKIE**](/previous-versions//jj219262(v=vs.85))
...
-   [**HSTRING \_ 標頭**](/windows/win32/api/hstring/ns-hstring-hstring_header)
...
-   [**PDF \_ 轉譯 \_ 參數**](/windows/desktop/api/windows.data.pdf.interop/ns-windows-data-pdf-interop-pdf_render_params)
-   [**Rect**](/windows/win32/api/windows.foundation/ns-windows-foundation-rect)
-   [**之 iserverinformation**](/windows/win32/api/combaseapi/ns-combaseapi-serverinformation)
-   [**大小**](/windows/win32/api/windows.foundation/ns-windows-foundation-size)
