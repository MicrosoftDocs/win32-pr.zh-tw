...
---
# <a name="shv-module"></a><span data-ttu-id="b8340-103">SHV 模組</span><span class="sxs-lookup"><span data-stu-id="b8340-103">SHV Module</span></span>

> [!Note]  
> <span data-ttu-id="b8340-104">從 Windows 10 開始，無法使用網路存取保護平臺</span><span class="sxs-lookup"><span data-stu-id="b8340-104">The Network Access Protection platform is not available starting with Windows 10</span></span>

 

<span data-ttu-id="b8340-105">設定系統健康狀態驗證 (SHV) 模組，包括向 NAP 系統註冊及取消註冊。</span><span class="sxs-lookup"><span data-stu-id="b8340-105">Sets up a system health validator (SHV) module including registration and unregistration with the NAP system.</span></span>

> [!Note]  
> <span data-ttu-id="b8340-106">NAP SDK 也包含一組完整的範例程式碼，可在中 \\ 找到。範例 \\ NetDS \\ NAP .。。SDK 安裝的目錄。</span><span class="sxs-lookup"><span data-stu-id="b8340-106">The NAP SDK also contains a full set of sample code that can be found in the ...\\Samples\\NetDS\\NAP... directory of your SDK installation.</span></span> <span data-ttu-id="b8340-107">此範例集包括系統健康情況代理程式 (SHA) 、SHV 和強制用戶端 (EC) 。</span><span class="sxs-lookup"><span data-stu-id="b8340-107">This sample set includes a system health agent (SHA), SHV, and enforcement client (EC).</span></span> <span data-ttu-id="b8340-108">它有完整的工作 NAP 案例，可設定 SHA-SHV 與 SHA-1 之間的通訊。</span><span class="sxs-lookup"><span data-stu-id="b8340-108">It has full working NAP scenarios setting up communication between SHA-SHV and SHA-EC.</span></span>
