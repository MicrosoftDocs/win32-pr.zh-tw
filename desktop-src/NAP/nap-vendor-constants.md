---
title: 'NAP 廠商常數 (NapMicrosoftVendorIds .h) '
description: 以下是在 NapMicrosoftVendorIds 中定義的內部 Microsoft NAP 元件識別碼。
...
ms.locfileid: "106969997"
---
# <a name="nap-vendor-constants"></a>NAP 廠商常數
...
以下是在 NapMicrosoftVendorIds 中定義的內部 Microsoft NAP 元件識別碼。 在執行 SHA 或 SHV 時，請勿使用已指派給內部 Microsoft 系統健康情況元件的這些識別碼值。
...
| 標頭<br/>                   | <dl> <dt>NapMicrosoftVendorIds。h</dt> </dl> |
