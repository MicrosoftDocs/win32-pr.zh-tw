...
---
# <a name="freeisolationinfoex-function"></a>FreeIsolationInfoEx 函式
...
**FreeIsolationInfoEx** 函式會釋出 [**IsolationInfoEx**](/windows/win32/api/naptypes/ns-naptypes-isolationinfoex)的資料結構。
...
要釋放的 [**IsolationInfoEx**](/windows/win32/api/naptypes/ns-naptypes-isolationinfoex) 資料結構指標。
