...
ms.locfileid: "118940073"
---
# <a name="inapenforcementclientconnectiongetcorrelationid-method"></a>INapEnforcementClientConnection：： GetCorrelationId 方法
...
**INapEnforcementClientConnection：： GetCorrelationId** 方法會取得用來相互關聯 SoH 要求和 soh 回應的識別碼。
...
識別此 SoH 交換的唯一 [**CorrelationId**](/windows/win32/api/naptypes/ns-naptypes-correlationid) 結構。
