...
---
# <a name="freefixupinfo-function"></a>FreeFixupInfo 函式
...
**FreeFixupInfo** 函數會釋出 [**FixupInfo**](/windows/win32/api/naptypes/ns-naptypes-fixupinfo)資料結構。
...
要釋放的 [**FixupInfo**](/windows/win32/api/naptypes/ns-naptypes-fixupinfo) 資料結構指標。
