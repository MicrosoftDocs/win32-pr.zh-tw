...
ms.locfileid: "118368097"
---
# <a name="inapenforcementclientconnectionsetenforcerprivatedata-method"></a>INapEnforcementClientConnection：： SetEnforcerPrivateData 方法
...
Enforcer 會使用 **INapEnforcementClientConnection：： SetEnforcerPrivateData** 方法來設定私用資料。
...
只有 enforcer 可以解讀的 [**PrivateData**](/windows/win32/api/naptypes/ns-naptypes-privatedata) 不透明資料 blob 指標。
