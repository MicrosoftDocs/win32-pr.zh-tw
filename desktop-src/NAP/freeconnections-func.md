...
ms.locfileid: "118940635"
---
# <a name="freeconnections-function"></a>FreeConnections 函式
...
**FreeConnections** 函數會釋出 [**連接**](connections-struct.md)資料結構。
...
要釋放的 [**連接**](connections-struct.md) 結構指標。
