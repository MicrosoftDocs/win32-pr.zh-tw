...
當游標停留在視窗的非工作區時，在先前呼叫 [**TrackMouseEvent**](/windows/win32/api/winuser/nf-winuser-trackmouseevent)所指定的期間內，將滑鼠停留在視窗的非工作區上。
...
當產生此訊息時，會停止停留追蹤。 如果應用程式需要進一步追蹤滑鼠停留行為，則必須再次呼叫 [**TrackMouseEvent**](/windows/win32/api/winuser/nf-winuser-trackmouseevent) 。
