...
ms.locfileid: "119557128"
---
# <a name="wm_rbuttonup-message"></a>WM \_ RBUTTONUP 訊息

當使用者放開滑鼠右鍵，而游標位於視窗的工作區時張貼。 如果未捕捉到滑鼠，則會將訊息張貼到游標下的視窗。 否則，會將訊息張貼到已捕捉滑鼠的視窗。
...
| <span id="MK_RBUTTON"></span><span id="mk_rbutton"></span><dl> <dt>**MK \_RBUTTON**</dt> <dt>0x0002</dt> </dl>    | SHIFT 鍵已關閉。<br/>           |
