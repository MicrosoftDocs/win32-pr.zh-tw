...
ms.locfileid: "119778548"
---
# <a name="wm_nclbuttondown-message"></a>WM \_ NCLBUTTONDOWN 訊息
...
[**DefWindowProc**](/windows/desktop/api/winuser/nf-winuser-defwindowproca)函式會測試指定的點，以找出游標位置並執行適當的動作。 如果有的話， **DefWindowProc** 會將 [**WM \_ SYSCOMMAND**](/windows/desktop/menurc/wm-syscommand) 訊息傳送至視窗。
