...
ms.locfileid: "119666298"
---
# <a name="wm_ncrbuttondblclk-message"></a>WM \_ NCRBUTTONDBLCLK 訊息

當使用者按兩下滑鼠右鍵，而游標位於視窗的非工作區域內時，即會公佈。 這則訊息會張貼至包含資料指標的視窗。 如果視窗已捕捉到滑鼠，則不會張貼此訊息。
...
視窗不需要 **CS \_ DBLCLKS** 樣式即可接收 **WM \_ NCRBUTTONDBLCLK** 訊息。

當使用者按下、放開，然後在系統的按兩下時間限制內再次按下滑鼠右鍵時，系統會產生 **WM \_ NCRBUTTONDBLCLK** 訊息。 按兩下滑鼠右鍵會實際產生四則訊息： [**wm \_ NCRBUTTONDOWN**](wm-ncrbuttondown.md)、 [**wm \_ NCRBUTTONUP**](wm-ncrbuttonup.md)、 **wm \_ NCRBUTTONDBLCLK** 和 **wm \_ NCRBUTTONUP** 。
