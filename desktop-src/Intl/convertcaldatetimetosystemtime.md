...
ms.locfileid: "119631928"
---
# <a name="convertcaldatetimetosystemtime-function"></a>ConvertCalDateTimeToSystemTime 函式

已取代。 將指定的 [**CALDATETIME**](caldatetime.md) 結構轉換成 [**SYSTEMTIME**](/windows/win32/api/minwinbase/ns-minwinbase-systemtime) 結構。
...
要轉換之 [**CALDATETIME**](caldatetime.md) 結構的指標。
...
對等 [**SYSTEMTIME**](/windows/win32/api/minwinbase/ns-minwinbase-systemtime) 結構的指標。
