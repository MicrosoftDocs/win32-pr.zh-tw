...
| 語言                 | No        | 使用與 RFC 4646 相容的名稱格式所指定的語言 (Windows Vista 和更新版本) ，例如 en-us （英文） (美國) 。                                                                                                                                                                                                                                                                                                                                                                             |
| ultimateFallbackLanguage | No        | 要插入 LN 檔案之資源設定資料中的語言，代表要在搜尋對應語言專屬資源檔時使用的最終回溯語言。 如果資源載入器無法從執行緒慣用 UI 語言載入要求的資源檔，它會使用最終的回溯語言做為最後一次嘗試。 語言的指定方式是使用符合 RFC 4646 (Windows Vista 和更新版本) 的名稱格式，例如 en-us （英文） (美國) 。       |
