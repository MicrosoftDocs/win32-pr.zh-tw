...
---
# <a name="mui-system-settings-application-sample"></a><span data-ttu-id="44d5f-103">MUI：系統設定應用程式範例</span><span class="sxs-lookup"><span data-stu-id="44d5f-103">MUI: System Settings Application Sample</span></span>

<span data-ttu-id="44d5f-104">本主題所述的範例應用程式是簡單的 Hello MUI 應用程式，支援其使用者介面語言的系統設定。</span><span class="sxs-lookup"><span data-stu-id="44d5f-104">The sample application described in this topic is a simple Hello MUI application that supports system settings for its user interface languages.</span></span>
