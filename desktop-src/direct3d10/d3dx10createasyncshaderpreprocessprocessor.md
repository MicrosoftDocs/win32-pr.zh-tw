...
---
# <a name="d3dx10createasyncshaderpreprocessprocessor-function"></a>D3DX10CreateAsyncShaderPreprocessProcessor 函式
...
緩衝區指標的位址，其中包含著色器的 ASCII 文字 (查看 [**ID3D10Blob 介面**](/windows/win32/api/D3DCommon/nn-d3dcommon-id3d10blob)) 。
