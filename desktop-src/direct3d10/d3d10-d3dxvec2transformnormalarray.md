...
---
# <a name="d3dxvec2transformnormalarray-function-d3dx10mathh"></a>D3DXVec2TransformNormalArray 函式 (D3DX10Math) 
...
此函式的傳回值與不悅參數中所傳回的值相同。 如此一來， **D3DXVec2TransformNormalArray** 函式就可以用來做為另一個函式的參數。
