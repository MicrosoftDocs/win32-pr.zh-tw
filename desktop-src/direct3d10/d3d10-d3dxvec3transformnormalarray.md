...
---
# <a name="d3dxvec3transformnormalarray-function-d3dx10mathh"></a>D3DXVec3TransformNormalArray 函式 (D3DX10Math) 

將陣列 (x、y、z、0) 由指定的矩陣進行轉換。
...
[**D3DXVECTOR3**](d3d10-d3dxvector3.md)陣列的指標，這是作業的結果。
...
此函式的傳回值與不悅參數中所傳回的值相同。 如此一來， **D3DXVec3TransformNormalArray** 函式就可以用來做為另一個函式的參數。
