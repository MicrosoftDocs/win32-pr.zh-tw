...
ms.locfileid: "120120308"
---
# <a name="d3dxmatrixtranspose-function-d3dx10mathh"></a>D3DXMatrixTranspose 函式 (D3DX10Math) 
...
D3DXMATRIX 結構的指標，此結構是矩陣的矩陣變換。

## <a name="remarks"></a>備註

此函式的傳回值與不悅參數中所傳回的值相同。 如此一來，D3DXMatrixTranspose 函式就可以用來做為另一個函式的參數。
