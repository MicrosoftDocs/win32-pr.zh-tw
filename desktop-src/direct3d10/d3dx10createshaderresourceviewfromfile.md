...
ms.locfileid: "119634668"
---
# <a name="d3dx10createshaderresourceviewfromfile-function"></a>D3DX10CreateShaderResourceViewFromFile 函式
...
如需支援的影像格式清單，請參閱 [**D3DX10 \_ 影像檔案 \_ \_ 格式**](d3dx10-image-file-format.md)。
