...
description: SystemMonitor 類別具有下列屬性
...
[**SystemMonitor**](systemmonitor.md)類別具有下列屬性：

-   [**外觀**](systemmonitor-appearance.md)
-   [**顏色**](systemmonitor-backcolor.md)
...
-   [**反白顯示**](systemmonitor-highlight.md)
